import { n as splitGraphemes, s as visibleWidth } from "./ansi-DzD8RHcJ.mjs";
import { t as normalizeLowercaseStringOrEmpty } from "./string-coerce-BstKUO5B.mjs";
import { stylePromptTitle } from "./prompt-style.mjs";
import { AsyncLocalStorage } from "node:async_hooks";
import { note as note$1 } from "@clack/prompts";
...
function note(message, title) {
	...
	note$1(wrappedMessage, stylePromptTitle(title), { output: createNoteOutput(resolveNoteOutputColumns(wrappedMessage, columns)) });
}
