...
import { T as BrowserProfileUnavailableError } from "./tmp-openclaw-dir-Ci2i7GZs.js";
import "./config-BUwFeNPd.js";
import { d as markBrowserRuntimeStopping, r as beginProfileTransition, s as isBrowserRuntimeRunning } from "./server-context.lifecycle-BfszrfGc.js";
import { a as getExtensionRelayModule, t as createBrowserRouteContext } from "./server-context-DbSJ5QHS.js";
import { n as sweepTrackedBrowserTabs } from "./session-tab-registry-B1NUOYG-.js";
...
async function stopBrowserRuntimeInternal(params, finalizeGlobalAdapters) {
	...
	if (finalizeGlobalAdapters) try {
		const { disposeGatewayExtensionRelay } = await import("./gateway-relay-route-CJG-RuQR.js");
