...
import { f as resetPublishedConfigRuntimeEnv, p as ALLOW_OLDER_BINARY_DESTRUCTIVE_ACTIONS_ENV } from "./config-env-vars-DwleMuU3.js";
...
import { t as enforceGatewayRunFutureConfigGuard } from "./future-config-guard-D3I47UZn.js";
...
async function isSameGatewayRunConfigSnapshot(expected, current, options = {}) {
	const { hashRuntimeConfigValue } = await import("./runtime-snapshot-u3zFAwMy.js");
...
async function guardGatewayRunSelectedConfig(params) {
	...
	const [path, { applyConfigEnvVars, isConfigRuntimeEnvVarAllowed }, { loadGlobalRuntimeDotEnvFiles }, { normalizeEnv }, { normalizeStateDirEnv, resolveStateDir }, { resolveConfigDir }] = await Promise.all([
		import("node:path"),
		import("./config-env-vars-BlCv_JQv.js"),
		import("./dotenv-global-DWo79W-G.js"),
		import("./env-DG0SGnsh.js"),
...
async function prepareGatewayRunBootstrap(params) {
	...
	const { planPristineStartupConfigMigrations, planPristineStartupStateMigrations } = await import("./pristine-startup-state-DESn_rkn.js");
