...
import { i as hasUsableOAuthCredential, o as isSafeToAdoptMainStoreOAuthIdentity, t as areOAuthCredentialsEquivalent } from "./oauth-shared-B-oYylTU.js";
import { a as loadPersistedAuthProfileStore, p as isLegacyOAuthRef } from "./persisted-pDgmg_nM.js";
...
async function scanStaleOAuthProfileShadows(params) {
	...
	const mainAuthPath = path.resolve(resolveLegacyAuthProfilesPath(mainAgentDir));
