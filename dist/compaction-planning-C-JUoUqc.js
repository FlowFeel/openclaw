...
import { i as repairToolUseResultPairing, s as stripToolResultDetails } from "./ai-transport-runtime-host-BuwNINnx.js";
...
function groupCompactionMessages(messages, perMessageTokens) {
	...
	for (const [index, message] of messages.entries()) {
		...
		if (message.role === "assistant") {
			...
			if (resultId) pendingToolCallIds.delete(resultId);
			else pendingToolCallIds.clear();
		}
...
//#endregion
export { buildHistoryPrunePlan as a, buildSummaryChunks as c, isOversizedForSummary as d, projectCompactionMessagesForPlanning as f, SUMMARIZATION_OVERHEAD_TOKENS as i, computeAdaptiveChunkRatio as l, readCompactionPlanningOmittedChars as m, MIN_CHUNK_RATIO as n, buildOversizedFallbackPlan as o, sanitizeCompactionMessages as p, SAFETY_MARGIN as r, buildStageSplitPlan as s, BASE_CHUNK_RATIO as t, estimateMessagesTokens as u };
