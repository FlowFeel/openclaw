...
import { n as resolveApprovalRequestSessionConversation } from "./exec-approval-session-target-Ff9nhvur.js";
import { n as createChannelApproverDmTargetResolver, r as createChannelNativeOriginTargetResolver } from "./approval-native-helpers-tS4fVsGH.js";
import { n as createApproverRestrictedNativeApprovalCapability } from "./approval-delivery-helpers-iwE37gkl.js";
import { n as createLazyChannelApprovalNativeRuntimeAdapter } from "./approval-handler-adapter-runtime-Tv9LYgST.js";
import "./approval-native-runtime-BUJChYI5.js";
import { t as createRuntimeDirectoryLiveAdapter } from "./runtime-forwarders-Dxil5z45.js";
import { c as createNestedAllowlistOverrideResolver, o as createAccountScopedAllowlistNameResolver, r as buildLegacyDmAccountAllowlistAdapter } from "./allowlist-config-edit-CG60UeoA.js";
import { t as PAIRING_APPROVED_MESSAGE } from "./pairing-message-DNhqI-OE.js";
import { _ as asString, b as resolveEnabledConfiguredAccountId, d as createDefaultChannelRuntimeState, g as appendMatchMetadata, o as buildTokenChannelStatusSummary, p as readAccountStatusSnapshot, u as createComputedAccountStatusAdapter } from "./status-helpers-CSowaqvB.js";
import "./channel-core-BvCuTDf2.js";
import { f as createChannelMessageAdapterFromOutbound } from "./channel-outbound-COSGJaQ7.js";
import { i as createPairingPrefixStripper } from "./channel-pairing-BTpKky3B.js";
import { d as resolveScopeRequireMention, f as resolveScopeToolsPolicy, p as scopeKey } from "./channel-policy-DDPgHZTe.js";
...
import { c as resolveDiscordAccountAllowFrom, i as listEnabledDiscordAccounts, o as resolveDefaultDiscordAccountId, r as listDiscordAccountIds, s as resolveDiscordAccount } from "./accounts-Bu1tgR5z.js";
import { t as getDiscordRuntime } from "./runtime-Dg4d9hPu.js";
import { t as parseDiscordTarget } from "./target-parsing-BqdWGKw5.js";
import { n as looksLikeDiscordTargetId, r as normalizeDiscordMessagingTarget } from "./normalize-DqOl0p8d.js";
import "./channel-api-CmZXftEy.js";
import { t as resolveDiscordOutboundSessionRoute } from "./outbound-session-route-DgZlh9do.js";
import { u as withAbortTimeout } from "./timeouts-DB8J_ZTL.js";
import { i as shouldSuppressLocalDiscordExecApprovalPrompt, n as isDiscordExecApprovalApprover, r as isDiscordExecApprovalClientEnabled, t as getDiscordExecApprovalApprovers } from "./exec-approvals-iNZSy14Q.js";
import { t as shouldHandleDiscordApprovalRequest } from "./approval-shared-DiWomcdH.js";
import { r as resolveRequiredDiscordChannelPermissions } from "./audit-core-fZVFz0C1.js";
import { t as discordMessageActions$1 } from "./channel-actions-DzSU_pz3.js";
import { n as resolveDiscordCurrentConversationIdentity } from "./conversation-identity-Dj8g36-7.js";
import { r as openDiscordCommandDeployHashStore } from "./command-deploy-store-DFkBTViB.js";
import { n as setThreadBindingMaxAgeBySessionKey, t as setThreadBindingIdleTimeoutBySessionKey } from "./thread-bindings.session-updates-DsuQ5jKD.js";
import { n as discordOutbound } from "./outbound-adapter-i_fxD-u1.js";
import { i as discordSecurityAdapter, n as discordConfigAdapter, r as discordSetupContract, t as createDiscordPluginBase } from "./shared-uTutYZ9J.js";
...
function createDiscordApprovalCapability(configOverride) {
	return createApproverRestrictedNativeApprovalCapability({
		...
		nativeRuntime: createLazyChannelApprovalNativeRuntimeAdapter({
			...
			load: async () => (await import("./approval-handler.runtime-DNOlkrQs.js")).discordApprovalNativeRuntime
		})
	});
}
...
const loadDiscordDirectoryConfigModule = createLazyRuntimeModule(() => import("./directory-config-CzuuMbe2.js"));
const loadDiscordResolveChannelsModule = createLazyRuntimeModule(() => import("./resolve-channels-CSWZz0Nj.js"));
const loadDiscordResolveUsersModule = createLazyRuntimeModule(() => import("./resolve-users-CSwkCsey.js"));
const loadDiscordThreadBindingsManagerModule = createLazyRuntimeModule(() => import("./thread-bindings.manager-qTRuh5l_.js"));
const loadDiscordTargetResolverModule = createLazyRuntimeModule(() => import("./target-resolver-DP0JnUQz.js"));
const loadDiscordProviderRuntime = createLazyRuntimeModule(() => import("./provider.runtime.js"));
const loadDiscordProbeRuntime = createLazyRuntimeModule(() => import("./probe.runtime-Bz6yAr6M.js"));
...
const loadDiscordAuditModule = createLazyRuntimeModule(() => import("./audit-DEtddxbC.js"));
const loadDiscordSendModule = createLazyRuntimeModule(() => import("./send-DO23viKt.js"));
const loadDiscordDirectoryLiveModule = createLazyRuntimeModule(() => import("./directory-live-Ce_9SHW0.js"));
//#endregion
...
const discordMessageActions = {
	...
	requiresTrustedRequesterSender: (ctx) => resolveRuntimeDiscordMessageActions()?.requiresTrustedRequesterSender?.(ctx) ?? discordMessageActions$1.requiresTrustedRequesterSender?.(ctx) ?? false,
