...
import { i as asOptionalRecord, o as isRecord, t as asNullableObjectRecord } from "./record-coerce-DHZ4bFlT.js";
import { t as pruneMapToMaxSize } from "./map-size-DAGm21RM.js";
import { C as hashConfigIncludeRaw, E as resolveConfigIncludes, T as resolveConfigIncludeWritePath, b as ConfigIncludeError, w as readConfigIncludeFileWithGuards } from "./redact-BGqyyKN9.js";
import { t as sanitizeForLog } from "./ansi-DbP9Z_r_.js";
import { i as isPathInside } from "./path-D8zNGPJM.js";
import { c as resolveUserPath, o as resolveRequiredHomeDir } from "./home-dir-Cs7bTrwJ.js";
import { g as isPlainObject } from "./utils-Bs67j6-3.js";
import { t as sleep } from "./sleep-Ce8zcpEF.js";
import { n as containsEnvVarReference, r as resolveConfigEnvVars } from "./env-substitution-acZl0cGf.js";
...
import { C as resolveStateDir, _ as resolveIncludeRoots, d as resolveConfigPath } from "./paths-CL43LNS6.js";
import { n as extractErrorCode, r as formatErrorMessage, t as collectErrorGraphCandidates } from "./errors-Cg_yT1Sv.js";
import { r as normalizeProviderId } from "./provider-id-BIcU_2-A.js";
import { c as normalizeConfiguredProviderCatalogModelId, o as collectManifestModelIdNormalizationPolicies } from "./plugin-metadata-lifecycle-NcA0EWhA.js";
import { _ as computeModelPolicyAllowlist, a as readAgentRosterProperty, b as isExplicitModelPolicy, f as resolveDefaultAgentId, m as toAgentEntriesRecord, n as listAgentEntries, o as resolveAgentConfig, r as listAgentEntriesWithSource, t as hasAgentRosterProperty, u as resolveAgentWorkspaceDir, y as hasModelPolicyAllowlistMigrationMarker } from "./agent-scope-config-Dusa8eSA.js";
import { n as normalizeAgentId } from "./agent-id-DDgUze4y.js";
import "./path-guards-C3glTcy2.js";
import { c as shouldEnableShellEnvFallback, i as loadShellEnvFallback, o as resolveShellEnvFallbackTimeoutMs, s as shouldDeferShellEnvFallback } from "./shell-env-ic769138.js";
import { r as collectConfiguredModelRefs } from "./configured-model-refs-XCtO9k7W.js";
import "./model-catalog-DWiqPTMG.js";
import { n as planManifestModelCatalogSuppressions } from "./manifest-planner-BAbScYx0.js";
...
import { h as getNodeSqliteKysely, p as executeSqliteQuerySync } from "./node-sqlite-B_0DgpUE.js";
...
import { s as createConfigValidationMetadataPluginIdScope } from "./gateway-startup-plugin-ids-C-hC0TmS.js";
import { i as GENERATED_BUNDLED_CHANNEL_CONFIG_METADATA } from "./ids-DPg7j456.js";
import { t as replaceFileAtomic } from "./replace-file-BYn355zQ.js";
import { i as writeConfigMachineState } from "./config-machine-state-i7eWuJLs.js";
import { n as normalizeAgentModelRefForConfig, t as normalizeAgentModelMapForConfig } from "./model-input-BofPWz0k.js";
import "./agent-scope-DyEposw2.js";
import { n as resolveManifestCommandAliasOwnerInRegistry } from "./manifest-command-aliases-B8DIagnu.js";
import { r as loadInstalledPluginIndexInstallRecordsSync } from "./installed-plugin-index-record-reader-DA9P0iII.js";
import { r as hasKind } from "./slots-pOTBtf7J.js";
import { c as normalizePluginsConfig, f as resolveMemorySlotDecision, o as normalizePluginId, u as resolveEffectivePluginActivationState } from "./config-state-DrPZVhOu.js";
import { h as resolveOfficialExternalPluginInstall, n as getOfficialExternalPluginCatalogEntry } from "./official-external-plugin-catalog-CWuAzOfx.js";
import { G as evaluateDmPolicyAllowFromDependency, K as isBuiltInModelProviderOverlayId } from "./zod-schema.agent-runtime-CaWcMFul.js";
import { t as sanitizeTerminalText } from "./safe-text-wtXgRSZv.js";
import { i as summarizeAllowedValues, r as appendAllowedValuesHint, t as validateJsonSchemaValue } from "./schema-validator-CySXOkZz.js";
...
import { c as getPublishedConfigRuntimeEnvState, n as cloneEnvWithPlatformSemantics, s as createConfigRuntimeEnvBase, t as applyConfigEnvVars } from "./config-env-vars-Dh6msnxE.js";
...
import { t as loadDotEnv } from "./dotenv-Dm7CmAGp.js";
import { t as GATEWAY_CONFIG_SELECTION_ENV_KEYS } from "./gateway-env-selection-DZkwrn1I.js";
import { a as getRuntimeConfigSnapshot, c as getRuntimeConfigSourceSnapshot, d as loadPinnedRuntimeConfig, f as notifyRuntimeConfigWriteListeners, g as registerRuntimeConfigWriteListener, h as registerManagedRuntimeConfigWriteOwner, l as hasManagedRuntimeConfigWriteOwner, m as preflightRuntimeSnapshotWrite, n as createRuntimeConfigWriteNotification, p as preflightManagedRuntimeConfigWrite, r as finalizeRuntimeSnapshotWrite, s as getRuntimeConfigSnapshotRefreshHandler } from "./runtime-snapshot-Bzqj8IgJ.js";
import { f as migratePersistedImplicitMainRoster } from "./legacy-C8NOAlee.js";
import "./defaults-CdX9UGcX.js";
import { t as resolveBundledProviderPolicySurface } from "./provider-public-artifacts-CZklmvuv.js";
import { n as normalizeTalkConfig } from "./talk-Desj3oxA.js";
import { i as normalizeTrustedSafeBinDirs, u as normalizeSafeBinProfileFixtures } from "./exec-safe-bin-trust-DHudQEAW.js";
import { n as ok, t as err } from "./result-BQGgYouL.js";
import { i as unsetConfigValueAtPath, n as parseConfigPath, r as setConfigValueAtPath } from "./config-paths-H__p5Mi7.js";
import { t as resolveShellEnvExpectedKeys } from "./shell-env-expected-keys-BNN38Wi9.js";
import { t as resolveWebSearchInstallCatalogEntries } from "./web-search-install-catalog-MHYBiCuB.js";
import { s as ChannelHeartbeatVisibilitySchema } from "./zod-schema.channels-config-VtOOhddS.js";
import { a as resolveChannelDmAllowFrom, o as resolveChannelDmPolicy } from "./dm-access-Bq5cULcy.js";
import { i as isPathWithinRoot, n as isAvatarDataUrl, o as isWindowsAbsolutePath, r as isAvatarHttpUrl, t as hasAvatarUriScheme } from "./avatar-policy-BX3hGmH_.js";
...
import { M as isValidExactModelPolicyRef, N as parseModelPolicyWildcardRef, j as isModelPolicyCompatSelector } from "./model-selection-shared-V7VmYFPH.js";
import { n as McpServerNameSchema, r as NodeHostMcpServerNameSchema, t as OpenClawSchema } from "./zod-schema-9ObLtj6p.js";
import { C as shouldSuppressMissingCodexPluginDiagnostics } from "./codex-route-model-ref-BDwklqCa.js";
import { a as throwInvalidConfig } from "./io.invalid-config-Chuupwwv.js";
import { t as KeyedAsyncQueue } from "./keyed-async-queue-CTreGrmR.js";
import { n as formatConfigIssueLines, r as formatConfigIssueSummary } from "./issue-format-NBZpPOU4.js";
import { r as shouldAttemptLastKnownGoodRecovery, t as isPluginLocalInvalidConfigSnapshot } from "./recovery-policy-CsUZ07YX.js";
import { i as includeContributionOwnsAgentRoster, n as configIncludeOwnsAgentRosterValues } from "./agent-roster-provenance-CfRWZSQN.js";
...
function isPathCaseInsensitive(value) {
	...
	try {
		...
		const code = error.code;
		if (code !== "ENOENT" && code !== "ENOTDIR") return platformDefault();
	}
	let candidate = path.dirname(resolved);
	for (;;) {
		try {
			if (fs.statSync(candidate).isDirectory()) return probeDirectory(candidate);
		} catch {}
		const parent = path.dirname(candidate);
		if (parent === candidate) return platformDefault();
		candidate = parent;
	}
}
//#endregion
...
const AUTO_MANAGED_CONFIG_META_PATHS = [["meta", AUTO_MANAGED_CONFIG_META_FIELDS.lastTouchedVersion], [
	"meta",
	"migrations",
...
function applyModelDefaults(cfg, options = {}) {
	...
	if (providerConfig) {
		...
		for (const [providerId, provider] of Object.entries(providerConfig)) {
			...
			const providerContextWindow = isPositiveNumber(normalizedProvider.contextWindow) ? normalizedProvider.contextWindow : void 0;
			const providerContextTokens = isPositiveNumber(normalizedProvider.contextTokens) ? normalizedProvider.contextTokens : void 0;
			const providerMaxTokens = isPositiveNumber(normalizedProvider.maxTokens) ? normalizedProvider.maxTokens : void 0;
			...
			const nextModels = models.map((model) => {
				...
				const contextWindow = isPositiveNumber(raw.contextWindow) ? raw.contextWindow : providerContextWindow ?? 2e5;
				if (raw.contextWindow !== contextWindow) modelMutated = true;
				const contextTokens = isPositiveNumber(raw.contextTokens) ? raw.contextTokens : providerContextTokens;
				if (raw.contextTokens !== contextTokens) modelMutated = true;
				const defaultMaxTokens = Math.min(providerMaxTokens ?? DEFAULT_MODEL_MAX_TOKENS, contextWindow);
...
const FULL_MATERIALIZATION_PROFILE = {
...
function applyOverrideTree(cfg, overrideTree) {
	...
	if (next.agents === cfg.agents) return next;
	...
	for (const record of registry.plugins) {
		...
		for (const [channelId, channelConfig] of Object.entries(record.channelConfigs ?? {})) {
			...
			byChannelId.set(channelId, {
				...
				configSchema: record.origin === "bundled" || channelConfig.schema === void 0 ? channelConfig.schema : normalizeCoreOwnedChannelSchema(channelConfig.schema),
...
function mapZodIssueToConfigIssue(issue) {
	...
	const path = formatConfigPath$1(pathSegments);
...
function validateIdentityAvatar(config, env) {
	...
	for (const { entry, source } of agents) {
		...
		if (!isWorkspaceAvatarPath(avatar, resolveAgentWorkspaceDir(config, entry.id ?? resolveDefaultAgentId(config), env))) issues.push(createIdentityAvatarIssue(source, "identity.avatar must stay within the agent workspace."));
	}
	return issues;
}
...
function collectModelPolicyAllowIssues(config) {
	...
	for (const { entry: agent, source } of listAgentEntriesWithSource(config)) {
		...
		validateRefs(agent.modelPolicy?.allow, `${pathPrefix}.modelPolicy.allow`, collectAliases(defaultModels, agent.models));
	}
	return issues;
}
/**
...
function validateConfigObjectRaw(raw, opts) {
	...
	const validatedConfig = attachAgentListProjection(materializeBundledModelProviderOverlays(validated.data));
...
function validateConfigObject(raw, opts) {
	...
	return {
		ok: true,
		config: attachAgentListProjection(materializeRuntimeConfig(result.config, "snapshot", { manifestRegistry: opts?.manifestRegistry }))
	};
}
//#endregion
...
function validateExplicitPluginConfig(params) {
	const { raw, config, effectiveConfig, env, applyDefaults, registry, knownIds, normalizedPlugins, ensureCompatPluginIds, ensureOverriddenPluginIds, issues, warnings } = params;
...
function validateConfigObjectWithPluginsBase(raw, opts) {
	...
	const ensureChannelSchemas = () => {
		...
		if (!info.channelSchemas) {
			...
			for (const entry of collectChannelSchemaMetadataWithOwnership(info.registry)) {
				...
				else if (!current) info.channelSchemas.set(entry.id, {});
			}
		}
	...
	const validateHeartbeatTarget = (target, issuePath) => {
		...
		if (normalized === "last" || normalized === "none" || normalizeBundledChannelId(trimmed)) return;
	...
	if (!hasExplicitPluginsConfig) return issues.length > 0 ? {
		ok: false,
		issues,
		warnings
	} : {
...
function createConfigIoContext(options = {}) {
	...
	function resolveRuntimePreflightSourceConfig(candidate) {
		const env = { ...deps.env };
		return coerceConfig(migratePersistedImplicitMainRoster(resolveConfigForRead(resolveConfigIncludesForRead(candidate, configPath, {
			...deps,
			env
		}), env, deps.lowerPrecedenceEnv).resolvedConfigRaw).config);
	}
...
function createConfigFileSnapshot(params) {
	...
	return {
		...
		raw: params.raw,
		parsed: params.parsed,
		...params.sourceConfigBeforeMigrations ? { sourceConfigBeforeMigrations: asResolvedSourceConfig(params.sourceConfigBeforeMigrations) } : {},
		sourceConfig,
...
async function collectInvalidConfigLegacyIssues(raw, sourceRaw) {
	...
	const { findDoctorLegacyConfigIssues } = await import("./legacy-config-issues-BRI6CP0y.js");
...
function loadConfigFromContext(context, options = {}) {
	...
	try {
		...
		if (!deps.fs.existsSync(configPath)) {
			...
			return migratePersistedImplicitMainRoster({}).config;
		}
		const raw = deps.fs.readFileSync(configPath, "utf-8");
		...
		for (const diagnostic of rosterMigration.diagnostics) deps.logger.warn(`Config (${configPath}): ${diagnostic}`);
...
async function readConfigFileSnapshotInternal(context, options = {}) {
	...
	try {
		...
		const rosterMigration = migratePersistedImplicitMainRoster(readResolution.resolvedConfigRaw);
		envVarWarnings.push(...rosterMigration.diagnostics.map((message) => ({
			path: "agents.entries",
			message
		})));
		const effectiveConfigRaw = rosterMigration.config;
...
async function readSourceConfigBestEffortFromContext(context) {
	...
	try {
		...
		return coerceConfig(resolveConfigForRead(resolved, deps.env, deps.lowerPrecedenceEnv).resolvedConfigRaw);
	} catch {
		return {};
	}
}
...
async function cleanOrphanBackups(configPath, ioFs) {
	...
	for (const entry of entries) {
		...
		await ioFs.unlink(orphanPath).catch((error) => {
...
var UnresolvedAgentRosterIdError = class extends Error {
	constructor(authoredId) {
		super(`Config write cannot safely resolve an explicitly replaced agent list slot for id "${authoredId}"; use a resolved literal id before writing the roster.`);
...
function containsAuthoredRosterReference(value) {
	if (typeof value === "string") return value.includes("${");
	if (Array.isArray(value)) return value.some(containsAuthoredRosterReference);
	if (!isRecord(value)) return false;
	if (typeof value.source === "string" && typeof value.id === "string") return true;
...
function canonicalizeAgentRosterForExplicitWrite(params) {
	...
	for (const index of renamedLegacyIndexes) {
		...
		if (isRecord(entry) && typeof entry.id === "string" && entry.id.includes("${")) throw new Error("Config write cannot safely resolve an env-backed renamed agent id; set the resolved literal id or rename the authored entry directly.");
	}
	const resolveExplicitLegacyEntryId = (entry, index) => {
		...
		return explicitId.includes("${") ? void 0 : explicitId;
	};
	...
	const explicitEntries = explicitRoster?.kind === "list" && Array.isArray(explicitRoster.value) ? Object.fromEntries(explicitRoster.value.flatMap((entry, index) => {
		...
		if (typeof id !== "string") {
			if (structurallyExplicitLegacyIndexes.has(index) && typeof entry.id === "string") throw new UnresolvedAgentRosterIdError(entry.id);
			return [];
		}
	...
	if (ambiguousAddedIds.length > 0 && ambiguousRemovedIds.some((id) => containsAuthoredRosterReference(authoredEntries[id]))) throw new Error("Config write cannot safely match renamed agent entries with authored references; rename agents one at a time.");
	let entries = Object.fromEntries(Object.entries(nextEntries).map(([id, nextEntry]) => {
		...
		if (isRecord(value) && isRecord(nextEntry)) if (Object.hasOwn(nextEntry, "default")) {
			if (!(Object.hasOwn(value, "default") && containsAuthoredRosterReference(value.default) && (Object.hasOwn(runtimeEntries, priorId) && isRecord(runtimeEntries[priorId]) && isDeepStrictEqual(runtimeEntries[priorId].default, nextEntry.default) || Object.hasOwn(sourceEntries, priorId) && isRecord(sourceEntries[priorId]) && isDeepStrictEqual(sourceEntries[priorId].default, nextEntry.default)))) value.default = cloneUnknown(nextEntry.default);
...
function resolvePersistCandidateForWrite(params) {
	...
	} else if (canCanonicalizeAgentRoster(params.nextConfig)) persistedBase = restoreAuthoredAgentRoster(persistedBase, rootAuthoredConfig);
...
function hasOwnIncludeDirective(value) {
	return value !== null && typeof value === "object" && Object.hasOwn(value, "$include");
}
function hasIncludedGatewayModeOwner(value) {
	if (hasOwnIncludeDirective(value)) return true;
	if (value === null || typeof value !== "object" || Array.isArray(value)) return false;
	const gateway = value.gateway;
	if (hasOwnIncludeDirective(gateway)) return true;
	if (gateway === null || typeof gateway !== "object" || Array.isArray(gateway)) return false;
	return hasOwnIncludeDirective(gateway.mode);
}
async function writeConfigFileFromContext(context, cfg, options, readSnapshot) {
	...
	const snapshot = (options.baseSnapshot ? {
	...
	if (snapshot.valid) persistCandidate = resolvePersistCandidateForWrite({
	...
	const authoredGateway = snapshot.parsed.gateway;
	const authoredGatewayMode = authoredGateway !== null && typeof authoredGateway === "object" && !Array.isArray(authoredGateway) ? authoredGateway.mode : void 0;
	const gatewayModeAuthoredLocally = authoredGateway !== null && typeof authoredGateway === "object" && !Array.isArray(authoredGateway) && Object.hasOwn(authoredGateway, "mode") && !hasOwnIncludeDirective(authoredGatewayMode);
	const preservesIncludedGatewayMode = options.allowIncludeAncestorExplicitSetPaths === true && gatewayModeBefore != null && !gatewayModeAuthoredLocally && hasIncludedGatewayModeOwner(stampedOutputConfig) && !options.explicitSetPaths?.some((explicitPath) => explicitPath[0] === "gateway");
	const gatewayModeAfter = resolveGatewayMode(stampedOutputConfig) ?? (preservesIncludedGatewayMode ? gatewayModeBefore : null) ?? null;
...
//#endregion
export { AUTO_MANAGED_CONFIG_META_PATHS as $, resolveManagedUnsetPathsForWrite as A, captureConfigOverrideApplier as B, ConfigRuntimeRefreshError as C, createPreUpdateConfigSnapshot as D, collectChangedPaths as E, validateConfigObjectRaw as F, asResolvedSourceConfig as G, resetConfigOverrides as H, collectUnsupportedSecretRefPolicyIssues as I, resolveNormalizedProviderModelMaxTokens as J, asRuntimeConfig as K, collectChannelSchemaMetadata as L, validateConfigObjectRawWithPlugins as M, validateConfigObjectWithPlugins as N, maintainConfigBackups as O, validateConfigObject as P, ConfigMutationConflictError as Q, collectPluginSchemaMetadata as R, projectSourceOntoRuntimeShape as S, restoreEnvVarRefs as T, setConfigOverride as U, getConfigOverrides as V, unsetConfigOverride as W, resolveAgentMaxConcurrent as X, normalizeProviderConfigForConfigDefaults as Y, resolveSubagentMaxConcurrent as Z, recoverConfigFromLastKnownGood as _, preserveConfigSnapshotAsClobbered as a, resolveOwnerPromptNumbers as at, createConfigIO as b, readBestEffortConfigSnapshot as c, readConfigFileSnapshotForWrite as d, parseConfigJson5 as et, readConfigFileSnapshotWithPluginMetadata as f, recoverConfigFromJsonRootSuffix as g, readSourceConfigSnapshotForWrite as h, loadConfig as i, resolveOwnerDisplaySetting as it, resolveModelIdNormalizationPolicies as j, applyUnsetPathsForWrite as k, readConfigFileSnapshot as l, readSourceConfigSnapshot as m, clearConfigCache as n, restoreEnvChangesIfUnchanged as nt, promoteConfigSnapshotToLastKnownGood as o, readSourceConfigBestEffort as p, DEFAULT_MODEL_ALIASES as q, getRuntimeConfig as r, snapshotEnv as rt, readBestEffortConfig as s, projectConfigOntoRuntimeSourceSnapshot as t, resolveConfigSnapshotHash as tt, readConfigFileSnapshotForRuntimeTransaction as u, registerConfigWriteListener as v, resolveWriteEnvSnapshotForPath as w, warnIfJSON5CommentsWillBeStripped as x, writeConfigFile as y, applyConfigOverrides as z };
