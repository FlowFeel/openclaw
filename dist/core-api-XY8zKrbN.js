...
import { c as DEFAULT_UPLOAD_DIR, l as resolveExistingUploadPaths, r as resolveBrowserConfig } from "./config-Da5ffEih.js";
import { Y as withTimeout, j as parseBrowserErrorPayload } from "./tmp-openclaw-dir-DQI4fBxj.js";
import "./control-auth-CXEYT68Y.js";
import "./chrome.executables-B2udiA_j.js";
import "./trash-hWxEfvIX.js";
import { o as loadBrowserConfigForRuntimeRefresh } from "./server-context-DCzVcpAM.js";
import "./sdk-setup-tools-DRxyA9La.js";
import { C as fetchBrowserJson, D as withBaseUrl, E as buildProfileQuery, T as setBridgeAuthForPort, w as deleteBridgeAuthForPort } from "./session-tab-registry-DzvuLxVk.js";
import "./routes-Bo5sbKnu.js";
import { i as listenBrowserHttpServer, n as installBrowserAuthMiddleware, r as installBrowserCommonMiddleware, t as hasVerifiedBrowserAuth } from "./server-middleware-C-QNmoLz.js";
import { c as stopBrowserBridgeRuntime, n as createBrowserControlContext } from "./plugin-enabled-Dz4t-PS_.js";
import { a as resolveRequestedBrowserProfile, i as normalizeBrowserRequestPath, n as isBrowserHostLocalRoute, r as isPersistentBrowserProfileMutation, t as createBrowserRouteDispatcher } from "./dispatcher-YJ7S2lZb.js";
...
async function startBrowserBridgeServer(params) {
	...
	if (params.skipRouteRegistrationForTest) app.get("/", (_req, res) => {
		...
		const [{ createBrowserRouteContext }, { registerBrowserRoutes }] = await Promise.all([import("./server-context-3oHGo0nB.js"), import("./routes-rea9uBv1.js")]);
