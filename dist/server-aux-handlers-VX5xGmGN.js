...
import { _ as resolveSecretInputRef } from "./types.secrets-BvApkFoj.js";
import { i as resolveManifestContractOwnerPluginId } from "./plugin-registry-contributions-B0602V_s.js";
import "./plugin-registry-6MbhJA7X.js";
import "./config-BBVHtcXg.js";
import { n as resolveSecretRefValue } from "./resolve-zGIf9IjE.js";
import { i as createResolverContext } from "./runtime-shared-Br87CeOH.js";
import { t as assertExpectedResolvedSecretValue } from "./secret-value-CmYVEVQi.js";
...
import { i as loadOrCreateProcessDeviceIdentity } from "./device-identity-BOrXxcUy.js";
...
import { n as getLoadedChannelPlugin } from "./registry-DOSZ6AfI.js";
...
import { c as buildPluginApprovalExpiredMessage, l as buildPluginApprovalRequestMessage, s as approvalDecisionLabel } from "./plugin-approvals-DmWtM_Ej.js";
import { t as resolveCanonicalPluginApprovalRequestAllowedDecisions } from "./plugin-approval-canonical-decisions-CtBpKRPA.js";
import { j as resolveExecApprovalRequestAllowedDecisions } from "./exec-approvals-sCmCk_jQ.js";
import { a as getActiveSecretsRuntimeEnv, c as getActiveSecretsRuntimeSnapshotRevision, s as getActiveSecretsRuntimeSnapshot } from "./runtime-state-DhF-BA9k.js";
import { t as analyzeCommandSecretAssignmentsFromSnapshot } from "./command-config-CXhOyrwd.js";
import { t as resolveRuntimeWebTools } from "./runtime-web-tools-KfuGQLQO.js";
...
import { f as formatExecApprovalExpiresIn } from "./exec-approval-reply-CBvUCFxF.js";
import { t as createPendingApprovalRegistry } from "./pending-approval-registry-BP7u96lB.js";
import { i as sanitizeExecApprovalWarningText, t as resolveExecApprovalCommandDisplay } from "./exec-approval-command-display-BtRPbRj9.js";
import { a as buildTypedApprovalPendingReplyPayload, i as buildPluginApprovalResolvedReplyPayload, n as buildApprovalResolvedReplyPayload, o as buildTypedPluginApprovalPendingReplyPayload } from "./approval-renderers-DUPcLame.js";
import { d as listDevicePairing, l as hasEffectivePairedDeviceRole } from "./device-pairing-D3ZJFObN.js";
import { g as resolveApnsRelayConfigFromEnv, i as clearApnsRegistrationIfCurrent, l as loadApnsRegistrations } from "./push-apns-store-ChR3wFuA.js";
import { n as closeOrphanedOperatorApprovals, u as pruneTerminalOperatorApprovals } from "./operator-approval-store-D873Qvth.js";
import { t as resolveApprovalSessionAudienceWithFallback } from "./approval-session-audience-oPLoknGt.js";
import { t as SYSTEM_AGENT_APPROVAL_DECISIONS } from "./system-agent-approvals-BczGX_94.js";
import { a as sendApnsPluginApprovalAlert, c as resolveApnsAuthConfigFromEnv, i as sendApnsExecApprovalResolvedWake, o as sendApnsPluginApprovalResolvedWake, r as sendApnsExecApprovalAlert, s as shouldClearStoredApnsRegistration } from "./push-apns-owoosUSI.js";
import { n as ExecApprovalManager } from "./exec-approval-manager-5dZjZ1MP.js";
import { t as QuestionManager } from "./question-manager-ZRqozUbe.js";
import { t as publishAppliedApprovalResolution } from "./approval-publication-CGdnIAg7.js";
...
async function activateSecretsRuntimeSnapshotIfCurrent(snapshot, expectedRevision, options) {
	const runtime = await import("./runtime-6RXfdk6s.js");
...
function createGatewayAuxHandlers(params) {
	...
	const loadExecApprovalHandlers = createLazyPromise(() => import("./exec-approval-CG77zbQA.js").then(({ createExecApprovalHandlers }) => createExecApprovalHandlers(execApprovalManager, {
		forwarder: execApprovalForwarder,
		iosPushDelivery: execApprovalIosPushDelivery
	})), { cacheRejections: true });
	const questionManager = new QuestionManager();
	const loadQuestionHandlers = createLazyPromise(() => import("./question-BDcOhnyO.js").then(({ createQuestionHandlers }) => createQuestionHandlers(questionManager)), { cacheRejections: true });
	...
	const loadPluginApprovalHandlers = createLazyPromise(() => import("./plugin-approval-CmIueF3-.js").then(({ createPluginApprovalHandlers }) => createPluginApprovalHandlers(pluginApprovalManager, {
		forwarder: execApprovalForwarder,
		iosPushDelivery: pluginApprovalIosPushDelivery
	})), { cacheRejections: true });
	const loadApprovalHandlers = createLazyPromise(() => import("./approval-BpKyqdyQ.js").then(({ createApprovalHandlers }) => createApprovalHandlers({
		execApprovalManager,
	...
	const loadSecretsHandlers = createLazyPromise(() => import("./secrets-De6O_wnT.js").then(({ createSecretsHandlers }) => createSecretsHandlers({
