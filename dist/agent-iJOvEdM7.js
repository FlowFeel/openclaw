...
import { s as readErrorName } from "./errors-D-7D3ZtF.js";
...
import { l as AGENT_SESSION_RESET_COMMAND_RE } from "./method-scopes-ChuOr7sh.js";
...
import { a as mergeDeliveryContext, c as normalizeSessionDeliveryState, d as sessionDeliveryOrigin, f as sessionDeliveryRoute, n as deliveryContextFromSession, s as normalizeDeliveryContext, u as sessionDeliveryChannel } from "./delivery-context.shared-B-QSuGw_.js";
...
import { Ct as buildSessionCreationStamp, R as applySqliteSessionEntryReplacements, st as loadSqliteSessionEntry, ut as patchSqliteSessionEntryTarget } from "./session-accessor.sqlite-B9iW7DOt.js";
...
import { s as resolveCliRuntimeExecutionProvider } from "./model-runtime-aliases-D6C4F5xr.js";
...
import { f as isTimeoutError } from "./failover-error-U3al4tnA.js";
import { u as recordSessionCreated } from "./session-state-events-MWtkoPhW.js";
import { V as mapAgentRunTerminalOutcomeToTaskStatus } from "./task-registry-ZiNcN-Vv.js";
import { n as buildAgentRunTerminalOutcome, o as classifyAgentRunTerminalOutcome, p as normalizeAgentRunTimeoutPhase } from "./agent-run-terminal-outcome-9kJP3Yn1.js";
...
import { C as retainEmbeddedAgentRunAbortabilityForRunId, i as clearEmbeddedAgentRunAbortabilityForRunId, l as isEmbeddedAgentRunAbortableForRunId } from "./runs-Bw__iUSb.js";
import "./sessions-CBo4LOdS.js";
import { c as resolveTerminalMainSessionTranscriptRegistryCheck, i as hasTerminalMainSessionTranscriptNewerThanRegistrySync, o as resolveSessionLifecycleTimestamps, s as resolveSessionWorkStartError } from "./lifecycle-CeMojaXs.js";
...
import { _ as findSwarmCollectorSession, g as findAuthorizedSwarmCollectorRequest } from "./subagent-registry.store.sqlite-gBhFvyR2.js";
...
import { a as releaseMainSessionRecoveryOwner, n as commitMainSessionRecovery } from "./main-session-recovery-store-Dmn-Y9cG.js";
...
import { s as resolveTrustedGroupId } from "./agent-tools.policy-Bw6_eMDn.js";
import { a as resolveExactSubagentCompletionEvent } from "./requester-tool-policy-DlFpMABa.js";
import { r as hasGeneratedMediaCompletionEvent } from "./subagent-requester-store-key-B70nPXG0.js";
import { r as validateStructuredOutputSchema } from "./openclaw-tools-DDu2b20y.js";
import { l as consumeSubagentCompletionToolHandoff } from "./server-plugins-D28cwNc7.js";
...
import { n as shouldDowngradeDeliveryToSessionOnly } from "./best-effort-delivery-ChT5zC80.js";
...
import { a as setChannelSourceTurnSameThreadRequired, i as setChannelSourceTurnId } from "./source-turn-id-DBX5_no8.js";
...
import { f as updateChatRunProvider, l as resolveAgentRunExpiresAtMs, s as registerChatAbortController } from "./chat-abort-S5cQPsk-.js";
import { a as emitGatewaySessionEndPluginHook, c as performGatewaySessionReset, o as emitGatewaySessionStartPluginHook } from "./session-reset-service-BY3TcxCJ.js";
import { n as agentCommandFromGatewayIngress } from "./agent-command-BoD6qpqv.js";
...
import { n as waitForAgentJob, t as setGatewayDedupeEntry } from "./agent-job-CpqqlG4n.js";
...
import { a as parseMessageWithAttachments, i as logAttachmentFailure, n as MediaOffloadError, t as normalizeRpcAttachmentsToChatAttachments } from "./attachment-normalize-BEmmmy0G.js";
import { _ as gatewayClientSenderFields, i as authorizeResolvedSessionMutation } from "./session-sharing-C3cQJ56a.js";
...
import { r as resolveVoiceWakeRouteByTrigger, t as loadVoiceWakeRoutingConfig } from "./voicewake-routing-DBFKUAyU.js";
import { t as reactivateCompletedSubagentSession } from "./session-subagent-reactivation-gQNskV_h.js";
...
async function registerPluginSubagentRunFromGateway(params) {
	...
	const { registerSubagentRun } = await import("./subagent-registry-_565RV8I.js");
	registerSubagentRun({
		runId: params.runId,
		childSessionKey,
