...
import { a as normalizeChannelId$1, t as getChannelPlugin } from "./registry-DOSZ6AfI.js";
import "./plugins-DYLnGbXq.js";
import "./message-channel-Bo27VP7K.js";
import "./logging-Bw0qwOSE.js";
import { r as createMessageActionDiscoveryContext, u as resolveMessageActionDiscoveryForPlugin } from "./message-action-discovery-BLGLSVzQ.js";
...
import { s as getChannelsCommandSecretTargetIds } from "./command-secret-targets-B23ZqGNS.js";
import { t as listManifestChannelContributionIds } from "./manifest-contribution-ids-BKyksM-U.js";
...
import { t as resolveInstallableChannelPlugin } from "./channel-plugin-resolution-DYLKlzpS.js";
import { n as resolveLogFile } from "./log-tail-BoyZWrYh.js";
import { t as parseLogLine } from "./parse-log-line-BfhcnUPK.js";
import { t as requireValidConfigFileSnapshot } from "./config-validation-CVZ-qE0d.js";
import { i as prepareChannelAccountRemoval, n as channelLabel, r as applyPreparedChannelAccountRemoval, t as channelsAddCommand } from "./add-DsufXQWc.js";
import { c as shouldUseWizard, o as formatChannelAccountLabel, s as requireValidConfig } from "./shared-D4VTmqS4.js";
import { t as channelsListCommand } from "./list-B_QiH1Am.js";
import { t as channelsStatusCommand } from "./status-CiCHBS1M.js";
...
async function channelsRemoveCommand(opts, runtime = defaultRuntime, params) {
	...
	const resolvedPluginState = Boolean(lookupChannel || channel) ? await (async () => {
		const { resolveInstallableChannelPlugin } = await import("./channel-plugin-resolution-ByML8VUb.js");
