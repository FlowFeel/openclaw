...
import { u as withConsoleSubsystemsSuppressed } from "./console-DRDfhKk-.js";
import { i as closeOpenClawStateDatabaseByPath } from "./openclaw-state-db-D9eH245j.js";
...
import { g as resolveOfficialExternalPluginLabel, h as resolveOfficialExternalPluginInstall, i as getOfficialExternalPluginCatalogManifest, m as resolveOfficialExternalPluginId, u as listOfficialExternalPluginCatalogEntries } from "./official-external-plugin-catalog-CWuAzOfx.js";
import { i as listAvailableManifestContractPlugins, o as loadManifestContractSnapshot } from "./manifest-contract-eligibility-BxCz9N8R.js";
import { s as withFileLock } from "./file-lock-CndaTTeS.js";
import "./file-lock-DTTGVw6O.js";
import { Q as registerOpenClawAgentDatabase, h as openOpenClawAgentDatabase, l as disposeOpenClawAgentDatabaseByPath } from "./openclaw-agent-db-DemdumbZ.js";
import { n as clearRuntimeAuthProfileStoreSnapshot } from "./store-BWT5kQzj.js";
import { r as resolveOnboardingAgentTarget, t as applyOnboardingPrimaryModel } from "./onboard-agent-target-enCiwOCS.js";
...
import { t as ensureOnboardingPluginInstalled } from "./onboarding-plugin-install-HAxSvLW0.js";
import crypto from "node:crypto";
import { createReadStream } from "node:fs";
import path from "node:path";
import fs$1 from "node:fs/promises";
//#region src/wizard/setup.model-auth.ts
const loadAuthChoiceModule = createLazyRuntimeModule(() => import("./auth-choice-CHhV6Vcc.js"));
const loadModelPickerModule = createLazyRuntimeModule(() => import("./model-picker-OljaP_kJ.js"));
async function resolveAuthChoiceModelSelectionPolicy(params) {
	...
	const [{ resolveManifestProviderAuthChoice }, { resolvePluginSetupProvider }] = await Promise.all([import("./provider-auth-choices-f_Oyci0_.js"), import("./setup-registry-BNigDWxW.js")]);
...
async function runSetupModelAuthStep(params) {
	...
	if (authChoiceFromPrompt) {
		const [{ ensureAuthProfileStore }, { promptAuthChoiceGrouped: promptAuthChoice, isKeepCurrentAuthChoice: isKeepCurrentChoice }, { detectAvailableSetupProviderIds }] = await Promise.all([
			...
			import("./auth-choice-prompt-DoYCsmE4.js"),
			import("./provider-setup-availability-CB8YjaTQ.js")
		]);
	...
	while (true) {
		...
		if (authChoice === "custom-api-key") {
			const { promptCustomApiConfig } = await import("./onboard-custom-C0UOdvJI.js");
...
async function createPromotionConfigRuntime(config) {
	const { mutateConfigFile } = await import("./mutate-D3-ZJ8so.js");
...
const loadMigrationProviderRuntimeModule = createLazyRuntimeModule(() => import("./migration-provider-runtime-CCRwGUHP.js"));
const loadMigrationContextModule = createLazyRuntimeModule(() => import("./context-JpZEcYr3.js"));
...
async function runSetupMigrationImport(params) {
	const [{ applyLocalSetupWorkspaceConfig, applySkipBootstrapConfig }, { createMigrationLogger, buildMigrationReportDir }, { assertApplySucceeded, assertConflictFreePlan, formatMigrationPreview, formatMigrationResult }, { resolveStateDir }, onboardHelpers] = await Promise.all([
		...
		loadConfigPathsModule(),
		import("./onboard-helpers-CKVn1bCG.js")
	]);
