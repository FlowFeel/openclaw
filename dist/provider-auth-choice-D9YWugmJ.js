...
import { r as formatLiteralProviderPrefixedModelRef } from "./model-ref-shared-BCBRWGJh.js";
...
import { n as resolveManifestProviderAuthChoice } from "./provider-auth-choices-t9Huvqjl.js";
import { n as openUrl } from "./browser-open-B0NttymQ.js";
import { t as isRemoteEnvironment } from "./remote-env-CiPs8v4d.js";
import { n as t } from "./i18n-BYpJa9f7.js";
import { n as applyProviderAuthConfigPatch, t as applyDefaultModel } from "./provider-auth-choice-helpers-CXrCbTnC.js";
import { t as applyAuthProfileConfig } from "./provider-auth-helpers-Cy_Bi6JW.js";
import { r as resolveProviderInstallCatalogEntry } from "./provider-install-catalog-BNM2sDYU.js";
...
async function applyDefaultModelFromAuthChoice(params) {
	...
	if (!preservesDifferentPrimary) {
		const { CODEX_RUNTIME_PLUGIN_ID, ensureCodexRuntimePluginForModelSelection } = await import("./codex-runtime-plugin-install-CPdSqNVS.js");
		...
		const { ensureCopilotRuntimePluginForModelSelection } = await import("./copilot-runtime-plugin-install-vMqHoEHa.js");
