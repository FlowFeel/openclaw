...
import { i as markdownToIRWithMeta } from "./construct-fallbacks-BR_o1n_g.js";
...
import { f as messageAction, g as uriAction, h as postbackAction, o as createReceiptCard, p as normalizeLineAction } from "./flex-templates-zbWz2xlR.js";
...
function processLineMessage(text) {
	...
	const segments = [];
	return {
		text: projectPlainText(ir, codeSpans, plainTextInsertions, hasOversizedTable ? (segment) => segments.push(segment) : void 0),
		flexMessages,
...
//#endregion
export { buildTemplateMessageFromPayload as a, createConfirmTemplate as c, processLineMessage as i, createTemplateCarousel as l, convertTableToFlexBubble as n, createButtonTemplate as o, hasMarkdownToConvert as r, createCarouselColumn as s, convertCodeBlockToFlexBubble as t, toFlexMessage as u };
