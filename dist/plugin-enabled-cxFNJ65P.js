import { t as collectErrorGraphCandidates } from "./errors-Cg_yT1Sv.js";
import { c as registerUnhandledRejectionHandler } from "./unhandled-rejections-CyRemXOR.js";
...
import { T as BrowserProfileUnavailableError } from "./tmp-openclaw-dir-BK3eq-mf.js";
import "./config-CCqm3Ogf.js";
import { d as markBrowserRuntimeStopping, r as beginProfileTransition, s as isBrowserRuntimeRunning } from "./server-context.lifecycle-DGUJZrvY.js";
import { a as getExtensionRelayModule, t as createBrowserRouteContext } from "./server-context-CirUoj7g.js";
import { n as sweepTrackedBrowserTabs } from "./session-tab-registry-CPen4hh5.js";
...
async function stopBrowserRuntimeInternal(params, finalizeGlobalAdapters) {
	...
	if (finalizeGlobalAdapters) try {
		const { disposeGatewayExtensionRelay } = await import("./gateway-relay-route-DQiCiVkq.js");
