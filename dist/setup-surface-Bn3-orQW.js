...
import { _ as saveDelegatedTokens, g as resolveMSTeamsCredentials, m as hasConfiguredMSTeamsCredentials } from "./graph-users-Cf_3LBlF.js";
import { d as resolveMSTeamsChannelAllowlist, p as resolveMSTeamsUserAllowlist, s as parseMSTeamsTeamEntry } from "./resolve-allowlist-D6dIOba1.js";
import { r as formatUnknownError } from "./errors-DLYGrAA2.js";
	...
	finalize: async (params) => {
		...
		if (finalCreds?.type === "secret") {
			if (await params.prompter.confirm({
				...
				let oauthModule;
				try {
					oauthModule = await import("./oauth-Dm8JGnmn.js");
				} catch (err) {
