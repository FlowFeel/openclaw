...
import { T as MarkdownConfigSchema, b as GroupPolicySchema } from "./zod-schema.agent-runtime-CaWcMFul.js";
...
import { t as applyAccountNameToChannelSection } from "./setup-helpers-t3GC4Z1N.js";
import { k as runSingleChannelSecretStep, x as patchTopLevelChannelConfigSection } from "./setup-wizard-helpers-C8pTV3Ti.js";
...
import { d as parseBuzzTarget, i as resolveBuzzPublicKey, o as BUZZ_CHANNEL_ID_PATTERN, r as resolveBuzzAccount, t as decodeBuzzPrivateKey } from "./types-CJFyWMAi.js";
import { i as generateSecretKey, o as nip19_exports } from "./esm-B8-t-Wx3.js";
import { a as parseBuzzRoomMembershipEvent, c as parseBuzzAuthTag, l as openBuzzRelaySubscription, s as connectAuthenticatedBuzzRelaySession, t as BUZZ_ROOM_MEMBERSHIP_KIND } from "./room-membership-CB6Y7gtF.js";
...
const buzzSetupContract = defineChannelSetupContract({
	...
	adapter: {
		...
		validateInput: ({ accountId, input }) => {
			...
			if (input.useEnv) return process.env.BUZZ_PRIVATE_KEY?.trim() ? null : "BUZZ_PRIVATE_KEY is not set.";
			if (!input.privateKey?.trim()) return "Buzz requires --private-key or --use-env.";
			try {
