...
import { t as runSessionStartupMigration } from "./startup-migration-Bz-S-g-P.js";
...
async function runStartupSessionSqliteImport(params) {
	...
	const runDoctorSessionSqlite = params.deps?.runDoctorSessionSqlite ?? (await import("./doctor-session-sqlite-BdESs3sy.js")).runDoctorSessionSqlite;
	let report;
	try {
...
async function restoreFailedStartupSessionSqliteRun(params, report, blockingIssues) {
	...
	if (!restoreSessionSqliteMigrationRun || !writeSessionSqliteMigrationFailureReports) {
		const doctorModule = await import("./doctor-session-sqlite-BdESs3sy.js");
