...
import { c as kindFromMime, r as extensionForMime, u as normalizeMimeType } from "./mime-Ir6g3Vae.js";
import { n as probePlaybackMediaFileDescriptor, o as runFfmpeg } from "./media-probe-Cb2WIEbY.js";
import { n as PLAYBACK_TRANSCODE_SUBDIR, p as writePlaybackTranscodeCache, s as getMediaDir } from "./store-BDR50q7S.js";
...
async function resolvePlaybackTranscode(params) {
	...
	if (failedAtMs !== void 0) {
		if (Date.now() - failedAtMs < PLAYBACK_TRANSCODE_FAILURE_COOLDOWN_MS) return { kind: "fallback" };
