...
async function runGatewayCommandOnce(opts, hooks = {}) {
	...
	const serverImportMeasurement = startupTrace.startMeasure("cli.server-import", () => import("./server-C4JUjFkD.js"));
...
async function runGatewayCommand(opts, hooks = {}, recoveryDeps) {
	try {
		...
		const { offerInvalidConfigRecovery } = await import("./invalid-config-recovery-Rx5aOWAM.js");
