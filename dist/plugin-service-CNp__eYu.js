...
import { t as startLazyPluginServiceModule } from "./plugin-runtime-DauSL6BM.js";
...
import { t as describeImageFile } from "./runtime-BrbklANZ.js";
...
import { a as resolveProfile, l as resolveExistingUploadPaths, r as resolveBrowserConfig } from "./config-BcGUGkwH.js";
import { Y as withTimeout } from "./tmp-openclaw-dir-BSVbmTRJ.js";
import "./errors-B7paGh5n.js";
import { N as parseBrowserNavigationUrl } from "./chrome-BN-TgRYG.js";
import { t as getBrowserProfileCapabilities } from "./profile-capabilities-DqO0AgW7.js";
import "./sdk-setup-tools-BCrVVAXE.js";
import { C as fetchBrowserJson, S as BrowserServiceError, _ as browserStatus, a as untrackSessionBrowserTab, d as browserImportProfile, f as browserOpenTab, g as browserStart, h as browserSnapshot, i as trackSessionBrowserTab, l as browserDoctor, o as browserCloseTab, p as browserProfiles, r as touchSessionBrowserTab, u as browserFocusTab, v as browserStop, x as browserTabs, y as browserSystemProfiles } from "./session-tab-registry-cVJiMCwS.js";
import { _ as isBrowserProxyUploadRequest, a as persistBrowserProxyFiles, b as parseBrowserProxyFailure, c as browserPdfSave, d as browserArmFileChooser, f as browserDownload, h as browserWaitForDownload, i as applyBrowserProxyPaths, l as browserAct, m as browserScreenshotAction, o as browserConsoleMessages, p as browserNavigate, s as browserPageContent, u as browserArmDialog, v as prepareBrowserProxyUploadRequest, y as BROWSER_PROXY_ERROR_ENVELOPE } from "./core-api-BzuK8fNT.js";
import { o as normalizeBrowserScreenshot, r as parseSystemProfileDomains } from "./routes-CLkH_IQa.js";
import { a as describeBrowserScreenshot, c as stageBrowserScreenshotForSharing, n as executeExtractAction, o as neutralizeMediaDirectives, s as resolveRuntimeImageSanitization } from "./browser-extract-CcfGn__7.js";
import { n as createBrowserControlContext } from "./plugin-enabled-CFmH0OGz.js";
import { a as resolveRequestedBrowserProfile, n as isBrowserHostLocalRoute, r as isPersistentBrowserProfileMutation, t as createBrowserRouteDispatcher } from "./dispatcher-BOz9-Z4P.js";
...
function createBrowserPluginService() {
	...
	return {
		id: "browser-control",
		start: async () => {
			const pageShare = await import("./page-share-BJTSkmS_.js");
			...
			handle = await startLazyPluginServiceModule({
				...
				loadDefaultModule: async () => await import("./server-DgFkz9W8.js"),
		...
		stop: async () => {
			const { setPageShareSink } = await import("./page-share-BJTSkmS_.js");
			...
			const { stopBrowserControlService } = await import("./control-service-eGTPFY77.js");
