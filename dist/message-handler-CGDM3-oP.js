...
import { A as parseDiagnosticTraceparent, S as createDiagnosticTraceContext, c as emitTrustedSecurityEvent, j as runWithDiagnosticTraceContext, x as createChildDiagnosticTraceContext } from "./diagnostic-events-Dt41CZkD.js";
import { c as getActivePluginGatewayNodePolicyRegistry } from "./runtime-WkCmQTS9.js";
import { o as sha256HexPrefix } from "./crypto-digest-CmUwt1S-.js";
import { i as runUtf8CommandWithTimeout } from "./exec-SGTX01mL.js";
import { a as isLoopbackAddress, i as isLocalishHost, m as resolveClientIp, n as hasForwardedRequestHeaders, r as isLocalDirectRequest, s as isPrivateOrLoopbackAddress, u as isTrustedProxyAddress } from "./net-B22ilI8B.js";
import { a as AUTH_RATE_LIMIT_SCOPE_NODE_PAIRING } from "./auth-rate-limit-D67GPKfj.js";
import { n as normalizeChromeExtensionOrigin, t as checkBrowserOrigin } from "./origin-check-1UpqVOpx.js";
import { a as withSerializedRateLimitAttempt } from "./auth-B6R6zmCG.js";
import { a as hasGatewayClientCap, n as GATEWAY_CLIENT_IDS, r as GATEWAY_CLIENT_MODES, t as GATEWAY_CLIENT_CAPS } from "./client-info-Dlrmm4mP.js";
import "./version-CwNT1gaY.js";
import { a as normalizeDevicePublicKeyBase64Url, t as deriveDeviceIdFromPublicKey } from "./device-identity-BOrXxcUy.js";
...
import { a as getGatewaySuspendAdmissionPhase, g as tryBeginGatewayRootWorkAdmission, m as runWithGatewayIndependentRootWorkAdmission, o as isGatewayRestartDraining } from "./gateway-work-admission-BaRJo64l.js";
import { c as isOperatorUiClient, i as isGatewayCliClient, l as isWebchatClient, n as isBrowserOperatorUiClient, r as isEphemeralGatewayClient, t as isBrowserCopilotClient } from "./message-channel-Bo27VP7K.js";
import { $p as GATEWAY_SERVER_CAPS, et as validateConnectParams, kn as validateRequestFrame } from "./src-BSn6va4B.js";
import { a as errorShape, s as formatValidationErrors } from "./error-codes-P4fBo0lR.js";
import { n as ensureProfileForEmail, s as listProfiles } from "./user-profiles-DoQoc9os.js";
import { t as formatUserProfileAvatarPath } from "./user-profiles-http-path-CvR7l2ks.js";
import { n as verifyAgentRuntimeIdentityToken } from "./agent-runtime-identity-token-BpMUmeEC.js";
import { n as isOperatorApprovalRuntimeToken } from "./operator-approval-runtime-token-CyRsxJlt.js";
import { i as TALK_PTT_COMMANDS, n as IOS_WATCH_RELAY_COMMANDS, r as PLATFORM_DEFAULTS, t as DEFAULT_DANGEROUS_NODE_COMMANDS } from "./node-command-policy-BdDcKUU6.js";
...
import { C as isVoiceNodePairingSetupBootstrapProfile, E as resolveBootstrapProfileScopesForRoles, T as resolveBootstrapProfileScopesForRole, a as redeemDeviceBootstrapTokenProfile, h as BOOTSTRAP_HANDOFF_OPERATOR_SCOPES, l as verifyDeviceBootstrapToken, n as getBoundDeviceBootstrapProfile, o as restoreDeviceBootstrapToken, r as getDeviceBootstrapTokenProfile, s as revokeDeviceBootstrapToken, x as isMobilePairingSetupBootstrapProfile } from "./device-bootstrap-DYEV7gvD.js";
import { D as verifyDeviceToken, T as updatePairedDeviceMetadata, a as ensureDeviceToken, d as listDevicePairing, f as listEffectivePairedDeviceRoles, l as hasEffectivePairedDeviceRole, m as pruneSupersededSilentPairedDevices, r as approveDevicePairing, s as getPairedDevice, t as approveBootstrapDevicePairing, u as listApprovedPairedDeviceRoles, v as requestDevicePairing, y as resolveEffectiveOperatorDeviceIdentity } from "./device-pairing-D3ZJFObN.js";
import { d as requestNodePairing, l as releaseNodePairingCleanupClaim, n as beginNodePairingConnect, r as finalizeNodePairingCleanupClaim, s as recordPairedNodeConnection, t as approveNodePairing } from "./node-pairing-CthjYRqK.js";
import { i as recordRemoteNodeInfo, o as refreshRemoteNodeBins } from "./remote-DeCYAn2P.js";
import { n as logRejectedLargePayload } from "./diagnostic-payload-Cvs6bzBU.js";
import { n as serializeEventPayload } from "./node-registry-BLwZIK15.js";
...
import { n as logWs, t as formatForLog } from "./ws-log-B9tqgW3b.js";
import { n as listControlUiPluginTabs, r as listControlUiPluginWidgetKinds } from "./control-ui-plugin-tabs-StWdCHma.js";
import { t as resolveSharedGatewaySessionGeneration } from "./ws-shared-generation-8sA0oUQm.js";
import { r as resolveChatAttachmentPolicy } from "./chat-attachment-policy-DrGl1Ors.js";
import { n as allowedSessionVisibilities } from "./session-sharing-BuGIPH6F.js";
import { t as loadVoiceWakeRoutingConfig } from "./voicewake-routing-D5Hy03MN.js";
import { n as loadVoiceWakeConfig } from "./server-utils-Cs46ZMHG.js";
import { a as incrementPresenceVersion, n as getHealthCache, r as getHealthVersion, t as buildGatewaySnapshot } from "./health-state-B7JO1VbQ.js";
import { n as parseGatewayRole, r as roleCanSkipDeviceIdentity } from "./role-policy-BFDpfdiZ.js";
import { n as clearRemovedNodeRuntimeState } from "./node-runtime-state-0dPtJ4Z8.js";
import { t as captureAuthenticatedNodePairingState } from "./node-pairing-state-DzJGcHd2.js";
import { t as resolveLocalNodeId } from "./local-id-BUMPSUDn.js";
import { n as buildHandshakeAuthLogKey, r as shouldLimitMissingCredentialAuthLog, t as HandshakeAuthLogLimiter } from "./handshake-auth-log-limiter-TNKbAdjh.js";
import { n as scheduleNodeConnectionNotification } from "./node-connection-notifications-BrOF2p7f.js";
import { t as truncateCloseReason } from "./close-reason-D2Hhty2p.js";
import { a as resolvePairingLocality, c as shouldPreserveLocalCliSharedAuthScopes, d as resolveConnectAuthState, i as resolveHandshakeBrowserSecurityContext, l as shouldSkipLocalBackendSelfPairing, n as isNativeAppUiClient, o as resolveUnauthorizedHandshakeContext, r as resolveDeviceSignaturePayloadVersion, s as shouldAllowSilentLocalPairing, t as reconcileNodePairingOnConnect, u as resolveConnectAuthDecision } from "./node-connect-reconcile-CfNb_G3K.js";
...
function createGatewayAuthenticatedRequestDispatcher(params) {
	...
	const dispatch = async (parsed, client) => {
		...
		const executeRequest = async () => {
			const nodeInvocationController = req.method === "node.invoke" && client.connect.client.id === GATEWAY_CLIENT_IDS.CLI && client.connect.client.mode === GATEWAY_CLIENT_MODES.CLI ? new AbortController() : void 0;
			const cancelNodeInvocation = () => nodeInvocationController?.abort();
			if (nodeInvocationController) client.socket.once("close", cancelNodeInvocation);
			try {
				...
				if (nodeInvocationController) client.socket.off("close", cancelNodeInvocation);
			}
		};
		const upstreamTrace = parseDiagnosticTraceparent(req.traceparent);
		const requestDispatch = upstreamTrace ? runWithDiagnosticTraceContext(createChildDiagnosticTraceContext(upstreamTrace), executeRequest) : executeRequest();
...
function formatGatewayAuthFailureMessage(params) {
	...
	const tokenHint = isCli ? "set gateway.remote.token to match gateway.auth.token" : isControlUi || isWebchat ? uiHint : "provide gateway auth token";
...
function isSetupCodeHandoffBootstrapClient(params) {
	return isMobilePairingSetupBootstrapProfile(params.profile) && isSetupCodeMobileBootstrapClient(params.client) || isVoiceNodePairingSetupBootstrapProfile(params.profile) && isSetupCodeVoiceNodeBootstrapClient(params.client);
}
...
function shouldAllowControlUiDeviceAuthMigration(params) {
	const sharedAuthOk = params.sharedAuthOk && (params.authMethod === "token" || params.authMethod === "password");
	const trustedProxyAuthOk = params.trustedProxyAuthOk === true && params.authMethod === "trusted-proxy";
	return params.policy.deviceAuthMigrationPending && params.policy.isControlUi && params.role === "operator" && (sharedAuthOk || trustedProxyAuthOk);
}
...
function shouldClearUnboundScopesForMissingDeviceIdentity(params) {
	return params.decision.kind !== "allow" || !params.preserveInsecureLocalControlUiScopes && (params.authMethod === "token" || params.authMethod === "password" || params.authMethod === "trusted-proxy");
}
...
async function authenticateGatewayConnect(context) {
	...
	const handleMissingDeviceIdentity = () => {
		...
		const allowDeviceLessControlUiMigration = !device && shouldAllowControlUiDeviceAuthMigration({
		...
		const decision = allowDeviceLessControlUiMigration ? { kind: "allow" } : evaluateMissingDeviceIdentity({
			hasDeviceIdentity: Boolean(device),
			role,
			isControlUi,
			controlUiAuthPolicy,
...
async function authorizeExistingGatewayDevice(params) {
	...
	if (retryBootstrapHandoffProfile) {
		...
		if (isSetupCodeHandoffBootstrapClient({
...
async function authorizeGatewayConnectDevice(context, state) {
	...
	const { role, isControlUi, isBrowserOperatorUi, isWebchat, isNativeAppUi, device, devicePublicKey, authMethod, authResult, hasRequestedScopes, bootstrapTokenCandidate, pairingLocality, skipLocalBackendSelfPairing, skipControlUiPairingForDevice, allowControlUiDeviceAuthMigration } = state;
	...
	const deviceAuthMigrationScopes = authMethod !== "trusted-proxy" || roleScopesAllow({
		role: "operator",
		requestedScopes: ["operator.pairing"],
		allowedScopes: scopes
	}) ? ["operator.pairing"] : [];
	if (allowControlUiDeviceAuthMigration) {
		const existingOperator = (await listDevicePairing()).paired.map(resolveEffectiveOperatorDeviceIdentity).find((candidate) => candidate && roleScopesAllow({
			role: "operator",
			requestedScopes: ["operator.pairing"],
		...
		if (existingOperator) {
			...
			if (!device) {
				const message = "control ui requires device identity (use HTTPS or localhost secure context)";
				setHandshakeState("failed");
				send({
					type: "res",
					id: frame.id,
					ok: false,
					error: errorShape(ErrorCodes.INVALID_REQUEST, message, { details: { code: ConnectErrorDetailCodes.CONTROL_UI_DEVICE_IDENTITY_REQUIRED } })
				});
				close(1008, truncateCloseReason(message));
				return;
			}
		} else allowControlUiDeviceAuthMigrationForUnpairedInstall = true;
	}
	if (!device && allowControlUiDeviceAuthMigrationForUnpairedInstall && deviceAuthMigrationScopes.length > 0) connectionAdmittedForControlUiDeviceAuthMigration = true;
	if (device && devicePublicKey) {
		...
		const requirePairing = async (reason, existingPairedDevice = null) => {
			...
			const bootstrapApprovalProfile = setupCodeHandoffBootstrapProfile ?? controlUiOperatorBootstrapProfile;
			const pairingRequestScopes = allowControlUiDeviceAuthMigrationForUnpairedInstall && deviceAuthMigrationScopes.length > 0 && reason === "not-paired" && !existingPairedDevice ? uniqueStrings([...scopes, ...deviceAuthMigrationScopes]) : scopes;
			const pairing = await requestDevicePairing({
				...
				silent: reason === "scope-upgrade" && !allowSetupCodeHandoffBootstrapPairing ? false : allowSilentLocalPairing || allowSilentTrustedCidrsNodePairing || allowSetupCodeHandoffBootstrapPairing || allowControlUiOperatorBootstrapPairing
			});
			...
			const inlineApprovalAttempted = !allowControlUiDeviceAuthMigrationForUnpairedInstall && (trustedProxyAutoApproveScopes !== null || pairing.request.silent === true);
			if (inlineApprovalAttempted) {
				...
				if (approved?.status === "approved") {
					...
					if (!(allowSetupCodeHandoffBootstrapPairing && boundBootstrapProfile)) try {
			...
			recoveryRequestId = await resolveLivePendingRequestId();
			const pairingResolved = inlineApprovalAttempted && (approved?.status === "approved" || resolvedByConcurrentApproval);
			if (allowControlUiDeviceAuthMigrationForUnpairedInstall && deviceAuthMigrationScopes.length > 0 && reason === "not-paired" && !existingPairedDevice && !pairingResolved && recoveryRequestId) {
	...
	if (connectionAdmittedForControlUiDeviceAuthMigration) scopes = deviceAuthMigrationScopes;
...
async function sendGatewayHello(context, state, pluginSurfaceUrls) {
	...
	const { resolvedAuth, role, scopes, device, hasTokenAuth, hasPasswordAuth, bootstrapTokenCandidate, authMethod, issuedBootstrapProfile, handoffBootstrapProfile, deviceToken, bootstrapDeviceTokens, controlUiDeviceAuthMigrationPending } = state;
	...
	const helloOk = {
		...
		...controlUiDeviceAuthMigrationPending ? { deviceAuthMigration: { pending: true } } : {},
		auth: {
			role,
		...
		policy: {
			...
			hasMultipleSessionSharingIdentities: listProfiles().filter((profile) => !profile.mergedInto).length >= 2
		}
	};
...
async function attachAuthenticatedGatewayConnect(context, state) {
	...
	const { minProtocol, maxProtocol, usesLegacyNodeProtocol, role, scopes, device, devicePublicKey, deviceToken, authResult, authMethod, pairingLocality, sessionUsesSharedGatewayAuth, sessionSharedGatewaySessionGeneration } = state;
	...
	const nextClient = {
		...
		isControlUiDeviceAuthMigration: state.controlUiDeviceAuthMigrationPending && Boolean(connectParams.device),
	...
	if (state.controlUiDeviceAuthMigrationPending && context.handler.isControlUiDeviceAuthMigrationPending?.() !== true) {
		const hasDeviceIdentity = Boolean(device);
		const message = "device auth migration completed during connect; reconnect";
		markHandshakeFailure("control-ui-device-auth-migration-completed", { device: hasDeviceIdentity ? "yes" : "no" });
		sendHandshakeErrorResponse(hasDeviceIdentity ? ErrorCodes.NOT_PAIRED : ErrorCodes.INVALID_REQUEST, message, { details: { code: hasDeviceIdentity ? ConnectErrorDetailCodes.PAIRING_REQUIRED : ConnectErrorDetailCodes.CONTROL_UI_DEVICE_IDENTITY_REQUIRED } });
		await releasePendingNodePairingCleanup();
		close(1008, truncateCloseReason(message));
		return;
	}
