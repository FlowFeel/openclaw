...
import { c as DEFAULT_UPLOAD_DIR, l as resolveExistingUploadPaths, r as resolveBrowserConfig } from "./config-BcGUGkwH.js";
import { Y as withTimeout, j as parseBrowserErrorPayload } from "./tmp-openclaw-dir-BSVbmTRJ.js";
import "./control-auth-dKa9J3g_.js";
import "./chrome.executables-B2udiA_j.js";
import "./trash-Bna8FICl.js";
import { o as loadBrowserConfigForRuntimeRefresh } from "./server-context-BtTjZdye.js";
import "./sdk-setup-tools-BCrVVAXE.js";
import { C as fetchBrowserJson, D as withBaseUrl, E as buildProfileQuery, T as setBridgeAuthForPort, w as deleteBridgeAuthForPort } from "./session-tab-registry-cVJiMCwS.js";
import "./routes-CLkH_IQa.js";
import { i as listenBrowserHttpServer, n as installBrowserAuthMiddleware, r as installBrowserCommonMiddleware, t as hasVerifiedBrowserAuth } from "./server-middleware-DfqthEBf.js";
import { c as stopBrowserBridgeRuntime, n as createBrowserControlContext } from "./plugin-enabled-CFmH0OGz.js";
import { a as resolveRequestedBrowserProfile, i as normalizeBrowserRequestPath, n as isBrowserHostLocalRoute, r as isPersistentBrowserProfileMutation, t as createBrowserRouteDispatcher } from "./dispatcher-BOz9-Z4P.js";
...
async function startBrowserBridgeServer(params) {
	...
	if (params.skipRouteRegistrationForTest) app.get("/", (_req, res) => {
		...
		const [{ createBrowserRouteContext }, { registerBrowserRoutes }] = await Promise.all([import("./server-context-BY2aqXnw.js"), import("./routes-CpMG2mwa.js")]);
