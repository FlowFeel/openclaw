...
import { u as isEmbeddedAgentRunActive } from "./runs-Du_qIW6W.js";
...
async function runSkillHistoryScanReview(params) {
	...
	try {
		...
		const { runEmbeddedAgent } = await import("./embedded-agent-Bv58Yqvq.js");
...
async function forwardSkillWorkshopRevisionToChatSend(opts, params) {
	const { chatHandlers } = await import("./chat-Dienltb-.js");
