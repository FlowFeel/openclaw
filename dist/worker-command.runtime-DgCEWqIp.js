...
async function runWorkerDescriptor(descriptor, options = {}) {
	...
	try {
		...
		const [{ runWorkerEmbeddedTurn }, { createWorkerInferenceStreamAdapter }] = await Promise.all([import("./embedded-agent.runtime-Ck57Ikv-.js"), import("./inference-stream.runtime.js")]);
