...
import { i as MINIMAX_OAUTH_MARKER } from "./model-auth-markers-z4js65k2.js";
...
import { r as buildOpenAICompatibleLiveModelProviderConfig } from "./provider-catalog-live-runtime-sjb7bAnk.js";
import { c as buildProviderStreamFamilyHooks } from "./provider-stream-B_5uewGA.js";
import "./provider-stream-family-CCM6KDXf.js";
import { h as fetchMinimaxUsage } from "./provider-usage-CvS4J5mE.js";
import { i as MINIMAX_TEXT_MODEL_ORDER, o as isMiniMaxModernModelId, r as MINIMAX_TEXT_MODEL_CATALOG, t as MINIMAX_DEFAULT_MODEL_ID } from "./provider-models-DXpszwbF.js";
import { f as resolveMinimaxApiCost, n as DEFAULT_MINIMAX_MAX_TOKENS } from "./model-definitions-D6La0IB4.js";
import { i as resolveMinimaxCatalogBaseUrl, n as buildMinimaxPortalProvider, r as buildMinimaxProvider, t as buildMinimaxModelDiscovery } from "./provider-catalog--V1owi8-.js";
import { n as applyMinimaxApiConfigCn, t as applyMinimaxApiConfig } from "./onboard-DXUcgaZ2.js";
import "./api-CmEH9YVU.js";
...
async function resolvePortalCatalog(ctx) {
	...
	const usesPortalBearerAuth = apiKeyAuth.apiKey === "MINIMAX_OAUTH_TOKEN" || profileAuth.mode === "token" && profileAuth.apiKey === apiKey || !apiKeyAuth.apiKey && !explicitApiKey && profileAuth.mode === "oauth";
	...
	return { provider: await buildOpenAICompatibleLiveModelProviderConfig({
		...
		providerConfig,
		apiKey,
		discoveryApiKey: apiKeyAuth.discoveryApiKey ?? (usesPortalBearerAuth ? profileAuth.discoveryApiKey : void 0),
