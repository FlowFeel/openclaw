...
import { n as WizardPrompter } from "./types.public-DXXzw640.js";
import { i as AuthProfileStore } from "./types-D67e2Gtu.js";
import { k as RuntimeEnv, o as PluginOrigin, s as OpenClawPackageBuild } from "./manifest-registry-Dd29F7Rx.js";
import { C as ProviderAuthResult, Dt as EmbeddedAgentRunResult, F as RunCliAgentParams, L as resolveCliBackendLiveSessionRequirement, b as RunEmbeddedAgentParams, t as ProviderPlugin, u as AgentHarnessAuthBindingFingerprintParams, x as AgentHarnessRuntimeArtifactBinding } from "./types-CRZpySL92.js";
import { n as InstalledPluginIndexRefreshReason } from "./installed-plugin-index-types-COVojO1x.js";
import { n as PluginMetadataRegistryView, r as PluginMetadataSnapshot } from "./plugin-metadata-snapshot.types-C2GH8pkR.js";
import { t as resolvePluginMetadataSnapshot } from "./plugin-metadata-snapshot-BW66cz37.js";
import { J as TransformConfigFileWithRetryParams, W as ConfigMutationResult, ut as readConfigFileSnapshot } from "./config-d6m_KxcO.js";
import { a as resolveApiKeyForProvider, o as ResolvedProviderAuth } from "./provider-model-types-BbGdZNB-.js";
import { a as ensureAuthProfileStore, l as OpenClawAgentDatabase, o as loadAuthProfileStoreForRuntime, s as updateAuthProfileStoreWithLock } from "./usage-DV3tLgoC.js";
import { d as PluginLoadOptions } from "./loader-zy29gxvC.js";
 ...
 */
declare function listManualSetupInferenceOptions(deps?: DetectSetupInferenceDeps): Promise<Pick<SetupInferenceDetection, "manualProviders" | "authOptions" | "prepareOptions" | "workspace" | "setupComplete">>;
