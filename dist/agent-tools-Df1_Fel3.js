...
import { a as resolveGatewayMessageChannel } from "./message-channel-normalize-Cs-kjMZm.js";
import "./message-channel-Bo27VP7K.js";
import { H as listChannelAgentTools, l as rewrapToolWithBeforeToolCallHook, u as wrapToolWithBeforeToolCallHook } from "./agent-tools.before-tool-call-uaLOAHZ3.js";
import { B as hasOnlyCrlfLineEndings, H as restoreLineEndings, L as withFileMutationQueue, R as withFileMutationQueues, T as createReadTool, V as normalizeToLF, v as createCodingTools, z as decodeUtf8File } from "./sessions-CxWGGmnA.js";
import { t as ToolAuthorizationError } from "./common-yW0U9cHP.js";
import { r as resolveImageSanitizationLimits } from "./image-sanitization-CxLP0YN-.js";
import { g as SANDBOX_AGENT_WORKSPACE_MOUNT } from "./constants-BdVrBvbE.js";
import { s as isCompletionReportInputProvenance } from "./input-provenance-CYGbY89H.js";
import { i as getPluginToolMeta, s as appendRuntimePluginToolGrant } from "./tools-sUgO7zqy.js";
...
import { b as isToolWrappedWithBeforeToolCallHook, c as wrapToolWithGatewayCallerIdentity, l as copyAgentToolMetadata } from "./gateway-B5H4NIb8.js";
import { S as TOOL_SEARCH_CODE_MODE_TOOL_NAME, b as TOOL_CALL_RAW_TOOL_NAME, r as createToolSearchTools, s as resolveToolSearchConfig, w as TOOL_SEARCH_RAW_TOOL_NAME, x as TOOL_DESCRIBE_RAW_TOOL_NAME } from "./tool-search-BhU6HOAE.js";
...
import { C as wrapToolWorkspaceRootGuard, E as withMemoryWriteProvenance, S as wrapToolMemoryFlushAppendOnlyWrite, T as createMemoryWriteProvenanceObserver, _ as createOpenClawReadTool, b as createSandboxedWriteTool, g as createHostWorkspaceWriteTool, h as createHostWorkspaceEditTool, m as resolveOpenClawPluginToolsForOptions, p as filterToolsByClientCaps, t as createOpenClawTools, v as createSandboxedEditTool, w as wrapToolWorkspaceRootGuardWithOptions, x as wrapReadToolWithSkillContent, y as createSandboxedReadTool } from "./openclaw-tools-B_OHwLQN.js";
import { n as resolveEventSessionRoutingPolicy } from "./event-session-routing-BY6OxTFh.js";
...
import { s as shouldSuppressManagedWebSearchTool } from "./codex-native-web-search-core-Cb_ckxKl.js";
import "./codex-native-web-search-CVwDWqsG.js";
...
import { c as resolveReadOnlyWorkspaceSkillMounts } from "./workspace-mounts-DEtZw7ZS.js";
...
const bashToolsModuleLoader$1 = createLazyImportLoader(() => import("./bash-tools-BLZOyCBG.js"));
...
const bashToolsModuleLoader = createLazyImportLoader(() => import("./bash-tools-BLZOyCBG.js"));
