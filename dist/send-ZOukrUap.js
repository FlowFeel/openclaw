...
import { d as stripTargetKindPrefix, u as stripChannelTargetPrefix } from "./core-Djf8nMCZ.js";
import "./channel-outbound-COSGJaQ7.js";
import "./text-utility-runtime-D52Cj1WO.js";
import { a as resolveZaloToken, i as resolveZaloAccount } from "./accounts-C0Nu5BC5.js";
import { c as sendPhoto, s as sendMessage } from "./api-Cab6ipRQ.js";
...
async function sendMessageZalo(chatId, text, options = {}) {
	...
	if (options.mediaUrl && (options.mediaUrl.trim() || !text)) return sendPhotoZalo(context.chatId, options.mediaUrl, {
		...options,
		token: context.token,
