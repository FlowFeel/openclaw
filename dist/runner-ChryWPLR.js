...
import { c as buildMediaUnderstandingRegistry, l as getMediaUnderstandingProvider } from "./defaults.constants-CM5ca1gG.js";
import { i as matchesMediaEntryCapability } from "./runtime-media-secret-owner-C-EJ4rYa.js";
import { a as resolveModelEntries, s as resolveScopeDecision } from "./resolve-19I0nqBl.js";
import { n as resolveOpenAiAudioAuthModelApi } from "./openai-audio-api-BEkNYRPi.js";
import { a as runCliEntry, d as isMediaUnderstandingSkipError, l as MediaAttachmentCache, o as runProviderEntry, r as formatDecisionSummary, t as buildModelDecision, u as selectAttachments } from "./runner.entries-DZ_bZlhz.js";
...
const loadHasAvailableAuthForProvider = createLazyRuntimeNamedExport(() => import("./model-auth-CK2I_VyC.js"), "hasAvailableAuthForProvider");
const loadPreparedModelCatalogApi = createLazyRuntimeModule(async () => ({
	...await import("./model-catalog-U0thN6yI.js"),
	...await import("./prepared-model-catalog-BddDieHg.js")
}));
...
async function resolveAutoImageModelId(params) {
	...
	const { resolveDefaultMediaModel } = await import("./defaults-ucax1TUm.js");
