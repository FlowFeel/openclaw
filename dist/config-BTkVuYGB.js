...
import { o as isPrivateNetworkOptInEnabled, u as ssrfPolicyFromDangerouslyAllowPrivateNetwork } from "./ssrf-policy-BhrO0_v9.js";
import "./ssrf-runtime-BKWYxujx.js";
import "./secret-input-runtime-c5a4e1R9.js";
import { a as resolveMatrixDefaultOrOnlyAccountId, n as requiresExplicitMatrixDefaultAccount, o as resolveMatrixAccountStringValues } from "./account-selection-GIBMiG30.js";
import { t as getMatrixScopedEnvVarNames } from "./env-vars-W8rRlmHr.js";
import { o as resolveMatrixBaseConfig, r as listNormalizedMatrixAccountIds, t as findMatrixAccountConfig } from "./account-config-OygLNK0j.js";
...
import { s as repairCurrentTokenStorageMetaDeviceId } from "./storage-xmjHT5f5.js";
//#region extensions/matrix/src/matrix/client/config.ts
const loadMatrixAuthClientDeps = createLazyRuntimeModule(() => Promise.all([import("./sdk-C8e6WNi2.js"), import("./logging-35b6mrN5.js")]).then(([sdkModule, loggingModule]) => ({
...
const loadMatrixCredentialsReadDeps = createLazyRuntimeModule(() => import("./credentials-read-CvMTJn_z.js"));
