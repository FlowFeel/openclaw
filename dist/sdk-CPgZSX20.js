...
import { t as SqliteBackedMatrixSyncStore } from "./file-sync-store-BzmdvLZ_.js";
import { n as LogService, r as noop, t as ConsoleLogger } from "./logger-DZvsm4Ma.js";
import { t as MATRIX_IDB_PERSIST_INTERVAL_MS } from "./idb-persistence-lock-DAJ49nZX.js";
import { n as isMatrixNotFoundError, t as formatMatrixErrorReason } from "./errors-C4OJJ2dh.js";
import { i as throwIfMatrixStartupAborted, n as createMatrixStartupAbortError } from "./startup-abort-BYdCNXCk.js";
import { a as matrixEventToRaw, n as createMatrixGuardedFetch, o as parseMxc, t as MatrixAuthedHttpClient } from "./http-client-DXrv_kPs.js";
import { n as resolveMatrixRoomKeyBackupReadinessError } from "./backup-health-Dm_YMVFT.js";
import { t as createMatrixJsSdkClientLogger } from "./logging-BZhOLWUT.js";
import { a as isMatrixAccessTokenInvalidatedError, c as resolveMatrixLocalTimeoutMs, f as isMatrixReadySyncState, i as createMatrixExplicitBootstrapOptions, l as unresolvedMatrixDeviceVerificationStatus, n as MATRIX_INITIAL_CRYPTO_BOOTSTRAP_OPTIONS, o as resolveMatrixDiagnostic, p as isMatrixTerminalSyncState, r as MATRIX_STATUS_DIAGNOSTIC_TIMEOUT_MS, s as resolveMatrixDiagnosticResult, t as MATRIX_AUTOMATIC_REPAIR_BOOTSTRAP_OPTIONS, u as unresolvedMatrixRoomKeyBackupStatus } from "./client-support-Dyvq4T4B.js";
import { n as isRepairableSecretStorageAccessError, t as MatrixRecoveryKeyStore } from "./recovery-key-store-DGO9xRNR.js";
...
const loadMatrixCryptoRuntime = createLazyRuntimeModule(() => import("./crypto-runtime-mzdp3G45.js").then((runtime) => {
