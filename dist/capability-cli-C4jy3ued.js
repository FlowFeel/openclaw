...
import { b as updateAuthProfileStoreWithLock, d as loadAuthProfileStoreForRuntime } from "./store-BMd0T0_g.js";
...
import { n as canonicalizeCaseOnlyCatalogModelRef } from "./model-selection-4mvNeCA1.js";
...
import { t as buildExplicitSessionIdSessionKey } from "./session-D61kRXnU.js";
...
import { c as buildMediaUnderstandingRegistry } from "./defaults.constants-CM5ca1gG.js";
import { h as getTtsCommandSecretTargetIds, i as getCapabilityWebFetchCommandSecretTargets, l as getMemoryEmbeddingCommandSecretTargetIds, o as getCapabilityWebSearchCommandSecretTargets, u as getModelsCommandSecretTargetIds } from "./command-secret-targets-IDxJd0Jh.js";
import { n as normalizeSpeechProviderId } from "./provider-registry-core-tbOIZwiJ.js";
import { o as listSpeechProviders, r as canonicalizeSpeechProviderId } from "./directives-DDKnCSyc.js";
...
import { _ as setTtsProvider, g as setTtsPersona, l as listSpeechVoices, m as setTtsEnabled, s as resolveExplicitTtsOverrides, t as getTtsProvider } from "./runtime-api-CViYHuub.js";
...
import { i as listWebSearchProviders, n as isWebSearchProviderConfigured, o as runWebSearch } from "./runtime-CLK7mhcF.js";
import { c as resolveMemorySearchConfig } from "./config-utils-bVWMjALM.js";
import { n as listEmbeddingProviders } from "./embedding-provider-runtime-DQXuj6xT.js";
import { a as listMemoryEmbeddingProviders } from "./memory-embedding-provider-runtime-zFJ3Eme9.js";
...
import { i as resolveWebFetchDefinition, n as isWebFetchProviderConfigured, r as listWebFetchProviders } from "./runtime-Cx2yDtiS.js";
...
import { c as transcribeAudioFile, i as describeVideoFile, o as prepareImageDescriptionInput, r as describePreparedImageWithModel, t as describeImageFile } from "./runtime-BkT6t24f.js";
...
async function runModelAuthStatus() {
	const captured = [];
	const { modelsStatusCommand } = await import("./list.status-command-KAA4jikc.js");
...
function registerModelCapabilityCommands(capability) {
	...
	modelAuth.command("login").description("Run provider auth login").requiredOption("--provider <id>", "Provider id").option("--method <id>", "Provider auth method id").action(async (opts) => {
		await runCommandWithRuntime(defaultRuntime, async () => {
			const { modelsAuthLoginCommand } = await import("./auth-BuXdH39D.js");
