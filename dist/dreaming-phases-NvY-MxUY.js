...
import { D as resolveMemoryRemDreamingConfig, E as resolveMemoryLightDreamingConfig, T as resolveMemoryDreamingWorkspaces, y as formatMemoryDreamingDay } from "./dreaming-CisvAHct.js";
...
import { S as writeMemoryCoreWorkspaceEntries, b as readMemoryCoreWorkspaceEntries, n as DREAMING_DAILY_PROVENANCE_NAMESPACE, t as DREAMING_DAILY_INGESTION_NAMESPACE, v as normalizeMemoryCoreWorkspaceKey } from "./dreaming-state-CswYxS-h.js";
import "./dreaming-shared-8l3nTpoP.js";
import { t as appendFailedDreamingEvent } from "./dreaming-events-BB3502b5.js";
import { a as runDreamNarrative, r as readRecentDreamDiaryEntries } from "./dreaming-narrative-2J0NuTT4.js";
import { n as normalizeDailyIngestionState, r as normalizeMemoryDay } from "./dreaming-ingestion-state-BNS21l_z.js";
import { a as mergeTrackedMessageHashes, c as sessionIngestionSourceFromCorpus, d as writeSessionIngestionState, l as sessionIngestionStateKeyFromCorpus, o as readSessionIngestionState, r as appendSessionCorpusLines, s as scanSessionIngestionSource, u as trimTrackedSessionScopes } from "./session-ingestion-VzrfcI6J.js";
import { c as filterLiveShortTermRecallEntries, d as recordShortTermRecalls, f as filterFreshLightDreamingEntries, g as recordRemConsideredPhaseSignals, h as recordDreamingPhaseSignals, l as readShortTermRecallEntries, m as readLightStagedKeys } from "./short-term-promotion-DcwUg1Fk.js";
import { t as writeDailyDreamingPhaseBlock } from "./dreaming-markdown-94Holhbo.js";
import { n as textSimilarity } from "./tokenize-eIBzdr_p.js";
...
function compareDreamingTimestampDesc(left, right) {
...
function dedupeEntries(entries, threshold) {
	...
	for (const entry of entries) {
		...
		if (duplicate) {
			...
			duplicate.lastRecalledAt = parseDreamingTimestampMs(entry.lastRecalledAt) > parseDreamingTimestampMs(duplicate.lastRecalledAt) ? entry.lastRecalledAt : duplicate.lastRecalledAt;
			continue;
		}
		deduped.push({ ...entry });
	}
