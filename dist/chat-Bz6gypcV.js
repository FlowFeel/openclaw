...
import { gt as resolveSqliteSessionKeyBySessionId } from "./session-accessor.sqlite-CtCo5VZ6.js";
import { ut as beginSessionWorkAdmission } from "./session-entry-slot-keys-DPRQmSpa.js";
import { I as resolveSessionTranscriptActiveLeafEntryId, b as isSessionTranscriptProjectionUnavailableError, p as readSessionTranscriptMessageAnchorPage } from "./session-accessor-D5Or7WgI.js";
...
import { c as readSessionMessagesAsync, f as resolveTranscriptReadTarget, g as ArchivedTranscriptReader, i as readRecentSessionMessagesWithStatsAsync, l as readSessionMessagesPageWithStatsAsync, m as toTranscriptReadScope, o as readSessionMessageByIdAsync, p as sqliteMessageEventWithSeq, v as capArrayByJsonBytes } from "./session-transcript-readers-O8pyQfzE.js";
import { n as resolveSessionModelRef } from "./session-model-ref-D_2SCgSv.js";
import { C as loadSessionEntryReadOnly, S as loadSessionEntry, j as getSessionDefaults, x as listAgentsForGateway } from "./session-utils-row-Br8x7LNG.js";
import { t as listGatewayAgentsBasic } from "./agent-list-c7Bg3rPD.js";
import { i as buildGatewaySessionInfo } from "./session-utils-list-Cf4VExhd.js";
import "./session-utils-P5pxtsqu.js";
import { t as resolveSwarmConfig } from "./swarm-config-BozrcCT-.js";
import { c as augmentChatHistoryWithCanvasBlocks, i as projectRecentChatDisplayMessages, n as projectChatDisplayMessages, o as dropPreSessionStartAnnouncePairs, s as isHeartbeatHistoryTurnBoundaryMessage, t as projectChatDisplayMessage, u as resolveEffectiveChatHistoryMaxChars } from "./chat-display-projection-BiWlQzhw.js";
import { d as resolveInFlightRunSnapshot, i as boundInFlightRunSnapshotForChatHistory } from "./chat-abort-B1M0lO2h.js";
...
import { r as modelCatalogBrowseRequiresFullDiscovery } from "./model-catalog-browse-s5RltdlS.js";
import { a as resolveClaudeCliBindingSessionId } from "./cli-session-history.claude-Mbvb4UVx.js";
import { n as resolveChatHistoryWithCliSessionImports } from "./cli-session-history-Ctci9mwG.js";
import { C as scheduleChatHistoryManagedMediaCleanup, L as normalizeOptionalChatText, o as appendAssistantTranscriptMessage } from "./chat-abort-runtime-Dd15wmDz.js";
import { t as assertValidParams } from "./validation-DyQ6nhKI.js";
import { t as handleChatAbortRequest } from "./chat-abort-handler-De8ZuRHJ.js";
import { a as sendGlobalAwareNodeChatPayload, n as resolveRequestedChatAgentId, r as validateChatSelectedAgent, t as handleChatSend } from "./chat-send-handler-DIZ9saYX.js";
import { r as resolveSessionHistoryTailReadOptions } from "./session-history-state-DFggQewR.js";
...
import { i as resolveVisibleActiveSessionRunState } from "./session-active-runs-DWNtWv20.js";
...
async function buildChatStartupMetadataResult(params) {
	...
	try {
		const { buildModelsListResult } = await import("./models-list-result-CXYr60q0.js");
...
async function buildChatMetadataResult(params) {
	const [{ buildModelsListResult }, { buildCommandsListResult }] = await Promise.all([import("./models-list-result-CXYr60q0.js"), import("./commands-list-result-BMIydzl0.js")]);
...
async function buildChatStartupModelCatalogProjection(params) {
	const { createGatewayAgentModelCatalogProjector } = await import("./models-list-result-CXYr60q0.js");
...
const chatHandlers = {
	...
	"chat.toolTitles": async ({ params, respond, context }) => {
		...
		const { generateToolCallTitles } = await import("./chat-tool-titles-_CqulogV.js");
