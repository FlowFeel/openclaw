...
import { At as boolean, Et as array, Nn as record, Rn as string, Tn as object, Xn as union, Zn as unknown, dn as literal, wn as number, yt as _enum } from "./schemas-CZ9Toj_c.js";
...
import { _ as DmPolicySchema, b as GroupPolicySchema } from "./zod-schema.agent-runtime-CaWcMFul.js";
import { a as buildChannelConfigSchema, c as buildMultiAccountChannelSchema, o as buildGroupEntrySchema } from "./config-schema-CPBvH4gM.js";
import { t as formatDocsLink } from "./links-ClIwBcy4.js";
import { v as isValidAgentHarnessSessionStoreEntry } from "./session-entry-slot-keys-DPRQmSpa.js";
import { i as createActionGate, t as ToolAuthorizationError } from "./common-yW0U9cHP.js";
...
import { d as normalizeLegacyInteractiveReply, f as normalizeMessagePresentation, l as legacyInteractiveReplyToPresentation, x as resolveLegacyInteractiveTextFallback } from "./payload-BofbwVaq.js";
import { i as createHybridChannelConfigAdapter, t as adaptScopedAccountAccessor } from "./channel-config-helpers-BwgkzH7b.js";
import { n as describeAccountSnapshot } from "./account-helpers-Dal2iRvY.js";
import { f as resolveSessionStoreBackupPaths, i as listSessionEntries, m as resolveStorePath, n as deleteSessionEntry, o as loadTranscriptEventsSync } from "./session-store-runtime-DND3iX5-.js";
import "./number-runtime-C6TGSEc_.js";
import "./string-coerce-runtime-CLK2YdzD.js";
import "./routing-ofUAgwWc.js";
import { r as buildSecretInputSchema } from "./secret-input-Dsfz4fVL.js";
import { c as patchScopedAccountConfig } from "./setup-helpers-t3GC4Z1N.js";
import { i as createChatChannelPlugin, t as buildChannelOutboundSessionRoute, u as stripChannelTargetPrefix } from "./core-QIH5yboB.js";
import { N as splitSetupEntries, T as promptSingleChannelSecretInput, j as setSetupChannelEnabled, p as mergeAllowFromEntries } from "./setup-wizard-helpers-C8pTV3Ti.js";
...
import { d as createDefaultChannelRuntimeState, i as buildProbeChannelStatusSummary, u as createComputedAccountStatusAdapter } from "./status-helpers-CSowaqvB.js";
...
import { p as defineChannelMessageAdapter } from "./channel-outbound-sjGCUxtt.js";
import { i as createPairingPrefixStripper } from "./channel-pairing-SZNlxp28.js";
import { F as projectConfigAccountIdWarningCollector, T as createAllowlistProviderGroupPolicyWarningCollector } from "./channel-policy-BgbKncah.js";
import { n as createChannelDirectoryAdapter } from "./directory-runtime-lZ5xkImA.js";
import "./state-paths-BmhF8vB7.js";
import { a as resolveDefaultFeishuAccountId, i as listFeishuAccountIds, l as resolveFeishuRuntimeAccount, n as inspectFeishuCredentials, p as isRecord$1, r as listEnabledFeishuAccounts, s as resolveFeishuAccount } from "./accounts-9P32R9R0.js";
import { i as resolveReceiveIdType, n as looksLikeFeishuId, r as normalizeFeishuTarget } from "./targets-CYvuU_k1.js";
import { A as resolveFeishuChatType, D as resolveFeishuGroupToolPolicy, _ as canEnumerateAllFeishuPeers, a as readNativeFeishuCardJson, b as resolveFeishuChatReadPreliminaryAuthorization, g as canEnumerateAllFeishuGroups, h as authorizeFeishuChatMemberRead, k as normalizeFeishuChatType, m as assertFeishuChatReadAllowed, n as createFeishuSendReceipt, u as chunkFeishuMarkdown, v as isFeishuGroupReadAllowed, w as resolveFeishuGroupConfig, y as isFeishuGroupReadEnabled } from "./send-result-CUChe1dA.js";
import { n as normalizeFeishuWebhookPath, t as DEFAULT_FEISHU_WEBHOOK_PATH } from "./webhook-path-CdNjPCi8.js";
import { a as parseFeishuTargetId, i as parseFeishuDirectConversationId, n as buildFeishuModelOverrideParentCandidates, o as resolveConfiguredFeishuGroupSessionScope, r as parseFeishuConversationId, t as buildFeishuConversationId } from "./conversation-id-DG-b0jtV.js";
import { a as listAuthorizedFeishuDirectoryGroups, c as listFeishuDirectoryPeers, i as isFeishuCardWithinEnvelope, n as buildFeishuPresentationCard, o as listAuthorizedFeishuDirectoryPeers, s as listFeishuDirectoryGroups, t as assertFeishuCardWithinEnvelope } from "./presentation-card-AKzUZwlk.js";
import { n as normalizeCompatibilityConfig, t as legacyConfigRules } from "./doctor-contract-CQynqR3Z.js";
import { t as messageActionTargetAliases } from "./security-audit-BTdGEYHW.js";
import { n as collectRuntimeConfigAssignments, r as secretTargetRegistryEntries } from "./secret-contract-C1DxlvQu.js";
import { t as collectFeishuSecurityAuditFindings } from "./security-audit-shared-D1hFqble.js";
import { t as resolveFeishuSessionConversation } from "./session-conversation-DOjQ3Xwr.js";
...
const feishuDmPolicy = createChannelDmPolicy({
	...
	resolveAccount: (cfg, accountId) => {
		...
		const account = resolvedAccountId === "default" ? void 0 : feishuCfg?.accounts?.[resolvedAccountId];
		return {
...
const loadAppRegistrationModule = createLazyRuntimeModule(() => import("./app-registration-DgaKZ7Wd.js"));
	...
	status: {
		...
		resolveStatusLines: async ({ cfg, accountId, configured }) => {
			...
			if (configured && account.configured) try {
				const { probeFeishu } = await import("./probe-6XW3JmR8.js");
...
const loadFeishuChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-YwwuV24-.js"), "feishuChannelRuntime");
...
async function createFeishuActionClient(account) {
	const { createFeishuClient } = await import("./client-DdQaiBh9.js");
...
const feishuPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			const { monitorFeishuProvider } = await import("./monitor-BotMzT_W.js");
...
//#endregion
export { setFeishuNamedAccountEnabled as a, feishuSetupAdapter as i, feishuSetupWizard as n, runFeishuLogin as r, feishuPlugin as t };
