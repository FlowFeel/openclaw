...
import { r as dispatchGatewayMethodInProcess, u as hasInProcessGatewayContext } from "./server-plugins-D28cwNc7.js";
...
var AttributionRingBuffer = class {
	...
	*/
	getConcurrencyTimeSeries(options) {
		...
		const mem = typeof process !== "undefined" && process.memoryUsage ? process.memoryUsage() : void 0;
		const currentHeapPct = mem && mem.heapTotal > 0 ? Math.round(mem.heapUsed / mem.heapTotal * 1e3) / 10 : void 0;
