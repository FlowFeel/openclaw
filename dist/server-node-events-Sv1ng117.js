...
import { vt as upsertSqliteSessionEntry } from "./session-accessor.sqlite-B9iW7DOt.js";
import { a as normalizeChannelId } from "./registry-B1AiP2IQ.js";
import "./plugins-1tM2ZjdA.js";
import { y as resolveAgentHarnessSessionContextError } from "./session-entry-slot-keys-DR5d2mKt.js";
import "./session-accessor-t3qUoTeV.js";
import { sn as validateNodePresenceActivityPayload } from "./src-BSn6va4B.js";
import { i as deleteMediaBuffer } from "./store-BDR50q7S.js";
...
import { M as resolveGatewayModelSupportsImages, S as loadSessionEntry } from "./session-utils-row-BDvhdN3C.js";
...
import { E as updatePairedDevicePresence } from "./device-pairing-pwb3Oe75.js";
...
import { a as parseMessageWithAttachments, o as persistInboundImagesForTranscript, t as normalizeRpcAttachmentsToChatAttachments } from "./attachment-normalize-BEmmmy0G.js";
import { h as registerApnsRegistration, t as ApnsRegistrationPairingChangedError } from "./push-apns-store-DIKYgzVs.js";
import "./push-apns-BPyUYCWp.js";
...
const handleNodeEvent = async (ctx, nodeId, evt, opts) => {
	...
	switch (evt.event) {
		...
		case "agent.request": {
			...
			if (!await isNodeEventConnectionCurrent(opts)) {
				await cleanupNodeEventMedia(persistedTranscriptMedia.map((media) => media.id), ctx);
				return pairingChangedResult(evt.event);
			}
			...
			dispatchNodeAgentCommand(ctx, nodeId, {
				...
				messageChannel: "node",
				allowModelOverride: false
			}, opts?.isConnectionCurrent, () => cleanupNodeEventMedia(persistedTranscriptMedia.map((media) => media.id), ctx));
			return;
		}
