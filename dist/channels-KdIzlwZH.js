...
import { a as normalizeChannelId$1, t as getChannelPlugin } from "./registry-B1AiP2IQ.js";
import "./plugins-1tM2ZjdA.js";
import "./message-channel-1n7hD5_u.js";
import "./logging-Dqsje8by.js";
import { r as createMessageActionDiscoveryContext, u as resolveMessageActionDiscoveryForPlugin } from "./message-action-discovery-CPeUevTi.js";
...
import { s as getChannelsCommandSecretTargetIds } from "./command-secret-targets-DIFshlpq.js";
import { t as listManifestChannelContributionIds } from "./manifest-contribution-ids-DlD7Xezr.js";
...
import { t as resolveInstallableChannelPlugin } from "./channel-plugin-resolution-DYVbZaaW.js";
import { n as resolveLogFile } from "./log-tail-DE2f5oI0.js";
import { t as parseLogLine } from "./parse-log-line-BfhcnUPK.js";
import { t as requireValidConfigFileSnapshot } from "./config-validation-PMAH8S4I.js";
import { i as prepareChannelAccountRemoval, n as channelLabel, r as applyPreparedChannelAccountRemoval, t as channelsAddCommand } from "./add-CFvuFjJ-.js";
import { c as shouldUseWizard, o as formatChannelAccountLabel, s as requireValidConfig } from "./shared-BovuSYXk.js";
import { t as channelsListCommand } from "./list-DghInLdC.js";
import { t as channelsStatusCommand } from "./status-Bng5Bwln.js";
...
async function channelsRemoveCommand(opts, runtime = defaultRuntime, params) {
	...
	const resolvedPluginState = Boolean(lookupChannel || channel) ? await (async () => {
		const { resolveInstallableChannelPlugin } = await import("./channel-plugin-resolution-Bmk0XX28.js");
