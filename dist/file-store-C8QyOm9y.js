...
import { n as readFileDescriptorBoundedSync } from "./bounded-read-Cox0d2jX.js";
import { d as resolveSafeRelativePath, i as isPathInside, o as isPathRelativeEscape } from "./path-D8zNGPJM.js";
import { O as createSyncDirectoryGuard, T as assertSyncDirectoryGuard$1, b as canonicalPathFromExistingAncestor, r as getFsSafeTestHooks } from "./pinned-write-CO4XA8tE.js";
import { a as stringifyJsonDocument, c as resolveOpenedFileRealPathForHandle, i as root } from "./root-impl-DYBxk3hn.js";
import { t as createSidecarLockManager } from "./sidecar-lock-DvH3ZuQw.js";
import { t as serializePathWrite } from "./write-queue-Cq_SK85X.js";
...
import { n as resolveSecureTempRoot } from "./temp-target-CTNQantz.js";
import { s as writeSecretFileAtomic } from "./secret-file-DU9lZTFY.js";
...
function createJsonStore(adapter, options = {}) {
	...
	async function withSerializedMutation(run) {
		...
		if (activePaths?.has(canonicalPath)) throw new FsSafeError("store-reentrant-update", `jsonStore cannot write or update ${canonicalPath} from inside its active update callback; return the complete next value from the outer update instead`);
