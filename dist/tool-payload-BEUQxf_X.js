import { o as parseStandalonePlainTextToolCallBlocks$1, s as stripPlainTextToolCallBlocks$1 } from "./src-BCj7auhV.js";
...
function stripPlainTextToolCallBlocks(text, options) {
	return stripPlainTextToolCallBlocks$1(text, options);
}
