...
import { m as normalizeSecretInputString, s as coerceSecretRef } from "./types.secrets-BvApkFoj.js";
...
import { h as setRuntimeAuthProfileStoreSnapshot, o as getRuntimeAuthProfileStoreSnapshot, u as hasRuntimeAuthProfileStoreSnapshot } from "./runtime-snapshots-D6jlj0Te.js";
import { a as resolveTokenExpiryState, n as evaluateStoredCredentialEligibility } from "./credential-state-oLRZBnMF.js";
import { S as log, a as isSafeToAdoptBootstrapOAuthIdentity, b as OAUTH_REFRESH_LOCK_OPTIONS, c as shouldBootstrapFromExternalCliCredential, i as hasUsableOAuthCredential, m as shouldMirrorRefreshedOAuthCredential, n as hasMatchingOAuthIdentity, o as isSafeToAdoptMainStoreOAuthIdentity, t as areOAuthCredentialsEquivalent, u as shouldReplaceStoredOAuthCredential, y as OAUTH_REFRESH_CALL_TIMEOUT_MS } from "./oauth-shared-B-oYylTU.js";
import { n as readExternalCliBootstrapCredential } from "./external-cli-sync-CELhQFMz.js";
import { b as updateAuthProfileStoreWithLock, f as loadAuthProfileStoreForSecretsRuntime, h as resolvePersistedAuthProfileOwnerAgentDir, o as ensureAuthProfileStoreWithoutExternalProfiles, p as loadAuthProfileStoreWithoutExternalProfiles } from "./store-C8MGqOG3.js";
...
import { i as OAuthProviderConfiguredUnavailableError, n as getOAuthApiKey, r as getOAuthProviders } from "./oauth-BRTRteUM.js";
import { r as resolveOAuthRefreshLockPath } from "./paths-ChRr3Z9Q.js";
import { t as buildOAuthRequestSignal } from "./provider-oauth-runtime-DbIkXv96.js";
import { n as SecretSurfaceUnavailableError, s as findActiveDegradedSecretOwner } from "./runtime-degraded-state-V0p9ck6P.js";
import { t as resolveAuthProfileSecretOwnerId } from "./runtime-auth-profile-owner-xVMTpfMP.js";
import { t as OAuthRefreshFailureError } from "./oauth-refresh-failure-BUReLFib.js";
import { t as assertNoOAuthSecretRefPolicyViolations } from "./policy-DI7O2zhj.js";
import { t as clearLastGoodProfileWithLock } from "./profiles-B5_Ws1zV.js";
import { n as suggestOAuthProfileIdForLegacyDefault } from "./repair-B9E8U86g.js";
import "node:crypto";
	...
	async function doRefreshOAuthTokenWithLock(params) {
		...
		try {
			return await withFileLock(globalRefreshLockPath, OAUTH_REFRESH_LOCK_OPTIONS, async () => {
				...
				if (ownerAgentDir) {
					if (resolveAuthProfileDatabasePath(void 0) !== authPath) await mirrorRefreshedCredentialIntoMainStore({
						profileId: params.profileId,
						refreshed: refreshedCredentials
					});
				}
