...
import { h as MessagePresentationButton, p as MessagePresentationAction } from "./payload-D0D49c9Y.js";
import { M as CommandExplanationSummary, a as ExecApprovalRequest, i as ExecApprovalDecision, s as ExecApprovalResolved } from "./exec-approvals-core-ByvfWxmW.js";
import { c as PluginApprovalRequest, u as PluginApprovalResolved } from "./plugin-approvals-BeZNQzQv.js";
...
//#endregion
export { ChannelApprovalNativeDeliveryPlan as A, PluginApprovalExpiredView as C, ChannelNativeApprovalDeliveryCallbacks as D, ResolvedApprovalView as E, ChannelApprovalKind as F, resolveChannelNativeApprovalDeliveryPlan as M, ChannelApprovalNativeAdapter as N, ChannelNativeApprovalTransportSpec as O, ChannelApprovalNativeTarget as P, PendingApprovalView as S, PluginApprovalResolvedView as T, ApprovalViewModel as _, ChannelApprovalNativeFinalAction as a, ExecApprovalResolvedView as b, ChannelApprovalNativePresentationAdapter as c, ChannelApprovalNativeTransportAdapter as d, ExecApprovalChannelRuntime as f, ApprovalMetadataView as g, ApprovalActionView as h, ChannelApprovalNativeAvailabilityAdapter as i, ChannelApprovalNativePlannedTarget as j, PreparedChannelNativeApprovalTarget as k, ChannelApprovalNativeRuntimeAdapter as l, ExecApprovalChannelRuntimeEventKind as m, ApprovalResolved as n, ChannelApprovalNativeInteractionAdapter as o, ExecApprovalChannelRuntimeAdapter as p, ChannelApprovalCapabilityHandlerContext as r, ChannelApprovalNativeObserveAdapter as s, ApprovalRequest as t, ChannelApprovalNativeRuntimeSpec as u, ExecApprovalExpiredView as v, PluginApprovalPendingView as w, ExpiredApprovalView as x, ExecApprovalPendingView as y };