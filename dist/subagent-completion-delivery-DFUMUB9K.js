...
import { b as findTaskByRunId, v as publishTaskRecordAfterAtomicStore, x as getTaskById } from "./task-registry-CYuVw6Rm.js";
...
async function settleCorrelatedSubagentDelivery(queued, outcome) {
	...
	publishCommittedRecords(subagent, projectedTask);
	if (outcome === "recovered") {
		const { resumeSubagentRun } = await import("./subagent-registry-CjPpjF8W.js");
