...
import { i as isExplicitCommandTurn, s as resolveCommandTurnContext } from "./command-turn-context-chpcv6RY.js";
...
function resolveCommandBody(input) {
	if (typeof input.commandText === "string") return input.commandText;
