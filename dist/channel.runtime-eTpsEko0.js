...
import { t as sendMessageZalo } from "./send-CGTWGWiV.js";
...
async function notifyZaloPairingApproval(params) {
	const { resolveZaloAccount } = await import("./accounts-PYyq4OyK.js");
...
async function startZaloGatewayAccount(ctx) {
	...
	const { monitorZaloProvider } = await import("./monitor-D7-rge5S.js");
