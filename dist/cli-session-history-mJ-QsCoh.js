...
import { i as readClaudeCliSessionMessages, t as CLAUDE_CLI_PROVIDER } from "./cli-session-history.claude-DRtGxhse.js";
...
function hasSameExternalIdentity(existing, imported) {
	...
	if (!importedIdentity || !existingIdentity) return;
...
function isEquivalentImportedMessage(existing, imported) {
	...
	if (sameExternalIdentity !== void 0) return sameExternalIdentity;
