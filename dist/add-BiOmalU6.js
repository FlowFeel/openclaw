...
const channelSetupPluginInstallLoader = createLazyImportLoader(() => import("./plugin-install-v1ucicfl.js"));
const onboardChannelsLoader = createLazyImportLoader(() => import("./onboard-channels-CRCe6eBh.js"));
...
async function channelsAddCommandImpl(opts, runtime, params) {
	...
	if (shouldUseWizard(params)) {
		const { resolveInitialWizardChannel, runChannelsAddWizardFlow } = await import("./add-wizard-D1wOaciF.js");
