...
import { n as isImmutableGitCommitRef, r as parseGitPluginSpec } from "./git-install-DjrcK0Wp.js";
...
import { h as fetchClawHubSkillCard, t as CLAWHUB_SKILLS_SH_TRUST_LABEL, y as fetchClawHubSkillVerification } from "./clawhub-Clykbwlp.js";
...
import { s as withTempDir } from "./install-source-utils-Bi2zlcsu.js";
...
import { c as searchSkillsFromClawHub, f as readTrackedClawHubSkillSlugs, l as readVerifiedClawHubSkillSourceUrl, m as installExtractedSkillRoot, o as resolveClawHubSkillVerificationTarget, p as untrackClawHubSkill, r as updateSkillsFromClawHub, t as installSkillFromClawHub, v as validateRequestedSkillSlug } from "./clawhub-DgSLScUf.js";
import { t as CLAWHUB_TRUST_ERROR_CODE } from "./clawhub-install-trust-CReac6nQ.js";
import { n as resolveSkillStatusEntry } from "./status-v2W0ohF-.js";
import { a as quarantineSkillProposal, d as inspectSkillProposal, f as listSkillProposals, h as readSkillProposalDraftFile, i as proposeUpdateSkill, m as readSkillProposalDraftDirectory, o as rejectSkillProposal, r as proposeCreateSkill, s as reviseSkillProposal, t as applySkillProposal } from "./service-CmvGStrk.js";
import { n as renderTable, t as getTerminalTableWidth } from "./table-xycldY5I.js";
import { t as resolveOptionFromCommand } from "./cli-utils-Cr1AjnyO.js";
...
import { t as resolveClawHubRiskAcknowledgementCliOptions } from "./clawhub-risk-acknowledgement-BrXcM8pO.js";
...
async function loadSkillsStatusReport(options) {
	...
	const { buildWorkspaceSkillStatus } = await import("./status-IhO0s8yg.js");
...
async function runSkillProposalApply(resolved, proposalId) {
	const { callGateway, isGatewayCredentialsRequiredError, isGatewayTransportError } = await import("./call-DctZOBCQ.js");
	try {
		await callGateway({
			config: resolved.config,
			method: "health",
		...
		const { acquireGatewayLock } = await import("./gateway-lock-MRYQL4Zv.js");
		let lock;
		try {
