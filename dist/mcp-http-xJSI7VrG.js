...
import { t as checkBrowserOrigin } from "./origin-check-1UpqVOpx.js";
...
import { h as runBeforeToolCallHook } from "./agent-tools.before-tool-call-uaLOAHZ3.js";
import { c as resolveToolExecutionErrorKind, i as protectNetworkToolExecutionError, l as resolveToolResultFailureKind, t as formatToolExecutionErrorMessage } from "./tool-result-error-BI56-yEJ.js";
import "./sessions-BqBqRT1f.js";
import { i as getPluginToolMeta } from "./tools-sUgO7zqy.js";
import { o as DirectoryCache } from "./target-resolver-BRdj-hLk.js";
...
import { a as registerMcpLoopbackClientGrantRevocationListener, d as revokeMcpLoopbackClientGrantsForRuntime, o as resolveAttachGrant, s as resolveMcpLoopbackClientGrant } from "./mcp-grant-store-bQkGAKnX.js";
import { t as resolveGatewayScopedTools } from "./tool-resolution-DByrBJum.js";
import { l as getHeader } from "./http-auth-utils-3kt7C83x.js";
...
function resolveMediatedNativeTools(toolsAllow, mode) {
	if (mode === "exact") return new Set((toolsAllow ?? []).map((name) => normalizeToolName(name)).filter((name) => NATIVE_TOOL_EXCLUDE.has(name)));
	if (toolsAllow === void 0 || toolsAllow.some((toolName) => normalizeToolName(toolName) === "*")) return /* @__PURE__ */ new Set();
