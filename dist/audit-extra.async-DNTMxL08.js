...
import { D as extensionUsesSkippedScannerPath } from "./redact-DUpJZuMu.js";
...
import { S as resolveOAuthDir } from "./paths-CL43LNS6.js";
...
import { o as resolveAuthProfileDatabaseFilePaths } from "./sqlite-DQLy89x1.js";
import { t as collectIncludePathsRecursive } from "./includes-scan-BVX0cndS.js";
...
const loadSkillsModule = createLazyRuntimeModule(() => import("./workspace-CW_rytt_.js"));
const loadConfigModule = createLazyRuntimeModule(() => import("./config/config.js"));
const loadAuditFsModule = createLazyRuntimeModule(() => import("./audit-fs-BAEpE3p-.js"));
const loadAgentScopeModule = createLazyRuntimeModule(() => import("./agent-scope-Jqp3H3Rj.js"));
const loadAgentWorkspaceDirsModule = createLazyRuntimeModule(() => import("./workspace-dirs-mp3XFAJe.js"));
const loadSkillSourceModule = createLazyRuntimeModule(() => import("./source-C6H4DQLF.js"));
const loadSkillScannerModule = createLazyRuntimeModule(() => import("./scanner-L-bEh36V.js"));
const loadExecDockerRaw = createLazyRuntimeNamedExport(() => import("./docker-CJJnlwM8.js"), "execDockerRaw");
const loadSandboxBrowserSecurityHashEpoch = createLazyRuntimeNamedExport(() => import("./constants-DRQA4m_M.js"), "SANDBOX_BROWSER_SECURITY_HASH_EPOCH");
...
async function collectInstalledSkillsCodeSafetyFindings(params) {
	...
	const [{ listAgentWorkspaceDirs, listExplicitAgentWorkspaceDirs }, { resolveSkillSource }] = await Promise.all([loadAgentWorkspaceDirsModule(), loadSkillSourceModule()]);
