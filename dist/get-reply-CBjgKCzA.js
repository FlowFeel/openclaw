...
import { a as resolveEffectiveAgentRuntime, n as hasResolvedThinkingCatalogEntry } from "./thinking-runtime-1FRCPyWR.js";
...
import { n as clearCommandLane, s as getQueueSize } from "./command-queue-BbrEP4i9.js";
...
import { d as isChannelProgressDraftWorkToolName, f as isCommandToolName } from "./streaming-B45j2FQx.js";
import { t as collectTextContentBlocks } from "./content-blocks-DRK0dze4.js";
import { M as resolveBootstrapMode } from "./openclaw-tools-dPoXkP5n.js";
...
import { t as resolveQueueSettings } from "./queue-Irl6tzJB.js";
...
import { t as clearAllCliSessions } from "./cli-session-qfSu2tit.js";
...
import { a as appendChannelPromptContext, c as buildInboundMediaNoteProjection, n as MEDIA_ONLY_USER_TEXT, t as isReasoningTagProvider } from "./provider-utils-CpMqd4Cc.js";
...
import { t as resolveDefaultModel } from "./directive-handling.defaults-Z0T3u78m.js";
...
import { a as createReplyTimingTracker, d as resolveSilentReplySettings, i as resolveEffectiveReplyRoute, n as createReplySessionEntryHandle, r as isSystemEventProvider, s as admitReplyTurn } from "./session-entry-handle-CKnQnjqd.js";
...
import { i as resolveStoredModelOverride, t as isStaleHeartbeatAutoFallbackOverride } from "./stored-model-override-COLDiva4.js";
...
import { n as clearSessionResetRuntimeState, t as resolveResetPreservedSelection } from "./reset-preserved-selection-DKnwtAOG.js";
...
import { t as resolveBlockStreamingChunking } from "./block-streaming-DyAFwqss.js";
import { t as buildCommandContext } from "./commands-context-5rYZwhm-.js";
import { n as resolveModelRuntimeDirective } from "./directive-handling.model-runtime-CgipnuKC.js";
...
import { t as resolveContextTokens } from "./model-selection-context-hqFUwm3F.js";
import { n as createModelSelectionState, t as createFastTestModelSelectionState } from "./model-selection-4EbwX56V.js";
...
import { a as buildInboundUserContextPrefix, c as resolveInboundUserContextPromptJoiner, i as buildInboundMetaSystemPrompt, l as resolveActiveRunQueueAction, o as formatActiveGoalContext, r as resolveTypingMode, t as resolveCurrentTurnImages } from "./current-turn-images-DDcu7tsv.js";
...
import { n as resolveEffectiveToolInventory } from "./tools-effective-inventory-CAjrWlrQ.js";
import { n as flushSessionActivityAssistantNote, r as noteSessionActivityEvent, t as createSessionActivityNoteState } from "./session-activity-notes-CM8CCq6f.js";
import { t as PROGRESS_STATUS_PREAMBLE_FRESH_MS } from "./progress-draft-compositor-DCAyXL2n.js";
...
const directiveImplLoader = createLazyImportLoader(() => import("./directive-handling.impl-BB7VzMrz.js"));
...
const skillToolDispatchRuntimeLoader = createLazyImportLoader(() => import("./tool-dispatch-C5Y_lT7w.js"));
const abortCutoffRuntimeLoader = createLazyImportLoader(() => import("./abort-cutoff.runtime.js"));
const commandsRuntimeLoader$1 = createLazyImportLoader(() => import("./commands.runtime-C8_F1hah.js"));
...
const commandsRuntimeLoader = createLazyImportLoader(() => import("./commands.runtime-C8_F1hah.js"));
const skillCommandsRuntimeLoader = createLazyImportLoader(() => import("./chat-commands.runtime.js"));
const statusCommandRuntimeLoader = createLazyImportLoader(() => import("./commands-status-DHbtGzgo.js"));
...
const embeddedAgentRuntimeLoader = createLazyImportLoader(() => import("./embedded-agent.runtime-Diwomoq0.js"));
...
const loadDeliverRuntime = createLazyPromiseLoader(() => import("./runtime-CZpVG7Wl.js"), { cacheRejections: true }).load;
...
async function getReplyFromConfig(ctx, opts, configOverride) {
	...
	if (usePublishedModelRuntime && !isFastTestEnv) {
		const owner = await (await import("./prepared-model-catalog-ClbAcHfK.js")).loadResolvedPublishedModelCatalogOwner({ agentId });
