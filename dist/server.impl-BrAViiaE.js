...
import { f as setGatewaySigusr1RestartPolicy, p as setPreRestartDeferralCheck } from "./restart-CuyhHAIM.js";
...
import "./server-plugins-B7M_VHf6.js";
...
import { a as incrementPresenceVersion, i as getPresenceVersion, n as getHealthCache, o as refreshGatewayHealthSnapshot, r as getHealthVersion } from "./health-state-CVIlUfcm.js";
...
async function startGatewayCoreRuntime(input) {
	...
	const [{ startGatewayEventSubscriptions }, { startGatewayRuntimeServices }] = await startupTrace.measure("runtime.post-early-imports", () => Promise.all([import("./server-runtime-subscriptions-dXE9neGa.js"), import("./server-runtime-startup-services-CarEcSE8.js")]));
	...
	const { execApprovalManager, cancelRunBoundApprovals, forwardPluginApprovalRequest, pluginApprovalIosPushDelivery, pluginApprovalManager, systemAgentApprovalManager, extraHandlers, coreGatewayHandlers } = await startupTrace.measure("gateway.handlers", async () => {
		const [{ createGatewayAuxHandlers }, { coreGatewayHandlers: coreGatewayHandlersLocal }] = await Promise.all([import("./server-aux-handlers-I7L9W6Mu.js"), import("./server-methods-kNh7u-zt.js")]);
		return {
...
function createLazyGatewayCronState(params) {
	...
	const cronStateLoader = createLazyPromiseLoader(() => import("./server-cron-CdedMLtI.js").then(({ buildGatewayCronService }) => {
		loaded = {
...
const getPluginIconHttpModule = createLazyRuntimeModule(() => import("./plugin-icon-http-BqqaQm7J.js"));
const getModelsHttpModule = createLazyRuntimeModule(() => import("./models-http-Jk735e6q.js"));
const getOpenAiHttpModule = createLazyRuntimeModule(() => import("./openai-http-DDm5wNbz.js"));
const getOpenResponsesHttpModule = createLazyRuntimeModule(() => import("./openresponses-http-0ZWcYmuP.js"));
const getSessionHistoryHttpModule = createLazyRuntimeModule(() => import("./sessions-history-http-CBxbnH--.js"));
const getSessionKillHttpModule = createLazyRuntimeModule(() => import("./session-kill-http-D6y2WCbP.js"));
const getToolsInvokeHttpModule = createLazyRuntimeModule(() => import("./tools-invoke-http-swO_rTS8.js"));
	...
	const handleHooksRequest = async (req, res) => {
		...
		return await runWithGatewayHttpWorkAdmission(res, async () => {
			if (!loadedHooksRequestHandler) {
				const { createGatewayHooksRequestHandler } = await import("./hooks-caAp7Wy8.js");
...
async function prepareGatewayRuntimeState(params) {
	...
	const { runDefaultChannelSetupWizard, runDefaultSetupWizard } = await import("./wizard-FOqBy4uo.js");
...
async function prepareGatewayServerBootstrap(input) {
	...
	const loadStartupPluginsModule = createLazyPromise(() => import("./server-startup-plugins-CCL_kcbL.js"), { cacheRejections: true });
...
async function finishGatewayStartup(params) {
	...
	const { createGatewayInstanceRuntime } = await import("./server-instance-runtime-CDjapa14.js");
	...
	const [{ attachGatewayWsHandlers }, { listPluginNodeCapabilities }] = await startupTrace.measure("gateway.ws-imports", () => Promise.all([import("./server-ws-runtime-BjaLU1vy.js"), import("./route-capability-Cjzy-wRF.js")]));
	...
	const loadScheduledServicesModule = createLazyPromise(() => import("./server-runtime-services-B52CtJyL.js"), { cacheRejections: true });
	...
	activateScheduledServicesWhenReady();
	const { startManagedGatewayConfigReloader } = await import("./server-reload-handlers-DjGtjjEp.js");
...
const loadGatewayStartupEarlyModule = createLazyRuntimeModule(() => import("./server-startup-early-Cejk0Om2.js"));
const loadGatewayStartupPostAttachModule = createLazyRuntimeModule(() => import("./server-startup-post-attach-BSOBEWZg.js"));
const log = createSubsystemLogger("gateway");
const logDiscovery = log.child("discovery");
const logTailscale = log.child("tailscale");
const logChannels = log.child("channels");
const getChannelRuntime = createLazyRuntimeModule(() => import("./runtime-channel-DZzpsSl7.js").then(({ createRuntimeChannel }) => createRuntimeChannel()));
...
const loadGatewayPluginBootstrapModule = createLazyRuntimeModule(() => import("./server-plugin-bootstrap-u7Zeh5yO.js"));
...
async function stopTaskRegistryMaintenanceOnDemand() {
	const { stopTaskRegistryMaintenance } = await import("./task-registry.maintenance-CP4XYGk4.js");
