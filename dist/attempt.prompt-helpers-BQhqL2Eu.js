...
import { L as buildPluginAgentTurnPrepareContext, O as drainPluginNextTurnInjectionContext } from "./loader-CT1KBBu5.js";
import { d as resolveSelectedOpenAIRuntimeProvider, g as isDefaultAgentRuntimeId, v as normalizeOptionalAgentRuntimeId } from "./openai-routing-Db2edxk0.js";
import "./agent-scope-DyEposw2.js";
import { t as parseDurationMs } from "./parse-duration-Be19e01j.js";
import "./defaults-CdX9UGcX.js";
import { C as resolveModelRefFromString, a as buildModelAliasIndex, d as inferUniqueProviderFromConfiguredModels } from "./model-selection-shared-V7VmYFPH.js";
import { g as joinPresentTextSegments } from "./hook-runner-global-BNa5TLJ4.js";
import { k as deriveContextPromptTokens } from "./session-accessor.sqlite-CtCo5VZ6.js";
import { i as resolveBoundAgentIdForSession } from "./commands-DjyhqAKB.js";
import { i as resolveCandidateThinkingLevel } from "./thinking-runtime-Ct74CGZn.js";
import { d as shouldPreserveUserFacingSessionStateForInputProvenance } from "./input-provenance-CYGbY89H.js";
import { c as resolveHeartbeatPrompt, n as HEARTBEAT_CRON_TASK_GUIDANCE } from "./heartbeat-Cw1AzhxC.js";
import { o as deriveSessionName } from "./bash-tools.shared-0H8_zJuj.js";
import { d as listRunningSessions } from "./bash-process-registry--IqPmVga.js";
import { t as agentRuntimeAuthPlanMatchesTarget } from "./prepare-auth-C8ecPbie.js";
import { t as log } from "./logger-PoK3sCV7.js";
import { c as resolveEffectiveToolFsWorkspaceOnly } from "./local-roots-DY1lg2k6.js";
import { d as buildActiveImageGenerationTaskPromptContextForSession, n as buildActiveVideoGenerationTaskPromptContextForSession, o as buildActiveMusicGenerationTaskPromptContextForSession } from "./openclaw-tools-B_OHwLQN.js";
import { n as resolveProcessToolScopeKey } from "./agent-tools-Df1_Fel3.js";
...
function resolveHeartbeatPromptForSystemPrompt(params) {
	...
	const prompt = resolveHeartbeatPrompt(heartbeat?.prompt);
...
//#endregion
export { wrapPluginSystemContextSection as _, prependSystemPromptAddition as a, resolveContextEngineCapabilities as b, resolvePromptBuildHookResult as c, shouldWarnOnOrphanedUserRepair as d, buildEmbeddedCompactionRuntimeContext as f, resolveEmbeddedCompactionThinkingLevel as g, resolveEmbeddedCompactionTarget as h, mergeOrphanedTrailingUserPrompt as i, resolvePromptModeForSession as l, resolveCompactionHarnessRuntime as m, buildAfterTurnRuntimeContextFromUsage as n, resolveAttemptFsWorkspaceOnly as o, resolveCompactionContextTokenBudget as p, forgetPromptBuildDrainCacheForRun as r, resolveAttemptMediaTaskSystemPromptAddition as s, buildAfterTurnRuntimeContext as t, shouldInjectHeartbeatPrompt as u, resolveHeartbeatPromptForSystemPrompt as v, listActiveProcessSessionReferences as y };
