...
function createTerminalLaunchPolicy(initialConfig) {
	...
	return {
		...
		isEnabled: () => isTerminalConfigEnabled(activeConfig) && !terminalDisabledUntilRestart && !terminalDisabledUntilCommit && (preparedConfig === null || isTerminalConfigEnabled(preparedConfig)),
