...
import { i as resolveProviderRequestPolicy } from "./provider-attribution-DUC9Ms4a.js";
import { f as resolveProviderRequestPolicyConfig } from "./provider-request-config-C5exA1l5.js";
...
import { a as patchCodexNativeWebSearchPayload, o as resolveCodexNativeSearchActivation } from "./codex-native-web-search-core-Cb_ckxKl.js";
import { n as createOpenAIResponsesTransportStreamFn } from "./openai-transport-stream-DYOY9tN6.js";
import { C as applyAnthropicEphemeralCacheControlMarkers, T as mapThinkingLevelToReasoningEffort, h as normalizeOpenAICompatibleReasoningPayload, w as resolveAnthropicEphemeralCacheControl } from "./provider-stream-shared-BzNzn982.js";
import { resolveOpenAIReasoningEffortForModel, supportsOpenAIReasoningEffort } from "@openclaw/ai/internal/openai";
import { applyOpenAIResponsesPayloadPolicy, emitModelTransportDebug, filterCodeModePayloadTools, flattenCompletionMessagesToStringContent, isCodeModeModelVisibleToolName, readCodeModePayloadToolName, resolveOpenAIResponsesPayloadPolicy, stripCompletionMessagesToRoleContent } from "@openclaw/ai/transports";
...
function filterCodeModePayloadHookResult(payload, nextPayload, visibleToolNames) {
		...
		if ((params.codeModeToolSurfaceEnabled === true || codeModeSurfaceFromOptions || isCodeModeEnabled(params.config)) && codeModeVisibleToolNames) {
			...
			const codeModeOptions = {
				...
				onPayload: (payload) => {
					...
					if (isPromiseLike(nextPayload)) return Promise.resolve(nextPayload).then((resolvedPayload) => filterCodeModePayloadHookResult(payload, resolvedPayload, codeModeVisibleToolNames));
