...
import { d as resolveDefaultAgentDir, f as resolveDefaultAgentId, u as resolveAgentWorkspaceDir } from "./agent-scope-config-Dusa8eSA.js";
import { r as getRuntimeConfig, t as projectConfigOntoRuntimeSourceSnapshot } from "./io-BsQc3Kgy.js";
...
import { n as resolveInstalledManifestRegistryIndexFingerprint } from "./manifest-registry-installed-0UVF8EI7.js";
...
import { c as getRuntimeConfigSourceSnapshot, u as hashRuntimeConfigValue } from "./runtime-snapshot-Bzqj8IgJ.js";
import { T as resolveCatalogOwnedModelCompat, h as parseConfiguredModelVisibilityEntries } from "./model-selection-shared-V7VmYFPH.js";
import { a as normalizeConfiguredProviderCatalogModelId } from "./model-ref-shared-BEKlpylb.js";
...
import { c as isNonSecretApiKeyMarker, d as resolveEnvSecretRefHeaderValueMarker, f as resolveNonEnvSecretRefApiKeyMarker, p as resolveNonEnvSecretRefHeaderValueMarker } from "./model-auth-markers-z4js65k2.js";
import { d as resolveOwningPluginIdsForProviderRef } from "./providers-YwyHR_AL.js";
import { T as resolveProviderConfigApiKeyWithPlugin, h as normalizeProviderConfigWithPlugin, n as applyProviderNativeStreamingUsageCompatWithPlugin } from "./provider-runtime-DlVC1wsY.js";
import { i as ensureAuthProfileStore } from "./store-BWT5kQzj.js";
import { d as PLUGIN_MODEL_CATALOG_GENERATED_BY, f as repairPluginModelCatalogTransportMetadata, i as isGeneratedPluginModelCatalog, l as replacePersistedPluginModelCatalogs, n as encodePluginModelCatalogRelativePath, o as loadPersistedPluginModelCatalogs, s as loadPersistedPluginModelCatalogsReadOnly, t as decodePluginModelCatalogRelativePathPluginId, u as resolvePluginModelCatalogOwnerPluginId } from "./plugin-model-catalog-DdAXxyD8.js";
import { a as runProviderCatalog, i as resolveRuntimePluginDiscoveryProviders, n as normalizePluginDiscoveryResult, o as runProviderStaticCatalog, r as prepareProviderStaticCatalog, t as groupPluginDiscoveryProvidersByOrder } from "./provider-discovery-UXN1ZFRC.js";
import { a as normalizeConfiguredProviderApiKey, c as resolveApiKeyFromProfiles, l as resolveMissingProviderApiKey, o as normalizeHeaderValues, r as createProviderAuthResolver, s as normalizeResolvedEnvApiKey, t as createProviderApiKeyResolver } from "./models-config.providers.secrets-CkzsKj4c.js";
...
function mergeProviderModels(implicit, explicit) {
	...
	const mergedModels = explicitModels.map((explicitModel) => {
		...
		}, contextWindow === void 0 ? {} : { contextWindow }, contextTokens === void 0 ? {} : { contextTokens }, maxTokens === void 0 ? {} : { maxTokens }, { compat });
	});
...
async function prepareImplicitProviderStaticCatalog(params) {
	...
	const prepared = await prepareProviderStaticCatalog({ providers: staticCatalogProviderIds ? providers.filter((provider) => [
		...
		...provider.aliases ?? [],
		...provider.hookAliases ?? []
	].some((id) => staticCatalogProviderIds.has(normalizeProviderId(id)))) : providers });
...
async function buildModelsJsonFingerprint(params) {
	...
	const pluginCatalogFingerprint = createHash("sha256").update(stableStringify(listPreparedPluginModelCatalogs(params.agentDir))).digest("base64url");
...
//#endregion
export { planOpenClawModelsJsonSource as n, prepareImplicitProviderStaticCatalog as r, ensureOpenClawModelsJson as t };
