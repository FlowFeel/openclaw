...
import { i as isCliRuntimeAliasForProvider } from "./model-runtime-aliases-D6C4F5xr.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-BsZayE7D.js";
import { v as MissingAgentHarnessError, x as recordAgentHarnessPreflightOwner } from "./failover-error-U3al4tnA.js";
import { d as projectAgentRunAttemptTerminal, u as normalizeAgentRunAttemptTerminal } from "./agent-run-terminal-outcome-9kJP3Yn1.js";
import { t as resolveAgentHarnessAutoSelectionHint } from "./auto-selection-Cid2o--p.js";
import { c as resolveAgentHarnessPreparedAuthSupport, l as resolveAgentHarnessPreparedRouteSupport, o as buildAgentHarnessSupportContext, s as compareHarnessSupport } from "./thinking-runtime-93ZQ8Ibj.js";
import { t as createOpenClawAgentHarness } from "./builtin-openclaw-BtmzbRwt.js";
...
import { t as assertSettledTurnFinalizationResult } from "./settled-turn-finalization-result-C2xKQp6X.js";
...
async function runSelectedAgentHarnessAttempt(params) {
	...
	if (internalParams.systemAgentTool && !isSystemAgentOnlyAllowlist(internalParams.toolsAllow)) throw new Error("OpenClaw host authority requires toolsAllow: [\"openclaw\"]");
	const ringZeroTools = internalParams.systemAgentTool ? [(await import("./system-agent-tool-CtEhhyad.js")).createSystemAgentTool(internalParams.systemAgentTool)] : [];
