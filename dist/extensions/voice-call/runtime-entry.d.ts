import { s as SessionScope } from "../../types-PE8jeqx6.js";
...
import { C as TtsDirectiveParseResult, S as TtsDirectiveOverrides, V as PluginRuntime, f as RealtimeTranscriptionProviderPlugin, g as RealtimeTranscriptionProviderConfig, h as RealtimeVoiceProviderConfig, p as RealtimeVoiceProviderPlugin, x as TalkEvent } from "../../types-CJY5tURi.js";
...
type WebhookVerificationResult = {
  ...
  verifiedRequestKey?: string; /** Release only this delivery's replay reservation when processing fails. */
  releaseReplay?: () => void;
};
...
declare class MediaStreamHandler {
  ...
  close(shutdownBarrier?: Promise<unknown>): Promise<void>;
  /**
...
declare class RealtimeCallHandler {
  ...
  private handleCall;
  private beginUserTranscriptOwnerAdoption;
  ...
  private resetUserTranscriptState;
  private clearUserTranscriptState;
  private cancelNativeConsult;
  private cancelForcedConsult;
  private resetConsultSession;
  private resetConsultSessionForContinuity;
  private cancelConsultSession;
  private isActiveBridgeOwner;
