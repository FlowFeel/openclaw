...
import { i as createPersistentDedupeImportEntry } from "../../persistent-dedupe-ImNUIds4.js";
import { a as resolveMatrixDefaultOrOnlyAccountId, n as requiresExplicitMatrixDefaultAccount } from "../../account-selection-BObnVAfj.js";
import "../../record-shared-DM43IPkv.js";
import { r as resolveMatrixCredentialsDir } from "../../storage-paths-HvTTKK7M.js";
import { a as isMatrixCredentialRevocation, c as normalizeMatrixStoredCredentials, n as MATRIX_CREDENTIALS_NAMESPACE, s as matrixCredentialsStoreKey } from "../../credentials-read-C1zRvdH3.js";
import { n as normalizeCompatibilityConfig, t as legacyConfigRules } from "../../doctor-contract-9tzufyKT.js";
...
import { a as openMatrixStorageMetaStoreOptions, i as normalizeMatrixStorageMetadata, n as hasMatrixStorageMetaStateInStore, u as writeMatrixStorageMetaStateToStore } from "../../storage-uW4ogs0b.js";
import { a as writeMatrixSyncCacheStateToStore, i as readLegacyMatrixSyncCacheState, n as hasMatrixSyncCacheStateInStore, r as openMatrixSyncCacheStoreOptions } from "../../file-sync-store-Cu5dofBt.js";
import { n as MATRIX_IDB_SNAPSHOT_LOCK_OPTIONS } from "../../idb-persistence-lock-DAJ49nZX.js";
import { r as readLegacyMatrixIdbSnapshotStateUnlocked, t as isValidMatrixIdbSnapshotJson } from "../../idb-persistence-C7UVpmI0.js";
import { a as resolveMatrixInboundDedupeStateNamespace, n as MATRIX_INBOUND_DEDUPE_TTL_MS, r as buildMatrixInboundDedupeEventKey } from "../../inbound-dedupe-xtNSUISL.js";
		...
		async migrateLegacyState(params) {
			...
			const recordCompletionIfClean = async (verifyRetirement = false) => {
				...
				try {
					...
					changes.push(`Recorded Matrix inbound dedupe migration completion (${sources.sqliteRoots.length} SQLite roots, ${sources.jsonRoots.length} JSON roots scanned)`);
				} catch (err) {
