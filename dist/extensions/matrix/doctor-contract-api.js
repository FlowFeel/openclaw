...
import { a as isMatrixCredentialRevocation, c as normalizeMatrixStoredCredentials, n as MATRIX_CREDENTIALS_NAMESPACE, s as matrixCredentialsStoreKey } from "../../credentials-read-ClBY51fb.js";
import { n as normalizeCompatibilityConfig, t as legacyConfigRules } from "../../doctor-contract-Ch1WLZu-.js";
...
import { a as openMatrixStorageMetaStoreOptions, i as normalizeMatrixStorageMetadata, n as hasMatrixStorageMetaStateInStore, u as writeMatrixStorageMetaStateToStore } from "../../storage-Drg_zZij.js";
import { a as writeMatrixSyncCacheStateToStore, i as readLegacyMatrixSyncCacheState, n as hasMatrixSyncCacheStateInStore, r as openMatrixSyncCacheStoreOptions } from "../../file-sync-store-D3Zr6b8p.js";
import { n as MATRIX_IDB_SNAPSHOT_LOCK_OPTIONS } from "../../idb-persistence-lock-DAJ49nZX.js";
import { r as readLegacyMatrixIdbSnapshotStateUnlocked, t as isValidMatrixIdbSnapshotJson } from "../../idb-persistence-CsQnPtzM.js";
import { a as resolveMatrixInboundDedupeStateNamespace, n as MATRIX_INBOUND_DEDUPE_TTL_MS, r as buildMatrixInboundDedupeEventKey } from "../../inbound-dedupe-DLly8WCB.js";
