...
import "../../provider-model-shared-Oe6yOo6H.js";
...
import { l as sanitizeEmbeddingCacheHeaders } from "../../memory-core-host-engine-embeddings-D41Yx4NL.js";
import "../../provider-auth-api-key-BBYStzXM.js";
...
import { _ as resolveOllamaApiBase, a as buildOllamaProvider, c as enrichOllamaCompletionModels, d as fetchOllamaModels, f as isOllamaCloudModel, h as queryOllamaModelShowInfo, i as buildOllamaModelDefinition, l as enrichOllamaModelsWithContext, n as buildDefaultOllamaCloudModelDefinition, o as capLocalOllamaModelContext, r as buildOllamaBaseUrlSsrFPolicy, s as capLocalOllamaProviderContext, t as readProviderBaseUrl, u as fetchLoadedOllamaModelNames, v as throwIfOllamaRequestAborted } from "../../provider-base-url-03y17KxQ.js";
import { a as resolveOllamaSetupDefaultBaseUrl, c as orderPreferredOllamaModelIds, i as promptAndConfigureOllama, n as configureOllamaNonInteractive, r as ensureOllamaModelPulled, s as findAvailableOllamaModelName } from "../../setup-DYqW2DeU.js";
import { d as resolveConfiguredOllamaProviderConfig, o as createConfiguredOllamaCompatStreamWrapper, s as createConfiguredOllamaStreamFn } from "../../stream-D_-kLZ6I.js";
import "../../api--HgfG-qv.js";
import { r as resolveThinkingProfile } from "../../provider-policy-api-DoThWsPT.js";
import { a as resolveOllamaRuntimeBaseUrl, i as resolveOllamaDiscoveryResult, n as OLLAMA_PROVIDER_ID, o as shouldUseSyntheticOllamaAuth, r as isLocalOllamaBaseUrl, t as OLLAMA_DEFAULT_API_KEY } from "../../discovery-shared-DwAZS4eG.js";
import { n as createOllamaEmbeddingProvider, t as DEFAULT_OLLAMA_EMBEDDING_MODEL } from "../../embedding-provider-CmmJhAu3.js";
import { t as createOllamaWebSearchProvider } from "../../web-search-provider-Bp5O-pue.js";
...
async function validateOllamaNonInteractive(ctx) {
	...
	if (requestedModel && isOllamaCloudModel(requestedModel)) {
		const { checkOllamaCloudAuth } = await import("../../setup-D3AXfRA-.js");
