...
import { l as sanitizeEmbeddingCacheHeaders } from "../../memory-core-host-engine-embeddings-DJe7MzzG.js";
...
import { _ as resolveOllamaApiBase, a as buildOllamaProvider, c as enrichOllamaCompletionModels, d as fetchOllamaModels, f as isOllamaCloudModel, h as queryOllamaModelShowInfo, i as buildOllamaModelDefinition, l as enrichOllamaModelsWithContext, n as buildDefaultOllamaCloudModelDefinition, o as capLocalOllamaModelContext, r as buildOllamaBaseUrlSsrFPolicy, s as capLocalOllamaProviderContext, t as readProviderBaseUrl, u as fetchLoadedOllamaModelNames, v as throwIfOllamaRequestAborted } from "../../provider-base-url-BEtrMUhw.js";
import { a as resolveOllamaSetupDefaultBaseUrl, c as orderPreferredOllamaModelIds, i as promptAndConfigureOllama, n as configureOllamaNonInteractive, r as ensureOllamaModelPulled, s as findAvailableOllamaModelName } from "../../setup-B3fWWWuY.js";
import { d as resolveConfiguredOllamaProviderConfig, o as createConfiguredOllamaCompatStreamWrapper, s as createConfiguredOllamaStreamFn } from "../../stream-CYzmT9Wo.js";
import "../../api-DmSQEEoG.js";
import { r as resolveThinkingProfile } from "../../provider-policy-api-DoThWsPT.js";
import { a as resolveOllamaRuntimeBaseUrl, i as resolveOllamaDiscoveryResult, n as OLLAMA_PROVIDER_ID, o as shouldUseSyntheticOllamaAuth, r as isLocalOllamaBaseUrl, t as OLLAMA_DEFAULT_API_KEY } from "../../discovery-shared-DSzgvtKN.js";
import { n as createOllamaEmbeddingProvider, t as DEFAULT_OLLAMA_EMBEDDING_MODEL } from "../../embedding-provider-D6Zg4Hp-.js";
import { t as createOllamaWebSearchProvider } from "../../web-search-provider-CcCyLt7g.js";
...
async function validateOllamaNonInteractive(ctx) {
	...
	if (requestedModel && isOllamaCloudModel(requestedModel)) {
		const { checkOllamaCloudAuth } = await import("../../setup-ggSQdJcT.js");
