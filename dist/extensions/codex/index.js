...
import { a as closeCodexStartupClientBestEffort, d as unsubscribeCodexThreadBestEffort, h as isCodexNotificationForTurn, o as interruptCodexTurnAndWaitBestEffort, p as getCodexAppServerTurnRouter, t as resumeCodexAppServerThread, u as retireUnsafeCodexTurnClientBestEffort } from "../../thread-resume-CDsDVTvc.js";
import { r as isAssistantCommentaryCompletionNotification } from "../../attempt-notifications-C8Uxu1kc.js";
import { a as assertCodexThreadStartResponse } from "../../protocol-validators-Cf6MSlge.js";
import { i as defaultCodexAppInventoryCache, r as buildCodexPluginAppCacheKey } from "../../plugin-app-cache-key-DI-s9sbo.js";
import { J as pluginReadParams, K as ensureCodexPluginActivation, _ as CODEX_NATIVE_PERSONALITY_NONE, q as isOpenAiCuratedMarketplace, y as resolveCodexAppServerRequestModelSelection } from "../../thread-lifecycle-DtE7JXiG.js";
import "../../incognito-session-C8lb8Cnn.js";
import { t as buildCodexMediaUnderstandingProvider } from "../../media-understanding-provider-CoM_rW2X.js";
import { n as describeControlFailure, t as CODEX_CONTROL_METHODS } from "../../capabilities-CmmEJYpp.js";
import { r as formatCodexDisplayText } from "../../command-formatters-YWRC0PN_.js";
import { t as resolveCodexAppServerForModelProvider } from "../../app-server-policy-DE2iXNzD.js";
import { n as resolveCodexNativeExecutionBlock, r as resolveCodexNativeSandboxBlock } from "../../sandbox-guard-gphn8P0A.js";
import { d as CODEX_NATIVE_EXECUTION_AUTH_ERROR, f as canMutateCodexHost, u as trackCodexConversationActiveTurn } from "../../conversation-control-CurgzxBe.js";
...
import { d as resumeCodexCliSessionOnNode, l as listCodexCliSessionsOnNode, o as createCodexCliSessionNodeHostCommands, s as createCodexCliSessionNodeInvokePolicies, t as codexControlRequest, u as resolveCodexCliSessionForBindingOnNode } from "../../command-rpc-CkpBGlf3.js";
import { i as withCodexAppServerJsonClient, r as requestCodexAppServerJson } from "../../request-CIyA76N2.js";
import { i as createCodexSessionCatalogNodeInvokePolicies, n as createCodexSessionCatalogControl, o as assertCodexArchiveDescendantsUnowned, r as createCodexSessionCatalogNodeHostCommands, t as codexSessionCatalogRuntime } from "../../session-catalog-G0QOVtWe.js";
...
function createLazyCodexAppServerBindingStore(state) {
	let resolved;
	const store = () => resolved ??= import("../../session-binding-Bk60gUoc.js").then(({ createCodexAppServerBindingStore }) => createCodexAppServerBindingStore(state));
	return {
...
async function loadDefaultCodexSubcommandHandler() {
	const { handleCodexSubcommand } = await import("../../command-handlers-TB_0yCN-.js");
...
const loadCodexWebSearchRuntime = createLazyRuntimeModule(() => import("../../web-search-provider.runtime-Cl13jhVR.js"));
...
var codex_default = definePluginEntry({
	...
	register(api) {
		...
		api.on("after_compaction", async (event, ctx) => {
			...
			const { sessionBindingIdentity } = await import("../../session-binding-Bk60gUoc.js");
			const identity = sessionBindingIdentity({
				sessionId,
