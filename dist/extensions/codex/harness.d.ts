...
import { y as AgentHarness, z as PluginRuntime } from "../../types-CHzJhI3f.js";
...
declare const threadBindingSchema: ZodObject<{
  ...
  cwd: ZodString;
  rolloutPath: ZodCatch<ZodOptional<ZodString>>;
  ...
  nativeSkillIsolationFingerprint: ZodCatch<ZodOptional<ZodString>>;
