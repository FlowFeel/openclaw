...
import { c as resolveMemorySearchConfig, m as DEFAULT_AGENT_COMPACTION_RESERVE_TOKENS_FLOOR } from "../../config-utils-C6i4U27o.js";
import { t as resolveMemoryBackendConfig } from "../../backend-config-BMIViikb.js";
...
import "../../memory-core-host-runtime-files-ChmJGRn8.js";
...
import { t as registerShortTermPromotionDreaming } from "../../dreaming-BYjQVwEH.js";
import { i as normalizeSessionBackfillSelection, n as executeSessionBackfillBatch, t as executeSessionBackfill } from "../../session-backfill-ZbIMCCl-.js";
...
const loadMemoryToolsModule = createLazyRuntimeModule(() => import("../../tools-BxsK-ZKh.js"));
const loadStandingIntentsModule = createLazyRuntimeModule(() => import("../../standing-intents-C9BgWg9a.js"));
const loadStandingIntentToolModule = createLazyRuntimeModule(() => import("../../standing-intents-tool-C269ChnN.js"));
const loadRuntimeProviderModule = createLazyRuntimeModule(() => import("../../runtime-provider-Bj8gtcAM.js"));
...
var memory_core_default = definePluginEntry({
	...
	register(api) {
		...
		api.registerCommand({
			...
			handler: async (ctx) => {
				const { handleDreamingCommand } = await import("../../dreaming-command-B92YDeYm.js");
