...
import { l as resolveInlineImageJsonResponseMaxBytes, n as generatedImageAssetFromBase64 } from "../../image-generation-DS34MOKs.js";
	...
	return {
		...
		async generateImage(req) {
			...
			try {
				...
				const payload = await readProviderJsonResponse(res, "google.image-generation", { maxBytes: resolveInlineImageJsonResponseMaxBytes(GOOGLE_MAX_IMAGE_RESULTS, resolveGeneratedMediaMaxBytes(req.cfg, "image")) });
				let imageIndex = 0;
				const images = [];
