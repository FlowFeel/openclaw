...
import { s as resolveGoogleGemini3ThinkingLevel } from "../../stream-payload-utils-BcOTedPh.js";
import "../../runtime-env-DEukRWMB.js";
import "../../number-runtime-C6TGSEc_.js";
import "../../string-coerce-runtime-CLK2YdzD.js";
import "../../secret-input-Dsfz4fVL.js";
import "../../media-runtime-CSmTPMNF.js";
import { H as REALTIME_VOICE_AUDIO_FORMAT_PCM16_24KHZ, V as REALTIME_VOICE_AUDIO_FORMAT_G711_ULAW_8KHZ, m as REALTIME_VOICE_AGENT_CONSULT_TOOL_NAME } from "../../realtime-session-harness-BwpuC40T.js";
...
var GoogleRealtimeVoiceBridge = class {
	...
	submitToolResult(callId, result, options) {
		...
		try {
			...
			if (session && canSendImmediately) session.sendToolResponse({ functionResponses: [functionResponse] });
			else this.queueToolResponseForReconnect(callId, functionResponse);
	...
	queueToolResponseForReconnect(callId, functionResponse) {
