...
import { n as condenseToolParameters, t as globalToolCommandLogger } from "./tool-command-logger-DA1CKbVE.js";
			...
			execute: async (...args) => {
				...
				try {
					...
					try {
						...
						const heapPct = mem && mem.heapTotal > 0 ? mem.heapUsed / mem.heapTotal * 100 : void 0;
