...
import { r as loadPluginManifest } from "./manifest-BUOsMMgJ.js";
...
import { i as passesManifestOwnerBasePolicy, n as isActivatedManifestOwner, r as isBundledManifestOwner, t as hasExplicitManifestOwnerTrust } from "./manifest-owner-policy-Cvik9_1s.js";
import "./defaults-CdX9UGcX.js";
import { l as normalizeStaticProviderModelId, t as createStaticProviderModelIdNormalizer } from "./model-ref-shared-BEKlpylb.js";
import { t as listOpenClawPluginManifestMetadata } from "./manifest-metadata-scan-XLgrv6yg.js";
import { u as isSecretRefHeaderValueMarker } from "./model-auth-markers-z4js65k2.js";
import { n as attachModelProviderMetadataOwners, p as sanitizeConfiguredModelProviderRequest, r as attachModelProviderRequestTransport, u as resolveProviderRequestConfig } from "./provider-request-config-C5exA1l5.js";
import { d as resolveOwningPluginIdsForProviderRef, n as resolveBundledProviderCompatPluginIds, t as resolveActivatableProviderOwnerPluginIds } from "./providers-YwyHR_AL.js";
import { t as attachModelProviderLocalService } from "./provider-local-service-CH_EvCyJ.js";
import { n as normalizeGoogleApiBaseUrl } from "./google-api-base-url-UBNiBOzj.js";
import { i as resolveRuntimePluginDiscoveryProviders, n as normalizePluginDiscoveryResult, o as runProviderStaticCatalog } from "./provider-discovery-UXN1ZFRC.js";
...
async function loadBundledProviderStaticCatalogContextModels(params = {}) {
	...
	const discoveryEntryPluginIds = new Set((metadataSnapshot?.manifestRegistry?.plugins ?? loadPluginManifestRegistry({
		config: params.cfg,
		workspaceDir: params.workspaceDir,
		env
...
//#endregion
export { resolveBundledProviderStaticCatalogModel as a, createStaticModelIdMatcher as c, normalizeResolvedTransportApi as d, resolveProviderModelInput as f, loadBundledProviderStaticCatalogContextModels as i, staticModelIdMatches as l, createBundledProviderStaticCatalogContextResolver as n, resolveBundledStaticCatalogModel as o, sanitizeModelHeaders as p, createBundledStaticCatalogModelResolver as r, resolveManifestModelCatalogProviderAliasMetadata as s, bundledStaticCatalogProviderUsesRuntimeAugment as t, buildInlineProviderModels as u };
