...
import { Q as cronTaskRecordStoreKey, rt as resolveCronTaskRecordTimestamp } from "./openclaw-state-db-BU55lNCH.js";
...
import { g as isPluginStateDatabaseOpen, y as sweepExpiredPluginStateEntries } from "./plugin-state-store-aPYaqCXn.js";
...
import { i as isAcpTurnActive, t as getAcpSessionManager } from "./manager-b2r7oh2O.js";
import { M as resolveTaskForLookupToken, N as ensureTaskRegistryReady, S as hasActiveTaskForChildSessionKey, T as listTaskRecords, _ as maybeDeliverTaskTerminalUpdate, c as markTaskTerminalById, g as isBackgroundExecTask, o as markTaskLostById, p as isHarnessOwnedSubagentTask, u as setTaskCleanupAfterById, x as getTaskById, y as deleteTaskRecordById } from "./task-registry-BbNCFm_L.js";
import { s as listTaskRegistryRecordsByRuntimeSourceIdFromSqlite } from "./task-registry.store.sqlite-7VY-WxbM.js";
...
import { d as tryRecoverTaskBeforeMarkLost, s as getDetachedTaskLifecycleRuntime } from "./detached-task-runtime-CO42wZ7V.js";
import { n as readAcpSessionEntry, t as listAcpSessionEntries } from "./session-meta-DqFXJodN.js";
import "./sessions-CBo4LOdS.js";
import { s as isCronJobActive } from "./active-jobs-BGi1uzPV.js";
import { n as isBackgroundExecSessionActive } from "./bash-process-control-m9SC-S8M.js";
...
const HARNESS_OWNED_SUBAGENT_RECONCILE_GRACE_MS = 30 * 6e4;
...
const defaultTaskRegistryMaintenanceRuntime = {
	...
	listSessionEntries: listSqliteSessionEntriesReadOnly,
	resolveStorePath,
