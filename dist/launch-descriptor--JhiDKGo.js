...
import { N as WorkerTranscriptMessageSchema, g as WorkerConnectRequestFrameSchema } from "./worker-admission-cYaTLkLk.js";
import { c as WorkerInferenceModelRefSchema, l as WorkerInferenceOptionsSchema } from "./worker-inference-jzapa-pT.js";
import { n as isWorkerLocalToolName } from "./tool-authority-CJ-HJhS-.js";
...
function parseToolAuthority(value) {
	if (!isRecord(value) || !hasExactKeys(value, ["allowedToolNames"]) || !Array.isArray(value.allowedToolNames) || !value.allowedToolNames.every(isWorkerLocalToolName) || new Set(value.allowedToolNames).size !== value.allowedToolNames.length) return;
