...
import { i as readPromotionClaims, n as markPromotionSlugsNotified, r as maybeRefreshPromotionsFeed, t as listLivePromotionEntries } from "./promotions-feed-EtiwDgXG.js";
...
function startPromotionsFeedRefresh(nowMs = Date.now()) {
	return {
		nowMs,
		statePromise: maybeRefreshPromotionsFeed({ nowMs }).catch(() => void 0)
	};
}
/**
...
//#endregion
export { applyPromotionClaimTags, printAvailablePromotionsSection, startPromotionsFeedRefresh };
