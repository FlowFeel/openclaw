...
import { Sf as SESSION_OBSERVER_HEALTH_VALUES } from "./src-BSn6va4B.js";
import { a as terminalHealthFor } from "./session-activity-notes-C_nHogVp.js";
...
function rememberSessionObserverDormantRun(runs, floors, run) {
	...
	while (runs.size > MAX_DORMANT_RUNS) {
		...
		runs.delete(oldest);
		if (evicted) rememberSessionObserverRevisionFloor(floors, sessionObserverScopeKey(evicted.sessionKey, evicted.agentId), {
...
function loadCompletionRuntime() {
	completionRuntimePromise ??= import("./simple-completion-runtime-CapmVK5N.js");
