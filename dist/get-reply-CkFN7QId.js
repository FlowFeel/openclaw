...
import { c as resolveAgentDir, n as listAgentEntries, o as resolveAgentConfig, u as resolveAgentWorkspaceDir } from "./agent-scope-config-Dusa8eSA.js";
import { n as normalizeAgentId } from "./agent-id-DDgUze4y.js";
import { a as isSubagentSessionKey, c as parseAgentSessionKey, n as isAcpSessionKey } from "./session-key-utils-02xWdGSz.js";
import { a as buildAgentMainSessionKey, u as normalizeMainKey } from "./session-key-DtTE9-Tg.js";
import { t as DEFAULT_AGENT_WORKSPACE_DIR } from "./workspace-default-CK-leyvS.js";
import { at as resolveOwnerPromptNumbers, r as getRuntimeConfig } from "./io-BsQc3Kgy.js";
...
import { o as findChatChannelMeta } from "./registry-DqHlaOgA.js";
import { r as getLoadedChannelPluginForRead } from "./registry-loaded-DSocaiGy.js";
import { a as listOpenAIAuthProfileProvidersForAgentRuntime, c as resolveContextConfigProviderForRuntime } from "./openai-routing-Db2edxk0.js";
import { t as modelKey } from "./model-key-BaNhQShd.js";
import { D as hasSessionAutoModelFallbackProvenance, f as resolveAgentSkillsFilter, g as resolveSessionAgentId, i as hasLegacyAutoFallbackWithoutOrigin, p as resolveAutoFallbackPrimaryProbe, t as clearAutoFallbackPrimaryProbeSelection } from "./agent-scope-DyEposw2.js";
import { a as normalizeElevatedLevel, c as normalizeTraceLevel, i as isSessionDefaultDirectiveValue, o as normalizeReasoningLevel, s as normalizeThinkLevel, u as normalizeVerboseLevel } from "./thinking.shared-k6K-6JHM.js";
...
import { n as isThinkingLevelSupported, o as resolveSupportedThinkingLevel, t as formatThinkingLevels } from "./thinking-CTxMHCzD.js";
...
import { c as normalizeSessionDeliveryState, d as sessionDeliveryOrigin, f as sessionDeliveryRoute, n as deliveryContextFromSession, o as normalizeDeliveryChannelRoute, r as deliveryContextKey, s as normalizeDeliveryContext, u as sessionDeliveryChannel } from "./delivery-context.shared-DR6KpKlV.js";
import "./message-channel-constants-76XnXM8q.js";
import { n as canonicalizeMainSessionAlias } from "./main-session-Bjm_i_Af.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, l as resolveStorePath } from "./paths-DSnYpBD3.js";
import { Ct as buildSessionCreationStamp, st as loadSqliteSessionEntry, wt as sessionEntryForkedFromParent, yt as resolveSessionStorePathForScope } from "./session-accessor.sqlite-CtCo5VZ6.js";
import { a as normalizeChannelId, t as getChannelPlugin } from "./registry-DOSZ6AfI.js";
...
import { a as isInternalMessageChannel } from "./message-channel-Bo27VP7K.js";
import { a as resolveGroupSessionKey } from "./store-entry-shape-CTwpu-C_.js";
import { $ as conversationIdentityFromMsgContext, at as deriveSessionMetaPatch } from "./targets-Bz-meSET.js";
import { t as formatSqliteSessionFileMarker } from "./legacy-sqlite-marker-COPKCuIN.js";
import { T as DEFAULT_RESET_TRIGGERS, _t as interruptSessionWorkAdmissions, q as resolveMaintenanceConfigFromInput, wt as runExclusiveSessionStoreWrite, xt as runExclusiveSessionLifecycleMutation, y as resolveAgentHarnessSessionContextError } from "./session-entry-slot-keys-DPRQmSpa.js";
import { a as hasStagedMediaFacts, l as normalizeMediaFacts, s as isImageMediaFact } from "./media-facts-D_wLZOa9.js";
import { M as loadReplySessionInitializationSnapshot, j as commitReplySessionInitialization } from "./session-accessor-D5Or7WgI.js";
...
import { g as isWorkspaceBootstrapPending, p as ensureAgentWorkspace } from "./workspace-aPJlJwqC.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-CS3ZCTG9.js";
import { g as registerMainSessionGroupWatch, n as classifySessionStateActor, t as acknowledgeSessionStateNotices, u as recordSessionCreated, y as decodeSessionStateNoticeContextKey } from "./session-state-events-COmXZrBv.js";
import { a as enqueueSystemEvent, l as peekSystemEventEntries, t as consumeSelectedSystemEventEntries } from "./system-events-BNZxjP0P.js";
import { a as isNativeCommandTurn, c as resolveCommandTurnTargetSessionKey, r as isAuthorizedTextSlashCommandTurn, s as resolveCommandTurnContext } from "./command-turn-context-chpcv6RY.js";
import { t as getSessionBindingService } from "./session-binding-service-DfYoR_Na.js";
import { i as setAbortMemory, n as isAbortRequestText, t as getAbortMemory } from "./abort-primitives-BReFL4mn.js";
import { t as hasControlCommand } from "./command-detection-DovQ96XW.js";
import { n as isInternalSourceReplyChannel } from "./source-reply-delivery-mode-Dp5l5GTP.js";
import "./delivery-context-B7i0AGns.js";
import { n as resolveAgentTimeoutMs } from "./timeout-BEGWfRGM.js";
import { D as resolveActiveReplyRunThreadId, E as resolveActiveReplyRunSessionId, N as waitForReplyRunEndBySessionId, g as isReplyRunActiveForSessionId, o as abortReplyRunBySessionId, t as REPLY_RUN_IDLE_SETTLE_TIMEOUT_MS, w as replyRunRegistry, y as isReplyRunStreamingForSessionId } from "./reply-run-registry-CFY_Ts2Y.js";
import { a as isSessionWorkStartInvalidatedError, o as resolveSessionLifecycleTimestamps, r as hasTerminalMainSessionTranscriptNewerThanRegistry, s as resolveSessionWorkStartError } from "./lifecycle-Dw-f5gZg.js";
...
import { a as resolveEffectiveAgentRuntime, n as hasResolvedThinkingCatalogEntry } from "./thinking-runtime-Ct74CGZn.js";
import { t as resolveFastModeState } from "./fast-mode-DRb2pnqM.js";
import { n as normalizeQueueDropPolicy, r as normalizeQueueMode } from "./settings-DAWZCttJ.js";
import { c as isInterSessionInputProvenance, r as annotateInterSessionPromptText } from "./input-provenance-CYGbY89H.js";
import { o as resolveReplyToMode } from "./reply-threading-2qXVyLek.js";
import { o as HEARTBEAT_TRANSCRIPT_PROMPT, u as stripHeartbeatToken } from "./heartbeat-Cw1AzhxC.js";
import { o as sanitizePendingFinalDeliveryText, t as PENDING_FINAL_DELIVERY_CLEAR_PATCH } from "./pending-final-delivery-DL2bB7Gi.js";
import { n as buildMainSessionRecoveryClearPatch } from "./main-session-recovery-clear-BngYLTap.js";
import { a as createUserTurnTranscriptRecorder, c as resolvePersistedUserTurnText } from "./user-turn-transcript-BTXVzeiZ.js";
import { n as clearCommandLane, s as getQueueSize } from "./command-queue-DxY-0HMA.js";
...
import { n as resolveChannelGroupRequireMention } from "./group-policy-CBMV7DIY.js";
import { z as normalizeExecTarget } from "./exec-approvals-sCmCk_jQ.js";
import { t as buildOutboundSessionContext } from "./session-context-DdqCb4cM.js";
import { d as isChannelProgressDraftWorkToolName, f as isCommandToolName } from "./streaming-Df3LUUGR.js";
import { t as collectTextContentBlocks } from "./content-blocks-DRK0dze4.js";
import { M as resolveBootstrapMode } from "./openclaw-tools-B_OHwLQN.js";
...
import { a as isModelSelectionLocked, n as MODEL_SELECTION_LOCKED_RESET_MESSAGE, r as ModelSelectionLockedError, t as MODEL_SELECTION_LOCKED_MESSAGE } from "./model-overrides-BT6Lelev.js";
import { i as resolveParentForkDecision, r as forkSessionFromParent } from "./session-fork-DpLaEENe.js";
...
import { t as resolveQueueSettings } from "./queue-BZLakrew.js";
import { i as normalizeInboundTextNewlines, t as finalizeInboundContext } from "./inbound-context-BIpjK7pv.js";
import { i as toInternalMessagePreprocessedContext, n as deriveInboundMessageHookContext, s as toInternalMessageTranscribedContext } from "./message-hook-mappers-C7WE74nE.js";
...
import { i as updateAmbientTranscriptWatermark } from "./ambient-transcript-watermark-BDgvVGil.js";
import { i as isExecCompletionEvent } from "./heartbeat-events-filter-sLs_6Z5x.js";
import { a as appendChannelPromptContext, c as buildInboundMediaNoteProjection, n as MEDIA_ONLY_USER_TEXT, t as isReasoningTagProvider } from "./provider-utils-DQdO9BDc.js";
import { a as resolveTimezone, n as formatUtcTimestamp, r as formatZonedTimestamp } from "./format-datetime-Bp7Mn3G9.js";
import { n as resolveEmbeddedFullAccessState } from "./sandbox-info-CL0qtibX.js";
...
import { i as setChannelSourceTurnId, n as readChannelSourceTurnId, o as shouldMintChannelSourceTurnId, t as buildChannelSourceTurnId } from "./source-turn-id-raOki4r6.js";
import { t as cleanupBrowserSessionsForLifecycleEnd } from "./browser-lifecycle-cleanup-DN83-_E6.js";
import { t as resolveDefaultModel } from "./directive-handling.defaults-GodaGG1U.js";
...
import { a as createReplyTimingTracker, d as resolveSilentReplySettings, i as resolveEffectiveReplyRoute, n as createReplySessionEntryHandle, r as isSystemEventProvider, s as admitReplyTurn } from "./session-entry-handle-DCkmpsdB.js";
import { s as takeCommandSessionMetadataChangesFromTargets } from "./commands-goal-xCDJy0Gz.js";
import { i as resolveConversationBindingContextFromMessage } from "./conversation-binding-input-5YJ3bL_E.js";
import { n as resolveRoutedDeliveryThreadId, t as isSlackDirectRoutedThreadTurn } from "./routed-delivery-thread-DAzW9Z6U.js";
import { t as resolveChannelModelOverride } from "./model-overrides-BSS0htXj.js";
import { i as resolveStoredModelOverride, t as isStaleHeartbeatAutoFallbackOverride } from "./stored-model-override-CIi2XjrS.js";
...
import { n as hasInboundMedia, r as hasInboundMediaForUnderstanding, t as hasInboundAudio } from "./inbound-media-D2C7tI4T.js";
import { a as shouldHandleFastReplyTextCommands, c as shouldUseReplyFastTestRuntime, d as resolveSessionResetCommand, f as usesPublishedReplyRuntime, i as resolveGetReplyConfig, n as buildFastReplyCommandContext, o as shouldUseReplyFastDirectiveExecution, p as stageRemoteInboundMediaIfNeeded, r as initFastReplySessionState, s as shouldUseReplyFastTestBootstrap, t as resolveRunTypingPolicy } from "./typing-policy-Bca_69Ft.js";
import { n as resolveOriginMessageProvider } from "./origin-routing-DR55bzxd.js";
import { n as shouldHandleTextCommands } from "./commands-text-routing-CYeQwY3X.js";
import { a as stripMentions, o as stripStructuralPrefixes } from "./mentions-Dt1nBxBr.js";
import { r as HISTORY_CONTEXT_MARKER } from "./history-DLKGD0Dj.js";
import { n as shouldUseFromAsSenderFallback } from "./command-auth-DE3S77jY.js";
...
import { t as resolveEffectiveResetTargetSessionKey } from "./acp-reset-target-BM9GwRbs.js";
import { a as buildSessionStartHookPayload, i as buildSessionEndHookPayload, r as noteActiveSessionForShutdown, t as forgetActiveSessionForShutdown } from "./active-sessions-shutdown-tracker-CcnjeX1j.js";
import { n as clearSessionResetRuntimeState, t as resolveResetPreservedSelection } from "./reset-preserved-selection-D0zrb_wv.js";
import { t as emitSessionAutoResetHook } from "./session-auto-reset-C9aI3svj.js";
import { a as resolveEnvelopeFormatOptions } from "./envelope-DYPQHVWk.js";
import { n as runWithSessionInitConflictRetry, t as ReplySessionInitConflictError } from "./session-init-conflict-retry-CJwFJVpg.js";
...
import { t as resolveBlockStreamingChunking } from "./block-streaming-BhQhhRSe.js";
import { t as buildCommandContext } from "./commands-context-DhunfJeo.js";
import { n as resolveModelRuntimeDirective } from "./directive-handling.model-runtime-DLGWTQtA.js";
import { n as resolveModelSelectionFromDirective, t as maybeHandleUnexpectedNativeDirectiveArguments } from "./directive-handling.native-B-OqCahU.js";
import { n as resolveSessionAuthProfileOverride } from "./session-override-CqXr7YEI.js";
import { t as resolveContextTokens } from "./model-selection-context-CdOpSj6c.js";
import { n as createModelSelectionState, t as createFastTestModelSelectionState } from "./model-selection-v798-5Na.js";
import { n as extractExplicitGroupId, t as formatElevatedUnavailableMessage } from "./elevated-unavailable-DPhJIJLf.js";
import { t as resolveRuntimePolicySessionKey } from "./runtime-policy-session-key-C23Br4Oe.js";
import { a as resolveSkillCommandInvocation, i as listReservedChatSlashCommandNames, o as resolveSkillReferenceInvocations, r as hasSkillReferenceCandidate } from "./chat-commands-Cx9y1U0p.js";
import { t as persistReplySessionEntry } from "./session-entry-persistence-BnKc-1eY.js";
import { n as resolvePreparedReplyQueueState } from "./get-reply-run-queue-BpRZxGwG.js";
import { a as buildInboundUserContextPrefix, c as resolveInboundUserContextPromptJoiner, i as buildInboundMetaSystemPrompt, l as resolveActiveRunQueueAction, o as formatActiveGoalContext, r as resolveTypingMode, t as resolveCurrentTurnImages } from "./current-turn-images-CJ8h1qNX.js";
import { t as buildChannelSummary } from "./channel-summary-Yepw43ON.js";
import { n as consumeSessionSkillSuggestion } from "./skill-suggestions-B52bOJwy.js";
import { n as resolveEffectiveToolInventory } from "./tools-effective-inventory-qqe1xxdf.js";
import { n as flushSessionActivityAssistantNote, r as noteSessionActivityEvent, t as createSessionActivityNoteState } from "./session-activity-notes-BcL00ri7.js";
import { t as PROGRESS_STATUS_PREAMBLE_FRESH_MS } from "./progress-draft-compositor-CaMXsbv8.js";
import { a as sanitizeProgressStatusText } from "./progress-draft-status-text-CNItMpsR.js";
import { t as isResetAuthorizedForContext } from "./reset-authorization-BgalSUJ8.js";
...
const directiveLevelsLoader = createLazyImportLoader(() => import("./directive-handling.levels-93-cycPH.js"));
const directiveImplLoader = createLazyImportLoader(() => import("./directive-handling.impl-DPJq0Ddz.js"));
...
async function applyInlineDirectiveOverrides(params) {
	...
	const canPersistStickyModelSelection = Array.isArray(ctx.GatewayClientScopes) ? ctx.GatewayClientScopes.includes("operator.admin") : command.senderIsOwner;
...
async function resolveReplyDirectives(params) {
	...
	let parsedDirectives = parseInlineDirectives(commandText, {
		...
		nativeCommand: command.isAuthorizedSender && isNativeCommandTurn(commandTurn) && commandTurn.commandName ? resolveNativeReplyDirectiveCommand((await loadCommandsRegistry()).findCommandByNativeName(commandTurn.commandName, command.channel, { includeBundledChannelFallback: false })?.key) : void 0
	});
	...
	if ((parsedDirectives.hasThinkDirective || parsedDirectives.hasVerboseDirective || parsedDirectives.hasTraceDirective || parsedDirectives.hasFastDirective || parsedDirectives.hasReasoningDirective || parsedDirectives.hasElevatedDirective || parsedDirectives.hasExecDirective || parsedDirectives.hasModelDirective || parsedDirectives.hasQueueDirective) && !parsedDirectives.nativeCommand) {
	...
	let cleanedBody = (() => {
		...
		if (preserveAgentText) return existingBody;
...
const skillToolDispatchRuntimeLoader = createLazyImportLoader(() => import("./tool-dispatch-Cxs4Y7xM.js"));
const abortCutoffRuntimeLoader = createLazyImportLoader(() => import("./abort-cutoff.runtime.js"));
const commandsRuntimeLoader$1 = createLazyImportLoader(() => import("./commands.runtime-BkdI2E8z.js"));
...
async function handleInlineActions(params) {
	...
	const hasSkillReferences = command.isAuthorizedSender && ctx.Surface === "webchat" && hasSkillReferenceCandidate(initialCleanedBody);
...
const commandsRuntimeLoader = createLazyImportLoader(() => import("./commands.runtime-BkdI2E8z.js"));
const skillCommandsRuntimeLoader = createLazyImportLoader(() => import("./chat-commands.runtime.js"));
const statusCommandRuntimeLoader = createLazyImportLoader(() => import("./commands-status-DQlnb4cD.js"));
...
const embeddedAgentRuntimeLoader = createLazyImportLoader(() => import("./embedded-agent.runtime-BD_8SrBz.js"));
...
async function prepareReplyRunAdmission(context) {
	...
	const resolvePreparedSessionState = () => {
		const latestSessionEntry = sessionStore && sessionKey ? sessionStore[sessionKey] ?? (storePath ? loadSqliteSessionEntry({
			storePath,
			sessionKey,
	...
	const shouldSteer = !isRoomEvent && activeRunAcceptsCurrentThread && !context.isHeartbeat && !effectiveResetTriggered && resolvedQueue.mode === "steer";
...
function resolvePromptSourceReplyMode(params) {
	...
	const sourceReplyDeliveryMode = params.promptSessionCtx.InboundEventKind === "room_event" && !isInternalPromptChannel ? "message_tool_only" : isInternalPromptChannel && params.opts?.sourceReplyDeliveryMode === void 0 ? "automatic" : params.opts?.sourceReplyDeliveryMode;
	return {
		sourceReplyDeliveryMode,
		sessionPromptSourceReplyDeliveryMode: params.opts?.sessionPromptSourceReplyDeliveryMode ?? sourceReplyDeliveryMode
	};
}
//#endregion
...
async function prepareReplyRunContext(params) {
	...
	const { sourceReplyDeliveryMode, sessionPromptSourceReplyDeliveryMode } = resolvePromptSourceReplyMode({
		promptSessionCtx,
		opts
	});
	...
	const refreshInboundContextAfterAdmissionWait = async () => {
		if (isHeartbeat) return;
		const latestSessionEntry = storePath && sessionKey ? loadSqliteSessionEntry({
			storePath,
			sessionKey,
			readConsistency: "latest"
	...
	const prefixedBodyBase = heartbeatRunScope === "commitment-only" ? promptEnvelopeBase.effectiveBaseBody : await applySessionHints({
...
async function executePreparedReplyRun(state) {
	const { context, resolvedThinkLevel, thinkingCatalog, skillsSnapshot, prefixedCommandBody, queuedBody, transcriptBody, transcriptCommandBody, promptMedia, currentInboundContext, isRoomEvent, providedReplyOperation, preparedSessionState, resolvedQueue, embeddedAgentRuntime, resolveActiveEmbeddedSessionId, resolvePreparedSessionState, runReplyAgent, queueKey, shouldSteer, shouldFollowup, isActive, isStreaming, authProfileId, authProfileIdSource } = state;
	const { params, runtimePolicySessionKey, isHeartbeat, traceRunPhase, promptSessionCtx, inboundEventKind, sourceReplyDeliveryMode, silentReplyPromptMode, useFastReplyRuntime, fullAccessState, extraSystemPromptParts, extraSystemPromptStatic, cliSessionBindingFacts, baseBodyTrimmedRaw, effectiveResetTriggered, isBareSessionReset, workspaceDir, hasUserBody, shouldInjectGroupIntro, typingMode, allowEmptyAssistantReplyAsSilent } = context;
...
const loadDeliverRuntime = createLazyPromiseLoader(() => import("./runtime-s5Yw1b3o.js"), { cacheRejections: true }).load;
...
async function initSessionStateAttemptLocked(params, attemptContext, staleSnapshotRetried, lifecycleMutationIdentity) {
	...
	const lastThreadIdRaw = isSystemEvent ? baseDeliveryContext?.threadId : ctx.MessageThreadId ?? ctx.TransportThreadId ?? (isThread ? baseDeliveryContext?.threadId : void 0);
...
async function getReplyFromConfig(ctx, opts, configOverride) {
	...
	if (usePublishedModelRuntime && !isFastTestEnv) {
		const owner = await (await import("./prepared-model-catalog-CDZ2A_-7.js")).loadResolvedPublishedModelCatalogOwner({ agentId });
		if (!publishedModelCatalogOwnerMatchesAgent(owner, agentId)) throw new Error(`reply model catalog owner changed from ${agentId} to ${owner.agentId}`);
		cfg = owner.config;
		...
		if (opts?.isHeartbeat) {
			if (classifyHeartbeatPendingFinalDelivery(text, resolveHeartbeatAckMaxChars(cfg, agentId)).shouldClear) {
				...
				if (sessionKey && storePath) {
					const { updateSessionEntry } = await import("./session-accessor-CEi8QDQp.js");
