...
import { n as CLI_OUTBOUND_SEND_FACTORY } from "./outbound-send-deps-CtctZGaJ.js";
...
function createDefaultDeps() {
	...
	const resolveSender = (channelId) => createLazySender(channelId, async () => {
		const { createChannelOutboundRuntimeSend } = await import("./channel-outbound-send-CYgyZgvP.js");
