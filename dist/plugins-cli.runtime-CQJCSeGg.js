...
const loadPluginsStatus = createModuleLoader(() => import("./status-CoKWGsHn.js"));
const loadPluginSlotSelection = createModuleLoader(() => import("./slot-selection-PLLC9Vc9.js"));
...
async function runPluginMarketplaceRefreshCommand(opts) {
	...
	const { clearManagedPluginOfficialCatalogCache } = await import("./management-service-BBqJtsmX.js");
