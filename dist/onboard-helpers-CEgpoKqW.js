...
import { d as movePathToTrash } from "./fs-safe-DVaClkIX.js";
import { d as resolveConfigDir, h as shortenHomePath, m as shortenHomeInString } from "./utils-Bs67j6-3.js";
...
import "./control-ui-links-Ci1IGfKN.js";
...
import "./browser-open-Q4xq7OR_.js";
import { r as listAgentSessionDirs } from "./cleanup-utils-CGuNqv7r.js";
...
async function handleReset(scope, workspaceDir, runtime) {
	...
	for (const sessionDir of sessionDirs) await moveToTrash(sessionDir, runtime);
	if (scope === "full") {
