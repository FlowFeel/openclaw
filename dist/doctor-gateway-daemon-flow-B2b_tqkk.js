...
import { _ as resolveNodeLaunchAgentLabel, h as resolveGatewayWindowsTaskName, m as resolveGatewaySystemdServiceName, u as resolveGatewayLaunchAgentLabel } from "./constants-Qf4OESGR.js";
import { g as resolveGatewayPort, i as isDefaultInstallIdentity } from "./paths-CL43LNS6.js";
import { t as formatCliCommand } from "./command-format-C5kg4XY_.js";
import { o as getResolvedLoggerSettings } from "./logger-Cv9z4NYi.js";
import { d as isWSL, p as isWSLEnv } from "./undici-runtime-CXx9v98C.js";
import "./config-BBVHtcXg.js";
import { b as classifySystemdUnavailableDetail, l as isSystemdUserServiceAvailable } from "./systemd-CE12Te8p.js";
...
import { _ as resolveGatewayRequiredListenHosts, h as resolveGatewayBindHost } from "./net-B22ilI8B.js";
import { a as formatPortDiagnostics, n as inspectPortUsage, s as isExpectedGatewayListeners, t as inspectPortConnections } from "./ports-inspect-CrH88LRj.js";
import "./ports-Dvltmmu1.js";
import { o as isLaunchAgentLoaded, p as repairLaunchAgentBootstrap, s as launchAgentPlistExists } from "./launchd-DT4INyGN.js";
...
import { a as renderSystemdUnavailableHints, i as isSystemdUnavailableDetail, r as resolveDaemonContainerContext, t as buildPlatformRuntimeLogHints } from "./runtime-hints-DdAMOdVL.js";
...
import { n as formatGatewayRestartHandoffDiagnostic, r as readGatewayRestartHandoffSync } from "./restart-handoff-BzS44iP7.js";
import { r as findSystemGatewayServices } from "./inspect-Oof9mNlI.js";
import "./logging-Bw0qwOSE.js";
import { t as note } from "./note-uiKX_qfX.js";
import { r as formatHealthCheckFailure, t as formatGatewayClosedDiagnostic } from "./health-format-Zuwkge8R.js";
...
async function maybeRepairGatewayDaemon(params) {
	...
	if (params.cfg.gateway?.mode !== "remote") {
		...
		const diagnostics = await inspectPortUsage(port, { probeHosts: resolveGatewayRequiredListenHosts(await resolveGatewayBindHost(params.cfg.gateway?.bind ?? "loopback", params.cfg.gateway?.customBindHost)) });
		await maybeReportEstablishedGatewayClients({
			cfg: params.cfg,
			deep: params.options.deep ?? false,
			port
