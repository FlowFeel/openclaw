...
import { n as require_ecdsa_sig_formatter, t as require_jws } from "./jws-B3OzQhTV.js";
 ...
 /**
		...
		*/
		static async #getProxyAgent() {
			this.#proxyAgent ||= (await import("./dist-CS0kIU02.js").then((m) => /* @__PURE__ */ __toESM(m.default))).HttpsProxyAgent;
			return this.#proxyAgent;
		}
		static async #getFetch() {
			const hasWindow = typeof window !== "undefined" && !!window;
			this.#fetch ||= hasWindow ? window.fetch : (await import("./src-DdYn3yhE.js")).default;
			return this.#fetch;
		}
		/**
		* Merges headers.
...
var require_colours$1 = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
...
//#endregion
//#region node_modules/google-logging-utils/build/src/types.js
...
var require_logging_utils$1 = /* @__PURE__ */ __commonJSMin(((exports) => {
	var __createBinding = exports && exports.__createBinding || (Object.create ? (function(o, m, k, k2) {
		if (k2 === void 0) k2 = k;
		var desc = Object.getOwnPropertyDescriptor(m, k);
		if (!desc || ("get" in desc ? !m.__esModule : desc.writable || desc.configurable)) desc = {
	...
	const util$1 = __importStar(__require("util"));
	const colours_1 = require_colours$1();
	...
	*/
	var AdhocDebugLogger = class extends events_1$2.EventEmitter {
		namespace;
		upstream;
		func;
		/**
	...
	var NodeBackend = class extends DebugLogBackendBase {
		...
		makeLogger(namespace) {
			...
			return (fields, ...args) => {
				...
				const msg = util$1.formatWithOptions({ colors: colours_1.Colours.enabled }, ...args);
...
var require_src$3 = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	__exportStar(require_logging_utils$1(), exports);
}));
//#endregion
...
//#endregion
//#region node_modules/google-auth-library/node_modules/google-logging-utils/build/src/colours.js
...
//#endregion
//#region node_modules/google-auth-library/node_modules/google-logging-utils/build/src/logging-utils.js
...
//#endregion
//#region node_modules/google-auth-library/node_modules/google-logging-utils/build/src/index.js
...
var require_authclient = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	const google_logging_utils_1 = require_src$1();
	...
	var GoogleAuth = class {
		...
		*/
		async _tryGetApplicationCredentialsFromWellKnownFile(options) {
			...
			if (!configDir) if (this._isWindows()) {
				if (process.env["APPDATA"]) configDir = path.join(process.env["APPDATA"], "gcloud");
			} else {
				const home = process.env["HOME"];
				if (home) configDir = path.join(home, ".config", "gcloud");
			}
