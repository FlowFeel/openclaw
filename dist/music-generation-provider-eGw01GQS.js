...
import { t as executeProviderOperationWithRetry } from "./operation-retry-CSNZJoxv.js";
import { c as postJsonRequest, h as resolveProviderOperationTimeoutMs, n as createProviderOperationDeadline, o as fetchWithTimeoutGuarded, p as resolveProviderHttpRequestConfig, r as createProviderOperationTimeoutResolver } from "./shared-3S5SOCXx.js";
...
import { a as resolveMinimaxMediaBaseUrl, i as resolveMinimaxGuardedRequestOptions, n as assertMinimaxBaseResp, r as normalizeMinimaxHexAudio, t as DEFAULT_MINIMAX_MEDIA_BASE_URL } from "./media-provider-runtime-D1EjSg3R.js";
...
async function downloadTrackFromUrl(params) {
	...
	try {
		try {
			assertProviderBinaryResponseContent(result.response, "MiniMax generated music download", "audio");
		} catch (error) {
		...
		if (buffer.byteLength === 0) throw new Error("MiniMax generated music download: malformed audio response");
		return {
			buffer,
			mimeType,
