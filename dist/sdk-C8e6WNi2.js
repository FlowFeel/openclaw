...
import "./reaction-common-BWj4zGM5.js";
import { t as SqliteBackedMatrixSyncStore } from "./file-sync-store-DGSs89GL.js";
import { n as LogService, r as noop, t as ConsoleLogger } from "./logger-D5FFuQel.js";
import { t as MATRIX_IDB_PERSIST_INTERVAL_MS } from "./idb-persistence-lock-DAJ49nZX.js";
import { n as isMatrixNotFoundError, t as formatMatrixErrorReason } from "./errors-Dyh26Vmo.js";
import { i as throwIfMatrixStartupAborted, n as createMatrixStartupAbortError } from "./startup-abort-DSMiSrz4.js";
import { a as matrixEventToRaw, n as createMatrixGuardedFetch, o as parseMxc, t as MatrixAuthedHttpClient } from "./http-client-DVz4igf2.js";
import { n as resolveMatrixRoomKeyBackupReadinessError } from "./backup-health-Dm_YMVFT.js";
import { t as createMatrixJsSdkClientLogger } from "./logging-8HGBni8w.js";
import { a as isMatrixAccessTokenInvalidatedError, c as resolveMatrixLocalTimeoutMs, f as isMatrixReadySyncState, i as createMatrixExplicitBootstrapOptions, l as unresolvedMatrixDeviceVerificationStatus, n as MATRIX_INITIAL_CRYPTO_BOOTSTRAP_OPTIONS, o as resolveMatrixDiagnostic, p as isMatrixTerminalSyncState, r as MATRIX_STATUS_DIAGNOSTIC_TIMEOUT_MS, s as resolveMatrixDiagnosticResult, t as MATRIX_AUTOMATIC_REPAIR_BOOTSTRAP_OPTIONS, u as unresolvedMatrixRoomKeyBackupStatus } from "./client-support-CkTF6nV1.js";
import { n as isRepairableSecretStorageAccessError, t as MatrixRecoveryKeyStore } from "./recovery-key-store-BbjS5qv_.js";
...
const loadMatrixCryptoRuntime = createLazyRuntimeModule(() => import("./crypto-runtime-DfPDho9V.js").then((runtime) => {
