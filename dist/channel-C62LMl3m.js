...
import { t as matrixPluginBase } from "./channel.setup-k-74EenU.js";
import { n as normalizeCompatibilityConfig, t as legacyConfigRules } from "./doctor-contract-s-3inccd.js";
import { r as resolveMatrixRoomScopePath, t as buildMatrixRoomScopeTree } from "./rooms-X6m2yQqu.js";
...
const matrixNativeApprovalCapability = createApproverRestrictedNativeApprovalCapability({
	...
	nativeRuntime: createLazyChannelApprovalNativeRuntimeAdapter({
		...
		load: async () => (await import("./approval-handler.runtime-Dp86mT-b.js")).matrixApprovalNativeRuntime
	})
});
...
const loadMatrixChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-F1wKy35m.js"), "matrixChannelRuntime");
...
const matrixPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			...
			try {
				monitorMatrixProvider = (await import("./monitor-IC_9i4pC.js")).monitorMatrixProvider;
			} finally {
				releaseLock();
			}
