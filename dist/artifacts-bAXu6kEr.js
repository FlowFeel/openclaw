...
import { _ as validateArtifactsDownloadParams, v as validateArtifactsGetParams, y as validateArtifactsListParams } from "./src-BSn6va4B.js";
import { a as errorShape } from "./error-codes-P4fBo0lR.js";
import { i as getTaskSessionLookupByIdForStatus } from "./task-status-access-Cl2Mqwif.js";
import { h as visitSessionMessagesAsync } from "./session-transcript-readers-O3pZVV3x.js";
import { C as loadSessionEntryReadOnly } from "./session-utils-row-Cby7i9PV.js";
import "./session-utils-DRzriWC1.js";
import { d as resolveManagedOutgoingMediaArtifactDownload, f as resolveManagedOutgoingMediaUrlDownload, l as parseManagedOutgoingArtifactId } from "./managed-image-attachments-XyX6UAvC.js";
import { t as assertValidParams } from "./validation-DyQ6nhKI.js";
import { n as resolveSessionKeyForRun } from "./server-session-key-BR5cPYNM.js";
...
async function loadArtifacts(query, cfg, opts = {}) {
	...
	const { storePath, entry } = scopedGlobalAgentId ? loadSessionEntryReadOnly(sessionKey, { agentId: scopedGlobalAgentId }) : loadSessionEntryReadOnly(sessionKey);
...
const artifactsHandlers = {
	...
	"artifacts.download": async ({ params, respond, context }) => {
		...
		if (!requireQueryable(params, respond)) return;
		if (params.sessionKey && !params.runId && !params.taskId && parseManagedOutgoingArtifactId(params.artifactId)) {
