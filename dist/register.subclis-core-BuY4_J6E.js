...
async function registerGatewayRunOnly(program) {
	const { addGatewayRunCommand } = await import("./run-command-C-Q4vDHD.js");
...
const entrySpecs = [
	...defineImportedProgramCommandGroupSpecs([
		...
		},
		{
			...
			loadModule: () => import("./gateway-cli-CyDB1jTW.js"),
		...
		{
			commandNames: ["models"],
			loadModule: () => import("./models-cli-K_KogRrS.js"),
		...
		},
		{
			...
			loadModule: () => import("./capability-cli-YCrgntq6.js"),
	...
	...defineImportedProgramCommandGroupSpecs([
		...
		{
			commandNames: ["worker"],
			loadModule: () => import("./worker-cli--xdTaAba.js"),
		...
		},
		{
			...
			loadModule: () => import("./tui-cli-BE9u-Are.js"),
	...
	...defineImportedProgramCommandGroupSpecs([
		...
		{
			commandNames: ["update"],
			loadModule: () => import("./update-cli-BHuk-Nvn.js"),
