...
import "./accounts-Bh2jobrr.js";
import "./runtime-api-DmTQ--6V.js";
import { r as getMe, t as ZaloApiError } from "./api-BRhZiSV-.js";
import { t as resolveZaloProxyFetch } from "./proxy-DdPYf9Pr.js";
import { t as sendMessageZalo } from "./send-oHerwxdD.js";
...
async function notifyZaloPairingApproval(params) {
	const { resolveZaloAccount } = await import("./accounts-Dz-6-rIL.js");
...
async function startZaloGatewayAccount(ctx) {
	...
	const { monitorZaloProvider } = await import("./monitor-DleXb5Md.js");
