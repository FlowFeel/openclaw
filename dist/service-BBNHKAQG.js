...
import { a as listGitWorktrees, c as requireGit, d as runGit, i as insideGitCheckout, l as requireGitBuffer, o as pathExists, s as removeEmptyParents, t as commandError, u as requireGitRaw } from "./git-Ba83QtEc.js";
import { t as createCrustaceanSlug } from "./session-slug-DUj8bbny.js";
import { a as hasLiveWorktreeRunLease, c as lockWorktreeForProcess, i as finalizeWorktreeRemoval, l as unlockWorktree, r as claimWorktreeRemoval, s as lockState, t as abortWorktreeRemoval } from "./run-lease-7G9F1Hoj.js";
import { _ as insertRegistryWorktree, a as deleteRegistryWorktree, c as findLiveRegistryWorktreeByOwner, d as getRegistryWorktree, f as getRegistryWorktreeProvisionedChunk, i as clearRegistryWorktreeProvisionedChunks, l as findLiveRegistryWorktreeByPath, m as getRegistryWorktreeProvisionedState, p as getRegistryWorktreeProvisionedPaths, u as findRegistryWorktreeByPath, v as insertRegistryWorktreeProvisionedChunk, x as updateRegistryWorktree, y as listRegistryWorktrees } from "./registry-iwzuX13n.js";
...
async function nameIsUnavailable(env, repoRoot, root, name, owner) {
	...
	if (owner.ownerId && registered && worktreeOwnerMatches(registered, owner)) return false;
	if (registered || await pathExists(worktreePath)) return true;
