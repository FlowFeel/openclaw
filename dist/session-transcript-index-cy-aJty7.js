...
function selectSessionTranscriptLeafControlledPath(entries) {
	...
	return selectSessionTranscriptActiveEntries({
		...
		const node = isRecord(entry) ? tree.byId.get(readNonEmptyString(entry.id) ?? "") : void 0;
...
//#endregion
export { selectSessionTranscriptTreePathNodes as C, selectSessionTranscriptLeafControlledPath as S, mergeSessionTranscriptTreePaths as _, reconcileSessionTranscriptIndexInTransaction as a, scanSessionTranscriptTree as b, deletePreparedSessionTranscriptProjectionChunkInTransaction as c, resolveVisibleTranscriptAppendParentId as d, selectVisibleTranscriptEventEntries as f, isSessionTranscriptSideAppendEntry as g, isSessionTranscriptLeafControl as h, listSessionsNeedingTranscriptIndexReconcile as i, finalizePreparedSessionTranscriptProjectionInTransaction as l, isCanonicalSessionTranscriptEntry as m, deleteSessionTranscriptIndexInTransaction as n, appendPreparedSessionTranscriptProjectionChunkInTransaction as o, selectVisibleTranscriptEvents as p, indexAppendedTranscriptEventInTransaction as r, claimPreparedSessionTranscriptProjectionInTransaction as s, deleteOrphanedTranscriptIndexRowsInTransaction as t, prepareSessionTranscriptProjection as u, mergeSessionTranscriptVisiblePathWithOpaqueAppendPath as v, selectSessionTranscriptActiveEntries as x, parseSessionTranscriptTreeEntry as y };
