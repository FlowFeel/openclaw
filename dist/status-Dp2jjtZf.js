...
import { m as resolveGatewaySystemdServiceName, u as resolveGatewayLaunchAgentLabel } from "./constants-Qf4OESGR.js";
...
import { p as isWSLEnv } from "./undici-runtime-CXx9v98C.js";
import { t as formatConfigIssueLine } from "./issue-format-NBZpPOU4.js";
import { b as classifySystemdUnavailableDetail } from "./systemd-CE12Te8p.js";
import { t as formatGatewayHeapLimitReport } from "./gateway-heap-CaeyR8CS.js";
import { a as resolveGatewayRestartLogPath, o as resolveGatewaySupervisorLogPaths } from "./restart-logs-BBbMF07G.js";
import { a as renderSystemdUnavailableHints, i as isSystemdUnavailableDetail, r as resolveDaemonContainerContext } from "./runtime-hints-DdAMOdVL.js";
import { a as filterDaemonEnv, d as resolveRuntimeStatusColor, f as safeDaemonEnv, t as createCliStatusTextStyles, u as renderRuntimeHints } from "./shared-C4IIJkT8.js";
...
import { n as resolveControlUiLinks } from "./control-ui-links-Ci1IGfKN.js";
import { n as formatGatewayRestartHandoffDiagnostic } from "./restart-handoff-BzS44iP7.js";
import { n as resolvePluginVersionDriftUpdateCommand } from "./plugin-version-drift-D-cJxRJb.js";
import { n as renderPortDiagnosticsForCli, r as resolvePortListeningAddresses, t as gatherDaemonStatus } from "./status.gather-DTf2CBD1.js";
import { i as renderGatewayServiceCleanupHints } from "./inspect-Oof9mNlI.js";
...
function printDaemonStatus(status, opts) {
	...
	if (serviceTargetsProbe && service.loaded && service.runtime?.status === "running" && status.port && status.port.status !== "busy") {
	...
	if (extraServices.length > 0) {
		...
		for (const hint of renderGatewayServiceCleanupHints(extraServices)) defaultRuntime.log(`${infoText("Cleanup hint:")} ${hint}`);
		spacer();
	}
