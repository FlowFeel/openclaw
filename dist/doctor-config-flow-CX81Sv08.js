...
import { J as resolveNormalizedProviderModelMaxTokens } from "./io-DCw4R0kD.js";
...
import { i as getBundledChannelSetupPlugin, o as hasBundledChannelPackageSetupFeature } from "./bundled-C1enQlWY.js";
import { s as HeartbeatSchema } from "./zod-schema.agent-runtime-CaWcMFul.js";
import { a as migrateLegacyXSearchConfig, c as migrateLegacyRuntimeModelRef, d as hasOwnKey, f as migratePersistedImplicitMainRoster, i as stripRetiredTuningKnobs, l as cloneRecord, o as legacyRuntimeModelAliasRequiresRuntimePolicy, r as migrateLegacyWebSearchConfig, s as listLegacyRuntimeModelProviderAliases, u as ensureRecord } from "./legacy-B52k-ZXJ.js";
import { r as normalizeTalkSection } from "./talk-tpRQh2VT.js";
import { a as isBlockedLegacyCodexModelRef } from "./codex-route-model-ref-B7v0y8up.js";
import { n as formatConfigIssueLines } from "./issue-format-NBZpPOU4.js";
import { c as mergeMissing, r as isLegacyModelsAddCodexMetadataModel } from "./legacy-config-migrations.runtime.models-iwZrvJ3V.js";
import { t as configIncludeOwnsAgentRoster } from "./agent-roster-provenance-BUXNi_-c.js";
import { i as setPathExistingStrict } from "./path-utils-DfXesdV4.js";
import { n as discoverConfigSecretTargets } from "./target-registry-query-Dzi3tmBI.js";
import "./target-registry-BfTxQydT.js";
import { c as callGateway } from "./call-YSl9HPoR.js";
import { a as runPluginSetupConfigMigrations } from "./setup-registry-CZI_WOsi.js";
...
import { n as resolveSingleAccountPromotion } from "./setup-promotion-helpers-BQ88Josz.js";
import { a as noteSandboxOriginProxyWarning, i as noteOpencodeProviderOverrides, n as noteImplicitFallbackClobberWarnings, s as stripUnknownConfigKeys } from "./doctor-config-analysis-CiHr9ksG.js";
import { t as runDoctorConfigPreflight } from "./doctor-config-preflight-DhWuTmrx.js";
import { n as applyChannelDoctorCompatibilityMigrations, t as migrateLegacyConfig } from "./legacy-config-migrate-vYtlP2_M.js";
import { n as cronCodexRuntimePolicyTargetKey } from "./store-migration-44TYYG9O.js";
import { n as containsAuthoredInclude, r as isSingleTopLevelIncludeMigration, t as classifyConfigPathMigrationOwnership } from "./include-migration-ownership-Cvhlq2vL.js";
...
async function loadAndMaybeMigrateDoctorConfig(params) {
	...
	const { collectBlockedLegacyOpenAICodexProviderPlan } = await import("./legacy-config-migrations.runtime.models-DQ-kxZw3.js");
	...
	if (preflight.cronCodexRuntimePolicyTargets?.length) {
		const { repairCronCodexRuntimePolicies } = await import("./runtime-policy-migration-lzg8564o.js");
	...
	const { prepareRetiredPhoneControlCleanup } = await import("./doctor-retired-phone-control-D7bbpiag.js");
	...
	const { applyPluginAutoEnable } = await import("./plugin-auto-enable-C8xltju8.js");
	applyConfigMutation(applyPluginAutoEnable({
		config: state.candidate,
		env: process.env
	}), { fixHint: `Run "${doctorFixCommand}" to apply these changes.` });
	if (!shouldRepair) {
		const { repairStaleAgentModelRefs } = await import("./stale-agent-model-ref-repair-CsxFcwhG.js");
	...
	const { collectPluginToolAllowlistWarnings } = await import("./plugin-tool-allowlist-warnings-BwzfXPKL.js");
	...
	if (hasConfiguredChannels) {
		const channelDoctor = await import("./channel-doctor-ZpoXg6S_.js");
	...
	const { repairHooksTokenReuseGatewayAuth } = await import("./hooks-token-reuse-repair-Dk8aarPb.js");
	...
	if (shouldRepair) {
		const { runDoctorRepairSequence } = await import("./repair-sequencing-BHDt1Mnl.js");
		...
		const { collectDoctorPreviewNotes } = await import("./preview-warnings-DC6ViifY.js");
	...
	const activeOpencodePluginIds = configuredOpencodePluginIds.length > 0 ? (await import("./providers-DLHNoNpC.js")).resolveEnabledProviderPluginIds({
		config: cfg,
