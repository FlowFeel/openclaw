...
const statusScanModuleLoader = createLazyImportLoader(() => import("./status.scan-zLZTWCyw.js"));
const statusScanFastJsonModuleLoader = createLazyImportLoader(() => import("./status.scan.fast-json-DYywjI1m.js"));
const statusAllModuleLoader = createLazyImportLoader(() => import("./status-all-C_JPHmxl.js"));
const statusCommandTextRuntimeLoader = createLazyImportLoader(() => import("./status.command.text-runtime-CYfdeAW1.js"));
