...
import { i as normalizePluginDependencySpecs, s as tracePluginLifecyclePhase } from "./discovery-BwgYKZ4p.js";
import { n as registerPluginMetadataProcessMemoLifecycleClear } from "./plugin-metadata-lifecycle-NcA0EWhA.js";
import { a as getPackageManifestMetadata, c as normalizeManifestChannelCommandDefaults, i as DEFAULT_PLUGIN_ENTRY_CANDIDATES } from "./manifest-BUOsMMgJ.js";
import { l as tryReadJsonSync } from "./json-C-CW4mQo.js";
import "./json-files-v5WP3doI.js";
import "./path-safety-DhI4mL0m.js";
import { d as extractPluginInstallRecordsFromInstalledPluginIndex, h as hashJson } from "./installed-plugin-index-DXmBG059.js";
import { r as resolveChannelSetupFieldCliAttributeName } from "./setup-contract-v3-D0s84.js";
...
function normalizePackageChannelDoctorCapabilities(doctorCapabilities) {
	...
	for (const key of ["groupAllowFromFallbackToAllowFrom", "warnOnEmptyGroupSenderAllowlist"]) if (typeof doctorCapabilities[key] === "boolean") normalized[key] = doctorCapabilities[key];
	return Object.keys(normalized).length > 0 ? normalized : void 0;
}
