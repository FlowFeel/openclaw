...
import { d as normalizeTrimmedStringList, h as normalizeUniqueTrimmedStringList, l as normalizeStringEntries, p as normalizeUniqueStringEntries, v as uniqueValues } from "./string-normalization-CRyoFBPt.js";
import { H as sanitizeCommandDescriptorDescription, V as normalizeCommandDescriptorName } from "./argv-D6QuZiS5.js";
import { f as safeRealpathSync, i as isPathInside, p as safeStatSync } from "./path-D8zNGPJM.js";
import { u as withTimeout } from "./fs-safe-DVaClkIX.js";
import { n as discoverOpenClawPlugins, o as isPluginLifecycleTraceEnabled } from "./discovery-BwgYKZ4p.js";
...
import { r as resolveConfigEnvVars } from "./env-substitution-acZl0cGf.js";
...
import { Y as normalizeSqliteNumber, d as openOpenClawStateDatabase, h as runOpenClawStateWriteTransaction } from "./openclaw-state-db-D9eH245j.js";
import { n as resolveOpenClawStateSqlitePath } from "./openclaw-state-db.paths-2PkDmkRl.js";
import { b as getCoreEmbeddingProvider } from "./gateway-startup-plugin-ids-C-hC0TmS.js";
import { i as emitAgentEvent, v as hasInvalidLifecycleStartTimestamp } from "./agent-events-COCf-9-O.js";
import { B as clearPluginRunContext, D as stageActivePluginRegistry, F as isPluginRegistryRetired, G as registerPluginSessionSchedulerJob, H as getPluginRunContext, I as createEmptyPluginRegistry, K as setPluginRunContext, M as withPluginRuntimePluginScope, O as withPluginRegistrationContext, P as isPluginRegistryActivated, S as requireActivePluginRegistry, T as restoreActivePluginRegistrySnapshot, U as getPluginSessionSchedulerJobGeneration, V as deletePluginSessionSchedulerJob, d as getActivePluginRegistry, f as getActivePluginRegistryKey, g as getActivePluginSessionExtensionRegistry, i as commitStagedPluginRegistry, j as withPluginRuntimePluginIdScope, n as captureActivePluginRegistrySnapshot, y as recordImportedPluginId, z as cleanupPluginSessionSchedulerJobs } from "./runtime-WkCmQTS9.js";
...
import { l as tryReadJsonSync } from "./json-C-CW4mQo.js";
import "./json-files-v5WP3doI.js";
import { c as listChatChannels } from "./registry-DqHlaOgA.js";
import { v as normalizeOptionalAgentRuntimeId } from "./openai-routing-Db2edxk0.js";
import "./agent-scope-DyEposw2.js";
import "./path-safety-DhI4mL0m.js";
import { t as shouldRejectHardlinkedPluginFiles } from "./hardlink-policy-BX_vqA3Y.js";
import { n as getCachedPluginModuleLoader, o as installOpenClawPluginSdkNativeResolver, t as createPluginModuleLoaderCache, u as toSafeImportPath } from "./plugin-module-loader-cache--sRKvOp1.js";
import { t as PluginLruCache } from "./plugin-cache-primitives-Dz0npwxC.js";
import { n as resolveOpenClawDevSourceRoot, t as isBundledPluginInsideDevSourceRoot } from "./dev-source-root-Cg6ajAVX.js";
import { c as resolvePluginRuntimeModulePathWithDiagnostics, t as buildPluginLoaderAliasMap } from "./sdk-alias-BiwifeHS.js";
...
import { d as extractPluginInstallRecordsFromInstalledPluginIndex, m as getPluginCompatRecord, s as collectPluginManifestCompatCodes } from "./installed-plugin-index-DXmBG059.js";
import { i as kindsEqual, n as defaultSlotIdForKey, r as hasKind } from "./slots-pOTBtf7J.js";
import { c as normalizePluginsConfig, f as resolveMemorySlotDecision, l as resolveEffectiveEnableState, n as createPluginActivationSource, t as applyTestPluginDefaults, u as resolveEffectivePluginActivationState } from "./config-state-DrPZVhOu.js";
import { t as isPluginEnabledByDefaultForPlatform } from "./default-enablement-CEIbpabL.js";
import { n as loadPluginManifestRegistry } from "./manifest-registry-xP2DL3Xg.js";
import { r as resolvePluginDiscoveryContext, t as fingerprintPluginDiscoveryContext } from "./plugin-control-plane-context-BLIc52iG.js";
import { d as normalizeChannelMeta } from "./bundled-Wqb8B5b_.js";
import { t as validateJsonSchemaValue } from "./schema-validator-CySXOkZz.js";
import { c as serializePluginIdScope, i as createPluginIdScopeSet, s as normalizePluginIdScope, t as getCurrentPluginMetadataSnapshot } from "./current-plugin-metadata-snapshot-LM8oq-yZ.js";
import { a as resolveManifestOwnerBasePolicyBlock, t as hasExplicitManifestOwnerTrust } from "./manifest-owner-policy-Cvik9_1s.js";
import { t as unwrapDefaultModuleExport } from "./module-export-DsZgGIbX.js";
import { C as resolveMemoryDreamingPluginConfig, S as resolveMemoryDreamingConfig, l as DEFAULT_MEMORY_DREAMING_PLUGIN_ID } from "./dreaming-CisvAHct.js";
import { s as validateWorkerProviderContract } from "./worker-provider-registry-db6cfAVj.js";
import { o as createConfigRuntimeEnv } from "./config-env-vars-Dh6msnxE.js";
import "./env-vars-DCWfPdO4.js";
import { n as ok, t as err } from "./result-BQGgYouL.js";
import { a as NODE_EXEC_APPROVALS_COMMANDS, d as NODE_SYSTEM_NOTIFY_COMMAND, f as NODE_SYSTEM_RUN_COMMANDS } from "./node-commands-CeG5w7c2.js";
import { t as normalizePluginGatewayMethodScope } from "./gateway-method-policy-BQVhuE4m.js";
import "./core-descriptors-Bngx0C2m.js";
...
import { t as resolvePluginActivationSourceConfig } from "./activation-source-config-B3c-n1H5.js";
import "./installed-plugin-index-records-BkPV4HdU.js";
import { t as quoteCliArg } from "./quote-cli-arg-BriMa9wW.js";
import { c as validateOptionalPluginStoreTtlMs, d as validatePluginStorePositiveInteger, l as validatePluginStoreKey, n as createPluginStateKeyedStore, r as createPluginStateSyncKeyedStore, s as serializePluginStoreJson, u as validatePluginStoreNamespace } from "./plugin-state-store-CeV9ciGZ.js";
import { n as activateContextEngineRegistrations, o as registerContextEngineInRegistry } from "./registry-DyBZw0Nd.js";
import { a as resetGlobalHookRunner, c as createPluginToolMatcherScope, d as pluginToolMatcherCoversTool, i as initializeGlobalHookRunner, n as getGlobalPluginRegistry, u as normalizePluginToolMatcher } from "./hook-runner-global-BNa5TLJ4.js";
...
import { n as detectMime, t as FILE_TYPE_SNIFF_MAX_BYTES, u as normalizeMimeType } from "./mime-Ir6g3Vae.js";
import { t as resolvePathFromInput } from "./path-policy-CKnH0pq8.js";
import { n as resolveWorkspaceRoot } from "./workspace-dir-DWZxOonu.js";
...
import { g as isAgentHarnessSessionKeyOwnedBy, h as isAgentHarnessSessionKey, t as normalizeSessionEntrySlotKey } from "./session-entry-slot-keys-DPRQmSpa.js";
import { at as updateResolvedSessionEntry, nt as resolveSessionEntryAccessTarget } from "./session-accessor-D5Or7WgI.js";
import { t as extractDeliveryInfo } from "./delivery-info-DXQpZ0K1.js";
import { i as readRecordValue } from "./safe-record-Cx9ufCqd.js";
import { n as copyProviderCatalogResultEntries, t as copyProviderCatalogModels } from "./provider-catalog-result-BT1b-TqX.js";
import { r as registerPluginInteractiveHandlerInRegistry } from "./interactive-registry-CUkwo4wt.js";
import { n as normalizePluginHttpPath, t as findPluginHttpRouteRegistrationConflicts } from "./http-route-overlap-C1nNY9hk.js";
import { a as registerPluginCommandInRegistry, t as isReservedCommandName } from "./command-registration-MGWB6wzh.js";
import { a as isPluginHookName, i as isPluginHookAgentTrigger, n as isConversationHookName, o as isPromptInjectionHookName, r as isDeprecatedPluginHookName, t as DEPRECATED_PLUGIN_HOOKS } from "./types-HshsOZMQ.js";
import "./with-timeout-C4AhiECB.js";
import { r as createChannelIngressDrain } from "./ingress-drain-DYX3uP7I.js";
import { n as createChannelIngressQueue } from "./ingress-queue-De5Ge-jR.js";
import { r as withOpenClawStateLease, t as OpenClawStateLeaseError } from "./openclaw-state-lease-DLXouRV4.js";
import { t as PluginStateLeaseError } from "./plugin-state-lease.types-C0g0-ID5.js";
import { n as inspectBundleMcpRuntimeSupport } from "./bundle-mcp-CbmnA29U.js";
import "./src-BSn6va4B.js";
import { a as resolveSetupChannelRegistration, i as resolveBundledRuntimeChannelRegistration, n as loadBundledRuntimeChannelPlugin, o as shouldLoadChannelPluginInSetupRuntime, r as mergeSetupRuntimeChannelPlugin, t as channelPluginIdBelongsToManifest } from "./loader-channel-setup-CTYY4Xiw.js";
...
function createPluginModuleLoader(options) {
	...
	const createLoaderForModule = (modulePath) => {
		...
		const defaultAliasMap = buildPluginLoaderAliasMap(modulePath, process.argv[1], import.meta.url, options.pluginSdkResolution, options.devSourceRoot);
...
const loadSendMessage = createLazyRuntimeModule(() => import("./message-DkzLrZdM.js").then((module) => module.sendMessage));
const loadGetChannelPlugin = createLazyRuntimeModule(() => import("./plugins-BbO9-w4w.js").then((module) => module.getChannelPlugin));
...
function createMemoryRegistrars(state) {
	...
	const registerMemoryEmbeddingProvider = (record, adapter) => {
		...
		const existing = registry.memoryEmbeddingProviders.find((entry) => entry.provider.id === adapter.id);
		if (existing) {
...
function createProviderRegistrars(state) {
	...
	const registerAgentHarness = (record, harness) => {
...
function createToolHookRegistrars(state) {
	...
	const registerTypedHook = (record, hookName, handler, opts, policy) => {
		...
		const eligibleTriggers = effectiveHookName === "before_agent_reply" ? normalizeEligibleTriggers(opts?.eligibleTriggers) : void 0;
		const matcher = effectiveHookName === "before_tool_call" || effectiveHookName === "after_tool_call" ? normalizePluginToolMatcher(opts?.matcher) : void 0;
		if (opts?.matcher && effectiveHookName !== "before_tool_call" && effectiveHookName !== "after_tool_call") pushDiagnostic({
			level: "warn",
			pluginId: record.id,
			source: record.source,
...
function invalidInput$1(message, operation = "register") {
...
const validationErrors = (operation) => ({
	invalid: (message) => invalidInput$1(message, operation),
...
function validatePositiveLimit(value, label, maximum) {
	...
	if (normalized > maximum) throw invalidInput$1(`${label} must be <= ${maximum}`, "open");
	return normalized;
}
function validateOverflowPolicy(value) {
	...
	throw invalidInput$1("plugin blob overflowPolicy must be evict-oldest or reject-new", "open");
}
...
function createPluginBlobStoreInternal(pluginId, options, env) {
	if (pluginId.startsWith("core:")) throw invalidInput$1("Plugin ids starting with 'core:' are reserved for core consumers.", "open");
	...
	if (maxBytesPerEntry > maxBytesPerNamespace) throw invalidInput$1("plugin blob maxBytesPerEntry must not exceed maxBytesPerNamespace", "open");
...
function createPluginRegistry(registryParams) {
	...
	const { createApi: createPluginApi, deactivatePluginSideEffectGuards } = createPluginApiFactory(state, registrars, createPluginRuntimeResolver(state));
	...
	const rollbackPluginGlobalSideEffects = (pluginId, record) => {
		...
		for (const value of Object.values(state.registry)) if (Array.isArray(value)) for (let index = value.length - 1; index >= 0; index -= 1) {
...
function buildCapabilityId(params) {
	...
	if (capabilityId.length > params.maxLength) return fail(params.pluginId, `capability id ${JSON.stringify(capabilityId)} exceeds ${params.maxLength} characters`);
	return capabilityId;
}
function requireOwnedMethod(params) {
	...
	if (descriptor?.owner.kind !== "plugin" || descriptor.owner.pluginId !== params.pluginId) return fail(params.pluginId, `method ${JSON.stringify(params.method)} must be registered by the declaring plugin`);
	if (descriptor.scope !== params.expectedScope) return fail(params.pluginId, `method ${JSON.stringify(params.method)} must use ${params.expectedScope}, got ${descriptor.scope}`);
	const handler = params.registry.gatewayHandlers[params.method];
	if (!handler) return fail(params.pluginId, `method ${JSON.stringify(params.method)} is missing its registered handler`);
	return handler;
}
...
function registerPluginDashboardCapabilities(params) {
	...
	const claimCapabilityId = (capabilityId) => {
		if (capabilityIds.has(capabilityId) || params.registry.dashboardDataBindings.has(capabilityId) || params.registry.dashboardActionVerbs.has(capabilityId)) fail(params.record.id, `duplicate capability id ${JSON.stringify(capabilityId)}`);
		if (CORE_BOARD_HOST_CAPABILITY_IDS.includes(capabilityId) || capabilityId.startsWith("cron.trigger:")) fail(params.record.id, `capability id ${JSON.stringify(capabilityId)} is reserved by core`);
	...
	for (const declaration of dashboard.actionVerbs ?? []) {
		...
		if (declaration.paramShape) try {
			...
			fail(params.record.id, `action ${JSON.stringify(capabilityId)} has an invalid paramShape: ${String(error)}`);
		}
		actionVerbs.push({
			...declaration,
			pluginId: params.record.id,
...
//#endregion
export { patchPluginSessionExtension as A, resolveVoiceModelRefs as C, synthesizeMediaGenerationCatalogEntries as D, listMediaGenerationProviderModels as E, resolvePluginRegistryLoadCacheKey as F, resolvePluginRuntimeArtifact as I, buildPluginAgentTurnPrepareContext as L, activatePluginRegistry as M, clearPluginRegistryLoadCache as N, drainPluginNextTurnInjectionContext as O, isPluginRegistryLoadInFlight as P, resolveSupportedVoiceModelRefs as S, voiceProviderSupportsModel as T, getPluginRegistryRuntime as _, resolveRuntimePluginRegistry as a, providerMatchesId as b, CORE_BOARD_DATA_BINDING_IDS as c, getAgentToolResultMiddlewareMatcherScope as d, listAgentToolResultMiddlewares as f, findUndeclaredPluginToolNames as g, createPluginGatewayMethodDescriptors as h, resolveCompatibleRuntimePluginRegistry as i, projectPluginSessionExtensionsSync as j, getPluginSessionExtensionStateSync as k, loadOpenClawPluginCliRegistry as l, createGatewayMethodRegistry as m, loadPluginRegistryHandle as n, loadOpenClawPlugins as o, createGatewayMethodDescriptorsFromHandlers as p, getRuntimePluginRegistryForLoadOptions as r, loadOpenClawPluginsWithInternalOverrides as s, loadAndActivateRootPluginRegistry as t, listCodexAppServerExtensionFactories as u, projectProviderCatalogResultToUnifiedTextRows as v, resolveVoiceProviderCandidates as w, resolvePrimaryVoiceProviderCandidate as x, getVoiceProviderConfig as y };
