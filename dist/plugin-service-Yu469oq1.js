...
import { t as startLazyPluginServiceModule } from "./plugin-runtime-Ddv_k2Et.js";
...
import { a as resolveProfile, l as resolveExistingUploadPaths, r as resolveBrowserConfig } from "./config-CJZl5XjK.js";
import { Y as withTimeout } from "./tmp-openclaw-dir-DULFdmUv.js";
import "./errors-DmEgfvpa.js";
import { N as parseBrowserNavigationUrl } from "./chrome-DPM_kB4N.js";
import { t as getBrowserProfileCapabilities } from "./profile-capabilities-DqO0AgW7.js";
import "./sdk-setup-tools-ukKv3Pmz.js";
import { C as fetchBrowserJson, S as BrowserServiceError, _ as browserStatus, a as untrackSessionBrowserTab, d as browserImportProfile, f as browserOpenTab, g as browserStart, h as browserSnapshot, i as trackSessionBrowserTab, l as browserDoctor, o as browserCloseTab, p as browserProfiles, r as touchSessionBrowserTab, u as browserFocusTab, v as browserStop, x as browserTabs, y as browserSystemProfiles } from "./session-tab-registry-COLduo1q.js";
import { _ as isBrowserProxyUploadRequest, a as persistBrowserProxyFiles, b as parseBrowserProxyFailure, c as browserPdfSave, d as browserArmFileChooser, f as browserDownload, h as browserWaitForDownload, i as applyBrowserProxyPaths, l as browserAct, m as browserScreenshotAction, o as browserConsoleMessages, p as browserNavigate, s as browserPageContent, u as browserArmDialog, v as prepareBrowserProxyUploadRequest, y as BROWSER_PROXY_ERROR_ENVELOPE } from "./core-api-mHpDP4-1.js";
import { o as normalizeBrowserScreenshot, r as parseSystemProfileDomains } from "./routes-UzAAMTNS.js";
import { a as describeBrowserScreenshot, c as stageBrowserScreenshotForSharing, n as executeExtractAction, o as neutralizeMediaDirectives, s as resolveRuntimeImageSanitization } from "./browser-extract-1WMDstiI.js";
import { n as createBrowserControlContext } from "./plugin-enabled-BFhPy1tz.js";
import { a as resolveRequestedBrowserProfile, n as isBrowserHostLocalRoute, r as isPersistentBrowserProfileMutation, t as createBrowserRouteDispatcher } from "./dispatcher-DsrR-WQK.js";
import { t as startBrowserControlServiceFromConfig } from "./control-service-BKg0eYk8.js";
...
function createBrowserPluginService() {
	...
	return {
		id: "browser-control",
		start: async () => {
			const pageShare = await import("./page-share-DnvJeqiL.js");
			...
			handle = await startLazyPluginServiceModule({
				...
				loadDefaultModule: async () => await import("./server-jxyeKRoD.js"),
		...
		stop: async () => {
			const { setPageShareSink } = await import("./page-share-DnvJeqiL.js");
			...
			const { stopBrowserControlService } = await import("./control-service-BFySEZak.js");
