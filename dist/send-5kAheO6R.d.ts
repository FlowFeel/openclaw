...
import { K as RetryConfig } from "./types-CHzJhI3f.js";
import { N as ChunkMode, St as OutboundMediaAccess, xt as PollInput } from "./setup-wizard-types-C6GPHZpk.js";
import { A as APIGuildMember, C as APIGuildScheduledEventEntityMetadata, E as GuildScheduledEventPrivacyLevel, F as APIRole, I as Snowflake, N as APIChannel, S as APIGuildScheduledEvent, T as GuildScheduledEventEntityType, g as RequestClient, k as APIMessage, w as APIGuildScheduledEventRecurrenceRule, x as APIVoiceState } from "./discord-B3FRtvAS.js";
import { S as DiscordTimeoutTarget, a as DiscordEmojiUpload, b as DiscordThreadCreate, c as DiscordModerationTarget, f as DiscordReactionSummary, g as DiscordSearchQuery, i as DiscordChannelPermissionSet, l as DiscordPermissionsSummary, m as DiscordRoleChange, n as DiscordChannelEdit, o as DiscordMessageEdit, r as DiscordChannelMove, s as DiscordMessageQuery, t as DiscordChannelCreate, u as DiscordReactOpts, v as DiscordSendResult, x as DiscordThreadList, y as DiscordStickerUpload } from "./send.types-BzqJHpNz.js";
import { i as DiscordReplyReference, n as DiscordSendComponents, r as DiscordSendEmbeds, t as DiscordAllowedMentions } from "./send.shared-trGDW0nb.js";
...
type VoiceMessageOpts = Pick<Parameters<typeof sendMessageDiscord>[2], "cfg" | "token" | "accountId" | "verbose" | "rest" | "reply" | "retry" | "silent" | "mediaAccess" | "mediaLocalRoots" | "mediaReadFile">;
/**
