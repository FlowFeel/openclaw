...
async function resolveLoader(params) {
	...
	const { loadPublishedPreparedModelCatalogOwnerSnapshot } = await import("./prepared-model-catalog-CDZ2A_-7.js");
	return loadPublishedPreparedModelCatalogOwnerSnapshot;
}
async function resetPreparedModelCatalogForTest() {
	const [{ resetPreparedModelRuntimeSnapshotsForTest }, { resetModelCatalogBuilderCacheForTest }] = await Promise.all([import("./prepared-model-runtime.test-support-BYyBntIt.js"), import("./model-catalog-D08l3HGh.js")]);
...
async function readPreparedGatewayModelCatalog(params) {
	const { getPreparedModelCatalogSnapshot } = await import("./prepared-model-catalog-CDZ2A_-7.js");
