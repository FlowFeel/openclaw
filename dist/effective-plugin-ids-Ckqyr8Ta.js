...
import { t as loadGatewayStartupPluginPlan } from "./gateway-startup-plugin-ids-C-hC0TmS.js";
...
import { o as listExplicitConfiguredChannelIdsForConfig, s as resolveConfiguredChannelPluginIds } from "./channel-presence-policy-BjX2SvLo.js";
...
function collectBundledChannelOwnerPluginIds(params) {
	...
	const env = params.bundledPluginsDir ? {
		...
		...isVitestRuntimeEnv(params.env) || isVitestRuntimeEnv() ? { OPENCLAW_TEST_TRUST_BUNDLED_PLUGINS_DIR: "1" } : {}
	} : params.env;
