...
import { i as formatUncaughtError, r as formatErrorMessage, s as readErrorName, t as collectErrorGraphCandidates } from "./errors-D-7D3ZtF.js";
import { n as createNonExitingRuntime } from "./runtime-DOr96aVu.js";
import { c as resolveAgentDir, f as resolveDefaultAgentId, o as resolveAgentConfig } from "./agent-scope-config-Dusa8eSA.js";
...
import { i as getChildLogger } from "./logger-CEPY5_jR.js";
...
import { i as shouldLogVerbose, o as warn, r as logVerbose, t as danger } from "./globals-DHQUG86L.js";
...
import { c as kindFromMime } from "./mime-Ir6g3Vae.js";
import { t as formatSqliteSessionFileMarker } from "./legacy-sqlite-marker-COPKCuIN.js";
import { t as DEFAULT_INGRESS_ADOPTION_STALL_MS } from "./ingress-drain-2RTV7UdL.js";
...
import { r as resolveThinkingDefaultWithRuntimeCatalog } from "./model-thinking-default-VKKhnMLC.js";
import { n as isInsideCode, t as findCodeRegions } from "./code-regions-B1zlXqqO.js";
import { f as stripReasoningTagsFromText } from "./assistant-visible-text-DONkuTGN.js";
...
import { i as formatFastModeCurrentStatus } from "./fast-mode-BORk623r.js";
...
import { t as hasControlCommand } from "./command-detection-lFmSYiNP.js";
import { r as stripInlineDirectiveTagsForDelivery } from "./directive-tags-XkukyPkv.js";
...
import { S as formatLocationText, a as hasOutboundReplyContent, w as toLocationContext } from "./reply-payload-BE_j43tQ.js";
...
import { t as resolveChannelGroupPolicy } from "./group-policy-BC5uZemX.js";
import { A as resolveChannelStreamingPreviewToolProgress, F as selectLongerFinalText, P as resolveTranscriptBackedChannelFinalText, T as resolveChannelStreamingBlockEnabled, d as isChannelProgressDraftWorkToolName, i as buildChannelProgressDraftLineForEntry, p as isPotentialTruncatedFinal, r as buildChannelProgressDraftLine } from "./streaming-Byu76Sav.js";
import { i as saveRemoteMedia, t as MediaFetchError } from "./fetch-CFjJOQmb.js";
import { n as getAgentScopedMediaLocalRoots } from "./local-roots-DY1lg2k6.js";
import { l as formatReasoningMessage } from "./embedded-agent-utils-BYrAMdPg.js";
import { m as triggerInternalHook, n as createInternalHookEvent } from "./internal-hooks-glvlO_hY.js";
import { i as resolveAgentRoute, n as deriveLastRoutePolicy } from "./resolve-route-Dzy9k3m6.js";
import { n as firstDefined } from "./allow-from-o-cfFFcK.js";
import { i as applyModelOverrideToSessionEntry, r as ModelSelectionLockedError } from "./model-overrides-BT6Lelev.js";
import { t as resolveAckReaction } from "./identity-DxC7SNFJ.js";
import { t as deriveDurableFinalDeliveryRequirements } from "./capabilities-CjTX8w_2.js";
import { a as toInternalMessageReceivedContext } from "./message-hook-mappers-B6i6KSrI.js";
...
import { h as resolveChannelConfigWrites } from "./channel-config-helpers-BwgkzH7b.js";
import { c as resolveThreadBindingMaxAgeMsForChannel, o as resolveThreadBindingIdleTimeoutMsForChannel, u as resolveThreadBindingSpawnPolicy } from "./thread-bindings-policy-BelzGFdH.js";
...
import { _ as updateSessionStoreEntry, c as readAmbientTranscriptWatermark, i as listSessionEntries, m as resolveStorePath, r as getSessionEntry, s as patchSessionEntry } from "./session-store-runtime-dul9f0ER.js";
import { d as createChannelPartialDeliveryError, f as isChannelPartialDeliveryError } from "./dispatch-Bvh2WBh-.js";
import { i as resolveStoredModelOverride } from "./stored-model-override-Cmtyl-oa.js";
import { c as parseCommandArgs, i as formatCommandArgMenuTitle, n as buildCommandTextFromArgs, o as listNativeCommandSpecs, r as findCommandByNativeName, s as listNativeCommandSpecsForConfig, u as resolveCommandArgMenu } from "./commands-registry-D7EYmGOY.js";
import { r as matchesMentionWithExplicit, t as buildMentionRegexes } from "./mentions-DAmJ29JV.js";
...
import { i as shouldRetryTelegramTransportFallback, o as normalizeTelegramApiRoot, r as resolveTelegramTransport, t as resolveTelegramApiBase } from "./fetch-FrUh6v7F.js";
import { t as expectDefined } from "./expect-runtime--WgnKYXT.js";
import "./number-runtime-C6TGSEc_.js";
import "./string-coerce-runtime-CLK2YdzD.js";
import { c as isTelegramMessageHasNoTextError, f as isTelegramRateLimitError, l as isTelegramMessageNotModifiedError, m as readTelegramRetryAfterMs, n as isRetryableTelegramApiError, p as isTelegramServerError, s as isTelegramEditTargetMissingError, t as isRecoverableTelegramNetworkError } from "./network-errors-DLD3mS-e.js";
import "./routing-BYqzCOl5.js";
import { r as getPluginCommandSpecs } from "./command-specs-DtQ5fYXw.js";
import { a as resolveEnvelopeFormatOptions, r as formatInboundEnvelope } from "./envelope-DYPQHVWk.js";
import { n as resolveInboundDebounceMs, t as createInboundDebouncer } from "./inbound-debounce-Duakvjqx.js";
import { i as shouldAckReaction } from "./ack-reactions-DV5aK48f.js";
import { t as evaluateSupplementalContextVisibility } from "./context-visibility-C5CaKMWO.js";
import { p as formatMediaPlaceholderText } from "./kernel-BmD9Chi3.js";
...
import { t as resolveMarkdownTableMode } from "./markdown-tables-sphRMT4d.js";
import { d as upsertChannelPairingRequest, s as readChannelAllowFromStore } from "./pairing-store-CTy8U4zO.js";
import { o as readLatestAssistantTextByIdentity, t as appendAssistantMirrorMessageByIdentity } from "./session-transcript-runtime-Cvc8VErx.js";
import { h as parseExecApprovalCommandText } from "./exec-approval-reply-NJpDn_K7.js";
import "./approval-reply-runtime-CY7TVctL.js";
...
import "./config-mutation-E7dCq_py.js";
...
import { n as createChannelProgressDraftCompositor } from "./progress-draft-compositor-CSgfZcLh.js";
import { n as isBtwRequestText } from "./btw-command-CsPaWKYu.js";
import { t as generateConversationLabel } from "./conversation-label-generator-Bd7004d7.js";
import "./reply-dispatch-runtime-CCzFVjsM.js";
import "./reply-reference-tvnAhCg2.js";
import "./reply-chunking-uTh3eV-E.js";
import { r as dispatchChannelInboundTurn, s as runChannelInboundEvent } from "./inbound-reply-dispatch-Dd9PyvSy.js";
import "./dedupe-runtime-aEFZQgGB.js";
import "./file-access-runtime-CtVtBVxP.js";
import "./runtime-config-snapshot-DjkKC15G.js";
import "./model-session-runtime-TWoFDVNw.js";
...
import { n as dispatchPluginInteractiveHandler, r as createInteractiveConversationBindingHelpers } from "./plugin-runtime-BIaL3Knz.js";
import "./security-runtime-Dk7rUwxb.js";
import "./hook-runtime-BtK7Iwxn.js";
import "./markdown-table-runtime-1KtmzObG.js";
import { t as resolveNativeCommandSessionTargets } from "./native-command-session-targets-8iIUPPYo.js";
import { n as formatModelsAvailableHeader } from "./commands-models-AcjdVom6.js";
import "./command-auth-native-CxtPZc15.js";
import "./command-primitives-runtime-DPqKtzG3.js";
import { n as buildCommandsMessagePaginated } from "./command-status-builders-B-VvDcUn.js";
import "./command-status-JMwUo-m0.js";
import "./command-detection-CXG4EAQY.js";
import "./command-surface-C_Espdug.js";
import { n as logInboundDrop, r as logTypingFailure } from "./logging-gUWPKC5g.js";
import { i as DEFAULT_EMOJIS } from "./channel-feedback-Doflo_AK.js";
import { o as classifyChannelInboundEvent, s as resolveUnmentionedGroupInboundPolicy, u as shouldDebounceTextInbound } from "./channel-inbound-Bmn0gdZ_.js";
import "./channel-inbound-debounce-BGa7I6XF.js";
import { a as createChannelIngressResolver, c as defineStableChannelIngressIdentity } from "./channel-ingress-runtime-BvjO25l3.js";
import { r as createChannelIngressMonitor } from "./ingress-monitor-Byj0Wgb8.js";
import { a as createMessageReceiveContext, i as resolveChannelDraftStreamingChunking } from "./channel-outbound-O2_4qIiZ.js";
import { t as createChannelPairingChallengeIssuer } from "./channel-pairing-BTpKky3B.js";
import { d as resolveScopeRequireMention, s as buildChannelGroupsScopeTree } from "./channel-policy-DDPgHZTe.js";
import { t as createChannelHistoryWindow } from "./reply-history-ydRF4RaB.js";
import { c as runClaimableDedupeClaimLoop, t as createChannelReplayGuard } from "./persistent-dedupe-ImNUIds4.js";
import "./models-provider-runtime-DW9N1_ZA.js";
import "./skill-commands-runtime-rp-XOLWr.js";
import "./native-command-config-runtime-CgbTdHDF.js";
import { t as codexChannelLoginRuntime } from "./provider-auth-login-flow-runtime-BuqerjYn.js";
import "./state-paths-BmhF8vB7.js";
import "./text-utility-runtime-D52Cj1WO.js";
import { a as normalizeDmAllowFromWithStore, i as normalizeAllowFrom, n as resolveTelegramDmAllow, o as resolveTelegramEffectiveDmPolicy, r as isSenderAllowed, t as expandTelegramAllowFromWithAccessGroups } from "./access-groups-DW-ZYoAo.js";
import { t as mergeTelegramAccountConfig } from "./account-config-DE09jCa-.js";
import { a as resolveDefaultTelegramAccountId, o as resolveTelegramAccount, s as resolveTelegramMediaRuntimeOptions } from "./accounts-CH5y3UJ3.js";
import { o as resolveTelegramTargetChatType } from "./targets-CJIsAOe0.js";
import { d as shouldSuppressLocalTelegramExecApprovalPrompt, n as isTelegramExecApprovalApprover, r as isTelegramExecApprovalAuthorizedSender } from "./exec-approvals-7Olo-bkV.js";
import { d as resolveTelegramMessageCacheScope, i as recordSentMessage } from "./sent-message-cache-CAytN1AT.js";
...
import { A as resolveTelegramStreamMode, B as hasLeadingBotCommandAddressedToOtherBot, C as resolveTelegramCommandAuthorization, D as resolveTelegramGroupAllowFromContext, E as resolveTelegramForumThreadId, F as buildSenderName, G as resolveTelegramPrimaryMedia, H as joinTelegramTextParts, I as extractTelegramLocation, J as resolveTelegramRichMessageText, L as getTelegramTextParts, M as shouldUseTelegramDmThreadSession, N as withResolvedTelegramForumFlag, O as resolveTelegramMessageForumFlagHint, P as buildSenderLabel, R as hasBotMention, S as resolveTelegramBotHasTopicsEnabled, T as resolveTelegramForumFlag, U as normalizeForwardedContext, W as renderTelegramTextEntities, _ as buildTypingThreadParams, a as resolveTelegramPromptContextDeliverySignature, b as isTelegramCommandsAllowFromConfigured, c as buildInlineKeyboard, d as buildTelegramGroupFrom, et as renderTelegramHtmlText, f as buildTelegramGroupPeerId, g as buildTelegramThreadParams, h as buildTelegramRoutingTarget, i as resolveCompleteTelegramPromptContextProjectionIds, j as resolveTelegramThreadSpec, k as resolveTelegramReplyId, l as TelegramPairingStoreReadError, m as buildTelegramParentPeer, n as createTelegramPromptContextProjectionSequence, p as buildTelegramInboundOriginTarget, q as resolveTelegramRichMessagePlaceholder, s as withTelegramPromptContextSource, u as buildGroupLabel, v as describeReplyTarget, y as extractTelegramForumFlag, z as hasBotMentionInText } from "./prompt-context-projection-B1FZZj1F.js";
import { r as resolveTelegramInlineButtonsScope } from "./inline-buttons-rn5Mcn4s.js";
import { n as resolveTelegramConversationRoute, t as resolveTelegramConversationBaseSessionKey } from "./conversation-route-MT73YqiK.js";
...
import { a as parseTelegramQuestionCallbackData, i as hasTelegramQuestionCallbackPrefix, n as resolveTelegramInlineButtons, r as resolveTelegramQuestionOptionIndices } from "./button-types-CAWoMaay.js";
import { n as canonicalizeTelegramPresentationPayload } from "./interactive-fallback-D_Qdpr5Q.js";
import { t as loadTelegramSendModule } from "./send-runtime-BL6mcY1m.js";
import { t as TELEGRAM_TEXT_CHUNK_LIMIT } from "./outbound-adapter-DpbAKT0n.js";
import { d as buildModelsKeyboard, g as resolveModelSelection, h as parseModelCallbackData, m as getModelsPageSize, o as buildTelegramModelsMenuButtons, p as calculateTotalPages, t as buildCommandsPaginationKeyboard } from "./command-ui-DPYaECea.js";
import { i as resolveTelegramCustomCommands, r as normalizeTelegramCommandName, t as TELEGRAM_COMMAND_NAME_PATTERN } from "./command-config-PZry_aTC.js";
import { n as getTopicName, o as resolveTopicNameCacheScope, p as getCachedSticker, s as updateTopicName, u as cacheSticker } from "./topic-name-cache-BWfp9YqW.js";
import { r as createTelegramThreadBindingManager } from "./thread-bindings-flJZsP1M.js";
import { t as describeStickerImage } from "./sticker-cache-CdYrnkxR.js";
import { n as evaluateTelegramGroupPolicyAccess, t as evaluateTelegramGroupBaseAccess } from "./group-access-DLb-ZAoi.js";
import { $ as selectTelegramGroupHistoryAfterLastSelf, B as buildTelegramConversationContext, C as markdownToTelegramRichBlocks, E as codeRichText, G as resolveProviderObservedTelegramThreadId, H as createTelegramMessageCache, J as isTelegramHistoryEntryAfterAmbientWatermark, K as buildTelegramSelfSenderName, O as italicRichText, Q as retainTelegramGroupHistoryPromptContext, R as recordOutboundMessageForPromptContext, T as boldRichText, V as buildTelegramReplyChain, W as isTelegramMessageFromCurrentBot, X as mergeTelegramGroupHistoryPromptContext, Y as isTelegramSelfSenderName, Z as recordTelegramGroupHistoryEntry, ct as resolveTelegramClientTimeoutMinimumSeconds, dt as withTelegramApiErrorLogging, ft as getOrCreateAccountThrottler, g as buildTelegramRichMarkdown, h as buildTelegramRichBlocksPlan, ht as sequentialize, k as paragraphBlock, lt as resolveTelegramClientTimeoutSeconds, m as TELEGRAM_RICH_TEXT_LIMIT, mt as apiThrottler, ot as asTelegramClientFetch, p as editMessageTelegram, pt as Bot$1, q as isTelegramChatWindowPromptContext, st as createTelegramClientFetch, ut as resolveTelegramOutboundClientTimeoutFloorSeconds, z as registerTelegramOutboundGroupHistoryRecorder } from "./send-Dhm1CdcY.js";
import { t as telegramInboundEventDelivery } from "./inbound-event-delivery-DdVerrw-.js";
import { n as buildTelegramInvalidApprovalTerminalText, r as buildTelegramLegacyApprovalTerminalText, t as buildTelegramCanonicalApprovalTerminalText } from "./approval-terminal-St41-r7e.js";
import { a as buildCappedTelegramMenuCommands, i as createTelegramDraftStream, n as resolveTelegramApproval, o as buildPluginTelegramMenuCommands, r as resolveTelegramLegacyApproval, s as syncTelegramMenuCommands, t as defaultTelegramBotDeps } from "./bot-deps-B_NbmhMh.js";
import { n as emitTelegramMessageSentHooks, t as deliverReplies } from "./delivery-CoYZHbfz.js";
...
async function buildTelegramInboundContextPayload(params) {
	...
	const inboundDebounceBodySegments = hasMultiMessageDebounceBatch ? options?.inboundDebounceMessages?.flatMap((debouncedMessage) => {
		...
		const segmentBody = renderTelegramTextEntities(textParts.text, textParts.entities) || formatMediaPlaceholderText(debouncedMedia ? [{ kind: debouncedMedia.kind }] : []);
	...
	const ambientTranscriptWatermarkLegacyKey = isGroup && historyKey ? sessionRuntime.resolveAmbientTranscriptWatermarkLegacyKey({
		channel: "telegram",
		accountId: route.accountId,
		conversationId: String(chatId),
		...resolvedThreadId !== void 0 ? { threadId: resolvedThreadId } : {}
...
const buildTelegramMessageContext = async ({ primaryCtx, allMedia, replyMedia = [], replyChain = [], promptContext = [], storeAllowFrom, options, bot, cfg, account, historyLimit, dmHistoryLimit, groupHistories, dmPolicy, allowFrom, groupAllowFrom, ackReactionScope, logger, resolveGroupActivation, resolveGroupRequireMention, resolveTelegramGroupConfig, runtime, sessionRuntime, upsertPairingRequest, sendChatActionHandler }) => {
...
function createLaneTextDeliverer(params) {
	...
	const streamText = async (laneName, lane, text, payload, useFinalTextRecovery, finalizePreview, buttons, promptContextSequence, followedByDurablePayload = false, allowErrorPayload = false) => {
		const stream = lane.stream;
	...
	return async ({ laneName, text, payload, infoKind, buttons, finalizePreview: requestedFinalizePreview, durable: requestedDurable, allowStream = true, promptContextSequence: suppliedPromptContextSequence }) => {
		...
		const streamed = allowStream && !reply.hasMedia ? await streamText(laneName, lane, streamedErrorDraftText ?? text, payload, isDurableFinal, finalizePreview, buttons, promptContextSequence, false, streamedErrorDraftText !== void 0) : void 0;
...
function createTelegramDraftController(params) {
	...
	const canStreamAnswerDraft = params.allowProviderPreview && streamDeliveryEnabled && !params.hasTelegramQuoteReply && !accountBlockStreamingEnabled && !params.forceBlockStreamingForReasoning;
	...
	const canStreamReasoningDraft = params.allowProviderPreview && !params.isRoomEvent && streamReasoningDraft && !streamReasoningInProgressDraft;
	...
	const updateDraftFromPartial = (lane, update, schedule = true) => {
	...
	const ingestDraftLaneSegments = async (update, isReasoning) => {
		if (isReasoning !== true) {
			...
			if (!stream) return;
			if (params.streamMode !== "progress" && (activeAnswerDraftIsToolProgressOnly || answerLane.finalized || rotateAnswerLaneWhenQueuedBlocksSettle && queuedAnswerBlockRotations.length === 0 && answerLane.hasStreamedMessage)) {
				const text = update.text;
				if (!text) return;
				await prepareAnswerLaneForText();
				updateDraftFromPartial(answerLane, {
					text,
					replace: true
				});
				return;
			...
			stream.updateLazy(() => {
				if (!didMaterialize) {
					const text = update.text;
					materialized = text ? updateDraftFromPartial(answerLane, {
						text,
						replace: true
					}, false) : void 0;
					didMaterialize = true;
...
function createTelegramProgressController(params) {
	...
	const handleToolStart = async (payload) => {
		...
		if (payload.phase === "start") if (canPushToolProgress() && resolveChannelStreamingPreviewToolProgress(params.telegramCfg, true, params.streamMode) && isChannelProgressDraftWorkToolName(toolName)) summary.noteToolCall();
		else {
...
function createTelegramReplyDelivery(params) {
	...
	const settleBufferedFinalAsNotVisible = () => {
		if (bufferedFinalSettlement) bufferedFinalSettlement.resolve({ visibleReplySent: bufferedFinalSettlement.visibleReplySent });
	...
	const flushBufferedFinalAnswer = async (currentPayloadVisible = false) => {
		...
		bufferedFinalSettlement = void 0;
		try {
			const result = await params.delivery.deliverFinalAnswerText(buffered.payload, buffered.text, resolvePayloadTelegramInlineButtons(buffered.payload));
	...
	const settleTerminalNoVisibleDelivery = async (info, options) => {
		if (options?.abandonBufferedFinal) resetReasoningStepState();
		else if (info.kind === "final") await flushBufferedFinalAnswer();
	...
	const deliver = (async (payload, info) => {
		if (params.fence.isSuperseded()) return await settleTerminalNoVisibleDelivery(info, { abandonBufferedFinal: true });
		const normalizedPayload = params.delivery.normalizeDeliveryPayload(payload);
		if (!normalizedPayload) return await settleTerminalNoVisibleDelivery(info);
		const deduped = info.kind === "final" ? deduplicateBlockSentMedia(normalizedPayload, sentBlockMediaUrls) : normalizedPayload;
		if (!deduped) return await settleTerminalNoVisibleDelivery(info);
		...
		if ((isToolPayloadAfterFinal || isNonTerminalWarningAfterDeliveredFinal) && !reply.hasMedia && !hasExecApprovalPayload(effectivePayload)) return await settleTerminalNoVisibleDelivery(info);
		...
		for (const segment of segments) {
			...
			const isDurableProgressCommentary = params.streamMode === "progress" && info.kind === "block" && effectivePayload.isCommentary === true;
			const suppressProgressAnswerBlock = params.streamMode === "progress" && info.kind === "block" && segment.lane === "answer" && !isDurableProgressCommentary && !reply.hasMedia && !hasExecApprovalPayload(effectivePayload) && telegramButtons === void 0;
			...
			if (segment.lane === "reasoning") {
				if (result.kind !== "skipped") {
					...
					if (finalization && bufferedFinalSettlement) bufferedFinalSettlement.visibleReplySent ||= blockDelivered;
					await flushBufferedFinalAnswer(blockDelivered);
				}
			} else if (info.kind === "final") resetReasoningStepState();
		}
	...
	return {
		...
		reasoningStepState: {
			...reasoningStepState,
			resetForNextStep: resetReasoningStepState
		}
	};
}
//#endregion
...
async function runTelegramDispatchTurn(params) {
	...
	try {
			...
			adapter: {
				...
				resolveTurn: () => ({
					...
					replyOptions: {
						...
						forceToolResultProgress: params.streamMode === "progress" && resolveChannelStreamingPreviewToolProgress(params.telegramCfg, true, params.streamMode),
		...
		params.state.noVisibleReplyFallbackEligible = turnResult.dispatchResult.noVisibleReplyFallbackEligible === true;
...
//#endregion
//#region src/infra/concurrency/sequential-keyed-queue.ts
/**
...
*/
var SequentialKeyedQueue = class {
	constructor() {
	...
	*/
	async runExclusive(key, fn) {
		...
		if (existing) this.collisionAvoidedCount++;
	...
	get activeDispatches() {
		return this.activeCount;
	}
	get collisionsAvoided() {
...
//#endregion
//#region src/infra/concurrency/admission-retry-policy.ts
...
*/
function isOptimisticConcurrencyError(error) {
	if (!error) return false;
	const msg = error instanceof Error ? error.message : typeof error === "string" ? error : JSON.stringify(error);
	return /changed while starting work/i.test(msg) || /SESSION_WORK_START_INVALIDATED/i.test(msg) || /session.*deleted while starting work/i.test(msg) || /transcript tail is not resumable/i.test(msg);
}
/**
* Computes deterministic retry decision for a turn admission error.
*/
function evaluateAdmissionRetry(error, attempt, options = {}) {
	...
	if (!isOptimisticConcurrencyError(error) || attempt >= maxRetries) return {
		shouldRetry: false,
		backoffMs: 0,
		attempt,
	...
	return {
		shouldRetry: true,
		backoffMs: Math.min(Math.round(rawBackoff), maxBackoff),
		attempt: attempt + 1,
...
//#endregion
//#region src/infra/concurrency/concurrency-telemetry.ts
var ConcurrencyTelemetryTracker = class {
	constructor() {
		this.totalDispatches = 0;
		this.totalRetries = 0;
		this.totalLockCollisionsAvoided = 0;
	}
	recordExecution(params) {
		this.totalDispatches++;
		this.totalRetries += Math.max(0, params.attempts - 1);
		if (params.collisionAvoided) this.totalLockCollisionsAvoided++;
		return {
			value: params.value,
...
//#endregion
//#region extensions/telegram/src/telegram-session-guard.ts
/**
...
const globalTelegramSessionGuard = new TelegramSessionGuard();
//#endregion
...
const dispatchTelegramMessage = async ({ context, bot, cfg, runtime, replyToMode, streamMode, textLimit, telegramCfg, telegramDeps: injectedTelegramDeps, opts, retryDispatchErrors = false, suppressFailureFallback = false, turnAdoptionLifecycle }) => {
	...
	const telegramDeps = injectedTelegramDeps ?? (await import("./bot-deps-B_k6DCZ7.js")).defaultTelegramBotDeps;
	...
	try {
		...
		const targetSessionKey = dispatchContext.ctxPayload.SessionKey || `telegram:${dispatchContext.chatId}:${dispatchContext.threadSpec.id ?? "default"}`;
		try {
			turnDispatched = (await globalTelegramSessionGuard.executeGuardedTurn({
				...
				onRetry: (attempt, err, backoffMs) => {
					loadFreshSessionEntry.clear();
					logVerbose(`[telegram-session-guard] retrying turn admission (attempt=${attempt}, backoff=${backoffMs}ms): ${String(err)}`);
				}
			})).value;
		} catch (err) {
	...
	if (!isRoomEvent && !suppressFailureFallback && !progress.finalAnswerDelivered() && (state.dispatchError || deliverySummary.failedNonSilent > 0 || deliverySummary.skippedNonSilent > 0 && !state.suppressSilentReplyFallback)) {
	...
	if (!sentFallback && !state.dispatchError && !deliverySummary.delivered && !state.suppressSilentReplyFallback && !state.queuedFinal && state.noVisibleReplyFallbackEligible) {
		sentFallback = (await delivery.deliverFallback([{ text: EMPTY_RESPONSE_FALLBACK$1 }], false)).delivered;
	...
	if (status.controller) status.finalizeInBackground({ outcome: !progress.finalAnswerDelivered() && (state.dispatchError != null || sentFallback) ? "error" : "done" }, "finalize");
	return { kind: "completed" };
};
//#endregion
...
function getTelegramMessageReactionSequentialKey(ctx) {
	...
	if (reaction?.chat?.is_forum === true && typeof reaction.chat.id === "number" && typeof reaction.message_id === "number") return `telegram:${reaction.chat.id}:message:${reaction.message_id}`;
	...
	return resolveTelegramMessageForumFlagHint({
		...
		isTopicMessage: msg?.is_topic_message
	}) && typeof msg?.chat.id === "number" && typeof msg.message_id === "number" ? `telegram:${msg.chat.id}:message:${msg.message_id}` : void 0;
}
		...
		invoke: ({ registration, namespace, payload }) => {
			...
			return registration.handler({
				...
				...createInteractiveConversationBindingHelpers({
					registration: handlerContext.auth?.isAuthorizedSender && handlerContext.senderId?.trim() && handlerContext.accountId?.trim() && handlerContext.conversationId?.trim() ? registration : {
						...registration,
						pluginRoot: void 0
					},
		...
		for (const command of nativeCommands) {
			...
			bot.command(normalizedCommandName, async (ctx) => {
				...
				if (commandDefinition?.key === "login") {
					...
					const sendLoginDeviceCode = async (params) => {
						await withTelegramApiErrorLogging({
							operation: "sendMessage",
							runtime,
							fn: () => bot.api.sendMessage(chatId, formatTelegramLoginDeviceCode(params), {
								...threadParams,
								parse_mode: "HTML"
							})
						});
				...
				const turnPlan = {
					...
					record: {
						...
						onRecordError: (err) => runtime.error?.(danger(`telegram slash: failed updating session meta: ${String(err)}`))
					},
					afterRecord: async () => {
					...
					delivery: {
						...
						onDelivered: (_payload, _info, result) => {
							...
							if (reason === "cancelled_by_reply_payload_sending_hook" || reason === "empty_after_reply_payload_sending_hook") deliveryState.intentionallySuppressed = true;
						},
						onError: (err, info) => {
				...
				const turnResult = await (telegramDeps.dispatchChannelInboundTurn ?? defaultTelegramNativeCommandDeps.dispatchChannelInboundTurn)(turnPlan);
				if (!deliveryState.delivered && !deliveryState.intentionallySuppressed && deliveryState.skippedNonSilent > 0 && (!turnResult.dispatched || turnResult.dispatchResult.sourceReplyDeliveryMode !== "message_tool_only" || deliveryState.failedNonSilent > 0)) await deliverReplies({
...
function registerTelegramCallbackQueryHandler({ accountId, bot, runtime, telegramDeps, shouldSkipUpdate }, messageRuntime, authorizationRuntime) {
	...
	bot.on("callback_query", async (ctx) => {
		...
		try {
			...
			if ((callbackMessage.reply_markup?.inline_keyboard?.length ?? 0) > 0) try {
		...
		try {
			...
			for (const { ctx, msg } of entry.messages) {
				...
				try {
					...
					if (entry.spooledReplayParticipants.length > 0 && (mediaRuntimeWithAbort.abortSignal?.aborted || isDurablyRetryableInboundMediaError(error))) throw error;
			...
			if (skippedCount > 0 && mediaDisposition !== "silent-ingest") {
				...
				await withTelegramApiErrorLogging({
					...
					fn: () => bot.api.sendMessage(primary.msg.chat.id, `⚠️ Received ${materializedCount} of ${entry.messages.length} images — ${skippedCount} could not be fetched and ${verb} skipped.`, {
						...buildTelegramThreadParams(resolveTelegramThreadSpec({
...
function createTelegramInboundTextRuntime({ opts, runtime }, messageRuntime) {
	...
	const flush = async (entry) => {
		try {
			...
			const combinedTextParts = joinTelegramTextParts(entry.messages.map((message) => message.msg), "");
			const combinedText = combinedTextParts.text;
...
function createTelegramHandlerInboundRuntime({ cfg, accountId, bot, opts, runtime, mediaMaxBytes, logger, resolveGroupActivation, resolveGroupRequireMention }, messageRuntime) {
	...
	const { handleMediaGroup, resolveUnaddressedGroupMediaDisposition } = createTelegramInboundMediaGroupRuntime({
		accountId,
		bot,
		opts,
		runtime,
	...
	const processInboundMessage = async (params) => {
		...
		try {
			...
			const warningThreadParams = buildTelegramThreadParams(resolveTelegramThreadSpec({
				isGroup,
				isForum,
				messageThreadId: resolvedThreadId ?? dmThreadId
			}));
...
function registerTelegramMessageHandlers({ bot, opts, runtime, shouldSkipUpdate }, messageRuntime, authorizationRuntime, inboundRuntime) {
	...
	bot.on("message", async (ctx) => {
		...
		if (normalizedMsg.from?.id != null && normalizedMsg.from.id === botUserId) return;
...
function createTelegramMessageContextRuntime({ cfg, accountId, opts, telegramCfg, telegramDeps }) {
	const messageCache = createTelegramMessageCache({ scope: resolveTelegramMessageCacheScope(telegramDeps.resolveStorePath(cfg.session?.store, { agentId: cfg.agents ? resolveDefaultAgentId(cfg) : "main" })) });
	...
	const resolveCachedMessageThreadId = async (params) => {
		return resolveProviderObservedTelegramThreadId(await messageCache.get({
			accountId,
			chatId: params.chatId,
	...
	const toReplyChainEntry = (node, ctx, media) => {
		const { sourceMessage: _sourceMessage, promptContextProjectionMarker: _promptContextProjectionMarker, threadBinding: _threadBinding, ...entry } = node;
...
function createTelegramMessageSessionRuntime({ accountId, resolveTelegramGroupConfig, telegramDeps }) {
	const resolveTelegramSessionState = (params) => {
		...
		const storedOverride = resolveStoredModelOverride({
			sessionEntry: entry,
			sessionStore: Object.fromEntries((telegramDeps.listSessionEntries ?? listSessionEntries)({
				storePath,
				readOnly: true
			}).map(({ sessionKey: key, entry: value }) => [key, value])),
			sessionKey,
	...
	const resolvePromptContextAmbientWatermark = (params) => {
		...
		const legacyKey = (telegramDeps.resolveAmbientTranscriptWatermarkLegacyKey ?? resolveAmbientTranscriptWatermarkLegacyKey)({
			channel: "telegram",
			accountId,
			conversationId: String(params.chatId),
			...params.resolvedThreadId !== void 0 ? { threadId: params.resolvedThreadId } : {}
...
function createTelegramHandlerMessageRuntime({ cfg, accountId, bot, opts, telegramTransport, runtime, mediaMaxBytes, telegramCfg, resolveTelegramGroupConfig, processMessage, logger, telegramDeps }) {
	...
	const { recordMessageForReplyChain, resolveCachedMessageThreadId, buildReplyChainForMessage, toReplyChainEntry, buildPromptContextForMessage } = createTelegramMessageContextRuntime({
		cfg,
		accountId,
		opts,
		telegramCfg,
...
function registerTelegramReactionHandler({ accountId, bot, runtime, telegramDeps, shouldSkipUpdate }, threadRecovery, authorizationRuntime) {
	...
	bot.on("message_reaction", async (ctx) => {
		try {
			...
			let cachedForumThreadId;
			if (isForum) {
				cachedForumThreadId = await threadRecovery.resolveCachedMessageThreadId({
					chatId,
					messageId
				});
				if (cachedForumThreadId === void 0) {
					runtime.log?.(warn(`telegram: skipped forum reaction account=${accountId} chat=${chatId} message=${messageId} reason=${TELEGRAM_REACTION_THREAD_UNRESOLVED_REASON}`));
					return;
				}
			}
			const eventAuthContext = await resolveTelegramEventAuthorizationContext({
				...
				isForum,
				senderId,
				...cachedForumThreadId === void 0 ? {} : { messageThreadId: cachedForumThreadId }
			});
			if (!await authorizeTelegramEventSender({
				chatId,
			...
			let sessionKey;
			if (isForum) sessionKey = resolveTelegramConversationRoute({
...
function createTelegramIngressMonitor(params) {
	return createChannelIngressMonitor({
		queue: params.queue,
		inspect: (update, context) => inspectTelegramSpooledUpdate(update, params.botInfo, context.phase === "claim" ? context.claimedLaneKey : void 0),
		payload: {
			version: 1,
		...
		deliver: async (update, lifecycle) => {
			...
			try {
				const result = await runWithTelegramSpooledReplayUpdate(update, async () => await params.dispatch(update, telegramLifecycle), telegramLifecycle);
...
//#endregion
export { resolveTelegramUpdateId$1 as a, resolveTelegramIngressSpoolDir as i, resolveTelegramAdoptionStallTimeoutMs as n, telegramSpooledUpdateLaneKey as o, createTelegramBot as r, writeTelegramSpooledUpdate as s, createTelegramTransportIngressMonitor as t };
