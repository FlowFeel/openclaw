import { A as ReplyDispatchBeforeDeliverOptions, C as PluginConversationBinding, D as PluginHookBeforeToolCallResult, E as PluginConversationBindingResolvedEvent$1, F as ResolvedSessionMaintenanceConfigInput, I as PluginJsonValue, M as ReplyDispatchRuntimeInfo, N as ReplyDispatcher, O as DiagnosticTraceContext, P as ReplyFollowupAdmissionBarrierTimeoutPolicy, S as PluginNextTurnInjectionEnqueueResult, T as PluginConversationBindingRequestResult, _ as PluginHookRegistration$1, a as OutboundDeliveryQueuePolicy, b as PluginToolMatcher, c as readRemoteMediaBuffer, d as saveMediaBuffer, f as SessionManager, g as PluginHookName, h as PluginHookHandlerMap, i as DurableFinalDeliveryRequirements, j as ReplyDispatchKind, k as ReplyDispatchBeforeDeliver, l as saveRemoteMedia, m as PluginHookBeforeToolCallEvent, n as resizeToJpeg, p as PluginSubagentRequesterContext, r as DeliverOutboundPayloadsParams, s as fetchRemoteMedia, t as getImageMetadata, u as saveResponseMedia, v as PluginHookRegistrationOptions, w as PluginConversationBindingRequestParams, x as PluginNextTurnInjection, y as PluginHookToolContext } from "./media-services-1HWzm960.js";
import { Bg as TtsMode, Gg as MentionPatternsPolicyConfig, Kg as MemoryCitationsMode, Lg as ResolvedTtsPersona, Mg as TalkProviderConfig, Ng as ChannelImplicitMentionsConfig, Qg as MarkdownTableMode$1, Rg as TtsAutoMode, Vg as TtsProvider, Wg as SafeBinProfileFixture, Xg as HumanDelayConfig, Yg as DmScope, Zg as IdentityConfig, a_ as SilentReplyConversationType, gt as ZodType, i_ as ChatType, n as OpenClawConfig, n_ as PromptMode, qg as ContextVisibilityMode, r_ as SilentReplyPromptMode, t as ConfigFileSnapshot, t_ as SessionScope, zg as TtsConfig } from "./types.openclaw-_47ZKysp.js";
import { t as FastMode } from "./string-coerce-D1ftETdv.js";
import { a as ModelProviderAuthMode, h as SecretRef, i as ModelMediaInputConfig, m as SecretInput, n as ModelCompatConfig, o as ModelProviderConfig, p as AgentToolModelConfig, r as ModelDefinitionConfig, t as ModelApi, u as AgentModelConfig } from "./types.models-BEJn4TTJ.js";
import { a as Context, c as Model, d as SimpleStreamOptions, g as Usage, i as AssistantMessageEventStreamContract, n as Api, o as ImageContent, r as AssistantMessage } from "./types-CwI9hEPH.js";
import { A as chunkByNewline, At as PluginHookChannelContext, B as PluginApprovalRequest, Bt as MediaFact, Ct as MsgContext, D as ChannelOutboundAdapter, Dt as HistoryMediaEntry, Et as HistoryEntry, F as resolveChunkMode, Ft as TaskSuggestionDeliveryMode, Gt as ReplyMediaAttachment, H as WizardPrompter, Ht as MediaKind, I as resolveTextChunkLimit, It as TurnAdoptionLifecycle, J as ChannelAccountSnapshot, Jt as MessagePresentation, Kt as ReplyPayload, Lt as UserTurnTranscriptRecorder, M as chunkMarkdownTextWithMode, Mt as BlockReplyContext, N as chunkText, Nt as GetReplyOptions, Ot as CommandTurnContext, P as chunkTextWithMode, Pt as PartialReplyPayload, Rt as InputProvenance, St as MentionSource, Tt as SupplementalContextFacts, Ut as mediaKindFromMime, V as PluginApprovalRequestPayload, Vt as PromptImageOrderEntry, W as MessageReceipt, Wt as AgentPlanStep, Yt as ModelPickerAction, _t as ExecSecurity, bt as FinalizedRuntimeMsgContext, ft as OutboundMediaReadFile, gt as ExecMode, ht as ExecAsk, j as chunkMarkdownText, jt as InboundEventKind, kt as CommandTurnKind, mt as ExecApprovalRequestPayload$1, pt as ExecApprovalDecision, st as ChannelThreadingToolContext, tt as ChannelMessageActionAdapter, ut as ConversationReadInvocationOrigin, vt as ExecTarget, wt as SessionTranscriptContext, xt as InboundSourceModality, yt as FinalizedMsgContext, z as OutboundPayloadDeliverySuppressionReason, zt as LegacyMediaContextKey } from "./setup-wizard-types-B677hB7z.js";
import { _ as ChannelRouteRef, a as SessionContextBudgetStatus, b as SessionsCompanionAskResult, c as SessionSystemPromptReport, d as SessionCreatedVia, f as HookExternalContentSource, g as Skill, h as DeliveryContext, l as SessionToolOverrides, m as SourceReplyDeliveryMode, n as CliSessionBinding, o as SessionEntry, r as GroupKeyResolution, s as SessionPluginJsonValue, t as ChannelId$1, u as SessionCreatedActor, v as CronScheduledToolPolicy, x as SessionsCompanionStateResult, y as SessionObserverDigest } from "./channel-id.types-D5AaRnW1.js";
import { C as PluginKind, D as ModelCatalogStatus, E as JsonSchemaObject, O as UnifiedModelCatalogEntry, _ as PluginManifestDashboard, a as PluginOrigin$1, b as PluginManifestMcpServer, d as RuntimeEnv, f as PluginBundleFormat, g as PluginManifestContracts, h as PluginFormat, i as PluginDependencyStatus, k as UnifiedModelCatalogKind, m as PluginDiagnostic, p as PluginConfigUiHint, t as PluginManifestRecord, v as PluginManifestDashboardActionVerb, y as PluginManifestDashboardDataBinding } from "./manifest-registry-Cbr_emsE.js";
import { n as PluginMetadataSnapshotOwnerMaps, r as PluginCompatCode, t as PluginMetadataSnapshot } from "./plugin-metadata-snapshot.types-Dv5_D5En.js";
import { i as ConfigWriteAfterWrite, n as resolveStateDir, r as ConfigReplaceResult } from "./config-DOwDAFiu.js";
import { i as AgentToolUpdateCallback, n as AgentTool, r as AgentToolResult, s as StreamFn, t as AgentMessage } from "./agent-core-4iyL9Wnl.js";
import { i as OAuthCredential$1, n as AuthProfileCredential, r as AuthProfileStore, t as ApiKeyCredential$1 } from "./types-FvzTWUJ4.js";
import { i as MediaUnderstandingProvider } from "./types-CPoo3Uhn.js";
import { n as ChannelPlugin$3, r as OperatorScope } from "./types.public-CxoCYEcS.js";
import { r as SsrFPolicy } from "./ssrf-82Db1HTt.js";
import { a as VideoGenerationProvider, i as VideoGenerationNormalization, n as GeneratedVideoAsset, o as VideoGenerationResolution, r as VideoGenerationIgnoredOverride, s as VideoGenerationSourceAsset, t as ModelProviderRequestTransportOverrides$1 } from "./provider-request-config-BYqFgiUH.js";
import { a as OAuthProviderInterface, i as OAuthProviderId, n as OAuthLoginCallbacks, t as OAuthCredentials } from "./provider-oauth-runtime-DxzcDXot.js";
import { a as buildAgentSessionKey, c as SessionBindingRecord, i as UpsertChannelPairingRequestForAccount, l as InboundLastRouteUpdate, n as ReadChannelAllowFromStoreForAccount, o as resolveAgentRoute, r as RemoveChannelAllowFromStoreEntryForAccount, t as buildPairingReply, u as RecordInboundSession$1 } from "./pairing-messages-BRRXQGTT.js";
import { n as resolveChannelGroupRequireMention, t as resolveChannelGroupPolicy } from "./group-policy-BLq-6IBc.js";
import { t as MediaNormalizationEntry } from "./normalization-CdPHM6JL.js";
import { a as ImageGenerationOutputFormat, c as ImageGenerationProviderOptions, d as ImageGenerationResolution, i as ImageGenerationNormalization, l as ImageGenerationQuality, n as ImageGenerationBackground, o as ImageGenerationProvider, p as ImageGenerationSourceImage, r as ImageGenerationIgnoredOverride, t as GeneratedImageAsset } from "./types-CJCX-FF5.js";
import { n as PluginStateKeyedStore, r as PluginStateSyncKeyedStore, t as OpenKeyedStoreOptions } from "./plugin-state-store.types-DHbgXxYY.js";
import { i as MediaUnderstandingRuntime } from "./runtime-types-6jfV0woi.js";
import { o as ProviderRouteOverridePresence, r as ProviderModelRouteRuntimePolicy, t as ProviderModelRouteAuthRequirement } from "./provider-model-types-Be5uEMwN.js";
...
type AnyAgentTool$1 = Omit<AgentTool, "execute"> & ErasedAgentToolExecute & {
  displaySummary?: string; /** Keep this tool model-visible; hidden catalog bridges cannot preserve its result contract. */
  catalogMode?: "direct-only"; /** Gateway client capabilities required before this tool can be assembled. */
  requiredClientCaps?: string[];
...
type CronJobPatch = Partial<Omit<CronJob, "id" | "createdAtMs" | "state" | "payload" | "delivery" | "failureAlert" | "declarationKey" | "displayName" | "owner" | "scheduledToolPolicy" | "pacing">> & {
...
type BuildPluginConfigSchemaOptions = {
  ...
  safeParse?: OpenClawPluginConfigSchema$1["safeParse"];
};
/** Build a plugin config schema from Zod, exporting JSON Schema when the Zod runtime supports it. */
declare function buildPluginConfigSchema(schema: ZodType, options?: BuildPluginConfigSchemaOptions): OpenClawPluginConfigSchema$1;
//#endregion
...
type TranscriptSourceProvider$2 = TranscriptSourceProvider;
...
type OpenClawPluginSecurityAuditCollector$2 = OpenClawPluginSecurityAuditCollector$1;
type OpenClawPluginService$2 = OpenClawPluginService$1;
type OpenClawPluginToolFactory$2 = OpenClawPluginToolFactory$1;
...
type MigrationProviderPlugin$2 = MigrationProviderPlugin$1;
...
type PluginToolRegistration = {
  pluginId: string;
  pluginName?: string;
  factory: OpenClawPluginToolFactory$2;
  names: string[];
...
type PluginTranscriptsSourceProviderRegistration = PluginOwnedProviderRegistration<TranscriptSourceProvider$2>;
...
type PluginMigrationProviderRegistration = PluginOwnedProviderRegistration<MigrationProviderPlugin$2>;
...
type PluginServiceRegistration = {
  pluginId: string;
  pluginName?: string;
  service: OpenClawPluginService$2;
  source: string;
  origin: PluginOrigin;
...
type PluginNodeHostCommandRegistration = {
  pluginId: string;
  pluginName?: string;
  command: OpenClawPluginNodeHostCommand$1;
  source: string;
  rootDir?: string;
};
...
type PluginSecurityAuditCollectorRegistration = {
  pluginId: string;
  pluginName?: string;
  collector: OpenClawPluginSecurityAuditCollector$2;
  source: string;
  rootDir?: string;
};
...
declare function resolveApiKeyForProvider$1(params: {
  provider: string;
  cfg?: OpenClawConfig;
  profileId?: string;
 ...
 */
type ProviderDefaultThinkingPolicyContext$1 = ProviderThinkingPolicyContext & {
...
type ProviderThinkingProfile$1 = {
 ...
 */
type ProviderReplayPolicyContext$1 = {
  config?: OpenClawConfig;
  agentDir?: string;
  workspaceDir?: string;
  env?: NodeJS.ProcessEnv;
 ...
 */
type ProviderSanitizeReplayHistoryContext = ProviderReplayPolicyContext$1 & {
  sessionId: string;
 ...
 */
type ProviderValidateReplayTurnsContext = ProviderReplayPolicyContext$1 & {
  sessionId?: string;
  messages: AgentMessage[];
  sessionState?: ProviderReplaySessionState;
};
 ...
 */
type ProviderNormalizeToolSchemasContext = ProviderReplayPolicyContext$1 & {
 ...
 */
type ProviderReasoningOutputModeContext = ProviderReplayPolicyContext$1;
//#endregion
...
type ProviderAuthMethod$1 = {
  ...
  run: (ctx: ProviderAuthContext$1) => Promise<ProviderAuthResult>;
 ...
 */
type ProviderNormalizeResolvedModelContext$1 = {
  config?: OpenClawConfig;
  agentDir?: string;
  workspaceDir?: string;
  provider: string;
 ...
 */
type ProviderResolveUsageAuthContext$1 = {
  config: OpenClawConfig;
  agentDir?: string;
  workspaceDir?: string;
  env: NodeJS.ProcessEnv;
 ...
 */
type ProviderResolvedUsageAuth$1 = ProviderUsageAuthToken | {
  handled: true;
};
/**
 ...
 */
type ProviderFetchUsageSnapshotContext$1 = {
  config: OpenClawConfig;
  agentDir?: string;
  workspaceDir?: string;
  env: NodeJS.ProcessEnv;
 ...
 */
type ProviderTransportTurnState$1 = {
  headers?: Record<string, string>;
  metadata?: Record<string, string>;
};
/**
 ...
 */
type ProviderResolveTransportTurnStateContext$1 = {
  provider: string;
  modelId: string;
  model?: ProviderRuntimeModel;
  sessionId?: string;
 ...
 */
type ProviderWebSocketSessionPolicy$1 = {
  headers?: Record<string, string>;
 ...
 */
type ProviderResolveWebSocketSessionPolicyContext$1 = {
  provider: string;
  modelId: string;
  model?: ProviderRuntimeModel;
  sessionId?: string;
...
type OpenClawPluginToolContext$1 = {
...
type OpenClawPluginToolFactory$1 = (ctx: OpenClawPluginToolContext$1) => AnyAgentTool$1 | AnyAgentTool$1[] | null | undefined;
...
type PluginRuntimeTaskFlow = {
  ...
  fromToolContext: (ctx: Pick<OpenClawPluginToolContext$1, "sessionKey" | "deliveryContext">) => BoundTaskFlowRuntime;
};
//#endregion
...
type PluginRuntimeTaskRuns = {
  ...
  fromToolContext: (ctx: Pick<OpenClawPluginToolContext$1, "sessionKey" | "deliveryContext">) => BoundTaskRunsRuntime;
};
...
type PluginRuntimeTaskFlows = {
  ...
  fromToolContext: (ctx: Pick<OpenClawPluginToolContext$1, "sessionKey" | "deliveryContext">) => BoundTaskFlowsRuntime;
};
//#endregion
...
type AgentHarnessProviderUsageCapability = {
   ...
   */
  fetchUsageSnapshot?: (ctx: ProviderFetchUsageSnapshotContext$1) => Promise<ProviderUsageSnapshot | null | undefined> | ProviderUsageSnapshot | null | undefined;
};
...
type OpenClawPluginNodeHostCommand$1 = OpenClawPluginNodeHostCommandBase & {
  duplex?: boolean;
...
type MigrationPlan$1 = {
  providerId: string;
  source: string;
  target?: string;
  summary: MigrationSummary;
  items: MigrationItem$1[];
  warnings?: string[];
  nextSteps?: string[];
  metadata?: Record<string, unknown>;
};
type MigrationApplyResult$1 = MigrationPlan$1 & {
  backupPath?: string;
  reportDir?: string;
};
...
type MigrationProviderContext$1 = {
  config: OpenClawConfig;
...
type MigrationProviderPlugin$1 = {
  ...
  detect?: (ctx: MigrationProviderContext$1) => MigrationDetection | Promise<MigrationDetection>;
  prepareApply?: (ctx: MigrationProviderContext$1) => MigrationProviderPreparation | Promise<MigrationProviderPreparation | undefined> | undefined;
  plan: (ctx: MigrationProviderContext$1) => MigrationPlan$1 | Promise<MigrationPlan$1>;
  apply: (ctx: MigrationProviderContext$1, plan?: MigrationPlan$1) => MigrationApplyResult$1 | Promise<MigrationApplyResult$1>;
};
...
type OpenClawPluginSecurityAuditContext$1 = {
  config: OpenClawConfig;
  sourceConfig: OpenClawConfig;
  env: NodeJS.ProcessEnv;
  stateDir: string;
...
type OpenClawPluginSecurityAuditCollector$1 = (ctx: OpenClawPluginSecurityAuditContext$1) => SecurityAuditFinding[] | Promise<SecurityAuditFinding[]>;
...
type ProviderPlugin = {
   ...
   * transport quirks.
   */
  normalizeResolvedModel?: (ctx: ProviderNormalizeResolvedModelContext$1) => ProviderRuntimeModel | null | undefined;
  /**
   ...
   */
  buildReplayPolicy?: (ctx: ProviderReplayPolicyContext$1) => ProviderReplayPolicy$1 | null | undefined;
  /**
   ...
   */
  normalizeToolSchemas?: (ctx: ProviderNormalizeToolSchemasContext) => AnyAgentTool$1[] | null | undefined;
  /**
   ...
   * core.
   */
  resolveTransportTurnState?: (ctx: ProviderResolveTransportTurnStateContext$1) => ProviderTransportTurnState$1 | null | undefined;
  /**
   * Provider-owned WebSocket session policy.
   *
   ...
   * fallback.
   */
  resolveWebSocketSessionPolicy?: (ctx: ProviderResolveWebSocketSessionPolicyContext$1) => ProviderWebSocketSessionPolicy$1 | null | undefined;
  /**
   ...
   */
  resolveUsageAuth?: (ctx: ProviderResolveUsageAuthContext$1) => Promise<ProviderResolvedUsageAuth$1 | null | undefined> | ProviderResolvedUsageAuth$1 | null | undefined;
  /**
   ...
   */
  resolveThinkingProfile?: (ctx: ProviderDefaultThinkingPolicyContext$1) => ProviderThinkingProfile$1 | null | undefined;
  /**
...
type OpenClawPluginApi$1 = {
  ...
  registerTool: (tool: AnyAgentTool$1 | OpenClawPluginToolFactory$1, opts?: OpenClawPluginToolOptions) => void;
  ...
  registerNodeHostCommand: (command: OpenClawPluginNodeHostCommand$1) => void;
 ...
 */
type OpenClawPluginConfigSchema$1 = {
...
type OpenClawPluginDefinition$1 = {
  id?: string;
  name?: string;
  description?: string;
  version?: string;
   ...
   */
  kind?: PluginKind | PluginKind[];
  configSchema?: OpenClawPluginConfigSchema$1;
  reload?: OpenClawPluginReloadRegistration;
  nodeHostCommands?: OpenClawPluginNodeHostCommand$1[];
  securityAuditCollectors?: OpenClawPluginSecurityAuditCollector$1[];
  register?: (api: OpenClawPluginApi$1) => void;
};
//#endregion
...
//#endregion
export { cloneFirstTemplateModel as $, ProviderWebSocketSessionPolicy as A, createActionGate as At, RealtimeVoiceBridge as B, ProviderReplayPolicyContext as C, GatewayRequestContext as Ct, ProviderResolvedUsageAuth as D, createSubsystemLogger as Dt, ProviderResolveWebSocketSessionPolicyContext as E, SubsystemLogger$1 as Et, ImageGenerationProviderPlugin as F, RealtimeVoiceToolResultOptions as G, RealtimeVoiceBrowserSession as H, RealtimeTranscriptionProviderPlugin as I, ProviderUsageSnapshot as J, GenerateImageParams as K, RealtimeVoiceProviderPlugin as L, OpenClawPluginDefinition$1 as M, OpenClawPluginApi$1 as N, ProviderThinkingProfile as O, FallbackAttempt as Ot, ProviderPlugin as P, ProviderThinkingProfile$1 as Q, SpeechProviderPlugin as R, ProviderReplayPolicy as S, getSessionEntry as St, ProviderResolveUsageAuthContext as T, GatewayRequestOptions as Tt, RealtimeVoiceBrowserSessionCreateRequest as U, RealtimeVoiceBridgeCreateRequest as V, RealtimeVoiceProviderCapabilities as W, resolveApiKeyForProvider as X, OPENAI_DEFAULT_IMAGE_MODEL as Y, normalizeGooglePreviewModelId as Z, ProviderAuthContext as _, createReplyPrefixContext as _t, MigrationProviderContext as a, getImageGenerationProvider as at, ProviderFetchUsageSnapshotContext as b, MemoryEmbeddingProviderCreateOptions as bt, OpenClawPluginConfigSchema as c, resolveAgentModelPrimaryValue as ct, OpenClawPluginSecurityAuditCollector as d, throwCapabilityGenerationFailure as dt, matchesExactOrPrefix as et, OpenClawPluginSecurityAuditContext as f, describeFailoverError as ft, PluginLogger as g, PluginRuntime as gt, OpenClawPluginToolFactory as h, PluginRegistry as ht, MigrationPlan as i, parseImageGenerationModelRef as it, definePluginEntry as j, ProviderTransportTurnState as k, AnyAgentTool$1 as kt, OpenClawPluginDefinition as l, buildNoCapabilityModelConfiguredMessage as lt, OpenClawPluginToolContext as m, getProviderEnvVars as mt, MigrationApplyResult as n, resolveGpt5SystemPromptContribution as nt, MigrationProviderPlugin as o, listImageGenerationProviders as ot, OpenClawPluginService as p, isFailoverError as pt, GenerateImageRuntimeResult as q, MigrationItem as r, ProviderSystemPromptContribution as rt, OpenClawPluginApi as s, resolveAgentModelFallbackValues as st, AnyAgentTool as t, Gpt5PromptOverlayMode as tt, OpenClawPluginNodeHostCommand as u, resolveCapabilityModelCandidates as ut, ProviderAuthMethod as v, MemoryEmbeddingProvider as vt, ProviderResolveTransportTurnStateContext as w, GatewayRequestHandlers as wt, ProviderNormalizeResolvedModelContext as x, buildPluginConfigSchema as xt, ProviderDefaultThinkingPolicyContext as y, MemoryEmbeddingProviderAdapter as yt, RealtimeVoiceAgentConsultRunner as z };