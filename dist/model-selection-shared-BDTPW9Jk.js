...
import { _ as computeModelPolicyAllowlist, o as resolveAgentConfig, v as hasExplicitModelPolicyAllow } from "./agent-scope-config-Dusa8eSA.js";
...
import { a as normalizeConfiguredProviderCatalogModelId, l as normalizeStaticProviderModelId, o as normalizeModelRef, s as normalizeProviderId$1 } from "./model-ref-shared-BCBRWGJh.js";
import { n as parseModelRef, t as findNormalizedProviderValue$1 } from "./model-selection-normalize-Bae-aoqX.js";
...
function modelTransportRoutesMatch(catalogRoute, configuredRoute) {
	...
	return (normalizeApi(configuredRoute.api) || catalogApi) === catalogApi && (normalizeBaseUrl(configuredRoute.baseUrl) || catalogBaseUrl) === catalogBaseUrl;
}
...
function buildAllowedModelSetWithFallbacks(params) {
	...
	const visibility = params.visibility ?? parseConfiguredModelVisibilityEntries({
		cfg: params.cfg,
		agentId: params.agentId
	});
	...
	const selectionAliasIndex = params.selectionAliasIndex ?? (params.agentId && policyAliasAgentId !== params.agentId ? buildModelAliasIndex({
		cfg: params.cfg,
		defaultProvider: params.defaultProvider,
		agentId: params.agentId,
		allowManifestNormalization: params.allowManifestNormalization,
...
//#endregion
export { resolveConfiguredProviderFallback as A, resolveModelRefFromString as C, findModelCatalogEntry as D, resolveUniqueCatalogModelRoute as E, isValidExactModelPolicyRef as M, parseModelPolicyWildcardRef as N, findModelInCatalog as O, resolveModelAliasFromPair as S, resolveCatalogOwnedModelCompat as T, resolveAllowlistModelKey as _, buildModelAliasIndex as a, resolveConfiguredModelRef as b, getModelRefStatusWithFallbackModels as c, inferUniqueProviderFromConfiguredModels as d, isModelKeyAllowedBySet as f, resolveAllowedModelRefFromAliasIndex as g, parseConfiguredModelVisibilityEntries as h, buildConfiguredModelCatalog as i, isModelPolicyCompatSelector as j, modelSupportsInput as k, hasConfiguredProviderModelRows as l, normalizeModelSelection as m, buildAllowedModelSetWithFallbacks as n, createModelVisibilityPolicyWithFallbacks as o, modelCatalogLogicalKey as p, buildConfiguredAllowlistKeys as r, dedupeModelCatalogEntries as s, LEGACY_MODEL_POLICY_ALLOW_CONFIG_PATH as t, inferUniqueProviderFromCatalog as u, resolveBareModelDefaultProvider as v, modelTransportRoutesMatch as w, resolveHooksGmailModel as x, resolveConfiguredModelPolicyAllow as y };
