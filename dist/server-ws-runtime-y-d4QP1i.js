...
import { c as resolvePreauthHandshakeTimeoutMs } from "./timeouts-Dbj-IGQf.js";
import { a as isLoopbackAddress } from "./net-B22ilI8B.js";
...
import { g as tryBeginGatewayRootWorkAdmission } from "./gateway-work-admission-BaRJo64l.js";
import { l as isWebchatClient } from "./message-channel-Bo27VP7K.js";
import { Ca as validateWorkerTranscriptCommitParams, Sa as validateWorkerLiveEventParams, ba as validateWorkerConnectRequestFrame, kn as validateRequestFrame, xa as validateWorkerHeartbeatParams } from "./src-BSn6va4B.js";
import { c as WORKER_PROTOCOL_METHODS, t as WORKER_HEARTBEAT_INTERVAL_MS, z as WORKER_PROTOCOL_MAX_PAYLOAD_BYTES } from "./worker-admission-cYaTLkLk.js";
import { a as WORKER_PROTOCOL_MAX_INFERENCE_PAYLOAD_BYTES, f as validateWorkerInferenceCancelParams, m as validateWorkerInferenceStartParams, r as WORKER_INFERENCE_METHODS } from "./worker-inference-jzapa-pT.js";
import { i as upsertPresence, n as touchPresence } from "./system-presence-CeixrtPU.js";
import { n as rawDataToString, t as rawDataByteLength } from "./ws-kHmoXE6T.js";
import { s as removeRemoteNodeInfo } from "./remote-DeCYAn2P.js";
...
import "./server-utils-Cs46ZMHG.js";
import { a as incrementPresenceVersion, r as getHealthVersion } from "./health-state-B7JO1VbQ.js";
...
import { l as closeTalkRealtimeRelaySessionsForConnection, n as closeTalkTranscriptionRelaySessionsForConnection } from "./talk-transcription-relay-BDfPsWYI.js";
...
function attachGatewayWsMessageHandlerOnDemand(params) {
	...
	import("./message-handler-CGDM3-oP.js").then(({ attachGatewayWsMessageHandler }) => {
