...
import { a as listLoadedChannelPluginsForRegistry } from "./registry-loaded-BSz-9sMZ.js";
...
async function cleanupPreviousPluginHostRegistry(params) {
	const [{ getRuntimeConfig }, { cleanupReplacedPluginHostRegistry }] = await Promise.all([import("./config/config.js"), import("./host-hook-cleanup-DHmeWRcl.js")]);
