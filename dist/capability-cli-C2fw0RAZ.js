...
import { t as planEffectiveModelCatalogRows } from "./model-catalog-DWiqPTMG.js";
import { u as readResponseWithLimit } from "./http-body-CcNaNPg0.js";
import { r as theme } from "./theme-vjDs9tao.js";
import { a as assertProviderBinaryResponseContent, r as assertOkOrThrowHttpError } from "./provider-http-errors-Cj7zfu8U.js";
...
import { c as getRuntimeConfigSourceSnapshot, w as setRuntimeConfigSnapshot } from "./runtime-snapshot-Bzqj8IgJ.js";
...
import { c as callGateway, v as randomIdempotencyKey } from "./call-B_qeDbXh.js";
import { t as buildGatewayConnectionDetailsWithResolvers } from "./connection-details-DpmIBm68.js";
...
import { p as sanitizeConfiguredModelProviderRequest } from "./provider-request-config-C5exA1l5.js";
import { n as detectMime, r as extensionForMime, u as normalizeMimeType } from "./mime-Ir6g3Vae.js";
import { b as updateAuthProfileStoreWithLock, d as loadAuthProfileStoreForRuntime } from "./store-BWT5kQzj.js";
import { n as loadPreparedModelCatalog } from "./prepared-model-catalog-DJrhvpj1.js";
import { c as getImageMetadata, i as convertHeicToJpeg } from "./image-ops-BtojRCsZ.js";
...
import { n as canonicalizeCaseOnlyCatalogModelRef } from "./model-selection-CZlE_kEq.js";
...
import { t as buildExplicitSessionIdSessionKey } from "./session-Col3TC3v.js";
import { t as runWithImageModelFallback } from "./model-fallback-image-D9g0_br7.js";
import { o as fetchWithTimeoutGuarded, p as resolveProviderHttpRequestConfig } from "./shared-3S5SOCXx.js";
import { c as buildMediaUnderstandingRegistry } from "./defaults.constants-Bzdu2YOa.js";
import { h as getTtsCommandSecretTargetIds, i as getCapabilityWebFetchCommandSecretTargets, l as getMemoryEmbeddingCommandSecretTargetIds, o as getCapabilityWebSearchCommandSecretTargets, u as getModelsCommandSecretTargetIds } from "./command-secret-targets-B23ZqGNS.js";
import { n as normalizeSpeechProviderId } from "./provider-registry-core-tbOIZwiJ.js";
import { o as listSpeechProviders, r as canonicalizeSpeechProviderId } from "./directives-DnFNXuz_.js";
import { g as resolveTtsConfig, o as getTtsPersona, u as listTtsPersonas, v as resolveTtsPrefsPath } from "./tts-settings-C8VLk2jJ.js";
import { _ as setTtsProvider, g as setTtsPersona, l as listSpeechVoices, m as setTtsEnabled, s as resolveExplicitTtsOverrides, t as getTtsProvider } from "./runtime-api-D5D5wy1P.js";
...
import { i as listWebSearchProviders, n as isWebSearchProviderConfigured, o as runWebSearch } from "./runtime-M43seitm.js";
import { c as resolveMemorySearchConfig } from "./config-utils-CIfwi7ve.js";
import { n as listEmbeddingProviders } from "./embedding-provider-runtime-BZHBSOFQ.js";
import { a as listMemoryEmbeddingProviders } from "./memory-embedding-provider-runtime-LDa5o1VF.js";
...
import { r as inspectLocalAudioSelection } from "./local-audio-IUt38He2.js";
import { i as resolveWebFetchDefinition, n as isWebFetchProviderConfigured, r as listWebFetchProviders } from "./runtime-BIv5lMgA.js";
...
import { c as transcribeAudioFile, i as describeVideoFile, o as prepareImageDescriptionInput, r as describePreparedImageWithModel, t as describeImageFile } from "./runtime-DEX1Whtn.js";
import { t as resolveCommandConfigWithSecrets } from "./command-config-resolution-tWAm5_sc.js";
import { n as parseTimeoutMsWithFallback } from "./parse-timeout-D6qJ8hKz.js";
import { r as createEmbeddingProvider } from "./memory-core-bundled-runtime-BI7x7lDU.js";
...
async function loadModelCatalogForInspection(cfg) {
...
async function runModelAuthStatus() {
	const captured = [];
	const { modelsStatusCommand } = await import("./list.status-command-BDVr5L1E.js");
...
function registerModelCapabilityCommands(capability) {
	...
	modelAuth.command("login").description("Run provider auth login").requiredOption("--provider <id>", "Provider id").option("--method <id>", "Provider auth method id").action(async (opts) => {
		await runCommandWithRuntime(defaultRuntime, async () => {
			const { modelsAuthLoginCommand } = await import("./auth-DIW02F9c.js");
...
function registerTtsCapabilityCommands(capability) {
	...
	tts.command("convert").description("Convert text to speech").requiredOption("--text <text>", "Input text").option("--channel <id>", "Channel hint").option("--voice <id>", "Voice hint").option("--provider <id>", "Speech provider id").option("--model <provider/model>", "Model override").option("--output <path>", "Output path").option("--local", "Force local execution", false).option("--gateway", "Force gateway execution", false).option("--json", "Output JSON", false).action(async (opts) => {
		await runCommandWithRuntime(defaultRuntime, async () => {
			const transport = resolveTransport({
				local: Boolean(opts.local),
				gateway: Boolean(opts.gateway),
