...
import { a as getPackageManifestMetadata, i as DEFAULT_PLUGIN_ENTRY_CANDIDATES, o as resolvePackageExtensionEntries, r as loadPluginManifest } from "./manifest-BUOsMMgJ.js";
...
import { a as readRootJsonObjectSync, l as tryReadJsonSync } from "./json-C-CW4mQo.js";
import "./json-files-v5WP3doI.js";
import { r as resolveSourceCheckoutDependencyDiagnostic } from "./bundled-dir-Ble_JuKC.js";
import "./path-safety-D798v7n_.js";
import { t as shouldRejectHardlinkedPluginFiles } from "./hardlink-policy-CXtc8Te0.js";
import { r as createPluginCacheKey, t as PluginLruCache } from "./plugin-cache-primitives-Dz0npwxC.js";
import { k as satisfiesPluginApiRange } from "./clawhub-Clykbwlp.js";
import { a as loadBundleManifest, c as withPluginScanExistenceCache, i as detectBundleManifestFormat } from "./bundle-manifest-BVamVGYB.js";
import { p as validatePluginId } from "./install-paths-D18EkQi8.js";
import { t as resolvePackagePluginApiRange } from "./package-compat-DJjXEzu-.js";
import { n as resolvePackageSetupSource, t as resolvePackageRuntimeExtensionSources } from "./package-entry-resolution-3FNbzYup.js";
import { n as resolvePluginSourceRoots } from "./roots-vBRx-90W.js";
...
function discoverPluginDirectory(params) {
	...
	const addPackageCandidate = (source, idHint) => {
		addCandidate({
			candidates: params.candidates,
			diagnostics: params.diagnostics,
			seen: params.seen,
	...
	if (extensions.length > 0) {
		...
		for (const source of resolvedRuntimeSources) addPackageCandidate(source, deriveIdHint({
			filePath: source,
...
//#endregion
export { projectPluginDependencyHealth as a, tracePluginLifecyclePhaseAsync as c, listBundledSourceOverlayDirs as d, buildBundledPluginLoadPathAliases as f, parsePackagedBundledPluginPath as g, parseLegacyBundledPluginPath as h, normalizePluginDependencySpecs as i, readLegacyNpmPluginDeclaration as l, normalizeBundledLookupPath as m, discoverOpenClawPlugins as n, isPluginLifecycleTraceEnabled as o, buildLegacyBundledRootPath as p, buildPluginDependencyStatus as r, tracePluginLifecyclePhase as s, discoverConfiguredPluginLoadPaths as t, isBundledSourceOverlayPath as u };
