...
import { n as getCommandPathWithRootOptions, p as isSimpleCommandHelpInvocation } from "./argv-D6QuZiS5.js";
...
import { a as scanCliRootOptions, i as takeCliRootOptionValue } from "./container-target-CUBB_V4p.js";
...
function createGatewayStartupTrace(argv, source) {
	...
	let pendingMessages = [];
	const timelineModule = hasDiagnosticsTimelinePath(process$1.env) ? import("./diagnostics-timeline-BMtfvHZk.js").catch(() => null) : null;
...
//#endregion
export { tryOutputPrecomputedCommandHelp as a, parseCliProfileArgs as i, createGatewayStartupTrace as n, applyCliProfileEnv as r, configureGatewayStartupTraceConsoleFormatting as t };
