...
import { a as resolveTailscaleResetOnExitFlag, i as resolveInstallDaemonFlag, n as registerOnboardAuthOptions, o as validateOnboardAuthOptionValues, t as pickOnboardAuthOptionValues } from "./register.onboard-D2-djYqQ.js";
...
async function runOnboardingEntry(options, commandRuntime, runtime) {
	if (options.baseline) {
		...
		const { setupCommand } = await import("./setup-B5urPswF.js");
		await setupCommand({
