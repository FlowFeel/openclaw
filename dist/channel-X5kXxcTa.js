...
import { _ as resolvePinnedHostnameWithPolicy } from "./ssrf-CLKoEH8E.js";
...
import { i as createHybridChannelConfigAdapter, l as createScopedDmSecurityResolver } from "./channel-config-helpers-BwgkzH7b.js";
...
import { d as createDefaultChannelRuntimeState, u as createComputedAccountStatusAdapter } from "./status-helpers-CSowaqvB.js";
...
import { s as resolveStableChannelMessageIngress, t as createStandardRawEventIngressMonitor } from "./channel-ingress-runtime-Zqqr2Y7k.js";
import { n as createChannelIngressError } from "./ingress-monitor-BG80PaNl.js";
import { p as defineChannelMessageAdapter } from "./channel-outbound-sjGCUxtt.js";
import { N as projectAccountConfigWarningCollector, P as projectAccountWarningCollector, k as createConditionalWarningCollector, w as composeWarningCollectors } from "./channel-policy-BgbKncah.js";
import { r as createEmptyChannelDirectoryAdapter } from "./directory-runtime-lZ5xkImA.js";
import { t as createPluginRuntimeStore } from "./runtime-store-CjjjpvHZ.js";
import "./text-utility-runtime-Dwuhfjgs.js";
import { a as createWebhookInFlightLimiter, i as beginWebhookRequestPipelineOrReject } from "./webhook-request-guards-cY_xufKf.js";
import { a as createFixedWindowRateLimiter } from "./webhook-ingress-CNHkUY93.js";
import { t as registerPluginHttpRoute } from "./http-registry-BjUjeeOq.js";
import { a as resolveAccount, i as listAccountIds, n as synologyChatSetupContract, r as synologyChatSetupWizard } from "./setup-surface-B3xkhlBI.js";
...
async function sendMessage(incomingUrl, text, userId, allowInsecureSsl = false) {
	...
	for (const chunk of chunks.length > 0 ? chunks : [text]) if (!await sendMessageChunk(incomingUrl, chunk, userId, allowInsecureSsl)) return false;
	return true;
}
async function sendMessageChunk(incomingUrl, text, userId, allowInsecureSsl = false) {
...
async function sendSynologyChatText(ctx) {
	...
	if (!await sendMessage(incomingUrl, ctx.text.replace(SYNOLOGY_MARKDOWN_LINK_RE, (match, label, url, offset) => {
	...
	}), ctx.to, account.allowInsecureSsl)) throw new Error("Failed to send message to Synology Chat");
