...
import { i as transitionMainSessionRecovery, n as isMainSessionRecoveryPending, t as isMainRestartRecoveryCandidate } from "./main-session-recovery-state-CUJxZLgx.js";
import { a as scheduleMainSessionRecoveryMutation, i as retryMainSessionRecoveryMutation } from "./main-session-recovery-lifecycle-CrLAHQ2O.js";
...
function scheduleMainSessionRecoveryOwnerRelease(lease) {
	scheduleMainSessionRecoveryMutation({
		...
		onSuccess: async (pending) => {
			if (pending) {
				const { scheduleMainSessionRecoveryPendingTarget } = await import("./main-session-recovery-owner-release-Ca3C7R_h.js");
