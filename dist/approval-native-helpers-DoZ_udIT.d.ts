...
import { v as ExecApprovalForwardingConfig, y as ExecApprovalForwardingMode } from "./types.slack-DInXzgyw.js";
...
import { i as ChannelOutboundPayloadHint } from "./outbound.types-BsP6frUw.js";
import { r as ReplyPayload } from "./reply-payload-DSgZ_G6Q.js";
import { i as ExecApprovalReplyMetadata } from "./exec-approval-reply-D-FAIo3m.js";
import { n as ExecApprovalSessionTarget } from "./exec-approval-session-target-qynsikid.js";
...
declare function createNativeApprovalMessagingTargetResolvers(params: {
  /** Lowercase channel id used by forwarding and turn-source routes. */channel: string; /** Channel-owned destination normalizer. */
...
//#endregion
export { createChannelApprovalForwardingEvaluator as a, createNativeApprovalChannelRouteGates as c, nativeApprovalTargetsMatch as d, resolveApprovalKind as f, NativeApprovalTarget as i, createNativeApprovalForwardingFallbackSuppressor as l, ChannelApprovalForwardingEligibilityParams as n, createChannelApproverDmTargetResolver as o, shouldSuppressLocalNativeExecApprovalPrompt as p, ChannelApprovalPotentialRouteParams as r, createChannelNativeOriginTargetResolver as s, ChannelApprovalExplicitTargetEligibilityParams as t, createNativeApprovalMessagingTargetResolvers as u };