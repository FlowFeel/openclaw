...
function describeSessionsSpawnTool(options) {
	...
	return [
		...
		visibilityLine,
		...options?.swarmEnabled ? ["`collect=true` (swarm): parallel fan-out collector children; structured result per `outputSchema`; `groupId` groups a batch; await with agents_wait."] : [],
...
//#endregion
export { describeSessionVisibilityScope as C, describeSessionsSendTool as D, describeSessionsSearchTool as E, describeSessionsSpawnTool as O, describeSessionStatusTool as S, describeSessionsListTool as T, SESSIONS_SPAWN_TOOL_DISPLAY_SUMMARY as _, resolveCoreToolProfilePolicy as a, UPDATE_PLAN_TOOL_DISPLAY_SUMMARY as b, CRON_TOOL_DISPLAY_SUMMARY as c, PROCESS_TOOL_DISPLAY_SUMMARY as d, SESSIONS_HISTORY_TOOL_DISPLAY_SUMMARY as f, SESSIONS_SPAWN_SUBAGENT_TOOL_DISPLAY_SUMMARY as g, SESSIONS_SEND_TOOL_DISPLAY_SUMMARY as h, listCoreToolSections as i, describeUpdatePlanTool as k, DISMISS_TASK_TOOL_DISPLAY_SUMMARY as l, SESSIONS_SEARCH_TOOL_DISPLAY_SUMMARY as m, PROFILE_OPTIONS as n, resolveCoreToolProfiles as o, SESSIONS_LIST_TOOL_DISPLAY_SUMMARY as p, isKnownCoreToolId as r, ASK_USER_TOOL_DISPLAY_SUMMARY as s, CORE_TOOL_GROUPS as t, EXEC_TOOL_DISPLAY_SUMMARY as u, SESSION_STATUS_TOOL_DISPLAY_SUMMARY as v, describeSessionsHistoryTool as w, describeAskUserTool as x, SPAWN_TASK_TOOL_DISPLAY_SUMMARY as y };
