...
import { o as getTailnetHostname } from "./tailscale-xOVRir9b.js";
import { n as pickPrimaryTailnetIPv4, r as pickPrimaryTailnetIPv6 } from "./tailnet-GjWC2Uzc.js";
import { a as writeWideAreaGatewayZone, i as resolveWideAreaDiscoveryDomain } from "./widearea-dns-BDKR3YQk.js";
...
async function startGatewayDiscovery(params) {
	...
	if (params.wideAreaDiscoveryEnabled) {
		...
		if (!wideAreaDomain) {
			params.logDiscovery.warn("wide-area discovery was requested without a domain; set discovery.wideArea.domain to enable unicast DNS-SD");
			return { bonjourStop };
		}
		const tailnetIPv4 = pickPrimaryTailnetIPv4();
		if (!tailnetIPv4) params.logDiscovery.warn("discovery.wideArea.domain is set, but no Tailscale IPv4 address was found; skipping unicast DNS-SD zone update");
		else try {
