...
import { u as toFormUrlEncoded } from "./provider-auth-SalgjzRl.js";
...
import { i as applyXaiOAuthConfig, n as XAI_OAUTH_DEFAULT_MODEL_REF } from "./onboard-D2rXy477.js";
import { t as xaiUserAgent } from "./xai-user-agent-CPa0fytF.js";
...
async function fetchXaiOAuthDiscoveryDocument(options = {}) {
	return asOptionalRecord(await readJsonResponse(await getFetchImpl(options.fetchImpl)(XAI_OAUTH_DISCOVERY_URL, {
		headers: {
...
async function requestXaiDeviceCode(params) {
	const json = asOptionalRecord(await readJsonResponse(await getFetchImpl(params.fetchImpl)(requireTrustedXaiOAuthEndpoint(params.deviceAuthorizationEndpoint, "device authorization endpoint"), {
		method: "POST",
		headers: {
			"Content-Type": "application/x-www-form-urlencoded",
			Accept: "application/json",
