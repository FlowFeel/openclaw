...
import { N as validateConfigObjectWithPlugins } from "./io-BsQc3Kgy.js";
...
import { i as GENERATED_BUNDLED_CHANNEL_CONFIG_METADATA, r as normalizeChatChannelId } from "./ids-DPg7j456.js";
...
import { i as materializePluginAutoEnableCandidates, t as applyPluginAutoEnable } from "./plugin-auto-enable-Bs1CK1Hn.js";
import { D as validateSkillProposalRecord, O as validateSkillProposalRollback, V as hashSkillProposalContent, a as readSkillProposal, n as importLegacySkillProposal, v as readSkillProposalRollback } from "./store-wPr8539E.js";
import { t as removePathWithinRoot } from "./fs-safe-remove-CHFZ58Nt.js";
import { d as resolveWorkspaceStateIdentity } from "./workspace-state-store-CqdzARee.js";
import { s as readChannelAllowFromStore } from "./pairing-store-CNA_dhgo.js";
import { n as maybeRepairCodexRoutes } from "./codex-route-warnings-DqpUS8hS.js";
import { r as VERSION_BOUND_RUNTIME_PLUGIN_POLICY_IDS_BY_SURFACE } from "./configured-runtime-plugin-installs-Du-iScG6.js";
import { d as isUpdatePackageSwapInProgress } from "./update-phase-Br5TVkeJ.js";
import { t as asObjectRecord } from "./object-BsiS9JXh.js";
import { t as repairMissingConfiguredPluginInstalls } from "./missing-configured-plugin-install-CxPvXhdz.js";
import { n as maybeMigrateAuthProfileJsonStoresToSqlite, r as maybeRepairOpenAICodexAuthConfig, t as collectOpenAICodexAuthProfileStoreIdMap } from "./doctor-auth-flat-profiles-BImV_JPp.js";
import { t as maybeRepairLegacyOAuthSidecarProfiles } from "./doctor-auth-oauth-sidecar-C8IpBDkM.js";
import { t as applyDoctorConfigMutation } from "./config-mutation-state-DO_xkJud.js";
import { o as maybeRepairPluginOpenClawHostLinks, r as maybeRepairStaleManagedNpmBundledPlugins } from "./doctor-plugin-registry-CVSf0u9O.js";
import { t as getDoctorChannelCapabilities } from "./channel-capabilities-OlTlIlGJ.js";
import { n as maybeRepairOpenPolicyAllowFrom, r as resolveAllowFromMode } from "./open-policy-allowfrom-CGPzHJgz.js";
import { n as hasAllowFromEntries, t as scanEmptyAllowlistPolicyWarnings } from "./empty-allowlist-scan-BG8uT0i9.js";
import { n as maybeRepairBundledPluginLoadPaths } from "./bundled-plugin-load-paths-BfvrQkCT.js";
import { a as collectChannelDoctorRepairMutations, s as createChannelDoctorEmptyAllowlistPolicyHooks, t as collectChannelDoctorCompatibilityMutations } from "./channel-doctor-CiwP4sYn.js";
import { n as maybeRepairContextEngineHostCompatibility } from "./context-engine-host-compat-CfrwWxHT.js";
import { r as maybeRepairExecSafeBinProfiles } from "./exec-safe-bins-BAlOY5fZ.js";
import { n as maybeRepairLegacyToolsBySenderKeys } from "./legacy-tools-by-sender-qZEVksOV.js";
import { t as cleanupLegacyPluginDependencyState } from "./plugin-dependency-cleanup-BaOwFkXm.js";
import { t as repairStaleAgentModelRefs } from "./stale-agent-model-ref-repair-CrG9QBYm.js";
import { n as maybeRepairStaleConfiguredAuthOrders } from "./stale-auth-order-DNqn_aMh.js";
import { n as repairStaleOAuthProfileShadows } from "./stale-oauth-profile-shadows-t3ritXYF.js";
import { r as maybeRepairStalePluginConfig } from "./stale-plugin-config-lSo_aut3.js";
