...
async function runConfiguredSystemAgentText(params) {
	...
	try {
		...
		text = extractPlannerResultText(route.runner === "cli" ? await (params.deps?.runCliAgent ?? (await import("./cli-runner-JgSKs66X.js")).runCliAgent)({
			...shared,
			executionMode: "side-question",
			cleanupCliLiveSessionOnRunEnd: true
		}) : await (params.deps?.runEmbeddedAgent ?? (await import("./embedded-agent-C8PdYTWR.js")).runEmbeddedAgent)({
			...shared,
			toolsAllow: [],
