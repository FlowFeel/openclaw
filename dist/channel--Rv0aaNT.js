...
import { r as createChannelNativeOriginTargetResolver } from "./approval-native-helpers-825lFIMx.js";
import { a as splitChannelApprovalCapability, i as createChannelApprovalCapability, n as createApproverRestrictedNativeApprovalCapability } from "./approval-delivery-helpers-BRQk5ihO.js";
...
import { i as resolveMatrixAccount, r as resolveDefaultMatrixAccountId, t as listMatrixAccountIds } from "./accounts-BHHYYhli.js";
...
import { t as matrixPluginBase } from "./channel.setup-CfXQ1NYl.js";
import { n as normalizeCompatibilityConfig, t as legacyConfigRules } from "./doctor-contract-Cx5LTXvO.js";
import { r as resolveMatrixRoomScopePath, t as buildMatrixRoomScopeTree } from "./rooms-C2OatJg5.js";
...
const matrixNativeApprovalCapability = createApproverRestrictedNativeApprovalCapability({
	...
	nativeRuntime: createLazyChannelApprovalNativeRuntimeAdapter({
		...
		load: async () => (await import("./approval-handler.runtime-WlnscPBs.js")).matrixApprovalNativeRuntime
	})
});
...
const loadMatrixChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-o08QZU6j.js"), "matrixChannelRuntime");
const loadMatrixDoctorModule = createLazyRuntimeModule(() => import("./doctor-DZseX4Ot.js"));
...
const matrixPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			...
			try {
				monitorMatrixProvider = (await import("./monitor-D8m1aRvK.js")).monitorMatrixProvider;
			} finally {
				releaseLock();
			}
