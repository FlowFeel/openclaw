...
function resolveLiveToolResultMaxChars(params) {
	const hardCapChars = params.maxResultCharsOverride && params.maxResultCharsOverride > 0 ? params.maxResultCharsOverride : resolveAutoLiveToolResultMaxChars(params.contextWindowTokens);
