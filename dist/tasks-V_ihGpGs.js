...
import { i as formatLookupMiss } from "./error-format-BZ5G9eas.js";
import { s as resolveAllAgentSessionStoreTargetsSync } from "./targets-Bz-meSET.js";
import { $ as listTaskFlowRecords, I as isTaskFlowCancellationPending, K as deleteTaskFlowRecordById, O as listTasksForFlowId, Q as getTaskFlowRegistryRestoreFailure, Z as getTaskFlowById, f as updateTaskNotifyPolicyById, ot as updateFlowRecordByIdExpectedRevision, x as getTaskById } from "./task-registry-Bs8cA6Tm.js";
import { n as formatTaskStatusDetail } from "./task-status-Bo-Cq_rI.js";
...
import { f as runSessionRegistryMaintenanceForStore } from "./sessions-BqBqRT1f.js";
import { a as getInspectableTaskRegistrySummary, c as reconcileInspectableTasks, d as runTaskRegistryMaintenance, i as getInspectableTaskAuditSummary, l as reconcileTaskLookupToken, o as getTaskRegistryMaintenanceDiagnostics, s as previewTaskRegistryMaintenance, t as configureTaskRegistryMaintenance } from "./task-registry.maintenance-DrCML_Ju.js";
import { i as summarizeRetainedLostTaskAuditFindings, n as listTaskAuditFindings } from "./task-registry.audit-DiY0ICYg.js";
import { t as normalizeCronLaneSegment } from "./task-runs-CoqbyJme.js";
import { i as summarizeTaskFlowAuditFindings, n as buildTaskSystemAuditJsonPayload, r as listTaskFlowAuditFindings, t as buildTaskSystemAuditFindings } from "./tasks-audit-system-B2SwXrOo.js";
...
async function tasksMaintenanceCommand(opts, runtime) {
	...
	runtime.log(info(`Session registry: ${sessionMaintenance.pruned} prune · ${sessionMaintenance.runningCronJobs} running automations`));
