...
import { v as readSessionTranscriptVisibleMessageDelta } from "./session-accessor-D5Or7WgI.js";
import { Co as isCloudWorkerPlacementState, fr as validateSessionsFilesGetParams, hr as validateSessionsFilesSetParams, mr as validateSessionsFilesRevealParams, pr as validateSessionsFilesListParams } from "./src-BSn6va4B.js";
import { a as errorShape } from "./error-codes-P4fBo0lR.js";
import { n as resolveToCwd } from "./path-utils-StYqp9vE.js";
import { f as resolveTranscriptReadTarget, m as toTranscriptReadScope, p as sqliteMessageEventWithSeq } from "./session-transcript-readers-O8pyQfzE.js";
import { C as loadSessionEntryReadOnly } from "./session-utils-row-Br8x7LNG.js";
import { d as runGit } from "./git-Ba83QtEc.js";
import "./session-utils-P5pxtsqu.js";
import { t as assertValidParams } from "./validation-DyQ6nhKI.js";
import { a as readWorkspaceFile, c as sortDirents, d as toUpdatedAtMs, f as updateWorkspaceFile, i as normalizeRelativePath, l as sortWorkspaceEntries, n as decodeUtf8Strict, o as readWorkspaceFilePrefix, p as workspaceStatKind, r as listWorkspacePath, s as resolveWorkspacePath, t as WORKSPACE_PREVIEW_MAX_BYTES, u as statWorkspacePath } from "./workspace-fs-jt_icDFf.js";
...
function loadSessionFileRoot(params) {
	...
	const configuredWorkspaceDir = spawnedCwd || spawnedWorkspaceDir ? void 0 : normalizePathValue(resolveAgentWorkspaceDir(loaded.cfg, agentId));
