...
import { $ as AUTO_MANAGED_CONFIG_META_PATHS, I as collectUnsupportedSecretRefPolicyIssues, M as validateConfigObjectRawWithPlugins, l as readConfigFileSnapshot } from "./io-DCw4R0kD.js";
...
import { C as resolveModelRefFromString, a as buildModelAliasIndex, b as resolveConfiguredModelRef } from "./model-selection-shared-BDTPW9Jk.js";
...
import { a as success, n as info, o as warn, t as danger } from "./globals-DHQUG86L.js";
import { r as replaceConfigFile } from "./mutate-j69oSRi2.js";
import "./config-UtpOr1Uw.js";
import { t as formatDocsLink } from "./links-ClIwBcy4.js";
import { a as isPluginIntegrationSecretProviderConfig, n as resolveSecretRefValue, s as resolveSecretProviderIntegrationConfig } from "./resolve-C2Qr40mZ.js";
import { c as resolveConfigSecretTargetByPath, n as discoverConfigSecretTargets } from "./target-registry-query-Dzi3tmBI.js";
...
import { t as buildGatewayReloadPlan } from "./config-reload-plan-_MQI2IDT.js";
...
import { n as readBestEffortRuntimeConfigSchema } from "./runtime-schema-BK3xUfCG.js";
...
async function createRuntimeModelRefResolver() {
	const [agentScope, modelSelection] = await Promise.all([import("./agent-scope-Jqp3H3Rj.js"), import("./model-selection-ChsC3QwE.js")]);
	const preparedByAgent = /* @__PURE__ */ new Map();
	let modelModules;
	const loadModelModules = () => modelModules ??= Promise.all([import("./model-DRw9QByh.js"), import("./prepared-model-catalog-ClbAcHfK.js")]);
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Non-interactive config helpers (get/set/patch/unset/file/schema/validate). Run without subcommand for guided setup.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.openclaw.ai/cli/config")}\n`).option("--section <section>", "Configuration sections for guided setup (repeatable). Use with no subcommand.", collectOption, []).action(async (opts) => {
		const { configureCommandFromSectionsArg } = await import("./configure-BrbziLHj.js");
