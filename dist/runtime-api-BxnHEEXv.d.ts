...
import { $ as ZodObject, Bh as $strip, St as ZodUnion, T as ZodEnum, Z as ZodNumber, a as ZodArray, b as ZodDefault, ch as $ZodTypeInternals, et as ZodOptional, gt as ZodType, lt as ZodString, n as OpenClawConfig, ol as output, ot as ZodRecord, u as ZodBoolean, zh as $strict } from "./types.openclaw-_47ZKysp.js";
import { J as ChannelAccountSnapshot } from "./setup-wizard-types-B677hB7z.js";
import { d as RuntimeEnv, w as ChannelConfigSchema } from "./manifest-registry-Cbr_emsE.js";
import { a as LineChannelData, c as LineOutboundMediaKind, d as LineTemplateMessagePayload, f as ResolvedLineAccount, i as resolveLineAccount, l as LineProbeResult, u as LineSendResult } from "./accounts-Df2DQJPF.js";
...
type FlexContainer$2 = FlexBubble$1 | FlexCarousel;
...
type Template = ButtonsTemplate$1 | CarouselTemplate$1 | ConfirmTemplate$1 | ImageCarouselTemplate;
type TemplateBase = {
  type: string;
};
//#endregion
...
//#endregion
//#region node_modules/@line/bot-sdk/dist/webhook/model/messageEditedEvent.d.ts
/**
...
declare namespace MessageEditedEvent {}
//#endregion
...
declare function createLocationMessage(location: LineLocation): LocationMessage | null;
...
declare function pushLocationMessage(to: string, location: LineLocation, opts: LinePushOpts): Promise<LineSendResult>;
...
//#endregion
export { FlexText as $, ProcessedLineMessage as A, sendMessageLine as At, createEventCard as B, createConfirmTemplate as Bt, createLineWebhookMiddleware as C, pushImageMessage as Ct, validateLineSignature as D, pushTemplateMessage as Dt, readLineWebhookRequestBody as E, pushMessagesLine as Et, toFlexMessage as F, ConfirmTemplate as Ft, createListCard as G, postbackAction as Gt, createActionCard as H, Action$2 as Ht, createAppleTvRemoteCard as I, TemplateMessage$1 as It, FlexBubble as J, stripMarkdown as Jt, CardAction as K, uriAction as Kt, createDeviceControlCard as L, buildTemplateMessageFromPayload as Lt, convertTableToFlexBubble as M, ButtonsTemplate as Mt, hasMarkdownToConvert as N, CarouselColumn as Nt, CodeBlock as O, pushTextMessageWithQuickReplies as Ot, processLineMessage as P, CarouselTemplate as Pt, FlexImage as Q, createMediaPlayerCard as R, createButtonTemplate as Rt, StartLineWebhookOptions as S, pushFlexMessage as St, createLineNodeWebhookHandler as T, pushMessageLine as Tt, createImageCard as U, datetimePickerAction as Ut, createReceiptCard as V, createTemplateCarousel as Vt, createInfoCard as W, messageAction as Wt, FlexComponent as X, FlexButton as Y, firstDefined as Yt, FlexContainer as Z, getRichMenuList as _, createQuickReplyItems as _t, RichMenuResponse as a, hasLineDirectives as at, parseLineWebhookBody as b, getUserDisplayName as bt, createDefaultMenuConfig as c, downloadLineMedia as ct, createRichMenuAlias as d, setLineRuntime as dt, ListItem as et, deleteRichMenu as f, monitorLineProvider as ft, getRichMenuIdOfUser as g, createLocationMessage as gt, getRichMenu as h, createImageMessage as ht, RichMenuRequest as i, resolveLineChannelAccessToken as it, convertCodeBlockToFlexBubble as j, showLoadingAnimation as jt, MarkdownTable as k, replyMessageLine as kt, createGridLayout as l, NormalizedAllowFrom as lt, getDefaultRichMenuId as m, createFlexMessage as mt, RichMenuArea as n, LineConfigSchema as nt, RichMenuSize as o, parseLineDirectives as ot, deleteRichMenuAlias as p, createAudioMessage as pt, FlexBox as q, formatDocsLink as qt, RichMenuAreaRequest as r, LineConfigSchemaType as rt, cancelDefaultRichMenu as s, probeLineBot as st, CreateRichMenuParams as t, LineChannelConfigSchema as tt, createRichMenu as u, normalizeAllowFrom as ut, setDefaultRichMenu as v, createTextMessageWithQuickReplies as vt, startLineWebhook as w, pushLocationMessage as wt, LineWebhookOptions as x, getUserProfile as xt, uploadRichMenuImage as y, createVideoMessage as yt, createAgendaCard as z, createCarouselColumn as zt };