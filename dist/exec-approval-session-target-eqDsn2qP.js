...
import { nt as resolveSessionConversationRef } from "./session-entry-slot-keys-DPRQmSpa.js";
import "./session-accessor-D5Or7WgI.js";
import { t as resolveSessionDeliveryTarget } from "./targets-session-BaGX-R2K.js";
import "./targets-CU0H3XI-.js";
...
function resolvePersistedApprovalRequestSessionBinding(params) {
	...
	const channel = normalizeOptionalChannel$1(context?.channel ?? origin?.provider);
