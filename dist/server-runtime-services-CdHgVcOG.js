...
import { n as getPluginRegistryState } from "./runtime-state-D2E7wBko.js";
import "./config-UtpOr1Uw.js";
import { c as isGatewayWorkAdmissionClosed, m as runWithGatewayIndependentRootWorkAdmission } from "./gateway-work-admission-D_DdbtmL.js";
import { ct as loadSqliteSessionEntryReadOnly, yt as resolveSessionStorePathForScope } from "./session-accessor.sqlite-B9iW7DOt.js";
import "./session-accessor-t3qUoTeV.js";
import { f as recordSessionHumanDirectMessage, p as recordSessionStateEvent } from "./session-state-events-MWtkoPhW.js";
import { i as updateSessionUpstreamLinkMarker, n as listWatchedSessionUpstreamLinks, r as readSessionUpstreamLink, t as deleteSessionUpstreamLink } from "./session-upstream-links-CB_vQpz0.js";
import { u as isEmbeddedAgentRunActive } from "./runs-ehu0VRUR.js";
import { i as readRecentUserAssistantTextForSession } from "./transcript-CkD940e8.js";
import { t as computeBackoffMs } from "./delivery-recovery.shared-5qX8QsGe.js";
import { c as startSessionDeliveryRuntime, o as schedulePendingSessionDeliveries } from "./subagent-completion-delivery-DIMnEot2.js";
import { n as resolveHeartbeatIntervalMs } from "./heartbeat-summary-S-VZc34p.js";
import "./embedded-agent-C4QunjfG.js";
import { n as startHeartbeatRunner, o as resolveHeartbeatAgents } from "./heartbeat-runner-DnxtCBc8.js";
import { r as createNoopHeartbeatRunner } from "./server-runtime-startup-services-CBEA8_iu.js";
import "./server-idle-task-DjyFy2K9.js";
...
function loadProbeSession(probe, options) {
	...
	const entry = (options.loadEntry ?? loadSqliteSessionEntryReadOnly)({
...
function startPendingOutboundDeliveryRecovery(params) {
	...
	const recover = (startup) => {
		...
		const settled = runWithGatewayIndependentRootWorkAdmission(async () => {
			if (stopped) return;
			const { drainPendingDeliveries, recoverPendingDeliveries } = await import("./delivery-queue-BXr2XIdx.js");
			const { deliverOutboundPayloadsInternal } = await import("./deliver-4BQUpH45.js");
			if (stopped) return;
...
function startPendingSessionDeliveryRuntime(params) {
	...
	const timer = setTimeout(() => {
		runWithGatewayIndependentRootWorkAdmission(async () => {
			const { deliverQueuedSessionDelivery, recoverPendingRestartContinuationDeliveries, settleQueuedSessionDelivery } = await import("./server-restart-sentinel-pGr1gj-D.js");
			if (stopped) return;
