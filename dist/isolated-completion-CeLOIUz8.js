...
import { i as resolveCliBackendConfig, o as resolveCliRuntimeCanonicalProvider } from "./cli-backends-Cs_tFLvt.js";
...
import { n as prepareSimpleCompletionModel } from "./simple-completion-runtime-o7vopKEW.js";
...
async function resolveHarness(runtime) {
	if (runtime === "openclaw") {
		const { createOpenClawAgentHarness } = await import("./builtin-openclaw-BorsZdBY.js");
