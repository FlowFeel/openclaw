...
import { n as isTruthyEnvValue, r as logAcceptedEnvOption } from "./env-vD3tMcRW.js";
...
import { B as captureConfigOverrideApplier, l as readConfigFileSnapshot, o as promoteConfigSnapshotToLastKnownGood, r as getRuntimeConfig, u as readConfigFileSnapshotForRuntimeTransaction, v as registerConfigWriteListener } from "./io-BsQc3Kgy.js";
...
import { r as runtimeForLogger, t as createSubsystemLogger } from "./subsystem-Ess1Ww-N.js";
...
import { i as listLoadedChannelPlugins, n as getLoadedChannelPluginEntryById } from "./registry-loaded-DSocaiGy.js";
import { r as setCurrentPluginMetadataSnapshot } from "./current-plugin-metadata-snapshot-LM8oq-yZ.js";
import { d as prepareConfigRuntimeEnv, l as initializePublishedConfigRuntimeEnv, r as collectConfigRuntimeEnvOwnership } from "./config-env-vars-Dh6msnxE.js";
import { n as assertGatewayConfigEnvSelectionUnchanged } from "./gateway-env-selection-DZkwrn1I.js";
import { S as setAppliedRuntimeConfigSnapshot, c as getRuntimeConfigSourceSnapshot } from "./runtime-snapshot-Bzqj8IgJ.js";
import { t as KeyedAsyncQueue } from "./keyed-async-queue-CTreGrmR.js";
import { n as ensureControlUiAllowedOriginsForNonLoopbackBind } from "./gateway-control-ui-origins-JQOYrYru.js";
import { t as GatewayLockError } from "./gateway-lock-bSCpyKdU.js";
...
import { n as authorizeHttpGatewayConnect } from "./auth-B6R6zmCG.js";
...
import { a as normalizeDevicePublicKeyBase64Url } from "./device-identity-BOrXxcUy.js";
import { t as loadGatewayTlsRuntime$1 } from "./gateway-DquHjBUP.js";
...
import { c as isGatewayWorkAdmissionClosed, i as getActiveGatewayRootWorkCount } from "./gateway-work-admission-BaRJo64l.js";
import { f as setGatewaySigusr1RestartPolicy, p as setPreRestartDeferralCheck } from "./restart-Cneg3xRO.js";
import { r as readGatewayRestartHandoffSync } from "./restart-handoff-BzS44iP7.js";
import { a as resolveMainSessionKey } from "./main-session-Bjm_i_Af.js";
import { t as isBrowserCopilotClient } from "./message-channel-Bo27VP7K.js";
import { i as tryLoadActivatedBundledPluginPublicSurfaceModule } from "./facade-runtime-CL9WBJ0v.js";
import { i as streamSimple } from "./stream-CURxsedE.js";
import { t as event_stream_exports } from "./event-stream-MHM-_qcK.js";
import { r as installModelExecutionPort } from "./sessions-CxWGGmnA.js";
import { a as enqueueSystemEvent } from "./system-events-BNZxjP0P.js";
import { C as stopDiagnosticHeartbeat, S as startDiagnosticHeartbeat } from "./diagnostic-CdMjo2Fb.js";
import { l as resolveCronJobsStorePathFromConfig } from "./store-BwY4XtES.js";
import { d as getActiveEmbeddedRunCount, m as resolveActiveEmbeddedRunSessionId } from "./run-state-oGYwHnd-.js";
...
import { c as getTotalQueueSize, d as isGatewayDraining } from "./command-queue-DxY-0HMA.js";
...
import "./server-plugins-I6ua_jgC.js";
import { i as getActiveSecretsRuntimeConfigSnapshot, r as clearSecretsRuntimeSnapshot } from "./runtime-state-DhF-BA9k.js";
import { t as clearSessionSuspensionTimers } from "./session-suspension-A0HAqEj-.js";
import { t as isTerminalConfigEnabled } from "./enabled-BSjeiWpO.js";
import { a as terminateCompactionPlanningPool, o as TopicAffineWorkerPool, s as WorkerPoolError } from "./compaction-planning-worker-BOb5RHg-.js";
import { t as installSessionPlacementAdmissionProvider } from "./session-placement-admission-BEJd445g.js";
import { n as applyGatewayLaneConcurrency, r as resolveGatewayLaneConcurrency, t as resolveHookClientIpConfig } from "./hook-client-ip-config-ChmBxQV8.js";
...
import { n as mergeGatewayAuthConfig, r as mergeGatewayTailscaleConfig } from "./startup-auth-Dc9f--5L.js";
...
import { d as resumeGatewayRestartTraceFromHandoff, i as finishGatewayRestartTrace, n as collectGatewayProcessMemoryUsageMb, u as resumeGatewayRestartTraceFromEnv } from "./restart-trace-wEbhk9Tt.js";
import { i as upsertPresence } from "./system-presence-CeixrtPU.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-Dt7Wf9uQ.js";
import { c as resolveControlUiRootSync, i as isPackageProvenControlUiRootSync, n as ensureControlUiAssetsBuilt, r as isControlUiStartupAssetsReady, s as resolveControlUiRootOverrideSync } from "./control-ui-assets-JTXWzqa5.js";
import { d as listDevicePairing, p as onEffectiveOperatorDevicePaired, y as resolveEffectiveOperatorDeviceIdentity } from "./device-pairing-D3ZJFObN.js";
import { d as requestNodePairing, f as reusePendingNodePairingForReconnect, r as finalizeNodePairingCleanupClaim } from "./node-pairing-CthjYRqK.js";
import { c as removeRemoteNodeInfoForConnection, i as recordRemoteNodeInfo, s as removeRemoteNodeInfo } from "./remote-DeCYAn2P.js";
...
import { i as summarizeAgentEventForWsLog, n as logWs, r as shouldLogWs } from "./ws-log-B9tqgW3b.js";
...
import { a as sendGatewayAuthFailure, f as setDefaultSecurityHeaders, r as finishFailedGatewayHttpResponse } from "./http-common-C1Esyf5_.js";
import { t as resolveSharedGatewaySessionGeneration } from "./ws-shared-generation-8sA0oUQm.js";
import { n as queuePluginSessionsChanged } from "./gateway-events-BT97kIcB.js";
import { c as canReceiveSessionEvent } from "./session-sharing-BuGIPH6F.js";
import { n as resolveAssistantIdentity } from "./assistant-identity-BeK0sXRO.js";
...
import { n as resolveGatewayReloadPluginActivationCandidate, r as resolveGatewayStartupPluginActivationConfig, t as mergeActivationSectionsIntoRuntimeConfig } from "./plugin-activation-runtime-config-xZ7Pz6e8.js";
import { a as incrementPresenceVersion, i as getPresenceVersion, n as getHealthCache, o as refreshGatewayHealthSnapshot, r as getHealthVersion } from "./health-state-B7JO1VbQ.js";
import { t as resolveGatewayPluginConfig } from "./runtime-plugin-config-C-fI38sN.js";
import { t as createControlUiSessionPullRequestSubscriptions } from "./control-ui-session-pr-subscriptions-BIjjA-w3.js";
...
import { t as createGatewayStartupTrace } from "./server-startup-trace-1bubQfP_.js";
import { t as GATEWAY_EVENTS } from "./server-methods-list-By1dPxJ0.js";
...
import { a as writeGatewayUpgradeServiceUnavailable, n as shouldEnforceGatewayAuthForPluginPath, r as runWithGatewayHttpWorkAdmission } from "./route-auth-B4CAn8JH.js";
...
async function startGatewayCoreRuntime(input) {
	...
	const [{ startGatewayEventSubscriptions }, { startGatewayRuntimeServices }] = await startupTrace.measure("runtime.post-early-imports", () => Promise.all([import("./server-runtime-subscriptions-DVbqubHq.js"), import("./server-runtime-startup-services-vvNV0Xbo.js")]));
	...
	const { createOperatorApprovalSessionEventRuntime } = await import("./operator-approval-session-events-SUo8w57d.js");
	...
	const { execApprovalManager, cancelRunBoundApprovals, forwardPluginApprovalRequest, pluginApprovalIosPushDelivery, pluginApprovalManager, systemAgentApprovalManager, extraHandlers, coreGatewayHandlers } = await startupTrace.measure("gateway.handlers", async () => {
		const [{ createGatewayAuxHandlers }, { coreGatewayHandlers: coreGatewayHandlersLocal }] = await Promise.all([import("./server-aux-handlers-VX5xGmGN.js"), import("./server-methods-BqxjRs_B.js")]);
		return {
	...
	const reloadAttachedGatewayPlugins = async (params) => {
		...
		const [{ loadPluginLookUpTable }, { listAmbientOnlyConfiguredChannelIds }, { prepareGatewayPluginLoad }, { startPluginServices }] = await Promise.all([
			import("./plugin-lookup-table-CjRRNzfd.js"),
			import("./channel-presence-policy-WYOK4-Po.js"),
			loadGatewayPluginBootstrapModule(),
			import("./services-BDw2p4U8.js")
		]);
...
function createLazyGatewayCronState(params) {
	...
	const cronStateLoader = createLazyPromiseLoader(() => import("./server-cron-C_nVObTm.js").then(({ buildGatewayCronService }) => {
		loaded = {
...
async function prepareGatewayLifecycle(params) {
	...
	const { createGatewayNodeSessionRuntime } = await import("./server-node-session-runtime-BTOqbMBV.js");
	...
	const { createWatchNodeHttpRuntime } = await import("./watch-node-http-CX6wNS2h.js");
	...
	const { TerminalSessionManager, DEFAULT_TERMINAL_DETACH_SECONDS } = await import("./session-manager-CvqVaCye.js");
	...
	const createCloseHandler = () => async (optsValue) => {
		...
		await createGatewayCloseHandler({
			...
			markMainSessionsAbortedForRestart: async ({ sessionKeys, sessionIds, activeRuns, reason, isActiveRun }) => {
				...
				const { markRestartAbortedMainSessions } = await import("./main-session-restart-recovery-DMkyfztr.js");
...
const getControlUiModule = createLazyRuntimeModule(() => import("./control-ui-BeDQhnX0.js"));
const getCanvasServeModule = createLazyRuntimeModule(() => import("./serve.runtime.js"));
const getBoardHttpModule = createLazyRuntimeModule(() => import("./board-http-DtLfwUt3.js"));
const getEmbeddingsHttpModule = createLazyRuntimeModule(() => import("./embeddings-http-DR-CnWV8.js"));
const getManagedMediaAttachmentsModule = createLazyRuntimeModule(() => import("./managed-image-attachments-BIpWXyaF.js"));
const getMcpAppStandaloneModule = createLazyRuntimeModule(() => import("./mcp-app-standalone-DlKTW5id.js"));
const getPluginIconHttpModule = createLazyRuntimeModule(() => import("./plugin-icon-http-P3cfZbNl.js"));
const getModelsHttpModule = createLazyRuntimeModule(() => import("./models-http-BJAIgTAH.js"));
const getOpenAiHttpModule = createLazyRuntimeModule(() => import("./openai-http-Doinupcw.js"));
const getOpenResponsesHttpModule = createLazyRuntimeModule(() => import("./openresponses-http-BelVRWrz.js"));
const getSessionHistoryHttpModule = createLazyRuntimeModule(() => import("./sessions-history-http-DkXEGTbl.js"));
const getSessionKillHttpModule = createLazyRuntimeModule(() => import("./session-kill-http-BS-o8cGx.js"));
const getToolsInvokeHttpModule = createLazyRuntimeModule(() => import("./tools-invoke-http-B4wSQDAb.js"));
const getUserProfilesHttpModule = createLazyRuntimeModule(() => import("./user-profiles-http-BBtkXSsO.js"));
const getPluginNodeCapabilityAuthModule = createLazyRuntimeModule(() => import("./plugin-node-capability-auth-D53lJIjx.js"));
const getHttpAuthUtilsModule = createLazyRuntimeModule(() => import("./http-auth-utils-B7lLl_aE.js"));
const getPluginRouteRuntimeScopesModule = createLazyRuntimeModule(() => import("./plugin-route-runtime-scopes-DV9tVaCj.js"));
...
const loadGatewayPluginsHttpModule = async () => await import("./plugins-http-w1Y07C02.js");
	...
	const handleHooksRequest = async (req, res) => {
		...
		return await runWithGatewayHttpWorkAdmission(res, async () => {
			if (!loadedHooksRequestHandler) {
				const { createGatewayHooksRequestHandler } = await import("./hooks-CspJWlzL.js");
...
async function prepareGatewayRuntimeState(params) {
	...
	const runtimeConfig = await startupTrace.measure("runtime.config", async () => {
		const { resolveGatewayRuntimeConfig } = await import("./server-runtime-config-IrBLVduY.js");
	...
	if (bootstrap.generatedStartupAuthToken && isLoopbackHost(bindHost)) {
		const { ensureStartupLocalCliPairing } = await import("./startup-local-cli-pairing-ByIsocFt.js");
	...
	const { createTerminalLaunchPolicy } = await import("./launch-BaB-PeRV.js");
	const terminalLaunchPolicy = createTerminalLaunchPolicy(cfgAtStart);
	const { runDefaultChannelSetupWizard, runDefaultSetupWizard } = await import("./wizard-BgGiFUC1.js");
	...
	const { createChannelManager } = await import("./server-channels-Cid68kmu.js");
...
async function prepareGatewayServerBootstrap(input) {
	...
	const [{ OPENCLAW_DATABASE_SCHEMA_DOCS_URL, OpenClawDatabaseSchemaPreflightError, preflightOpenClawDatabaseSchemas }, agentDatabase, stateDatabase] = await Promise.all([
		import("./openclaw-database-preflight-CbIU8d5R.js"),
		import("./openclaw-agent-db-Eyvs3qpa.js"),
		import("./openclaw-state-db-CgK3s5go.js")
	]);
	...
	const { bootstrapGatewayNetworkRuntime } = await import("./server-network-runtime-D0JPn0Qd.js");
	...
	const startupConfigModulePromise = import("./server-startup-config-Bs440lUw.js");
	const loadStartupPluginsModule = createLazyPromise(() => import("./server-startup-plugins-0qeUW-RU.js"), { cacheRejections: true });
	...
	const { claimControlUiDeviceAuthMigration, completeControlUiDeviceAuthMigration, importPendingControlUiDeviceAuthMigration, isLegacyControlUiDeviceAuthMigrationInput, readControlUiDeviceAuthMigrationState, recoverControlUiDeviceAuthMigrationClaim, releaseControlUiDeviceAuthMigrationClaim } = await import("./control-ui-device-auth-migration-BorZDGPS.js");
...
async function finishGatewayStartup(params) {
	...
	const sessionChangeSidecar = { stop: async () => {
		const { flushPendingSessionsChangedEvents } = await import("./session-change-event-HEZCwKuI.js");
	...
	const { createGatewayInstanceRuntime } = await import("./server-instance-runtime-DdCiXF6R.js");
	...
	const [{ attachGatewayWsHandlers }, { listPluginNodeCapabilities }] = await startupTrace.measure("gateway.ws-imports", () => Promise.all([import("./server-ws-runtime-y-d4QP1i.js"), import("./route-capability-Cjzy-wRF.js")]));
	...
	const loadScheduledServicesModule = createLazyPromise(() => import("./server-runtime-services-NyRD2DIO.js"), { cacheRejections: true });
	...
	if (!minimalTestGateway) {
		const { startOpenClawDatabaseIntegrityVerifier } = await import("./openclaw-database-verify-Clo8_2H-.js");
		runtimeState.gatewayLifetimeSidecars.push(startOpenClawDatabaseIntegrityVerifier({ env: process.env }));
	}
	postAttachRuntimeReturned = true;
	activateScheduledServicesWhenReady();
	const { startManagedGatewayConfigReloader } = await import("./server-reload-handlers-BmsssPnB.js");
	...
	if (!minimalTestGateway) {
		...
		postReadyState.retainedPluginCleanupHandle = gatewayRuntimeServices.scheduleGatewayIdleTask({
			...
			run: async () => {
				const { cleanupRetainedPluginInstallGenerations } = await import("./server-retained-plugin-cleanup-owQrneI3.js");
...
const loadGatewayModelCatalogModule = createLazyRuntimeModule(() => import("./server-model-catalog-D0forhfk.js"));
const loadWorkerEnvironmentStartupModule = createLazyRuntimeModule(() => import("./server-worker-environment-startup-B3xBBqUx.js"));
const loadWorkerPlacementStartupModule = createLazyRuntimeModule(() => import("./server-worker-placement-startup-DyGbf_Aa.js"));
...
const loadGatewayStartupEarlyModule = createLazyRuntimeModule(() => import("./server-startup-early-D-DbH0DX.js"));
const loadGatewayStartupPostAttachModule = createLazyRuntimeModule(() => import("./server-startup-post-attach-ZwmVd9tQ.js"));
const log = createSubsystemLogger("gateway");
const logDiscovery = log.child("discovery");
const logTailscale = log.child("tailscale");
const logChannels = log.child("channels");
const getChannelRuntime = createLazyRuntimeModule(() => import("./runtime-channel-3oMyE6VF.js").then(({ createRuntimeChannel }) => createRuntimeChannel()));
async function closeMcpLoopbackServerOnDemand() {
	const { closeMcpLoopbackServer } = await import("./mcp-http-Dt8WX-rY.js");
...
const loadGatewayPluginBootstrapModule = createLazyRuntimeModule(() => import("./server-plugin-bootstrap-Cf9gYAu4.js"));
...
async function stopTaskRegistryMaintenanceOnDemand() {
	const { stopTaskRegistryMaintenance } = await import("./task-registry.maintenance-BY6uH1y8.js");
