...
import { l as isSystemdUserServiceAvailable } from "./systemd-CE12Te8p.js";
...
import { a as resolveGatewayService, n as formatGatewayServiceStartRepairIssues, o as startGatewayService, t as describeGatewayServiceRestart } from "./service-CbbYL0ZH.js";
...
import { n as DEFAULT_BOOTSTRAP_FILENAME } from "./workspace-aPJlJwqC.js";
import { f as probeGatewayReachable, g as waitForGatewayReachable, r as buildOnboardingControlUiUrl } from "./onboard-helpers-CEgpoKqW.js";
...
import { i as hasAuthProfileForProvider } from "./model-config.helpers-DyHTAZFt.js";
import { r as listConfiguredWebSearchProviders } from "./runtime-M43seitm.js";
...
import { i as waitForControlUiDocument, r as resolveControlUiHandoffTarget } from "./control-ui-handoff-Wa3Dbo0p.js";
...
async function startSessionGatewayForOnboarding(params) {
	...
	try {
		const { startGatewayServer } = await import("./server-Bg4NfXeN.js");
...
const loadSearchSetupModule = createLazyRuntimeModule(() => import("./search-setup-D9t5LPIq.js"));
/**
...
async function finalizeSetupWizard(options) {
	...
	try {
		...
		const [{ resolveDefaultModelAuthStatus, resolveDefaultModelCatalogFacts }, { loadPreparedModelCatalogSnapshot }] = await Promise.all([import("./auth-choice-CHhV6Vcc.js"), import("./prepared-model-catalog-CDZ2A_-7.js")]);
