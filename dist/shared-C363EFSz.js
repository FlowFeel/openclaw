...
import { n as resolveMatrixAuth, r as resolveMatrixAuthContext } from "./config-qJ5tyLJ8.js";
...
const loadMatrixCreateClientDeps = createLazyRuntimeModule(() => import("./create-client-BEKPG8H6.js").then((runtime) => ({ createMatrixClient: runtime.createMatrixClient })));
