...
import { n as gatewayInstallErrorHint, t as buildGatewayInstallPlan } from "./daemon-install-helpers-bA49b5gW.js";
...
import { i as applyAuthChoice } from "./auth-choice-17J4nrbC.js";
import { t as resolvePreferredProviderForAuthChoice } from "./provider-auth-choice-preference-QOMG_HOH.js";
import { i as setupChannels } from "./onboard-channels-C1WVQKLb.js";
...
import { i as promptModelAllowlist, n as applyModelFallbacksFromSelection, r as promptDefaultModel, t as applyModelAllowlist } from "./model-picker-DG-lLNTD.js";
...
async function promptWebToolsConfig(nextConfig, runtime, prompter) {
	...
	const { isCodexNativeWebSearchRelevant } = await import("./codex-native-web-search-BqXHOSvR.js");
	...
	if (enableSearch) {
		...
		if (configureManagedProvider) {
			const { resolveSearchProviderOptions, runSearchSetupFlow } = await import("./search-setup-B0GaBaJC.js");
