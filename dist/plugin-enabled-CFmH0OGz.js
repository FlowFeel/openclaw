...
import { T as BrowserProfileUnavailableError } from "./tmp-openclaw-dir-BSVbmTRJ.js";
import "./config-J3owQAwW.js";
import { d as markBrowserRuntimeStopping, r as beginProfileTransition, s as isBrowserRuntimeRunning } from "./server-context.lifecycle-BwlIq9d9.js";
import { a as getExtensionRelayModule, t as createBrowserRouteContext } from "./server-context-BtTjZdye.js";
import { n as sweepTrackedBrowserTabs } from "./session-tab-registry-cVJiMCwS.js";
...
async function stopBrowserRuntimeInternal(params, finalizeGlobalAdapters) {
	...
	if (finalizeGlobalAdapters) try {
		const { disposeGatewayExtensionRelay } = await import("./gateway-relay-route-FOoOu0pM.js");
