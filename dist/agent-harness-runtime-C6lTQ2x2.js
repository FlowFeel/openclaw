...
import { u as listCodexAppServerExtensionFactories } from "./loader-BmgwYkg7.js";
...
import "./agent-tools.before-tool-call-BwKgu8k0.js";
...
import { c as mergeAgentRunAttemptTerminal, d as projectAgentRunAttemptTerminal, f as setAgentRunAttemptTerminalFailure, u as normalizeAgentRunAttemptTerminal } from "./agent-run-terminal-outcome-9kJP3Yn1.js";
import "./run-termination-7xcnysfe.js";
import "./diagnostic-Ba_lpTat.js";
import { g as queueEmbeddedAgentMessageWithOutcome } from "./runs-Bw__iUSb.js";
...
import "./tools-CSTIF4SP.js";
import "./agent-end-side-effects-DXk4DE5h.js";
import "./local-model-lean-CeG7_aMD.js";
import "./gateway-C5_wViGG.js";
...
import "./openclaw-tools-BF-TS9dq.js";
import "./bootstrap-files-BmlEwlGk.js";
import { _ as wrapPluginSystemContextSection } from "./attempt.prompt-helpers-ey3uEUB2.js";
import "./nodes-utils-CrsQo95T.js";
import "./hook-helpers-CMmIshEb.js";
import "./tools-CgK1Uzk2.js";
import "./tool-schema-projection-ZrMdwk4s.js";
import "./attempt-tool-construction-plan-Bf7wzZfB.js";
import { n as prepareWatchedSessionsPrompt, t as buildWatchedSessionsPromptLines } from "./watched-sessions-prompt-jkq9d9dZ.js";
...
import "./native-hook-relay-6QA4VydE.js";
...
async function loadCodexBundleMcpThreadConfig(params) {
	const { loadCodexBundleMcpThreadConfig: load } = await import("./codex-mcp-config-DCS2AXa0.js");
	return load(params);
}
/**
...
async function prepareHarnessNativeMcpAppPreview(params) {
	...
	const { buildMcpAppCanvasPayload, fetchMcpAppView } = await import("./mcp-ui-resource-D43APmcB.js");
...
async function materializeRequesterScopedMcpToolsForHarnessRun(params) {
	...
	const { materializeRequesterScopedMcpToolsForHarnessRun: materialize } = await import("./agent-bundle-mcp-harness-WYs5LD9K.js");
