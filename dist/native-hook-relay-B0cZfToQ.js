...
import { d as getAgentToolResultMiddlewareMatcherScope, f as listAgentToolResultMiddlewares } from "./loader-CT1KBBu5.js";
...
import { l as mergePluginToolMatcherScopes, r as hasGlobalHooks, s as getToolHookMatcherScope, y as getGlobalHookRunnerRegistry } from "./hook-runner-global-BNa5TLJ4.js";
import { $ as PluginApprovalResolutions, M as getTrustedToolPolicyMatcherScope, N as cancelDeferredPluginToolApproval, P as requestDeferredPluginToolApproval, h as runBeforeToolCallHook, m as hasBeforeToolCallPolicy } from "./agent-tools.before-tool-call-uaLOAHZ3.js";
import "./types-HshsOZMQ.js";
import { l as payloadTextResult } from "./common-yW0U9cHP.js";
...
import { _ as truncateText, b as readNativeHookRelayBridgeRecordRow, c as normalizeOptionalPositiveInteger, d as readNativeHookRelayProvider, f as readNonEmptyString, g as snapshotNativeHookRelayPayload, h as shellQuoteArgs, i as isRetryableNativeHookRelayBridgeLookupError, l as normalizePositiveInteger, m as readOptionalString, o as isJsonObject, p as readOptionalBoolean, r as isNativeHookRelayBridgeStaleRegistrationError, s as isJsonValue, t as NATIVE_HOOK_RELAY_BRIDGE_STALE_REGISTRATION_ERROR, u as readNativeHookRelayEvent, v as codexNativeHookRelayResponseCodec, y as DEFAULT_RELAY_TIMEOUT_MS } from "./native-hook-relay-client-BEqBcKta.js";
...
function unregisterNativeHookRelayBridge(relayId, options) {
	const bridge = relayBridges$1.get(relayId);
	if (!bridge) return;
	relayBridges$1.delete(relayId);
	bridge.server.close();
	const removeRecord = () => {
		try {
...
function registerNativeHookRelay(params) {
	...
	unregisterNativeHookRelay(relayId, void 0, { deferBridgeRecordRemovalMs: 250 });
	const registration = {
		relayId,
...
//#endregion
export { resolveNativeHookRelayDeferredToolApproval as a, testing as i, invokeNativeHookRelay as n, buildNativeHookRelayCommand as o, registerNativeHookRelay as r, hasNativeHookRelayInvocation as t };
