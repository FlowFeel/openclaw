...
import { b as createConfigIO, r as getRuntimeConfig } from "./io-BsQc3Kgy.js";
...
import { p as getSecurityAuditCommandSecretTargetIds } from "./command-secret-targets-B23ZqGNS.js";
import { t as formatHelpExamples } from "./help-format-CAcwboTs.js";
import { t as runSecurityAudit } from "./audit-LpOp0vtP.js";
...
async function collectChannelSecurityConfigFixMutation(params) {
	...
	const collectPlugins = async () => {
		...
		try {
			...
			const { listBundledChannelPlugins } = await import("./bundled-DtAaLoZz.js");
