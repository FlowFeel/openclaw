...
import { n as asNullableRecord, o as isRecord } from "./record-coerce-DHZ4bFlT.js";
import { l as normalizeStringEntries } from "./string-normalization-CRyoFBPt.js";
import { u as redactToolPayloadText } from "./redact-BGqyyKN9.js";
import { p as safeStatSync } from "./path-D8zNGPJM.js";
...
import { a as isSubagentSessionKey, c as parseAgentSessionKey, i as isCronSessionKey } from "./session-key-utils-02xWdGSz.js";
import { f as resolveAgentIdFromSessionKey } from "./session-key-DtTE9-Tg.js";
import "./path-guards-C3glTcy2.js";
import { c as sanitizeHostExecEnvWithDiagnostics, n as isDangerousHostEnvOverrideVarName, o as normalizeHostOverrideEnvVarKey, r as isDangerousHostEnvVarName } from "./host-env-security-D4EXCIbD.js";
import { o as resolveShellEnvFallbackTimeoutMs, r as getShellPathFromLoginShell } from "./shell-env-ic769138.js";
...
import { a as logWarn, r as logInfo } from "./logger-CWK_jOH2.js";
import { i as addSafeTimeoutDelayGraceMs } from "./timeouts-Dbj-IGQf.js";
import { i as emitAgentEvent } from "./agent-events-COCf-9-O.js";
import { r as normalizeChatChannelId } from "./ids-DPg7j456.js";
import { p as resolveExecutionTargetTrustPath, s as resolveApprovalAuditTrustPath } from "./exec-command-resolution-BcEGhdwN.js";
import { F as splitShellArgs, c as isBlockedShellWrapperCommand } from "./shell-wrapper-resolution-4V1pkTCa.js";
import { d as PROCESS_TOOL_DISPLAY_SUMMARY, u as EXEC_TOOL_DISPLAY_SUMMARY } from "./tool-catalog-aNM_LYak.js";
import { c as WRITE_SCOPE, n as APPROVALS_SCOPE } from "./operator-scopes-Dw7Gu2cA.js";
import { m as runWithGatewayIndependentRootWorkAdmission, t as GatewayDrainingError } from "./gateway-work-admission-BaRJo64l.js";
...
import { s as normalizeDeliveryContext } from "./delivery-context.shared-DR6KpKlV.js";
...
import { i as normalizeMessageChannel, n as isGatewayMessageChannel } from "./message-channel-normalize-Cs-kjMZm.js";
import { s as isNativeApprovalChannel } from "./message-channel-Bo27VP7K.js";
import "./session-accessor-D5Or7WgI.js";
import { t as formatDurationCompact } from "./format-duration-DKk9BtRb.js";
import { a as failedTextResult } from "./common-yW0U9cHP.js";
import { n as textResult } from "./tool-results-BCM3fdVS.js";
import { E as parseExecApprovalResultText, T as isExecDeniedResultText, d as sanitizeUserFacingText, w as formatExecDeniedUserMessage } from "./sanitize-user-facing-text-Ba4C3tZ5.js";
import { h as BACKGROUND_EXEC_TASK_KIND } from "./task-registry-Bs8cA6Tm.js";
...
import { a as coerceEnv, c as readEnvInt, i as clampWithDefault, l as sliceLogLines, n as buildSandboxEnv, o as deriveSessionName, s as pad, u as truncateMiddle } from "./bash-tools.shared-0H8_zJuj.js";
import { a as deleteSession, c as getFinishedSession, d as listRunningSessions, f as markBackgrounded, h as tail, l as getSession, m as setJobTtlMs, o as drainSession, p as markExited, u as listFinishedSessions } from "./bash-process-registry--IqPmVga.js";
import { t as getProcessSupervisor } from "./supervisor-D9SmsI10.js";
import { t as callGatewayTool } from "./gateway-B5H4NIb8.js";
import { o as stripMalformedXmlArgValueSuffixFromKeys } from "./agent-tools.params-BZyOAvBo.js";
import { a as resolveExecApprovalInitiatingSurfaceState } from "./exec-approval-surface-DP9YlW0l.js";
import { u as resolveExecApprovalsTranscriptPath } from "./exec-approvals-config-DrfE-I9X.js";
import { A as resolveExecApprovalAllowedDecisions, B as requireValidExecTarget, D as minSecurity, E as maxAsk, F as normalizeExecAsk, H as resolveExecModePolicy, K as loadExecApprovals, M as resolveExecApprovalUnavailableDecisions, b as resolveAllowAlwaysPersistenceDecision, f as createExecApprovalPolicySnapshot, h as hasNodeCommandAllowAlwaysMarker, i as resolveExecApprovalsLocked, k as requiresExecApproval, m as hasExactCommandDurableExecApproval, p as hasDurableExecApproval, r as resolveExecApprovalsFromFile, s as commitExecAuthorizationLocked, w as commandRequiresSecurityAuditSuppressionApproval, x as resolveDurableExecApprovalRequirement, y as resolveAllowAlwaysPatternCoverage } from "./exec-approvals-sCmCk_jQ.js";
import { t as buildEnforcedShellCommand } from "./exec-approvals-analysis-XAN4qhrR.js";
import "./exec-wrapper-resolution-3NAqZbp9.js";
import { c as describeInterpreterInlineEval } from "./risks-DVvbIVRa.js";
import { i as evaluateShellAllowlistWithAuthorization } from "./exec-approvals-allowlist-DRhJBoRl.js";
import { n as describeProcessTool, t as describeExecTool } from "./bash-tools.descriptions-n5ceK7kT.js";
import { r as processSchema, t as execSchema } from "./bash-tools.schemas-BR2n1OVf.js";
import { r as resolveExecSafeBinRuntimePolicy } from "./exec-safe-bin-runtime-policy-DNHNJ1Ti.js";
import { a as resolveNodeIdFromList, t as listNodes } from "./nodes-utils-DC2wdBCD.js";
import { t as resolveExternalBestEffortDeliveryTarget } from "./best-effort-delivery-Bfr4N94O.js";
...
import { _ as renderExecOutputText, a as DEFAULT_PENDING_MAX_OUTPUT, c as buildExecRuntimeErrorOutcome, d as normalizeNotifyOutput, g as appendExecTimeoutRetryGuidance, h as runExecProcess, i as DEFAULT_PATH, l as createApprovalSlug, m as resolveExecTarget, n as DEFAULT_APPROVAL_TIMEOUT_MS, o as applyShellPath, p as resolveApprovalRunningNoticeMs, r as DEFAULT_MAX_OUTPUT, s as buildApprovalPendingMessage, v as renderExecUpdateText } from "./bash-tools.exec-runtime-BOxSsjY5.js";
import { i as formatExecApprovalContinuationSourceOutput, n as buildExecApprovalContinuationFallbackPrompt, r as buildExecApprovalContinuationPrompt } from "./bash-tools.exec-approval-output-gUsadhCg.js";
import { t as isApprovalNotFoundError } from "./approval-errors-BNzerOwp.js";
import { s as buildExecApprovalUnavailableReplyPayload } from "./exec-approval-reply-CBvUCFxF.js";
import { n as rejectUnsafeExecControlShellCommand } from "./exec-control-command-guard-C13_IAsy.js";
import { n as detectPolicyInlineEval } from "./policy-BIuMa4nV.js";
import { t as buildAuthorizedShellCommandFromPlan } from "./exec-authorization-render-SIU6drOi.js";
import { i as resolveExecAutoReviewDecision, n as defaultExecAutoReviewer } from "./exec-auto-review-B7v9ialR.js";
import { a as resolveRegisteredExecApprovalDecision, i as registerExecApprovalRequestForHostOrThrow, n as buildExecApprovalTurnSourceContext, r as isExecApprovalRunAbortedError, t as buildExecApprovalRequesterContext } from "./bash-tools.exec-approval-request-MXN-i1m6.js";
import { i as isExecApprovalFollowupSessionRebound, o as registerExecApprovalFollowupRuntimeHandoff, t as buildExecApprovalFollowupIdempotencyKey } from "./bash-tools.exec-approval-followup-state-Dt7XtEBa.js";
import { r as resolveSystemRunCommandRequest, t as extractShellCommandFromArgv } from "./system-run-command-BnpjDuob.js";
import { t as parsePreparedSystemRunPayload } from "./system-run-approval-context-ClRO-ZUk.js";
import { t as createModelExecAutoReviewer } from "./exec-auto-reviewer-Hm9z4O48.js";
...
const AGENT_FOLLOWUP_RUN_TIMEOUT_SECONDS = 300;
...
function isExecApprovalFollowupDirectDeliveryStale(params) {
	...
	try {
		return isExecApprovalFollowupSessionRebound({
			expectedSessionId,
			resolvedSessionId: normalizeOptionalString(loadSqliteSessionEntryReadOnly({
...
function formatDirectExecApprovalFollowupText(resultText, opts = {}) {
	...
	if (parsed.kind === "finished") {
		...
		const body = redactToolPayloadText(sanitizeUserFacingText(parsed.body, { errorContext: !metadata.includes("code 0") })).trim();
		let prefix = "";
	...
	if (parsed.kind === "completed") return redactToolPayloadText(sanitizeUserFacingText(parsed.body, { errorContext: true })).trim() || "Background command finished.";
	return redactToolPayloadText(sanitizeUserFacingText(parsed.raw, { errorContext: true })).trim() || null;
}
...
async function waitForAgentFollowupRun(params) {
	...
	for (;;) {
		...
		let wait;
		try {
			wait = await callGatewayTool("agent.wait", { timeoutMs: waitTimeoutMs + 2e3 }, {
				runId: params.runId,
	...
	if (sessionKey && params.direct !== true) try {
		...
		if (status === "accepted" || status === "in_flight" || status === "pending") {
			...
			if (waitResult.status === "observation_ended") {
				...
				log$1.warn(`Stopped observing accepted exec approval followup ${params.approvalId} after its bounded wait window; run ${runId} remains the sole delivery owner`);
			}
			return true;
		}
...
function buildHeadlessExecApprovalDeniedMessage(params) {
	return [
		`exec denied: ${params.trigger === "cron" ? "Automation runs" : "Headless runs"} cannot wait for interactive exec approval.`,
...
async function processGatewayAllowlist(params) {
	...
	if (requiresAllowlistPlanApproval && allowlistPlanUnavailableReason === "shell expansion in enforced arguments" && hostAsk === "off" && askFallback === "deny") {
	...
	if (requiresAsk) {
		...
		const autoReviewArgv = allowlistEval.segments.length === 1 && autoReviewSegment !== void 0 && autoReviewSegment.resolution?.policyBlocked !== true && !isBlockedShellWrapperCommand(autoReviewSegment.argv) && (autoReviewSegment.raw === void 0 || autoReviewSegment.raw.trim() === params.command.trim()) ? autoReviewSegment.argv : void 0;
		...
		if (canAutoReviewApprovalMiss) {
			const pendingDecision = resolveExecAutoReviewDecision(params.autoReviewer ?? defaultExecAutoReviewer, {
				command: params.command,
				argv: autoReviewArgv,
...
function classifyNodeInvokeFailure(error) {
	...
	const message = readString(nodeError?.message) ?? (error instanceof Error ? error.message : readString(error)) ?? "node invoke failed";
...
function formatNodeInvokeFailureText(params) {
	return [
		...params.failure.reason === "outcome-unknown" ? [`Node command outcome is unknown for ${params.nodeId}.`, "The command may have executed. Do not rerun it automatically."] : [`Node command was not dispatched to ${params.nodeId}.`, "It can be retried after the node reconnects."],
		"",
		"Command:",
		params.command,
		"",
...
function formatNodeInvokeFailureFollowup(params) {
	return `${params.failure.reason === "outcome-unknown" ? `Exec outcome unknown (node=${params.nodeId} id=${params.approvalId}, outcome-unknown)` : `Exec not dispatched (node=${params.nodeId} id=${params.approvalId}, not-dispatched)`}\n${formatNodeInvokeFailureText(params)}`;
}
...
async function invokeNodeSystemRun(params) {
	try {
		...
		const raw = callOptions ? await callGatewayTool("node.invoke", { timeoutMs: params.invokeWaitMs }, params.invoke, callOptions) : await callGatewayTool("node.invoke", { timeoutMs: params.invokeWaitMs }, params.invoke);
...
function resolveNodeInvokeDeadlineMs(runTimeoutSec, defaultTimeoutSec) {
...
function resolveNodeInvokeWaitMs(invokeDeadlineMs) {
	return addSafeTimeoutDelayGraceMs(invokeDeadlineMs, 5e3);
}
...
async function executeNodeHostCommand(params) {
		...
		if (!inlineApprovedByAsk) {
			...
			if (shouldResolveExecApprovalUnavailableInline({
				...
				(async () => {
					let decision;
					try {
						decision = await resolveApprovalDecisionOrUndefined({
							approvalId,
							preResolvedDecision,
							onFailure: () => void sendApprovalRequestFailedFollowup()
						});
					} catch (error) {
						if (isExecApprovalRunAbortedError(error)) return;
						await sendApprovalRequestFailedFollowup();
						return;
					}
					if (decision === void 0 || params.signal?.aborted) return;
	...
	if (!invocation.ok) return formatNodeInvokeFailureToolResult({
		failure: invocation.failure,
		nodeId: target.nodeId,
		command: params.command,
		startedAt,
...
function createExecRequestPreparation(params) {
	...
	const prepareBeforeToolCallParams = async (args, context) => {
		...
		if (getResolvedExecWorkdirPreparedState(execParams)?.resolution.kind === "unavailable") return execParams;
		if (!isExecToolArgsObject(execParams)) return execParams;
		if (shouldDeferResolveExecEnvUntilWorkdirValidated(execParams)) return markDeferredResolveExecEnvPrepared(execParams, { hookContext: context.hookContext });
		return prepareParamsWithResolvedExecEnv(execParams, { hookContext: context.hookContext });
	};
	const finalizeBeforeToolCallParams = (rawParams, preparedParams) => {
		...
		if (!envState && !deferredEnvState && !workdirState) return rawParams;
...
function resolvePreparedExecEnvironment(params) {
	...
	const requestedEnv = params.execParams.env !== void 0 || params.pluginEnv !== void 0 || channelContextEnv !== void 0 ? {
	...
	if (!params.sandbox && params.host === "gateway" && !requestedEnv?.PATH) applyShellPath(env, getShellPathFromLoginShell({
		env: process.env,
...
const fsSafeModuleLoader = createLazyImportLoader(() => import("./fs-safe-CK_5KK-N.js"));
...
function createExecTool(defaults) {
	...
	const notifySessionKey = normalizeOptionalString(defaults?.notifySessionKey ?? defaults?.sessionKey);
	...
	return {
		...
		execute: async (toolCallId, args, signal, onUpdate) => {
			...
			const deferredResolveExecEnvState = requestPreparation.getDeferredResolveExecEnvPreparedState(params);
			...
			try {
				...
				if (!resolveExecEnvPrepared) params = await requestPreparation.prepareParamsWithResolvedExecEnv(params, { hookContext: deferredResolveExecEnvState?.hookContext });
			...
			return new Promise((resolve, reject) => {
				const rejectIfAborted = () => {
					if (!toolAborted) return false;
					reject(createAbortError$1("Tool execution was aborted", { cause: signal?.reason }));
					return true;
				};
				...
				if (!toolAborted && allowBackground && yieldWindow !== null) if (yieldWindow === 0) onYieldNow();
				else yieldTimer = setTimeout(() => {
					onYieldNow();
				}, yieldWindow);
				run.promise.then((outcome) => {
					cleanupToolRunListeners();
					if (rejectIfAborted() || yielded || run.session.backgrounded) return;
					resolve(buildExecForegroundResult({
						outcome,
						cwd: run.session.cwd,
						warningText: getWarningText()
