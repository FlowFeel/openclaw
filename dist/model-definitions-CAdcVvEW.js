import { r as MINIMAX_TEXT_MODEL_CATALOG, t as MINIMAX_DEFAULT_MODEL_ID } from "./provider-models-DZ7PJi7Q.js";
...
function buildMinimaxModelDefinition(params) {
	...
	const compat = catalog && "compat" in catalog ? catalog.compat : void 0;
	return {
		id: params.id,
