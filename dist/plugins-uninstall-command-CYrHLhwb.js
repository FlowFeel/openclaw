...
async function runPluginUninstallCommandUnlocked(id, opts, runtime, skipPreview = false) {
	...
	const { buildPluginSnapshotReport } = await import("./status-CoKWGsHn.js");
	const { applyPluginUninstallDirectoryRemoval, formatUninstallActionLabels, formatUninstallSlotResetPreview, planPluginUninstall, pluginUninstallTargetExists, prepareConfigForPendingPluginDirectoryRemoval, resolveUninstallChannelConfigKeys, UNINSTALL_ACTION_LABELS } = await import("./uninstall-Cb4V59MQ.js");
	const { commitPluginInstallRecordsWithConfig } = await import("./install-record-commit-DMKBG1Dq.js");
	const { selectInstallMutationWriteOptions } = await import("./install-persistence-Dhp3Uj1O.js");
