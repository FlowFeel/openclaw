...
const loadAgentsBindModule = createLazyRuntimeModule(() => import("./agents.commands.bind-D6kyDPW5.js"));
async function loadAgentsAddCommand() {
	return (await import("./agents.commands.add-BuoWZqCf.js")).agentsAddCommand;
}
...
async function loadAgentsDeleteCommand() {
	return (await import("./agents.commands.delete-txyyy3x1.js")).agentsDeleteCommand;
}
async function loadAgentsSetIdentityCommand() {
	return (await import("./agents.commands.identity-GzUUWERd.js")).agentsSetIdentityCommand;
}
async function loadAgentsListCommand() {
	return (await import("./agents.commands.list-C1IE_oxx.js")).agentsListCommand;
}
