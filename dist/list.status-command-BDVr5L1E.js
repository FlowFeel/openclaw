...
import { c as shouldEnableShellEnvFallback, n as getShellEnvAppliedKeys } from "./shell-env-ic769138.js";
import { r as theme, t as colorize } from "./theme-vjDs9tao.js";
import { n as OPENAI_PROVIDER_ID } from "./openai-routing-Db2edxk0.js";
...
import { y as resolveMergedModelProviderConfig } from "./openai-model-routes--NVfVZh4.js";
import { t as resolveAgentHarnessPolicy } from "./policy-hKMGXdHG.js";
import { n as installTemporaryCurrentPluginMetadataSnapshot, t as getCurrentPluginMetadataSnapshot } from "./current-plugin-metadata-snapshot-LM8oq-yZ.js";
...
import { C as resolveModelRefFromString, N as parseModelPolicyWildcardRef, a as buildModelAliasIndex, b as resolveConfiguredModelRef, p as modelCatalogLogicalKey, y as resolveConfiguredModelPolicyAllow } from "./model-selection-shared-V7VmYFPH.js";
...
import { c as isNonSecretApiKeyMarker, g as resolveProviderEnvAuthLookupMaps, h as listProviderEnvAuthLookupKeys, l as isOAuthApiKeyMarker } from "./model-auth-markers-z4js65k2.js";
import { j as resolveProviderSyntheticAuthWithPlugin } from "./provider-runtime-DlVC1wsY.js";
import { a as loadPersistedAuthProfileStore } from "./persisted-YZpzzn3_.js";
import { c as getRuntimeAuthProfileStoreSnapshot, i as ensureAuthProfileStore, o as ensureAuthProfileStoreWithoutExternalProfiles } from "./store-BWT5kQzj.js";
import { u as resolveProfileUnusableUntilForDisplay } from "./usage-D2WAMRv4.js";
import { i as loadPreparedModelCatalogSnapshot } from "./prepared-model-catalog-DJrhvpj1.js";
...
import { n as resolveAgentHarnessOwnerPluginIds } from "./runtime-plugin-load-plan-CfrMO8pl.js";
import { i as resolveAuthProfileDisplayLabel } from "./auth-profiles-67bIpdG9.js";
import "./profiles-Hfbx6aWI.js";
import { r as getCustomProviderApiKey, x as resolveUsableCustomProviderApiKey } from "./model-auth-provider-config-Bf2cufz8.js";
import { t as createModelAuthAvailabilityResolver } from "./model-auth-availability-C8Zmw0UA.js";
...
import { n as resolveAgentHarnessRuntimeAvailability } from "./runtime-plugin-_-F_9ggx.js";
...
import { a as resolveKnownAgentId } from "./shared-BzUAJo8W.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort, t as DEFAULT_OAUTH_WARN_MS } from "./auth-health-BEWZFCoK.js";
...
const providerUsageRuntimeLoader = createLazyImportLoader(() => import("./provider-usage-COBVTdPV.js"));
...
const listProbeRuntimeLoader = createLazyImportLoader(() => import("./list.probe-DK5QR8JP.js"));
...
async function modelsStatusCommand(opts, runtime) {
	...
	const resolveCodexRuntimeAvailability = (provider) => {
		...
		const pending = (async () => {
			const { runPluginPayloadSmokeCheckForManifestRecords } = await import("./plugin-payload-validation-BbGz8LwG.js");
	...
	try {
		...
		if (missingProvidersInUse.length > 0) {
			const { buildProviderAuthRecoveryHint } = await import("./provider-auth-recovery-hint-Brsn_ACj.js");
			runtime.log("");
