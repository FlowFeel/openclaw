...
function resolveGpt5PromptOverlayMode(config, legacyPluginConfig, params) {
	...
	return (!providerId || OPENAI_FAMILY_GPT5_PROMPT_OVERLAY_PROVIDERS.has(providerId) ? normalizeGpt5PromptOverlayMode(config?.plugins?.entries?.openai?.config?.personality) : void 0) ?? normalizeGpt5PromptOverlayMode(legacyPluginConfig?.personality) ?? "friendly";
}
/** @deprecated OpenAI/Codex provider-owned prompt overlay helper; do not use from third-party plugins. */
...
//#endregion
export { isGpt5ModelId as a, resolveGpt5SystemPromptContribution as c, GPT5_HEARTBEAT_PROMPT_OVERLAY as i, GPT5_FRIENDLY_CHAT_PROMPT_OVERLAY as n, normalizeGpt5PromptOverlayMode as o, GPT5_FRIENDLY_PROMPT_OVERLAY as r, resolveGpt5PromptOverlayMode as s, GPT5_BEHAVIOR_CONTRACT as t };
