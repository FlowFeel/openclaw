...
import { a as resolveCliRuntimeOwnerFingerprint, i as resolveCliRuntimeArtifactFingerprint } from "./cli-auth-epoch-D190FCAo.js";
import { _ as isFailoverErrorMessage, i as classifyFailoverReason } from "./errors-B811vGBl.js";
import { c as isFailoverError, d as isTimeoutError, p as resolveFailoverStatus, t as FailoverError, u as isSignalTimeoutReason } from "./failover-error-BSBBvfXF.js";
...
import { d as waitForDeferredTurnMaintenanceForSession, i as bootstrapHarnessContextEngine, l as runHarnessContextEngineMaintenance, n as runAgentEndSideEffects, s as finalizeHarnessContextEngineTurn, t as awaitAgentEndSideEffects } from "./agent-end-side-effects-BrmMcpME.js";
...
import { o as shouldUseClaudeLiveSession } from "./claude-live-session-CgP6LSTn.js";
import { v as cliBackendLog, y as formatCliBackendOutputDigest } from "./helpers-ZECrr_yU.js";
import { n as getCliMessagingDeliveryEvidence, t as attachCliMessagingDeliveryEvidence } from "./delivery-evidence-Cmz7UHq4.js";
import { i as loadCliSessionHistoryMessages, l as claudeCliSessionTranscriptHasContent, r as loadCliSessionContextEngineMessages, s as buildAgentHookConversationMessages } from "./session-history-i9NM30mp.js";
...
async function runCliAgentInternal(params, diagnosticLifecycle) {
	...
	if (params.cleanupCliLiveSessionOnRunEnd === true) try {
		const { closeClaudeLiveSessionForContext } = await import("./claude-live-session-Cz2N9JGX.js");
		await closeClaudeLiveSessionForContext(context);
	} catch (error) {
		recordCleanupError(error);
	}
	if (params.cleanupBundleMcpOnRunEnd === true) try {
		const { retireSessionMcpRuntime } = await import("./agent-bundle-mcp-tools-XfIG9Zav.js");
