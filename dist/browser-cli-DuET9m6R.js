...
const browserCommandGroupDefinitions = [
	{
		...
		register: async (args) => {
			(await import("./browser-cli-manage-DqtH05qq.js")).registerBrowserManageCommands(args.browser, args.parentOpts);
		}
	},
	{
		...
		register: async (args) => {
			(await import("./browser-cli-inspect-mlcC1KQJ.js")).registerBrowserInspectCommands(args.browser, args.parentOpts);
		}
	},
	{
		placeholders: [
		...
		register: async (args) => {
			(await import("./browser-cli-actions-input-C3HrD9IL.js")).registerBrowserActionInputCommands(args.browser, args.parentOpts);
		}
	},
	{
		placeholders: [
		...
		register: async (args) => {
			(await import("./browser-cli-actions-observe-BNuyqdZ1.js")).registerBrowserActionObserveCommands(args.browser, args.parentOpts);
		}
	},
	{
		placeholders: [
		...
		register: async (args) => {
			(await import("./browser-cli-debug-DCD36aGS.js")).registerBrowserDebugCommands(args.browser, args.parentOpts);
		}
	},
	{
		placeholders: [
		...
		register: async (args) => {
			(await import("./browser-cli-state-CjzBlcjP.js")).registerBrowserStateCommands(args.browser, args.parentOpts);
		}
	},
	{
		placeholders: [command("extension", "Chrome extension load path and pairing")],
		register: async (args) => {
			(await import("./browser-cli-extension-GL05H9Nj.js")).registerBrowserExtensionCommands(args.browser, args.parentOpts, args.pluginRoot);
		}
	}
];
