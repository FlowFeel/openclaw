...
import { t as resolveChannelInboundAttachmentRoots } from "./channel-inbound-roots-01MRrxfy.js";
import { n as isMinimaxVlmProvider, t as isMinimaxVlmModel } from "./minimax-vlm-CCXFtvPU.js";
import { t as providerSupportsCapability } from "./provider-supports-msSTK_XS.js";
import { c as buildMediaUnderstandingRegistry, l as getMediaUnderstandingProvider } from "./defaults.constants-Bzdu2YOa.js";
import { i as matchesMediaEntryCapability } from "./runtime-media-secret-owner-C-EJ4rYa.js";
import { a as resolveModelEntries, s as resolveScopeDecision } from "./resolve-iHjR7Egs.js";
import { n as resolveOpenAiAudioAuthModelApi } from "./openai-audio-api-BEkNYRPi.js";
import { a as runCliEntry, d as isMediaUnderstandingSkipError, l as MediaAttachmentCache, o as runProviderEntry, r as formatDecisionSummary, t as buildModelDecision, u as selectAttachments } from "./runner.entries-CWlHR1tu.js";
import { a as normalizeAttachments } from "./attachments.normalize-qZn2-M5R.js";
import { r as inspectLocalAudioSelection, t as clearLocalAudioInspectionCacheForTests } from "./local-audio-IUt38He2.js";
...
const loadHasAvailableAuthForProvider = createLazyRuntimeNamedExport(() => import("./model-auth-CFB4LdRv.js"), "hasAvailableAuthForProvider");
const loadPreparedModelCatalogApi = createLazyRuntimeModule(async () => ({
	...await import("./model-catalog-D08l3HGh.js"),
	...await import("./prepared-model-catalog-CDZ2A_-7.js")
}));
...
async function resolveAutoImageModelId(params) {
	...
	const { resolveDefaultMediaModel } = await import("./defaults-DYWQ0JgL.js");
