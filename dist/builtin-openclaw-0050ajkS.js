...
import { i as redactSecrets, m as isSecretValueRegisteredForRedaction } from "./redact-BGqyyKN9.js";
...
import { n as ensureGlobalUndiciDispatcherStreamTimeouts, r as ensureGlobalUndiciEnvProxyDispatcher, t as DEFAULT_UNDICI_STREAM_TIMEOUT_MS } from "./undici-global-dispatcher-B0fHhkhz.js";
import { P as stripInternalMetadataForDisplay } from "./openclaw-state-db-D9eH245j.js";
...
import { S as requireActivePluginRegistry, d as getActivePluginRegistry, v as listImportedRuntimePluginIds } from "./runtime-WkCmQTS9.js";
...
import { a as resolveEffectivePluginActivationState, i as normalizePluginsConfigWithResolver } from "./manifest-registry-xP2DL3Xg.js";
...
import { r as loadPluginMetadataSnapshot, t as isPluginMetadataSnapshotCompatible } from "./plugin-metadata-snapshot-B_ZQ9Mbo.js";
...
import { a as createStreamIteratorWrapper, i as wrapStreamFnTextTransforms } from "./text-transforms.runtime-DMVbPf9Z.js";
import { a as resolveSecretSentinel, i as mintSecretSentinel, r as looksLikeSecretSentinel } from "./sentinel-DH6relF_.js";
import { t as describeProviderRequestRoutingSummary } from "./provider-attribution-DUC9Ms4a.js";
import { d as resolveProviderRequestHeaders } from "./provider-request-config-C5exA1l5.js";
import { c as resolveContextEngineOwnerPluginId } from "./registry-DyBZw0Nd.js";
import { h as resolveBlockMessage, t as getGlobalHookRunner } from "./hook-runner-global-BNa5TLJ4.js";
...
import { M as hasNonzeroUsage, N as makeZeroUsageSnapshot, P as normalizeUsage, nt as listSqliteSessionEntriesReadOnly, st as loadSqliteSessionEntry } from "./session-accessor.sqlite-CtCo5VZ6.js";
...
import { y as loadSqliteTranscriptEvents } from "./session-accessor.sqlite-transcript-store-BCfOcQgE.js";
import { $ as parseSessionThreadInfoFast, J as resolveQuotaSuspensionEntryMaintenance } from "./session-entry-slot-keys-DPRQmSpa.js";
...
import { $ as listSessionEntries, E as withOwnedSessionTranscriptWrites, K as updateSessionEntry, i as resolveSessionTranscriptRuntimeTarget, r as resolveSessionTranscriptRuntimeReadTarget, w as bindOwnedSessionTranscriptWrites } from "./session-accessor-D5Or7WgI.js";
import { l as listRegisteredPluginAgentPromptGuidance } from "./command-registration-MGWB6wzh.js";
import { B as finalizeToolTerminalPresentation, J as consumePreExecutionBlockedToolCall, K as resolveChannelReactionGuidance, Q as peekPreExecutionBlockedToolCall, R as isEmbeddedMode, U as listChannelSupportedActions, W as resolveChannelMessageToolHints, X as consumeTrackedToolExecutionStarted, Y as consumeStructuredReplaySafeToolCall, Z as peekAdjustedParamsForToolCall, c as recordStructuredReplayTrustForToolCall, q as consumeAdjustedParamsForToolCall } from "./agent-tools.before-tool-call-uaLOAHZ3.js";
import { d as resolveProviderRuntimePluginHandle } from "./provider-hook-runtime-C7-SJnLH.js";
import { M as resolveProviderSystemPromptContribution, N as resolveProviderTextTransforms, U as transformProviderSystemPrompt, W as validateProviderReplayTurnsWithPlugin, w as resolveProviderCacheTtlEligibility, z as sanitizeProviderReplayHistoryWithPlugin } from "./provider-runtime-DlVC1wsY.js";
import { t as sanitizeForConsole } from "./console-sanitize-NjY4pEOW.js";
import { t as buildGuardedModelFetch } from "./provider-transport-fetch-U3uyyPqS.js";
import { a as resolveToolCallArgumentsEncoding, n as extractModelCompat } from "./provider-model-compat-Rmx9B67o.js";
import { A as COMPACTION_SUMMARY_PREFIX, M as bashExecutionToText, O as BRANCH_SUMMARY_PREFIX, j as COMPACTION_SUMMARY_SUFFIX, k as BRANCH_SUMMARY_SUFFIX } from "./agent-core-3hvRadZX.js";
import { t as event_stream_exports } from "./event-stream-MHM-_qcK.js";
import { J as SettingsManager, K as wrapToolDefinition, i as DefaultResourceLoader, n as createAgentSessionForEmbeddedRunner } from "./sessions-CxWGGmnA.js";
import { a as isSessionContextMetadataEntry } from "./session-manager-codec-MEinfCA8.js";
import { r as detectRuntimeShell } from "./shell-utils-DzYfAjux.js";
import { a as sanitizeToolCallInputs, c as hasOnlyAssistantReasoningContent, i as repairToolUseResultPairing, l as isReasoningOnlyLengthAssistantTurn, o as sanitizeToolUseResultPairing, s as stripToolResultDetails } from "./ai-transport-runtime-host-CchjIxjf.js";
...
import { a as readToolResultDetails, n as isToolResultError } from "./tool-result-error-BI56-yEJ.js";
import { n as normalizeGoogleApiBaseUrl } from "./google-api-base-url-UBNiBOzj.js";
import { a as buildHistoryPrunePlan, d as isOversizedForSummary, i as SUMMARIZATION_OVERHEAD_TOKENS, l as computeAdaptiveChunkRatio, n as MIN_CHUNK_RATIO, r as SAFETY_MARGIN, t as BASE_CHUNK_RATIO } from "./compaction-planning-CK7RJNHD.js";
import { o as resolveModelAuthMode } from "./model-auth-yfB4tyNY.js";
import "./model-selection-CZlE_kEq.js";
import { C as MAX_WORKSPACE_BOOTSTRAP_FILE_BYTES, g as isWorkspaceBootstrapPending, n as DEFAULT_BOOTSTRAP_FILENAME, w as readWorkspaceBootstrapFile } from "./workspace-aPJlJwqC.js";
...
import { i as classifyFailoverReason, m as isCloudCodeAssistFormatError, u as formatUserFacingAssistantErrorText } from "./errors-Bujrccyt.js";
...
import { d as isTimeoutError, u as isSignalTimeoutReason } from "./failover-error-DBKQENP4.js";
import { r as isSessionWriteLockAcquireError } from "./session-write-lock-error-5gHYmvxH.js";
import { l as recordSessionCompacted } from "./session-state-events-COmXZrBv.js";
import { H as isTerminalTaskStatus } from "./task-registry-Bs8cA6Tm.js";
import { c as mergeAgentRunAttemptTerminal, d as projectAgentRunAttemptTerminal, f as setAgentRunAttemptTerminalFailure, r as buildAgentRunTerminalOutcomeFromAttempt } from "./agent-run-terminal-outcome-C9bgFmfC.js";
...
import { c as listTasksForOwnerOrRequesterSessionKeyForStatus, n as findTaskByRunIdForStatus } from "./task-status-access-C-YIcrT5.js";
import { n as resolveAgentTimeoutMs } from "./timeout-BEGWfRGM.js";
import { j as resolveCompactionTimeoutMs } from "./diagnostic-CdMjo2Fb.js";
import { h as setActiveEmbeddedRunLifecycleGeneration } from "./run-state-oGYwHnd-.js";
import { T as updateActiveEmbeddedRunSnapshot, h as markActiveEmbeddedRunAbandoned, r as clearActiveEmbeddedRun, w as setActiveEmbeddedRun } from "./runs-Bdk5tY9J.js";
...
import { f as parseReplyDirectives, p as splitMediaFromOutput } from "./payloads-6G4VluOK.js";
import { a as sanitizeGoogleTurnOrdering } from "./bootstrap-DOyGG4hV.js";
import { n as sanitizeSessionMessagesImages } from "./embedded-agent-helpers-dlCGQLQ2.js";
import { l as isMessagingToolDuplicateNormalized, u as normalizeTextForComparison } from "./reply-payloads-dedupe-B4sXvswH.js";
import { u as stripHeartbeatToken } from "./heartbeat-Cw1AzhxC.js";
import { n as CODE_MODE_WAIT_TOOL_NAME, t as CODE_MODE_EXEC_TOOL_NAME } from "./code-mode-control-tools-Bts-Jy9S.js";
import { t as buildLateMediaAttachedProjection } from "./user-turn-transcript-BTXVzeiZ.js";
...
import { a as getOrCreateSessionMcpRuntime, b as loadEmbeddedAgentMcpConfig } from "./agent-bundle-mcp-manager-api-D2GddaSc.js";
import { i as getPluginToolMeta } from "./tools-sUgO7zqy.js";
import { o as readMcpAppChannelView } from "./mcp-ui-resource-CHdOzPZi.js";
import { r as materializeBundleMcpToolsForRun } from "./agent-bundle-mcp-materialize-ajBEG2-c.js";
...
import { d as prepareMemoryPromptSection } from "./memory-state-D_cMOwNA.js";
import { t as resolvePreferredSessionKeyForSessionIdMatches } from "./session-id-resolution-joL8CTWk.js";
import { f as buildContextEngineRuntimeSettings, i as bootstrapHarnessContextEngine, n as runAgentEndSideEffects, r as assembleHarnessContextEngine, s as finalizeHarnessContextEngineTurn, u as runContextEngineMaintenance } from "./agent-end-side-effects--ABMNPXa.js";
...
import { l as copyAgentToolMetadata, m as getChannelAgentToolMeta } from "./gateway-B5H4NIb8.js";
...
import { i as makeBootstrapWarn, n as buildBootstrapContextForFiles, o as resolveBootstrapFilesForRun, r as hasCompletedBootstrapTurn, s as resolveContextInjectionMode, t as FULL_BOOTSTRAP_COMPLETED_CUSTOM_TYPE } from "./bootstrap-files-DfTRxNZ7.js";
...
import { n as rewriteTranscriptEntriesInSessionManager } from "./transcript-runtime-state-Bl8TA4TD.js";
...
import { A as settleRequesterAfterSessionSpawns, R as prependAgentSteeringPrompt, h as leasePendingAgentSteeringItems, t as ackPendingAgentSteeringItems, w as releasePendingAgentSteeringItems } from "./subagent-registry-C4ALZQd0.js";
import { c as resolveMainSessionAlias, s as resolveInternalSessionKey } from "./sessions-helpers-Cuf72ls2.js";
import { t as resolveToolLoopDetectionConfig } from "./tool-loop-detection-config-B_SwfAQE.js";
import { n as replaceWithEffectiveCronCreatorToolAllowlist } from "./cron-tool-tkG5AG2b.js";
import { p as mediaUrlsFromGeneratedAttachments } from "./subagent-announce-delivery-Y0rI4Ahg.js";
import { t as abortable } from "./abortable-Cb2uKKe9.js";
import { _ as buildApiErrorObservationFields, v as buildTextObservationFields, y as shouldSuppressRawErrorConsoleSuffix } from "./model-fallback-attempt-CwT_ozOy.js";
import { t as registerProviderStreamForModel } from "./provider-stream-CSQQqJCF.js";
import { t as buildSubagentList } from "./subagent-list-QeCafGQe.js";
import { o as listControlledSubagentRuns } from "./subagent-control-DeOJbVi3.js";
import { r as markdownToIR } from "./construct-fallbacks-BR_o1n_g.js";
import { a as resolveContextWindowInfo } from "./context-window-guard-O3VIGDkh.js";
import { n as mapThinkingLevelForProvider, t as mapThinkingLevel } from "./utils-CefVZRZM.js";
import { n as normalizeAgentRuntimeTools, t as logAgentRuntimeToolDiagnostics } from "./tools-BKYdulJW.js";
import { n as filterRuntimeCompatibleTools } from "./tool-schema-projection-ZrMdwk4s.js";
import { r as recordPersistedRuntimeToolSchemaQuarantine, t as clearRecoveredPersistedRuntimeToolSchemaQuarantines } from "./tool-schema-quarantine-health-iiox1BbR.js";
...
import { n as claimHeartbeatOutcomeForRun, t as buildHeartbeatOutcomeContext } from "./heartbeat-outcome-store-B_JNGsv7.js";
import { S as isAnthropicModelRef, s as createCodexNativeWebSearchWrapper, x as isAnthropicFamilyCacheTtlEligible } from "./proxy-CrJCXD6x.js";
import { a as resolvePreparedExtraParams, n as resolveAgentTransportOverride, o as isGooglePromptCacheEligible, r as resolveExplicitSettingsTransport, s as resolveCacheRetention, t as applyExtraParamsToAgent } from "./extra-params-BniXc1fJ.js";
import { a as resolveEmbeddedAgentStreamFn, i as resolveEmbeddedAgentBaseStreamFn, n as describeEmbeddedAgentStreamStrategy, r as resolveEmbeddedAgentApiKey, t as wrapStreamFnWithDiagnosticModelCallEvents } from "./attempt.model-diagnostic-events-CM1TPKMM.js";
import { i as resolveLiveToolResultMaxChars } from "./tool-result-limits-DjIhjsDF.js";
import { _ as stripInvalidThinkingSignatures, a as resolveLiveToolResultAggregateMaxChars, b as wrapAnthropicStreamWithRecovery, f as truncateToolResultText, g as shouldPreserveLatestAssistantThinking, h as dropThinkingBlocks, i as resolveCacheTtlPruningSettings, l as truncateOversizedToolResultsInMessages, m as dropReasoningFromHistory, p as assessLastAssistantMessage, r as pruneExpiredCacheTtlToolResults, s as toolResultWarningDedupe, u as truncateOversizedToolResultsInSessionManager, v as stripStaleThinkingSignaturesForCompactionReplay, x as formatContextLimitTruncationNotice, y as stripThinkingBlocksFromMessage } from "./transcript-visibility-CJfcHiRn.js";
...
import { a as buildModelIdentityPromptLine, c as prepareProjectMemoryBootstrap, i as appendModelIdentitySystemPrompt, o as resolveAgentPromptSurfaceForSessionKey, r as buildConfiguredAgentSystemPrompt, s as buildProjectMemoryWriteInstruction, t as buildSystemPromptParams } from "./system-prompt-params-BENSLgZq.js";
import { n as prepareWatchedSessionsPrompt } from "./watched-sessions-prompt-BpQzHAn1.js";
import { i as shouldPersistCompletedBootstrapTurn, n as composeSystemPromptWithHookContext, r as resolveAttemptSpawnWorkspaceDir, t as appendAttemptCacheTtlIfNeeded } from "./attempt.thread-helpers-wvQtocZt.js";
import { c as buildInboundMediaNoteProjection, o as formatContextJsonBlock, r as hasPersistedMedia, t as isReasoningTagProvider } from "./provider-utils-DQdO9BDc.js";
import { i as readPersistedMediaImageLayout, r as hydratePromptMediaMessages, t as detectAndLoadPromptImages } from "./images-BC0m77Nb.js";
...
import { n as toTrajectoryToolDefinitions, t as createTrajectoryRuntimeRecorder } from "./runtime-CSro6ugV.js";
import { n as redactConfigObject } from "./redact-snapshot-Ce9_WB-z.js";
import { i as resolveRuntimeOsLabel, r as resolveOsSummary } from "./os-summary--1-t8Sb6.js";
import { a as sanitizeSupportSnapshotValue, t as redactPathForSupport } from "./diagnostic-support-redaction-Dks684Cj.js";
import { d as resolveFinalAssistantVisibleText, u as resolveFinalAssistantRawText, v as resolveReportedModelRef } from "./helpers-BN65NIti.js";
...
import "./tool-loop-detection-BKEWA_YV.js";
import { i as runAgentHarnessBeforeAgentFinalizeHook } from "./lifecycle-hook-helpers-B_MyvJob.js";
...
import { a as toToolDefinitions, i as toClientToolDefinitions, n as findClientToolNameConflicts, t as createClientToolNameConflictError } from "./agent-tool-definition-adapter-D0dRoqXm.js";
import { n as isQueryStopWordToken, t as extractKeywords } from "./query-expansion-DzoKGtnD.js";
import { t as createAgentToolResultMiddlewareRunner } from "./tool-result-middleware-DT8nKWjd.js";
import { B as resolveCodeModeSkills } from "./code-mode-state-BNttlFne.js";
import { i as createCodeModeTools, n as resolveAgentToolSurfacePlan, r as addClientToolsToCodeModeCatalog, t as applyAgentToolSurfaceCatalog } from "./tool-surface-plan-D4N5PzfK.js";
...
import { n as collectRuntimeChannelCapabilities, t as buildSystemPromptReport } from "./system-prompt-report-BhiWei2a.js";
...
* telemetry.
*/
const execApprovalReplyModuleLoader = createLazyImportLoader(() => import("./exec-approval-reply-AOmm_I3H.js"));
