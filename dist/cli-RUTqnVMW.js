...
import { a as registerLazyCommandGroup, n as getCommandGroupNames, o as removeCommandGroupNames, t as findCommandGroupEntry } from "./register-command-groups-Bz2LvqeP.js";
import { n as setCommandJsonMode } from "./json-mode-DBVhsnA-.js";
import { n as loadPluginCliDescriptors, r as loadPluginCliRegistrationEntriesWithDefaults, t as createPluginCliLogger } from "./cli-registry-loader-DhGFnCsH.js";
...
const loadValidatedConfigForPluginRegistration = async (options) => {
	const snapshot = await readConfigFileSnapshot({ skipPluginValidation: options?.skipPluginValidation });
...
async function registerPluginCliCommandsFromValidatedConfig(program, env, loaderOptions, options) {
	const config = await loadValidatedConfigForPluginRegistration({ skipPluginValidation: options?.skipPluginValidation });
