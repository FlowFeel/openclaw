...
import { n as ensureCliExecutionBootstrap, r as resolveCliExecutionStartupContext, t as applyCliExecutionStartupPresentation } from "./command-execution-startup-CG76ese1.js";
...
const configCliLoader = createLazyImportLoader(() => import("./config-cli-Cy1bhY-K.js"));
...
const modelsStatusCommandLoader = createLazyImportLoader(() => import("./list.status-command-C8bB8ia9.js"));
const tasksJsonCommandLoader = createLazyImportLoader(() => import("./tasks-json-8BBz3mpQ.js"));
...
const routedCommandDefinitions = {
	...
	status: defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			if (args.json) {
				const { statusJsonCommand } = await import("./status-json-DFhBhUHa.js");
			...
			const { statusCommand } = await import("./status-0z4UMM2n.js");
