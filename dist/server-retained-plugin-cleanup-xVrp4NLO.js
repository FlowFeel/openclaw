...
async function cleanupRetainedPluginInstallGenerations(params) {
	try {
		const records = (await import("./installed-plugin-index-records-D0VI1KgI.js")).loadInstalledPluginIndexInstallRecordsSync();
		const { cleanupRetainedManagedNpmInstallGenerations } = await import("./managed-npm-retention-keMHUGO5.js");
