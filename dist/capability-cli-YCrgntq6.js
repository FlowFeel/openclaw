...
import { t as planEffectiveModelCatalogRows } from "./model-catalog-BEn_zNk0.js";
import { u as readResponseWithLimit } from "./http-body-DhB9daEt.js";
import { r as theme } from "./theme-vjDs9tao.js";
import { a as assertProviderBinaryResponseContent, r as assertOkOrThrowHttpError } from "./provider-http-errors-Dm9G78mz.js";
...
import { c as callGateway, v as randomIdempotencyKey } from "./call-YSl9HPoR.js";
...
import { s as resolveApiKeyForProvider } from "./model-auth-D32HIbZ7.js";
import { n as canonicalizeCaseOnlyCatalogModelRef } from "./model-selection-D5gxVbBh.js";
...
import { t as buildExplicitSessionIdSessionKey } from "./session-KmhKDbsn.js";
import { t as runWithImageModelFallback } from "./model-fallback-image-OCjAkido.js";
import { o as fetchWithTimeoutGuarded, p as resolveProviderHttpRequestConfig } from "./shared-Ck9SyaVQ.js";
import { c as buildMediaUnderstandingRegistry } from "./defaults.constants-BD7Nlx_t.js";
import { h as getTtsCommandSecretTargetIds, i as getCapabilityWebFetchCommandSecretTargets, l as getMemoryEmbeddingCommandSecretTargetIds, o as getCapabilityWebSearchCommandSecretTargets, u as getModelsCommandSecretTargetIds } from "./command-secret-targets-DIFshlpq.js";
import { n as normalizeSpeechProviderId } from "./provider-registry-core-tbOIZwiJ.js";
import { o as listSpeechProviders, r as canonicalizeSpeechProviderId } from "./directives-rfUF-x-9.js";
import { g as resolveTtsConfig, o as getTtsPersona, u as listTtsPersonas, v as resolveTtsPrefsPath } from "./tts-settings-Cim3tOQK.js";
import { _ as setTtsProvider, g as setTtsPersona, l as listSpeechVoices, m as setTtsEnabled, s as resolveExplicitTtsOverrides, t as getTtsProvider } from "./runtime-api-h4IEqjLu.js";
...
import { i as listWebSearchProviders, n as isWebSearchProviderConfigured, o as runWebSearch } from "./runtime-B9u5Z5Ps.js";
import { c as resolveMemorySearchConfig } from "./config-utils-dp-ljmDA.js";
import { n as listEmbeddingProviders } from "./embedding-provider-runtime-Cz_i0Cp6.js";
import { a as listMemoryEmbeddingProviders } from "./memory-embedding-provider-runtime-CGh7w7JF.js";
...
import { r as inspectLocalAudioSelection } from "./local-audio-BZ6KL61K.js";
import { i as resolveWebFetchDefinition, n as isWebFetchProviderConfigured, r as listWebFetchProviders } from "./runtime-AcbbEqUN.js";
...
import { c as transcribeAudioFile, i as describeVideoFile, o as prepareImageDescriptionInput, r as describePreparedImageWithModel, t as describeImageFile } from "./runtime-BrbklANZ.js";
import { t as resolveCommandConfigWithSecrets } from "./command-config-resolution-Cyyu6gp3.js";
import { n as parseTimeoutMsWithFallback } from "./parse-timeout-D6qJ8hKz.js";
import { r as createEmbeddingProvider } from "./memory-core-bundled-runtime-D42GlyTd.js";
...
async function runModelAuthStatus() {
	const captured = [];
	const { modelsStatusCommand } = await import("./list.status-command-CsM7pj-o.js");
...
function registerModelCapabilityCommands(capability) {
	...
	modelAuth.command("login").description("Run provider auth login").requiredOption("--provider <id>", "Provider id").option("--method <id>", "Provider auth method id").action(async (opts) => {
		await runCommandWithRuntime(defaultRuntime, async () => {
			const { modelsAuthLoginCommand } = await import("./auth-Cn1aFB81.js");
