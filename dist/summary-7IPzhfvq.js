...
import { N as resolveSessionTotalTokens } from "./session-entry-slot-keys-DPRQmSpa.js";
import "./session-accessor-D5Or7WgI.js";
import { f as redactSecretDegradationReason, u as listActiveDegradedSecretOwners } from "./runtime-degraded-state-V0p9ck6P.js";
import { t as areRuntimeModelRefsEquivalent } from "./model-runtime-aliases-D1mCKu2G.js";
import { u as peekSystemEvents } from "./system-events-BNZxjP0P.js";
...
const channelSummaryModuleLoader = createLazyImportLoader(() => import("./channel-summary-Bj55A_6f.js"));
const channelPluginIdsModuleLoader = createLazyImportLoader(() => import("./channel-plugin-ids-CBmAmC0M.js"));
const linkChannelModuleLoader = createLazyImportLoader(() => import("./link-channel-DvszSHZ2.js"));
const taskRegistryMaintenanceModuleLoader = createLazyImportLoader(() => import("./task-registry.maintenance-BY6uH1y8.js"));
const staticModelCatalogResolverLoader = createLazyImportLoader(async () => {
	const modelCatalog = await import("./model.static-catalog-CLACPTvl.js");
	return {
...
function listSessionCandidates(storePath, agentId) {
	return listSqliteSessionEntriesReadOnly({
		...agentId ? { agentId } : {},
		storePath
