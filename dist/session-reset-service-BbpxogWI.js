...
import { Ct as buildSessionCreationStamp, H as deleteSqliteSessionEntryLifecycle, U as resetSqliteSessionEntryLifecycle, wt as sessionEntryForkedFromParent } from "./session-accessor.sqlite-B9iW7DOt.js";
import { t as formatSqliteSessionFileMarker } from "./legacy-sqlite-marker-COPKCuIN.js";
import { _t as interruptSessionWorkAdmissions, gt as hasOnlySessionLifecycleMutationKindActive, lt as SESSION_WORK_ADMISSION_DRAIN_TIMEOUT_MS, w as resolveMissingAgentHarnessSessionError, xt as runExclusiveSessionLifecycleMutation, yt as isSessionLifecycleMutationActive } from "./session-entry-slot-keys-DR5d2mKt.js";
import { a as errorShape } from "./error-codes-P4fBo0lR.js";
import { t as getAcpSessionManager } from "./manager-b2r7oh2O.js";
import { a as handleSessionStateSessionDeleted, o as handleSessionStateSessionReset, u as recordSessionCreated } from "./session-state-events-MWtkoPhW.js";
import { t as getSessionBindingService } from "./session-binding-service-DW9rA35s.js";
import { t as getAcpRuntimeBackend } from "./registry-Dl-z2yBd.js";
import { c as writeAcpSessionMetaForMigration, r as readAcpSessionMeta, s as upsertAcpSessionMeta } from "./session-meta-DqFXJodN.js";
...
import { r as archiveSessionTranscriptsDetailed, s as resolveStableSessionEndTranscript } from "./session-transcript-files.fs-DUSeZC1w.js";
import { n as resolveSessionModelRef } from "./session-model-ref-D6sDGDAK.js";
import { S as loadSessionEntry, k as resolveGatewaySessionStoreTarget } from "./session-utils-row-Cby7i9PV.js";
import "./session-utils-DRzriWC1.js";
import { n as clearBootstrapSnapshotOnSessionBoundary, t as clearBootstrapSnapshot } from "./bootstrap-cache-8R0DvXGI.js";
import { m as triggerInternalHook, n as createInternalHookEvent } from "./internal-hooks-glvlO_hY.js";
import { a as isModelSelectionLocked, n as MODEL_SELECTION_LOCKED_RESET_MESSAGE } from "./model-overrides-BT6Lelev.js";
import { i as rebindCliSessionReseedReceiptsForReset } from "./cli-session-binding-F7hyyN-U.js";
import { t as clearAllCliSessions } from "./cli-session-qfSu2tit.js";
import { r as resolveSessionPlacementResetBlock } from "./session-placement-admission-BEJd445g.js";
import { t as cleanupBrowserSessionsForLifecycleEnd } from "./browser-lifecycle-cleanup-Dxv5_nqj.js";
import { r as stopSubagentsForRequester } from "./abort-CSpsUFdg.js";
import { a as buildSessionStartHookPayload, i as buildSessionEndHookPayload, n as listActiveSessionsForShutdown, r as noteActiveSessionForShutdown, t as forgetActiveSessionForShutdown } from "./active-sessions-shutdown-tracker-CcnjeX1j.js";
import { n as clearSessionResetRuntimeState, t as resolveResetPreservedSelection } from "./reset-preserved-selection-DKnwtAOG.js";
import { n as hasSessionAutoResetListeners, r as isSessionAutoResetReason, t as emitSessionAutoResetHook } from "./session-auto-reset-Bs72jkPR.js";
import { n as runPluginHostCleanup } from "./host-hook-cleanup-DV-3lJxO.js";
import { t as resolvePluginSessionOwnershipError } from "./session-plugin-ownership-Dlx-UDnP.js";
import { t as notifyGatewaySessionReset } from "./session-reset-notifications-Is8h_Auo.js";
...
async function ensureSessionRuntimeCleanup(params) {
	const [embeddedAgent, mcpTools, { clearFinishedSessionsForScopes }] = await Promise.all([
		import("./embedded-agent-C8PdYTWR.js"),
		import("./agent-bundle-mcp-tools-XfIG9Zav.js"),
		import("./bash-process-registry-35tDL4xx.js")
	]);
	...
	const ensureMcpRetirementWatcher = () => {
		...
		const watcher = getOrCreatePromise(mcpRunEndWatchers, sessionId, async () => {
...
async function performGatewaySessionReset(params) {
	...
	return await runExclusiveSessionLifecycleMutation({
		...
		prepare: async () => {
			...
			const currentEntry = loadSessionEntry(params.key, resetTarget.requestedAgentId ? { agentId: resetTarget.requestedAgentId } : void 0).entry;
		...
		run: async () => {
			...
			if (entry?.incognito === true || isIncognitoSessionKey(target.canonicalKey)) {
				if (!entry) return {
					ok: false,
				...
				if (!(await deleteSqliteSessionEntryLifecycle({
			...
			params.assertAuthorizedInstance?.();
			const boundaryEntry = loadSessionEntry(params.key, requestedAgentId ? { agentId: requestedAgentId } : void 0).entry;
			...
			const lifecycle = await resetSqliteSessionEntryLifecycle({
