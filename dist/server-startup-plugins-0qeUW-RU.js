...
import { g as collectUnregisteredConfiguredMemoryEmbeddingProviders, h as collectRegisteredEmbeddingProviderIds } from "./gateway-startup-plugin-ids-C-hC0TmS.js";
import { E as setActivePluginRegistry, I as createEmptyPluginRegistry, d as getActivePluginRegistry } from "./runtime-WkCmQTS9.js";
import "./loader-CT1KBBu5.js";
import "./agent-scope-DyEposw2.js";
import { r as listAmbientOnlyConfiguredChannelIds } from "./channel-presence-policy-BjX2SvLo.js";
import "./channel-plugin-ids-Ds82VHXY.js";
import { t as loadPluginLookUpTable } from "./plugin-lookup-table-BVMajdap.js";
import { m as initSubagentRegistry } from "./subagent-registry-C4ALZQd0.js";
import { r as resolveGatewayStartupPluginActivationConfig } from "./plugin-activation-runtime-config-xZ7Pz6e8.js";
import { n as listGatewayMethods } from "./server-methods-list-By1dPxJ0.js";
...
async function runGatewayStartupMaintenance(params) {
	...
	if (!params.minimalTestGateway || startupMaintenanceConfig.channels !== void 0) {
		const { runChannelPluginStartupMaintenance } = await import("./lifecycle-startup-dJGU_ix1.js");
		...
		if (!params.minimalTestGateway) {
			const { runStartupSessionMigration } = await import("./server-startup-session-migration-eOjU572X.js");
			startupTasks.push(runStartupSessionMigration({
				cfg: params.cfgAtStart,
				env: process.env,
				log: params.log
			}));
			const { migrateLegacyDevicePairingStore } = await import("./device-pairing-migration-CBtcG4yV.js");
			const { migrateLegacyNodePairingStore } = await import("./node-pairing-migration-cfz3k0Nm.js");
...
async function loadGatewayStartupPluginRuntime(params) {
	const { loadGatewayStartupPlugins } = await import("./server-plugin-bootstrap-Cf9gYAu4.js");
