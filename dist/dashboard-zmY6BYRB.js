...
import { n as openUrl, t as detectBrowserOpenSupport } from "./browser-open-Q4xq7OR_.js";
import { a as formatControlUiSshHint } from "./onboard-helpers-CEgpoKqW.js";
...
import { i as waitForControlUiDocument, n as issueControlUiBrowserHandoff, r as resolveControlUiHandoffTarget, t as hasVerifiedControlUiLoopbackAlias } from "./control-ui-handoff-Wa3Dbo0p.js";
...
const daemonStatusModuleLoader = createLazyImportLoader(() => import("./status.gather-C7p4jFfz.js"));
const daemonInstallModuleLoader = createLazyImportLoader(() => import("./install.runtime-ByewyVen.js"));
const daemonLifecycleModuleLoader = createLazyImportLoader(() => import("./lifecycle-BHMyeOzI.js"));
...
async function dashboardCommand(runtime = defaultRuntime, options = {}) {
	...
	if (!options.noOpen) if ((await detectBrowserOpenSupport()).ok) {
		...
		hint = opened ? void 0 : copied ? "Browser launch failed. Open the one-time pairing URL copied to clipboard." : "Browser launch failed. Open the Dashboard URL above manually.";
