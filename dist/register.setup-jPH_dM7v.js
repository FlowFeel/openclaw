...
import { a as resolveTailscaleResetOnExitFlag, i as resolveInstallDaemonFlag, n as registerOnboardAuthOptions, o as validateOnboardAuthOptionValues, t as pickOnboardAuthOptionValues } from "./register.onboard-CaNLl-BG.js";
...
async function runOnboardingEntry(options, commandRuntime, runtime) {
	if (options.baseline) {
		...
		const { setupCommand } = await import("./setup-BkfFizLb.js");
		await setupCommand({
	...
	if (!validateOnboardAuthOptionValues(options, runtime)) return;
