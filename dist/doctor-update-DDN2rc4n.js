...
import { i as isDefaultInstallIdentity } from "./paths-CL43LNS6.js";
...
import { t as runGatewayUpdate } from "./update-runner-DZ1Hk58n.js";
import { t as createUpdateProgress } from "./progress-wG3cChAI.js";
...
async function inspectGatewayServiceForUpdate(root) {
	if (!isDefaultInstallIdentity(process.env) || isServiceRepairExternallyManaged()) return NO_GATEWAY_SERVICE_UPDATE;
	try {
