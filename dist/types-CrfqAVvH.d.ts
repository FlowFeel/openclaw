import { D as ConversationReadInvocationOrigin, T as ChannelThreadingToolContext, k as OutboundMediaReadFile, m as ChannelMessageActionAdapter, n as ChannelAccountSnapshot } from "./types.core-C4iMq7Vo.js";
import { T as ThinkingLevel, d as Model, j as Usage, l as ImageContent, n as Api, r as AssistantMessage } from "./types-xx0UXBU1.js";
import { b as StreamFn, c as AgentMessage, f as AgentToolResult, p as AgentToolUpdateCallback, u as AgentTool } from "./types-BzdPB1fv.js";
import { l as ModelRegistry$1, u as AuthStorage } from "./index-D8dwacg6.js";
import { a as TaskSuggestionDeliveryMode, c as LegacyMediaContextKey, f as ReplyMediaAttachment, h as MessagePresentation, l as MediaFact, n as GetReplyOptions, o as TurnAdoptionLifecycle, p as ReplyPayload, r as PartialReplyPayload, s as AgentPlanStep, t as BlockReplyContext, u as PromptImageOrderEntry, v as ModelPickerAction } from "./types-zW07lbxl.js";
import { $ as ResolvedTtsPersona, Bt as IdentityConfig, Ft as SilentReplyConversationType, Gt as ChatType, It as ContextVisibilityMode, M as TalkProviderConfig, Rt as DmScope, W as ChannelImplicitMentionsConfig, Wt as SessionScope, ct as SafeBinProfileFixture, et as TtsAutoMode, ft as MemoryCitationsMode, gt as FastMode, ht as SilentReplyPromptMode, it as TtsProvider, mt as PromptMode, n as OpenClawConfig, nt as TtsMode, st as ToolLoopDetectionConfig, t as ConfigFileSnapshot, tt as TtsConfig, zt as HumanDelayConfig } from "./types.openclaw-B-6RRL7F.js";
import { _ as SessionCreatedActor, a as SessionEntry, c as SessionToolOverrides, d as CronScheduledToolPolicy, g as SourceReplyDeliveryMode, i as SessionContextBudgetStatus, n as GroupKeyResolution, o as SessionPluginJsonValue, s as SessionSystemPromptReport, t as CliSessionBinding, v as SessionCreatedVia } from "./types-C-ie8uJb.js";
import { _ as InboundEventKind, a as MsgContext, c as HistoryEntry, d as CommandTurnKind, f as PluginHookChannelContext, g as StructuredExtractionInput, h as MediaUnderstandingProvider, i as MentionSource, l as HistoryMediaEntry, m as MediaUnderstandingOutput, n as FinalizedRuntimeMsgContext, o as SessionTranscriptContext, p as MediaUnderstandingDecision, r as InboundSourceModality, s as SupplementalContextFacts, t as FinalizedMsgContext, u as CommandTurnContext } from "./templating-pXhKKc5q.js";
import { n as mediaKindFromMime, t as MediaKind } from "./constants-CbtCb9df.js";
import { _ as SecretInput, a as ModelMediaInputConfig, f as AgentModelConfig, i as ModelDefinitionConfig, n as ModelApi, o as ModelProviderAuthMode, r as ModelCompatConfig, s as ModelProviderConfig, v as SecretRef } from "./types.models-Cbb-WeIa.js";
import { i as OAuthCredential, n as AuthProfileCredential, r as AuthProfileStore, t as ApiKeyCredential } from "./types-BqfkEFeu.js";
import { n as InputProvenance, t as UserTurnTranscriptRecorder } from "./user-turn-transcript.types-BIrustIM.js";
...
import { n as SessionsCompanionAskResult, r as SessionsCompanionStateResult, t as SessionObserverDigest } from "./sessions-DLTLQ1qw.js";
import { t as ChannelId$1 } from "./channel-id.types-DjYEl-_2.js";
import { A as chunkMarkdownTextWithMode, B as MessageReceipt, J as PluginApprovalRequest, L as OutboundPayloadDeliverySuppressionReason, M as chunkTextWithMode, N as resolveChunkMode, O as chunkByNewline, P as resolveTextChunkLimit, Y as PluginApprovalRequestPayload, j as chunkText, k as chunkMarkdownText, w as ChannelOutboundAdapter } from "./types.adapters-DCMv7yAc.js";
import { D as UnifiedModelCatalogKind, E as UnifiedModelCatalogEntry, _ as PluginManifestDashboardActionVerb, a as PluginOrigin$1, d as PluginBundleFormat, f as PluginConfigUiHint, g as PluginManifestDashboard, h as PluginManifestContracts, i as PluginDependencyStatus, m as PluginFormat, p as PluginDiagnostic, t as PluginManifestRecord, v as PluginManifestDashboardDataBinding, w as PluginKind, y as PluginManifestMcpServer } from "./manifest-registry-yyab0mBB.js";
import { c as ExecAsk, d as ExecTarget, l as ExecMode, r as ExecApprovalRequestPayload$1, t as ExecApprovalDecision, u as ExecSecurity } from "./exec-approvals-core-CYhVMCan.js";
...
import { n as WizardPrompter, t as ChannelPlugin$3 } from "./types.plugin-CBDARGQD.js";
import { o as SessionBindingRecord } from "./session-binding.types-iPttD8T3.js";
import { n as HeartbeatRunResult, t as requestHeartbeat } from "./heartbeat-wake-DdC_ceqS.js";
import { i as PluginCompatCode, n as PluginMetadataSnapshot, t as PluginMetadataRegistryView } from "./plugin-metadata-snapshot.types-CKqzUu4R.js";
import { r as ConfigWriteAfterWrite, t as ConfigReplaceResult } from "./config-gPwpaYa_.js";
import { t as resolveStateDir } from "./paths-ckrEvGsP.js";
import { c as onSessionTranscriptUpdate, l as ResolvedSessionMaintenanceConfigInput } from "./session-accessor.types-CrgyBFG-.js";
import { A as PluginConversationBinding, B as ReplyDispatcher, F as DiagnosticTraceContext, I as ReplyDispatchBeforeDeliver, L as ReplyDispatchBeforeDeliverOptions, M as PluginConversationBindingRequestResult, N as PluginConversationBindingResolvedEvent$1, P as PluginHookBeforeToolCallResult, R as ReplyDispatchKind, V as ReplyFollowupAdmissionBarrierTimeoutPolicy, _ as PluginNextTurnInjectionEnqueueResult, a as PluginHookRegistration$1, d as PluginHookToolContext, f as PluginHookToolRequesterContext, g as PluginNextTurnInjection, h as PluginToolMatcher, i as PluginHookName, j as PluginConversationBindingRequestParams, n as PluginHookBeforeToolCallEvent, o as PluginHookRegistrationOptions, r as PluginHookHandlerMap, v as PluginJsonValue, z as ReplyDispatchRuntimeInfo } from "./hook-types-DiISlkO8.js";
import { c as SandboxBackendWorkdirValidator, g as SkillUsagePath, h as SkillTelemetrySource, m as SkillSnapshot, r as SandboxBackendExecSpec, s as SandboxBackendWorkdirValidation, u as SandboxFsBridge } from "./exec-defaults-2ifWpOT3.js";
...
import { h as completeSimple } from "./llm-Cmt9nqzk.js";
import { a as CronJobCreate, c as CronRunStatus, i as CronJob, o as CronJobPatch, s as CronPayload } from "./store-cq0chwDo.js";
import { n as createSubsystemLogger, r as LogLevel } from "./subsystem-RmDRaRJV.js";
import { t as OpenClawStateDatabaseOptions } from "./openclaw-state-db-contract-CmXakrzW.js";
import { a as WorkerEnvironmentState, c as SessionsCatalogArchiveParams, d as SessionsCatalogReadResult, f as ConnectParams, g as SessionApprovalReplay, h as ApprovalPresentation, i as NodeSkillDescriptor, l as SessionsCatalogContinueParams, m as RequestFrame, n as WizardStep$1, o as SystemAgentChatQuestion, p as ErrorShape, r as NodePluginToolDescriptor, s as SessionCatalogHost, t as WizardAnswer, u as SessionsCatalogReadParams } from "./index-Cfav1Wmh.js";
import { a as ModelCatalogEntry, n as resolveAgentDir, o as ModelCatalogSnapshot, r as resolveAgentWorkspaceDir } from "./model-selection-B9HPZ60v.js";
import { f as PluginSubagentRequesterContext } from "./message-sent-hook-D2x-P-J3.js";
import { o as runCommandWithTimeout, s as SpawnResult } from "./exec-ayCQTx2b.js";
import { _ as TaskScopeKind, a as OutboundDeliveryQueuePolicy, b as TaskTerminalOutcome, c as DetachedTaskLifecycleRuntimeRegistration, d as TaskDeliveryStatus, f as TaskNotifyPolicy, g as TaskRuntimeCounts, h as TaskRuntime, i as DurableFinalDeliveryRequirements, l as JsonValue, m as TaskRegistrySummary, n as AgentInternalEvent, p as TaskRecord, r as DeliverOutboundPayloadsParams, s as DetachedTaskLifecycleRuntime, t as AgentHarnessTaskRuntimeScope, u as TaskDeliveryState, v as TaskStatus, y as TaskStatusCounts } from "./agent-harness-task-runtime-scope-DWzpFRZm.js";
import { a as EmbeddingProviderCreateOptions, c as EmbeddingProviderRuntime, i as EmbeddingProviderCallOptions$1, n as EmbeddingProvider$1, r as EmbeddingProviderAdapter, s as EmbeddingProviderIndexIdentity } from "./embedding-providers-B14t3WBj.js";
import { n as SessionManager } from "./session-manager-m-0UfCAc.js";
import { r as RetryOptions } from "./index-BTQfvEv9.js";
import { n as PinnedDispatcherPolicy, r as SsrFPolicy$1, t as LookupFn } from "./ssrf-Crs8FTVH.js";
import { i as fetchWithSsrFGuard } from "./fetch-guard-BFmUMj1d.js";
import { o as shouldUseEnvHttpProxyForUrl } from "./proxy-env-MXKaepi-.js";
import { i as OAuthLoginCallbacks, r as OAuthCredentials } from "./provider-oauth-runtime-BK6L07z2.js";
...
import { i as UpsertChannelPairingRequestForAccount, n as ReadChannelAllowFromStoreForAccount, o as buildAgentSessionKey, r as RemoveChannelAllowFromStoreEntryForAccount, s as resolveAgentRoute, t as buildPairingReply } from "./pairing-messages-CIFfHHkX.js";
import { n as recordChannelActivity, t as getChannelActivity } from "./channel-activity-BmLouy1g.js";
import { c as InboundImplicitMentionKind, g as resolveInboundMentionDecision, h as implicitMentionKindWhen, i as MatchesMentionWithExplicit, r as MatchesMentionPatterns, t as BuildMentionRegexes } from "./mentions.types-D8HKdA_l.js";
import { n as resolveChannelGroupRequireMention, t as resolveChannelGroupPolicy } from "./group-policy-wxFRQsyo.js";
import { i as PairLoopGuardConfig } from "./pair-loop-guard-runtime-D5O3zwX9.js";
import { t as ResolveMarkdownTableMode } from "./markdown-tables.types-CwNiDtWo.js";
import { _ as ImageGenerationSourceImage, c as ImageGenerationOutputFormat, f as ImageGenerationProviderOptions, h as ImageGenerationResolution, i as ImageGenerationNormalization, l as ImageGenerationProvider, n as ImageGenerationBackground, p as ImageGenerationQuality, r as ImageGenerationIgnoredOverride, t as GeneratedImageAsset } from "./types-DjYN0p8g.js";
import { c as VideoGenerationProvider, f as VideoGenerationResolution, m as VideoGenerationSourceAsset, r as VideoGenerationIgnoredOverride, s as VideoGenerationNormalization, t as GeneratedVideoAsset } from "./types-BxdX8JcN.js";
import { c as MusicGenerationProvider, f as MusicGenerationSourceImage, o as MusicGenerationNormalization, r as MusicGenerationIgnoredOverride, s as MusicGenerationOutputFormat, t as GeneratedMusicAsset } from "./types-BhdsYWVA.js";
import { t as ModelProviderRequestTransportOverrides$1 } from "./provider-request-config-B6FN25DX.js";
import { o as ProviderUsageSnapshot } from "./provider-usage.types-CSw7pG9h.js";
import { t as ProviderAuthEvidence } from "./provider-env-vars-DMJl7-H2.js";
import { t as enqueueSystemEvent } from "./system-events-DSDPR1Ic.js";
...
import { c as ProviderRouteOverridePresence, i as ProviderModelRouteRuntimePolicy, t as ProviderModelRouteAuthRequirement } from "./provider-model-types-DqNZ-l-s.js";
import { o as TranscriptSourceProvider$2 } from "./provider-types-GUKla83s.js";
...
type LocalEmbeddingProviderRuntimeOptions = {
  workerScriptPath?: string;
  nodeLlamaCppImportUrl?: string;
};
declare function createLocalEmbeddingProvider(options: EmbeddingProviderOptions, runtimeOptions?: LocalEmbeddingProviderRuntimeOptions): Promise<EmbeddingProvider>;
//#endregion
...
declare function resolveMemorySearchStaleness(status: Pick<MemoryProviderStatus, "dirty" | "custom">, agentId?: string): {
  stale: true;
  warning: string;
  action: string;
} | null;
...
declare const MEMORY_CHUNKING_VERSION = 2;
...
type MemoryEmbeddingProviderCallOptions = Pick<EmbeddingProviderCallOptions$1, "signal">;
...
type MemoryEmbeddingProvider = Pick<EmbeddingProvider$1, "id" | "model" | "maxInputTokens" | "close"> & {
...
//#endregion
//#region src/channels/turn/kernel.d.ts
...
type ImageGenerationProviderPlugin$1 = ImageGenerationProviderPlugin;
type MediaUnderstandingProviderPlugin$1 = MediaUnderstandingProviderPlugin;
type TranscriptSourceProvider$1 = TranscriptSourceProvider;
type MusicGenerationProviderPlugin$1 = MusicGenerationProviderPlugin;
...
type RealtimeTranscriptionProviderPlugin$1 = RealtimeTranscriptionProviderPlugin;
type RealtimeVoiceProviderPlugin$1 = RealtimeVoiceProviderPlugin;
type SpeechProviderPlugin$1 = SpeechProviderPlugin;
type VideoGenerationProviderPlugin$1 = VideoGenerationProviderPlugin;
type WebFetchProviderPlugin$1 = WebFetchProviderPlugin;
type WebSearchProviderPlugin$1 = WebSearchProviderPlugin;
type WorkerProvider$1 = WorkerProvider;
...
type PluginSpeechProviderRegistration = PluginOwnedProviderRegistration<SpeechProviderPlugin$1>;
type PluginEmbeddingProviderRegistration = PluginOwnedProviderRegistration<EmbeddingProviderAdapter>;
type PluginRealtimeTranscriptionProviderRegistration = PluginOwnedProviderRegistration<RealtimeTranscriptionProviderPlugin$1>;
type PluginRealtimeVoiceProviderRegistration = PluginOwnedProviderRegistration<RealtimeVoiceProviderPlugin$1>;
type PluginMediaUnderstandingProviderRegistration = PluginOwnedProviderRegistration<MediaUnderstandingProviderPlugin$1>;
type PluginTranscriptsSourceProviderRegistration = PluginOwnedProviderRegistration<TranscriptSourceProvider$1>;
type PluginImageGenerationProviderRegistration = PluginOwnedProviderRegistration<ImageGenerationProviderPlugin$1>;
type PluginVideoGenerationProviderRegistration = PluginOwnedProviderRegistration<VideoGenerationProviderPlugin$1>;
type PluginMusicGenerationProviderRegistration = PluginOwnedProviderRegistration<MusicGenerationProviderPlugin$1>;
...
type PluginWorkerProviderRegistration = PluginOwnedProviderRegistration<WorkerProvider$1>;
...
type PreparedSimpleCompletionModel = {
  model: Model;
  auth: ResolvedProviderAuth; /** Non-reversible owner proof captured from the same auth snapshot. */
...
declare function prepareSimpleCompletionModel(params: {
  ...
  allowBundledStaticCatalogFallback?: boolean; /** @deprecated Model resolution is lifecycle-backed and always asynchronous. */
...
type TranscriptSourceProvider = TranscriptSourceProvider$2;
...
type OpenClawPluginApi = {
  ...
  registerWorkerProvider: (provider: WorkerProvider) => void; /** Register provider-owned model catalog rows for text and media generation. */
...
//#endregion
export { TALK_EVENT_TYPES as $, ThinkLevel as $i, CliBackendConfig as $n, listMemoryFiles as $r, WebSearchProviderToolDefinition as $t, RealtimeVoiceBrowserSessionCreateRequest as A, clearMemoryEmbeddingProviders as Ai, ProviderAuthResult as An, MemoryPluginRuntime as Ar, SpeechSynthesisStreamResult as At, RealtimeVoiceToolResultOptions as B, SystemAgentOperation as Bi, ProviderRuntimeModel as Bn, enforceEmbeddingMaxInputTokens as Br, PluginStateLeaseErrorCode as Bt, RealtimeVoiceAudioFormat as C, hasNonTextEmbeddingParts as Ci, ProviderWrapStreamFnContext as Cn, MemoryEmbeddingProviderAdapter as Cr, SpeechProviderPrepareSynthesisContext as Ct, RealtimeVoiceBridgeCreateRequest as D, getMemoryEmbeddingProvider as Di, ProviderAuthContext as Dn, MemoryEmbeddingProviderIndexIdentity as Dr, SpeechProviderResolveTalkOverridesContext as Dt, RealtimeVoiceBridgeCallbacks as E, registerMemoryCapability as Ei, ProviderResolveDynamicModelContext as En, MemoryEmbeddingProviderCreateResult as Er, SpeechProviderResolveTalkConfigContext as Et, RealtimeVoiceProviderId as F, buildCaseInsensitiveExtensionGlob as Fi, ProviderReplayPolicy as Fn, RemoteEmbeddingClient as Fr, TtsDirectiveParseResult as Ft, RealtimeTranscriptionSession as G, readNonNegativeIntegerParam as Gi, UnifiedModelCatalogProviderContext as Gn, MemoryChunk as Gr, PluginBlobEntryInfo as Gt, RealtimeTranscriptionProviderConfiguredContext as H, AnyAgentTool as Hi, ProviderCatalogContext as Hn, CuratedProjectAnnotations as Hr, PluginStateLeaseRunner as Ht, RealtimeVoiceProviderResolveConfigContext as I, classifyMemoryMultimodalPath as Ii, ProviderReplayPolicyContext as In, createRemoteEmbeddingProvider as Ir, ResolvedProviderRuntimeAuth as It, OpenClawPluginNodeHostCommandIo as J, readStringArrayParam as Ji, PluginRegistry as Jn, buildMultimodalChunkForIndexing as Jr, WebFetchProviderPlugin as Jt, RealtimeTranscriptionSessionCallbacks as K, readNumberParam as Ki, UnifiedModelCatalogProviderPlugin as Kn, MemoryFileEntry as Kr, PluginBlobStore as Kt, RealtimeVoiceRole as L, getMemoryMultimodalExtensions as Li, ProviderSanitizeReplayHistoryContext as Ln, resolveRemoteEmbeddingClient as Lr, PluginStateLeaseContext as Lt, RealtimeVoiceProviderCapabilities as M, registerMemoryEmbeddingProvider as Mi, ProviderSystemPromptContribution as Mn, RegisteredMemorySearchManager as Mr, SpeechTelephonySynthesisRequest as Mt, RealtimeVoiceProviderConfig as N, resolveSessionTranscriptsDirForAgent as Ni, ProviderNormalizeToolSchemasContext as Nn, buildRemoteBaseUrlPolicy as Nr, SpeechVoiceOption as Nt, RealtimeVoiceBridgeEvent as O, listMemoryEmbeddingProviders as Oi, ProviderAuthMethod as On, MemoryEmbeddingProviderRuntime as Or, SpeechSynthesisRequest as Ot, RealtimeVoiceProviderConfiguredContext as P, resolveMemorySearchConfig as Pi, ProviderReasoningOutputMode as Pn, withRemoteHttpResponse as Pr, TtsDirectiveOverrides as Pt, DiagnosticEventInput as Q, RuntimePluginToolGrant as Qi, CliBackendAuthEpochMode as Qn, extractProjectKeysFromCuratedEntry as Qr, WebSearchProviderSetupContext as Qt, RealtimeVoiceTool as R, DEFAULT_AGENT_COMPACTION_RESERVE_TOKENS_FLOOR as Ri, ProviderToolSchemaDiagnostic as Rn, RemoteEmbeddingProviderId as Rr, PluginStateLeaseDatabase as Rt, RealtimeVoiceAudioClearReason as S, EmbeddingInput as Si, ProviderThinkingProfile as Sn, MemoryEmbeddingProvider as Sr, SpeechProviderOverrides as St, RealtimeVoiceBridge as T, listMemoryCorpusSupplements as Ti, ProviderPreparedRuntimeAuth as Tn, MemoryEmbeddingProviderCreateOptions as Tr, SpeechProviderResolveConfigContext as Tt, RealtimeTranscriptionProviderId as U, asToolParamsRecord as Ui, ProviderCatalogResult as Un, INVALID_PROJECT_ANNOTATION_KEY as Ur, OpenBlobStoreOptions as Ut, RealtimeTranscriptionProviderConfig as V, SecretInputMode as Vi, ProviderAugmentModelCatalogContext as Vn, CuratedMarkdownEntry as Vr, PluginStateLeaseOptions as Vt, RealtimeTranscriptionProviderResolveConfigContext as W, readFiniteNumberParam as Wi, ProviderPluginCatalog as Wn, MEMORY_CHUNKING_VERSION as Wr, PluginBlobEntry as Wt, HookContext as X, jsonResult as Xi, PluginRuntime as Xn, cosineSimilarity as Xr, WebSearchCredentialResolutionSource as Xt, DelegationCapability as Y, readStringParam as Yi, SessionCatalogProvider as Yn, chunkMarkdown as Yr, WebFetchProviderToolDefinition as Yt, ToolOutcomeObserver as Z, SkillWorkshopRunOptions as Zi, ScheduledToolPolicyContext as Zn, ensureMemoryHostDir as Zr, WebSearchProviderPlugin as Zt, SpeechProviderPlugin as _, MemorySyncParams as _i, requireApiKey as _n, CliBackendToolAvailabilityEnforcement as _r, SpeechListVoicesRequest as _t, OpenClawPluginGatewayRuntimeScopeSurface as a, splitCuratedMarkdownEntries as ai, WebMediaResult as an, CliBackendParseJsonlEvent as ar, TalkEventType as at, REALTIME_VOICE_AUDIO_FORMAT_PCM16_24KHZ as b, SsrFPolicy as bi, upsertAuthProfile as bn, MemoryEmbeddingBatchChunk as br, SpeechProviderConfiguredContext as bt, MigrationDetection as c, MemoryOriginClass as ci, TrustedSubagentCompletionHandoff as cn, CliBackendPlugin$1 as cr, createTalkEventSequencer as ct, MigrationProviderContext as d, MemorySearchManager as di, completeWithPreparedSimpleCompletionModel as dn, CliBackendResolveExecutionArgs as dr, ResolvedTtsConfig as dt, normalizeExtraMemoryPaths as ei, WebSearchProviderToolExecutionContext as en, CliBackendExecutionMode as er, TalkBrain as et, MigrationProviderPlugin as f, MemorySearchResult as fi, prepareSimpleCompletionModel as fn, CliBackendResolveExecutionArgsContext as fr, ResolvedTtsModelOverrides as ft, RealtimeVoiceProviderPlugin as g, MemorySource as gi, ResolvedProviderAuth as gn, CliBackendToolAvailability as gr, SpeechDirectiveTokenParseResult as gt, RealtimeTranscriptionProviderPlugin as h, MemorySessionSyncTarget as hi, resolveApiKeyForProvider as hn, CliBackendThinkingLevel as hr, SpeechDirectiveTokenParseContext as ht, ProviderPlugin as i, runMemoryHostTasksWithConcurrency as ii, GenerateImageRuntimeResult as in, CliBackendNormalizeConfigContext as ir, TalkEventSequencer as it, RealtimeVoiceCloseReason as j, listRegisteredMemoryEmbeddingProviders as ji, ProviderPluginWizardSetup as jn, MemoryPromptSectionBuilder as jr, SpeechSynthesisTarget as jt, RealtimeVoiceBrowserSession as k, listRegisteredMemoryEmbeddingProviderAdapters as ki, ProviderAuthMethodNonInteractiveContext as kn, MemoryFlushPlan as kr, SpeechSynthesisStreamRequest as kt, MigrationItem as l, MemoryProviderStatus as li, ConversationRecallContext as ln, CliBackendPrepareExecutionContext as lr, PluginRuntimeCore as lt, ImageGenerationProviderPlugin as m, MemorySessionKind as mi, ModelAuthMode as mn, CliBackendSideQuestionToolMode as mr, resolveEffectiveTtsConfig as mt, OpenClawPluginConfigSchema as n, parseEmbedding as ni, GenerateVideoRuntimeResult as nn, CliBackendLiveSessionRequirement as nr, TalkEventContext as nt, MigrationApplyResult as o, stripMemoryAnnotationCarriers as oi, DEFAULT_CONTEXT_TOKENS as on, CliBackendParseJsonlEventContext as or, TalkMode as ot, MigrationSummary as p, MemorySearchRuntimeDebug as pi, prepareSimpleCompletionModelForAgent as pn, CliBackendRuntimeArtifactPolicy as pr, TtsConfigResolutionContext as pt, RealtimeTranscriptionSessionCreateRequest as q, readPositiveIntegerParam as qi, PluginHttpRouteRegistration as qn, buildFileEntry as qr, WebFetchCredentialResolutionSource as qt, OpenClawPluginApi as r, remapChunkLines as ri, GenerateImageParams as rn, CliBackendNativeToolMode as rr, TalkEventInput as rt, MigrationConfigRuntime as s, MemoryEntryProvenance as si, RunEmbeddedAgentParams as sn, CliBackendParsedJsonlEvent as sr, TalkTransport as st, OpenClawPluginDefinition as t, normalizeProjectAnnotationKey as ti, GenerateVideoParams as tn, CliBackendJsonlUsage as tr, TalkEvent as tt, MigrationPlan as u, MemoryReadResult as ui, ExecToolDefaults as un, CliBackendPreparedExecution as ur, RuntimeLogger as ut, VideoGenerationProviderPlugin as v, MemorySyncProgressUpdate as vi, resolveAwsSdkEnvVarName as vn, ProcessToolDefaults as vr, SpeechModelOverridePolicy as vt, RealtimeVoiceBargeInOptions as w, clearMemoryPluginState as wi, ProviderPrepareDynamicModelContext as wn, MemoryEmbeddingProviderCallOptions as wr, SpeechProviderPreparedSynthesis as wt, RealtimeVoiceAgentConsultRunner as x, createLocalEmbeddingProvider as xi, upsertAuthProfileWithLock as xn, MemoryEmbeddingBatchOptions as xr, SpeechProviderId as xt, REALTIME_VOICE_AUDIO_FORMAT_G711_ULAW_8KHZ as y, resolveMemorySearchStaleness as yi, resolveEnvApiKey as yn, MemoryCorpusSearchResult as yr, SpeechProviderConfig as yt, RealtimeVoiceToolCallEvent as z, spawnTerminalPty as zi, PreparedModelRuntimeSnapshot as zn, resolveRemoteEmbeddingBearerClient as zr, PluginStateLeaseError as zt };