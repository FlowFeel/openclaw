...
async function runGatewayCommandOnce(opts, hooks = {}) {
	...
	const serverImportMeasurement = startupTrace.startMeasure("cli.server-import", () => import("./server-D4KONp2g.js"));
...
async function runGatewayCommand(opts, hooks = {}, recoveryDeps) {
	try {
		...
		const { offerInvalidConfigRecovery } = await import("./invalid-config-recovery-B88nf0zZ.js");
