...
import { n as resolveMatrixAuth, r as resolveMatrixAuthContext } from "./config-BTkVuYGB.js";
import { t as awaitMatrixStartupWithAbort } from "./startup-abort-DSMiSrz4.js";
//#region extensions/matrix/src/matrix/client/shared.ts
const loadMatrixCreateClientDeps = createLazyRuntimeModule(() => import("./create-client-D18wx2R9.js").then((runtime) => ({ createMatrixClient: runtime.createMatrixClient })));
