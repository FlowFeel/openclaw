...
import { c as shouldUseWizard } from "./shared-BovuSYXk.js";
...
const channelSetupPluginInstallLoader = createLazyImportLoader(() => import("./plugin-install-SqbaCI5Z.js"));
const onboardChannelsLoader = createLazyImportLoader(() => import("./onboard-channels-CmMP81FJ.js"));
...
async function channelsAddCommandImpl(opts, runtime, params) {
	...
	if (shouldUseWizard(params)) {
		const { resolveInitialWizardChannel, runChannelsAddWizardFlow } = await import("./add-wizard-wd1JwhdW.js");
