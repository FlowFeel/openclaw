...
import { r as formatLiteralProviderPrefixedModelRef } from "./model-ref-shared-BEKlpylb.js";
...
import { n as resolveManifestProviderAuthChoice } from "./provider-auth-choices-_vLe6VPC.js";
import { n as openUrl } from "./browser-open-Q4xq7OR_.js";
import { t as isRemoteEnvironment } from "./remote-env-Bb6RhSTD.js";
import { n as t } from "./i18n-BYpJa9f7.js";
import { n as applyProviderAuthConfigPatch, t as applyDefaultModel } from "./provider-auth-choice-helpers-CMYuemdL.js";
import { t as applyAuthProfileConfig } from "./provider-auth-helpers-CpmS5ZvJ.js";
import { r as resolveProviderInstallCatalogEntry } from "./provider-install-catalog-B69Hv4PV.js";
...
async function applyDefaultModelFromAuthChoice(params) {
	...
	if (!preservesDifferentPrimary) {
		const { CODEX_RUNTIME_PLUGIN_ID, ensureCodexRuntimePluginForModelSelection } = await import("./codex-runtime-plugin-install-CgPwwJDr.js");
		...
		const { ensureCopilotRuntimePluginForModelSelection } = await import("./copilot-runtime-plugin-install-C6j5Bnmb.js");
