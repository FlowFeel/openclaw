...
import { f as DEFAULT_BROWSER_LOCAL_CDP_READY_TIMEOUT_MS } from "./constants-BoWgRtg0.js";
import { a as resolveProfile, n as getOwnBrowserProfile, r as resolveBrowserConfig } from "./config-B2k8sZ1m.js";
import { E as BrowserResetUnsupportedError, H as resolveCdpReachabilityTimeouts, L as CHROME_MCP_ATTACH_READY_WINDOW_MS, M as toBrowserErrorResponse, O as BrowserTabNotFoundError, T as BrowserProfileUnavailableError, U as usesFastLoopbackCdpProbeClass, V as PROFILE_ATTACH_RETRY_TIMEOUT_MS, a as fetchJson, b as BROWSER_ERROR_REASONS, k as BrowserTargetAmbiguousError, n as assertCdpEndpointAllowed, o as fetchOk, p as resolveCdpTabOwnership, t as appendCdpPath, u as normalizeCdpHttpBaseForJsonEndpoints, w as BrowserProfileNotFoundError } from "./tmp-openclaw-dir-BK3eq-mf.js";
import "./config-CCqm3Ogf.js";
import "./errors-Cb3-8IJ1.js";
import { A as assertBrowserNavigationAllowed, F as withBrowserNavigationPolicy, L as waitForCdpCommittedNavigationUrl, M as assertBrowserNavigationResultAllowed, P as requiresInspectableBrowserNavigationRedirectsForUrl, R as resolveBrowserNavigationProxyMode, a as isChromeReachable, c as stopOpenClawChrome, d as diagnoseChromeCdp, f as formatChromeCdpDiagnostic, h as createTargetViaCdp, i as isChromeCdpReady, k as InvalidBrowserNavigationUrlError, o as launchOpenClawChrome, r as isChromeCdpOwnedByPid, s as resolveOpenClawUserDataDir, t as ManagedChromeCleanupError, v as normalizeCdpWsUrl } from "./chrome-CObhw6aD.js";
import { a as getOrCreateProfileRuntime, c as isProfileGenerationCurrent, f as registerProfileHandle, g as getPwAiModule, h as getChromeMcpModule, i as enqueueProfileStart, l as isProfileRestartRequiredError, m as withProfileOperationLease, n as assertProfileLifecycleContext, o as getProfileLifecycle, p as releaseProfileHandle, r as beginProfileTransition, s as isBrowserRuntimeRunning, t as ProfileRestartRequiredError, u as isWithinProfileOperationLease } from "./server-context.lifecycle-DGUJZrvY.js";
import { t as getBrowserProfileCapabilities } from "./profile-capabilities-DqO0AgW7.js";
import { n as resolveCdpControlPolicy, r as resolveCdpReachabilityPolicy, t as movePathToTrash } from "./trash-BJi77wmF.js";
import { t as countChromeMcpTabs } from "./chrome-mcp-8Aev-65v.js";
...
function getExtensionRelayModule() {
	modPromise ??= import("./relay-lifecycle-qiypsPZq.js");
	return modPromise;
}
//#endregion
...
function createProfileContext(opts, runtimeState, profileState, profile) {
	...
	const context = {
		...
		isTransportAvailable: async (timeoutMs, callerSignal) => await withLease(callerSignal, async (signal) => await rawAvailability.isTransportAvailable(timeoutMs, signal)),
