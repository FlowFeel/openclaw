...
import { b as resolveConfiguredModelRef, i as buildConfiguredModelCatalog } from "./model-selection-shared-V7VmYFPH.js";
...
import { s as formatFastModeValue } from "./fast-mode-BORk623r.js";
import { t as resolveFastModeState } from "./fast-mode-DRb2pnqM.js";
import { t as collectEnabledInsecureOrDangerousFlagsFromCurrentSnapshot } from "./dangerous-config-flags-current-Bmu2mmnH.js";
...
async function logGatewayStartup(params) {
	...
	const enabledDangerousFlags = collectEnabledInsecureOrDangerousFlagsFromCurrentSnapshot(params.cfg) ?? (await import("./dangerous-config-flags-zmfPn0KX.js")).collectEnabledInsecureOrDangerousFlags(params.cfg);
...
async function collectConfiguredChannelStartupWarnings(params) {
	const [blockerModule, presencePolicyModule] = await Promise.all([import("./channel-plugin-blockers-DuYdZ2MA.js"), import("./channel-presence-policy-WYOK4-Po.js")]);
...
function formatSuppressedAmbientChannelsStartupWarning(channelIds) {
	...
	return `dev gateway suppressed ambient channel auto-configuration for ${safeChannelIds.length} ${safeChannelIds.length === 1 ? "channel" : "channels"}: ${safeChannelIds.join(", ")}. Use --dev-ambient-channels to re-enable ambient channel triggers.`;
}
