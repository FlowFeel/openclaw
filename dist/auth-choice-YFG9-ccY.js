...
import { n as resolveManifestProviderAuthChoice, t as resolveManifestDeprecatedProviderAuthChoice } from "./provider-auth-choices-t9Huvqjl.js";
import { t as applyAutoLocalModelLean } from "./local-model-lean-auto-DK4EDa6q.js";
import { r as resolveProviderInstallCatalogEntry, t as resolveDeprecatedProviderInstallCatalogEntry } from "./provider-install-catalog-BNM2sDYU.js";
import { a as normalizeSecretInputModeInput } from "./provider-auth-input-DNzGlXUB.js";
import { r as formatAuthChoiceChoicesForCli } from "./auth-choice-options-DntxAwYM.js";
import { i as resolveDeprecatedAuthChoiceReplacement, n as isDeprecatedAuthChoice, t as formatDeprecatedNonInteractiveAuthChoiceError } from "./auth-choice-legacy-CfBx4PYl.js";
import { t as resolvePreferredProviderForAuthChoice } from "./provider-auth-choice-preference-D5QuahNY.js";
import { t as normalizeApiKeyTokenProviderAuthChoice } from "./auth-choice.apply.api-providers-BIg9_Ofa.js";
import { n as ensureCodexRuntimePluginForModelSelection, t as CODEX_RUNTIME_PLUGIN_ID } from "./codex-runtime-plugin-install-BMBJiqXG.js";
...
import { t as ensureCopilotRuntimePluginForModelSelection } from "./copilot-runtime-plugin-install-DFFOrSOD.js";
...
async function applyNonInteractivePluginProviderChoice(params) {
	...
	if (!providerChoice) {
		...
		const { ensureOnboardingPluginInstalled } = await import("./onboarding-plugin-install-CpSdijTa.js");
	...
	if (codexInstall.installed) {
		const { offerPostInstallMigrations } = await import("./setup.post-install-migration-Co2txohY.js");
