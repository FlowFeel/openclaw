...
import { f as isSameSsrFPolicy } from "./ssrf-CLKoEH8E.js";
...
import { C as MAX_WORKSPACE_BOOTSTRAP_FILE_BYTES, c as DEFAULT_USER_FILENAME, i as DEFAULT_IDENTITY_FILENAME, n as DEFAULT_BOOTSTRAP_FILENAME, o as DEFAULT_SOUL_FILENAME, p as ensureAgentWorkspace, t as DEFAULT_AGENTS_FILENAME, w as readWorkspaceBootstrapFile } from "./workspace-aPJlJwqC.js";
import { C as SANDBOX_DOCKER_CREATE_ARGS_EPOCH, b as SANDBOX_BROWSER_SECURITY_HASH_EPOCH, g as SANDBOX_AGENT_WORKSPACE_MOUNT, v as SANDBOX_BROWSER_IMAGE_CONTRACT_EPOCH } from "./constants-BdVrBvbE.js";
import { n as isToolAllowed } from "./tool-policy-pa3CWGnu.js";
import { i as resolveSandboxConfigForAgent, r as resolveSandboxBrowserDockerCreateConfig } from "./config-2sq8RTeT.js";
...
import { n as toSandboxProvisioningError } from "./provisioning-error-DCaK9ITE.js";
import { c as resolveReadOnlyWorkspaceSkillMounts, i as formatReadOnlyWorkspaceSkillMountHashState, n as appendWorkspaceMountArgs, r as filterBindsConflictingWithProtectedMounts, s as resolveProtectedSkillMountContainerPaths, t as appendReadOnlyWorkspaceSkillMountArgs } from "./workspace-mounts-DEtZw7ZS.js";
import { a as DEFAULT_OPENCLAW_BROWSER_COLOR, d as ensureBrowserControlAuth, f as resolveBrowserControlAuth, l as resolveBrowserConfig, n as DEFAULT_BROWSER_ACTION_TIMEOUT_MS, s as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, u as resolveProfile } from "./browser-profiles-0NWnittd.js";
import { C as updateRegistry, S as updateBrowserRegistry, _ as readBrowserRegistry, f as readDockerContainerEnvVar, l as formatDockerDaemonUnavailableError, m as readDockerPort, p as readDockerContainerLabel, r as dockerContainerState, s as execDocker, t as buildSandboxCreateArgs, u as isDockerDaemonUnavailable, v as readRegisteredSandboxRuntimeIds } from "./docker--me2nKT1.js";
import { a as computeSandboxBrowserConfigHash, t as resolveDockerEnvPolicyEpoch } from "./sanitize-env-vars-z2ZDf5HE.js";
import { i as slugifySessionKey, n as resolveSandboxAgentId, r as resolveSandboxWorkspaceLayoutPaths, t as buildSandboxContainerName } from "./shared-CZuUk5jS.js";
import { n as validateNetworkMode } from "./validate-sandbox-security-D5Xq1Mhk.js";
import { A as buildPinnedMkdirpPlan, C as parseSandboxStatMtimeMs, F as runDockerSandboxShellCommand, M as buildPinnedRenamePlan, N as buildPinnedWritePlan, O as buildPinnedCopyPlan, i as startBrowserBridgeServer, j as buildPinnedRemovePlan, k as buildPinnedCreatePlan, l as requireSandboxBackendFactory, n as stopCachedBrowserBridge, r as stopCachedBrowserBridgesForContainer, s as getSandboxBackendWorkdirResolver, t as BROWSER_BRIDGES, w as parseSandboxStatSize, x as assertSshSandboxSecretOwnerAvailable } from "./browser-bridges-C_6A9P9l.js";
...
async function syncSandboxSkillsToWorkspace(params) {
	try {
		const [{ syncSkillsToWorkspace }, { getRemoteSkillEligibility }, { resolveNodeExecEligibility }] = await Promise.all([
			import("./workspace-CeLD32YI.js"),
			import("./remote-C8LIJzXv.js"),
			import("./exec-defaults-B34sIRCt.js")
		]);
...
async function resolveProvisionedSandboxContext(params, resolved) {
	...
	if (cfg.prune.idleHours !== 0 || cfg.prune.maxAgeDays !== 0) await (await import("./prune-Dua7cgRr.js")).maybePruneSandboxes(cfg);
