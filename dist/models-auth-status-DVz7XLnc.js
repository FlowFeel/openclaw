...
import { c as hasConfiguredSecretInput, s as coerceSecretRef } from "./types.secrets-BvApkFoj.js";
...
import { c as isNonSecretApiKeyMarker, g as resolveProviderEnvAuthLookupMaps, h as listProviderEnvAuthLookupKeys, s as isKnownEnvApiKeyMarker } from "./model-auth-markers-z4js65k2.js";
import { a as errorShape } from "./error-codes-P4fBo0lR.js";
import { h as resolvePersistedAuthProfileOwnerAgentDir, i as ensureAuthProfileStore, o as ensureAuthProfileStoreWithoutExternalProfiles, r as clearRuntimeAuthProfileStoreSnapshots } from "./store-BWT5kQzj.js";
import { r as resolveProviderEnvAuthEvidence } from "./model-auth-env-Dh-g1B4g.js";
import "./auth-profiles-67bIpdG9.js";
import { t as externalCliDiscoveryForConfigStatus } from "./external-cli-discovery-WL3vnn14.js";
import { i as removeAuthProfilesAcrossOwnerStores, o as removeProviderAuthProfilesWithLock } from "./profiles-Hfbx6aWI.js";
import { b as resolveProviderEntryApiKeyProfileReference, x as resolveUsableCustomProviderApiKey } from "./model-auth-provider-config-Bf2cufz8.js";
...
import { n as abortChatRunsForProvider } from "./chat-abort-B1M0lO2h.js";
...
import { n as buildAuthHealthSummary, r as formatRemainingShort } from "./auth-health-BEWZFCoK.js";
import { i as readProviderUsageStaleWhileRevalidate, n as fingerprintProviderUsageCredentials, t as clearModelAuthStatusUsageCache } from "./models-auth-status-usage-cache-Bb5hdknb.js";
import { d as refreshActiveProviderAuthRuntimeSnapshot } from "./runtime-0siwdHit.js";
import { n as unknownModelAuthAgentIdError, t as resolveModelAuthAgentScope } from "./model-auth-agent-scope-D4yQtrG5.js";
...
const modelsAuthStatusHandlers = {
	"models.authLogout": async ({ params, respond, context }) => {
		...
		try {
			...
			if (!scope.ok) {
				respond(false, void 0, unknownModelAuthAgentIdError(scope.agentId));
				return;
			}
