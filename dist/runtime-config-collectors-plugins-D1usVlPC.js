...
import { c as normalizePluginsConfig, d as resolveEnableState } from "./config-state-DrPZVhOu.js";
...
import { n as collectRuntimeSecretInputAssignment } from "./runtime-shared-Br87CeOH.js";
...
function collectPluginConfigAssignments(params) {
	...
	const workspaceDir = resolveAgentWorkspaceDir(params.config, resolveDefaultAgentId(params.config), params.context.env);
