...
import { B as finalizeToolTerminalPresentation, J as consumePreExecutionBlockedToolCall, h as runBeforeToolCallHook, q as consumeAdjustedParamsForToolCall, r as getBeforeToolCallFailureDisposition, u as wrapToolWithBeforeToolCallHook } from "./agent-tools.before-tool-call-uaLOAHZ3.js";
import { c as resolveToolExecutionErrorKind, l as resolveToolResultFailureKind, n as isToolResultError, t as formatToolExecutionErrorMessage } from "./tool-result-error-BI56-yEJ.js";
import { s as getMediaDir, u as saveMediaBuffer } from "./store-QVlUiM0_.js";
import { o as resolveModelAuthMode } from "./model-auth-yfB4tyNY.js";
import { n as isToolAllowed } from "./tool-policy-pa3CWGnu.js";
...
import { b as isToolWrappedWithBeforeToolCallHook, m as getChannelAgentToolMeta, t as callGatewayTool, x as setBeforeToolCallDiagnosticsEnabled } from "./gateway-B5H4NIb8.js";
...
import { a as isMessagingToolSendAction, r as isMessagingTool } from "./embedded-agent-messaging-Bc7tsqQd.js";
import { a as extractMessagingToolSend, f as filterToolResultMediaUrls, h as sanitizeToolResult, o as extractMessagingToolSendResult, u as extractToolResultMediaArtifact } from "./embedded-agent-subscribe.tools-agHp_6fR.js";
...
import { t as runAgentHarnessAfterToolCallHook } from "./hook-helpers-DbM1YFe0.js";
import { n as normalizeAgentRuntimeTools } from "./tools-BKYdulJW.js";
...
import { i as buildEmbeddedAttemptToolRunContext } from "./settled-turn-finalization-result-BmhJQmHW.js";
...
import { f as createCodexAppServerToolResultExtensionRunner } from "./agent-harness-runtime-C7IQ1WOo.js";
import { a as resolveNativeHookRelayDeferredToolApproval, n as invokeNativeHookRelay, r as registerNativeHookRelay, t as hasNativeHookRelayInvocation } from "./native-hook-relay-B0cZfToQ.js";
...
import { P as readCodexPluginConfig } from "./session-binding-Boew56yn.js";
import { L as resolveCodexGatewayTimeoutWithGraceMs, at as isJsonObject, d as releaseLeasedSharedCodexAppServerClient, rt as CODEX_OPENCLAW_DIRECT_DYNAMIC_TOOL_NAMESPACE } from "./shared-client-CDGOYFn5.js";
import { E as itemStatus, F as readItem, H as readString$2, _ as readCodexNotificationTurnId, b as auditNativeToolUnfinishedStatus, g as readCodexNotificationThreadId, v as auditNativeToolName, y as auditNativeToolTerminalStatus } from "./thread-resume-DATryQ9G.js";
import { l as readCodexTurn } from "./protocol-validators-Cf6MSlge.js";
import { D as isSystemAgentOnlyCodexDynamicToolAllowlist, E as isForcedPrivateQaCodexRuntime, O as normalizeCodexDynamicToolName, T as filterCodexDynamicToolsWithOpenClawShell, h as resolveCodexWebSearchPlan, i as invalidInlineImageText, o as sanitizeInlineImageDataUrl, w as filterCodexDynamicTools } from "./thread-lifecycle-BuENMZSU.js";
import { r as formatCodexDisplayText } from "./command-formatters-yohVCsto.js";
import { a as resolveCodexNodeExecToolOverrides, i as resolveCodexNativeExecutionPolicy } from "./sandbox-guard-COeyCqXZ.js";
