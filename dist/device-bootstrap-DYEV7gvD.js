...
function resolveBootstrapProfileScopesForRole(role, scopes, purpose) {
	...
	if (normalizedRole === "operator") {
		const allowedScopes = purpose === "mobile-full" ? MOBILE_FULL_ACCESS_OPERATOR_SCOPE_SET : purpose === "voice-node" ? VOICE_NODE_OPERATOR_SCOPE_SET : BOOTSTRAP_HANDOFF_OPERATOR_SCOPE_SET;
...
function normalizeDeviceBootstrapProfile(input) {
	const purpose = input?.purpose === "control-ui" || input?.purpose === "mobile-full" || input?.purpose === "voice-node" ? input.purpose : void 0;
	return {
...
//#endregion
export { loadPairedDevicePairingStoreRecord as A, isVoiceNodePairingSetupBootstrapProfile as C, resolveDeviceProfileRoleScopes as D, resolveBootstrapProfileScopesForRoles as E, nextApnsRegistrationVersion as F, persistDevicePairingStoreState as M, updatePairedDeviceNodeSurfaceInTransaction as N, resolveDeviceProfileScopes as O, updatePairedDevicePresenceInTransaction as P, isNodePairingSetupBootstrapProfile as S, resolveBootstrapProfileScopesForRole as T, NODE_PAIRING_SETUP_BOOTSTRAP_PROFILE as _, redeemDeviceBootstrapTokenProfile as a, deviceBootstrapProfilesEqual as b, revokeDeviceBootstrapTokensForDevice as c, verifyPairingToken as d, coercePairingStateRecord as f, FULL_ACCESS_PAIRING_SETUP_BOOTSTRAP_PROFILE as g, BOOTSTRAP_HANDOFF_OPERATOR_SCOPES as h, issueDeviceBootstrapToken as i, loadPairedDevicePairingStoreRecordFromDatabase as j, loadDevicePairingStoreState as k, verifyDeviceBootstrapToken as l, resolvePairingPaths as m, getBoundDeviceBootstrapProfile as n, restoreDeviceBootstrapToken as o, pruneExpiredPending as p, getDeviceBootstrapTokenProfile as r, revokeDeviceBootstrapToken as s, clearDeviceBootstrapTokens as t, generatePairingToken as u, PAIRING_SETUP_BOOTSTRAP_PROFILE as v, normalizeDeviceBootstrapProfile as w, isMobilePairingSetupBootstrapProfile as x, VOICE_NODE_PAIRING_SETUP_BOOTSTRAP_PROFILE as y };
