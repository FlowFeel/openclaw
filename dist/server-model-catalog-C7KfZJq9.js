...
async function resolveLoader(params) {
	...
	const { loadPublishedPreparedModelCatalogOwnerSnapshot } = await import("./prepared-model-catalog-BddDieHg.js");
	return loadPublishedPreparedModelCatalogOwnerSnapshot;
}
async function resetPreparedModelCatalogForTest() {
	const [{ resetPreparedModelRuntimeSnapshotsForTest }, { resetModelCatalogBuilderCacheForTest }] = await Promise.all([import("./prepared-model-runtime.test-support-BYyBntIt.js"), import("./model-catalog-U0thN6yI.js")]);
...
async function readPreparedGatewayModelCatalog(params) {
	const { getPreparedModelCatalogSnapshot } = await import("./prepared-model-catalog-BddDieHg.js");
