...
import { i as isMalformedApiKeyInput } from "./credential-state-oLRZBnMF.js";
...
import { n as promptSecretRefForSetup, r as resolveRefFallbackInput, t as extractEnvVarFromSourceLabel } from "./provider-auth-ref-Dt9IR8nq.js";
...
async function ensureApiKeyFromEnvOrPrompt(params) {
	...
	const envKey = resolveEnvApiKey(params.provider, env, {
		config: params.config,
		workspaceDir: resolveAgentWorkspaceDir(params.config, resolveDefaultAgentId(params.config), env)
	});
	if (selectedMode === "ref") {
