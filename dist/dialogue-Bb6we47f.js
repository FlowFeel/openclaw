...
import { a as parseSystemAgentOperation, n as describeSystemAgentPersistentOperation } from "./operations-DStBH-DH.js";
...
async function resolveSystemAgentOperation(input, runtime, opts) {
	...
	const planner = opts.planWithAssistant ?? (await import("./assistant-C4rAHJQH.js")).planSystemAgentCommand;
	let plan;
	try {
		plan = await planner({
			input,
