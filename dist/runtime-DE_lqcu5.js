...
import { i as getChildLogger, s as isFileLogLevelEnabled } from "./logger-Cv9z4NYi.js";
...
import { c as resolveThinkingProfile } from "./thinking-CTxMHCzD.js";
import { C as resolveModelRefFromString, a as buildModelAliasIndex, i as buildConfiguredModelCatalog } from "./model-selection-shared-V7VmYFPH.js";
import { _ as resolveToolProfilePolicy, c as mergeAlsoAllowPolicy, h as normalizeToolName, p as expandToolGroups } from "./tool-policy-CrjVfI-s.js";
...
import { n as detectMime } from "./mime-Ir6g3Vae.js";
import { l as resolveStorePath } from "./paths-DSnYpBD3.js";
import { G as rollbackSqlitePluginOwnedSessionEntryLifecycle, H as deleteSqliteSessionEntryLifecycle, W as rollbackSqliteAgentHarnessSessionEntryLifecycle, ct as loadSqliteSessionEntryReadOnly, lt as patchSqliteSessionEntry, nt as listSqliteSessionEntriesReadOnly, pt as replaceSqliteSessionEntry } from "./session-accessor.sqlite-CtCo5VZ6.js";
import { W as normalizeResolvedMaintenanceConfigInput, bt as isSessionWorkAdmissionActive, ut as beginSessionWorkAdmission, xt as runExclusiveSessionLifecycleMutation } from "./session-entry-slot-keys-DPRQmSpa.js";
import { r as onSessionTranscriptUpdate } from "./transcript-events-BG9Ai61T.js";
import { $ as listSessionEntries$1, K as updateSessionEntry } from "./session-accessor-D5Or7WgI.js";
import "./logging-Bw0qwOSE.js";
import { c as getImageMetadata, p as resizeToJpeg } from "./image-ops-BtojRCsZ.js";
...
import { J as failFlow, O as listTasksForFlowId, W as createManagedTaskFlow, X as finishFlow, at as setFlowWaiting, it as resumeFlow, nt as requestFlowCancel } from "./task-registry-Bs8cA6Tm.js";
import "./runtime-internal-grPJIfa5.js";
import { _ as findLatestTaskFlowForOwner, b as resolveTaskFlowForLookupTokenForOwner, d as getFlowTaskSummary, m as runTaskInFlowForOwner, r as cancelFlowByIdForOwner, t as cancelDetachedTaskRunById, v as getTaskFlowByIdForOwner, y as listTaskFlowsForOwner } from "./task-executor-verbdzU7.js";
...
import { a as resolveEffectiveAgentRuntime, t as concretizeAgentRuntime } from "./thinking-runtime-Ct74CGZn.js";
import { a as resolveInheritedToolPolicyForSession, o as resolveSubagentToolPolicyForSession, r as resolveEffectiveToolPolicy } from "./agent-tools.policy-7CMM1SfU.js";
import { z as normalizeExecTarget } from "./exec-approvals-sCmCk_jQ.js";
import { n as loadWebMedia } from "./web-media-DG7t3WQ-.js";
import { c as listRuntimeMusicGenerationProviders, s as generateMusic } from "./openclaw-tools-B_OHwLQN.js";
import { a as getTaskByIdForOwner, o as listTasksForRelatedSessionKeyForOwner, r as findLatestTaskForRelatedSessionKeyForOwner, s as resolveTaskForLookupTokenForOwner } from "./task-owner-access-CUw2DXVh.js";
import { o as resolveEffectiveSessionToolsVisibility } from "./session-visibility-BYkMOIPw.js";
import { n as listRuntimeImageGenerationProviders, t as generateImage } from "./runtime-DuMGz2My.js";
import { n as resolveAgentIdentity } from "./identity-DxC7SNFJ.js";
import { n as listRuntimeVideoGenerationProviders, t as generateVideo } from "./runtime-DHkm_a9L.js";
import { i as listWebSearchProviders, o as runWebSearch } from "./runtime-M43seitm.js";
import { t as resolveEmbeddedCliBackendDispatchEligibility } from "./cli-backend-dispatch-eligibility-TPBQ8QJ-.js";
import { t as RequestScopedSubagentRuntimeError } from "./error-runtime-Dbl9_3mW.js";
import { t as createRuntimeChannel } from "./runtime-channel-DizlR3PB.js";
...
function getSessionEntry(params) {
	return loadSqliteSessionEntryReadOnly(toSessionAccessScope(params));
}
function listSessionEntries(params = {}) {
	return (params.readOnly ? listSqliteSessionEntriesReadOnly : listSessionEntries$1)({
		...params.agentId !== void 0 ? { agentId: params.agentId } : {},
		...params.env !== void 0 ? { env: params.env } : {},
		...params.hydrateSkillPromptRefs !== void 0 ? { hydrateSkillPromptRefs: params.hydrateSkillPromptRefs } : {},
		...params.storePath !== void 0 ? { storePath: params.storePath } : {}
...
async function patchSessionEntry(params) {
	return await patchSqliteSessionEntry(toSessionAccessScope(params), params.update, {
...
async function upsertSessionEntry(params) {
	await replaceSqliteSessionEntry(toSessionAccessScope(params), params.entry);
}
async function createSessionEntry(params) {
	const [{ createGatewaySession }, { resolveGatewaySessionStoreTarget }, { readAcpSessionMetaForEntry, upsertAcpSessionMeta }] = await Promise.all([
		import("./session-create-service-CigMznkt.js"),
		import("./session-utils-iuUDrQnK.js"),
		import("./session-meta-BLqLLHJS.js")
	]);
		...
		run: async () => {
			...
			try {
				...
				if (initializesAfterCreate) {
					...
					const finalized = await patchSqliteSessionEntry({
				...
				try {
					...
					if (!(expectedEntry.modelSelectionLocked === true ? expectedEntry.agentHarnessId ? await rollbackSqliteAgentHarnessSessionEntryLifecycle(rollbackParams) : await rollbackSqlitePluginOwnedSessionEntryLifecycle({
						...rollbackParams,
						expectedPluginOwnerId: pluginInitial?.pluginOwnerId ?? ""
					}) : await deleteSqliteSessionEntryLifecycle(rollbackParams)).deleted) throw new Error(`created session ${callbackContext.key} changed before rollback`, { cause: error });
...
const runHeartbeatOnceInternal = createLazyRuntimeMethod(createLazyRuntimeModule(() => import("./heartbeat-runner-CyAMR2Lk.js")), (runtime) => runtime.runHeartbeatOnce);
...
const loadTtsRequestRuntime = createLazyRuntimeModule(() => import("./runtime-tts-request-Cbv2ODx9.js"));
const loadMediaUnderstandingRuntime = createLazyRuntimeModule(() => import("./runtime-B4sBNvcQ.js"));
const loadModelAuthRuntime = createLazyRuntimeModule(() => import("./runtime-model-auth.runtime.js"));
const loadGatewayPluginRuntime = createLazyRuntimeModule(() => import("./server-plugins-B_vHSqf2.js"));
...
function createRuntimeLlmFacade() {
	const loadAcquireLocalService = createLazyRuntimeMethod(() => import("./provider-local-service-DnaoCFrY.js"), (runtime) => runtime.createConfiguredProviderLocalServiceAcquirer(getRuntimeConfig));
...
function createRuntimeWorktrees() {
	const loadService = () => import("./service-109IUYPJ.js");
	return {
		async resolveCheckoutRoot(params) {
			const { findGitCheckoutRoot } = await import("./git-DOeLwfAJ.js");
			return findGitCheckoutRoot(params.path) ?? void 0;
		},
		async hasSelfContainedCheckoutMetadata(params) {
			const { hasSelfContainedGitMetadata } = await import("./git-DOeLwfAJ.js");
...
function createRuntimeSandbox(agent) {
	...
	return {
		...
		async prepareWorkspaceAuthority(params) {
			...
			const { resolveSandboxContext } = await import("./context-DBd1aA-m.js");
