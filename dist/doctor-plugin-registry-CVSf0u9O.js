...
import { a as resolveDefaultPluginNpmDir, r as resolveDefaultPluginExtensionsDir } from "./install-paths-D18EkQi8.js";
import { l as clearLoadInstalledPluginIndexInstallRecordsCache, n as loadInstalledPluginIndexInstallRecords, t as listRecoveredManagedNpmInstallCandidates } from "./installed-plugin-index-record-reader-DA9P0iII.js";
import { i as markRetainedManagedNpmInstall, l as listManagedPluginNpmRootsSync, r as hasRetainedManagedNpmInstallMarker } from "./managed-npm-retention-BDxTqE3b.js";
import { r as loadInstalledPluginIndex } from "./installed-plugin-index-DXmBG059.js";
import { o as refreshPluginRegistry } from "./plugin-registry-snapshot-z4cuS8rL.js";
import "./plugin-registry-6MbhJA7X.js";
import "./installed-plugin-index-records-BkPV4HdU.js";
import { n as saveJsonFile } from "./json-file-vo1Xldgv.js";
import { n as preflightPluginRegistryInstallMigration, t as migratePluginRegistryForInstall } from "./plugin-registry-migration-DNIBSGNi.js";
import { t as note } from "./note-uiKX_qfX.js";
import { a as reconcileRegisteredOpenClawHostLinks, n as auditOpenClawPeerDependenciesInManagedNpmRoot, o as relinkOpenClawPeerDependenciesInManagedNpmRoot } from "./plugin-peer-link-DXF9ykyQ.js";
import { t as listStaleLocalBundledPluginInstallRecords } from "./stale-local-bundled-plugin-install-records-BHYDxQG8.js";
...
async function listPluginOpenClawHostLinkIssues(params) {
	...
	const audits = await Promise.all(listManagedPluginNpmRoots(params).map((npmRoot) => auditOpenClawPeerDependenciesInManagedNpmRoot({
		npmRoot,
...
async function maybeRepairPluginOpenClawHostLinks(params) {
	...
	const registeredRepair = await reconcileRegisteredOpenClawHostLinks({
		...
		logger,
		onPackageReadError: (error, packageDir) => {
			logger.warn(`Could not inspect registered npm package ${shortenHomePath(packageDir)}: ${formatPackageReadFailure(error)}`);
		}
	});
...
async function maybeRepairPluginRegistryState(params) {
	...
	if (preflight.action === "skip-existing" || removedStaleManagedNpmBundledPlugins || removedStaleLocalBundledPluginIds.length > 0 || retiredStaleManagedNpmInstallGenerations || repairedPluginOpenClawHostLinks) {
...
//#endregion
export { pluginRegistryIssueToRepairEffect as a, pluginRegistryIssueToHealthFinding as i, maybeRepairPluginRegistryState as n, maybeRepairPluginOpenClawHostLinks as o, maybeRepairStaleManagedNpmBundledPlugins as r, detectPluginRegistryHealthIssues as t };
