...
async function loadAgentCliCommand() {
	return (await import("./agent-via-gateway-DcAt0HvJ.js")).agentCliCommand;
}
async function loadAgentExecCommand() {
	return (await import("./agent-exec-CJ2xQ28z.js")).agentExecCommand;
}
...
async function loadRunCommandWithRuntime() {
	return (await import("./cli-utils-De1Y8OZt.js")).runCommandWithRuntime;
}
