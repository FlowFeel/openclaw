...
import "./constants-BoWgRtg0.js";
import { l as resolveBrowserActRequestTimeoutMs } from "./act-policy-9AEfR1NQ.js";
import "./sdk-config-BpxJerJD.js";
import { c as DEFAULT_UPLOAD_DIR, l as resolveExistingUploadPaths, r as resolveBrowserConfig } from "./config-DrBFz_Sl.js";
import { Y as withTimeout, j as parseBrowserErrorPayload } from "./tmp-openclaw-dir-Ci2i7GZs.js";
import "./control-auth-RdXFzw-S.js";
import "./chrome.executables-B2udiA_j.js";
import "./trash-DHGVMgVj.js";
import { o as loadBrowserConfigForRuntimeRefresh } from "./server-context-DbSJ5QHS.js";
import "./sdk-setup-tools-BRa8kP0s.js";
import { C as fetchBrowserJson, D as withBaseUrl, E as buildProfileQuery, T as setBridgeAuthForPort, w as deleteBridgeAuthForPort } from "./session-tab-registry-B1NUOYG-.js";
import "./routes-BDQes0bG.js";
import { i as listenBrowserHttpServer, n as installBrowserAuthMiddleware, r as installBrowserCommonMiddleware, t as hasVerifiedBrowserAuth } from "./server-middleware-OMZmTZMZ.js";
import { c as stopBrowserBridgeRuntime, n as createBrowserControlContext } from "./plugin-enabled-Uq8hpi8K.js";
import { a as resolveRequestedBrowserProfile, i as normalizeBrowserRequestPath, n as isBrowserHostLocalRoute, r as isPersistentBrowserProfileMutation, t as createBrowserRouteDispatcher } from "./dispatcher-Cw7kQe8B.js";
import "./snapshot-urls-XEHa-0UE.js";
...
async function browserPageContent(baseUrl, opts) {
	return await fetchBrowserJson(withBaseUrl(baseUrl, `/extract${buildProfileQuery(opts.profile)}`), {
		method: "POST",
		headers: { "Content-Type": "application/json" },
		body: JSON.stringify({
			targetId: opts.targetId,
...
async function startBrowserBridgeServer(params) {
	...
	if (params.skipRouteRegistrationForTest) app.get("/", (_req, res) => {
		...
		const [{ createBrowserRouteContext }, { registerBrowserRoutes }] = await Promise.all([import("./server-context-ibxpRTh0.js"), import("./routes-Cavz29sS.js")]);
...
function isWsBackedBrowserProxyPath(path) {
	return path === "/act" || path === "/download" || path === "/extract" || path === "/navigate" || path === "/pdf" || path === "/screenshot" || path === "/snapshot" || path === "/wait/download";
}
...
//#endregion
export { isBrowserProxyUploadRequest as _, persistBrowserProxyFiles as a, parseBrowserProxyFailure as b, browserPdfSave as c, browserArmFileChooser as d, browserDownload as f, ensureBrowserProxyUploadCleanup as g, browserWaitForDownload as h, applyBrowserProxyPaths as i, browserAct as l, browserScreenshotAction as m, startBrowserBridgeServer as n, browserConsoleMessages as o, browserNavigate as p, stopBrowserBridgeServer as r, browserPageContent as s, runBrowserProxyCommand as t, browserArmDialog as u, prepareBrowserProxyUploadRequest as v, BROWSER_PROXY_ERROR_ENVELOPE as y };
