import { t as collectErrorGraphCandidates } from "./errors-D-7D3ZtF.js";
import { c as registerUnhandledRejectionHandler } from "./unhandled-rejections-5K00oho9.js";
...
import { r as resolveBrowserConfig } from "./config-Da5ffEih.js";
import { T as BrowserProfileUnavailableError } from "./tmp-openclaw-dir-DQI4fBxj.js";
import "./config-ImwtK-_l.js";
import { d as markBrowserRuntimeStopping, r as beginProfileTransition, s as isBrowserRuntimeRunning } from "./server-context.lifecycle-DZszx9yY.js";
import { a as getExtensionRelayModule, t as createBrowserRouteContext } from "./server-context-DCzVcpAM.js";
import { n as sweepTrackedBrowserTabs } from "./session-tab-registry-DzvuLxVk.js";
...
async function stopBrowserRuntimeInternal(params, finalizeGlobalAdapters) {
	...
	if (finalizeGlobalAdapters) try {
		const { disposeGatewayExtensionRelay } = await import("./gateway-relay-route-DfHykOAs.js");
