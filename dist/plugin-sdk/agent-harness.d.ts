import { o as ModelCompatConfig, r as OpenClawConfig } from "../types.openclaw-C7iFpWwX.js";
import { N as ChatType } from "../types.base-BYV-OxM1.js";
import { a as AgentToolUpdateCallback, i as AgentToolResult } from "../index-B4PKL_IC.js";
import { v as SourceReplyDeliveryMode } from "../types-CEcJgDdy.js";
import { E as InputProvenance, O as PluginHookChannelContext, h as TaskSuggestionDeliveryMode, j as InboundEventKind } from "../templating-B4o_FX7q.js";
import { D as AuthProfileStore } from "../types-b2oqVK5U.js";
import { n as AnyAgentTool } from "../common-DuX6Q50t.js";
import { B as ExecToolDefaults, Ds as ScheduledToolPolicyContext, Fn as AgentToolResultMiddlewareEvent, Nn as AgentToolResultMiddleware, Os as TrustedSubagentCompletionHandoff, Si as AgentHarness, V as ModelAuthMode, a as DelegationCapability, es as ProcessToolDefaults, qr as ConversationRecallContext, vs as SkillWorkshopRunOptions, wt as PreparedModelRuntimeSnapshot, y as ToolOutcomeObserver, zn as OpenClawAgentToolResult } from "../types-CVuq6K6F.js";
import { _ as SystemAgentOperation } from "../types-DCanIKq0.js";
import { a as SkillUsagePath, r as SkillSnapshot } from "../types-Bef8ClZo2.js";
import { An as SandboxContext, B as createCodexAppServerToolResultExtensionRunner, ct as disposeRegisteredAgentHarnesses, jn as SandboxToolPolicy, kn as ResolvedConversationCapabilityProfile, lt as PluginToolMcpMeta, pt as OpenClawCodingToolConstructionPlan, r as EmbeddedRunAttemptParams, z as createAgentToolResultMiddlewareRunner } from "../agent-harness-runtime-D7kMvoSk.js";
import { t as DiagnosticTraceContext } from "../diagnostic-trace-context-c5mRZYEt.js";
import { r as ToolDefinition } from "../model-catalog-bRc3XIBo.js";
import { c as abortAndDrainEmbeddedAgentRun, l as abortEmbeddedAgentRun, p as resolveActiveEmbeddedRunSessionId } from "../preemptive-compaction-E2UHSXQS.js";
