...
import { $ as TALK_EVENT_TYPES, A as RealtimeVoiceBrowserSessionCreateRequest, B as RealtimeVoiceToolResultOptions, C as RealtimeVoiceAudioFormat, D as RealtimeVoiceBridgeCreateRequest, E as RealtimeVoiceBridgeCallbacks, F as RealtimeVoiceProviderId, I as RealtimeVoiceProviderResolveConfigContext, L as RealtimeVoiceRole, M as RealtimeVoiceProviderCapabilities, N as RealtimeVoiceProviderConfig, O as RealtimeVoiceBridgeEvent, P as RealtimeVoiceProviderConfiguredContext, Q as DiagnosticEventInput, R as RealtimeVoiceTool, S as RealtimeVoiceAudioClearReason, T as RealtimeVoiceBridge, at as TalkEventType, b as REALTIME_VOICE_AUDIO_FORMAT_PCM16_24KHZ, ct as createTalkEventSequencer, et as TalkBrain, g as RealtimeVoiceProviderPlugin, it as TalkEventSequencer, j as RealtimeVoiceCloseReason, k as RealtimeVoiceBrowserSession, lt as PluginRuntimeCore, nt as TalkEventContext, ot as TalkMode, rt as TalkEventInput, sn as RunEmbeddedAgentParams, st as TalkTransport, tt as TalkEvent, ut as RuntimeLogger, w as RealtimeVoiceBargeInOptions, x as RealtimeVoiceAgentConsultRunner, y as REALTIME_VOICE_AUDIO_FORMAT_G711_ULAW_8KHZ, z as RealtimeVoiceToolCallEvent } from "../types-DdUyjaEr.js";
import { t as EmbeddedAgentQueueMessageOutcome } from "../runs-BmkwjmXu.js";
...
declare function consultRealtimeVoiceAgent(params: {
  ...
  questionSourceLabel?: string;
  agentId?: string;
  spawnedBy?: string | null; /** Sender identity established by the caller's ingress authorization boundary. */
  senderId?: string | null; /** Trusted owner bit established by the caller's ingress authorization boundary. */
...
type ResolveConfiguredRealtimeVoiceProviderParams = {
  ...
  cfgForResolve?: OpenClawConfig; /** Agent whose browser-session auth store should be inspected. */
  agentId?: string; /** Test/runtime override for the provider list. */
  providers?: RealtimeVoiceProviderPlugin[]; /** Model injected before provider-specific resolveConfig runs. */
  defaultModel?: string; /** Runtime surface being selected. Defaults to the provider bridge path. */
...
declare function createRealtimeVoiceAudioQueue(overflowPolicy: RealtimeVoiceAudioOverflowPolicy): RealtimeVoiceAudioQueue;
