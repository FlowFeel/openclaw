import { n as OpenClawConfig, pt as AgentModelEntryConfig } from "../types.openclaw-ymL1Xg7f.js";
...
declare function createAliasOnlyPresetAppliers(params: {
  modelRef: string;
  alias: string;
