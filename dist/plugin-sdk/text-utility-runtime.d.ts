import { t as BaseProbeResult } from "../types.core-Ckny0mU6.js";
...
declare function resolveLiveToolResultMaxChars(params: {
  contextWindowTokens: number; /** Config override from agents.defaults.contextLimits.maxResultChars. When set, replaces the auto-derived cap. */
