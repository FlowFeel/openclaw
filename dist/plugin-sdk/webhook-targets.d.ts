import { Jn as PluginRegistry } from "../types-fxGJj6Ov.js";
import { t as PluginHttpRouteRegistration } from "../registry-B652OOW2.js";
...
//#endregion
export { RegisterWebhookPluginRouteOptions, RegisterWebhookTargetOptions, RegisteredWebhookTarget, WebhookTargetMatchResult, canonicalizeWebhookRouteKey, normalizeWebhookPath, registerPluginHttpRoute, registerWebhookTarget, registerWebhookTargetWithPluginRoute, rejectNonPostWebhookRequest, resolveSingleWebhookTarget, resolveSingleWebhookTargetAsync, resolveWebhookPath, resolveWebhookTargetWithAuthOrReject, resolveWebhookTargetWithAuthOrRejectSync, resolveWebhookTargets, withResolvedWebhookRequestPipeline };