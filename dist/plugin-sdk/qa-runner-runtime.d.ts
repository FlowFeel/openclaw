...
type QaBusAttachment = {
  ...
  mimeType: string; /** Selects how QA Channel projects an inline fixture after saving it locally. */
...
type QaRunnerCredentialHost = {
  acquire<TPayload>(options: QaRunnerCredentialLeaseOptions<TPayload>): Promise<QaRunnerCredentialLease<TPayload>>;
  startHeartbeat(lease: Pick<QaRunnerCredentialLease<unknown>, "heartbeat" | "heartbeatIntervalMs" | "kind" | "source">): QaRunnerCredentialHeartbeat;
};
...
type QaRunnerTransportFactory = {
  id: string; /** Each create() call owns isolated runtime state and may run concurrently. */
...
type LiveTransportQaCliRegistration = QaRunnerCliRegistration;
...
declare function createLazyCliRuntimeLoader<T>(load: () => Promise<T>): () => Promise<T>;
/** Build a Commander registration object for one live-transport QA command. */
declare function createLiveTransportQaCliRegistration(params: LiveTransportQaCliRegistrationOptions): LiveTransportQaCliRegistration;
...
declare function runLiveTransportQaSuiteCommand(params: LiveTransportQaSuiteCommandOptions): Promise<unknown>;
...
//#endregion
export { LiveTransportQaCliRegistration, LiveTransportQaCliRegistrationOptions, LiveTransportQaCommandOptions, LiveTransportQaCredentialCliOptions, LiveTransportQaSuiteCommandOptions, QaRunnerCliContribution, QaRunnerCliRegistration, createLazyCliRuntimeLoader, createLiveTransportQaCliRegistration, isQaRuntimeAvailable, listQaRunnerCliContributions, loadQaRunnerBundledPluginTestApi, loadQaRuntimeModule, runLiveTransportQaSuiteCommand };