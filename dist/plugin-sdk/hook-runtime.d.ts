import { r as FinalizedMsgContext } from "../templating-DvDDlopJ.js";
import { $ as PluginHookMessageReceivedEvent, Q as PluginHookMessageContext, et as PluginHookMessageSentEvent, n as initializeGlobalHookRunner, r as resetGlobalHookRunner, tt as MessageHookMediaFact } from "../hook-runner-global-CrDna2QE.js";
...
type MessageReceivedHookContext = {
  ...
  messageId?: string; /** Staged, locally usable attachments in stable source order. */
  media?: MessageHookMediaFact[]; /** Original attachment facts when local staging has not completed yet. */
  originalMedia?: MessageHookMediaFact[]; /** True when originalMedia is present but media is withheld pending staging. */
  mediaStagingPending?: boolean; /** Additional provider-specific metadata */
