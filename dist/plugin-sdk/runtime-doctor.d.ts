import { k as PluginInstallRecord, n as OpenClawConfig } from "../types.openclaw-ymL1Xg7f.js";
...
import { t as collectProviderDangerousNameMatchingScopes } from "../dangerous-name-matching-Dm0ugG8H.js";
...
type ChannelAliasMigrationSpec<TMode extends string = StreamingAliasMode> = {
   ...
   */
  accountStreamingReplacesRoot?: boolean; /** Account resolution layers accounts.default between root and named accounts. */
...
//#endregion
//#region src/plugin-sdk/runtime-doctor.d.ts
type KeyMoveValue = {
  value: unknown;
};
...
//#endregion
export { type ChannelAliasMigrationSpec, type CompatMutationResult, type DoctorSessionRouteStateOwner, type LegacyStreamingAliasOptions, type NormalizeChannelConfigEntryParams, type NormalizeLegacyChannelAccountParams, type OpenClawStateDatabaseSchemaMigration, type OpenKeyedStoreOptions, type PluginDoctorStateMigration, type PluginDoctorStateMigrationContext, type PluginStateKeyedStore, type RetiredChannelKeyRemoval, type StreamingAliasMode, archiveLegacyStateSource, asObjectRecord, collectChannelAccountScopes, collectProviderDangerousNameMatchingScopes, createPluginStateSyncKeyedStore, defineChannelAliasMigration, defineKeyMoveMigration, detectOpenClawStateDatabaseSchemaMigrations, detectPluginInstallPathIssue, formatPluginInstallPathIssue, hasLegacyAccountStreamingAliases, hasLegacyStreamingAliases, legacyStateFileExists, materializeInheritedAccountStreaming, normalizeChannelAccounts, normalizeChannelConfigEntries, normalizeLegacyChannelAliases, normalizeLegacyDmAliases, normalizeLegacyStreamingAliases, removePluginFromConfig, repairOpenClawStateDatabaseSchema, resolveLegacyAliasStreamingMode, stripRetiredChannelKeys };