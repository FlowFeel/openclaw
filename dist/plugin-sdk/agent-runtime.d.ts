import { ct as PromptMode, r as OpenClawConfig, rt as TtsProvider } from "../types.openclaw-C7iFpWwX.js";
...
import { n as PluginMetadataSnapshot } from "../plugin-metadata-snapshot.types-BRAGhUAG.js";
import { C as ChannelOutboundTargetMode } from "../types.core-B0bzaGdW.js";
import { v as SourceReplyDeliveryMode } from "../types-CEcJgDdy.js";
import { A as PromptImageOrderEntry, E as InputProvenance, O as PluginHookChannelContext, _ as UserTurnInput, v as UserTurnTranscriptRecorder } from "../templating-B4o_FX7q.js";
import { D as AuthProfileStore, E as AuthProfileFailureReason, O as OAuthCredential, T as AuthProfileCredential } from "../types-b2oqVK5U.js";
...
import { O as RuntimePluginToolGrant, v as CliDeps } from "../types-DCanIKq0.js";
import { n as findModelInCatalog, t as modelSupportsVision } from "../model-catalog-bRc3XIBo.js";
import { a as listAgentIds, c as resolveAgentDir, d as resolveDefaultAgentId, i as setAgentEffectiveModelPrimary, l as resolveAgentWorkspaceDir, o as resolveAgentConfig, r as resolveSessionAgentIds, t as resolveAgentEffectiveModelPrimary, u as resolveDefaultAgentDir } from "../agent-scope-CeMvfb5u.js";
import { d as resolveAgentIdentity, m as resolveIdentityNamePrefix, p as resolveHumanDelayConfig, u as resolveAckReaction } from "../ack-reactions-C63Iwupy.js";
import { c as projectOutboundPayloadPlanForJson } from "../deliver-DeUP0g2f.js";
import { n as ModelCatalogSnapshot, t as ModelCatalogEntry } from "../model-catalog.types-MPuHn7fn.js";
import { a as findNormalizedProviderValue, c as resolveThinkingDefaultWithRuntimeCatalog, i as resolveModelRefFromString, l as resolveDefaultModelForAgent, n as buildConfiguredModelCatalog, o as parseModelRef, r as buildModelAliasIndex, s as resolveThinkingDefault, t as resolveAllowedModelRef } from "../model-selection-DKQpMH6s.js";
import { t as CODEX_APP_SERVER_AUTH_MARKER } from "../model-auth-markers-Bu63eVv3.js";
import { i as SerializedDurableMessagePayloadOutcome } from "../runtime-CAMHchxA.js";
