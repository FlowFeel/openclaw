...
const CORE_GATEWAY_HANDLER_MODULES = {
	agent: () => import("./agent-iJOvEdM7.js").then((module) => module.agentHandlers),
	...
	artifacts: () => import("./artifacts-BAyqB0-p.js").then((module) => module.artifactsHandlers),
	board: () => import("./board-DQilyBmB.js").then((module) => module.boardHandlers),
	...
	attach: () => import("./attach-BBGLXwPq.js").then((module) => module.attachHandlers),
	...
	chat: () => import("./chat-isBz9K3n.js").then((module) => module.chatHandlers),
	commands: () => import("./commands-DTE0Rt5u.js").then((module) => module.commandsHandlers),
	config: () => import("./config-Bi09-iBe.js").then((module) => module.configHandlers),
	...
	health: () => import("./health-CB3Wbh8Z.js").then((module) => module.healthHandlers),
	...
	"models-probe": () => import("./models-probe-DOeGS3OE.js").then((module) => module.modelsProbeHandlers),
	"native-hook-relay": () => import("./native-hook-relay-BK61FA1I.js").then((module) => module.nativeHookRelayHandlers),
	"nodes-pending": () => import("./nodes-pending-C_PDsF1P.js").then((module) => module.nodePendingHandlers),
	nodes: () => import("./nodes-zVROjRl6.js").then((module) => module.nodeHandlers),
	"plugin-host-hooks": () => import("./plugin-host-hooks-CPVxynKl.js").then((module) => module.pluginHostHookHandlers),
	plugins: () => import("./plugins-CrfwKllj.js").then((module) => module.pluginsHandlers),
	...
	restart: () => import("./restart-C8zBcP6u.js").then((module) => module.restartHandlers),
	suspend: () => import("./suspend-BvaxF-X3.js").then((module) => module.suspendHandlers),
	...
	"sessions-abort": () => import("./sessions-abort-afSwjdUK.js").then((module) => module.sessionAbortHandlers),
	"sessions-compact": () => import("./sessions-compact-Bavo8GRU.js").then((module) => module.sessionCompactHandlers),
	"sessions-compaction-checkpoints": () => import("./sessions-compaction-checkpoints-BieqECK0.js").then((module) => module.sessionCheckpointHandlers),
	"sessions-compaction-queries": () => import("./sessions-compaction-queries-BeImWGji.js").then((module) => module.sessionCheckpointQueryHandlers),
	"sessions-create": () => import("./sessions-create-C2Q1R6C6.js").then((module) => module.sessionCreateHandlers),
	"sessions-delete": () => import("./sessions-delete-T2Q8x29x.js").then((module) => module.sessionDeleteHandlers),
	"sessions-dispatch": () => import("./sessions-dispatch-7nB_taKQ.js").then((module) => module.sessionDispatchHandlers),
	"sessions-groups": () => import("./sessions-groups-ujuEF-nb.js").then((module) => module.sessionGroupHandlers),
	"sessions-messaging": () => import("./sessions-messaging-C2rnZ2th.js").then((module) => module.sessionMessagingHandlers),
	"sessions-mutations": () => import("./sessions-mutations-D35-xJkU.js").then((module) => module.sessionMutationHandlers),
	"sessions-read": () => import("./sessions-read-BOd-N_ec.js").then((module) => module.sessionReadHandlers),
	"sessions-rewind": () => import("./sessions-rewind-BFqhVvfz.js").then((module) => module.sessionRewindHandlers),
	"sessions-sharing": () => import("./sessions-sharing-DSasZpMa.js").then((module) => module.sessionSharingHandlers),
	"sessions-subscriptions": () => import("./sessions-subscriptions-WiopItwq.js").then((module) => module.sessionSubscriptionHandlers),
	"sessions-suggestions": () => import("./sessions-suggestions-dVkwN7zw.js").then((module) => module.sessionSuggestionHandlers),
	"session-catalog": () => import("./session-catalog-BR92k2Y7.js").then((module) => module.sessionCatalogHandlers),
	"session-discussion": () => import("./session-discussion-Bni2--v_.js").then((module) => module.sessionDiscussionHandlers),
	"session-observer-rpc": () => import("./session-observer-rpc-B0fBqz9q.js").then((module) => module.sessionObserverHandlers),
	"session-companion-rpc": () => import("./session-companion-rpc-iVKSHueO.js").then((module) => module.sessionCompanionHandlers),
	"hooks-status": () => import("./hooks-status-DOI02mN_.js").then((module) => module.hooksStatusHandlers),
	skills: () => import("./skills-khytvEb_.js").then((module) => module.skillsHandlers),
	system: () => import("./system-DZ3Hb0OC.js").then((module) => module.systemHandlers),
	talk: () => import("./talk-C62xAZ36.js").then((module) => module.talkHandlers),
	tasks: () => import("./tasks-lIVTujCM.js").then((module) => module.tasksHandlers),
	"task-suggestions": () => import("./task-suggestions-D2g-8nRY.js").then((module) => module.taskSuggestionsHandlers),
	"tools-catalog": () => import("./tools-catalog-NofhzCHl.js").then((module) => module.toolsCatalogHandlers),
	"tools-effective": () => import("./tools-effective-Do7IephE.js").then((module) => module.toolsEffectiveHandlers),
	"tools-invoke": () => import("./tools-invoke-BZ5nreo9.js").then((module) => module.toolsInvokeHandlers),
	...
	update: () => import("./update-CbpKNojV.js").then((module) => module.updateHandlers),
	...
	"system-agent": () => import("./system-agent-CgT6TxZ4.js").then((module) => module.systemAgentHandlers),
	"system-changes": () => import("./system-changes-CQ0LRloY.js").then((module) => module.systemChangesHandlers),
	wizard: () => import("./wizard-Dc9ZHGLp.js").then((module) => module.wizardHandlers)
};
