...
async function runGatewayHealthJsonRoute(args, runtime, deps = {}) {
	...
	try {
		...
		writeRuntimeJson(runtime, await (deps.callGateway ?? (await import("./gateway-rpc-_ctwtykG.js")).callGatewayFromCliWithTransport)("health", rpc, void 0, { defaultTimeoutMs: 1e4 }));
	} catch (error) {
		if (!rpc) {
		...
		const [healthModule, configModule, callModule] = await Promise.all([
			deps.emitReachableGatewayAuthDiagnostic ? void 0 : import("./health-HDtUQc0M.js"),
			deps.readBestEffortConfig ? void 0 : import("./read-best-effort-config.runtime.js"),
			deps.formatGatewayAuthErrorJson && deps.formatGatewayClientRequestErrorJson && deps.formatGatewayTransportErrorJson ? void 0 : import("./call-ujGvHIZc.js")
		]);
