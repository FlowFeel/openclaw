...
const loadDiscordComponentSend = createLazyRuntimeNamedExport(() => import("./send.components-BY5ibdLu.js"), "sendDiscordComponentMessage");
async function sendDiscordComponentMessageLazy(...args) {
	return await (await loadDiscordComponentSend())(...args);
}
const loadDiscordSharedInteractive = createLazyRuntimeModule(() => import("./shared-interactive-CoF9ICTu.js"));
