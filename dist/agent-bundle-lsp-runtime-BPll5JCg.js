...
import { o as setPluginToolMeta } from "./tools-sUgO7zqy.js";
import { t as createPendingRequestRegistry } from "./pending-request-registry-DlrpJG3c.js";
import { n as loadEnabledBundleLspConfig } from "./bundle-lsp-D_Hl92QE.js";
...
async function disposeSession(session) {
	...
	session.pendingRequests.rejectAll(/* @__PURE__ */ new Error("LSP session disposed"));
	terminateLspProcessTree(session);
}
