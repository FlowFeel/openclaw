...
import { a as stripReasoningTagsFromMarkdown, i as scanReasoningTags, n as isInsideCode, t as findCodeRegions } from "./code-regions-B1zlXqqO.js";
...
function stripReasoningTagsFromText(text, options) {
	...
	return applyTrim(stripReasoningTagsFromMarkdown(cleaned, {
		mode,
		scope
	}), trimMode);
}
...
function stripDowngradedToolCallText(text) {
	...
	cleaned = cleaned.replace(/\[Tool Result for ID[^\]]*\]\n?[\s\S]*?(?=\n*\[Tool |\n*$)/gi, (match, offset) => isInsideCode(offset, codeRegions) ? match : "");
...
//#endregion
export { stripAssistantInternalScaffolding as a, stripLegacyBracketToolCallBlocks as c, hasOrphanReasoningCloseBoundary as d, stripReasoningTagsFromText as f, sanitizeAssistantVisibleTextWithProfile as i, stripMinimaxToolCallXml as l, stripFinalTags as m, sanitizeAssistantVisibleText as n, stripAssistantInternalTraceLines as o, findFinalTagMatches as p, sanitizeAssistantVisibleTextWithOptions as r, stripDowngradedToolCallText as s, sanitizeAssistantFinalAnswerText as t, stripToolCallXmlTags as u };
