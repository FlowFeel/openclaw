...
import { d as parseBuzzTarget, i as resolveBuzzPublicKey, s as buildBuzzTarget, t as decodeBuzzPrivateKey } from "./types-CJFyWMAi.js";
import { r as finalizeEvent } from "./esm-B8-t-Wx3.js";
import { a as parseBuzzRoomMembershipEvent, c as parseBuzzAuthTag, l as openBuzzRelaySubscription, r as isNewerBuzzRoomMembership, s as connectAuthenticatedBuzzRelaySession, t as BUZZ_ROOM_MEMBERSHIP_KIND } from "./room-membership-CB6Y7gtF.js";
import { i as buildBuzzMessageTags, s as parseBuzzMessageEvent } from "./message-event-BR6pQ69W.js";
...
async function createBuzzQaTransportAdapter(context) {
	...
	if (requestedCredentialSource !== "file" && requestedCredentialSource !== "convex") throw new Error("Buzz QA credential source must be \"file\" or \"convex\".");
