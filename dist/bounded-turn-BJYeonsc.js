...
import { S as resolveCodexAppServerRuntimeOptions } from "./session-binding-Boew56yn.js";
import { at as isJsonObject, l as isCodexAppServerStartSelectionChangedError } from "./shared-client-CDGOYFn5.js";
import { _ as readCodexNotificationTurnId, n as CODEX_APP_SERVER_INTERRUPT_TIMEOUT_MS, o as interruptCodexTurnAndWaitBestEffort } from "./thread-resume-DATryQ9G.js";
import { _ as readCodexNotificationItem, g as isTerminalTurnStatus, h as isRetryableErrorNotification } from "./attempt-notifications-Diy0_dFi.js";
import { n as normalizeCodexResponseTokenUsage } from "./event-projector-usage-B7a6BEyw.js";
import { a as assertCodexThreadStartResponse, c as readCodexErrorNotification, o as assertCodexTurnStartResponse, u as readCodexTurnCompletedNotification } from "./protocol-validators-Cf6MSlge.js";
import { r as readModelListResult } from "./models-BDMhUs7C.js";
import { W as mergeCodexThreadConfigs, d as buildCodexRingZeroThreadConfigPatch, f as buildCodexRuntimeThreadConfig, l as assertCodexRingZeroHasNoManagedHooks, p as readCodexInheritedMcpServerNames, u as attestCodexRingZeroThreadHasNoMcpServers } from "./thread-lifecycle-BuENMZSU.js";
...
async function runBoundedCodexAppServerTurnInWorkspace(params, appServer, workspace, selectionAttempt = 0, timing) {
	...
	}) : await import("./shared-client-DGYnLJRe.js").then(({ createIsolatedCodexAppServerClient }) => createIsolatedCodexAppServerClient({
		startOptions,
		timeoutMs,
		authProfileId: params.profile,
		agentDir,
	...
	try {
		...
		if (params.requireNoExternalCapabilities) await assertCodexRingZeroHasNoManagedHooks(client, abortController.signal);
		const thread = assertCodexThreadStartResponse(await client.request("thread/start", {
			...
			config: buildCodexRuntimeThreadConfig(resolveBoundedThreadConfig(params, workspace, inheritedMcpServerNames), { nativeCodeModeEnabled: false }),
			environments: [],
			dynamicTools: [],
		...
		if (params.requireNoExternalCapabilities) await attestCodexRingZeroThreadHasNoMcpServers(client, thread.thread.id, abortController.signal);
