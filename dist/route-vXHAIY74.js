...
import { n as ensureCliExecutionBootstrap, r as resolveCliExecutionStartupContext, t as applyCliExecutionStartupPresentation } from "./command-execution-startup-BZr8u33U.js";
...
const modelsStatusCommandLoader = createLazyImportLoader(() => import("./list.status-command-CsM7pj-o.js"));
const tasksJsonCommandLoader = createLazyImportLoader(() => import("./tasks-json--2PELgSM.js"));
...
const routedCommandDefinitions = {
	...
	status: defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			if (args.json) {
				const { statusJsonCommand } = await import("./status-json-DOkZ6rcB.js");
			...
			const { statusCommand } = await import("./status-Ck2qpulH.js");
