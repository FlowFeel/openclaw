...
import { n as externalCliDiscoveryForProviderAuth, r as externalCliDiscoveryForProviders } from "./external-cli-discovery-WL3vnn14.js";
import { t as createModelAuthAvailabilityResolver } from "./model-auth-availability-C8Zmw0UA.js";
import { a as hasAvailableAuthForProvider, c as createRuntimeProviderAuthLookup, l as hasRuntimeAvailableProviderAuth } from "./model-auth-yfB4tyNY.js";
...
async function buildCurrentProviderAuthStateSnapshot(cfg, options = {}) {
	...
	for (const agentId of listAgentIds(cfg)) {
		...
		const { loadPreparedModelCatalogOwnerSnapshot } = await import("./prepared-model-catalog-CDZ2A_-7.js");
...
function createProviderAuthWarmPresenceStore(store) {
	...
	const usageStats = {};
	if (store.usageStats) {
		for (const [id, stats] of Object.entries(store.usageStats)) if (id.startsWith("inline-api-key:")) usageStats[id] = stats;
	}
	return {
