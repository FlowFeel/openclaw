...
import { i as isDefaultInstallIdentity, v as resolveIsNixMode } from "./paths-CL43LNS6.js";
import { i as writeConfigMachineState } from "./config-machine-state-i7eWuJLs.js";
import { n as NON_DEFAULT_INSTALL_SERVICE_SKIP_REASON } from "./gateway-supervision-D_xpxHux.js";
import { t as note } from "./note-uiKX_qfX.js";
import { n as hasActiveGatewayExecCredential, t as resolveDoctorWorkspaceSuggestionScopes } from "./doctor-workspace-suggestion-scopes-Cd2p6boe.js";
import { l as isLegacyParentWritableUpdateDoctorPass } from "./update-phase-Br5TVkeJ.js";
import { i as createDoctorHealthContribution, n as runCoreHealthFindingNote, r as runStructuredHealthRepairs, t as runCoreContributionHealth } from "./doctor-health-contribution-core-BtVMfPA4.js";
...
async function runWriteConfigHealth(ctx, options = {}) {
	const { applyWizardMetadata } = await import("./onboard-helpers-CKVn1bCG.js");
	const { replaceConfigFile } = await import("./config/config.js");
	const { logConfigUpdated } = await import("./logging-Ci4qMKQZ.js");
	const { shortenHomePath } = await import("./utils-blFhDTzd.js");
	...
	if (ctx.configResult.retiredPhoneControlStateCleanupPending === true) {
		const { finalizeRetiredPhoneControlCleanup } = await import("./doctor-retired-phone-control-WEjhIqwj.js");
	...
	const { repairCronCodexModelRefsAfterConfigWrite } = await import("./legacy-repair-DK91AJDd.js");
...
async function runCommandOwnerHealth(ctx) {
	const { noteCommandOwnerHealth } = await import("./doctor-command-owner-CtRhHWGX.js");
	noteCommandOwnerHealth(ctx.cfg);
}
async function runClaudeCliHealth(ctx) {
	const { noteClaudeCliHealth } = await import("./doctor-claude-cli-BrZoa3Iw.js");
...
async function runGatewayServicesHealth(ctx) {
	...
	const { maybeRepairGatewayServiceConfig, maybeResolveDuelingSystemdGatewayScopes, maybeScanExtraGatewayServices } = await import("./doctor-gateway-services-B-BLa3Vg.js");
	const { noteMacLaunchAgentOverrides, noteMacLaunchctlGatewayEnvOverrides, noteMacStaleOpenClawUpdateLaunchdJobs } = await import("./doctor-platform-notes-CSj0MTF4.js");
...
async function runStartupChannelMaintenanceHealth(ctx) {
	const { maybeRunDoctorStartupChannelMaintenance } = await import("./doctor-startup-channel-maintenance-CNL9p839.js");
...
async function runSecurityHealth(ctx) {
	const { noteInstallPolicyHealth } = await import("./doctor-install-policy-ClFarAMd.js");
	const { noteSecurityWarnings } = await import("./doctor-security-C9kWimJH.js");
...
async function runWebFetchProxyHealth(ctx) {
	...
	const { noteWebFetchProxyDiagnostic } = await import("./doctor-web-fetch-proxy-C8IYm70Y.js");
...
async function runBrowserHealth(ctx) {
	const { noteChromeMcpBrowserReadiness } = await import("./doctor-browser-M6gfeEp2.js");
...
async function runOpenAIOAuthTlsHealth(ctx) {
	const { noteOpenAIOAuthTlsPrerequisites } = await import("./provider-openai-chatgpt-oauth-tls-DPOM8FXz.js");
...
async function runWhatsappResponsivenessHealth(ctx) {
	const { noteWhatsappResponsivenessHealth } = await import("./doctor-whatsapp-responsiveness-D0hu0owz.js");
...
async function runDevicePairingHealth(ctx) {
	const { noteDevicePairingHealth } = await import("./doctor-device-pairing-DjYWtJrJ.js");
...
async function runGatewayDaemonHealth(ctx) {
	if (!isDefaultInstallIdentity(ctx.env ?? process.env)) return;
	const { maybeRepairGatewayDaemon } = await import("./doctor-gateway-daemon-flow-B2b_tqkk.js");
...
const loadDoctorStateIntegrityModule$1 = async () => await import("./doctor-state-integrity-DoXgytFu.js");
async function runActiveToolSchemaWarningsHealth(ctx) {
	if (!ctx.prompter.shouldRepair) return;
	const { collectActiveToolSchemaProjectionWarnings } = await import("./active-tool-schema-warnings-DnZudM_g.js");
...
async function runHooksModelHealth(ctx) {
	...
	const { loadPreparedModelCatalog } = await import("./prepared-model-catalog-CDZ2A_-7.js");
	const { getModelRefStatus, resolveConfiguredModelRef, resolveHooksGmailModel } = await import("./model-selection-Cmjka01x.js");
	const { note } = await import("./terminal-core/note.js");
...
async function collectWorkspaceStatusPluginVersionDrift(params) {
	...
	try {
		const { gatherDaemonStatus } = await import("./status.gather-C7p4jFfz.js");
...
async function runWorkspaceStatusHealth(ctx) {
	...
	const { noteWorkspaceStatus } = await import("./doctor-workspace-status-CT7a6lI9.js");
	noteWorkspaceStatus(ctx.cfg, { pluginVersionDrift });
}
async function runSkillsHealth(ctx) {
	const { maybeRepairSkillReadiness } = await import("./doctor-skills-BQ-njrQC.js");
...
async function runBootstrapSizeHealth(ctx) {
	const { noteBootstrapFileSize } = await import("./doctor-bootstrap-size-D4OBLJox.js");
	await noteBootstrapFileSize(ctx.cfg);
}
async function runHeartbeatCadenceMigrationHealth(ctx) {
	const { maybeMigrateHeartbeatCadenceToCron } = await import("./doctor-heartbeat-cadence-migration-CynfTl_-.js");
...
async function runHeartbeatScratchMigrationHealth(ctx) {
	const { maybeMigrateHeartbeatFilesToScratch } = await import("./doctor-heartbeat-scratch-migration-CSqPnelZ.js");
...
async function runToolsMdMigrationHealth(ctx) {
	const { maybeMigrateToolsMd } = await import("./doctor-tools-md-migration-hEHWvkqK.js");
...
async function runHeartbeatTaskMigrationHealth(ctx) {
	const { maybeMigrateHeartbeatTasksToCron } = await import("./doctor-heartbeat-task-migration-CXmZngxD.js");
...
async function runMemorySearchHealthContribution(ctx) {
	const { maybeRepairMemoryRecallHealth, noteMemoryRecallHealth, noteMemorySearchHealth } = await import("./doctor-memory-search-BPlyno_b.js");
...
function memorySearchNoteToFinding(message) {
	...
	else if (firstLine.includes("QMD memory backend")) path = "memory.backend";
...
async function collectMemorySearchHealthFindings(ctx) {
	const { noteMemorySearchHealth } = await import("./doctor-memory-search-BPlyno_b.js");
	const notes = [];
...
async function runWorkspaceSuggestionsHealth(ctx) {
	...
	const { MEMORY_SYSTEM_PROMPT, shouldSuggestMemorySystem } = await import("./doctor-workspace-BSBL67OM.js");
	const { note } = await import("./terminal-core/note.js");
	...
	return [
		...
		createDoctorHealthContribution({
			...
			healthChecks: {
				...
				async detect(ctx) {
					const { collectMissingDefaultAccountBindingWarnings, collectMissingExplicitDefaultAccountWarnings } = await import("./default-account-warnings-DPphcoaQ.js");
		...
		createDoctorHealthContribution({
			...
			healthChecks: [{
				...
				defaultEnabled: false,
				async detect(ctx) {
					const { channelPluginBlockerHitToHealthFinding, scanConfiguredChannelPluginBlockers } = await import("./channel-plugin-blockers-DuYdZ2MA.js");
				...
				defaultEnabled: false,
				async detect(ctx) {
					const { collectChannelPreviewWarningHealthFindings } = await import("./doctor-startup-channel-maintenance-CNL9p839.js");
		...
		createDoctorHealthContribution({
			...
			healthChecks: {
				...
				defaultEnabled: false,
				async detect(ctx) {
					const { collectWorkspaceStatusHealthFindings } = await import("./doctor-workspace-status-CT7a6lI9.js");
					const pluginVersionDrift = await collectWorkspaceStatusPluginVersionDrift({
						cfg: ctx.cfg,
						options: {
							nonInteractive: true,
		...
		createDoctorHealthContribution({
			...
			healthChecks: {
				...
				defaultEnabled: false,
				async detect() {
					const { getSkillCuratorDoctorWarning } = await import("./curator-D5nmHaHf.js");
		...
		createDoctorHealthContribution({
			...
			healthChecks: {
				...
				defaultEnabled: true,
				async detect(ctx) {
					const { collectHeartbeatCadenceMigrationFindings } = await import("./doctor-heartbeat-cadence-migration-CynfTl_-.js");
		...
		createDoctorHealthContribution({
			...
			healthChecks: {
				...
				defaultEnabled: true,
				async detect(ctx) {
					const { collectHeartbeatScratchMigrationFindings } = await import("./doctor-heartbeat-scratch-migration-CSqPnelZ.js");
		...
		createDoctorHealthContribution({
			...
			healthChecks: {
				...
				defaultEnabled: true,
				async detect(ctx) {
					const { collectToolsMdMigrationFindings } = await import("./doctor-tools-md-migration-hEHWvkqK.js");
		...
		createDoctorHealthContribution({
			...
			healthChecks: {
				...
				defaultEnabled: true,
				async detect(ctx) {
					const { collectHeartbeatTaskMigrationFindings } = await import("./doctor-heartbeat-task-migration-CXmZngxD.js");
		...
		createDoctorHealthContribution({
			...
			healthChecks: {
				...
				defaultEnabled: false,
				async detect(ctx) {
					const { collectWhatsappResponsivenessHealthFindings } = await import("./doctor-whatsapp-responsiveness-D0hu0owz.js");
					let status;
		...
		createDoctorHealthContribution({
			...
			healthChecks: {
				...
				defaultEnabled: false,
				async detect(ctx) {
					const { collectDevicePairingHealthFindings } = await import("./doctor-device-pairing-DjYWtJrJ.js");
...
const loadDoctorStateIntegrityModule = async () => await import("./doctor-state-integrity-DoXgytFu.js");
async function runLegacyPluginManifestHealth(ctx) {
	const { maybeRepairLegacyPluginManifestContracts } = await import("./doctor-plugin-manifests-BwLi1s3L.js");
...
async function runPluginRegistryHealth(ctx) {
	const { maybeRepairPluginRegistryState } = await import("./doctor-plugin-registry-Cv_sZ1x8.js");
...
async function runReleaseConfiguredPluginInstallsHealth(ctx) {
	...
	const { maybeRunConfiguredPluginInstallReleaseStep } = await import("./release-configured-plugin-installs-CjbZ3f2j.js");
	const { note } = await import("./terminal-core/note.js");
...
async function runDiskSpaceHealth(ctx) {
	const { noteDiskSpace } = await import("./doctor-disk-space-B1VGQyTA.js");
	noteDiskSpace(ctx.cfg);
}
async function runDatabaseBloatHealth(ctx) {
	const { noteSqliteDatabaseBloat } = await import("./doctor-db-bloat-BjZ2Qaf8.js");
	noteSqliteDatabaseBloat(ctx.cfg);
}
async function runAgentMemorySchemaHealth(ctx) {
	const { noteDoctorAgentMemorySchemaHealth } = await import("./doctor-agent-memory-schema-BmkNgxAY.js");
...
async function runChannelIngressDeadLettersHealth() {
	const { noteChannelIngressDeadLetters } = await import("./doctor-channel-ingress-B_KHcwWQ.js");
...
async function runCodexSessionRouteHealth(ctx) {
	const { maybeRepairCodexSessionRoutes } = await import("./codex-route-warnings-C6noilE7.js");
	const { note } = await import("./terminal-core/note.js");
...
async function runSessionLocksHealth(ctx) {
	const { noteSessionLockHealth } = await import("./doctor-session-locks-OG3fky-D.js");
...
async function runSessionTranscriptsHealth(ctx) {
	const { noteSessionTranscriptHealth } = await import("./doctor-session-transcripts-D7EbaU_W.js");
...
async function runSessionTranscriptHeadersHealth(ctx) {
	const { noteSessionTranscriptHeaderHealth } = await import("./doctor-session-transcript-headers-BS0zdrsv.js");
...
async function runSessionTranscriptLabelsHealth(ctx) {
	const { noteSessionTranscriptLabelHealth } = await import("./doctor-session-transcript-labels-BsDHZAfS.js");
...
async function runSessionSnapshotsHealth(ctx) {
	const { noteSessionSnapshotHealth } = await import("./doctor-session-snapshots-COKYuufM.js");
...
async function runConfigAuditScrubHealth(ctx) {
	const { maybeRepairLegacyRuntimeFiles } = await import("./doctor-usage-cost-cache-BVu99grq.js");
	await maybeRepairLegacyRuntimeFiles(ctx.prompter.shouldRepair, ctx.env);
}
async function runLegacyCronHealth(ctx) {
	const { maybeRepairLegacyCronStore, noteLegacyWhatsAppCrontabHealthCheck } = await import("./cron-33aKh_Rb.js");
...
async function runSandboxHealth(ctx) {
	const { maybeRepairSandboxImages, maybeRepairSandboxRegistryFiles, noteSandboxScopeWarnings } = await import("./doctor-sandbox-7FEoyZMB.js");
...
async function runTelegramGeneralTopicConversationHealth(ctx) {
	const { runCoreContributionHealth } = await import("./doctor-health-contribution-core-Cy_z7WIR.js");
	...
	return [
		...
		createDoctorHealthContribution({
			...
			healthChecks: {
				...
				defaultEnabled: false,
				async detect(ctx) {
					const { collectAuthProfileHealthFindings } = await import("./doctor-auth-BR93jkns.js");
		...
		createDoctorHealthContribution({
			...
			healthChecks: {
				...
				defaultEnabled: false,
				async detect() {
					const { detectSessionTranscriptHealthIssues, sessionTranscriptIssueToHealthFinding } = await import("./doctor-session-transcripts-D7EbaU_W.js");
					return (await detectSessionTranscriptHealthIssues()).map(sessionTranscriptIssueToHealthFinding);
				},
				repair: legacyOwnedRepair(async () => {
					const { detectSessionTranscriptHealthIssues, sessionTranscriptIssueToRepairEffect } = await import("./doctor-session-transcripts-D7EbaU_W.js");
		...
		createDoctorHealthContribution({
			...
			healthChecks: {
				...
				defaultEnabled: false,
				async detect(ctx) {
					const { collectLegacyPluginManifestContractMigrations, legacyPluginManifestContractMigrationToHealthFinding } = await import("./doctor-plugin-manifests-BwLi1s3L.js");
		...
		createDoctorHealthContribution({
			...
			healthChecks: {
				...
				defaultEnabled: false,
				async detect() {
					const { detectLegacyPluginDependencyStateIssues, legacyPluginDependencyStateIssueToHealthFinding } = await import("./plugin-dependency-cleanup-C7fDckXt.js");
		...
		createDoctorHealthContribution({
			...
			healthChecks: {
				...
				defaultEnabled: false,
				async detect() {
					const { collectStalePluginRuntimeSymlinkHealthFindings } = await import("./plugin-runtime-symlinks-CRYid5I4.js");
		...
		createDoctorHealthContribution({
			...
			healthChecks: {
				...
				defaultEnabled: false,
				async detect(ctx) {
					const { detectConfiguredPluginInstallHealthIssues, configuredPluginInstallIssueToHealthFinding } = await import("./missing-configured-plugin-install-CRenn-CD.js");
				...
				repair: legacyOwnedRepair(async (ctx) => {
					const { detectConfiguredPluginInstallHealthIssues, configuredPluginInstallIssueToRepairEffect } = await import("./missing-configured-plugin-install-CRenn-CD.js");
					return (await detectConfiguredPluginInstallHealthIssues({
						cfg: ctx.cfg,
						env: process.env
		...
		createDoctorHealthContribution({
			...
			healthChecks: {
				...
				defaultEnabled: false,
				async detect(ctx) {
					const { detectPluginRegistryHealthIssues, pluginRegistryIssueToHealthFinding } = await import("./doctor-plugin-registry-Cv_sZ1x8.js");
				...
				repair: legacyOwnedRepair(async (ctx) => {
					const { detectPluginRegistryHealthIssues, pluginRegistryIssueToRepairEffect } = await import("./doctor-plugin-registry-Cv_sZ1x8.js");
					return (await detectPluginRegistryHealthIssues({
						config: ctx.cfg,
						env: process.env,
						prompter: { shouldRepair: false }
		...
		createDoctorHealthContribution({
			...
			healthChecks: {
				...
				defaultEnabled: false,
				async detect(ctx) {
					const { collectDiskSpaceHealthFindings } = await import("./doctor-disk-space-B1VGQyTA.js");
		...
		createDoctorHealthContribution({
			...
			healthChecks: {
				...
				defaultEnabled: false,
				async detect(ctx) {
					const { detectStateIntegrityHealthIssues, stateIntegrityIssueToHealthFinding } = await import("./doctor-state-integrity-DoXgytFu.js");
				...
				repair: legacyOwnedRepair(async (ctx) => {
					const { detectStateIntegrityHealthIssues, stateIntegrityIssueToRepairEffect } = await import("./doctor-state-integrity-DoXgytFu.js");
					return detectStateIntegrityHealthIssues(ctx.cfg, {
						configPath: ctx.configPath,
						env: process.env
		...
		createDoctorHealthContribution({
			...
			healthChecks: {
				...
				defaultEnabled: false,
				async detect(ctx) {
					const { detectSessionSnapshotHealthIssues, sessionSnapshotIssueToHealthFinding } = await import("./doctor-session-snapshots-COKYuufM.js");
				...
				repair: legacyOwnedRepair(async (ctx) => {
					const { detectSessionSnapshotHealthIssues, sessionSnapshotIssueToRepairEffect } = await import("./doctor-session-snapshots-COKYuufM.js");
					return (await detectSessionSnapshotHealthIssues({
						cfg: ctx.cfg,
						env: process.env
		...
		createDoctorHealthContribution({
			...
			healthChecks: {
				...
				defaultEnabled: false,
				async detect() {
					const { configAuditScrubToHealthFinding, detectConfigAuditScrubIssue } = await import("./doctor-config-audit-scrub-DQqYTyor.js");
					const result = await detectConfigAuditScrubIssue();
					return result.rewritten > 0 ? [configAuditScrubToHealthFinding(result)] : [];
				},
				repair: legacyOwnedRepair(async () => {
					const { configAuditScrubToRepairEffect, detectConfigAuditScrubIssue } = await import("./doctor-config-audit-scrub-DQqYTyor.js");
					const result = await detectConfigAuditScrubIssue();
		...
		createDoctorHealthContribution({
			...
			healthChecks: {
				...
				async detect() {
					const { detectLegacySandboxRegistryFileIssues, legacySandboxRegistryInspectionToHealthFinding } = await import("./doctor-sandbox-7FEoyZMB.js");
					return (await detectLegacySandboxRegistryFileIssues()).map(legacySandboxRegistryInspectionToHealthFinding);
				},
				repair: legacyOwnedRepair(async () => {
					const { detectLegacySandboxRegistryFileIssues, legacySandboxRegistryInspectionToRepairEffect } = await import("./doctor-sandbox-7FEoyZMB.js");
...
const loadCommandFormatModule = async () => await import("./command-format-nGsiCAcY.js");
const loadDoctorCoreChecksModule = async () => await import("./doctor-core-checks-BuXJXsNW.js");
const loadNoteModule = async () => await import("./terminal-core/note.js");
const loadOnboardHelpersModule = async () => await import("./onboard-helpers-CKVn1bCG.js");
const loadSecretTypesModule = async () => await import("./types.secrets-Lmd-hqvC.js");
async function runGatewayConfigHealth(ctx) {
	const { formatCliCommand } = await loadCommandFormatModule();
	const { hasAmbiguousGatewayAuthModeConfig } = await import("./auth-mode-policy-CKKPFg8F.js");
...
async function runAuthProfileHealth(ctx) {
	const { maybeMigrateAuthProfileJsonStoresToSqlite } = await import("./doctor-auth-flat-profiles-Dq7PjAP_.js");
	const { maybeRepairLegacyOAuthProfileIds } = await import("./doctor-auth-legacy-oauth-25V7QThL.js");
	const { maybeRepairLegacyOAuthSidecarProfiles } = await import("./doctor-auth-oauth-sidecar-BUkJMbWq.js");
	const { maybeMigrateLegacyPluginModelCatalogs } = await import("./doctor-plugin-model-catalog-AosTylgw.js");
	const { noteAuthProfileHealth, noteLegacyCodexProviderOverride } = await import("./doctor-auth-BR93jkns.js");
	const { buildGatewayConnectionDetails } = await import("./call-ujGvHIZc.js");
	const { note } = await loadNoteModule();
...
async function runGatewayAuthHealth(ctx) {
	...
	const { resolveGatewayAuth } = await import("./auth-C8juT_Xa.js");
	const { resolveGatewayAuthToken } = await import("./auth-token-resolution-ZllVazre.js");
	const { note } = await loadNoteModule();
	...
	if (gatewayTokenRef && gatewayTokenRef.source === "exec") {
		const { getSkippedExecRefStaticError } = await import("./exec-resolution-policy-BwcbiKj_.js");
...
async function runLegacyStateHealth(ctx) {
	const { detectLegacyStateMigrations, runLegacyStateMigrations } = await import("./doctor-state-migrations-Dc88c8kL.js");
	const { note } = await loadNoteModule();
...
async function runSystemdLingerHealth(ctx) {
	...
	const { resolveGatewayService } = await import("./service-Dkib5td9.js");
	const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-Bxj_sra5.js");
	const { note } = await loadNoteModule();
...
async function detectSystemdLingerFindings(ctx) {
	...
	if (!loaded) return [];
	const { isSystemdUserServiceAvailable, readSystemdUserLingerStatus } = await import("./systemd-D1WJK-gC.js");
...
async function runShellCompletionHealth(ctx) {
	const { doctorShellCompletion } = await import("./doctor-completion-euTtvRoM.js");
...
async function runGatewayHealthChecks(ctx) {
	...
	const { checkGatewayHealth, probeGatewayMemoryStatus } = await import("./doctor-gateway-health-DzaJutSR.js");
...
async function resolveDoctorContributionHealthChecks() {
	const { createCoreHealthChecks } = await import("./doctor-core-checks-BuXJXsNW.js");
