...
import { p as stripRuntimeContextCustomMessages } from "./internal-runtime-context-s8_TwHnQ.js";
...
import { St as publishSqliteTranscriptUpdate } from "./session-accessor.sqlite-CtCo5VZ6.js";
...
import { c as recordTaskRunProgressByRunId, i as failTaskRunByRunId, n as createQueuedTaskRun, t as completeTaskRunByRunId, u as startTaskRunByRunId } from "./detached-task-runtime-BImEfMLT.js";
import { d as isGatewayDraining, r as enqueueCommandInLane } from "./command-queue-DxY-0HMA.js";
import { n as OPENCLAW_EMBEDDED_CONTEXT_ENGINE_HOST } from "./host-compat-BibWlia2.js";
import { v as runWithPreparedMemoryPromptSection } from "./memory-state-D_cMOwNA.js";
import { t as log$1 } from "./logger-PoK3sCV7.js";
import { O as findActiveSessionTask } from "./openclaw-tools-B_OHwLQN.js";
import { c as updateTaskNotifyPolicyForOwner, i as findTaskByRunIdForOwner, n as cancelTaskByIdForOwner } from "./task-owner-access-CUw2DXVh.js";
import { b as resolveContextEngineCapabilities, n as buildAfterTurnRuntimeContextFromUsage, t as buildAfterTurnRuntimeContext } from "./attempt.prompt-helpers-BQhqL2Eu.js";
import { n as rewriteTranscriptEntriesInSessionManager, t as resolveRuntimeTranscriptReadTarget } from "./transcript-runtime-state-Bl8TA4TD.js";
import { r as runAgentHarnessAgentEndHook, t as awaitAgentHarnessAgentEndHook } from "./lifecycle-hook-helpers-B_MyvJob.js";
...
function buildContextEngineMaintenanceRuntimeContext(params) {
	return {
		...
		rewriteTranscriptEntries: async (request) => {
			...
			const runtimeStorePath = params.sessionTarget?.storePath ?? (runtimeAgentId ? resolveStorePath(params.config?.session?.store, { agentId: runtimeAgentId }) : void 0);
			let runtimeTarget;
			...
			if (result.changed && runtimeTarget) await publishSqliteTranscriptUpdate(runtimeTarget);
			return result;
		}
	};
}
...
async function runCoreAgentEndSideEffects(params) {
	try {
		const { scheduleSkillExperienceReview } = await import("./experience-review-default-DoHHu0dV.js");
	...
	try {
		const { runSkillResearchAutoCapture } = await import("./autocapture-BExRbqe8.js");
