...
import { t as addGatewayServiceCommands } from "./register-service-commands-7slSnWD7.js";
...
import { t as addGatewayRunCommand } from "./run-command-DJr1N-1o.js";
...
const usageFormatModuleLoader = createLazyImportLoader(() => import("./usage-format-jtvYfUIk.js"));
...
function registerGatewayCli(program, deps = {}) {
	...
	gateway.command("auth-token").description("Reveal the configured shared Gateway token").option("--show", "Print the token to an interactive terminal", false).action(async (opts) => {
		await runGatewayCommand(async () => {
			...
			const { gatewayAuthTokenCommand } = await import("./gateway-auth-token-CbClTL5z.js");
