...
import { d as isTimeoutError } from "./failover-error-BSBBvfXF.js";
import { u as recordSessionCreated } from "./session-state-events-MWtkoPhW.js";
import { V as mapAgentRunTerminalOutcomeToTaskStatus } from "./task-registry-C6MCtVnT.js";
import { n as buildAgentRunTerminalOutcome, o as classifyAgentRunTerminalOutcome, p as normalizeAgentRunTimeoutPhase } from "./agent-run-terminal-outcome-DXPF-TAc.js";
...
import { C as retainEmbeddedAgentRunAbortabilityForRunId, i as clearEmbeddedAgentRunAbortabilityForRunId, l as isEmbeddedAgentRunAbortableForRunId } from "./runs-Du_qIW6W.js";
...
import { M as resolveGatewayModelSupportsImages, O as resolveDeletedAgentIdFromSessionKey, S as loadSessionEntry } from "./session-utils-row-Cby7i9PV.js";
...
import { a as releaseMainSessionRecoveryOwner, n as commitMainSessionRecovery } from "./main-session-recovery-store-BLi4qSF0.js";
...
import { r as validateStructuredOutputSchema } from "./openclaw-tools-CoDz4vSH.js";
import { l as consumeSubagentCompletionToolHandoff } from "./server-plugins-Dw5hvH9r.js";
...
import { f as updateChatRunProvider, l as resolveAgentRunExpiresAtMs, s as registerChatAbortController } from "./chat-abort-BvCyxb9W.js";
import { a as emitGatewaySessionEndPluginHook, c as performGatewaySessionReset, o as emitGatewaySessionStartPluginHook } from "./session-reset-service-bcdW_m_M.js";
import { n as agentCommandFromGatewayIngress } from "./agent-command-Dr-CXQcL.js";
...
import { n as waitForAgentJob, t as setGatewayDedupeEntry } from "./agent-job-C6LRLwR3.js";
...
import { a as parseMessageWithAttachments, i as logAttachmentFailure, n as MediaOffloadError, t as normalizeRpcAttachmentsToChatAttachments } from "./attachment-normalize-n86LTUwu.js";
import { _ as gatewayClientSenderFields, i as authorizeResolvedSessionMutation } from "./session-sharing-CSGmZX63.js";
...
import { t as reactivateCompletedSubagentSession } from "./session-subagent-reactivation-evp6pFvh.js";
...
async function registerPluginSubagentRunFromGateway(params) {
	...
	const { registerSubagentRun } = await import("./subagent-registry-CYpnAYTA.js");
	registerSubagentRun({
		runId: params.runId,
		childSessionKey,
