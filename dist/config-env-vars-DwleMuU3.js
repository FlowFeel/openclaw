import { a as normalizeZaiEnv, o as resolveEnvNormalizationKeys, t as expandEnvNormalizationKeys } from "./env-Bnf0Z-yF.js";
import { n as containsEnvVarReference } from "./env-substitution-EW55PmJg.js";
...
function resolveTouchedVersion(params) {
	const readSourceVersion = (value) => {
		if (!value || typeof value !== "object") return;
		const meta = value.meta;
		if (!meta || typeof meta !== "object") return;
		const version = meta.lastTouchedVersion;
		return typeof version === "string" ? version.trim() || void 0 : void 0;
	};
	return readSourceVersion(params.snapshot?.sourceConfig) ?? readSourceVersion(params.snapshot?.config) ?? readSourceVersion(params.config) ?? null;
}
...
//#endregion
export { collectConfigServiceEnvVars as a, getPublishedConfigRuntimeEnvState as c, prepareConfigRuntimeEnv as d, resetPublishedConfigRuntimeEnv as f, resolveFutureConfigActionBlock as h, collectConfigRuntimeEnvVars as i, initializePublishedConfigRuntimeEnv as l, formatFutureConfigActionBlock as m, cloneEnvWithPlatformSemantics as n, createConfigRuntimeEnv as o, ALLOW_OLDER_BINARY_DESTRUCTIVE_ACTIONS_ENV as p, collectConfigRuntimeEnvOwnership as r, createConfigRuntimeEnvBase as s, applyConfigEnvVars as t, isConfigRuntimeEnvVarAllowed as u };
