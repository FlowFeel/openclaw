...
import { N as resolveSessionTotalTokens } from "./session-entry-slot-keys-DR5d2mKt.js";
...
import { u as peekSystemEvents } from "./system-events-fsxpbPNB.js";
...
const channelSummaryModuleLoader = createLazyImportLoader(() => import("./channel-summary-DmYRfFkr.js"));
const channelPluginIdsModuleLoader = createLazyImportLoader(() => import("./channel-plugin-ids-CAcq9tfq.js"));
const linkChannelModuleLoader = createLazyImportLoader(() => import("./link-channel-BDjo1YYY.js"));
const taskRegistryMaintenanceModuleLoader = createLazyImportLoader(() => import("./task-registry.maintenance-BoQDbuA7.js"));
const staticModelCatalogResolverLoader = createLazyImportLoader(async () => {
	const modelCatalog = await import("./model.static-catalog-O-ntbE88.js");
	return {
