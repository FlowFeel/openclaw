...
import { H as resetConfigOverrides, N as validateConfigObjectWithPlugins, U as setConfigOverride, V as getConfigOverrides, W as unsetConfigOverride, at as resolveOwnerPromptNumbers, d as readConfigFileSnapshotForWrite, l as readConfigFileSnapshot } from "./io-DCw4R0kD.js";
...
import { c as resolveContextConfigProviderForRuntime } from "./openai-routing-G4z6ipSe.js";
...
import { d as scheduleGatewaySigusr1Restart, m as triggerOpenClawRestart } from "./restart-Btxr3FFZ.js";
import { t as normalizeChatType } from "./chat-type-BARlA53h.js";
import "./installed-plugin-index-records-D-ObTfAD.js";
import { c as normalizeSessionDeliveryState, d as sessionDeliveryOrigin, n as deliveryContextFromSession } from "./delivery-context.shared-B-QSuGw_.js";
...
import { ct as loadSqliteSessionEntryReadOnly, lt as patchSqliteSessionEntry, yt as resolveSessionStorePathForScope } from "./session-accessor.sqlite-B9iW7DOt.js";
...
import { t as resolveChannelApprovalAdapter } from "./plugins-1tM2ZjdA.js";
...
import { a as normalizeStoreSessionKey, s as resolveSessionStoreEntry } from "./store-entry-0o94FtE8.js";
...
import { J as applySessionPatchProjection, K as updateSessionEntry } from "./session-accessor-t3qUoTeV.js";
import { t as extractDeliveryInfo } from "./delivery-info-D_tbjn1X.js";
import { o as migrateSessionEntries } from "./session-manager-codec-qDky9Jof.js";
import "./session-manager-Rig6qOU_.js";
...
import { i as isCliRuntimeAliasForProvider, s as resolveCliRuntimeExecutionProvider } from "./model-runtime-aliases-DphvzCQU.js";
...
import { i as setAbortMemory, r as isAbortTrigger } from "./abort-primitives-i7c2CWmO.js";
import { l as listTasksForSessionKeyForStatus, s as listTasksForAgentIdForStatus } from "./task-status-access-D8bnycbU.js";
import { a as readAcpSessionMetaForEntry } from "./session-meta-DqFXJodN.js";
import { w as replyRunRegistry } from "./reply-run-registry-CA3-OJtf.js";
import { m as resolveActiveEmbeddedRunSessionId } from "./run-state-D3E5NYGs.js";
import { _ as queueEmbeddedAgentMessageWithOutcomeAsync, a as formatEmbeddedAgentQueueFailureSummary, u as isEmbeddedAgentRunActive } from "./runs-Du_qIW6W.js";
import { t as formatTokenCount } from "./token-format-D942KbWN.js";
import "./sessions-CBo4LOdS.js";
import { r as readLatestAssistantTextFromSessionTranscript } from "./transcript-CkD940e8.js";
import { c as readSessionMessagesAsync } from "./session-transcript-readers-O3pZVV3x.js";
import { n as formatUsd } from "./usage-format-BjulFdpS.js";
import { I as deriveSessionTitle } from "./session-utils-row-Cby7i9PV.js";
...
import { G as createMessageCharEstimateCache, K as estimateMessageCharsCached, v as isRealConversationMessage } from "./builtin-openclaw-voNo-gIX.js";
import { d as isTrustedMessageActionTurnIngress, f as mintMessageActionTurnCapability, h as revokeMessageActionTurnCapability } from "./code-mode-control-tools-B1t6Lt9X.js";
import { c as getFinishedSession, l as getSession } from "./bash-process-registry--IqPmVga.js";
import { a as formatDoctorNonInteractiveHint, f as writeRestartSentinel, n as clearRestartSentinel, t as buildRestartSuccessContinuation } from "./restart-sentinel-LeBKd1mT.js";
import { t as resolveConversationCapabilityProfile } from "./conversation-capability-profile-DmJDM--X.js";
import { a as supportsModelTools } from "./openclaw-tools-CoDz4vSH.js";
...
import { n as routeReply } from "./route-reply-D-Csqzxb.js";
import { t as clearSessionQueues } from "./cleanup-BTmg1VqF.js";
...
import { a as getTtsMaxLength, c as isSummarizationEnabled, g as resolveTtsConfig, l as isTtsEnabled, o as getTtsPersona, u as listTtsPersonas, v as resolveTtsPrefsPath } from "./tts-settings-Cim3tOQK.js";
import { C as getResolvedSpeechProviderConfig, _ as setTtsProvider, c as getLastTtsAttempt, d as setLastTtsAttempt, f as setSummarizationEnabled, g as setTtsPersona, h as setTtsMaxLength, m as setTtsEnabled, t as getTtsProvider, w as isTtsProviderConfigured } from "./runtime-api-h4IEqjLu.js";
import { n as textToSpeech } from "./tts-C8gjifd4.js";
import { n as redactConfigObject, r as redactConfigSnapshot, t as REDACTED_SENTINEL } from "./redact-snapshot-Ba1hEL2u.js";
import "./sandbox-BHXEMQc2.js";
import { t as buildSystemPromptReport } from "./system-prompt-report-DkESfz4H.js";
import { n as agentHarnessExposesOpenClawTools, s as selectAgentHarness } from "./selection-C25zbbCu.js";
...
import { a as markCommandSessionMetadataChanged, n as handleGoalCommand } from "./commands-goal-CjxjuA9q.js";
import { r as resolveConversationBindingContextFromAcpCommand } from "./conversation-binding-input-CMVPiS7Y.js";
import "./commands-registry-BlZ2e_EW.js";
import { n as applyCommandTextToParams } from "./command-context-rewrite-DyA5NUca.js";
import { a as rejectNonOwnerCommand, c as requireGatewayClientScope, i as matchCommandPrefix, n as commandReply, o as rejectUnauthorizedCommand, r as defineAuthorizedTextCommand, s as requireCommandFlagEnabled, t as buildDisabledCommandReply } from "./command-gates-K4MNWh5a.js";
...
import { n as formatAbortReplyText, r as stopSubagentsForRequester, t as abortSessionRunTargetWithOutcome } from "./abort-DU3oW05_.js";
import { n as formatTimeAgo } from "./format-relative-Dd106CpA.js";
import { n as setChannelConversationBindingMaxAgeBySessionKey, t as setChannelConversationBindingIdleTimeoutBySessionKey } from "./conversation-bindings-DKCej-2i.js";
import { l as removeChannelAllowFromStoreEntry, n as addChannelAllowFromStoreEntry, s as readChannelAllowFromStore } from "./pairing-store-CTy8U4zO.js";
import { n as formatNonClawHubInstallWarning, t as NON_CLAWHUB_INSTALL_FORCE_FLAG } from "./install-provenance-DZLEqpF9.js";
import { t as handleSystemAgentCommand } from "./commands-system-agent-BNmPddrv.js";
import { n as resolveSkillWorkshopToolPolicyAvailability } from "./tool-policy-diagnostic-IsE5Fe-8.js";
...
import { a as resolveSkillCommandInvocation, t as listSkillCommandsForAgents } from "./chat-commands-Cx9Vx76N.js";
import { t as persistReplySessionEntry } from "./session-entry-persistence-DSn-gj0Z.js";
import { n as resolveEffectiveToolInventory, t as resolveConfiguredModelCompat } from "./tools-effective-inventory-HmRDRLTd.js";
import { t as extractBtwQuestion } from "./btw-command-Cwm__JSS.js";
import { r as handleModelsCommand } from "./commands-models-DmEVPSZZ.js";
import { n as buildCommandsMessagePaginated, r as buildHelpMessage, t as buildCommandsMessage } from "./command-status-builders-_FDy5jl8.js";
import { t as codexChannelLoginRuntime } from "./provider-auth-login-flow-runtime-u7vJL4Pu.js";
import { r as createExecTool } from "./bash-tools-C4TYtaEA.js";
import { t as runBtwSideQuestion } from "./btw-DHlyxthF.js";
import { a as loadCostUsageSummary, n as loadSessionCostSummary } from "./session-cost-usage-BwjPDyx8.js";
import { n as buildThreadingToolContext } from "./agent-runner-utils-BkLX1YsA.js";
import { C as stopWithText, b as resolveAcpAction, d as COMMAND, x as resolveAcpHelpText } from "./shared-Bdey-L6B.js";
import { a as resolveHandledPrefix, c as resolveSubagentsAction, l as stopWithText$1, o as resolveRequesterSessionKey } from "./shared-BPW2e5et.js";
import { t as buildToolsMessage } from "./status-D0flTd1d.js";
import { n as resolveCommandSurfaceChannel, t as resolveChannelAccountId } from "./channel-context-BogzwAwC.js";
import { t as handleApproveCommand } from "./commands-approve-BtCi9eP4.js";
import { t as buildConfigSchema } from "./schema-qdtW9X1e.js";
import { t as loadGatewayRuntimeConfigSchema } from "./runtime-schema-BK3xUfCG.js";
import { t as parseConfigValue } from "./config-value-D2VJu0bm.js";
import { t as resolveCommandsSystemPromptBundle } from "./commands-system-prompt-Dam4-kEw.js";
import { n as buildStatusReply, t as buildStatusPluginsReply } from "./commands-status-DtAuwU_o.js";
...
import { a as buildPluginDiagnosticsReport, c as formatPluginCompatibilityNotice, o as buildPluginInspectReport, t as buildAllPluginInspectReports } from "./status-DIL63tje.js";
import { t as buildPluginRegistrySnapshotReport } from "./status-snapshot-CHYBr89L.js";
import { a as selectInstallMutationWriteOptions, i as resolveInstallConfigMutationPreflights } from "./install-persistence-0w6g-lDo.js";
import { t as withPluginLifecycleLease } from "./plugin-lifecycle-lease-Cz3f3Szj.js";
import { r as resolvePluginInstallSourcePlan } from "./plugin-install-plan-trBTcHgG.js";
import { n as createPluginInstallLogger } from "./plugins-command-helpers-zRqY0Cb2.js";
import { t as CLAWHUB_INSTALL_ERROR_CODE } from "./clawhub-error-codes-OgrR1N6P.js";
import "./clawhub-CE8R--1P.js";
import { a as installManagedPluginSource } from "./management-service-GShWA1U7.js";
...
const lifecycleHandlersLoader = createLazyImportLoader(() => import("./lifecycle-oZREpsl0.js"));
const runtimeOptionHandlersLoader = createLazyImportLoader(() => import("./runtime-options-XM4n_j6F.js"));
const diagnosticHandlersLoader = createLazyImportLoader(() => import("./diagnostics-Bpsto5a0.js"));
...
async function resolveContextReport(params) {
	...
	const { resolveCommandsSystemPromptBundle } = await import("./commands-system-prompt-CxBk94wV.js");
...
const actionAgentsLoader = createLazyImportLoader(() => import("./action-agents-CABH8tPM.js"));
const actionFocusLoader = createLazyImportLoader(() => import("./action-focus-CgWyhAFK.js"));
const actionHelpLoader = createLazyImportLoader(() => import("./action-help-GIki0510.js"));
const actionInfoLoader = createLazyImportLoader(() => import("./action-info-CWPHSuUj.js"));
const actionListLoader = createLazyImportLoader(() => import("./action-list-DPsX5Ubh.js"));
const actionLogLoader = createLazyImportLoader(() => import("./action-log-DOcP9OLr.js"));
const actionUnfocusLoader = createLazyImportLoader(() => import("./action-unfocus-ergDNPEm.js"));
