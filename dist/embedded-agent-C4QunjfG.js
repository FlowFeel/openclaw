...
import { c as resolveAgentDir, d as resolveDefaultAgentDir, f as resolveDefaultAgentId, s as resolveAgentContextLimits, u as resolveAgentWorkspaceDir } from "./agent-scope-config-Dusa8eSA.js";
...
import { g as withAgentRunLifecycleGeneration, n as captureAgentRunLifecycleGeneration, s as getAgentEventLifecycleGeneration, t as assertAgentRunLifecycleGenerationCurrent, u as onAgentEvent } from "./agent-events-COCf-9-O.js";
import { _ as retainQueuedAgentRunContext, a as getAgentRunContext, n as claimAgentRunContext, p as registerAgentRunContext } from "./agent-run-registry-BluEqSPq.js";
import { N as withPluginRuntimeRegistryScope, S as requireActivePluginRegistry } from "./runtime-yJAYArQt.js";
import { c as resolveContextConfigProviderForRuntime, d as resolveSelectedOpenAIRuntimeProvider, i as isOpenAIProvider, n as OPENAI_PROVIDER_ID, v as normalizeOptionalAgentRuntimeId } from "./openai-routing-G4z6ipSe.js";
import { _ as resolveSessionAgentIds, h as resolveRunModelFallbacksOverride, r as hasConfiguredModelFallbacks } from "./agent-scope-DyEposw2.js";
import { l as providerModelRouteAcceptsAuthMode } from "./openai-model-routes-NsaPlbzf.js";
import { s as sleepWithAbort } from "./src-DKBD8PDy.js";
import { t as isPluginMetadataSnapshotCompatible } from "./plugin-metadata-snapshot-DtW_P3kZ.js";
...
import { nt as isIncognitoOpenClawAgentSqlitePath } from "./openclaw-agent-db--PLC25lY.js";
import { r as resolveSubscriptionAuthModeForProfiles } from "./profile-list-BV1ORe-C.js";
import { o as isProfileInCooldown } from "./usage-state-C6UiSWt7.js";
import { a as resolveSecretSentinel, r as looksLikeSecretSentinel } from "./sentinel-DVfNmxPl.js";
import { t as applyPreparedRuntimeAuthToModel } from "./provider-request-config-DZemMjbU.js";
import { a as unwrapSecretSentinelsForProviderEgress, t as protectPreparedProviderRuntimeAuth } from "./provider-secret-egress-J5B4EL1L.js";
import { c as resolveContextEngineOwnerPluginId, s as resolveContextEngine } from "./registry-DxqpqZwd.js";
import { t as getGlobalHookRunner } from "./hook-runner-global-CRNklGqK.js";
import { i as copyReplyPayloadMetadata, t as FAST_MODE_AUTO_PROGRESS_KIND } from "./reply-payload-BtIUrr9c.js";
import { r as MAX_IMAGE_BYTES } from "./constants-Mf57IYS0.js";
import { l as resolveStorePath } from "./paths-DSnYpBD3.js";
import { P as normalizeUsage, k as deriveContextPromptTokens, o as appendSqliteTranscriptMessage, st as loadSqliteSessionEntry } from "./session-accessor.sqlite-B9iW7DOt.js";
import { i as normalizeMessageChannel } from "./message-channel-normalize-Bmutiks_.js";
import { o as isMarkdownCapableMessageChannel } from "./message-channel-1n7hD5_u.js";
import { n as parseSqliteSessionFileMarker, t as formatSqliteSessionFileMarker } from "./legacy-sqlite-marker-COPKCuIN.js";
import { d as readPersistedMediaFacts, s as isImageMediaFact } from "./media-facts-D_wLZOa9.js";
import { $ as listSessionEntries, K as updateSessionEntry, r as resolveSessionTranscriptRuntimeReadTarget } from "./session-accessor-t3qUoTeV.js";
import "./backoff-CCtTkmwj.js";
import { a as resolveProviderAuthProfileId, d as resolveProviderRuntimePluginHandle } from "./provider-hook-runtime-CJN_HH27.js";
import { x as prepareProviderRuntimeAuth } from "./provider-runtime-ByIbzpnW.js";
...
import { a as markAuthProfileFailure, d as resolveProfilesUnavailableReason, o as markInlineProviderApiKeyFailure } from "./usage-CM9l2_CL.js";
import { Ct as classifyRateLimitWindow } from "./sessions-Digi7ATr.js";
import { c as hasOnlyAssistantReasoningContent } from "./ai-transport-runtime-host-BuwNINnx.js";
...
import { n as SecretSurfaceUnavailableError } from "./runtime-degraded-state-V0p9ck6P.js";
import { n as isToolResultError } from "./tool-result-error-D4i-Z2FR.js";
...
import { n as acquireReadOnlyPreparedModelRuntime, s as prepareModelRuntimeSnapshot, t as acquireAgentRunPreparedModelRuntime } from "./prepared-model-runtime-BoxOFkXM.js";
import "./auth-profiles-BCkmjCRk.js";
import { n as markAuthProfileSuccess } from "./profiles-B5_Ws1zV.js";
import { s as isConfigBackedInlineProviderApiKey } from "./model-auth-provider-config-CaDHRX5w.js";
import { i as getApiKeyForModel, n as applyLocalNoAuthHeaderOverride, t as applyAuthHeaderOverride } from "./model-auth-D32HIbZ7.js";
...
import { t as ensureSelectedAgentHarnessPlugin } from "./runtime-plugin-q2V_5kgr.js";
import { S as isTimeoutErrorMessage, n as formatBillingErrorMessage } from "./sanitize-user-facing-text-Ba4C3tZ5.js";
import { C as parseImageSizeError, S as parseImageDimensionError, _ as isFailoverErrorMessage, c as extractObservedOverflowTokenCount, f as isAuthAssistantError, g as isFailoverAssistantError, h as isCompactionFailureError, i as classifyFailoverReason, l as formatAssistantErrorText, p as isBillingAssistantError, r as classifyAssistantFailoverReason, v as isGenericUnknownStreamErrorMessage, y as isRateLimitAssistantError } from "./errors-B811vGBl.js";
import { n as isLikelyContextOverflowError } from "./context-overflow-DNey-WOn.js";
import { a as describeFailoverError, i as coerceToFailoverError, p as resolveFailoverStatus, t as FailoverError } from "./failover-error-CMC-wGmM.js";
import { d as projectAgentRunAttemptTerminal, r as buildAgentRunTerminalOutcomeFromAttempt } from "./agent-run-terminal-outcome-Bl2pG_Kc.js";
import { a as createAgentRunDirectAbortError } from "./run-termination-BeCPtaNS.js";
import { c as resolveFastModeForElapsed, l as resolveFastModeModelAutoOnSeconds, n as formatFastModeAutoProgressText } from "./fast-mode-BORk623r.js";
import { t as DEFAULT_AGENT_TIMEOUT_MS } from "./timeout-BEGWfRGM.js";
import { j as resolveCompactionTimeoutMs, k as compactContextEngineWithSafetyTimeout } from "./diagnostic-D_EA4nFT.js";
import { b as resolveActiveEmbeddedRunHandleSessionIdBySessionFile, d as isEmbeddedAgentRunHandleActive, r as clearActiveEmbeddedRun, w as setActiveEmbeddedRun, y as resolveActiveEmbeddedRunHandleSessionId } from "./runs-ehu0VRUR.js";
import "./sessions-CBo4LOdS.js";
import { i as resolveModelCostConfig, t as estimateUsageCost } from "./usage-format-BjulFdpS.js";
import { c as resolveAgentHarnessPreparedAuthSupport, i as resolveCandidateThinkingLevel, l as resolveAgentHarnessPreparedRouteSupport } from "./thinking-runtime-1FRCPyWR.js";
import "./fast-mode-DRb2pnqM.js";
import { l as isMainSessionRestartRecoveryInputProvenance } from "./input-provenance-CYGbY89H.js";
import { t as pickFallbackThinkingLevel } from "./embedded-agent-helpers-zm6jLxdk.js";
import { $ as createToolTerminalObserver, B as resolveSilentToolResultReplyPayload, C as clearProviderPromptState, D as resolveAgentRunSessionTarget, E as applyAgentRunSessionTargetIdentity, F as resolveIncompleteTurnPayloadText, H as shouldRetrySilentErrorAssistantTurn, I as resolveReasoningOnlyRetryInstruction, L as resolveReplayInvalidFlag, M as hasAttemptTerminalState, N as hasYieldContinuationEvidence, P as resolveEmptyResponseRetryInstruction, R as resolveRunLivenessState, T as markLastProviderPromptContextRejected, U as shouldTreatEmptyAssistantReplyAsSilent, V as shouldRetryMissingAssistantTurn, W as isStrictAgenticExecutionContractActive, Z as applyResolvedToolPromptFinalizer, a as resolveAttemptWorkspaceSandbox, c as createEmbeddedRunStageTracker, et as createEmbeddedRunReplayState, j as YIELD_DIAGNOSTIC_TEXT, l as formatEmbeddedRunStageSummary, n as measureEmbeddedAgentPreparation, nt as emitAgentItemEvent, o as EMBEDDED_RUN_ATTEMPT_DISPATCH_STAGE, s as createEmbeddedRunStageSummaryEmitter, tt as observeReplayMetadata, w as getProviderPromptState, z as resolveSettledToolTerminalContinuationInstruction } from "./builtin-openclaw-CYuvs_0I.js";
...
import { o as getCommandLaneSnapshot, r as enqueueCommandInLane } from "./command-queue-BbrEP4i9.js";
import { l as retireSessionMcpRuntime, u as retireSessionMcpRuntimeForSessionKey } from "./agent-bundle-mcp-manager-api-BO7-Y1u4.js";
...
import { t as ensureContextEnginesInitialized } from "./init-CgsTDx_o.js";
import { d as waitForDeferredTurnMaintenanceForSession, f as buildContextEngineRuntimeSettings, u as runContextEngineMaintenance } from "./agent-end-side-effects-OmZZY1Jt.js";
import { n as maybeCompactAgentHarnessSession, r as isRecoverableNativeHarnessBindingFailure, t as resolveContextEngineCompactionSuccessor } from "./compaction-successor-Dvu_s22I.js";
import { r as resolveModelAsync, t as createEmptyAgentDiscoveryStores } from "./model-DdLCu9LE.js";
import { t as materializePreparedRuntimeModel } from "./materialize-model-Bp8i5w8L.js";
import { n as canRunPreparedAgentRuntimeAuthAttempt, r as prepareAgentRuntimeAuth } from "./prepare-auth-CocQW4Ze.js";
import { i as resolveCredentialScopedAuthAttemptModelDecision, n as hasPreparedAuthAttemptModelMetadata, r as providerUsesCredentialScopedModelMetadata, t as createPreparedRuntimeModelMaterializer } from "./credential-scoped-model-CjrMvAKP.js";
import { t as log$3 } from "./logger-BeJ7WAxI.js";
import { m as hasOutboundDeliveryEvidence, p as hasMessagingToolDeliveryEvidence } from "./delivery-evidence-hC0w28qO.js";
import { n as isExecLikeToolName } from "./tool-error-summary-DDV0ZoKC.js";
import { b as resolveContextEngineCapabilities, f as buildEmbeddedCompactionRuntimeContext, p as resolveCompactionContextTokenBudget, r as forgetPromptBuildDrainCacheForRun, y as listActiveProcessSessionReferences } from "./attempt.prompt-helpers-BfWmAA4S.js";
import { a as resolveDelegationCapability, n as resolveProcessToolScopeKey } from "./agent-tools-CpYejLH6.js";
import { A as settleRequesterAfterSessionSpawns } from "./subagent-registry-DBvWqYln.js";
...
import { i as LiveSessionModelSwitchError, r as shouldUseTransientCooldownProbeSlot } from "./failover-policy-CREBEvs_.js";
import { _ as buildApiErrorObservationFields, y as shouldSuppressRawErrorConsoleSuffix } from "./model-fallback-attempt-DCerkT6E.js";
import { a as resolveStoredSessionKeyForSessionId, i as resolveSessionKeyForRequest } from "./session-BfLchzC-.js";
import { a as resolveSessionSuspensionTarget, c as suspendSession, i as resolveSessionSuspensionReason } from "./session-suspension-DMbHqSuh.js";
...
import { c as truncateOversizedToolResultsInActiveTarget, o as sessionLikelyHasOversizedToolResults } from "./transcript-visibility-0PUROgcA.js";
...
import { n as resolveSystemPromptRepoRoot } from "./system-prompt-params-DHodj0v2.js";
import { i as readPersistedMediaImageLayout, t as detectAndLoadPromptImages } from "./images-B2Oatti_.js";
import { o as prepareEmbeddedSessionActiveProjectKeys, r as getEmbeddedSessionPromptState } from "./session-prompt-state-6IEK6xZr.js";
import { a as runAgentCleanupStep, r as resolveSettledTurnFinalizationText } from "./settled-turn-finalization-result-CnDUUCjr.js";
import { t as createTrajectoryRuntimeRecorder } from "./runtime-DfPrTYmB.js";
import { S as mergeUsageIntoAccumulator, _ as resolveRateLimitProfileRotationLimit, a as buildUsageAgentMetaFields, b as createUsageAccumulator, c as resolveActiveErrorContext, d as resolveFinalAssistantVisibleText, f as resolveLatestCallUsage, g as resolveOverloadProfileRotationLimit, h as resolveOverloadFailoverBackoffMs, i as buildErrorAgentMeta, l as resolveEmbeddedAttemptBasePrompt, m as resolveNextSameModelRateLimitRetryCount, n as RUNTIME_AUTH_REFRESH_MIN_DELAY_MS, o as createCompactionDiagId, p as resolveMaxRunRetryIterations, r as RUNTIME_AUTH_REFRESH_RETRY_MS, s as isAssistantForModelRef, t as RUNTIME_AUTH_REFRESH_MARGIN_MS, u as resolveFinalAssistantRawText, v as resolveReportedModelRef, x as mergeAttemptRunStatsIntoAccumulator, y as resolveSameModelRateLimitRetryDelayMs } from "./helpers-DOU3STAD.js";
import { a as runAgentHarnessAttempt, c as selectAgentHarnessForPreparedModelProviders, o as runAgentHarnessSettledTurnFinalization, s as selectAgentHarness, t as agentHarnessBuildsOpenClawTools } from "./selection-rDYHmLIn.js";
import { t as DEFERRED_CONTEXT_ENGINE_COMPACTION_REASON } from "./compact-reasons-BdRFPqua.js";
import { d as persistCompactionCheckpoint, i as asCompactionHookRunner, l as runPostCompactionSideEffects, n as prepareCompactionHarnessAuth, r as resolveCompactionRuntimeSelection, t as resolveProjectKey, u as compactionCheckpointStore } from "./project-memory-scope-Cd3odU1E.js";
import { n as buildHandledBeforeAgentReplyPayloads, r as runBeforeAgentReplyForTurn, t as buildEmbeddedRunPayloads } from "./payloads-D6s1CroT.js";
import { n as resolveRunWorkspaceDir, t as redactRunIdentifier } from "./workspace-run-Dt0CVS5Z.js";
import { r as stripOpenClawMcpToolPrefix } from "./tool-policy-Cq4UBQeI.js";
import { t as resolveEmbeddedCliBackendDispatchEligibility } from "./cli-backend-dispatch-eligibility-Bl2Skaux.js";
import { n as buildAgentRuntimePlan } from "./build-C4_N1ffh.js";
import { n as createAgentHarnessTaskRuntimeScope } from "./agent-harness-task-runtime-scope-CyimyMWZ.js";
import { a as resizeExecApprovalContinuationPrompt } from "./bash-tools.exec-approval-output-gUsadhCg.js";
import { i as shouldSwitchToLiveModel, n as clearLiveModelSwitchPending, t as mergeAttemptToolMediaPayloads } from "./tool-media-payloads-DU0JbpS6.js";
import { a as resolveHookModelSelection, i as resolveEmbeddedRuntimeModelPolicy, n as createNativeModelOwnedRuntimeModel, o as resolveNativeModelOwnedHarnessId, r as resolveAgentHarnessRunAdmissionError, t as buildBeforeModelResolveAttachments } from "./setup-36TLEaJJ.js";
import { t as formatAuthProfileFailureMessage } from "./failure-copy-BxXcpEBa.js";
import { t as resolveExternalCliAuthOverlayScopeFromSelection } from "./external-cli-auth-selection-C2ntn8sf.js";
import { a as withSessionPlacementTurnAdmission } from "./session-placement-admission-BEJd445g.js";
import { n as readChannelSourceTurnId, r as readChannelSourceTurnSameThreadRequired } from "./source-turn-id-DBX5_no8.js";
...
async function compactEmbeddedAgentSession(params) {
	...
	if (resolvedParams.trigger !== "manual") return await compactEmbeddedAgentSessionImpl(resolvedParams);
...
async function compactEmbeddedAgentSessionImpl(inputParams) {
	...
	const runtimeSelection = resolveCompactionRuntimeSelection({
		...
		selectedHarnessRuntime: params.modelSelectionLocked === true ? normalizeOptionalAgentRuntimeId(params.agentHarnessId) : void 0
	});
	...
	const run = async () => {
		...
		try {
			return await compactResolvedContextEngine(params, contextEngine, agentDir, resolvedWorkspaceDir, lease.snapshot, () => {
...
async function compactResolvedContextEngine(params, contextEngine, agentDir, resolvedWorkspaceDir, preparedModelRuntime, releaseContextEngineOwnership) {
	const runtimeTarget = await resolveAgentRunSessionTarget(params);
	...
	try {
		...
		const { model: ceModel, authStorage, modelRegistry } = await resolveModelAsync(ceRuntimeProvider, ceModelId, agentDir, params.config, {
			...initialModelAuth,
			...preparedStores,
...
async function retireDispatchSessionMcpRuntime(params) {
	try {
		const { retireSessionMcpRuntime, retireSessionMcpRuntimeForSessionKey } = await import("./agent-bundle-mcp-tools-XfIG9Zav.js");
...
//#endregion
//#region src/agents/embedded-agent-runner/run/plugin-harness-prompt-images.ts
function toTypeOnlyImageFact(fact, hydrationSuppressed) {
	return {
		contentType: fact.contentType,
		kind: fact.kind === "sticker" ? "sticker" : "image",
		messageId: fact.messageId,
		transcribed: fact.transcribed,
		...fact.hydrationSuppressed === true || hydrationSuppressed ? { hydrationSuppressed: true } : {}
	};
}
...
async function preparePluginHarnessPromptImages(params) {
	...
	if (!params.pluginHarnessOwnsTransport) return {
		images: runParams.images,
		imageOrder: runParams.imageOrder,
		media: runParams.media
	};
	const persistedMessage = runParams.userTurnTranscriptRecorder?.message ?? await runParams.userTurnTranscriptRecorder?.resolveMessage();
	...
	if (!hydrationMedia?.some(isImageMediaFact)) return {
		images: runParams.images,
		imageOrder: runParams.imageOrder,
		media: runParams.media
	};
	...
	const result = await detectAndLoadPromptImages({
		...
		localRoots: workspace.effectiveFsWorkspaceOnly ? [workspace.effectiveWorkspace, workspace.resolvedWorkspace] : void 0,
		workspaceOnly: workspace.effectiveFsWorkspaceOnly,
		sandbox: workspace.sandbox?.enabled && workspace.sandbox.fsBridge ? {
			root: workspace.sandbox.workspaceDir,
			bridge: workspace.sandbox.fsBridge
		} : void 0
	});
	if (result.failedMediaCount > 0) throw new Error(`failed to hydrate ${result.failedMediaCount} structured image attachment(s) for plugin harness input`);
	const materializedFactIndexes = new Set(result.imageFactIndexes.filter((index) => index !== null));
	const retainedMedia = hydrationMedia?.map((fact, factIndex) => isImageMediaFact(fact) ? toTypeOnlyImageFact(fact, !materializedFactIndexes.has(factIndex)) : fact);
	return {
		images: result.images,
		imageOrder: result.images.length > 0 ? result.images.map(() => "inline") : void 0,
		media: retainedMedia?.length ? retainedMedia : void 0
	};
}
//#endregion
...
async function dispatchEmbeddedRunAttempt(input) {
	...
	const rawAttempt = await runEmbeddedAttemptWithBackend(attemptParams).catch((err) => {
...
async function prepareAndDispatchEmbeddedRunAttempt(input) {
	...
	const resolvedTranscriptTarget = (existingSessionTarget?.sessionKey === resolvedSessionKey || sessionPromptState.sessionTargetAdopted ? existingSessionTarget : void 0) ?? (resolvedSessionKey ? await resolveSessionTranscriptRuntimeReadTarget({
...
function applyEmbeddedAttemptSessionIdentity(params) {
	...
	if (sessionFileUsed && sessionFileChanged) {
		...
		if (marker) {
			...
			const retainedEntry = retainedSessionKey ? loadSqliteSessionEntry({
			...
			const keyedEntry = loadSqliteSessionEntry({
...
function normalizeEmbeddedRunAttemptResult(attempt) {
	...
	return {
		...
		replayMetadata: raw.replayMetadata ?? {
...
function buildContextEngineCompactionSessionTarget(params) {
	...
	const suppliedEntry = marker && candidateSessionKey ? loadSqliteSessionEntry({
		agentId: marker.agentId,
		sessionKey: candidateSessionKey,
		storePath: marker.storePath
	}) : void 0;
	const markerMatches = marker ? listSessionEntries({
		agentId: marker.agentId,
		storePath: marker.storePath
	}).filter(({ entry }) => entry.sessionId === marker.sessionId) : [];
	...
	const markerSessionKey = marker ? suppliedEntry?.sessionId === marker.sessionId ? candidateSessionKey : candidateSessionKey && !suppliedEntry ? candidateSessionKey : preferredMarkerSessionKey ?? (markerMatches.length === 0 ? marker.sessionId : void 0) : void 0;
	if (marker && !markerSessionKey) throw new Error("Legacy compaction transcript identity is ambiguous");
	...
	const sessionKey = completeTarget ? targetSessionKey : marker ? markerSessionKey : targetSessionKey ?? suppliedSessionKey ?? targetSessionId ?? params.sessionId;
	const agentId = targetAgentId ?? marker?.agentId ?? params.agentId ?? resolveAgentIdFromSessionKey(sessionKey, resolveDefaultAgentId(params.config ?? {}));
	const storePath = targetStorePath ?? marker?.storePath ?? resolveStorePath(params.config?.session?.store, { agentId });
	return {
		agentId,
...
function assertAgentHarnessRunAdmission(params) {
	...
	const durableEntry = loadSqliteSessionEntry({
...
async function recoverEmbeddedRunOverflow(input) {
	...
	const providerPromptRejection = contextOverflowError.source === "assistantError" || projectAgentRunAttemptTerminal(input.attempt.terminal).promptErrorSource === "prompt" ? markLastProviderPromptContextRejected(getProviderPromptState(input.runParams.runId)) : void 0;
			...
			if (preflightRecovery?.route === "compact_then_truncate") {
				...
				const truncResult = await truncateOversizedToolResultsInActiveTarget({
					...
					maxCharsOverride: resolveLiveToolResultMaxChars({
						contextWindowTokens: input.contextTokenBudget,
						...resolveAgentContextLimits(runParams.config, input.sessionAgentId)?.maxResultChars ? { maxResultCharsOverride: resolveAgentContextLimits(runParams.config, input.sessionAgentId)?.maxResultChars } : {}
					}),
...
async function recoverEmbeddedRunAttempt(input) {
	...
	const params = runInput.runParams;
	const runtime = preparedRuntime.snapshot();
	const { attempt, sessionIdUsed, attemptAssistant, currentAttemptCompletedAssistant, terminalState, setTerminalLifecycleMeta, attemptCompactionCount, activeErrorContext, resolveReplayInvalidForAttempt, assistantErrorText, canRestartForLiveSwitch } = normalizedAttempt;
...
function resolveSettledTurnFinalizationRequest(input) {
	...
	return resolveSettledToolTerminalContinuationInstruction({
		...
		allowEmptyStopContinuation: input.runParams.terminalReplyExpectation === "required" || input.runParams.terminalReplyExpectation == null && (input.runParams.trigger == null || input.runParams.trigger === "user" || input.runParams.trigger === "manual"),
		payloadCount,
...
function completeEmbeddedRun(input) {
	...
	const terminalPayloads = input.emptyAssistantReplyIsSilent ? [{ text: SILENT_REPLY_TOKEN }] : input.payloadsForTerminalPath?.length ? input.payloadsForTerminalPath : input.attempt.yieldDetected && !yieldHasContinuation ? [{ text: YIELD_DIAGNOSTIC_TEXT }] : input.payloadsForTerminalPath;
	input.setTerminalLifecycleMeta({
		replayInvalid,
		livenessState,
		stopReason,
...
async function runPreparedSettledTurnFinalization(input) {
	return await withEmbeddedRunLaneProgressHeartbeat(input.noteLaneTaskProgress, async () => {
		return buildSettledTurnFinalizationAttemptResult({
			result: await runEmbeddedSettledTurnFinalizationWithBackend({
				...input.attempt,
...
function createAgentTurnTaintState() {
	let tainted = false;
	return {
		observe(observation) {
...
async function runPreparedEmbeddedLoop(input) {
	...
	ensureContextEnginesInitialized();
	const contextEngine = await measureEmbeddedAgentPreparation("context-engine", () => resolveContextEngine(params.config, {
		agentDir,
		workspaceDir: resolvedWorkspace
	}), { config: params.config });
	...
	try {
		...
		while (true) {
			...
			latestMcpAppChannelView = dispatchedAttempt.rawAttempt.latestMcpAppChannelView ?? latestMcpAppChannelView;
			...
			const { attempt: terminalAttempt, attemptAssistant: terminalAttemptAssistant, terminalState: resolvedTerminalState, attemptCompactionCount: terminalAttemptCompactionCount, prepared: terminalPrepared, finalizationAttempted: settledTurnFinalizationAttempted } = finalizedTerminal;
			lastRunPromptUsage = finalizedTerminal.lastRunPromptUsage;
			if (finalizedTerminal.finalizationSucceeded) assistantProfileFailureReason = null;
			const { agentMeta, reportedModelRef, finalAssistantVisibleText, finalAssistantRawText, payloads, payloadsWithToolMedia, timedOutDuringPrompt, recoveredFinalAssistantPayloadsAfterPromptTimeout, hasSuccessfulFinalAssistantAfterPromptTimeout, hasPartialAssistantTextAfterPromptTimeout, attemptToolSummary, failureSignal } = terminalPrepared;
...
function createEmbeddedRunLaneController(options) {
	...
	const enqueueSession = (task, opts) => {
		...
		let queuedRun;
		try {
			if (params.enqueue) queuedRun = params.enqueue(taskWithLaneAdmission, withRunLaneWait(sessionOpts));
			else {
				noteLaneWaitIfBusy(options.sessionLane);
				queuedRun = enqueueCommandInLane(options.sessionLane, taskWithLaneAdmission, withRunLaneWait(sessionOpts));
			}
		} catch (error) {
			releaseQueuedContext("abandoned");
			throw error;
...
async function runEmbeddedAgentInternal(paramsInput) {
	...
	return enqueueSession(async () => {
		...
		return enqueueGlobal(async () => {
			...
			}).map((candidate) => requestedHarnessRuntime ? {
			...
			const preparedModelRuntimeLease = await withEmbeddedRunLaneProgressHeartbeat(noteLaneTaskProgress, () => params.preparedModelRuntimeMode === "isolated-read-only" ? acquireReadOnlyPreparedModelRuntime(preparedInput) : acquireAgentRunPreparedModelRuntime(preparedInput, { retainIdleRunOwner }));
			...
			try {
				...
				return await withPluginRuntimeRegistryScope(preparedModelRuntime.pluginRegistry, runPrepared);
			} finally {
