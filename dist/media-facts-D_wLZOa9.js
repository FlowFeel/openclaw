...
import { c as kindFromMime, i as getFileExtension, l as mimeTypeFromFilePath, u as normalizeMimeType } from "./mime-Ir6g3Vae.js";
...
function readPersistedMediaFactInputs(message) {
	...
	const media = metadata && typeof metadata === "object" && !Array.isArray(metadata) ? metadata.media : void 0;
	return Array.isArray(media) ? media : void 0;
}
...
function canonicalizePersistedUserMessageMedia(message) {
	...
	const openclaw = metadata && typeof metadata === "object" && !Array.isArray(metadata) ? { ...metadata } : {};
...
function isImageMediaFact(fact) {
	if (fact.kind && fact.kind !== "unknown") return fact.kind === "image" || fact.kind === "sticker";
	...
	if (inferredMime === "image/svg+xml") return false;
	if (kindFromMime(inferredMime) === "image") return true;
...
function normalizeMediaFact(media, index, defaults = {}) {
	...
	return {
		...
		contentType,
		kind: media.kind ?? defaults.kind ?? (isGenericBinaryMediaContentType(contentType) ? void 0 : kindFromMime(contentType)),
...
//#endregion
export { hasStagedMediaFacts as a, isMeaningfulMediaFact as c, readPersistedMediaFacts as d, readRuntimePromptImageOrder as f, stripLegacyMediaContextFields as g, resolveStagedMediaFacts as h, hasMeaningfulRetiredMediaCarrier as i, normalizeMediaFacts as l, resolveMediaFacts as m, attachRuntimePromptMediaFacts as n, isGenericBinaryMediaContentType as o, readRuntimePromptMediaFacts as p, canonicalizePersistedUserMessageMedia as r, isImageMediaFact as s, PERSISTED_LEGACY_MEDIA_KEYS as t, projectMediaFacts as u };
