...
import { at as resolveOwnerPromptNumbers, r as getRuntimeConfig } from "./io-DCw4R0kD.js";
...
import { n as CHAT_CHANNEL_ORDER, r as normalizeChatChannelId } from "./ids-DcuH-YRr.js";
import { o as findChatChannelMeta } from "./registry-Ddw5GtUg.js";
import { r as getLoadedChannelPluginForRead } from "./registry-loaded-BSz-9sMZ.js";
import { a as listOpenAIAuthProfileProvidersForAgentRuntime, c as resolveContextConfigProviderForRuntime } from "./openai-routing-G4z6ipSe.js";
...
import { h as runWithGatewayIndependentRootWorkContinuation } from "./gateway-work-admission-D_DdbtmL.js";
...
import { c as normalizeSessionDeliveryState, d as sessionDeliveryOrigin, f as sessionDeliveryRoute, n as deliveryContextFromSession, o as normalizeDeliveryChannelRoute, r as deliveryContextKey, s as normalizeDeliveryContext, u as sessionDeliveryChannel } from "./delivery-context.shared-B-QSuGw_.js";
...
import { Ct as buildSessionCreationStamp, st as loadSqliteSessionEntry, wt as sessionEntryForkedFromParent, yt as resolveSessionStorePathForScope } from "./session-accessor.sqlite-B9iW7DOt.js";
...
import { $ as conversationIdentityFromMsgContext, at as deriveSessionMetaPatch } from "./targets-Dooi6t13.js";
import { t as formatSqliteSessionFileMarker } from "./legacy-sqlite-marker-COPKCuIN.js";
import { T as DEFAULT_RESET_TRIGGERS, _t as interruptSessionWorkAdmissions, q as resolveMaintenanceConfigFromInput, wt as runExclusiveSessionStoreWrite, xt as runExclusiveSessionLifecycleMutation, y as resolveAgentHarnessSessionContextError } from "./session-entry-slot-keys-DR5d2mKt.js";
import { a as hasStagedMediaFacts, l as normalizeMediaFacts, s as isImageMediaFact } from "./media-facts-D_wLZOa9.js";
import { M as loadReplySessionInitializationSnapshot, j as commitReplySessionInitialization } from "./session-accessor-t3qUoTeV.js";
...
import { g as isWorkspaceBootstrapPending, p as ensureAgentWorkspace } from "./workspace-CelKqYGr.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-BsZayE7D.js";
import { g as registerMainSessionGroupWatch, n as classifySessionStateActor, t as acknowledgeSessionStateNotices, u as recordSessionCreated, y as decodeSessionStateNoticeContextKey } from "./session-state-events-MWtkoPhW.js";
import { a as enqueueSystemEvent, l as peekSystemEventEntries, t as consumeSelectedSystemEventEntries } from "./system-events-fsxpbPNB.js";
...
import { i as setAbortMemory, n as isAbortRequestText, t as getAbortMemory } from "./abort-primitives-i7c2CWmO.js";
import { t as hasControlCommand } from "./command-detection-5NC1E5MR.js";
import { n as isInternalSourceReplyChannel } from "./source-reply-delivery-mode-DBkd7D2I.js";
import "./delivery-context-BPtbSx1b.js";
import { n as resolveAgentTimeoutMs } from "./timeout-BEGWfRGM.js";
import { D as resolveActiveReplyRunThreadId, E as resolveActiveReplyRunSessionId, N as waitForReplyRunEndBySessionId, g as isReplyRunActiveForSessionId, o as abortReplyRunBySessionId, t as REPLY_RUN_IDLE_SETTLE_TIMEOUT_MS, w as replyRunRegistry, y as isReplyRunStreamingForSessionId } from "./reply-run-registry-tXvcNkN4.js";
import { a as isSessionWorkStartInvalidatedError, o as resolveSessionLifecycleTimestamps, r as hasTerminalMainSessionTranscriptNewerThanRegistry, s as resolveSessionWorkStartError } from "./lifecycle-CeMojaXs.js";
import { n as resolveSessionResetPolicy, t as evaluateSessionFreshness } from "./reset-policy-efjZRFhj.js";
import { n as resolveSessionResetType, r as resolveThreadFlag, t as resolveChannelResetConfig } from "./reset--HEclQZS.js";
import { n as resolveSessionKey } from "./session-key-CY0q26lB.js";
import { a as resolveEffectiveAgentRuntime, n as hasResolvedThinkingCatalogEntry } from "./thinking-runtime-93ZQ8Ibj.js";
import { t as resolveFastModeState } from "./fast-mode-DRb2pnqM.js";
import { n as normalizeQueueDropPolicy, r as normalizeQueueMode } from "./settings-B9QZfJQM.js";
import { c as isInterSessionInputProvenance, r as annotateInterSessionPromptText } from "./input-provenance-CYGbY89H.js";
import { o as resolveReplyToMode } from "./reply-threading-DWyGycTp.js";
import { o as HEARTBEAT_TRANSCRIPT_PROMPT, u as stripHeartbeatToken } from "./heartbeat-Cw1AzhxC.js";
import { o as sanitizePendingFinalDeliveryText, t as PENDING_FINAL_DELIVERY_CLEAR_PATCH } from "./pending-final-delivery-BzZojDaN.js";
import { n as buildMainSessionRecoveryClearPatch } from "./main-session-recovery-clear-BngYLTap.js";
import { a as createUserTurnTranscriptRecorder, c as resolvePersistedUserTurnText } from "./user-turn-transcript-Cd8sokau.js";
import { n as clearCommandLane, s as getQueueSize } from "./command-queue-Cl58ne2E.js";
import { l as retireSessionMcpRuntime } from "./agent-bundle-mcp-manager-api-BO7-Y1u4.js";
import "./agent-bundle-mcp-tools-qs9ydpAf.js";
import { n as resolveChannelGroupRequireMention } from "./group-policy-BC5uZemX.js";
import { z as normalizeExecTarget } from "./exec-approvals-DpQk_nvk.js";
import { t as buildOutboundSessionContext } from "./session-context-DdqCb4cM.js";
import { d as isChannelProgressDraftWorkToolName, f as isCommandToolName } from "./streaming-Byu76Sav.js";
import { t as collectTextContentBlocks } from "./content-blocks-DRK0dze4.js";
import { M as resolveBootstrapMode } from "./openclaw-tools-BF-TS9dq.js";
...
import { i as resolveParentForkDecision, r as forkSessionFromParent } from "./session-fork-BU0em0SK.js";
...
import { t as resolveQueueSettings } from "./queue-DIufyn8Z.js";
import { i as normalizeInboundTextNewlines, t as finalizeInboundContext } from "./inbound-context-BIpjK7pv.js";
import { i as toInternalMessagePreprocessedContext, n as deriveInboundMessageHookContext, s as toInternalMessageTranscribedContext } from "./message-hook-mappers-B6i6KSrI.js";
import { t as clearAllCliSessions } from "./cli-session-BYqPb4bQ.js";
...
import { i as updateAmbientTranscriptWatermark } from "./ambient-transcript-watermark-C1PEpxU7.js";
import { i as isExecCompletionEvent } from "./heartbeat-events-filter-sLs_6Z5x.js";
import { a as appendChannelPromptContext, c as buildInboundMediaNoteProjection, n as MEDIA_ONLY_USER_TEXT, t as isReasoningTagProvider } from "./provider-utils-y6gc_xvb.js";
import { a as resolveTimezone, n as formatUtcTimestamp, r as formatZonedTimestamp } from "./format-datetime-Bp7Mn3G9.js";
import { n as resolveEmbeddedFullAccessState } from "./sandbox-info-CKzCKg96.js";
...
import { n as resolveUtilityModelRefForAgent } from "./utility-model-DQIZKWEI.js";
...
import { t as cleanupBrowserSessionsForLifecycleEnd } from "./browser-lifecycle-cleanup-Dxv5_nqj.js";
...
import { a as createReplyTimingTracker, d as resolveSilentReplySettings, i as resolveEffectiveReplyRoute, n as createReplySessionEntryHandle, r as isSystemEventProvider, s as admitReplyTurn } from "./session-entry-handle-nOo0NulB.js";
import { s as takeCommandSessionMetadataChangesFromTargets } from "./commands-goal-CjxjuA9q.js";
...
import { i as resolveStoredModelOverride, t as isStaleHeartbeatAutoFallbackOverride } from "./stored-model-override-Cmtyl-oa.js";
...
import { a as stripMentions, o as stripStructuralPrefixes } from "./mentions-DAmJ29JV.js";
import { r as HISTORY_CONTEXT_MARKER } from "./history-DLKGD0Dj.js";
import { n as shouldUseFromAsSenderFallback } from "./command-auth-C7VE93x4.js";
...
import { t as resolveEffectiveResetTargetSessionKey } from "./acp-reset-target-kuN-1SsC.js";
...
import { n as clearSessionResetRuntimeState, t as resolveResetPreservedSelection } from "./reset-preserved-selection-BgFZjmIi.js";
import { t as emitSessionAutoResetHook } from "./session-auto-reset-Bs72jkPR.js";
import { a as resolveEnvelopeFormatOptions } from "./envelope-DYPQHVWk.js";
import { n as runWithSessionInitConflictRetry, t as ReplySessionInitConflictError } from "./session-init-conflict-retry-D_-aTChM.js";
import { t as normalizeGroupActivation } from "./group-activation-MKTJBUwi.js";
import { t as ensureSessionDiffBaseline } from "./session-diff-baseline-DEG0opbr.js";
import { t as resolveBlockStreamingChunking } from "./block-streaming-B6qHjcBF.js";
import { t as buildCommandContext } from "./commands-context-5rYZwhm-.js";
import { n as resolveModelRuntimeDirective } from "./directive-handling.model-runtime-CLQOQyMI.js";
import { n as resolveModelSelectionFromDirective, t as maybeHandleUnexpectedNativeDirectiveArguments } from "./directive-handling.native-gjCU50Dg.js";
...
import { n as createModelSelectionState, t as createFastTestModelSelectionState } from "./model-selection-dFmCV_n0.js";
import { n as extractExplicitGroupId, t as formatElevatedUnavailableMessage } from "./elevated-unavailable-BjUfVUYI.js";
import { t as resolveRuntimePolicySessionKey } from "./runtime-policy-session-key-C23Br4Oe.js";
import { a as resolveSkillCommandInvocation, i as listReservedChatSlashCommandNames, o as resolveSkillReferenceInvocations, r as hasSkillReferenceCandidate } from "./chat-commands-Cx9Vx76N.js";
import { t as persistReplySessionEntry } from "./session-entry-persistence-DSn-gj0Z.js";
import { n as resolvePreparedReplyQueueState } from "./get-reply-run-queue-stNf2ypN.js";
import { a as buildInboundUserContextPrefix, c as resolveInboundUserContextPromptJoiner, i as buildInboundMetaSystemPrompt, l as resolveActiveRunQueueAction, o as formatActiveGoalContext, r as resolveTypingMode, t as resolveCurrentTurnImages } from "./current-turn-images-3Y2C1neI.js";
import { t as buildChannelSummary } from "./channel-summary-BXYcAyjn.js";
import { n as consumeSessionSkillSuggestion } from "./skill-suggestions-CwhvRyrc.js";
import { n as resolveEffectiveToolInventory } from "./tools-effective-inventory-DfMduyhC.js";
import { n as flushSessionActivityAssistantNote, r as noteSessionActivityEvent, t as createSessionActivityNoteState } from "./session-activity-notes-C_nHogVp.js";
import { t as PROGRESS_STATUS_PREAMBLE_FRESH_MS } from "./progress-draft-compositor-CSgfZcLh.js";
import { a as sanitizeProgressStatusText } from "./progress-draft-status-text-CcADy0Te.js";
import { t as isResetAuthorizedForContext } from "./reset-authorization-D58MeXAh.js";
...
const directiveLevelsLoader = createLazyImportLoader(() => import("./directive-handling.levels-CXtmjoHL.js"));
const directiveImplLoader = createLazyImportLoader(() => import("./directive-handling.impl-B2NRipHE.js"));
...
const skillToolDispatchRuntimeLoader = createLazyImportLoader(() => import("./tool-dispatch-CAjXunje.js"));
const abortCutoffRuntimeLoader = createLazyImportLoader(() => import("./abort-cutoff.runtime.js"));
const commandsRuntimeLoader$1 = createLazyImportLoader(() => import("./commands.runtime-DBydW55V.js"));
...
const commandsRuntimeLoader = createLazyImportLoader(() => import("./commands.runtime-DBydW55V.js"));
const skillCommandsRuntimeLoader = createLazyImportLoader(() => import("./chat-commands.runtime.js"));
const statusCommandRuntimeLoader = createLazyImportLoader(() => import("./commands-status-BIoWzmVL.js"));
...
const embeddedAgentRuntimeLoader = createLazyImportLoader(() => import("./embedded-agent.runtime-2w2ds8IR.js"));
...
const sessionAccessorRuntimeLoader = createLazyImportLoader(() => import("./session-accessor-DnNtcMuD.js"));
...
const loadDeliverRuntime = createLazyPromiseLoader(() => import("./runtime-9cdhOTW9.js"), { cacheRejections: true }).load;
...
async function getReplyFromConfig(ctx, opts, configOverride) {
	...
	if (usePublishedModelRuntime && !isFastTestEnv) {
		const owner = await (await import("./prepared-model-catalog-BddDieHg.js")).loadResolvedPublishedModelCatalogOwner({ agentId });
		...
		if (opts?.isHeartbeat) {
			if (classifyHeartbeatPendingFinalDelivery(text, resolveHeartbeatAckMaxChars(cfg, agentId)).shouldClear) {
				...
				if (sessionKey && storePath) {
					const { updateSessionEntry } = await import("./session-accessor-DnNtcMuD.js");
