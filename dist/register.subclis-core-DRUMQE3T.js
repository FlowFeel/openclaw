...
async function registerGatewayRunOnly(program) {
	const { addGatewayRunCommand } = await import("./run-command-CCozw4Dv.js");
...
const entrySpecs = [
	...defineImportedProgramCommandGroupSpecs([
		...
		},
		{
			...
			loadModule: () => import("./gateway-cli-CL_vdBfI.js"),
		...
		{
			commandNames: ["models"],
			loadModule: () => import("./models-cli-D0W3yBE7.js"),
			exportName: "registerModelsCli"
		},
		{
			commandNames: ["promos"],
			loadModule: () => import("./promos-cli-B8UcdRTf.js"),
			exportName: "registerPromosCli"
		},
		{
			commandNames: ["infer", "capability"],
			loadModule: () => import("./capability-cli-BB3s9ZhN.js"),
	...
	...defineImportedProgramCommandGroupSpecs([
		...
		{
			commandNames: ["worker"],
			loadModule: () => import("./worker-cli-Bas8LGd4.js"),
		...
		},
		{
			...
			loadModule: () => import("./tui-cli-MW2RDWzp.js"),
		...
		{
			commandNames: ["hooks"],
			loadModule: () => import("./hooks-cli-BiYcjMdZ.js"),
	...
	},
	{
		...
		register: async (program, argv) => {
			await registerSubCliWithPluginCommands(program, argv, async () => {
				(await import("./plugins-cli-DI3Yi7qc.js")).registerPluginsCli(program);
			}, "after");
		}
	},
	{
		...
		register: async (program, argv, context) => {
			await (await import("./channels-cli-CWPMa1ZZ.js")).registerChannelsCli(program, argv, { includeSetupOptions: context.purpose === "completion" });
		}
	},
	...defineImportedProgramCommandGroupSpecs([
		{
			commandNames: ["directory"],
			loadModule: () => import("./directory-cli-BCteBoTM.js"),
		...
		{
			commandNames: ["skills"],
			loadModule: () => import("./skills-cli-D9lkFDx6.js"),
			exportName: "registerSkillsCli"
		},
		{
			commandNames: ["update"],
			loadModule: () => import("./update-cli-BhhBolIG.js"),
