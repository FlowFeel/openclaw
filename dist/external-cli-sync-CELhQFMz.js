...
import { a as resolveOsHomeRelativePath } from "./home-dir-Cs7bTrwJ.js";
import { r as normalizeProviderId } from "./provider-id-BIcU_2-A.js";
import { t as createSubsystemLogger } from "./subsystem-Cr19cPPQ.js";
import { S as log$1, _ as EXTERNAL_CLI_SYNC_TTL_MS, a as isSafeToAdoptBootstrapOAuthIdentity, c as shouldBootstrapFromExternalCliCredential, d as isSafeToCopyOAuthIdentity, h as CLAUDE_CLI_PROFILE_ID, i as hasUsableOAuthCredential, t as areOAuthCredentialsEquivalent, v as MINIMAX_CLI_PROFILE_ID, x as OPENAI_CODEX_DEFAULT_PROFILE_ID } from "./oauth-shared-B-oYylTU.js";
...
function readCodexCliActiveApiKey(options) {
	...
	const candidates = [];
	const raw = loadJsonFile(path.join(codexHome, CODEX_CLI_AUTH_FILENAME));
...
//#endregion
export { readCodexCliActiveApiKey as a, readClaudeCliCredentialsCached as i, readExternalCliBootstrapCredential as n, readCodexCliCredentialsCached as o, resolveExternalCliAuthProfiles as r, readGeminiCliCredentialsCached as s, isSafeToUseExternalCliCredential as t };
