...
async function runStructuredDoctorHealthContribution(params) {
	...
	const { runDoctorHealthRepairs } = await import("./doctor-repair-flow-BmG8mzV0.js");
	const { resolveAgentWorkspaceDir, resolveDefaultAgentId } = await import("./agent-scope-Jqp3H3Rj.js");
...
async function runStructuredHealthRepairs(ctx, resolveCoreChecks) {
	...
	const { registerBundledHealthChecks } = await import("./bundled-health-checks-BI3dVEeC.js");
...
async function runCoreContributionHealth(ctx, checkIds) {
	...
	const { CORE_HEALTH_CHECKS } = await import("./doctor-core-checks-BMpSa9M7.js");
	const { runDoctorHealthRepairs } = await import("./doctor-repair-flow-BmG8mzV0.js");
	const { resolveAgentWorkspaceDir, resolveDefaultAgentId } = await import("./agent-scope-Jqp3H3Rj.js");
	const { note } = await import("./terminal-core/note.js");
