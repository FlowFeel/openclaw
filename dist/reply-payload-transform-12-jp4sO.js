...
import { J as requireOpenAllowFrom, _ as DmPolicySchema, b as GroupPolicySchema } from "./zod-schema.agent-runtime-CaWcMFul.js";
...
import { f as requireChannelOpenAllowFrom } from "./extension-shared-C6go2BUn.js";
import "./channel-config-schema-DElcW4F1.js";
import { a as createEventCard, i as createAgendaCard, n as createDeviceControlCard, r as createMediaPlayerCard, t as createAppleTvRemoteCard } from "./flex-templates-TnKb3ImC.js";
...
function parseLineDirectives(payload) {
	...
	if (locationMatch && !lineData.location) {
		...
		if (parts.length >= 4) {
			...
			if (address && latitude !== void 0 && longitude !== void 0) lineData.location = {
