...
import { c as hasTailscaleFunnelRouteForPort, i as enableTailscaleServe, n as disableTailscaleServe, o as getTailnetHostname, r as enableTailscaleFunnel, s as getTailnetHostnameAfterServe, t as disableTailscaleFunnel } from "./tailscale-CDFP6Kpp.js";
...
async function startGatewayTailscaleExposure(params) {
	...
	try {
		...
		const host = await (params.tailscaleMode === "serve" && !preservedFunnel ? getTailnetHostnameAfterServe() : getTailnetHostname()).catch(() => null);
		if (host) {
