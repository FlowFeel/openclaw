...
import "./types-CgiR85I_.js";
import { i as extractTextContent } from "./query-b-c3PQeX.js";
import { i as normalizeActiveSummary, l as truncateSummary } from "./prompt-OW3Ekruj.js";
import { c as isUnavailableMemorySearchDebug, i as fileTranscriptSource, l as resolveTranscriptReadLimits, o as hasUnavailableMemoryResultInSessionRecord, s as hasUsableMemoryResultInSessionRecord, u as streamActiveMemoryTranscriptRecords } from "./transcript-iV-dU20k.js";
import { i as readMergedActiveMemoryTranscriptState } from "./transcript-watch-Cq9z62kN.js";
...
async function buildTimeoutRecallResult(params) {
	...
	return summary.length === 0 || isUnavailableMemorySearchDebug(searchDebug) || !subagentPartialData.settled || params.hasUnavailableMemorySearchResult || subagentPartialData.hasUnavailableMemorySearchResult || transcriptState?.hasUnavailableMemorySearchResult ? {
		status: "timeout",
...
function buildSubagentRecallResult(params) {
	...
	if (summary.length > 0 && hasUsableMemoryResult) return {
		status: "ok",
		elapsedMs: params.elapsedMs,
		rawReply,
		summary,
