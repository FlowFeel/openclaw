...
import { n as CLI_OUTBOUND_SEND_FACTORY } from "./outbound-send-deps-9PgpYcx6.js";
...
function createDefaultDeps() {
	...
	const resolveSender = (channelId) => createLazySender(channelId, async () => {
		const { createChannelOutboundRuntimeSend } = await import("./channel-outbound-send-B2UDszR9.js");
