...
import { c as ModelProviderDeclarationConfig, i as ModelDefinitionConfig, s as ModelProviderConfig } from "./types.models-Cbb-WeIa.js";
import { Hn as ProviderCatalogContext, Un as ProviderCatalogResult, i as ProviderPlugin } from "./types-DdUyjaEr.js";
...
declare function readManifestProviderDefaultModelRef(manifest: unknown, providerId: string): string | undefined;
/**
...
declare function buildManifestProviderCatalogFamily(params: {
  surfaces: readonly ManifestProviderCatalogSurface[];
  docsPath?: string;
}): {
  entries: ManifestProviderCatalogEntry[];
  staticDiscovery: ProviderPlugin[];
...
declare function buildManifestModelDefinition(params: {
  /** Provider id that owns the manifest catalog row. */providerId: string; /** Raw manifest modelCatalog provider block that contains the row. */
  catalog: unknown; /** Optional provider policy applied after manifest normalization. */
...
//#endregion
export { buildManifestModelDefinition as a, clearLiveCatalogCacheForTests as c, readManifestProviderDefaultModelRef as d, supportsNativeStreamingUsageCompat as f, findCatalogTemplate as h, applyProviderNativeStreamingUsageCompat as i, getCachedLiveCatalogValue as l, buildSingleProviderApiKeyCatalog as m, ManifestProviderCatalogEntry as n, buildManifestModelProviderConfig as o, buildPairedProviderApiKeyCatalog as p, ManifestProviderCatalogSurface as r, buildManifestProviderCatalogFamily as s, ConfiguredProviderCatalogEntry as t, readConfiguredProviderCatalogEntries as u };