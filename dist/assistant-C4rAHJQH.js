...
async function runConfiguredSystemAgentText(params) {
	...
	try {
		...
		text = extractPlannerResultText(route.runner === "cli" ? await (params.deps?.runCliAgent ?? (await import("./cli-runner-CUWjD261.js")).runCliAgent)({
			...shared,
			executionMode: "side-question",
			cleanupCliLiveSessionOnRunEnd: true
		}) : await (params.deps?.runEmbeddedAgent ?? (await import("./embedded-agent-A4lbfjQj.js")).runEmbeddedAgent)({
			...shared,
			toolsAllow: [],
