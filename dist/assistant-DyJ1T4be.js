...
async function runConfiguredSystemAgentText(params) {
	...
	try {
		...
		text = extractPlannerResultText(route.runner === "cli" ? await (params.deps?.runCliAgent ?? (await import("./cli-runner-5ZVub1v0.js")).runCliAgent)({
			...shared,
			executionMode: "side-question",
			cleanupCliLiveSessionOnRunEnd: true
		}) : await (params.deps?.runEmbeddedAgent ?? (await import("./embedded-agent-Bv58Yqvq.js")).runEmbeddedAgent)({
			...shared,
			toolsAllow: [],
