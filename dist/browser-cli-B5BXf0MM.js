...
import { n as shouldEagerRegisterSubcommands } from "./command-registration-policy-DfVbI5Fh.js";
import { t as addGatewayClientOptions } from "./gateway-rpc-D_6iKrfK.js";
...
import { n as resolveBrowserLazySubcommand } from "./cli-output-mode-Brd5DK2D.js";
...
const browserCommandGroupDefinitions = [
	{
		...
		register: async (args) => {
			(await import("./browser-cli-manage-DlP9JiiI.js")).registerBrowserManageCommands(args.browser, args.parentOpts);
		}
	},
	{
		...
		register: async (args) => {
			(await import("./browser-cli-inspect-DEkU4NOv.js")).registerBrowserInspectCommands(args.browser, args.parentOpts);
		}
	},
	{
		placeholders: [
		...
		register: async (args) => {
			(await import("./browser-cli-actions-input-VRXvGkWX.js")).registerBrowserActionInputCommands(args.browser, args.parentOpts);
		}
	},
	{
		placeholders: [
		...
		register: async (args) => {
			(await import("./browser-cli-actions-observe-C_uavhrD.js")).registerBrowserActionObserveCommands(args.browser, args.parentOpts);
		}
	},
	{
		placeholders: [
		...
		register: async (args) => {
			(await import("./browser-cli-debug-Dm6i7DD7.js")).registerBrowserDebugCommands(args.browser, args.parentOpts);
		}
	},
	{
		placeholders: [
		...
		register: async (args) => {
			(await import("./browser-cli-state-Dsi3wqkE.js")).registerBrowserStateCommands(args.browser, args.parentOpts);
		}
	},
	{
		placeholders: [command("extension", "Chrome extension load path and pairing")],
		register: async (args) => {
			(await import("./browser-cli-extension-BL1E18bc.js")).registerBrowserExtensionCommands(args.browser, args.parentOpts, args.pluginRoot);
		}
	}
];
