...
import "./accounts-D_Dh8MtW.js";
import "./runtime-api-BJ6Osx34.js";
import { r as getMe, t as ZaloApiError } from "./api-Cab6ipRQ.js";
import { t as resolveZaloProxyFetch } from "./proxy-mO11GDEH.js";
import { t as sendMessageZalo } from "./send-BvMvsMcG.js";
...
async function notifyZaloPairingApproval(params) {
	const { resolveZaloAccount } = await import("./accounts-BJwbLzNR.js");
...
async function startZaloGatewayAccount(ctx) {
	...
	const { monitorZaloProvider } = await import("./monitor-DCtNzz67.js");
