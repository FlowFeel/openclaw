...
import { o as onSubagentRegistryPersisted } from "./subagent-registry-state-jajoFCVZ.js";
import { f as getSubagentRunsByRunIds } from "./subagent-registry-C4ALZQd0.js";
import { y as resolveSubagentCompletionResultText } from "./subagent-registry-helpers-DG9sluup.js";
...
function createAgentsWaitTool(opts) {
	...
	return {
		...
		description: "Wait for collector subagents started by sessions_spawn collect=true. Accepts many run ids; returns once any completes (completed results incl. structured output, plus pending ids), or on timeoutSeconds.",
...
//#endregion
export { waitForCollectorCompletion as i, SWARM_CODE_MODE_REQUEST_FINGERPRINT as n, createAgentsWaitTool as r, SWARM_CODE_MODE_IDEMPOTENCY_KEY as t };
