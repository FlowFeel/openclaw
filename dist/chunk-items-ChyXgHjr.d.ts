...
//#endregion
export { stripToolCallXmlTags as $, MarkdownParseOptions as A, MarkdownStyle as B, RenderStyleMap as C, RenderedMarkdownChunk as D, RenderMarkdownIRChunksWithinLimitOptions as E, markdownToIR as F, sanitizeAssistantVisibleText as G, FormatCapabilityProfile as H, markdownToIRWithMeta as I, stripAssistantInternalScaffolding as J, sanitizeAssistantVisibleTextWithOptions as K, sliceMarkdownIR as L, MarkdownTableData as M, MarkdownTableMeta as N, renderMarkdownIRChunksWithinLimit as O, chunkMarkdownIR as P, stripMinimaxToolCallXml as Q, MarkdownAnnotationSpan as R, RenderOptions as S, renderMarkdownWithMarkers as T, AssistantVisibleTextSanitizerProfile as U, MarkdownStyleSpan as V, sanitizeAssistantFinalAnswerText as W, stripDowngradedToolCallText as X, stripAssistantInternalTraceLines as Y, stripLegacyBracketToolCallBlocks as Z, findCodeRegions as _, sanitizeReplyDirectiveId as a, isAutoLinkedFileRef as b, stripInlineDirectiveTagsFromMessageForDisplay as c, ReasoningTagMode as d, ReasoningTagScope as f, CodeRegion as g, stripReasoningTagsFromText as h, parseInlineDirectives as i, MarkdownTableCell as j, MarkdownIR as k, sanitizeTerminalText as l, hasOrphanReasoningCloseBoundary as m, DisplayMessageWithContent as n, stripInlineDirectiveTagsForDelivery as o, ReasoningTagTrim as p, sanitizeAssistantVisibleTextWithProfile as q, InlineDirectiveParseResult as r, stripInlineDirectiveTagsForDisplay as s, chunkItems as t, stripMarkdown as u, isInsideCode as v, RenderStyleMarker as w, RenderLink as x, FILE_REF_EXTENSIONS_WITH_TLD as y, MarkdownLinkSpan as z };