...
import { An as preprocess, At as boolean, Bt as discriminatedUnion, Et as array, Ln as strictObject, Nn as record, Qn as url, Rn as string, Tc as config, Tn as object, Xn as union, Zn as unknown, dn as literal, un as lazy, wc as NEVER, wn as number, yt as _enum } from "./schemas-CZ9Toj_c.js";
...
import { A as QueueSchema, B as TtsConfigSchema, C as InboundDebounceSchema, D as ModelsConfigSchema, I as SecretsConfigSchema, L as SsrFPolicyConfigSchema, N as SecretInputSchema, O as NativeCommandsSettingSchema, S as HumanDelaySchema, U as TypingModeSchema, W as VisibleRepliesSchema, X as AgentModelSchema, Y as createAllowDenyChannelRulesSchema, Z as AgentToolModelSchema, a as AgentSandboxSchema, c as MemorySearchSchema, d as BlockStreamingChunkSchema, f as BlockStreamingCoalesceSchema, i as AgentModelRuntimeEntrySchema, n as AgentEntrySchema, o as ElevatedAllowFromSchema, r as AgentModelPolicySchema, s as HeartbeatSchema, t as AgentContextLimitsSchema, u as ToolsSchema, x as HexColorSchema, y as GroupChatSchema } from "./zod-schema.agent-runtime-CaWcMFul.js";
import { s as isValidSecretRef } from "./ref-contract-BVYOI0KD.js";
import { n as sensitive, t as configUiMetadata } from "./zod-schema.sensitive-OPEpgIMg.js";
import { t as isSensitiveConfigPath } from "./sensitive-paths-DYIyGcFS.js";
import { i as ApprovalsSchema, n as ChannelsSchema } from "./zod-schema.channels-config-VtOOhddS.js";
...
const AgentDefaultsSchema = object({
	...
	compaction: object({
		...
		compactAtRatio: number().positive().max(1).optional(),
	...
	runtime: object({
		isolation: _enum([
			...
			"in-process",
			"remote"
		]).optional().describe("Multithreaded runtime isolation mode. auto (default): Scale 0 on 1-CPU, Scale 1 on >1-CPU. disabled: always inline. in-process: worker_threads pool. remote: SSH workers."),
		workerCount: number().int().positive().max(64).optional().describe("Worker pool size for in-process isolation (default: availableParallelism, capped 1–64).")
	}).strict().optional(),
	subagents: object({
...
const CloudWorkersConfigShape = { profiles: record(string().min(1).refine((value) => value === value.trim(), "Worker profile ids must not contain outer whitespace"), CloudWorkerProfileSchema).optional().register(configUiMetadata, {
...
//#endregion
export { CLOUD_WORKER_FIELD_LABELS as a, parseByteSize as c, CLOUD_WORKER_FIELD_HELP as i, McpServerNameSchema as n, validateCloudWorkerProfileSettings as o, NodeHostMcpServerNameSchema as r, parseNonNegativeByteSize as s, OpenClawSchema as t };
