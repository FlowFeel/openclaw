...
const discordChannelConfigUiHints = {
	...
	...createChannelConfigUiHints({
		...
		streaming: {
			...
			"block.enabled": "Enable chunked block-style Discord preview delivery when channels.discord.streaming.mode=\"block\".",
