...
import { n as resolveNormalizedXaiToolModel, r as resolvePositiveIntegerToolConfig, t as coerceXaiToolConfig } from "./tool-config-shared-aky51Auo.js";
import { a as requireXaiResponseTextCitationsAndInline, n as buildXaiResponsesToolBody, o as resolveXaiResponsesEndpoint } from "./responses-tool-shared-CiwtsHL1.js";
...
async function requestXaiXSearch(params) {
	...
	return await postTrustedWebToolsJson({
		...
		return requireXaiResponseTextCitationsAndInline(await readProviderJsonObjectResponse(response, "xAI X search failed"), "xAI X search failed", params.inlineCitations, XAI_X_SEARCH_MAX_CONTENT_CHARS);
	});
}
//#endregion
