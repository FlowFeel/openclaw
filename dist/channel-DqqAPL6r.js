...
import { s as recordChannelBotPairLoopAndCheckSuppression } from "./kernel-CyB9GCRw.js";
import { t as buildChannelOutboundSessionRoute } from "./core-QIH5yboB.js";
...
import { d as dispatchInboundDirectDm } from "./channel-inbound-DgZwCM1p.js";
...
import { tt as randomBytes } from "./hkdf-C7rH9AZE.js";
import { $ as PipelineError, D as loadKeys, E as generateAndStoreKeys, H as reserveReefIdentityBinding, I as finalizeReefIdentityBinding, L as loadReefIdentityBinding, O as openStores, P as assertReefIdentityBinding, T as ReefInboxCursorStore, V as releaseReefIdentityReservation, _t as canonicalBytes, a as REEF_OUTBOUND_DELIVERY_TTL_MS, at as createAnthropicGuard, c as isReefPairingApprovalToken, ct as bodyHash, dt as parseHandleEpoch, et as composeInbound, it as verifyReceipt, l as openReefTrustStore, lt as fingerprint, mt as appendInboxRead, nt as InvalidDeliveryReceiptError, ot as createOpenAiGuard, pt as appendAudit, rt as confirmDelivery, st as REEF_MAX_PLAINTEXT_BYTES, tt as composeOutbound, ut as formatHandleEpoch } from "./doctor-state-paths-CUBPj3Ut.js";
import { a as ReefTransportClient, c as isDefinitiveReefRegistrationFailure, i as ReefInboxConnection, l as isReefOwnershipRejection, n as assertLegacyReefKeysMigrated, o as abortableSleep, r as ReefFriendManager, s as createReefWebSocket, u as isRetryableReefRelayFailure } from "./legacy-key-guard-DZQuih4r.js";
import { a as resolveReefConfig, i as parseReefRelayUrl, n as autonomyBudget, r as normalizeReefTarget, t as ReefChannelConfigSchema } from "./config-schema-DEI_3Fvv.js";
import { a as reefPeerIdentity, i as matchesReefPeerIdentity } from "./friend-types-BXCwAc8D.js";
...
const reefSetupContract = defineChannelSetupContract({
	fields: {},
...
const reefPlugin = {
	...
	gateway: { startAccount: async (ctx) => {
		...
		const inbox = new ReefInboxConnection(transport, (entries) => processReefInboxEntriesInOrder({
			...
			onState: (state) => {
				if (ctx.abortSignal.aborted) return;
				ctx.setStatus(state === "connected" ? channelReadyPatch({ accountId: "default" }) : {
					accountId: "default",
					running: true,
					connected: false,
