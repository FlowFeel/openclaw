...
//#endregion
export { resolveTimestampMsToIsoString as A, resolveExpiresAtMsFromDurationSeconds as C, resolveOptionalIntegerOption as D, resolveNonNegativeIntegerOption as E, resolvePositiveTimerTimeoutMs as O, resolveExpiresAtMsFromDurationOrEpoch as S, resolveIntegerOption as T, parseStrictNonNegativeInteger as _, asDateTimestampMs as a, resolveDateTimestampMs as b, asSafeIntegerInRange as c, finiteSecondsToTimerSafeMilliseconds as d, isFutureDateTimestampMs as f, parseStrictInteger as g, parseStrictFiniteNumber as h, addTimerTimeoutGraceMs as i, timestampMsToIsoString as j, resolveTimerTimeoutMs as k, clampPositiveTimerTimeoutMs as l, parseFiniteNumber as m, MAX_TIMER_TIMEOUT_MS as n, asFiniteNumber as o, nonNegativeSecondsToSafeMilliseconds as p, MAX_TIMER_TIMEOUT_SECONDS as r, asFiniteNumberInRange as s, MAX_DATE_TIMESTAMP_MS as t, clampTimerTimeoutMs as u, parseStrictPositiveInteger as v, resolveExpiresAtMsFromEpochSeconds as w, resolveExpiresAtMsFromDurationMs as x, positiveSecondsToSafeMilliseconds as y };