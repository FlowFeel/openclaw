...
import { c as hasConfiguredSecretInput, m as normalizeSecretInputString } from "./types.secrets-BvApkFoj.js";
...
import { f as createTopLevelChannelParsedAllowFromPrompt, j as setSetupChannelEnabled, l as createTopLevelChannelDmPolicy, p as mergeAllowFromEntries, x as patchTopLevelChannelConfigSection, y as parseSetupEntriesWithParser } from "./setup-wizard-helpers-Br2IavKW.js";
...
import { a as parseRelayUrls, i as createNostrSetupStatus, n as createNostrSetupAdapter, o as DEFAULT_RELAYS, r as createNostrSetupContract, t as buildNostrSetupPatch } from "./setup-adapter-DYoC9ZHs.js";
...
const { listAccountIds: listNostrAccountIds, resolveDefaultAccountId: resolveDefaultNostrAccountId } = createAccountListHelpers("nostr", {
	...
	resolveImplicitAccountId: (cfg) => {
		...
		return normalizeSecretInputString(account?.privateKey) ? normalizeOptionalAccountId(account?.defaultAccount) ?? "default" : void 0;
	}
});
/**
