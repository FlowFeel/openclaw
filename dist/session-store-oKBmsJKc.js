...
import { M as hasNonzeroUsage, j as deriveSessionTotalTokens, lt as patchSqliteSessionEntry } from "./session-accessor.sqlite-B9iW7DOt.js";
import { P as setSessionRuntimeModel, q as resolveMaintenanceConfigFromInput } from "./session-entry-slot-keys-DR5d2mKt.js";
...
import { n as clearCliSession, o as setCliSessionBinding, s as setCliSessionId } from "./cli-session-BYqPb4bQ.js";
...
const contextModuleLoader = createLazyImportLoader(() => import("./context-yzITBIn4.js"));
...
async function recordCliCompactionInStore(params) {
	...
	if (Boolean(newSessionId && newSessionId !== entry.sessionId) && newSessionId) {
		delete next.sessionFile;
