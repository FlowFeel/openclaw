...
import { f as resolveSessionMutationAuthorization, t as SessionMutationAuthorizationChangedError } from "./session-sharing-C3cQJ56a.js";
...
const CORE_GATEWAY_HANDLER_MODULES = {
	agent: () => import("./agent-dFi7Xjbl.js").then((module) => module.agentHandlers),
	"agent-identity": () => import("./agent-identity-BDBliwMO.js").then((module) => module.agentIdentityHandlers),
	agents: () => import("./agents-CqpiKyU2.js").then((module) => module.agentsHandlers),
	"agents-workspace": () => import("./agents-workspace-B0zysbXZ.js").then((module) => module.agentsWorkspaceHandlers),
	artifacts: () => import("./artifacts-B5jHH4S5.js").then((module) => module.artifactsHandlers),
	board: () => import("./board-Bjr7GTcK.js").then((module) => module.boardHandlers),
	...
	attach: () => import("./attach-BoYptOzX.js").then((module) => module.attachHandlers),
	...
	chat: () => import("./chat-BFhJENKi.js").then((module) => module.chatHandlers),
	commands: () => import("./commands-DTE0Rt5u.js").then((module) => module.commandsHandlers),
	config: () => import("./config-CwjWCfxH.js").then((module) => module.configHandlers),
	conversations: () => import("./conversations-BYn_ZB3j.js").then((module) => module.conversationHandlers),
	connect: () => import("./connect-Culw5M5d.js").then((module) => module.connectHandlers),
	"control-ui": () => import("./control-ui-CLdIm43i.js").then((module) => module.controlUiHandlers),
	cron: () => import("./cron-DoFSWS4i.js").then((module) => module.cronHandlers),
	...
	doctor: () => import("./doctor-Ctc0SDjV.js").then((module) => module.doctorHandlers),
	...
	health: () => import("./health-BPC3pTWe.js").then((module) => module.healthHandlers),
	logs: () => import("./logs-CKcMVdRF.js").then((module) => module.logsHandlers),
	"memory-search": () => import("./memory-search-Bv4yWdse.js").then((module) => module.memorySearchHandlers),
	terminal: () => import("./terminal-DRO0RqW8.js").then((module) => module.terminalHandlers),
	"ui-command": () => import("./ui-command-BVkyadDV.js").then((module) => module.uiCommandHandlers),
	"models-auth-status": () => import("./models-auth-status-BXm7pXrE.js").then((module) => module.modelsAuthStatusHandlers),
	models: () => import("./models-CBhBeJk6.js").then((module) => module.modelsHandlers),
	"models-probe": () => import("./models-probe-CBfoCs4a.js").then((module) => module.modelsProbeHandlers),
	"native-hook-relay": () => import("./native-hook-relay-BK61FA1I.js").then((module) => module.nativeHookRelayHandlers),
	"nodes-pending": () => import("./nodes-pending-DgyqzfW_.js").then((module) => module.nodePendingHandlers),
	nodes: () => import("./nodes-bAyjqjqt.js").then((module) => module.nodeHandlers),
	"plugin-host-hooks": () => import("./plugin-host-hooks-CPVxynKl.js").then((module) => module.pluginHostHookHandlers),
	plugins: () => import("./plugins-DMHZ7KFP.js").then((module) => module.pluginsHandlers),
	migrations: () => import("./migrations-JDRyV9xW.js").then((module) => module.migrationsHandlers),
	push: () => import("./push-KKAxDzeF.js").then((module) => module.pushHandlers),
	restart: () => import("./restart-GQNtFq_q.js").then((module) => module.restartHandlers),
	suspend: () => import("./suspend-C_i-1euL.js").then((module) => module.suspendHandlers),
	send: () => import("./send-CyFG4VUx.js").then((module) => module.sendHandlers),
	"sessions-files": () => import("./sessions-files-DDFesm9q.js").then((module) => module.sessionsFilesHandlers),
	"sessions-diff": () => import("./sessions-diff-D_D2OAYd.js").then((module) => module.sessionsDiffHandlers),
	"sessions-abort": () => import("./sessions-abort-Cmm_xrza.js").then((module) => module.sessionAbortHandlers),
	"sessions-compact": () => import("./sessions-compact-ovKyT2QC.js").then((module) => module.sessionCompactHandlers),
	"sessions-compaction-checkpoints": () => import("./sessions-compaction-checkpoints-J5js02CJ.js").then((module) => module.sessionCheckpointHandlers),
	"sessions-compaction-queries": () => import("./sessions-compaction-queries-D6weTaI4.js").then((module) => module.sessionCheckpointQueryHandlers),
	"sessions-create": () => import("./sessions-create-CHHijGFp.js").then((module) => module.sessionCreateHandlers),
	"sessions-delete": () => import("./sessions-delete-CUXQVUkq.js").then((module) => module.sessionDeleteHandlers),
	"sessions-dispatch": () => import("./sessions-dispatch-BLrlatVt.js").then((module) => module.sessionDispatchHandlers),
	"sessions-groups": () => import("./sessions-groups-ujuEF-nb.js").then((module) => module.sessionGroupHandlers),
	"sessions-messaging": () => import("./sessions-messaging-o8tQyb_N.js").then((module) => module.sessionMessagingHandlers),
	"sessions-mutations": () => import("./sessions-mutations-m3H7xx8T.js").then((module) => module.sessionMutationHandlers),
	"sessions-read": () => import("./sessions-read-CvtS_I5n.js").then((module) => module.sessionReadHandlers),
	"sessions-rewind": () => import("./sessions-rewind-jp3yRleX.js").then((module) => module.sessionRewindHandlers),
	"sessions-sharing": () => import("./sessions-sharing-DSasZpMa.js").then((module) => module.sessionSharingHandlers),
	"sessions-subscriptions": () => import("./sessions-subscriptions-BST4Rqi7.js").then((module) => module.sessionSubscriptionHandlers),
	"sessions-suggestions": () => import("./sessions-suggestions-CHUzp9FL.js").then((module) => module.sessionSuggestionHandlers),
	"session-catalog": () => import("./session-catalog-BR92k2Y7.js").then((module) => module.sessionCatalogHandlers),
	"session-discussion": () => import("./session-discussion-DaFBhWss.js").then((module) => module.sessionDiscussionHandlers),
	"session-observer-rpc": () => import("./session-observer-rpc-B0fBqz9q.js").then((module) => module.sessionObserverHandlers),
	"session-companion-rpc": () => import("./session-companion-rpc-DV2fmP0m.js").then((module) => module.sessionCompanionHandlers),
	"hooks-status": () => import("./hooks-status-DOI02mN_.js").then((module) => module.hooksStatusHandlers),
	skills: () => import("./skills-CyUkIvKA.js").then((module) => module.skillsHandlers),
	system: () => import("./system-Bv62wdw3.js").then((module) => module.systemHandlers),
	talk: () => import("./talk-DtN9IYMb.js").then((module) => module.talkHandlers),
	tasks: () => import("./tasks-D6BfNWmL.js").then((module) => module.tasksHandlers),
	"task-suggestions": () => import("./task-suggestions-D-IDFlP0.js").then((module) => module.taskSuggestionsHandlers),
	"tools-catalog": () => import("./tools-catalog-NofhzCHl.js").then((module) => module.toolsCatalogHandlers),
	"tools-effective": () => import("./tools-effective-DF0Pe3K0.js").then((module) => module.toolsEffectiveHandlers),
	"tools-invoke": () => import("./tools-invoke-BCgbSaHV.js").then((module) => module.toolsInvokeHandlers),
	"mcp-app": () => import("./mcp-app-DFQ8VyDy.js").then((module) => module.mcpAppHandlers),
	tts: () => import("./tts-DSIcoACp.js").then((module) => module.ttsHandlers),
	update: () => import("./update-9lWQioLu.js").then((module) => module.updateHandlers),
	usage: () => import("./usage-Cq_eJJD4.js").then((module) => module.usageHandlers),
	...
	"system-agent": () => import("./system-agent-Brs0Bs19.js").then((module) => module.systemAgentHandlers),
	"system-changes": () => import("./system-changes-CQ0LRloY.js").then((module) => module.systemChangesHandlers),
	wizard: () => import("./wizard-FOqBy4uo.js").then((module) => module.wizardHandlers)
};
