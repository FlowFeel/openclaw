...
import { r as DEFAULT_HEARTBEAT_FILENAME } from "./workspace-aPJlJwqC.js";
...
import { a as writeCronJobScratch, n as hashCronScratchSource, r as readCronJobScratchState, t as deleteCronJobScratch } from "./scratch-store-UY2vnsGh.js";
import { o as resolveHeartbeatAgents } from "./heartbeat-runner-ByanrMPP.js";
import { t as note } from "./note-uiKX_qfX.js";
import { n as ensureHeartbeatMonitorJobs } from "./doctor-heartbeat-cadence-migration-DIUOBnaa.js";
...
async function collectHeartbeatScratchMigrationFindings(cfg) {
	...
	for (const agent of resolveHeartbeatAgents(cfg)) {
		const heartbeatPath = path.join(resolveAgentWorkspaceDir(cfg, agent.agentId), DEFAULT_HEARTBEAT_FILENAME);
		try {
