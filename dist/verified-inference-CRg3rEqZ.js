import { f as safeRealpathSync } from "./path-D8zNGPJM.js";
...
import { I as resolvePluginRuntimeArtifact } from "./loader-CT1KBBu5.js";
import "./agent-scope-DyEposw2.js";
import "./path-safety-DhI4mL0m.js";
import { c as normalizePluginsConfig } from "./config-state-DrPZVhOu.js";
import { i as loadPluginRegistrySnapshot } from "./plugin-registry-snapshot-z4cuS8rL.js";
...
import { d as resolveOwningPluginIdsForProviderRef, l as resolveOwningPluginIdsForModelRefs } from "./providers-YwyHR_AL.js";
...
import { a as resolveCliRuntimeOwnerFingerprint, i as resolveCliRuntimeArtifactFingerprint, n as resolveCliAuthBindingFingerprint } from "./cli-auth-epoch-B8qvN1lA.js";
...
import "./runtime-plugin-_-F_9ggx.js";
import { n as projectInferenceRoute, r as resolveSystemAgentConfiguredRouteFromConfig } from "./inference-route-Co_fOQeJ.js";
...
async function resolveCurrentAuthFingerprint(params) {
	...
	if (params.authProfileId) {
		...
		if (credential.type === "oauth" || params.route.runner === "embedded" && params.route.agentHarnessRuntimeOverride !== "openclaw") {
			...
			if (!params.modelId || !params.modelApi) return;
			const auth = await (params.deps.resolveApiKeyForProvider ?? resolveApiKeyForProvider)({
				provider: params.route.provider,
				cfg: params.route.runConfig,
				agentDir: params.route.agentDir,
...
async function resolveSystemAgentVerifiedInferenceRoute(binding, deps = {}) {
	...
	const config = snapshot.runtimeConfig ?? snapshot.config;
	const currentRoute = await resolveSystemAgentConfiguredRouteFromConfig(config, binding.execution.agentId, deps);
