...
import { f as readConfigFileSnapshotWithPluginMetadata, z as applyConfigOverrides } from "./io-DCw4R0kD.js";
import { a as measureDiagnosticsTimelineSpan } from "./diagnostics-timeline--Yi1HEPC.js";
import { t as createInvalidConfigError } from "./io.invalid-config-BvEx-KOJ.js";
...
import { c as hasLegacyAuthProfileSourcesForStartup } from "./legacy-source-diagnostic-CQwNDL5h.js";
import { a as prepareSecretsRuntimeFastPathSnapshot, n as collectCandidateAgentDirs } from "./runtime-fast-path-CzHKKCqm.js";
...
import { c as getActiveSecretsRuntimeSnapshotRevision, d as graftActiveSecretsRuntimeAuthState, f as hasActiveSecretsRuntimeSnapshotLineage, h as hasSameSecretReloadContract, p as hasCurrentAuthStoreCredentialsRevision, s as getActiveSecretsRuntimeSnapshot, t as activateSecretsRuntimeSnapshotState } from "./runtime-state-CdeDRMxT.js";
import { n as evaluateGatewayAuthSurfaceStates, t as GATEWAY_AUTH_SURFACE_PATHS } from "./runtime-gateway-auth-surfaces-Yk0_BQV6.js";
import { r as registerProviderAuthRuntimeSnapshotActivationOwner } from "./runtime-provider-auth-activation-Q1nw7laN.js";
import { i as assertGatewayAuthNotKnownWeak, n as mergeGatewayAuthConfig, r as mergeGatewayTailscaleConfig, t as ensureGatewayStartupAuth } from "./startup-auth-CC1KE9pL.js";
...
function createRuntimeSecretsActivator(params) {
	...
	const loadSecretsRuntime = createLazyPromise(() => import("./runtime-BIMATdnS.js"), { cacheRejections: true });
	const loadAuthProfiles = createLazyPromise(() => import("./auth-profiles-DAMYArzq.js"), { cacheRejections: true });
