...
import { o as truncateToVisibleWidth, r as stripAnsi, s as visibleWidth } from "./ansi-DbP9Z_r_.js";
...
import { t as createCliProgress } from "./progress-BjGUBuxw.js";
import { t as note$1 } from "./note-uiKX_qfX.js";
...
function readProgressColumns() {
	const columns = process.stdout.columns;
	if (typeof columns !== "number" || !Number.isFinite(columns) || columns <= 0) return;
	return columns;
}
function clampProgressLabel(label, columns) {
	if (columns === void 0) return label;
	...
	return {
		...
		progress: (label) => {
			...
			const handleResize = () => {
				...
				if (maxColumns === void 0 || columns === void 0 || columns >= maxColumns) return;
				maxColumns = columns;
				spin.message(renderLabel());
			};
			if (maxColumns !== void 0) process.stdout.on("resize", handleResize);
