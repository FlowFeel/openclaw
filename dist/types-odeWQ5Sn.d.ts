import { A as Context, At as FastMode, Bt as SilentReplyConversationType, C as ModelMediaInputConfig, Ct as SecretRef, D as Api, Dt as PromptMode, I as TextContent, M as Message, N as Model, O as AssistantMessage, Ot as SilentReplyPromptMode, P as SimpleStreamOptions, R as Usage, S as ModelDefinitionConfig, St as SecretInput, T as ModelProviderConfig, X as ChannelImplicitMentionsConfig, _t as MarkdownTableMode$1, at as TtsProvider, b as ModelApi, bt as SessionScope, ct as SafeBinProfileFixture, dt as ContextVisibilityMode, gt as IdentityConfig, ht as HumanDelayConfig, it as TtsMode, j as ImageContent, k as AssistantMessageEventStreamContract, kt as ChatType, lt as MentionPatternsPolicyConfig, n as OpenClawConfig, nt as TtsAutoMode, pt as DmScope, rt as TtsConfig, t as ConfigFileSnapshot, tt as ResolvedTtsPersona, ut as MemoryCitationsMode, vt as ReplyToMode, w as ModelProviderAuthMode, x as ModelCompatConfig, xt as AgentModelConfig, yt as SessionMaintenanceMode, z as TalkProviderConfig } from "./types.openclaw-B2WvMv3k.js";
import { $t as LegacyMediaContextKey, A as chunkMarkdownText, At as MsgContext, B as PluginApprovalRequest, Bt as GetReplyOptions, Ct as ExecMode, D as OutboundIdentity, Dt as FinalizedRuntimeMsgContext, E as ChannelOutboundAdapter, Et as FinalizedMsgContext, F as resolveTextChunkLimit, Ft as CommandTurnContext, G as RenderedMessageBatchPlanItem, Gt as InputProvenance, H as WizardPrompter, Ht as TaskSuggestionDeliveryMode, I as OutboundDeliveryResult, It as CommandTurnKind, Jt as AgentToolResult, K as OutboundSendDeps, Kt as AgentMessage, L as OutboundPayloadDeliveryOutcome, Lt as PluginHookChannelContext, M as chunkText, Mt as SupplementalContextFacts, N as chunkTextWithMode, Nt as HistoryEntry, O as OutboundDeliveryFormattingOptions, Ot as InboundSourceModality, P as resolveChunkMode, Pt as HistoryMediaEntry, Qt as StreamFn, R as OutboundPayloadDeliverySuppressionReason, Rt as InboundEventKind, St as ExecAsk, T as ChannelDeliveryCapabilities, Tt as ExecTarget, Ut as TurnAdoptionLifecycle, V as PluginApprovalRequestPayload, Vt as PartialReplyPayload, W as MessageReceipt, Wt as UserTurnTranscriptRecorder, Xt as BashExecutionMessage, Y as ChannelAccountSnapshot, Yt as AgentToolUpdateCallback, Zt as CustomMessage, an as ReplyMediaAttachment, cn as MessagePresentation, en as MediaFact, ft as ConversationReadInvocationOrigin, gt as OutboundMediaReadFile, ht as OutboundMediaAccess, in as AgentPlanStep, j as chunkMarkdownTextWithMode, jt as SessionTranscriptContext, k as chunkByNewline, kt as MentionSource, ln as ModelPickerAction, lt as ChannelThreadingToolContext, nn as MediaKind, on as ReplyPayload$1, qt as AgentTool, rn as mediaKindFromMime, rt as ChannelMessageActionAdapter, sn as LegacyInteractiveReply, tn as PromptImageOrderEntry, un as ReplyPayloadDelivery, w as ChannelPairingAdapter, wt as ExecSecurity, xt as ExecApprovalRequestPayload$1, yt as ExecApprovalDecision, zt as BlockReplyContext } from "./setup-wizard-types-C896ZHgy.js";
import { S as SessionsCompanionStateResult, _ as Skill, b as SessionObserverDigest, c as SessionPluginJsonValue, d as SessionCreatedActor, f as SessionCreatedVia, g as DeliveryContext, h as SourceReplyDeliveryMode, i as GroupKeyResolution, l as SessionSystemPromptReport, o as SessionContextBudgetStatus, p as HookExternalContentSource, r as CliSessionBinding, s as SessionEntry$1, t as ChannelId$2, u as SessionToolOverrides, v as ChannelRouteRef, x as SessionsCompanionAskResult, y as CronScheduledToolPolicy } from "./channel-id.types-D6R9ANrx.js";
import { D as UnifiedModelCatalogEntry, E as ModelCatalogStatus, O as UnifiedModelCatalogKind, S as PluginManifestMcpServer, T as PluginKind, a as PluginOrigin$1, b as PluginManifestDashboardActionVerb, f as RuntimeEnv, g as PluginFormat, h as PluginDiagnostic, i as PluginDependencyStatus, m as PluginConfigUiHint, p as PluginBundleFormat, t as PluginManifestRecord, v as PluginManifestContracts, x as PluginManifestDashboardDataBinding, y as PluginManifestDashboard } from "./manifest-registry-BChEetzl.js";
import { i as JsonSchemaObject } from "./types.config-C6_VK-8V.js";
import { n as PluginMetadataSnapshotOwnerMaps, r as PluginCompatCode, t as PluginMetadataSnapshot } from "./plugin-metadata-snapshot.types-CVlIGjzi.js";
import { n as ConfigReplaceResult, r as ConfigWriteAfterWrite, t as resolveStateDir } from "./config-BCGGiXq1.js";
import { i as StructuredExtractionInput, n as MediaUnderstandingOutput, r as MediaUnderstandingProvider, t as MediaUnderstandingDecision } from "./types-Ch6omCeJ.js";
import { i as OAuthCredential$1, n as AuthProfileCredential, r as AuthProfileStore, t as ApiKeyCredential$1 } from "./types-Bc5r7vtB.js";
import { n as ChannelPlugin$3, r as OperatorScope } from "./types.public-CDX1pJx5.js";
import { n as PinnedDispatcherPolicy, r as SsrFPolicy, t as LookupFn } from "./ssrf-82Db1HTt.js";
import { a as VideoGenerationProvider, i as VideoGenerationNormalization, n as GeneratedVideoAsset, o as VideoGenerationResolution, r as VideoGenerationIgnoredOverride, s as VideoGenerationSourceAsset, t as ModelProviderRequestTransportOverrides$1 } from "./provider-request-config-BiXrTO_G.js";
import { n as resolveChannelGroupRequireMention, t as resolveChannelGroupPolicy } from "./group-policy-6r3fz2Bw.js";
import { a as ImageGenerationOutputFormat, c as ImageGenerationQuality, i as ImageGenerationNormalization, l as ImageGenerationResolution, n as ImageGenerationBackground, o as ImageGenerationProvider, r as ImageGenerationIgnoredOverride, s as ImageGenerationProviderOptions, t as GeneratedImageAsset, u as ImageGenerationSourceImage } from "./types-C4M6d93S.js";
import { a as MusicGenerationProvider, i as MusicGenerationOutputFormat, n as MusicGenerationIgnoredOverride, o as MusicGenerationSourceImage, r as MusicGenerationNormalization, t as GeneratedMusicAsset } from "./types-C9d_boK5.js";
...
type PluginHookInboundClaimEvent = {
  ...
  wasMentioned?: boolean; /** Staged, locally usable attachments in stable source order. */
...
type PluginHookMessageReceivedEvent = {
  ...
  traceId?: string;
  spanId?: string;
  parentSpanId?: string; /** Staged, locally usable attachments in stable source order. */
  media?: PluginHookMediaFact[]; /** Original attachment facts when local staging has not completed yet. */
  originalMedia?: PluginHookMediaFact[]; /** True when `originalMedia` is present but `media` is intentionally withheld pending staging. */
  mediaStagingPending?: boolean;
  metadata?: PluginHookInboundMessageMetadata;
 ...
 */
| "subagent_spawning" | "subagent_delivery_target" | "subagent_spawned" | "subagent_progress" | "subagent_ended" /** @deprecated Use gateway_stop. */ | "deactivate" | "gateway_start" | "gateway_stop" | "heartbeat_prompt_contribution" | "cron_reconciled" | "cron_changed" | "skill_proposal_evaluate" | "skill_proposal_changed" | "skill_changed" | "before_dispatch" | "reply_dispatch" | "before_install" | "before_agent_run" | "resolve_exec_env";
...
type MessagingToolSourceReplyPayload = Pick<ReplyPayload$1, "audioAsVoice" | "channelData" | "interactive" | "mediaUrl" | "mediaUrls" | "presentation" | "text"> & {
...
type CronMessageChannel = ChannelId$2;
...
type ChannelRuntimeSnapshot = {
  channels: Partial<Record<ChannelId$2, ChannelAccountSnapshot>>;
  channelAccounts: Partial<Record<ChannelId$2, Record<string, ChannelAccountSnapshot>>>;
};
...
type GatewayRequestContext = {
  ...
  startChannel: (channel: ChannelId$2, accountId?: string, opts?: StartChannelOptions) => Promise<void>;
  stopChannel: (channel: ChannelId$2, accountId?: string) => Promise<void>;
  markChannelLoggedOut: (channelId: ChannelId$2, cleared: boolean, accountId?: string) => void;
...
type GetReplyFromConfig = (ctx: MsgContext, opts?: GetReplyOptions, configOverride?: OpenClawConfig) => Promise<ReplyPayload$1 | ReplyPayload$1[] | undefined>;
type InternalGetReplyFromConfig = (ctx: MsgContext, opts?: InternalGetReplyOptions, configOverride?: OpenClawConfig) => Promise<ReplyPayload$1 | ReplyPayload$1[] | undefined>;
//#endregion
...
type ReplyDispatchSkipHandler = (payload: ReplyPayload$1, info: ReplyDispatchRuntimeInfo & {
  reason: NormalizeReplySkipReason;
}) => void;
type ReplyDispatchCancelHandler = (payload: ReplyPayload$1, info: ReplyDispatchRuntimeInfo) => Promise<void> | void;
type ReplyDispatchDeliverer = (payload: ReplyPayload$1, info: ReplyDispatchRuntimeInfo) => Promise<unknown>;
type ReplyDispatcherOptions = {
  ...
  transformReplyPayload?: (payload: ReplyPayload$1) => ReplyPayload$1 | null; /** Static context for response prefix template interpolation. */
...
type PairingChannel = ChannelId$2;
...
type ChannelReplyPipeline = ReplyPrefixOptions & {
  ...
  transformReplyPayload?: (payload: ReplyPayload$1) => ReplyPayload$1 | null;
};
...
type ChannelDeliveryAdapterBase = {
  /** Return null when channel policy intentionally suppresses this logical payload. */preparePayload?: (payload: ReplyPayload$1, info: ChannelDeliveryInfo) => MaybePromise$1<ReplyPayload$1 | null>;
  onDelivered?: (payload: ReplyPayload$1, info: ChannelDeliveryInfo, result: ChannelDeliveryResult | void) => Promise<void> | void; /** Let core emit the one canonical `message_sent` after non-durable provider settlement. */
...
type ChannelCoreManagedTurnDeliveryAdapter = ChannelDeliveryAdapterBase & {
  deliver: (payload: ReplyPayload$1, info: ChannelDeliveryInfo) => Promise<ChannelDeliveryResult | void>;
  durable?: false | ChannelTurnDurableDeliveryOptions | ((payload: ReplyPayload$1, info: ChannelDeliveryInfo) => false | ChannelTurnDurableDeliveryOptions | Promise<false | ChannelTurnDurableDeliveryOptions>);
};
...
type ChannelProviderOwnedMessageSendingDeliveryAdapter = ChannelDeliveryAdapterBase & {
   ...
   */
  deliverWithProviderMessageSending: (payload: ReplyPayload$1, info: ChannelDeliveryInfo) => Promise<ChannelDeliveryResult | void>;
  deliver?: never;
  durable?: never;
};
 ...
 */
type LoadChannelOutboundAdapter = (id: ChannelId$2) => Promise<ChannelOutboundAdapter | undefined>;
//#endregion
...
type ReasoningStreamPayload = Pick<ReplyPayload$1, "text" | "mediaUrls" | "isReasoning" | "isReasoningSnapshot"> & {
...
type RunEmbeddedAgentParams = {
  ...
  onToolResult?: (payload: ReplyPayload$1) => void | Promise<void>; /** Synchronous private observer for the sanitized per-tool result. */
 ...
 */
type PluginCommandResult = ReplyPayload$1 & {
...
//#endregion
export { MemoryEmbeddingProviderRuntime as $, PluginHttpRouteRegistration as A, OutboundReplyPayload as B, ProviderPrepareRuntimeAuthContext as C, jsonResult as Ct, ProviderAuthContext as D, ProviderResolvedUsageAuth as E, PluginConversationBindingRequestResult as Et, SessionUpstreamActivity as F, resolveInboundMentionDecision as G, deliverTextOrMediaReply as H, SessionUpstreamProbe as I, CliBackendNormalizeConfigContext as J, PairingChannel as K, PluginRuntime as L, SessionCatalogContinueProviderResult as M, SessionCatalogEntrySnapshot as N, ProviderAuthMethod as O, SessionCatalogTerminalPlan as P, MemoryEmbeddingProviderCreateOptions as Q, InboundMediaFacts as R, ProviderFetchUsageSnapshotContext as S, readStringParam as St, ProviderResolveUsageAuthContext as T, PluginConversationBindingRequestParams as Tt, isNumericTargetId as U, ReplyPayload as V, sendPayloadWithChunkedTextAndMedia as W, CliBackendResolveExecutionArgsContext as X, CliBackendPlugin$1 as Y, MemoryEmbeddingProvider as Z, resolveApiKeyForProvider as _, createActionGate as _t, OpenClawPluginGatewayRuntimeScopeSurface as a, MemorySessionKind as at, ProviderUsageSnapshot as b, readStringArrayParam as bt, OpenClawPluginServiceContext as c, MemorySyncParams as ct, OpenClawPluginNodeHostCommand as d, EmbeddingInput as dt, MemoryPluginRuntime as et, PluginLogger as f, emptyPluginConfigSchema as ft, WebSearchProviderPlugin as g, AnyAgentTool as gt, PluginStateLeaseRunner as h, SessionCatalogPullRequestSummary as ht, ProviderPlugin as i, MemorySearchResult as it, PluginRegistry as j, ProviderAuthResult as k, PluginInteractiveRegistration as l, MemorySyncProgressUpdate as lt, OpenClawPluginToolFactory as m, ModelCatalogEntry as mt, OpenClawPluginConfigSchema as n, MemoryProviderStatus as nt, OpenClawPluginNodeInvokePolicy as o, MemorySessionSyncTarget as ot, OpenClawPluginToolContext as p, ResolvedMemorySearchConfig as pt, CliBackendConfig as q, OpenClawPluginApi as r, MemorySearchManager as rt, OpenClawPluginService as s, MemorySource as st, OpenClawPluginDefinition as t, MemoryEntryProvenance as tt, SpeechProviderPlugin as u, RetryConfig as ut, ProviderDefaultThinkingPolicyContext as v, readNumberParam as vt, ProviderPreparedRuntimeAuth as w, PluginConversationBinding as wt, ProviderWrapStreamFnContext as x, readStringOrNumberParam as xt, ProviderThinkingProfile as y, readReactionParams as yt, createChannelReplyPipeline as z };