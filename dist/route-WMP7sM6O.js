...
import { n as ensureCliExecutionBootstrap, r as resolveCliExecutionStartupContext, t as applyCliExecutionStartupPresentation } from "./command-execution-startup-BX3TTySP.js";
...
const configCliLoader = createLazyImportLoader(() => import("./config-cli-4O0UC6FC.js"));
const agentsListCommandLoader = createLazyImportLoader(() => import("./agents.commands.list-B05oBxAT.js"));
const modelsListCommandLoader = createLazyImportLoader(() => import("./list.list-command-DjII6qAA.js"));
const modelsStatusCommandLoader = createLazyImportLoader(() => import("./list.status-command-BDVr5L1E.js"));
const tasksJsonCommandLoader = createLazyImportLoader(() => import("./tasks-json-DQeH_Oc2.js"));
...
const routedCommandDefinitions = {
	...
	status: defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			if (args.json) {
				const { statusJsonCommand } = await import("./status-json-L2FEkoFX.js");
			...
			const { statusCommand } = await import("./status-xHlW_Lut.js");
	...
	"gateway-status": defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { runDaemonStatus } = await import("./status-C2Sfpbyr.js");
	...
	"gateway-health": defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { runGatewayHealthJsonRoute } = await import("./health-route-C2MPxqwy.js");
	...
	sessions: defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { sessionsCommand } = await import("./sessions-DBi-P0Sc.js");
	...
	"channels-list": defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { channelsListCommand } = await import("./list-CuEgK68o.js");
	...
	"channels-status": defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { channelsStatusCommand } = await import("./status-C3MGTeAz.js");
