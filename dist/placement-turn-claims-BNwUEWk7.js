...
import { g as parseWorkerWorkspaceReconciliationPlan, v as serializeWorkerWorkspaceReconciliationPlan } from "./workspace-reconcile-DRy0gf8w.js";
...
function isCurrentJournalOwner(placement, owner) {
	return (placement?.state === "active" || placement?.state === "draining") && placement.environmentId === owner.environmentId && placement.activeOwnerEpoch === owner.ownerEpoch && placement.generation === owner.placementGeneration;
}
...
//#endregion
export { normalizeEpoch as _, hasWorkerWorkspacePendingResult as a, ensureLocal as c, getRequired as d, query$2 as f, nextGeneration as g, assertRecordShape as h, createPlacementWorkspaceResultOps as i, find as l, canTransitionWorkerSessionPlacement as m, createPlacementTurnClaimOps as n, clearWorkerWorkspaceReconciliation as o, transitionValues as p, signalTurnClaimRelease as r, createPlacementWorkspaceJournalOps as s, ActiveTurnClaimError as t, fromRow as u, normalizeIdentity as v, required as y };
