...
import { t as BUNDLED_OFFICIAL_EXTERNAL_PLUGIN_CATALOGS } from "./official-external-plugin-bundled-catalogs-CXacmba3.js";
...
async function parseHostedCatalogFeedBody(params) {
	...
	if (params.verification?.mode === "signed") {
		const { verifyOfficialExternalPluginCatalogSignedEnvelope } = await import("./official-external-plugin-catalog-envelope-BuZzeV8t.js");
...
async function resolveHostedCatalogSnapshotStore(params) {
	...
	const { createSqliteHostedOfficialExternalPluginCatalogSnapshotStore } = await import("./official-external-plugin-catalog-snapshot-store-54DV09sR.js");
...
async function loadHostedOfficialExternalPluginCatalogEntries(params) {
	...
	let release;
	try {
		const { fetchWithSsrFGuard } = await import("./fetch-guard-DrUnJQ0K.js");
...
//#endregion
export { resolveOfficialExternalProviderContractPluginIds as _, isOfficialExternalPluginCatalogFeed as a, resolveOfficialExternalWebProviderContractPluginIdsForEnv as b, listOfficialExternalChannelCatalogEntries as c, listOfficialExternalProviderCatalogEntries as d, loadConfiguredHostedOfficialExternalPluginCatalogEntries as f, resolveOfficialExternalPluginLabel as g, resolveOfficialExternalPluginInstall as h, getOfficialExternalPluginCatalogManifest as i, listOfficialExternalChannelEnvVars as l, resolveOfficialExternalPluginId as m, getOfficialExternalPluginCatalogEntry as n, isOfficialExternalPluginCatalogSequence as o, parseOfficialExternalPluginCatalogTimestamp as p, getOfficialExternalPluginCatalogEntryForPackage as r, isOfficialExternalPluginId as s, HostedCatalogSignedFeedMonotonicityError as t, listOfficialExternalPluginCatalogEntries as u, resolveOfficialExternalProviderPluginIds as v, resolveOfficialExternalProviderPluginIdsForEnv as y };
