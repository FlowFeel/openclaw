...
async function inspectSystemLaunchDaemonOwnership(label, options = {}) {
	...
	const initialQuery = classifySystemLaunchDaemonQuery(serviceTarget, await execLaunchctl(["print", serviceTarget]));
	...
	return classifySystemLaunchDaemonQuery(serviceTarget, await execLaunchctl(["print", serviceTarget]));
}
