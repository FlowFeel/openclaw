...
import { E as resolveChannelStreamingChunkMode } from "./streaming-B45j2FQx.js";
...
function chunkByNewline(text, maxLineLength, opts) {
	...
	for (const line of lines) {
		...
		const firstLimit = avoidTrailingHighSurrogateBreak(lineValue, 0, Math.max(1, lineLimit - prefix.length));
