...
import { b as parseStrictPositiveInteger, k as resolveOptionalIntegerOption } from "./number-coercion-Crk_c9KW.js";
...
import { u as resolveProviderRuntimePlugin } from "./provider-hook-runtime-CJN_HH27.js";
import { A as COMPACTION_SUMMARY_PREFIX, M as bashExecutionToText, O as BRANCH_SUMMARY_PREFIX, T as CompactionError, j as COMPACTION_SUMMARY_SUFFIX, k as BRANCH_SUMMARY_SUFFIX } from "./agent-core-DwxIhy3z.js";
import { st as generateSummary } from "./sessions-Digi7ATr.js";
import "./session-manager-codec-qDky9Jof.js";
import { r as SAFETY_MARGIN } from "./compaction-planning-C-JUoUqc.js";
import "./model-selection-D5gxVbBh.js";
import { d as isTimeoutError } from "./failover-error-CMC-wGmM.js";
import { u as normalizeAgentRunAttemptTerminal } from "./agent-run-terminal-outcome-Bl2pG_Kc.js";
import { r as isGoogleModelApi } from "./embedded-agent-helpers-zm6jLxdk.js";
import { n as estimateToolResultReductionPotential } from "./transcript-visibility-0PUROgcA.js";
...
import { n as buildStageSplitPlanWithWorker, r as buildSummaryChunksWithWorker, t as buildOversizedFallbackPlanWithWorker } from "./compaction-planning-worker-DIJ6HAIL.js";
import { d as resolveFinalAssistantVisibleText } from "./helpers-DOU3STAD.js";
...
async function summarizeChunks(params) {
	...
	for (const [completedChunks, chunk] of chunks.entries()) try {
		...
		if (params.signal.aborted || !isAbortError(err) && isTimeoutError(err) || completedChunks === 0) throw err;
...
function resolveSettledTurnFinalizationText(result) {
	...
	if (!text || isSilentReplyText(text)) throw new Error("Settled-turn finalization completed without a visible answer");
	return text;
}
/**
...
//#endregion
export { runAgentCleanupStep as a, estimateLlmBoundaryTokenPressure as c, shouldPreemptivelyCompactBeforePrompt as d, resolveContextWindowTokens as f, shouldAllowProviderOwnedThinkingReplay as g, resolveTranscriptPolicy as h, buildEmbeddedAttemptToolRunContext as i, estimateRenderedLlmBoundaryTokenPressure as l, providerRequiresSignedThinking as m, projectSettledTurnFinalizationAttemptResult as n, PREEMPTIVE_OVERFLOW_ERROR_TEXT as o, summarizeInStages as p, resolveSettledTurnFinalizationText as r, buildPrePromptContextBudgetStatus as s, assertSettledTurnFinalizationResult as t, formatPrePromptPrecheckLog as u };
