...
import { f as resolveDefaultAgentId, n as listAgentEntries, o as resolveAgentConfig, t as hasAgentRosterProperty } from "./agent-scope-config-Dusa8eSA.js";
import { n as normalizeAgentId } from "./agent-id-DDgUze4y.js";
import { c as parseAgentSessionKey, f as parseThreadSessionSuffix, u as parseRawSessionConversationRef } from "./session-key-utils-02xWdGSz.js";
...
import { _ as resolveToolProfilePolicy, c as mergeAlsoAllowPolicy, h as normalizeToolName } from "./tool-policy-CrjVfI-s.js";
...
import { tt as resolveSessionConversation } from "./session-entry-slot-keys-DR5d2mKt.js";
import { r as resolveSandboxToolPolicyForAgent } from "./tool-policy-CnoAKsDO.js";
import { r as resolveChannelGroupToolsPolicy } from "./group-policy-BC5uZemX.js";
import { a as resolveStoredSubagentInheritedToolDenylist, i as resolveStoredSubagentInheritedToolAllowlist, r as resolveStoredSubagentCapabilities, s as resolveSubagentCapabilityStore } from "./subagent-capabilities-nSrXwosf.js";
...
function resolveEffectiveToolPolicy(params) {
	const agentId = (typeof params.agentId === "string" && params.agentId.trim() ? normalizeAgentId(params.agentId) : void 0) ?? (params.sessionKey ? parseAgentSessionKey(params.sessionKey)?.agentId : void 0) ?? (params.config && (!hasAgentRosterProperty(params.config) || listAgentEntries(params.config).length > 0) ? resolveDefaultAgentId(params.config) : void 0);
...
function resolveGroupToolPolicy(params) {
	...
	if (!channel) return params.requireConfiguredAccount && accountId !== "default" ? denyAllToolPolicy() : void 0;
	let plugin;
	try {
