...
import { u as listCodexAppServerExtensionFactories } from "./loader-CT1KBBu5.js";
...
import "./registry-DkL0MuB5.js";
import "./provider-request-config-C5exA1l5.js";
import "./registry-DyBZw0Nd.js";
import { g as joinPresentTextSegments, t as getGlobalHookRunner } from "./hook-runner-global-BNa5TLJ4.js";
import "./session-accessor.sqlite-CtCo5VZ6.js";
import "./agent-tools.before-tool-call-uaLOAHZ3.js";
import "./tool-result-error-BI56-yEJ.js";
...
import { c as mergeAgentRunAttemptTerminal, d as projectAgentRunAttemptTerminal, f as setAgentRunAttemptTerminalFailure, u as normalizeAgentRunAttemptTerminal } from "./agent-run-terminal-outcome-C9bgFmfC.js";
import "./run-termination-CczpQCyZ.js";
import "./diagnostic-CdMjo2Fb.js";
import { g as queueEmbeddedAgentMessageWithOutcome } from "./runs-Bdk5tY9J.js";
import "./tool-replay-safety-CRqM1och.js";
import { m as shouldLoadRequesterScopedMcpHarnessRuntime } from "./agent-bundle-mcp-manager-api-D2GddaSc.js";
import "./tools-sUgO7zqy.js";
import "./agent-end-side-effects--ABMNPXa.js";
import "./local-model-lean-CeG7_aMD.js";
import "./gateway-B5H4NIb8.js";
import "./tool-mutation-BmnNoynG.js";
import "./logger-PoK3sCV7.js";
...
import "./streaming-Df3LUUGR.js";
import "./embedded-agent-messaging-Bc7tsqQd.js";
import "./embedded-agent-subscribe.tools-agHp_6fR.js";
import "./embedded-agent-message-tool-source-reply-x3_0ZuNB.js";
import "./openclaw-tools-B_OHwLQN.js";
import "./bootstrap-files-DfTRxNZ7.js";
import { _ as wrapPluginSystemContextSection } from "./attempt.prompt-helpers-BQhqL2Eu.js";
import "./nodes-utils-DC2wdBCD.js";
import "./hook-helpers-DbM1YFe0.js";
import "./tools-BKYdulJW.js";
import "./tool-schema-projection-ZrMdwk4s.js";
import "./attempt-tool-construction-plan-D4Oh4XYT.js";
import { n as prepareWatchedSessionsPrompt, t as buildWatchedSessionsPromptLines } from "./watched-sessions-prompt-BpQzHAn1.js";
import "./attempt.thread-helpers-wvQtocZt.js";
import "./settled-turn-finalization-result-BmhJQmHW.js";
import { i as resolveSessionWriteLockOptions, t as acquireSessionWriteLock$1 } from "./session-write-lock-CDkoLPi5.js";
import { s as buildAgentHookContext } from "./lifecycle-hook-helpers-B_MyvJob.js";
import "./tool-result-middleware-DT8nKWjd.js";
import "./context-BSQua5VL.js";
import "./sandbox-C8V7Nism.js";
import "./result-fallback-classifier-C2AZaw2h.js";
import "./build-BykyiSkJ.js";
import { n as parseSessionLockFilePayload, r as readSessionLockProcessStartTime, t as inspectSessionLockFileContention } from "./session-lock-file-inspection-Cj5iI-9P.js";
import "./native-hook-relay-B0cZfToQ.js";
...
async function loadCodexBundleMcpThreadConfig(params) {
	const { loadCodexBundleMcpThreadConfig: load } = await import("./codex-mcp-config-BYggpi5t.js");
	return load(params);
}
/**
...
async function prepareHarnessNativeMcpAppPreview(params) {
	...
	const { buildMcpAppCanvasPayload, fetchMcpAppView } = await import("./mcp-ui-resource-BX0vuAD1.js");
...
async function materializeRequesterScopedMcpToolsForHarnessRun(params) {
	...
	const { materializeRequesterScopedMcpToolsForHarnessRun: materialize } = await import("./agent-bundle-mcp-harness-DKz1fOrq.js");
