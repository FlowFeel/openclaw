...
import { c as shouldEnableShellEnvFallback, n as getShellEnvAppliedKeys } from "./shell-env-BP86qu6I.js";
import { r as theme, t as colorize } from "./theme-vjDs9tao.js";
import { n as OPENAI_PROVIDER_ID } from "./openai-routing-G4z6ipSe.js";
...
import { y as resolveMergedModelProviderConfig } from "./openai-model-routes-NsaPlbzf.js";
import { t as resolveAgentHarnessPolicy } from "./policy-BxKGFISr.js";
import { n as installTemporaryCurrentPluginMetadataSnapshot, t as getCurrentPluginMetadataSnapshot } from "./current-plugin-metadata-snapshot-krwg-Yx5.js";
...
import { C as resolveModelRefFromString, N as parseModelPolicyWildcardRef, a as buildModelAliasIndex, b as resolveConfiguredModelRef, p as modelCatalogLogicalKey, y as resolveConfiguredModelPolicyAllow } from "./model-selection-shared-BDTPW9Jk.js";
...
import { c as isNonSecretApiKeyMarker, g as resolveProviderEnvAuthLookupMaps, h as listProviderEnvAuthLookupKeys, l as isOAuthApiKeyMarker } from "./model-auth-markers-Co0rjfKm.js";
import { j as resolveProviderSyntheticAuthWithPlugin } from "./provider-runtime-pe0BhJuO.js";
import { a as loadPersistedAuthProfileStore } from "./persisted-pDgmg_nM.js";
import { c as getRuntimeAuthProfileStoreSnapshot, i as ensureAuthProfileStore, o as ensureAuthProfileStoreWithoutExternalProfiles } from "./store-BMd0T0_g.js";
import { u as resolveProfileUnusableUntilForDisplay } from "./usage-DhtWp5Y_.js";
import { i as loadPreparedModelCatalogSnapshot } from "./prepared-model-catalog-CdxSfQZ8.js";
...
import { n as resolveAgentHarnessOwnerPluginIds } from "./runtime-plugin-load-plan-Bnq_I-yx.js";
import { i as resolveAuthProfileDisplayLabel } from "./auth-profiles-9ILihU8J.js";
import "./profiles-C4bFcrKC.js";
import { r as getCustomProviderApiKey, x as resolveUsableCustomProviderApiKey } from "./model-auth-provider-config-B5rr_zPt.js";
import { t as createModelAuthAvailabilityResolver } from "./model-auth-availability-DioPh4UX.js";
...
import { n as resolveAgentHarnessRuntimeAvailability } from "./runtime-plugin-Ab_u_Uth.js";
import { n as createModelVisibilityPolicy } from "./model-visibility-policy-BnYDbXrZ.js";
import { n as resolveUtilityModelRefForAgent, t as readUtilityModelSetting } from "./utility-model-DQIZKWEI.js";
import { i as isRich, t as ensureFlagCompatibility } from "./list.options-CKiCgycC.js";
import { a as resolveKnownAgentId } from "./shared-CK2TyYBP.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort, t as DEFAULT_OAUTH_WARN_MS } from "./auth-health-DKwFAu9I.js";
import { t as maskApiKey } from "./secret-mask-CWRecbVB.js";
import { t as loadModelsConfig } from "./load-config-DvhYH7Fo.js";
...
const providerUsageRuntimeLoader = createLazyImportLoader(() => import("./provider-usage-CbajJmrv.js"));
const progressRuntimeLoader = createLazyImportLoader(() => import("./progress-9yJEe3sF.js"));
const terminalTableRuntimeLoader = createLazyImportLoader(() => import("./terminal-core/table.js"));
const listProbeRuntimeLoader = createLazyImportLoader(() => import("./list.probe-BStDGQp_.js"));
...
function installCommandPluginMetadataSnapshot(params) {
	...
	return installTemporaryCurrentPluginMetadataSnapshot(params.snapshot, {
		config: params.config,
		workspaceDir: params.workspaceDir,
		env: params.env
	}).release;
...
async function modelsStatusCommand(opts, runtime) {
	...
	const resolveCodexRuntimeAvailability = (provider) => {
		...
		const pending = (async () => {
			const { runPluginPayloadSmokeCheckForManifestRecords } = await import("./plugin-payload-validation-C4vQf4Pb.js");
	...
	try {
		...
		if (missingProvidersInUse.length > 0) {
			const { buildProviderAuthRecoveryHint } = await import("./provider-auth-recovery-hint-CdJRvhl-.js");
			runtime.log("");
