...
import { a as guardedRename } from "./pinned-write-CO4XA8tE.js";
...
function regularReadFlags() {
	return constants.O_RDONLY | (typeof constants.O_NOFOLLOW === "number" && process.platform !== "win32" ? constants.O_NOFOLLOW : 0) | (typeof constants.O_NONBLOCK === "number" && process.platform !== "win32" ? constants.O_NONBLOCK : 0);
}
