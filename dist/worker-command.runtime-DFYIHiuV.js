...
async function runWorkerDescriptor(descriptor, options = {}) {
	...
	try {
		...
		const [{ runWorkerEmbeddedTurn }, { createWorkerInferenceStreamAdapter }] = await Promise.all([import("./embedded-agent.runtime-HLEVmQo7.js"), import("./inference-stream.runtime.js")]);
