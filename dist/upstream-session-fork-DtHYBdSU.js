...
import { a as upsertSessionUpstreamLink, t as deleteSessionUpstreamLink } from "./session-upstream-links-CB_vQpz0.js";
import "./string-coerce-runtime-CLK2YdzD.js";
import { u as readVisibleSessionTranscriptMessageEntries } from "./session-transcript-runtime-Cvc8VErx.js";
import "./session-catalog-BNXEx0co.js";
import { v as sessionBindingIdentity } from "./session-binding-Bu5tE7CD.js";
import { r as assertCodexThreadForkResponse } from "./protocol-validators-Cf6MSlge.js";
import "./incognito-session-C8lb8Cnn.js";
import { i as createImportedCodexSession, n as codexUpstreamBaseline, t as codexLastTerminalTurnId } from "./session-upstream-marker-CbpgQvvU.js";
...
async function forkCodexUpstreamSession(params, options) {
	try {
		return await options.control.withPinnedConnection(async (control) => {
			...
			if (incognito && !clientId) throw new Error("Incognito Codex forks require the live pinned app-server client");
			let linked = false;
			let bindingIdentity;
			...
			try {
				...
				const forkedTurns = incognito ? response.thread.turns ?? [] : await listCodexUpstreamTurns(control, threadId);
