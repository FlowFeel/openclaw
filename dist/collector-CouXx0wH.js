...
import { t as inspectChannelAccount } from "./account-inspection-CqCfxK1t.js";
import { n as buildChannelAccountSnapshotFromAccount } from "./status-CdVXez9a.js";
...
async function buildHealthSessionSummary(storePath, agentId) {
	const { listSessionEntriesReadOnly } = await import("./session-accessor-DnNtcMuD.js");
	const { isTransientSqliteError } = await import("./unhandled-rejections-DlYiJKVa.js");
	let listed;
	try {
