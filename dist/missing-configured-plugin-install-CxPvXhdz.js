...
import { l as readLegacyNpmPluginDeclaration } from "./discovery-BwgYKZ4p.js";
...
import { i as isOpenClawOrgNpmSpec, s as parseRegistryNpmSpec, t as compareOpenClawReleaseVersions } from "./npm-registry-spec-CCN1EPEy.js";
import { n as VERSION, o as resolveCompatibilityHostVersion } from "./version-CeFj_iGk.js";
import { p as collectConfiguredMemoryEmbeddingProviderIds } from "./gateway-startup-plugin-ids-C-hC0TmS.js";
import { t as collectConfiguredSpeechProviderIds } from "./gateway-startup-speech-providers-DhAJaYJ6.js";
import { a as resolveDefaultPluginNpmDir, l as resolvePluginNpmPackageDir, o as resolvePluginInstallDir, r as resolveDefaultPluginExtensionsDir } from "./install-paths-D18EkQi8.js";
import { n as loadInstalledPluginIndexInstallRecords } from "./installed-plugin-index-record-reader-DA9P0iII.js";
import { r as loadInstalledPluginIndex } from "./installed-plugin-index-DXmBG059.js";
import { _ as resolveOfficialExternalProviderContractPluginIds, b as resolveOfficialExternalWebProviderContractPluginIdsForEnv, g as resolveOfficialExternalPluginLabel, h as resolveOfficialExternalPluginInstall, m as resolveOfficialExternalPluginId, u as listOfficialExternalPluginCatalogEntries, v as resolveOfficialExternalProviderPluginIds, y as resolveOfficialExternalProviderPluginIdsForEnv } from "./official-external-plugin-catalog-CWuAzOfx.js";
import { n as listExplicitlyDisabledChannelIdsForConfig, r as listPotentialConfiguredChannelIds } from "./config-presence-DHykKEMa.js";
import { t as sanitizeTerminalText } from "./safe-text-wtXgRSZv.js";
import { c as resolveConfiguredChannelPresencePolicy } from "./channel-presence-policy-BjX2SvLo.js";
import { n as resolveWebSearchInstallCatalogEntriesForEnv, r as resolveWebSearchInstallCatalogEntry } from "./web-search-install-catalog-MHYBiCuB.js";
import { c as loadManifestMetadataSnapshot } from "./manifest-contract-eligibility-BxCz9N8R.js";
import { c as buildNpmResolutionInstallFields, f as resolveNpmInstallRecordSpec, s as writePersistedInstalledPluginIndexInstallRecords } from "./installed-plugin-index-records-BkPV4HdU.js";
import { n as resolveProviderInstallCatalogEntries } from "./provider-install-catalog-B69Hv4PV.js";
import "./channel-plugin-ids-Ds82VHXY.js";
import { r as installPluginFromNpmSpec } from "./install-BNVuEMPU.js";
import { t as CLAWHUB_INSTALL_ERROR_CODE } from "./clawhub-error-codes-OgrR1N6P.js";
import { t as installPluginFromClawHub } from "./clawhub-BBoMPCcf.js";
...
import { n as resolveNpmInstallSpecsForUpdateChannel, t as resolveClawHubInstallSpecsForUpdateChannel } from "./install-channel-specs-QIANA_UJ.js";
import { n as updateNpmInstalledPlugins, r as isClawHubTrustSkippedOutcome } from "./update-BKikhBgq.js";
import { i as collectConfiguredRuntimePluginIds, n as VERSION_BOUND_RUNTIME_PLUGIN_IDS, t as CONFIGURED_RUNTIME_PLUGIN_INSTALL_CANDIDATES } from "./configured-runtime-plugin-installs-Du-iScG6.js";
import { c as isLegacyPackageUpdateDoctorPass, f as shouldDeferConfiguredPluginInstallRepair, u as isPostCoreConvergencePass } from "./update-phase-Br5TVkeJ.js";
import { t as asObjectRecord } from "./object-BsiS9JXh.js";
import { n as collectConfiguredModelProviderSelectionIds, r as collectConfiguredProviderSelectionIds, t as collectConfiguredMediaProviderSelectionIds } from "./configured-provider-selection-ids-s5jidgrq.js";
...
async function resolveConfiguredPluginInstallContext(params) {
	...
	return {
		...
		officialReplacementPluginIds: new Set(collectOfficialReplacementInstallCandidates({
			cfg: params.cfg,
			env: params.env,
...
async function detectConfiguredPluginInstallHealthIssues(params) {
	...
	for (const candidate of collectDownloadableInstallCandidates({
		...
		const hasUsableRecord = hasRecord && !isInstalledRecordMissingOnDisk(records[candidate.pluginId], env);
...
function configuredPluginInstallIssueToHealthFinding(issue) {
	...
	return {
		...
		fixHint: issue.kind === "missing-install-record" ? `Run \`openclaw doctor --fix\` to install ${issue.installSpec}.` : detail.fixHint
	};
}
...
async function repairMissingPluginInstalls(params) {
	const env = params.env ?? process.env;
	const { knownIds, configuredChannelOwnerPluginIds, bundledPluginsById, configuredPluginIdsWithStaleDescriptors, records, updateChannel, installedPluginIdsWithRepairablePackageDiagnostics, installedPluginIdsWithStaleVersionBoundRuntimePackages, installedPluginIdsWithRepairablePackages, officialReplacementPluginIds } = await resolveConfiguredPluginInstallContext({
		cfg: params.cfg,
		env,
	...
	for (const candidate of collectDownloadableInstallCandidates({
		...
		const hasUsableRecord = hasRecord && !isInstalledRecordMissingOnDisk(nextRecords[candidate.pluginId], env);
		if (!shouldReplaceBrokenOfficialInstall && (hasUsableRecord || knownIds.has(candidate.pluginId) && !hasRecord)) continue;
	...
	if (nextRecords !== records) await writePersistedInstalledPluginIndexInstallRecords(nextRecords, persistedIndexOptions);
	else if (params.baselineRecords) await writePersistedInstalledPluginIndexInstallRecords(nextRecords, persistedIndexOptions);
	return {
		changes,
		warnings,
...
//#endregion
export { detectConfiguredPluginInstallHealthIssues as a, configuredPluginInstallIssueToRepairEffect as i, repairMissingPluginInstallsForIds as n, collectConfiguredProviderPluginIds as o, configuredPluginInstallIssueToHealthFinding as r, repairMissingConfiguredPluginInstalls as t };
