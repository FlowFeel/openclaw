...
import { t as buildRandomTempFilePath } from "./temp-download-Cilxb_2A.js";
import { d as listOfficialExternalProviderCatalogEntries, i as getOfficialExternalPluginCatalogManifest } from "./official-external-plugin-catalog-CWuAzOfx.js";
import { i as shouldLogVerbose, r as logVerbose } from "./globals-Cw62Mq_M.js";
import { n as runExec } from "./exec-SGTX01mL.js";
import { n as CUSTOM_LOCAL_AUTH_MARKER } from "./model-auth-markers-z4js65k2.js";
import { c as mergeModelProviderRequestOverrides, m as sanitizeConfiguredProviderRequest, p as sanitizeConfiguredModelProviderRequest } from "./provider-request-config-C5exA1l5.js";
import { n as detectMime } from "./mime-Ir6g3Vae.js";
import { o as runFfmpeg } from "./media-probe-BL-Ub3TA.js";
import "./media-services-Ii2z0iaY.js";
import { r as assertSecretOwnerAvailable } from "./runtime-degraded-state-V0p9ck6P.js";
import { a as resolveInboundMediaReference, n as classifyMediaReferenceSource, r as normalizeMediaReferenceSource } from "./media-reference-sxufFF1B.js";
import { r as readRemoteMediaBuffer, t as MediaFetchError } from "./fetch-CNBCr8CY.js";
import { r as mergeInboundPathRoots, t as isInboundPathAllowed } from "./inbound-path-policy-DQ5Rksw7.js";
import { i as getDefaultMediaLocalRoots } from "./local-roots-DY1lg2k6.js";
import { n as normalizeMediaProviderId, t as normalizeMediaExecutionProviderId } from "./provider-id-DSbuCFIb.js";
import { n as resolveOfficialExternalPluginRepairHint } from "./official-external-plugin-repair-hints-D_rfxjK5.js";
import { r as providerOperationRetryConfig } from "./operation-retry-CSNZJoxv.js";
import { t as describeImageWithModel } from "./image-runtime-DJpunQo1.js";
import { a as DEFAULT_TIMEOUT_SECONDS, l as getMediaUnderstandingProvider, n as DEFAULT_MAX_BYTES, o as DEFAULT_VIDEO_MAX_BASE64_BYTES, s as MIN_AUDIO_FILE_BYTES, t as CLI_OUTPUT_MAX_BUFFER } from "./defaults.constants-Bzdu2YOa.js";
import { t as assertRuntimeMediaRequestSecretOwnerAvailable } from "./runtime-media-secret-owner-C-EJ4rYa.js";
import { c as resolveTimeoutMs, n as resolveMaxBytes, o as resolvePrompt, r as resolveMaxChars } from "./resolve-iHjR7Egs.js";
...
import { a as extractImageContentFromSource, s as normalizeMimeType } from "./input-files-Dj_f4ctG.js";
import { i as normalizeAttachmentPath, n as isImageAttachment, r as isVideoAttachment, t as isAudioAttachment } from "./attachments.normalize-qZn2-M5R.js";
import "./temp-path-CW1P0Bq-.js";
import { a as resolveRequestedLocalAudioBackend, i as recordLocalAudioBackendObservation } from "./local-audio-IUt38He2.js";
import { n as executeWithApiKeyRotation, t as collectProviderApiKeysForExecution } from "./api-key-rotation-C5oFvX1Q.js";
import { i as resolveProxyFetchFromEnv } from "./proxy-fetch-CXtGpMfW.js";
...
var MediaAttachmentCache = class {
	...
	async getPath(params) {
		...
		if (entry.resolvedPath) {
			try {
				const size = await this.ensureLocalStat(entry);
				if (entry.resolvedPath && params.maxBytes && size !== void 0 && size > params.maxBytes) throw new MediaUnderstandingSkipError("maxBytes", `Attachment ${params.attachmentIndex + 1} exceeds maxBytes ${params.maxBytes}`);
			} catch (err) {
				if (!this.recordRecoverableLocalError(entry, err)) throw err;
			}
		...
		if (await this.activateStoreAlias(entry)) try {
			const size = await this.ensureLocalStat(entry);
			if (entry.resolvedPath) {
				if (params.maxBytes && size !== void 0 && size > params.maxBytes) throw new MediaUnderstandingSkipError("maxBytes", `Attachment ${params.attachmentIndex + 1} exceeds maxBytes ${params.maxBytes}`);
...
const loadModelAuth = createLazyRuntimeModule(async () => await import("./model-auth-CFB4LdRv.js"));
...
async function runProviderEntry(params) {
	...
	if (capability === "audio") {
		...
		const model = entry.model?.trim() || (await import("./defaults-DYWQ0JgL.js")).resolveDefaultMediaModel({
			cfg,
			providerId,
			capability: "audio",
			workspaceDir: params.workspaceDir
...
//#endregion
export { runCliEntry as a, normalizeImageDescriptionInput as c, isMediaUnderstandingSkipError as d, normalizeDecisionReason as i, MediaAttachmentCache as l, findDecisionReason as n, runProviderEntry as o, formatDecisionSummary as r, summarizeDecisionReason as s, buildModelDecision as t, selectAttachments as u };
