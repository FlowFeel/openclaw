...
import { i as resolveMatrixAccount } from "./accounts-BHHYYhli.js";
import { n as updateMatrixAccountConfig, t as resolveMatrixConfigPath } from "./config-update-DXmd3dgG.js";
import { n as matrixSetupAdapter } from "./setup-core-BeRBLEh5.js";
import { t as withResolvedActionClient } from "./client-Ds-0zHAs.js";
import { r as resolveMatrixAuthContext } from "./config-qJ5tyLJ8.js";
...
async function addMatrixAccount(params) {
	...
	if (accountConfig.encryption === true) {
		const { maybeBootstrapNewEncryptedMatrixAccount } = await import("./setup-bootstrap-3AsN4mZ_.js");
...
const loadMatrixActionClientModule = createLazyRuntimeModule(() => import("./client-Dn3C0etK.js"));
