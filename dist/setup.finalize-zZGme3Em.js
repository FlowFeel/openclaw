...
import { i as hasAuthProfileForProvider } from "./model-config.helpers-CQpluoYR.js";
import { r as listConfiguredWebSearchProviders } from "./runtime-CLK7mhcF.js";
...
async function startSessionGatewayForOnboarding(params) {
	...
	try {
		const { startGatewayServer } = await import("./server-C4JUjFkD.js");
...
const loadSearchSetupModule = createLazyRuntimeModule(() => import("./search-setup-B0GaBaJC.js"));
/**
...
async function finalizeSetupWizard(options) {
	...
	try {
		...
		const [{ resolveDefaultModelAuthStatus, resolveDefaultModelCatalogFacts }, { loadPreparedModelCatalogSnapshot }] = await Promise.all([import("./auth-choice-DPPCy75h.js"), import("./prepared-model-catalog-BddDieHg.js")]);
