...
import { b as findTaskByRunId, v as publishTaskRecordAfterAtomicStore, x as getTaskById } from "./task-registry-BbNCFm_L.js";
import { f as upsertTaskRunRowInDatabase, t as bindTaskRecord } from "./task-registry.store.sqlite-7VY-WxbM.js";
import "./runtime-internal-BwdZ6Qvg.js";
import { b as subagentRuns, c as upsertSubagentRunRowInDatabase, d as ensureDeliveryState, t as bindSubagentRunRecord } from "./subagent-registry.store.sqlite-gBhFvyR2.js";
import { t as ANNOUNCE_COMPLETION_HARD_EXPIRY_MS, y as resolveSubagentCompletionResultText } from "./subagent-registry-helpers-C-18dXVO.js";
import { _ as upsertBoundDeliveryQueueEntryInDatabase, g as loadDeliveryQueueEntryInDatabase, h as bindDeliveryQueueEntry, s as getDeliveryQueueEntryStatus, u as loadDeliveryQueueEntryAnyStatus } from "./delivery-queue-sqlite-C1XlYRGJ.js";
import { _ as prepareClaimedSessionDelivery, a as SessionDeliveryDeferredError, i as SessionDeliveryDeadLetteredError, m as loadPendingSessionDelivery, p as loadPendingSessionDeliveries, r as SESSION_DELIVERY_QUEUE_NAME, t as drainPendingSessionDeliveries, v as releaseSessionDeliveryClaim } from "./session-delivery-queue-PakCA19S.js";
import { t as computeBackoffMs } from "./delivery-recovery.shared-5qX8QsGe.js";
...
async function settleCorrelatedSubagentDelivery(queued, outcome) {
	...
	publishCommittedRecords(subagent, projectedTask);
	if (outcome === "recovered") {
		const { resumeSubagentRun } = await import("./subagent-registry-XK4iQvAp.js");
