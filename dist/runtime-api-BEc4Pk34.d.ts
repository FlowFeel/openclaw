import { yt as AcpRuntime } from "./types.openclaw-DlZm98yj.js";
...
//#endregion
export { AcpRuntimeErrorCode as a, WindowsSpawnResolution as c, resolveWindowsSpawnProgramCandidate as d, AcpRuntimeError as i, applyWindowsSpawnProgramPolicy as l, registerAcpRuntimeBackend as n, WindowsSpawnProgram as o, unregisterAcpRuntimeBackend as r, WindowsSpawnProgramCandidate as s, getAcpRuntimeBackend as t, materializeWindowsSpawnProgram as u };