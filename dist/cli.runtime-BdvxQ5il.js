...
import { D as resolveMemoryRemDreamingConfig, E as resolveMemoryLightDreamingConfig, S as resolveMemoryDreamingConfig } from "./dreaming-CisvAHct.js";
import { b as isUsageCountedSessionTranscriptFileName, c as resolveSessionTranscriptsDirForAgent } from "./paths-DSnYpBD3.js";
...
import { d as normalizeExtraMemoryPaths, u as listMemoryFiles } from "./internal-CYxvuRJj.js";
...
import "./memory-core-host-runtime-cli-Az1kUuUY.js";
...
import { n as resolveShortTermPromotionDreamingConfig } from "./dreaming-Cjf2gARb.js";
import { i as removeBackfillDiaryEntries, o as writeBackfillDiaryEntries } from "./dreaming-narrative-2J0NuTT4.js";
import { t as previewGroundedRemMarkdown } from "./rem-evidence-BeXMX9Q9.js";
import { r as runSessionBackfill } from "./session-backfill-rQu03QY6.js";
import { a as resolveShortTermRecallLockPath, d as recordShortTermRecalls, i as repairShortTermPromotionArtifacts, n as auditShortTermPromotionArtifacts, o as resolveShortTermRecallStorePath, r as removeGroundedShortTermCandidates, s as applyShortTermPromotions, t as rankShortTermPromotionCandidates, u as recordGroundedShortTermCandidates } from "./short-term-promotion-DcwUg1Fk.js";
import { i as seedHistoricalDailyMemorySignals } from "./dreaming-phases-NvY-MxUY.js";
import { t as previewRemHarness } from "./rem-harness-DUSWN8Nf.js";
import { i as formatMemoryVectorDegradedWriteReason } from "./manager-DuiBzVhj.js";
import { r as getMemorySearchManager } from "./memory-CiCw_RX4.js";
	...
	for (const result of allResults) {
		...
		if (audit?.issues.length) {
			...
			if (!opts.fix) {
				...
				if (audit.issues.some((issue) => issue.code === "qmd-index-missing")) lines.push(`  ${muted(`Fix: openclaw memory index --agent ${agentId}`)}`);
			}
		}
