...
import { tt as MemoryEntryProvenance } from "./types-odeWQ5Sn.js";
...
type ShortTermAuditIssue = {
  severity: "warn" | "error";
  code: "recall-store-unreadable" | "recall-store-empty" | "recall-store-invalid" | "recall-store-dangling" | "recall-store-over-limit" | "recall-lock-stale" | "recall-lock-unreadable" | "qmd-index-missing" | "qmd-index-empty" | "qmd-collections-empty";
  message: string;
  fixable: boolean;
};
...
//#endregion
export { repairShortTermPromotionArtifacts as a, RepairShortTermPromotionArtifactsResult as c, ShortTermDreamingStatsEntry as d, ShortTermRecallEntry as f, removeGroundedShortTermCandidates as i, ShortTermAuditSummary as l, resolveMemoryRemDreamingConfig as n, loadShortTermPromotionDreamingStats as o, auditShortTermPromotionArtifacts as r, PromotionCandidate as s, resolveMemoryDeepDreamingConfig as t, ShortTermDreamingStats as u };