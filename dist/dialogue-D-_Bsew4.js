...
import { a as parseSystemAgentOperation, n as describeSystemAgentPersistentOperation } from "./operations-CPFqirC1.js";
...
async function resolveSystemAgentOperation(input, runtime, opts) {
	...
	const planner = opts.planWithAssistant ?? (await import("./assistant-CQmq5t2T.js")).planSystemAgentCommand;
	let plan;
	try {
		plan = await planner({
			input,
