import { d as inspectProviderToolSchemasWithPlugin, v as normalizeProviderToolSchemasWithPlugin } from "./provider-runtime-DlVC1wsY.js";
import { l as copyAgentToolMetadata } from "./gateway-B5H4NIb8.js";
...
function copyRuntimeToolMetadata(source, target) {
	...
	copyAgentToolMetadata(source, target);
}
...
function normalizeAgentRuntimeTools(params) {
	...
	const normalized = params.runtimePlan?.tools.normalize(normalizableTools, planContext) ?? (normalizableTools.length === 0 ? normalizableTools : normalizeProviderToolSchemas({
