...
import { m as readProviderJsonResponse, r as assertOkOrThrowHttpError } from "./provider-http-errors-Cj7zfu8U.js";
...
import { r as isProviderApiKeyConfigured } from "./provider-auth-SalgjzRl.js";
import { c as postJsonRequest, h as resolveProviderOperationTimeoutMs, l as postMultipartRequest, n as createProviderOperationDeadline, p as resolveProviderHttpRequestConfig } from "./shared-3S5SOCXx.js";
...
import { c as parseOpenAiCompatibleImageResponse, l as resolveInlineImageJsonResponseMaxBytes, o as imageSourceUploadFileName } from "./image-generation-DS34MOKs.js";
import { f as extractFoundryEndpoint, g as isFoundryProviderApi, h as isFoundryMaiImageModel, o as PROVIDER_ID, r as DEFAULT_API } from "./shared-CIx0ozNE.js";
import "./shared-runtime-BS4zHTqa.js";
import { t as prepareFoundryRuntimeAuth } from "./runtime-Bxsihzzv.js";
	...
	return {
		...
		async generateImage(req) {
			...
			try {
				...
				return {
					images: parseMaiImageResponse(await readProviderJsonResponse(response, "microsoft-foundry.image-generation", { maxBytes: resolveInlineImageJsonResponseMaxBytes(MAI_IMAGE_MAX_RESULTS, resolveGeneratedMediaMaxBytes(req.cfg, "image")) }), label),
					model
				};
			} finally {
				await release();
