...
import { f as isSameSsrFPolicy } from "./ssrf-C889LYfv.js";
import { c as splitSandboxBindSpec, s as resolveSandboxHostPathViaExistingAncestor } from "./network-mode-BDM-B9l_.js";
import { t as KeyedAsyncQueue } from "./keyed-async-queue-CTreGrmR.js";
import { a as resolveSandboxPath, i as resolveSandboxInputPath } from "./sandbox-paths-Cwxd9MU0.js";
import { C as MAX_WORKSPACE_BOOTSTRAP_FILE_BYTES, c as DEFAULT_USER_FILENAME, i as DEFAULT_IDENTITY_FILENAME, n as DEFAULT_BOOTSTRAP_FILENAME, o as DEFAULT_SOUL_FILENAME, p as ensureAgentWorkspace, t as DEFAULT_AGENTS_FILENAME, w as readWorkspaceBootstrapFile } from "./workspace-CelKqYGr.js";
import { C as SANDBOX_DOCKER_CREATE_ARGS_EPOCH, b as SANDBOX_BROWSER_SECURITY_HASH_EPOCH, g as SANDBOX_AGENT_WORKSPACE_MOUNT, v as SANDBOX_BROWSER_IMAGE_CONTRACT_EPOCH } from "./constants-Bx1otCol.js";
import { n as isToolAllowed } from "./tool-policy-CnoAKsDO.js";
import { i as resolveSandboxConfigForAgent, r as resolveSandboxBrowserDockerCreateConfig } from "./config-Cp0gVUpH.js";
...
import { n as toSandboxProvisioningError } from "./provisioning-error-BdOep9IC.js";
import { c as resolveReadOnlyWorkspaceSkillMounts, i as formatReadOnlyWorkspaceSkillMountHashState, n as appendWorkspaceMountArgs, r as filterBindsConflictingWithProtectedMounts, s as resolveProtectedSkillMountContainerPaths, t as appendReadOnlyWorkspaceSkillMountArgs } from "./workspace-mounts-CCr3SGIJ.js";
import { a as DEFAULT_OPENCLAW_BROWSER_COLOR, d as ensureBrowserControlAuth, f as resolveBrowserControlAuth, l as resolveBrowserConfig, n as DEFAULT_BROWSER_ACTION_TIMEOUT_MS, s as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, u as resolveProfile } from "./browser-profiles-m-PrxlvD.js";
import { C as updateRegistry, S as updateBrowserRegistry, _ as readBrowserRegistry, f as readDockerContainerEnvVar, l as formatDockerDaemonUnavailableError, m as readDockerPort, p as readDockerContainerLabel, r as dockerContainerState, s as execDocker, t as buildSandboxCreateArgs, u as isDockerDaemonUnavailable, v as readRegisteredSandboxRuntimeIds } from "./docker-BEBl8MGb.js";
import { a as computeSandboxBrowserConfigHash, t as resolveDockerEnvPolicyEpoch } from "./sanitize-env-vars-CFjdcS_D.js";
import { i as slugifySessionKey, n as resolveSandboxAgentId, r as resolveSandboxWorkspaceLayoutPaths, t as buildSandboxContainerName } from "./shared-Ckksfird.js";
import { n as validateNetworkMode } from "./validate-sandbox-security-Dj7RZU7m.js";
import { A as buildPinnedMkdirpPlan, C as parseSandboxStatMtimeMs, F as runDockerSandboxShellCommand, M as buildPinnedRenamePlan, N as buildPinnedWritePlan, O as buildPinnedCopyPlan, i as startBrowserBridgeServer, j as buildPinnedRemovePlan, k as buildPinnedCreatePlan, l as requireSandboxBackendFactory, n as stopCachedBrowserBridge, r as stopCachedBrowserBridgesForContainer, s as getSandboxBackendWorkdirResolver, t as BROWSER_BRIDGES, w as parseSandboxStatSize, x as assertSshSandboxSecretOwnerAvailable } from "./browser-bridges-Kd9fcEev.js";
...
async function syncSandboxSkillsToWorkspace(params) {
	try {
		const [{ syncSkillsToWorkspace }, { getRemoteSkillEligibility }, { resolveNodeExecEligibility }] = await Promise.all([
			import("./workspace-CW_rytt_.js"),
			import("./remote-CMP617yQ.js"),
			import("./exec-defaults-Bu-FrQ6k.js")
		]);
...
async function resolveProvisionedSandboxContext(params, resolved) {
	...
	if (cfg.prune.idleHours !== 0 || cfg.prune.maxAgeDays !== 0) await (await import("./prune-DG4tX5kj.js")).maybePruneSandboxes(cfg);
