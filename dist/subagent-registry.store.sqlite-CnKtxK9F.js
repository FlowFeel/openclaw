...
import { M as normalizeAgentRunTerminalReplySnapshot, d as openOpenClawStateDatabase, h as runOpenClawStateWriteTransaction } from "./openclaw-state-db-D9eH245j.js";
...
function hasCanonicalDeliveryState(value) {
	return hasStateStatus(value, DELIVERY_STATUSES) && !("handoffLeaseId" in value || "handoffLeasedAt" in value || "handoffInjectedAt" in value);
}
function isCanonicalSubagentRunRecord(value) {
	return isRecord(value) && hasStateStatus(value.execution, EXECUTION_STATUSES) && isRecord(value.completion) && typeof value.completion.required === "boolean" && hasCanonicalDeliveryState(value.delivery);
}
...
function rowToSubagentRunReadRecord(row) {
	...
	return Object.fromEntries(Object.entries({
		...
		delivery: deliveryStatus ? {
			...
			...normalizeFiniteNumber(row.delivery_suspended_at) !== void 0 ? { suspendedAt: row.delivery_suspended_at ?? void 0 } : {}
		} : void 0
...
//#endregion
export { findSwarmCollectorSession as _, loadSubagentSessionListRunsFromSqlite as a, subagentRuns as b, upsertSubagentRunRowInDatabase as c, ensureDeliveryState as d, getDeliveryAttemptCount as f, findAuthorizedSwarmCollectorRequest as g, normalizeSubagentRunState as h, loadSubagentRunsForControllerFromSqlite as i, clearDeliveryState as l, isDeliverySuspended as m, loadSubagentRegistryFromSqlite as n, saveSubagentRegistryChangesToSqlite as o, getDeliveryLastError as p, loadSubagentRunsForChildSessionFromSqlite as r, saveSubagentRegistryToSqlite as s, bindSubagentRunRecord as t, ensureCompletionState as u, getSubagentRunsForChildSession as v, getSubagentRunsForCollectorGroup as y };
