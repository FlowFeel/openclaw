...
import { a as listGitWorktrees, d as runGit, t as commandError } from "./git-Ba83QtEc.js";
import { b as releaseWorktreeRunLeaseRow, d as getRegistryWorktree, g as hasLiveWorktreeRunLeaseRow, n as admitWorktreeRunLeaseRow, r as claimWorktreeRemovalRow, s as finalizeWorktreeRemovalRows, t as abortWorktreeRemovalRow, y as listRegistryWorktrees } from "./registry-iwzuX13n.js";
...
async function retainGitLock(env, id) {
	await withGitLockTransition(id, async () => {
		...
		try {
			...
			log.warn(`worktree git lock unavailable for ${id}: ${formatErrorMessage(error)}`);
		}
	});
}
