...
import { Bn as ProviderRuntimeModel, En as ProviderResolveDynamicModelContext, Fn as ProviderReplayPolicy, In as ProviderReplayPolicyContext, Ln as ProviderSanitizeReplayHistoryContext, Mn as ProviderSystemPromptContribution, Pn as ProviderReasoningOutputMode, Sn as ProviderThinkingProfile, i as ProviderPlugin } from "./types-DdUyjaEr.js";
import { r as PluginMetadataSnapshotOwnerMaps } from "./plugin-metadata-snapshot.types-CKqzUu4R.js";
import { m as definePluginEntry } from "./plugin-entry-DuzbjtPT.js";
...
//#endregion
export { supportsClaudeAdaptiveThinking as $, isGpt5ModelId as A, buildPassthroughGeminiSanitizingReplayPolicy as B, resolveToolCallArgumentsEncoding as C, GPT5_FRIENDLY_PROMPT_OVERLAY as D, GPT5_FRIENDLY_CHAT_PROMPT_OVERLAY as E, buildAnthropicReplayPolicyForModel as F, requiresClaudeMandatoryAdaptiveThinking as G, resolveTaggedReasoningOutputMode as H, buildGoogleGeminiReplayPolicy as I, resolveClaudeMythos5ModelIdentity as J, resolveClaudeFable5ModelIdentity as K, buildHybridAnthropicOrOpenAIReplayPolicy as L, resolveGpt5PromptOverlayMode as M, resolveGpt5SystemPromptContribution as N, GPT5_HEARTBEAT_PROMPT_OVERLAY as O, isCloudModelRef as P, supportsClaude1MContext as Q, buildNativeAnthropicReplayPolicyForModel as R, normalizeModelCompat as S, GPT5_BEHAVIOR_CONTRACT as T, sanitizeGoogleGeminiReplayHistory as U, buildStrictAnthropicReplayPolicy as V, requiresClaudeDefaultSampling as W, resolveClaudeOpus5ModelIdentity as X, resolveClaudeNativeThinkingLevelMap as Y, resolveClaudeSonnet5ModelIdentity as Z, cloneFirstTemplateModel as _, ProviderReplayFamily as a, applyModelCompatPatch as b, defineSelfHostedOpenAICompatibleProvider as c, normalizeAntigravityPreviewModelId as d, supportsClaudeFastMode as et, normalizeGooglePreviewModelId as f, resolveClaudeThinkingProfile as g, isClaudeAdaptiveThinkingDefaultModelId as h, PASSTHROUGH_GEMINI_REPLAY_HOOKS as i, normalizeGpt5PromptOverlayMode as j, Gpt5PromptOverlayMode as k, isProxyReasoningUnsupportedModelHint as l, selectPreferredLocalModelId as m, NATIVE_ANTHROPIC_REPLAY_HOOKS as n, supportsClaudeNativeXhighEffort as nt, SelfHostedOpenAICompatibleProviderOptions as o, normalizeProviderId as p, resolveClaudeModelIdentity as q, OPENAI_COMPATIBLE_REPLAY_HOOKS as r, buildProviderReplayFamilyHooks as s, ANTHROPIC_BY_MODEL_REPLAY_HOOKS as t, supportsClaudeNativeMaxEffort as tt, modelCostsEqual as u, matchesExactOrPrefix as v, resolveUnsupportedToolSchemaKeywords as w, hasToolSchemaProfile as x, resolveFamilyForwardCompatModel as y, buildOpenAICompatibleReplayPolicy as z };