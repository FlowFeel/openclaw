...
import { h as isBrowserProxyNodeInvokeCommand, m as isAdminOnlyNodeInvokeCommand } from "./node-commands-CeG5w7c2.js";
import { c as isForbiddenBrowserProxyMutation } from "./method-scopes-ChuOr7sh.js";
...
import { $t as validateNodePairApproveParams, Jt as validateNodeEventParams, Qt as validateNodeListParams, Xt as validateNodeInvokeProgressParams, Yt as validateNodeInvokeParams, Zt as validateNodeInvokeResultParams, cn as validateNodeRenameParams, en as validateNodePairListParams, ln as validateNodeSkillsUpdateParams, nn as validateNodePairRemoveParams, on as validateNodePluginToolsUpdateParams, qt as validateNodeDescribeParams, rn as validateNodePendingAckParams, tn as validateNodePairRejectParams } from "./src-BSn6va4B.js";
import { a as errorShape, o as missingScopeErrorShape } from "./error-codes-P4fBo0lR.js";
import { p as replaceRemoteNodeSkills } from "./workspace-D-nfQV8D.js";
import { a as isForegroundRestrictedPluginNodeCommand, c as normalizeDeclaredNodeCommands, l as resolveNodeCommandAllowlist, o as isNodeCommandAllowed, t as DEFAULT_DANGEROUS_NODE_COMMANDS, u as resolveNodePairingCommandAllowlist } from "./node-command-policy-DdvZ7E6j.js";
import { _ as removePairedDeviceRole, d as listDevicePairing, s as getPairedDevice, u as listApprovedPairedDeviceRoles, x as resolveNodePairingState } from "./device-pairing-pwb3Oe75.js";
import { a as listNodePairing, c as rejectNodePairing, i as getPendingNodePairing, o as projectNodePairing, t as approveNodePairing, u as renamePairedNode } from "./node-pairing-B1-4tayK.js";
...
import { i as respondUnavailableOnThrow, r as respondUnavailableOnNodeInvokeErrorWithProvenance, t as respondInvalidParams } from "./nodes.helpers-Dm-FYJFz.js";
import { i as buildSystemRunApprovalBinding, l as toSystemRunApprovalMismatchError, o as matchSystemRunApprovalBinding, r as resolveSystemRunCommandRequest, s as missingSystemRunApprovalBinding } from "./system-run-command-BnpjDuob.js";
import { r as resolveSystemRunApprovalRuntimeContext } from "./system-run-approval-context-ClRO-ZUk.js";
import { c as loadApnsRegistration, g as resolveApnsRelayConfigFromEnv, i as clearApnsRegistrationIfCurrent } from "./push-apns-store-DIKYgzVs.js";
import { c as resolveApnsAuthConfigFromEnv, n as sendApnsBackgroundWake, s as shouldClearStoredApnsRegistration, t as sendApnsAlert } from "./push-apns-BPyUYCWp.js";
import { t as EXEC_APPROVAL_RESOLVED_ENTRY_GRACE_MS } from "./exec-approval-manager-CiCCczJ0.js";
import { a as removePendingNodeAction, i as listPendingNodeActions, n as clearRemovedNodeRuntimeState, o as replacePendingNodeActionsForGeneration, r as enqueuePendingNodeAction, t as acknowledgePendingNodeActions } from "./node-runtime-state-BnvKce59.js";
import { a as invalidateNodeWakeState, c as runNodeWakeAttempt, l as runNodeWakeNudgeAttempt, n as NODE_WAKE_RECONNECT_WAIT_MS, o as isNodeWakeLifecycleCurrent, r as captureNodeWakeLifecycle, s as releaseNodeWakeLifecycle, t as NODE_WAKE_RECONNECT_RETRY_WAIT_MS } from "./node-wake-state-CLsta4Jn.js";
import { i as pairedDeviceHasNonOperatorRole, n as deniesCrossDeviceManagement, o as resolveDeviceManagementAuthz, s as resolveDeviceSessionAuthz, t as emitDeviceManagementSecurityEvent } from "./device-management-security-DBAvOEyn.js";
import { n as getKnownNode, r as listKnownNodes, t as createKnownNodeCatalog } from "./node-catalog-Cjeceeru.js";
import { a as isNodePairingGenerationCurrent, n as captureNodePairingGeneration, r as captureNodePairingState } from "./node-pairing-state-BsMP4I3d.js";
import { t as applyPluginNodeInvokePolicy } from "./node-invoke-plugin-policy-BY224AUd.js";
...
const nodeEventHandlers = { "node.event": async ({ params, respond, context, client }) => {
	...
	await respondUnavailableOnThrow(respond, async () => {
		...
		const { handleNodeEvent } = await import("./server-node-events-bOcSqFBp.js");
...
function listNodesForClient(params) {
	...
	})).map((node) => node.nodeId === params.localNodeId ? Object.assign({}, node, { gatewayLocal: true }) : node);
	...
	"node.list": async ({ params, respond, client, context }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			...
			const localNodeId = await resolveLocalNodeId().catch((error) => {
				context.logGateway.warn(`failed to resolve same-install node-host identity: ${formatErrorMessage(error)}`);
				return null;
			});
...
//#endregion
export { waitForNodeReconnect as i, maybeSendNodeWakeNudge as n, maybeWakeNodeWithApns as r, nodeHandlers as t };
