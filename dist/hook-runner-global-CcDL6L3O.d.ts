import { i as OpenClawConfig, ti as TtsAutoMode, vs as ChatType } from "./types.openclaw-3lPuYQv-.js";
import { g as DeliveryContext, h as SourceReplyDeliveryMode } from "./types-Dt3tB0SE.js";
import { t as AgentMessage } from "./types-ifNunyTs.js";
import { N as ReplyPayload, S as PluginHookChannelContext, t as FinalizedMsgContext, w as MediaFact } from "./templating-CXWZ_qCV.js";
 ...
 */
declare function hasGlobalHooks<K extends PluginHookName>(hookName: K, ctx?: Parameters<PluginHookHandlerMap[K]>[1]): boolean;
...
//#endregion
export { ReplyDispatchBeforeDeliverOptions as C, ReplyFollowupAdmissionBarrierTimeoutPolicy as D, ReplyDispatcher as E, ReplyDispatchBeforeDeliver as S, ReplyDispatchRuntimeInfo as T, PluginConversationBindingRequestParams as _, resetGlobalHookRunner as a, PluginHookBeforeToolCallResult as b, PluginSubagentRequesterContext as c, PluginHookReplyPayloadSendingContext as d, PluginHookToolContext as f, PluginConversationBinding as g, PluginJsonValue as h, initializeGlobalHookRunner as i, PluginHookBeforeToolCallEvent as l, PluginToolMatcher as m, getGlobalPluginRegistry as n, runGlobalGatewayStopSafely as o, PluginHookToolRequesterContext as p, hasGlobalHooks as r, HookEntry as s, getGlobalHookRunner as t, PluginHookRegistration as u, PluginConversationBindingRequestResult as v, ReplyDispatchKind as w, DiagnosticTraceContext as x, PluginConversationBindingResolvedEvent as y };