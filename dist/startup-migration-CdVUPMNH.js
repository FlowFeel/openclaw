...
import { f as isOpenClawAgentDatabaseOpen, h as openOpenClawAgentDatabase, i as closeOpenClawAgentDatabaseByPath } from "./openclaw-agent-db--PLC25lY.js";
import { d as SESSION_STORE_TEMP_STALE_MS, v as isSessionStoreTempArtifactName } from "./paths-DSnYpBD3.js";
import { W as setCanonicalSqliteSessionMainKey, s as resolveAllAgentSessionStoreTargetsSync } from "./targets-Dooi6t13.js";
import { r as resolveSqliteTargetFromSessionStorePath } from "./session-sqlite-target-BlEPGL-w.js";
import { f as migrateOrphanedSessionKeys } from "./state-migrations-b2biCSrC.js";
...
async function runSessionStartupMigration(params) {
	...
	try {
		let removedFiles = 0;
		for (const target of resolveTargets(params.cfg, { env: params.env ?? process.env })) {
