...
import { C as listFreshTasksForOwnerKey, E as listTaskRecordsUnsorted, k as listTasksForOwnerKey } from "./task-registry-CYuVw6Rm.js";
...
import { t as cancelDetachedTaskRunById } from "./task-executor-DKMaRIVg.js";
import { d as registerGeneratedMediaTaskActivity, u as clearGeneratedMediaTaskActivity } from "./task-status-access-CeK79h8b.js";
import { c as recordTaskRunProgressByRunId, i as failTaskRunByRunId, r as createRunningTaskRun, t as completeTaskRunByRunId } from "./detached-task-runtime-B4AETmyJ.js";
...
import { t as buildTaskStatusSnapshotForRelatedSessionKeyForOwner } from "./task-owner-access-oW1uywlo.js";
...
import { o as getInProcessGatewayRequestContext, r as dispatchGatewayMethodInProcess, u as hasInProcessGatewayContext } from "./server-plugins-B7M_VHf6.js";
...
import { n as SWARM_CODE_MODE_REQUEST_FINGERPRINT, r as createAgentsWaitTool, t as SWARM_CODE_MODE_IDEMPOTENCY_KEY } from "./swarm-code-mode-dkEqSknt.js";
...
import { o as listControlledSubagentRuns, s as resolveSubagentController, t as MAX_RECENT_MINUTES } from "./subagent-control-B_nRNkmT.js";
...
const defaultAgentStepDeps = {
	agentCommandFromIngress: (async (...args) => {
		const { agentCommandFromIngress } = await import("./agent-COlyptaf.js");
...
const acpSpawnModuleLoader = createLazyImportLoader(() => import("./acp-spawn-f6soEs8v.js"));
	...
	const tools = [
		...
		createSessionsYieldTool({
			...
			onBeforeYield: requesterSessionKey && requesterTurnRunId ? async () => {
				const { markRequesterTurnYielded } = await import("./subagent-registry-CjPpjF8W.js");
