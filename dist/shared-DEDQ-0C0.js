...
import { n as resolveMatrixAuth, r as resolveMatrixAuthContext } from "./config-CjddSpCO.js";
import { t as awaitMatrixStartupWithAbort } from "./startup-abort-BYdCNXCk.js";
//#region extensions/matrix/src/matrix/client/shared.ts
const loadMatrixCreateClientDeps = createLazyRuntimeModule(() => import("./create-client-BLDm6aWe.js").then((runtime) => ({ createMatrixClient: runtime.createMatrixClient })));
