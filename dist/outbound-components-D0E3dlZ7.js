...
const loadDiscordComponentSend = createLazyRuntimeNamedExport(() => import("./send.components-jfgd6T0N.js"), "sendDiscordComponentMessage");
async function sendDiscordComponentMessageLazy(...args) {
	return await (await loadDiscordComponentSend())(...args);
}
const loadDiscordSharedInteractive = createLazyRuntimeModule(() => import("./shared-interactive-B8AIDs2q.js"));
