...
import { c as performGatewaySessionReset } from "./session-reset-service-BN-FVjQD.js";
...
import { a as enforceChatHistoryFinalBudget, i as CHAT_HISTORY_MAX_SINGLE_MESSAGE_BYTES, n as enrichChatHistoryCompactionMarkers, o as replaceOversizedChatHistoryMessages, r as readChatHistoryPage } from "./chat-Bnva4sHW.js";
import { a as isAgentLifecycleYieldedWaiting } from "./session-lifecycle-state-BoFtWO_a.js";
import { n as createGatewaySession } from "./session-create-service-aL32duv_.js";
...
var EmbeddedTuiBackend = class {
	...
	async runBtwTurn(params) {
		...
		const { runBtwSideQuestion } = await import("./btw-Cqop6_yb.js");
