...
import { a as parseSystemAgentOperation, n as describeSystemAgentPersistentOperation } from "./operations-Cqkrh_F4.js";
...
async function resolveSystemAgentOperation(input, runtime, opts) {
	...
	const planner = opts.planWithAssistant ?? (await import("./assistant-DyJ1T4be.js")).planSystemAgentCommand;
	let plan;
	try {
		plan = await planner({
			input,
