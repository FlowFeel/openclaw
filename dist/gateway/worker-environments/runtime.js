...
import { c as resolveNpmJsonEntries, r as isExactSemverVersion } from "../../npm-registry-spec-CCN1EPEy.js";
...
import { ya as validateWorkerAdmissionHandshake } from "../../src-BSn6va4B.js";
import "../../worker-admission-cYaTLkLk.js";
import { i as normalizeScpRemotePath } from "../../scp-host-BtrM4IVE.js";
import { n as collectPackageDistInventory } from "../../package-dist-inventory-69ttVzFT.js";
...
async function collectWorkerBundleManifest(sourceRoot, stagingRoot) {
	...
	const distFiles = (await collectPackageDistInventory(sourceRoot)).filter((relativePath) => !relativePath.startsWith(CONTROL_UI_DIST_PREFIX));
