...
import { l as normalizeMediaFacts } from "./media-facts-D_wLZOa9.js";
...
import { t as resolveChannelInboundAttachmentRoots } from "./channel-inbound-roots-BS9lcokh.js";
import { n as isMinimaxVlmProvider, t as isMinimaxVlmModel } from "./minimax-vlm-C1va_sOg.js";
import { t as providerSupportsCapability } from "./provider-supports-msSTK_XS.js";
import { c as buildMediaUnderstandingRegistry, l as getMediaUnderstandingProvider } from "./defaults.constants-BD7Nlx_t.js";
import { i as matchesMediaEntryCapability } from "./runtime-media-secret-owner-C-EJ4rYa.js";
import { a as resolveModelEntries, s as resolveScopeDecision } from "./resolve-0kU3je6X.js";
import { n as resolveOpenAiAudioAuthModelApi } from "./openai-audio-api-BEkNYRPi.js";
import { a as runCliEntry, d as isMediaUnderstandingSkipError, l as MediaAttachmentCache, o as runProviderEntry, r as formatDecisionSummary, t as buildModelDecision, u as selectAttachments } from "./runner.entries-DK8t-WRd.js";
import { a as normalizeAttachments } from "./attachments.normalize-qZn2-M5R.js";
import { r as inspectLocalAudioSelection, t as clearLocalAudioInspectionCacheForTests } from "./local-audio-BZ6KL61K.js";
...
const loadHasAvailableAuthForProvider = createLazyRuntimeNamedExport(() => import("./model-auth-BR9AFEUL.js"), "hasAvailableAuthForProvider");
const loadPreparedModelCatalogApi = createLazyRuntimeModule(async () => ({
	...await import("./model-catalog-CcDInTyl.js"),
	...await import("./prepared-model-catalog-ClbAcHfK.js")
}));
...
async function resolveAutoImageModelId(params) {
	...
	const { resolveDefaultMediaModel } = await import("./defaults-BR1boIhr.js");
