...
function isLocalDirectRequest(req, _trustedProxies, _allowRealIpFallback = false) {
	return Boolean(req && !hasForwardedRequestHeaders(req) && isLoopbackAddress(req.socket?.remoteAddress));
}
...
async function resolveGatewayListenHosts(bindHost, opts) {
	...
	if (bindHost !== "127.0.0.1") return requiredHosts;
...
function resolveGatewayRequiredListenHosts(bindHost) {
	if (!isValidIPv4(bindHost) || bindHost === "0.0.0.0" || bindHost === "127.0.0.1") return [bindHost];
...
//#endregion
export { resolveGatewayRequiredListenHosts as _, isLoopbackAddress as a, resolveRequestClientIp as b, isPrivateOrLoopbackHost as c, isValidIPv4 as d, normalizeHostHeader as f, resolveGatewayListenHosts as g, resolveGatewayBindHost as h, isLocalishHost as i, isSecureWebSocketUrl as l, resolveClientIp as m, hasForwardedRequestHeaders as n, isLoopbackHost as o, pickPrimaryLanIPv4 as p, isLocalDirectRequest as r, isPrivateOrLoopbackAddress as s, defaultGatewayBindMode as t, isTrustedProxyAddress as u, resolveHostName as v, resolveLocalInterfaceAddressMatch as y };
