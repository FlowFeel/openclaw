...
import { r as hasResolvedRosterBeforeMigrations, t as configIncludeOwnsAgentRoster } from "./agent-roster-provenance-BUXNi_-c.js";
...
*/
const agentWorkspaceModuleLoader = createLazyImportLoader(() => import("./workspace-fBzfEn2v.js"));
const configIOModuleLoader = createLazyImportLoader(() => import("./config/config.js"));
const configLoggingModuleLoader = createLazyImportLoader(() => import("./logging-l6OoqoUS.js"));
...
async function resolveDefaultSessionTranscriptsDir(agentId) {
	const { resolveSessionTranscriptsDirForAgent } = await import("./sessions-BXkYDbE_.js");
