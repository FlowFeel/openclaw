...
import "./thread-bindings-session-runtime-CfB_YBgu.js";
...
import { a as listBindingsForAccount, c as resolveBindingKey, f as setMatrixThreadBindingManagerEntry, h as toSessionBindingRecord, l as resolveEffectiveBindingExpiry, m as toMatrixBindingTargetKind, o as removeBindingRecord, r as getMatrixThreadBindingManagerEntry, t as deleteMatrixThreadBindingManagerEntry, u as setBindingRecord } from "./thread-bindings-shared-CXo3zvhw.js";
import { T as resolveMatrixSqliteStateKey, w as resolveMatrixSqliteStateEnv } from "./crypto-state-store-3ILKBeVs.js";
import { c as resolveMatrixStateFilePath, t as claimCurrentTokenStorageState } from "./storage-xmjHT5f5.js";
import { r as sendMessageMatrix } from "./send-BX1nUWA6.js";
	...
	const sessionBindingAdapter = {
		...
		bind: async (input) => {
			...
			const record = {
				...
				targetSessionKey,
				agentId: normalizeOptionalString(input.metadata?.agentId) || resolveAgentIdFromSessionKey(targetSessionKey, resolveDefaultAgentId(params.cfg)),
