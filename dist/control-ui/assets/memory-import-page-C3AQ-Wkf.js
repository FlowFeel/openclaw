import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{b as t,y as n}from"./control-ui-foundation-OE0aAIzW.js";import{Bc as r,Bo as i,Ho as a,Kc as o,Ro as s,Vc as c,Wc as l}from"./control-ui-core-BUddgKjW.js";import{K as u,Q as ee,W as d,Y as f,nt as p}from"./lit-runtime-D5xZwgO1.js";import{f as te,g as m,i as h,m as g,p as _,r as v}from"./control-ui-foundation-Dgui328h.js";import{Ut as y,Wt as b,_ as ne,jt as x,v as S}from"./control-ui-core-Ct5CBwjl.js";import{o as C,t as w}from"./control-ui-core-s0pW0mau.js";import{pt as re,vt as T,yt as ie}from"./control-ui-core-vLOElyFQ.js";import{i as ae,n as E}from"./gateway-runtime-DWs8EJ0W.js";import{o as D,r as O}from"./provider-icon-C8NbtTKP.js";import{n as k,t as A}from"./settings-workspace-BbyrBOFl.js";import{c as j,f as M,h as N,i as P,m as F,n as I,s as L,t as R,u as z}from"./settings-ui-Bko7fBdZ.js";import{t as B}from"./agent-select-registration-BVCfxMHW.js";var V=e((()=>{}));function H(e,t){let n=e.details?.[t];return typeof n==`string`&&n.trim()?n:void 0}function U(e){let t=new Map;for(let n of e){let e=H(n,`collectionId`)??n.id,r=H(n,`collectionLabel`)??H(n,`sourceLabel`)??C(`memoryImport.unknownCollection`),i=t.get(e)??{id:e,label:r,items:[]};i.items.push(n),t.set(e,i)}return[...t.values()].toSorted((e,t)=>e.label.localeCompare(t.label))}function W(e){return e.providerId===`claude`?C(`memoryImport.claudeCode`):e.label}function G(e){return e.providerId===`codex`?C(`memoryImport.codexDescription`):e.providerId===`claude`?C(`memoryImport.claudeDescription`):C(`memoryImport.providerFallback`)}function K(e){return C(e===1?`memoryImport.fileCountOne`:`memoryImport.fileCount`,{count:String(e)})}function q(e){return C(e===1?`memoryImport.backfill.processedDayCountOne`:`memoryImport.backfill.processedDayCount`,{count:String(e)})}function J(e){let t=H(e,`relativePath`);if(t)return t;let n=e.target??e.source??e.id;return n.split(/[\\/]/u).at(-1)??n}function oe(e,t,n,r,i){let a=t.items.filter(e=>e.status===`planned`).map(e=>e.id),o=a.length>0&&a.every(e=>n.has(e)),s=t.items.filter(e=>e.status===`conflict`).length;return f`
...
//# sourceMappingURL=memory-import-page-C3AQ-Wkf.js.map