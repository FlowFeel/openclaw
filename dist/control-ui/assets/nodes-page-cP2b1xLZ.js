import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{b as t,d as n,l as r,y as i}from"./control-ui-foundation-OE0aAIzW.js";import{$n as a,$s as o,Ar as s,Bc as c,Gs as l,Hc as u,Hs as d,Kc as f,Ks as p,Qn as m,Qs as ee,Rs as te,Un as h,Us as g,Vc as ne,Vs as re,Wc as ie,Xn as _,Xs as ae,Zs as oe,ec as se,is as ce,kr as le,nc as ue,oc as de,qs as v,rc as fe,rr as y,rs as pe,tc as me,zs as he}from"./control-ui-core-ChU36mQ7.js";import{K as b,Q as ge,W as x,Y as S,it as _e,nt as C}from"./lit-runtime-D5xZwgO1.js";import{f as ve,i as ye,m as be,p as xe,r as Se}from"./control-ui-foundation-Dgui328h.js";import{Ut as Ce,Wt as we,_ as Te,bt as Ee,jt as De,v as Oe,wt as ke}from"./control-ui-core-CmlLmVZa.js";import{At as Ae,F as je,Jt as Me,M as w,N as T,Xt as Ne,jt as E,nn as D}from"./control-ui-foundation-DkfOBVsU.js";import{o as O,t as k}from"./control-ui-core-M4uhXYSJ.js";import{vt as A,yt as j}from"./control-ui-core-pXkCFtVv.js";import{n as Pe,t as Fe}from"./poll-controller-BnQs2EZr.js";import{n as Ie,t as Le}from"./settings-workspace-BbyrBOFl.js";import{c as M,f as N,h as P,i as F,n as Re,p as ze,s as Be,t as I,u as L}from"./settings-ui-Bq4yxauk.js";import{n as Ve,t as He}from"./gateway-page-controller-CmSjSlgL.js";import{t as Ue}from"./agent-select-registration-FrLOwyPP.js";import{n as We,t as Ge}from"./confirm-dialog-gLs3P1IO.js";import{n as R,t as Ke}from"./platform-label-CpNCbwLC.js";var qe=e((()=>{}));function z(e){let t=E(e?.agents)?e.agents:null,n=E(t?.entries)?t.entries:{},r=[];for(let[e,t]of Object.entries(n)){if(!E(t))continue;let n=D(t.name),i=t.default===!0;r.push({id:e,name:n,isDefault:i,record:t})}return r}function B(e,t){let n=new Set(t),r=[];for(let t of e){if(!(Array.isArray(t.commands)?t.commands:[]).some(e=>n.has(String(e))))continue;let e=D(t.nodeId)??``;if(!e)continue;let i=D(t.displayName)??e;r.push({id:e,label:i===e?e:`${i} · ${e}`})}return r.sort((e,t)=>e.label.localeCompare(t.label)),r}function V(e){let t=e.platform?.trim().toLowerCase()??``,n=e.clientId?.trim().toLowerCase()??``,r=e.clientMode?.trim().toLowerCase()??``;return Ye.test(t)||n===w.WATCHOS_APP?Je:Xe.test(t)?U:Ze.test(t)||Qe.has(n)?A.smartphone:$e.has(n)||r===T.WEBCHAT?A.globe:et.has(r)||tt.has(n)?A.terminal:A.monitor}function H(e){return S`
...
//# sourceMappingURL=nodes-page-cP2b1xLZ.js.map