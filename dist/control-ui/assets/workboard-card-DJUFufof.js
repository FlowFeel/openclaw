import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{K as t,W as n,Y as r}from"./lit-runtime-D5xZwgO1.js";import{o as i,t as a}from"./control-ui-core-DkYXaYTI.js";import{n as o,t as s}from"./workboard-widget-BOzGfkSe.js";var c,l;e((()=>{n(),a(),o(),c=class extends s{async handleStatusChange(e){let t=this.readStringProp(`cardId`),n=this.cards.find(e=>e.id===t),r=e.currentTarget.value;!n||!this.statuses.includes(r)||await this.moveCard(n,r)}render(){let e=this.readStringProp(`cardId`);if(!e)return r`<p class="workboard-widget__state" role="alert">
...
//# sourceMappingURL=workboard-card-DJUFufof.js.map