import{n as e,r as t}from"./rolldown-runtime-DaJ6WEGw.js";import{b as n,y as r}from"./control-ui-foundation-OE0aAIzW.js";import{Yc as i,at as a,it as o,qc as s}from"./control-ui-core-UWR2ANgr.js";import{K as c,Q as l,W as u,Y as d,Z as f,it as p,nt as m}from"./lit-runtime-D5xZwgO1.js";import{St as h}from"./control-ui-foundation-Dgui328h.js";import{Ct as g,Wt as _}from"./control-ui-foundation-DkfOBVsU.js";import{i as ee,n as te,r as ne,t as re}from"./lobster-pet-contract-DZpOweii.js";var ie=e((()=>{}));function ae(e){let t=`${e.getFullYear()}-${e.getMonth()+1}-${e.getDate()}`,n=2166136261;for(let e=0;e<t.length;e++)n^=t.charCodeAt(e),n=Math.imul(n,16777619);return n>>>0}function oe(e){return ae(e)%16==3}var v=e((()=>{}));function y(){try{let e=s()?.getItem(S),t=e?JSON.parse(e):{},n=new Map;if(Array.isArray(t)){for(let e of t)typeof e==`string`&&e&&n.set(e,{firstSeenAt:null,name:null,shinySeenAt:null});return n}if(t&&typeof t==`object`)for(let[e,r]of Object.entries(t))e&&n.set(e,{firstSeenAt:typeof r?.firstSeenAt==`number`?r.firstSeenAt:null,name:typeof r?.name==`string`&&r.name?r.name:null,shinySeenAt:typeof r?.shinySeenAt==`number`?r.shinySeenAt:null});return n}catch{return new Map}}function se(e){let t={};for(let[n,r]of[...e.entries()].toSorted(([e],[t])=>e.localeCompare(t)))t[n]={...r.firstSeenAt===null?{}:{firstSeenAt:r.firstSeenAt},...r.name===null?{}:{name:r.name},...r.shinySeenAt===null?{}:{shinySeenAt:r.shinySeenAt}};s()?.setItem(S,JSON.stringify(t))}function ce(){return new Set(y().keys())}function b(){return y()}function le(e,t={}){try{let n=y(),r=n.get(e);if(r){let i=t.shiny===!0&&r.shinySeenAt===null;if(r.firstSeenAt!==null&&r.name!==null&&!i)return;n.set(e,{firstSeenAt:r.firstSeenAt??Date.now(),name:r.name??t.name??null,shinySeenAt:r.shinySeenAt??(t.shiny===!0?Date.now():null)})}else n.set(e,{firstSeenAt:Date.now(),name:t.name??null,shinySeenAt:t.shiny===!0?Date.now():null});se(n)}catch{}}function x(){try{let e=s()?.getItem(C),t=e?JSON.parse(e):{},n=t&&typeof t==`object`?t:{};return{visits:typeof n.visits==`number`&&n.visits>=0?n.visits:0,shoos:typeof n.shoos==`number`&&n.shoos>=0?n.shoos:0}}catch{return{visits:0,shoos:0}}}function ue(e){try{s()?.setItem(C,JSON.stringify(e))}catch{}}function de(){let e=x();ue({...e,visits:e.visits+1})}function fe(){let e=x();ue({...e,shoos:e.shoos+1})}function pe(){let{visits:e,shoos:t}=x();return{tier:e<3?`shy`:e<15?`regular`:`friend`,wary:t>=3&&t>e*.3,visits:e,shoos:t}}function me(e){for(let[t,n]of ge)if(e>=t)return n;return null}function he(e,t){if(e===null||t.getTime()-e<_e)return!1;let n=new Date(e);return n.getMonth()===t.getMonth()&&n.getDate()===t.getDate()}var S,C,w,ge,_e,T=e((()=>{i(),S=`openclaw.control.lobsterdex.v1`,C=`openclaw.control.lobsterpet.familiarity.v1`,w={shy:{stayMul:.6,firstDelayMul:1.3,gapMul:1},regular:{stayMul:1,firstDelayMul:1,gapMul:1},friend:{stayMul:1.6,firstDelayMul:.7,gapMul:.8},waryGapMul:1.7},ge=[[250,`Elder`],[100,`Captain`],[50,`Sir`]],_e=300*24*60*60*1e3}));function ve(e,t,n){let r=e;if(!t)return r;try{let e=window.AudioContext;if(!e)return r;r??=new e,r.state===`suspended`&&r.resume();let t=r.currentTime,i=r.createOscillator(),a=r.createGain();i.type=`sine`,n===`poke`?(i.frequency.setValueAtTime(330,t),i.frequency.exponentialRampToValueAtTime(165,t+.09)):(i.frequency.setValueAtTime(392,t),i.frequency.exponentialRampToValueAtTime(523,t+.18)),a.gain.setValueAtTime(1e-4,t),a.gain.exponentialRampToValueAtTime(.05,t+.02),a.gain.exponentialRampToValueAtTime(1e-4,t+(n===`poke`?.12:.24)),i.connect(a).connect(r.destination),i.start(t),i.stop(t+.26)}catch{}return r}function ye(){let e=ve(null,!0,`poke`);e&&window.setTimeout(()=>void e.close().catch(()=>{}),300)}var be=e((()=>{}));function E(e){return Se[e]??e}function xe(e){return _(D[(e>>>3)%D.length],`lobster pet name catalog entry`)}var Se,D,Ce,O=e((()=>{g(),Se={blue:`Blueberry`,gold:`Goldie`,lumen:`Glimmer`,magma:`Ember`,oilslick:`Slick`,aurora:`Borealis`,nebula:`Cosmo`,banana:`Peel`,mood:`Ringo`,bee:`Buzz`,rubberduck:`Debuggy`,watermelon:`Pips`,clawtron:`Clawtron`,selene:`Selene`,geode:`Amethyst`,ghost:`Boo`,glass:`Prism`,split:`Picasso`,sourdough:`Boule`,zombie:`Shambles`,plush:`Buttons`,balloon:`Squeaky`,cottoncandy:`Taffy`,cryptid:`Nessie`,flatpack:`Skaldjur`,tinfoil:`Mulder`,actual:`Homarus`,disco:`Boogie`,chimera:`Frankie`,blueprint:`Prototype`,phosphor:`TTY`,ascii:`Figlet`,portal:`Warp`,notexture:`Magenta`,loading:`Spinner`,eclipse:`Umbra`,heisenbug:`Segfault`,invisible:`Nobody`,pixel:`Sprite`,retro:`OG`,goldenretro:`24K`},D=[`Pinchy`,`Barnaby`,`Thermidor`,`Clawdette`,`Sheldon`,`Scuttles`,`Bisque`,`Crusty`,`Snips`,`Bubbles`,`Clawdia`,`Ferdinand`,`Maple`,`Pearl`,`Biscuit`,`Captain`,`Ziggy`,`Noodle`,`Waffles`,`Pippin`,`Squirt`,`Chip`,`Clementine`,`Moss`],Ce={crimson:{flavor:`The classic red, first in every tide pool.`,hint:`Where every story starts.`},blue:{flavor:`1 in 2 million, and knows it.`,hint:`One in two million.`},gold:{flavor:`1 in 30 million karats.`,hint:`Worth its weight.`},lumen:{flavor:`Brings its own night lights.`,hint:`Glows where it's darkest.`},magma:{flavor:`Fresh from the vent, still cooling.`,hint:`Runs hot.`},oilslick:{flavor:`Black shell, rainbow finish.`,hint:`Spilled, not stirred.`},aurora:{flavor:`Northern lights, southern claws.`,hint:`Best seen on clear nights.`},nebula:{flavor:`Not from any ocean on this planet.`,hint:`Came from very far away.`},banana:{flavor:`Banana. For scale.`,hint:`For scale.`},mood:{flavor:`Wears whatever color you're feeling.`,hint:`Matches your vibe.`},bee:{flavor:`Technically not a bee.`,hint:`Do not tell the bees.`},rubberduck:{flavor:`Listens to your bugs. Judges silently.`,hint:`Quack.`},watermelon:{flavor:`Contains 6% lobster.`,hint:`Ripe when thumped.`},clawtron:{flavor:`60% rivets, 40% love.`,hint:`Beep boop snip.`},selene:{flavor:`Carries the current moon on its belly.`,hint:`Waxes and wanes.`},geode:{flavor:`Rock outside, amethyst inside.`,hint:`Crack the surface.`},ghost:{flavor:`1 in 100 million, barely there.`,hint:`You'd walk right past it.`},glass:{flavor:`Fully transparent. Nothing to hide.`,hint:`Easy to miss, hard to forget.`},split:{flavor:`Two lobsters, one shell.`,hint:`Can't pick a side.`},sourdough:{flavor:`Started from a starter. 24-hour proof.`,hint:`Still proofing.`},zombie:{flavor:`Slightly used. Still friendly.`,hint:`It's been better.`},plush:{flavor:`Machine washable. Air dry only.`,hint:`Soft to the touch.`},balloon:{flavor:`Do not pop.`,hint:`Handle with care.`},cottoncandy:{flavor:`Pastel, like the famous Maine catch.`,hint:`Sweeter than it looks.`},cryptid:{flavor:`Every photo comes out blurry.`,hint:`Sightings unconfirmed.`},flatpack:{flavor:`Some assembly required.`,hint:`Missing one screw.`},tinfoil:{flavor:`The tide is a psyop.`,hint:`They know.`},actual:{flavor:`An actual lobster. Unsettling, honestly.`,hint:`Anatomically correct.`},disco:{flavor:`Born under a mirror ball.`,hint:`The night is still young.`},chimera:{flavor:`Borrowed parts. No refunds.`,hint:`Something's off.`},blueprint:{flavor:`Final hardware pending approval.`,hint:`Still on the drawing board.`},phosphor:{flavor:`80 columns, 24 rows, one lobster.`,hint:`Hums at sixty hertz.`},ascii:{flavor:`Renders anywhere. Even over SSH.`,hint:`chmod +x`},portal:{flavor:`Arrives before it leaves.`,hint:`Mind the gap.`},notexture:{flavor:`Texture not found.`,hint:`404.`},loading:{flavor:`Still loading. Any second now.`,hint:`…`},eclipse:{flavor:`Do not look directly at it.`,hint:`Once in a blue moon.`},heisenbug:{flavor:`Only renders right when nobody's watching.`,hint:`Cannot be reproduced.`},invisible:{flavor:`It's right there. Look closer.`,hint:`Trust me, it exists.`},pixel:{flavor:`Rendered in 1987. Still runs.`,hint:`Insert coin.`},retro:{flavor:`The original: big claw, no apologies.`,hint:`The one that started it all.`},goldenretro:{flavor:`One in a generation.`,hint:`Worth the wait.`}}}));function we(e){return((e.getTime()-Te)/864e5%k+k)%k/k}var k,Te,Ee=e((()=>{k=29.53059,Te=Date.parse(`2000-01-06T18:14:00.000Z`)}));function De(e){let t=ke.map(e=>_(j.find(t=>t.id===e),`chimera donor palette ${e}`)),n=()=>{let n=Math.floor(e()*t.length);return _(t.splice(n,1)[0],`distinct chimera donor`)};return{body:n().shell,clawLeft:n().shell,clawRight:n().shell,antennae:n().shell}}function Oe(e){return j.find(t=>t.shell===e)?.claw}var A,j,ke,Ae,je=e((()=>{g(),A=[[{id:`crimson`,shell:`#ff4f40`,claw:`#ff775f`},26],[{id:`blue`,shell:`#4a7dfc`,claw:`#7fa4ff`},7],[{id:`gold`,shell:`#f4b840`,claw:`#f9d47a`},5],[{id:`lumen`,shell:`#1d2f4e`,claw:`#2e4a77`},2],[{id:`magma`,shell:`#241214`,claw:`#3a1d18`},2],[{id:`oilslick`,shell:`#15171d`,claw:`#23262e`},2],[{id:`aurora`,shell:`#dce6f0`,claw:`#e9f0f7`},2],[{id:`nebula`,shell:`#34255c`,claw:`#4a3a7d`},2],[{id:`banana`,shell:`#f7e27d`,claw:`#f3d55b`},2],[{id:`mood`,shell:`var(--accent, #7f77dd)`,claw:`var(--accent-hover, #9a93e8)`},1.5],[{id:`bee`,shell:`#f4c531`,claw:`#2b2b23`},1.5],[{id:`rubberduck`,shell:`#ffd93b`,claw:`#ffb03b`},1.5],[{id:`watermelon`,shell:`#3f9d63`,claw:`#4fb072`},1.5],[{id:`clawtron`,shell:`#8d99a6`,claw:`#a2aeba`},1],[{id:`selene`,shell:`#c9ced8`,claw:`#d8dde5`},1],[{id:`geode`,shell:`#6b6474`,claw:`#7d7588`},1],[{id:`ghost`,shell:`#dce8f2`,claw:`#ecf3fa`},1],[{id:`glass`,shell:`#cfe4f4`,claw:`#e0eef8`},1],[{id:`split`,shell:`#ff4f40`,claw:`#ff775f`},1],[{id:`sourdough`,shell:`#d9a662`,claw:`#e6bc82`},1],[{id:`zombie`,shell:`#9db08a`,claw:`#86a17a`},1],[{id:`plush`,shell:`#e8967a`,claw:`#f2b09a`},1],[{id:`balloon`,shell:`#ff5c8a`,claw:`#ff7ea1`},1],[{id:`cryptid`,shell:`#6e6257`,claw:`#7d7263`},.9],[{id:`flatpack`,shell:`#d9c9a8`,claw:`#d9c9a8`},.9],[{id:`tinfoil`,shell:`#9aa4ad`,claw:`#a8b2bb`},.9],[{id:`actual`,shell:`#a63c28`,claw:`#8f3220`},.9],[{id:`cottoncandy`,shell:`#f6a8c9`,claw:`#a5c6f0`},.8],[{id:`disco`,shell:`#b8c4d8`,claw:`#cbd5e6`},.8],[{id:`chimera`,shell:`#b0685a`,claw:`#b0685a`},.75],[{id:`pixel`,shell:`#d84c3e`,claw:`#ef8f6a`},.7],[{id:`blueprint`,shell:`#123a66`,claw:`#123a66`},.7],[{id:`phosphor`,shell:`#0d2415`,claw:`#0f2b19`},.7],[{id:`ascii`,shell:`var(--lob-ascii-ink, #d8dee6)`,claw:`var(--lob-ascii-ink, #d8dee6)`},.7],[{id:`portal`,shell:`#4a9df8`,claw:`#ff9a2e`},.7],[{id:`notexture`,shell:`#ff00dc`,claw:`#111111`},.65],[{id:`loading`,shell:`#3a4150`,claw:`#454d5e`},.65],[{id:`eclipse`,shell:`#14161d`,claw:`#1d2026`},.65],[{id:`heisenbug`,shell:`#262a33`,claw:`#343945`},.6],[{id:`invisible`,shell:`rgba(127,140,160,0.07)`,claw:`rgba(127,140,160,0.07)`},.55],[{id:`retro`,shell:`#e8262c`,claw:`#f04a3e`},.5],[{id:`goldenretro`,shell:`#e8b422`,claw:`#f6cf5a`},.1]],j=A.map(([e])=>e),ke=[`crimson`,`blue`,`gold`,`banana`,`watermelon`],Ae={body:`#ff4f40`,clawLeft:`#4a7dfc`,clawRight:`#f4b840`,antennae:`#3f9d63`}}));function Me(e,t){return f`
  ...
  `}function Re(e){return f`
    ...
    ${e?f`
        ...
        `:``}
  `}var ze,Be,Ve,He,Ue,We=e((()=>{u(),ze=f`
...
`,Be=f`
  <path
    ...
    stroke-linecap="round"
  />
`,Ve=[{y:12,x:44,count:4},{y:20,x:36,count:6},{y:28,x:28,count:8},{y:36,x:20,count:10},{y:44,x:16,count:11},{y:52,x:16,count:11},{y:60,x:16,count:11},{y:68,x:20,count:10},{y:76,x:24,count:9},{y:84,x:32,count:7},{y:92,x:44,count:4}],He=f`
  <g class="lob-notexture" shape-rendering="crispEdges">
    ${Ve.flatMap((e,t)=>Array.from({length:e.count},(n,r)=>f`<rect
          x=${e.x+r*8}
          y=${e.y}
          width="8"
          height="8"
...
`}));function Ge(e){let t=(Math.round(e)%8+8)%8;return t===0?f`<g class="lob-selene-moon"><circle cx="60" cy="64" r="12" fill="#26304a" /><circle cx="60" cy="64" r="11" fill="none" stroke="#f4f7fc" stroke-width="1" /></g>`:t===4?f`<g class="lob-selene-moon"><circle cx="60" cy="64" r="12" fill="#26304a" /><circle cx="60" cy="64" r="11" fill="#f4f7fc" /></g>`:f`
    ...
    <svg class="lobster-bottle__svg" viewBox="0 0 48 44" aria-hidden="true">
      <g transform="rotate(-16 24 30)">
        ...
        ${e?f`
            ...
            `:f`<rect x="41" y="21.5" width="5" height="9" rx="1.8" fill="#8a5a2b" />`}
  ...
  `}var Qe,$e,et,tt,nt,rt,it,at,ot,st,ct,lt,ut,dt,ft,pt,mt,ht,gt,_t,vt,yt,bt,xt,St,Ct,wt,Tt,M,Et,Dt,Ot,kt,At,jt,Mt=e((()=>{u(),We(),Qe={crown:f`
    <path
...
`,dt=new Set(`split.retro.lumen.magma.oilslick.aurora.nebula.glass.geode.phosphor.heisenbug.blueprint.clawtron.selene.pixel.banana.bee.rubberduck.watermelon.sourdough.zombie.plush.balloon.disco.cryptid.flatpack.tinfoil.actual.chimera.notexture.loading.eclipse.ascii.portal.invisible.goldenretro`.split(`.`)),ft=f`
  <g fill="#8a6430">
...
`,yt={lumen:et,magma:tt,oilslick:nt,aurora:rt,nebula:it,glass:at,geode:ot,phosphor:st,blueprint:lt,clawtron:ut,banana:ft,bee:pt,rubberduck:mt,sourdough:ht,zombie:gt,plush:_t,disco:vt,watermelon:ze,eclipse:Be,notexture:He,chimera:Ue},bt=f`
  <path
...
`,M=new Set([`crown`,`sprout`,`santa`,`pumpkin`,`party`]),Et=f`
  <g class="lob-cap">
...
`,Ot={perky:f`
  ...
  `},kt={crab:qe,snail:Je,duck:Ye,jellyfish:Xe},At=f`
...
`,jt={stranger:`a stranger`,crab:`definitely a lobster`,snail:`in no particular hurry`,duck:`a duck. obviously`,jellyfish:`just drifting`}}));function N(e){return{palette:e,scale:2,accessory:`none`,antennae:`perky`,side:`left`,spotPct:0,facing:1,personality:`friendly`,blinkDelayS:o(e.id)%36/10,build:`round`,clawSize:`regular`,tailFan:!1,shiny:!1,crusherSide:null,freckles:!1,glint:null,chimeraParts:e.id===`chimera`?Ae:null}}function Nt(e){return e.getMonth()===V.month&&e.getDate()===V.day}function Pt(e){let t=e.getMonth(),n=e.getDate();return t===11?[[`santa`,18]]:t===9&&n>=20?[[`pumpkin`,18]]:t===8&&n===25?[[`monocle`,24]]:[]}function P(e,t){let n=E(e.palette.id);return n===e.palette.id?xe(t):n}function Ft(e,t){for(let n=1;n<=24;n++){let r=R(e+n*7919>>>0);if(r.palette.id!==t)return r}return R(e+1>>>0)}function F(e){let t=e>>>0;return()=>{t=t+1831565813|0;let e=Math.imul(t^t>>>15,1|t);return e=e+Math.imul(e^e>>>7,61|e)^e,((e^e>>>14)>>>0)/4294967296}}function I(e,t){let n=t.reduce((e,[,t])=>e+t,0),r=e()*n;for(let[e,n]of t)if(r-=n,r<=0)return e;return _(t.at(-1),`weighted lobster choice fallback`)[0]}function L(e,t,n){return t+e()*(n-t)}function R(e,t=new Date){let n=F(e),r=I(n,A),i=I(n,Wt),a=I(n,[...Ht,...Pt(t)]),o=n()<.6?`perky`:`droopy`,s=n()<.5?`left`:`right`,c=G[s],l=Math.round(L(n,c[0],c[1])),u=n()<.5?1:-1,d=I(n,Ut),f=Math.round(L(n,0,4)*10)/10,p=I(n,Gt),m=I(n,Kt),h=n()<.3,g=n()<1/512,_=n(),ee=n()<.5?`left`:`right`,te=_<.15?ee:null,ne=n()<.12,re=n(),ie=W[Math.floor(n()*W.length)]??null,ae=re<.3?ie:null,oe=De(n),v={palette:r,scale:i,accessory:a,antennae:o,side:s,spotPct:l,facing:u,personality:d,blinkDelayS:f,build:p,clawSize:m,tailFan:h,shiny:g,crusherSide:te,freckles:ne,glint:ae,chimeraParts:r.id===`chimera`?oe:null},y=r.id===`clawtron`?{...v,antennae:`perky`}:v;if(r.id===`zombie`&&(y={...v,antennae:`droopy`}),Nt(t)){let e=A.find(([e])=>e.id===`retro`)?.[0];return{...y,palette:e??r,accessory:`party`,chimeraParts:null}}return y}function z(e,t={}){let n=e.palette.id===`pixel`,r=e.palette.id===`flatpack`,i=e.palette.id===`loading`,a=e.palette.id===`actual`,o=e.palette.id===`balloon`,s=e.palette.id===`ascii`,l=e.palette.id===`portal`,u=o||s||l,d=Bt.has(e.palette.id),p=t.shell||t.sleeping&&!t.reading,m=p?`display:none`:``,h=p?`opacity:1`:t.standalone||t.reading?`display:none`:``,g=Math.round(we(new Date)*8)%8;return f`
    <svg
      class="lobster-pet__svg"
      viewBox="0 0 120 105"
      preserveAspectRatio="none"
      aria-hidden="true"
    >
      <g class=${Vt[e.palette.id]??``}>
        ${r?Me(m,h):i?Ne(m,h):a?Pe(m,h):o?Fe(m,h):s?Ie(m,h):l?Le(m,h):n?Ke(m,h):f`
              ${d?St:Ot[e.antennae]}
              ${e.tailFan?wt:c}
              <g class="lob-claw lob-claw--l">
                <path d="M20 42 C5 37 0 47 5 57 C10 67 20 62 25 52 C28 45 25 42 20 42 Z" fill="var(--lob-claw)" />
              </g>
              ${d?c:f`<g class="lob-claw lob-claw--r"><path d="M100 42 C115 37 120 47 115 57 C110 67 100 62 95 52 C92 45 95 42 100 42 Z" fill="var(--lob-claw)" /></g>`}
              ${e.palette.id===`heisenbug`?ct:c}
              ...
              ${e.palette.id===`split`||e.palette.id===`geode`?bt:c}
              ${e.palette.id===`selene`?Ge(g):c}
              ${yt[e.palette.id]??c}
              ${e.palette.id===`tinfoil`?Re(!M.has(e.accessory)):c}
              ${e.freckles&&!dt.has(e.palette.id)?$e:c}
              ${e.palette.id===`invisible`?c:f`<ellipse cx="48" cy="28" rx="20" ry="11" fill="#ffffff" opacity="0.1" />`}
              ...
              ${t.sleeping&&!t.reading?f`<g class="lob-eye-peek"><circle cx="45" cy="32" r="4" fill="#0a1014" /><circle cx="46" cy="30.8" r="1.6" fill="var(--lob-glint, #00e5cc)" /></g>`:c}
      ...
      ${d?f`
            ${Ct}
            <g class="lob-claw lob-claw--r">${xt}</g>
          `:c}
      ${t.grumpy&&!d&&!r&&!i&&!a&&!u?Dt:c}
      ${e.accessory===`none`||t.shell||r?c:Qe[e.accessory]}
      ${t.bindle&&!d&&!r?Tt:c}
      ${t.sailorCap&&!t.shell&&!r&&!M.has(e.accessory)&&e.palette.id!==`tinfoil`?Et:c}
      ${t.reading?qt:c}
      </g>
    </svg>
  `}function It(e){let t=e.crusherSide,n=(o(e.palette.id)>>>8)%34/10,r=e.chimeraParts?Oe(e.chimeraParts.body):void 0,i=n=>t===null?U[e.clawSize]:t===n?U.mighty:U.dainty;return[`--lob-shell:${e.chimeraParts?.body??e.palette.shell}`,`--lob-claw:${r??e.palette.claw}`,`--lob-blink-delay:${e.blinkDelayS}s`,`--lob-breathe-delay:-${n}s`,`--lob-w:${H[e.build].w}`,`--lob-h:${H[e.build].h}`,`--lob-claw-l:${i(`left`)}`,`--lob-claw-r:${i(`right`)}`,...e.chimeraParts?[`--lob-chimera-l:${e.chimeraParts.clawLeft}`,`--lob-chimera-r:${e.chimeraParts.clawRight}`,`--lob-antennae-color:${e.chimeraParts.antennae}`]:[],...e.glint?[`--lob-glint-seed:${e.glint}`]:[]]}function Lt(e){return It(e).join(`;`)}function B(e,t,n,r){return[...It(e),`--lob-scale:${t}`,`--lob-x:${n}%`,`--lob-face:${r}`].join(`;`)}function Rt(e){let t=t=>e.anchor===`bar`?Math.min(t,e.barMaxScale):t,n=n=>{let r=e.anniversary&&e.look.accessory!==`party`?{...e.look,accessory:`party`}:e.look,i=[`lobster-pet`,`lobster-pet--${e.mode}`,`lobster-pet--palette-${e.look.palette.id}`,n?`lobster-pet--twin`:``,r.accessory===`party`?`lobster-pet--party`:``,e.look.shiny?`lobster-pet--shiny`:``,e.elder?`lobster-pet--elder`:``,e.presence===`leaving`?`lobster-pet--away`:``,e.entering?`lobster-pet--entering`:``,e.entering&&e.entrance!==`walk`?`lobster-pet--enter-${e.entrance}`:``,e.grumpy?`lobster-pet--grumpy`:``,e.vigil?`lobster-pet--vigil`:``,e.act?`lobster-pet--act-${e.act}`:``].filter(Boolean).join(` `),a=n?Math.min(e.zone[1],Math.max(e.zone[0],e.spotPct+(e.facing===1?-12:12))):e.spotPct,o=t(n?e.look.scale*.55:e.look.scale),s=n?`${B(e.look,o,a,e.facing===1?-1:1)};--lob-act-delay:0.18s`:B(e.look,o,a,e.facing),l=me(e.familiarityVisits),u=e.nameOverride??P(e.look,e.seed),f=l?`${l} ${u}`:u,p=e.look.shiny?`✦ ${f}`:f,m=e.movingDay&&!n;return d`
      <div
        class=${i}
        style=${s}
        aria-hidden="true"
      ...
      >
        <div class="lobster-pet__body">
          ...
          ${e.entering&&e.entrance===`balloon`?At:c}
          ${e.entering&&e.entrance===`bubble`?d`<span class="lobster-pet__entry-bubble"></span>`:c}
          ${e.look.shiny?d`
    ...
    `},r=e.presence!==`out`,i=e.shellVisible&&e.visitsEnabled&&!e.dismissed,a=e.passer!==null&&e.visitsEnabled,o=e.bottle!==null&&e.visitsEnabled&&!e.dismissed;if(!r&&!i&&!a&&!o)return c;let s=B(e.look,t(e.shellScale),e.shellSpotPct,e.facing),l=e.passer?.kind===`stranger`?Ft(e.seed,e.look.palette.id):e.look,u=e.passer?[`lobster-pet`,`lobster-pet--passer`,e.passer.kind===`stranger`?`lobster-pet--palette-${l.palette.id}`:`lobster-pet--${e.passer.kind}`,e.passer.kind===`stranger`&&l.shiny?`lobster-pet--shiny`:``,e.passer.direction===1?`lobster-pet--passer-ltr`:`lobster-pet--passer-rtl`].filter(Boolean).join(` `):``,f=e.passer?`${zt(e.passer.kind,e.passer.direction,l)};--lob-cross:${e.passer.crossMs}ms`:``;return d`
    ${i?d`
    ...
    ${o&&e.bottle?d`
        ...
        `:c}
    ${r?n(!1):c}
    ${r&&e.twinPlanned?n(!0):c}
    ${a&&e.passer?d`
          <div
            class=${u}
            style=${f}
            aria-hidden="true"
            title=${jt[e.passer.kind]}
          >
            <div class="lobster-pet__body">
              ${e.passer.kind===`stranger`?z(l,{standalone:!0}):kt[e.passer.kind]()}
            </div>
          </div>
        `:c}
  `}function zt(e,t,n){return e===`stranger`?B(n,Math.min(n.scale,2),0,t):{crab:`--lob-scale:2;--lob-w:1;--lob-h:0.82;--lob-face:1`,snail:`--lob-scale:1.7;--lob-w:1;--lob-h:0.9;--lob-face:${t}`,duck:`--lob-scale:1.9;--lob-w:1;--lob-h:1;--lob-face:${t}`,jellyfish:`--lob-scale:1.7;--lob-w:0.9;--lob-h:1.1;--lob-face:1`}[e]}var Bt,Vt,Ht,V,Ut,Wt,Gt,Kt,H,U,W,qt,G,K=e((()=>{g(),u(),a(),T(),O(),Ee(),je(),We(),Mt(),Bt=new Set([`retro`,`goldenretro`]),Vt={heisenbug:`lob-heisenbug-frame`,cryptid:`lob-cryptid-frame`,balloon:`lob-balloon-frame`},Ht=[[`none`,62],[`sprout`,14],[`patch`,14],[`crown`,10]],V={month:10,day:24},Ut=[[`sleepy`,25],[`zoomy`,25],[`friendly`,25],[`showoff`,25]],Wt=[[1.7,25],[2,55],[2.5,20]],Gt=[[`round`,40],[`squat`,30],[`slender`,30]],Kt=[[`regular`,55],[`dainty`,25],[`mighty`,20]],H={round:{w:1,h:1},squat:{w:1.14,h:.94},slender:{w:.88,h:1.1}},U={dainty:.85,regular:1,mighty:1.18},W=[`#ffd166`,`#ff8ac2`,`#b79bff`],qt=f`
...
`,G={left:[12,38],right:[60,84]}}));function Jt(e,t,n=new Date){return e===`busy`||e===`offline`?ln[e]:sn(n)?J.sleepy:t?J[t]:null}function Yt(e){return e===`error`?`droop`:e===`aborted`?`startle`:`cheer`}function Xt(e){return e<.06?`balloon`:e<.13?`bubble`:`walk`}function Zt(e){return F((e^12317)>>>0)()<.12}function Qt(e){return F((e^30485)>>>0)()<.04}function $t(e){let t=F((e^3243)>>>0),n=t();return n>=.095?null:{kind:n<.015?`crab`:n<.027?`snail`:n<.039?`duck`:n<.05?`jellyfish`:`stranger`,atMs:Math.round(6e4+t()*84e4),direction:t()<.5?1:-1}}function en(e){return F((e^57811)>>>0)()<.015}function tn(e,t){if(t.length===0)return null;let n=F((e^61982)>>>0);return n()>=.08?null:t[Math.floor(n()*t.length)]??null}function nn(e,t){let n=ce(),r={elder:!1,oldFriend:!1,friendName:null,dexComplete:j.every(e=>n.has(e.id)),look:t};if(en(e))return{...r,elder:!0,look:{...t,scale:3,accessory:`barnacle`,personality:`sleepy`,clawSize:`mighty`,crusherSide:null}};if(t.palette.id===`retro`||t.palette.id===`goldenretro`)return r;let i=tn(e,[...n].filter(e=>j.some(t=>t.id===e)).toSorted()),a=i?j.find(e=>e.id===i):void 0;return a?{...r,oldFriend:!0,friendName:b().get(a.id)?.name??null,look:{...t,palette:a,chimeraParts:a.id===`chimera`?N(a).chimeraParts:null}}:r}function rn(e,t){return e.elder?`Methuselah`:e.friendName??P(e.look,t)}function an(e){let t=F((e^45175)>>>0);return t()>=.03?null:{atMs:Math.round(45e3+t()*855e3),spotPct:Math.round(15+t()*70),fortuneIndex:Math.floor(t()*pn.length)}}function on(e){try{let t=s();if(!t)return!1;let n=t.getItem(mn);return n===e?!1:(t.setItem(mn,e),n!==null)}catch{return!1}}function sn(e=new Date){let t=e.getHours();return t>=22||t<6}function q(){return typeof window<`u`&&typeof window.matchMedia==`function`&&window.matchMedia(`(prefers-reduced-motion: reduce)`).matches}var cn,J,ln,un,Y,dn,fn,X,Z,Q,pn,mn,hn=e((()=>{i(),T(),K(),cn={wave:1400,snip:1e3,hop:750,spin:950,peek:1700,nap:4400,bubble:2600,scuttle:1250,startle:750,cheer:1300,molt:2600,pet:1500,droop:1600,sweep:1800},J={sleepy:{delayMs:[6e3,12e3],acts:[[`nap`,40],[`bubble`,20],[`wave`,12],[`scuttle`,12],[`peek`,10],[`hop`,6]]},zoomy:{delayMs:[2800,6e3],acts:[[`scuttle`,42],[`hop`,22],[`spin`,12],[`peek`,12],[`wave`,12]]},friendly:{delayMs:[3600,7500],acts:[[`wave`,32],[`snip`,22],[`scuttle`,18],[`hop`,14],[`bubble`,14]]},showoff:{delayMs:[3600,7500],acts:[[`spin`,24],[`snip`,22],[`peek`,20],[`hop`,18],[`wave`,16]]}},ln={busy:{delayMs:[2200,4500],acts:[[`scuttle`,40],[`hop`,20],[`snip`,20],[`wave`,12],[`spin`,8]]},offline:{delayMs:[2800,5600],acts:[[`scuttle`,55],[`peek`,30],[`hop`,15]]}},un={walk:450,balloon:1250,bubble:700},Y={stranger:11e3,crab:11e3,snail:9e4,duck:14e3,jellyfish:16e3},dn=[18,50],fn=1.7,X=[15e3,18e4],Z=[9e4,3e5],Q=[36e4,108e4],pn=[`the tide returns every branch to shore`,`molt before you feel ready`,`a shell is just armor you outgrew`,`somewhere, a test is green because of you`,`swim sideways when forward fails`,`the reef remembers kind commits`,`even the deep keeps a night light`,`barnacles are only patient passengers`,`no current lasts forever`,`bury your treasure in version control`,`the crab was a lobster all along`,`small claws, firm grip`,`rest is also progress`,`what washes away was never pinned`],mn=`openclaw.control.lobsterpet.gatewayVersion.v1`})),gn,_n=e((()=>{g(),hn(),gn=class{constructor(e,t){this.host=e,this.hooks=t,this.passer=null,this.bottlePlan=null,this.bottleVisible=!1,this.bottleOpened=!1,this.passerTimer=null,this.passerEndTimer=null,this.passerWatchTimer=null,this.bottleTimer=null,this.bottleEndTimer=null,this.openBottle=()=>{this.bottleOpened||!this.bottleVisible||(this.bottleOpened=!0,this.armBottleEbb(12e4),this.host.requestUpdate())},e.addController(this)}hostDisconnected(){this.clearTimers(),this.passer=null,this.bottleVisible=!1,this.host.requestUpdate()}reset(e){this.clearTimers(),this.passer=null,this.bottleVisible=!1,this.bottleOpened=!1,this.schedulePasser(e),this.scheduleBottle(e)}passerCrossMs(){return this.passer?Y[this.passer.kind]:0}bottle(){return!this.bottleVisible||!this.bottlePlan?null:{spotPct:this.bottlePlan.spotPct,opened:this.bottleOpened,fortune:_(pn[this.bottlePlan.fortuneIndex],`lobster bottle fortune`)}}clearTimers(){for(let e of[this.passerTimer,this.passerEndTimer,this.passerWatchTimer,this.bottleTimer,this.bottleEndTimer])e!==null&&window.clearTimeout(e);this.passerTimer=null,this.passerEndTimer=null,this.passerWatchTimer=null,this.bottleTimer=null,this.bottleEndTimer=null}schedulePasser(e){let t=$t(e);!t||q()||(this.passerTimer=window.setTimeout(()=>{if(this.passerTimer=null,!this.hooks.visitsEnabled()||document.hidden)return;this.passer=t,this.host.requestUpdate();let e=Y[t.kind];this.hooks.onPasserFacing(t.direction===1?-1:1),this.passerWatchTimer=window.setTimeout(()=>{this.passerWatchTimer=null,this.hooks.onPasserFacing(t.direction),this.hooks.onPasserMidCross()},e/2),this.passerEndTimer=window.setTimeout(()=>{this.passerEndTimer=null,this.passer=null,this.host.requestUpdate(),this.hooks.onPasserDone()},e)},t.atMs))}scheduleBottle(e){this.bottlePlan=an(e),this.bottlePlan&&(this.bottleTimer=window.setTimeout(()=>{this.bottleTimer=null,this.bottleVisible=!0,this.host.requestUpdate(),this.armBottleEbb(3e5)},this.bottlePlan.atMs))}armBottleEbb(e){this.bottleEndTimer!==null&&window.clearTimeout(this.bottleEndTimer),this.bottleEndTimer=window.setTimeout(()=>{this.bottleEndTimer=null,this.bottleVisible=!1,this.host.requestUpdate()},e)}}})),vn=t({LOBSTER_PET_PALETTES:()=>j,canonicalLobsterLook:()=>N,createLobsterPetLook:()=>R,lobsterLookStyle:()=>Lt,lobsterPaletteName:()=>E,lobsterPetSeed:()=>te,moonPhaseFraction:()=>we,renderLobsterSvg:()=>z,resolveLobsterPetMode:()=>ne,resolveLobsterRunOutcome:()=>ee}),$,yn=e((()=>{ie(),g(),u(),l(),v(),T(),be(),re(),K(),hn(),_n(),n(),O(),Ee(),$=class extends h{constructor(...e){super(...e),this.seed=0,this.mode=`idle`,this.visitsEnabled=!0,this.runOutcome=`ok`,this.soundsEnabled=!1,this.gatewayVersion=null,this.act=null,this.spotPct=80,this.facing=1,this.entering=!1,this.entrance=`walk`,this.presence=`out`,this.anchor=`ledge`,this.scheduledVisiting=!1,this.dismissed=!1,this.grumpy=!1,this.vigil=!1,this.outcomePresenceOwner=null,this.movingDay=!1,this.movingDayChecked=!1,this.anniversary=!1,this.sailorDay=!1,this.identity=null,this.entranceRng=F(0),this.traffic=new gn(this,{visitsEnabled:()=>this.visitsEnabled,onPasserFacing:e=>this.watchTraffic(e),onPasserMidCross:()=>this.reactToPasser(),onPasserDone:()=>this.scheduleNextAct()}),this.shellVisible=!1,this.shellSpotPct=50,this.shellScale=2,this.molted=!1,this.moltPlanned=!1,this.twinPlanned=!1,this.shellTimer=null,this.familiarity={tier:`regular`,wary:!1,visits:0,shoos:0},this.greetedThisLoad=!1,this.look=null,this.rng=F(0),this.visitRng=F(0),this.idleTimer=null,this.actEndTimer=null,this.enterTimer=null,this.visitTimer=null,this.leaveTimer=null,this.grumpyTimer=null,this.vigilTimer=null,this.holdTimer=null,this.holdPetted=!1,this.audioCtx=null,this.pokeTimes=[],this.lastGazeAt=0,this.restartPending=!1,this.handleVisibilityChange=()=>{document.hidden?(this.outcomePresenceOwner=null,this.clearActTimers(),this.act=null):this.scheduleNextAct()},this.handleHoldStart=()=>{q()||(this.holdPetted=!1,this.holdTimer!==null&&window.clearTimeout(this.holdTimer),this.holdTimer=window.setTimeout(()=>{this.holdTimer=null,this.holdPetted=!0,this.grumpy=!1,this.playChirp(`pet`),this.performAct(`pet`)},600))},this.handleHoldEnd=()=>{this.holdTimer!==null&&(window.clearTimeout(this.holdTimer),this.holdTimer=null,this.holdPetted||this.pokeNow()),this.holdPetted=!1},this.handleHoldCancel=()=>{this.holdTimer!==null&&(window.clearTimeout(this.holdTimer),this.holdTimer=null),this.holdPetted=!1},this.handleGaze=e=>{if(this.presence!==`in`||this.act!==null||this.vigil||q())return;let t=Date.now();if(t-this.lastGazeAt<120)return;this.lastGazeAt=t;let n=this.querySelector(`.lobster-pet:not(.lobster-pet--shell)`);if(!n)return;let r=n.getBoundingClientRect(),i=r.left+r.width/2,a=e.clientX<i?-1:1;a!==this.facing&&(this.facing=a)},this.handleShoo=e=>{e.preventDefault(),this.dismissed=!0,fe()}}createRenderRoot(){return this}connectedCallback(){super.connectedCallback(),document.addEventListener(`visibilitychange`,this.handleVisibilityChange),document.addEventListener(`pointermove`,this.handleGaze,{passive:!0})}disconnectedCallback(){document.removeEventListener(`visibilitychange`,this.handleVisibilityChange),this.clearActTimers(),this.clearVisitTimers(),this.grumpyTimer!==null&&(window.clearTimeout(this.grumpyTimer),this.grumpyTimer=null),this.shellTimer!==null&&(window.clearTimeout(this.shellTimer),this.shellTimer=null);for(let e of[this.vigilTimer,this.holdTimer])e!==null&&window.clearTimeout(e);this.vigilTimer=null,this.holdTimer=null,this.audioCtx&&=(this.audioCtx.close().catch(()=>{}),null),document.removeEventListener(`pointermove`,this.handleGaze),super.disconnectedCallback()}wantsVisible(){return this.visitsEnabled&&!this.dismissed&&(this.mode===`offline`||this.vigil||this.outcomePresenceOwner!==null||this.scheduledVisiting)}willUpdate(e){if(this.look===null||e.has(`seed`))this.look=R(this.seed),this.rng=F(this.seed^2654435769),this.visitRng=F(this.seed^99282957),this.entranceRng=F((this.seed^57978)>>>0),this.identity=nn(this.seed,this.look),this.look=this.identity.look,this.spotPct=this.look.spotPct,this.facing=this.look.facing,this.clearActTimers(),this.act=null,this.dismissed=!1,this.presence=`out`,this.molted=!1,this.shellVisible=!1,this.shellTimer!==null&&(window.clearTimeout(this.shellTimer),this.shellTimer=null),this.moltPlanned=Zt(this.seed)&&!this.identity.elder,this.twinPlanned=Qt(this.seed),this.familiarity=pe(),this.sailorDay=oe(new Date),this.greetedThisLoad=!1,this.scheduleVisits(),this.traffic.reset(this.seed),this.vigil=!1,this.outcomePresenceOwner=null,this.trackVigil();else if(e.has(`mode`)){let t=e.get(`mode`)===`busy`&&this.mode===`idle`,n=t&&this.vigil?`vigil`:null;if(this.trackVigil(),this.presence===`in`&&!q()){let e=Yt(this.runOutcome);this.performAct(t?e:`startle`,n)}}!this.movingDayChecked&&this.gatewayVersion&&(this.movingDayChecked=!0,this.movingDay=on(this.gatewayVersion)),this.toggleAttribute(`data-dex-complete`,(this.identity?.dexComplete??!1)&&this.visitsEnabled&&!this.dismissed),this.reconcilePresence()}reconcilePresence(){let e=this.wantsVisible();if(e&&this.presence!==`in`){this.leaveTimer!==null&&(window.clearTimeout(this.leaveTimer),this.leaveTimer=null),this.presence===`out`&&(this.rollPerch(),this.entrance=Xt(this.entranceRng()),this.look&&(this.anniversary=he(b().get(this.look.palette.id)?.firstSeenAt??null,new Date),le(this.look.palette.id,{name:this.identity?rn(this.identity,this.seed):P(this.look,this.seed),shiny:this.look.shiny}),de())),this.presence=`in`,this.entering=!q(),this.restartPending=!0;return}!e&&this.presence===`in`&&(this.outcomePresenceOwner=null,this.clearActTimers(),this.act=null,this.entering=!1,this.presence=`leaving`,this.leaveTimer=window.setTimeout(()=>{this.leaveTimer=null,this.presence=`out`},350))}updated(){this.restartPending&&(this.restartPending=!1,this.enterTimer=window.setTimeout(()=>{this.enterTimer=null,this.entering=!1,!this.greetedThisLoad&&(this.familiarity.tier===`friend`||this.identity?.oldFriend===!0)&&this.presence===`in`&&!q()&&(this.greetedThisLoad=!0,this.performAct(`wave`))},un[this.entrance]),this.scheduleNextAct())}playChirp(e){this.audioCtx=ve(this.audioCtx,this.soundsEnabled,e)}pokeNow(){this.playChirp(`poke`);let e=Date.now();if(this.pokeTimes=[...this.pokeTimes.filter(t=>e-t<6e3),e],this.pokeTimes.length>=10&&this.mode!==`offline`){this.huffOff();return}this.pokeTimes.length>=3&&this.enterGrumpy(),this.performAct(`startle`)}enterGrumpy(){this.grumpy=!0,this.grumpyTimer!==null&&window.clearTimeout(this.grumpyTimer),this.grumpyTimer=window.setTimeout(()=>{this.grumpyTimer=null,this.grumpy=!1},6e4)}huffOff(){this.pokeTimes=[],this.grumpy=!1,this.clearVisitTimers(),this.scheduledVisiting=!1,this.armArrival(L(this.visitRng,Q[0],Q[1]))}trackVigil(){this.vigilTimer!==null&&(window.clearTimeout(this.vigilTimer),this.vigilTimer=null),this.mode===`busy`?this.vigilTimer=window.setTimeout(()=>{this.vigilTimer=null,this.vigil=!0,this.clearActTimers(),this.act=null},6e5):this.vigil=!1}clearActTimers(){for(let e of[this.idleTimer,this.actEndTimer,this.enterTimer])e!==null&&window.clearTimeout(e);this.idleTimer=null,this.actEndTimer=null,this.enterTimer=null}clearVisitTimers(){for(let e of[this.visitTimer,this.leaveTimer])e!==null&&window.clearTimeout(e);this.visitTimer=null,this.leaveTimer=null}scheduleVisits(){if(this.clearVisitTimers(),this.scheduledVisiting=!1,this.visitRng()<.25)return;let e=w[this.familiarity.tier];this.armArrival(L(this.visitRng,X[0],X[1])*e.firstDelayMul)}armArrival(e){this.visitTimer=window.setTimeout(()=>{this.visitTimer=null,this.rollPerch(),this.scheduledVisiting=!0,this.armDeparture(L(this.visitRng,Z[0],Z[1])*w[this.familiarity.tier].stayMul)},e)}armDeparture(e){this.visitTimer=window.setTimeout(()=>{this.visitTimer=null,this.scheduledVisiting=!1;let e=w[this.familiarity.tier],t=this.familiarity.wary?w.waryGapMul:1;this.armArrival(L(this.visitRng,Q[0],Q[1])*e.gapMul*t)},e)}watchTraffic(e){this.presence===`in`&&this.act!==`scuttle`&&!this.vigil&&(this.facing=e)}reactToPasser(){let e=this.familiarity.tier===`friend`?`wave`:this.familiarity.tier===`shy`?`peek`:null;e===null||this.presence!==`in`||this.act!==null||this.vigil||this.mode!==`idle`||q()||this.performAct(e)}rollPerch(){this.anchor=this.visitRng()<.6?`ledge`:`bar`,this.setAttribute(`data-spot`,this.anchor);let e=this.currentZone();this.spotPct=Math.round(L(this.visitRng,e[0],e[1])),this.facing=this.visitRng()<.5?1:-1}currentZone(){if(this.anchor===`bar`)return dn;let e=this.look?.side??`right`;return G[e]}scheduleNextAct(){if(!this.look||this.presence!==`in`||this.vigil||this.traffic.passer!==null||this.idleTimer!==null||this.actEndTimer!==null||q())return;let e=Jt(this.mode,this.look.personality);if(!e)return;let t=L(this.rng,e.delayMs[0],e.delayMs[1]);this.idleTimer=window.setTimeout(()=>{this.idleTimer=null;let e=Jt(this.mode,this.look?.personality??null);if(!(!e||document.hidden||this.presence!==`in`||this.traffic.passer!==null)){if(this.moltPlanned&&!this.molted&&this.mode===`idle`){this.performAct(`molt`);return}this.performAct(I(this.rng,e.acts))}},t)}performAct(e,t=null){this.clearActTimers(),this.outcomePresenceOwner=t,this.entering=!1,e===`scuttle`&&this.startScuttle(),this.act=e,this.actEndTimer=window.setTimeout(()=>{if(this.actEndTimer=null,this.act=null,e===`molt`&&this.completeMolt(),e===`droop`){this.performAct(`sweep`,t);return}this.outcomePresenceOwner=null,this.wantsVisible()&&this.scheduleNextAct()},cn[e])}completeMolt(){if(this.molted=!0,this.look){let e=[1.7,2,2.5],t=e.indexOf(this.look.scale);this.shellScale=this.look.scale,this.look={...this.look,scale:_(e[Math.min(t+1,e.length-1)],`lobster molt size tier`)}}this.shellSpotPct=this.spotPct,this.shellVisible=!0;let e=this.currentZone();this.spotPct=Math.min(e[1],Math.max(e[0],this.spotPct+(this.facing===1?9:-9))),this.shellTimer!==null&&window.clearTimeout(this.shellTimer),this.shellTimer=window.setTimeout(()=>{this.shellTimer=null,this.shellVisible=!1},6e4)}startScuttle(){if(!this.look)return;let e=this.currentZone(),t=Math.round(L(this.rng,e[0],e[1]));Math.abs(t-this.spotPct)<4&&(t=Math.abs(e[0]-this.spotPct)>Math.abs(e[1]-this.spotPct)?e[0]:e[1]),this.facing=t<this.spotPct?-1:1,this.spotPct=t}render(){let e=this.look;if(!e)return c;let t=this.identity,n=t?.elder?`old as the tides`:t?.oldFriend?`an old friend`:null;return Rt({look:e,mode:this.mode,presence:this.presence,shellVisible:this.shellVisible,visitsEnabled:this.visitsEnabled,dismissed:this.dismissed,passer:this.traffic.passer?{kind:this.traffic.passer.kind,direction:this.traffic.passer.direction,crossMs:this.traffic.passerCrossMs()}:null,twinPlanned:this.twinPlanned,anniversary:this.anniversary,entering:this.entering,entrance:this.entrance,grumpy:this.grumpy,vigil:this.vigil,elder:t?.elder??!1,act:this.act,zone:this.currentZone(),spotPct:this.spotPct,facing:this.facing,anchor:this.anchor,barMaxScale:fn,shellScale:this.shellScale,shellSpotPct:this.shellSpotPct,familiarityVisits:this.familiarity.visits,seed:this.seed,movingDay:this.movingDay,sailorDay:this.sailorDay,nameOverride:t?rn(t,this.seed):null,flavor:n,bottle:this.traffic.bottle(),onPointerDown:this.handleHoldStart,onPointerUp:this.handleHoldEnd,onPointerCancel:this.handleHoldCancel,onContextMenu:this.handleShoo,onBottleOpen:this.traffic.openBottle})}},r([p({attribute:!1})],$.prototype,`seed`,void 0),r([p({attribute:!1})],$.prototype,`mode`,void 0),r([p({attribute:!1})],$.prototype,`visitsEnabled`,void 0),r([p({attribute:!1})],$.prototype,`runOutcome`,void 0),r([p({attribute:!1})],$.prototype,`soundsEnabled`,void 0),r([p({attribute:!1})],$.prototype,`gatewayVersion`,void 0),r([m()],$.prototype,`act`,void 0),r([m()],$.prototype,`spotPct`,void 0),r([m()],$.prototype,`facing`,void 0),r([m()],$.prototype,`entering`,void 0),r([m()],$.prototype,`entrance`,void 0),r([m()],$.prototype,`presence`,void 0),r([m()],$.prototype,`anchor`,void 0),r([m()],$.prototype,`scheduledVisiting`,void 0),r([m()],$.prototype,`dismissed`,void 0),r([m()],$.prototype,`grumpy`,void 0),r([m()],$.prototype,`vigil`,void 0),r([m()],$.prototype,`outcomePresenceOwner`,void 0),r([m()],$.prototype,`movingDay`,void 0),r([m()],$.prototype,`anniversary`,void 0),r([m()],$.prototype,`shellVisible`,void 0),customElements.get(`openclaw-lobster-pet`)||customElements.define(`openclaw-lobster-pet`,$)}));export{ie as _,K as a,j as c,O as d,E as f,T as g,b as h,R as i,je as l,ye as m,vn as n,Lt as o,be as p,N as r,z as s,yn as t,Ce as u};
//# sourceMappingURL=lobster-pet-B7v3fQvL.js.map