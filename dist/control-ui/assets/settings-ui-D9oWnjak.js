import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{In as t,Ln as n,Rn as r}from"./control-ui-core-CrKLOOVi.js";import{$ as i,B as a,I as o,K as s,Q as c,R as l,W as u,Y as d,ct as f,d as p,dt as m,it as h,nt as g,p as _,z as v}from"./lit-runtime-D5xZwgO1.js";import{$ as y,A as b,B as x,D as S,E as C,F as w,G as ee,K as te,M as ne,N as re,O as T,P as E,at as D,et as O,it as k,j as A,k as j,rt as M,tt as ie,v as N,y as P,z as F}from"./control-ui-foundation-Dgui328h.js";import{o as I,t as ae}from"./control-ui-core-DkYXaYTI.js";import{gt as L,vt as R,yt as oe}from"./control-ui-core-CTll8UdE.js";import{i as z,n as se,r as B,t as ce}from"./chunk.GWSUX3V5-CtwtgqtS.js";var V,H=e((()=>{u(),V=f`
  :host {
...
`})),U,W=e((()=>{H(),z(),A(),T(),C(),F(),D(),u(),c(),U=class extends b{constructor(){super(),this.checked=!1,this.forceDisabled=!1,this.appearance=`default`,this.disabled=!1,this.handleClick=()=>{!this.disabled&&!this.forceDisabled&&(this.checked=!0)},this.addEventListener(`click`,this.handleClick)}handleSizeChange(){j(this.localName,this.size)}connectedCallback(){super.connectedCallback(),this.setInitialAttributes()}setInitialAttributes(){this.setAttribute(`role`,`radio`),this.tabIndex=0,this.setAttribute(`aria-disabled`,this.disabled||this.forceDisabled?`true`:`false`)}updated(e){if(super.updated(e),e.has(`checked`)&&(this.customStates.set(`checked`,this.checked),this.setAttribute(`aria-checked`,this.checked?`true`:`false`),!this.disabled&&!this.forceDisabled&&(this.tabIndex=this.checked?0:-1)),e.has(`disabled`)||e.has(`forceDisabled`)){let e=this.disabled||this.forceDisabled;this.customStates.set(`disabled`,e),this.setAttribute(`aria-disabled`,e?`true`:`false`),e?this.tabIndex=-1:this.tabIndex=this.checked?0:-1}}setValue(){}render(){return d`
    ...
    `}},U.css=[B,S,V],k([g()],U.prototype,`checked`,2),k([g()],U.prototype,`forceDisabled`,2),k([h({reflect:!0})],U.prototype,`value`,2),k([h({reflect:!0})],U.prototype,`appearance`,2),k([h({reflect:!0})],U.prototype,`size`,2),k([x(`size`)],U.prototype,`handleSizeChange`,1),k([h({type:Boolean})],U.prototype,`disabled`,2),U=k([m(`wa-radio`)],U),U.disableWarning?.(`change-in-update`)})),G=e((()=>{W(),H(),z(),A(),C(),N(),P(),M()})),K,q=e((()=>{u(),K=f`
  .form-control {
    position: relative;
    border: none;
    padding: 0;
...
`})),J,le=e((()=>{q(),se(),z(),ee(),A(),T(),w(),C(),F(),D(),u(),c(),v(),J=class extends b{constructor(){super(),this.hasSlotController=new E(this,`hint`,`label`),this.label=``,this.hint=``,this.name=null,this.disabled=!1,this.orientation=`vertical`,this._value=null,this.defaultValue=this.getAttribute(`value`)||null,this.required=!1,this.withLabel=!1,this.withHint=!1,this.handleRadioClick=e=>{let t=e.target.closest(`wa-radio`);if(!t||t.disabled||t.forceDisabled||this.disabled)return;let n=this.value;this.value=t.value,t.checked=!0;let r=this.getAllRadios();for(let e of r)t!==e&&(e.checked=!1,e.setAttribute(`tabindex`,`-1`));this.value!==n&&this.updateComplete.then(()=>{this.dispatchEvent(new InputEvent(`input`,{bubbles:!0,composed:!0})),this.dispatchEvent(new Event(`change`,{bubbles:!0,composed:!0}))})},this.addEventListener(`keydown`,this.handleKeyDown),this.addEventListener(`click`,this.handleRadioClick)}static get validators(){let e=[ce({validationElement:Object.assign(document.createElement(`input`),{required:!0,type:`radio`,name:te(`__wa-radio`)})})];return[...super.validators,...e]}get value(){return this.valueHasChanged?this._value:this._value??this.defaultValue}set value(e){typeof e==`number`&&(e=String(e)),this.valueHasChanged=!0,this._value=e}handleSizeChange(){j(this.localName,this.size)}get validationTarget(){let e=this.querySelector(`:is(wa-radio):not([disabled])`);if(e)return e}updated(e){(e.has(`disabled`)||e.has(`size`)||e.has(`value`)||e.has(`defaultValue`))&&this.syncRadioElements()}formResetCallback(...e){this._value=null,super.formResetCallback(...e),this.syncRadioElements()}getAllRadios(){return[...this.querySelectorAll(`wa-radio`)]}handleLabelClick(){this.focus()}async syncRadioElements(){let e=this.getAllRadios();if(e.forEach((t,n)=>{this.size&&t.setAttribute(`size`,this.size),t.toggleAttribute(`data-wa-radio-horizontal`,this.orientation!==`vertical`),t.toggleAttribute(`data-wa-radio-vertical`,this.orientation===`vertical`),t.toggleAttribute(`data-wa-radio-first`,n===0),t.toggleAttribute(`data-wa-radio-inner`,n!==0&&n!==e.length-1),t.toggleAttribute(`data-wa-radio-last`,n===e.length-1),t.forceDisabled=this.disabled}),await Promise.all(e.map(async e=>{await e.updateComplete,!e.disabled&&e.value===this.value?e.checked=!0:e.checked=!1})),this.disabled)e.forEach(e=>{e.tabIndex=-1});else{let t=e.filter(e=>!e.disabled),n=t.find(e=>e.checked);t.length>0&&(n?t.forEach(e=>{e.tabIndex=e.checked?0:-1}):t.forEach((e,t)=>{e.tabIndex=t===0?0:-1})),e.filter(e=>e.disabled).forEach(e=>{e.tabIndex=-1})}}handleKeyDown(e){if(![`ArrowUp`,`ArrowDown`,`ArrowLeft`,`ArrowRight`,` `].includes(e.key)||this.disabled)return;let t=this.getAllRadios().filter(e=>!e.disabled);if(t.length<=0)return;e.preventDefault();let n=this.value,r=t.find(e=>e.checked)??t[0],i=e.key===` `?0:[`ArrowUp`,`ArrowLeft`].includes(e.key)?-1:1,a=t.indexOf(r)+i;a||=0,a<0&&(a=t.length-1),a>t.length-1&&(a=0);let o=t.some(e=>e.tagName.toLowerCase()===`wa-radio-button`);this.getAllRadios().forEach(e=>{e.checked=!1,o||e.setAttribute(`tabindex`,`-1`)}),this.value=t[a].value,t[a].checked=!0,o?t[a].shadowRoot.querySelector(`button`).focus():(t[a].setAttribute(`tabindex`,`0`),t[a].focus()),this.value!==n&&this.updateComplete.then(()=>{this.dispatchEvent(new InputEvent(`input`,{bubbles:!0,composed:!0})),this.dispatchEvent(new Event(`change`,{bubbles:!0,composed:!0}))}),e.preventDefault()}focus(e){if(this.disabled)return;let t=this.getAllRadios(),n=t.find(e=>e.checked),r=t.find(e=>!e.disabled),i=n||r;i&&i.focus(e)}render(){let e=this.hasSlotController.test(`label`,`withLabel`),t=this.hasSlotController.test(`hint`,`withHint`),n=this.label?!0:!!e,r=this.hint?!0:!!t;return d`
    ...
    `}},J.css=[S,B,K],J.shadowRootOptions={...b.shadowRootOptions,delegatesFocus:!0},k([i(`slot:not([name])`)],J.prototype,`defaultSlot`,2),k([h()],J.prototype,`label`,2),k([h({attribute:`hint`})],J.prototype,`hint`,2),k([h({reflect:!0})],J.prototype,`name`,2),k([h({type:Boolean,reflect:!0})],J.prototype,`disabled`,2),k([h({reflect:!0})],J.prototype,`orientation`,2),k([g()],J.prototype,`value`,1),k([h({attribute:`value`,reflect:!0})],J.prototype,`defaultValue`,2),k([h({reflect:!0})],J.prototype,`size`,2),k([x(`size`)],J.prototype,`handleSizeChange`,1),k([h({type:Boolean,reflect:!0})],J.prototype,`required`,2),k([h({type:Boolean,attribute:`with-label`})],J.prototype,`withLabel`,2),k([h({type:Boolean,attribute:`with-hint`})],J.prototype,`withHint`,2),J=k([m(`wa-radio-group`)],J),J.disableWarning?.(`change-in-update`)})),Y=e((()=>{le(),q(),W(),H(),z(),A(),C(),N(),P(),M()})),X,Z=e((()=>{u(),X=f`
  :host {
    --height: var(--wa-form-control-toggle-size);
...
`})),Q,ue=e((()=>{Z(),z(),re(),A(),T(),w(),C(),F(),O(),D(),u(),c(),v(),o(),p(),Q=class extends b{constructor(){super(...arguments),this.hasSlotController=new E(this,`hint`),this.localize=new y(this),this.title=``,this.name=null,this._value=this.getAttribute(`value`)??null,this.size=`m`,this.disabled=!1,this._checked=null,this.defaultChecked=this.hasAttribute(`checked`),this.required=!1,this.hint=``,this.withHint=!1}static get validators(){return[...super.validators,ne()]}get value(){return this._value??`on`}set value(e){this._value=e}handleSizeChange(){j(this.localName,this.size)}get checked(){return this.valueHasChanged?!!this._checked:this._checked??this.defaultChecked}set checked(e){this._checked=!!e,this.valueHasChanged=!0}handleClick(){this.hasInteracted=!0,this.checked=!this.checked,this.updateComplete.then(()=>{this.dispatchEvent(new Event(`change`,{bubbles:!0,composed:!0}))})}handleKeyDown(e){let t=this.localize.dir()===`rtl`;e.key===`ArrowLeft`&&(e.preventDefault(),this.checked=t,this.updateComplete.then(()=>{this.dispatchEvent(new Event(`change`,{bubbles:!0,composed:!0})),this.dispatchEvent(new InputEvent(`input`,{bubbles:!0,composed:!0}))})),e.key===`ArrowRight`&&(e.preventDefault(),this.checked=!t,this.updateComplete.then(()=>{this.dispatchEvent(new Event(`change`,{bubbles:!0,composed:!0})),this.dispatchEvent(new InputEvent(`input`,{bubbles:!0,composed:!0}))}))}willUpdate(e){super.willUpdate(e),(e.has(`value`)||e.has(`checked`)||e.has(`defaultChecked`))&&this.handleValueOrCheckedChange()}handleValueOrCheckedChange(){if(this.didSSR&&!this.hasUpdated){this.updateComplete.then(()=>{this.handleValueOrCheckedChange()});return}this.setValue(this.checked?this.value:null,this._value),this.updateValidity()}handleStateChange(){this.hasUpdated&&(this.input.checked=this.checked),this.customStates.set(`checked`,this.checked),this.updateValidity()}handleDisabledChange(){this.updateValidity()}click(){this.input.click()}focus(e){this.input.focus(e)}blur(){this.input.blur()}setValue(e,t){if(!this.checked){this.internals.setFormValue(null,null);return}this.internals.setFormValue(e??`on`,t)}formResetCallback(){this._checked=null,super.formResetCallback(),this.handleValueOrCheckedChange()}render(){let e=this.hasSlotController.test(`hint`,`withHint`),t=this.hint?!0:!!e,n=this.didSSR&&!this.hasUpdated?this.checked:this.defaultChecked,r=this.didSSR&&!this.hasUpdated?null:_(this.checked);return d`
      ...
      <slot
        ...
        >${this.hint}</slot
      >
    `}},Q.shadowRootOptions={...b.shadowRootOptions,delegatesFocus:!0},Q.css=[B,S,X],k([i(`input[type="checkbox"]`)],Q.prototype,`input`,2),k([h()],Q.prototype,`title`,2),k([h({reflect:!0})],Q.prototype,`name`,2),k([h({reflect:!0})],Q.prototype,`value`,1),k([h({reflect:!0})],Q.prototype,`size`,2),k([x(`size`)],Q.prototype,`handleSizeChange`,1),k([h({type:Boolean})],Q.prototype,`disabled`,2),k([h({type:Boolean,attribute:!1})],Q.prototype,`checked`,1),k([h({type:Boolean,attribute:`checked`,reflect:!0})],Q.prototype,`defaultChecked`,2),k([h({type:Boolean,reflect:!0})],Q.prototype,`required`,2),k([h({attribute:`hint`})],Q.prototype,`hint`,2),k([h({attribute:`with-hint`,type:Boolean})],Q.prototype,`withHint`,2),k([x([`checked`,`defaultChecked`])],Q.prototype,`handleStateChange`,1),k([x(`disabled`,{waitUntilFirstUpdate:!0})],Q.prototype,`handleDisabledChange`,1),Q=k([m(`wa-switch`)],Q),Q.disableWarning?.(`change-in-update`)})),$=e((()=>{ue(),Z(),z(),A(),C(),M(),O(),ie()}));function de(e,t={}){return d`
    <div class=${t.wide?`settings-page settings-page--wide`:`settings-page`}>
      ${t.intro?d`<p class="settings-page__intro">${t.intro}</p>`:s}
      ${e}
    </div>
  `}function fe(e,r){return d`<a href=${e} target=${t} rel=${n()}
    >${r}</a
  ...
  `}function ye(e){return{description:d`${I(e.overridden?`configForm.defaultValue`:`configForm.usingDefault`,{value:e.value})}`,action:e.overridden?d`
          <button
            type="button"
            class="btn btn--icon"
            title=${I(`configForm.resetToDefault`)}
            aria-label=${I(`configForm.resetToDefault`)}
            ?disabled=${e.disabled??!1}
  ...
  `}var Te=e((()=>{G(),Y(),$(),u(),p(),ae(),r(),oe(),L()}));export{Y as _,me as a,he as c,be as d,xe as f,$ as g,Se as h,Ce as i,we as l,ve as m,fe as n,ge as o,_e as p,ye as r,de as s,Te as t,pe as u,G as v};
//# sourceMappingURL=settings-ui-D9oWnjak.js.map