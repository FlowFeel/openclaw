import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{K as t,W as n,Y as r}from"./lit-runtime-D5xZwgO1.js";import{o as i,t as a}from"./control-ui-core-s0pW0mau.js";import{n as o,t as s}from"./workboard-widget-B1WIMeNh.js";var c,l;e((()=>{n(),a(),o(),c=class extends s{async handleStatusChange(e){let t=this.readStringProp(`cardId`),n=this.cards.find(e=>e.id===t),r=e.currentTarget.value;!n||!this.statuses.includes(r)||await this.moveCard(n,r)}render(){let e=this.readStringProp(`cardId`);if(!e)return r`<p class="workboard-widget__state" role="alert">
    ...
    `}},customElements.get(`openclaw-workboard-card-widget`)||customElements.define(`openclaw-workboard-card-widget`,c),l=({widget:e,sessionKey:t,canMutate:n,requestUpdate:i})=>r`
...
//# sourceMappingURL=workboard-card-D5NRjh9z.js.map