import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{b as t,y as n}from"./control-ui-foundation-OE0aAIzW.js";import{Bc as r,Kc as i,Qn as a,Vc as o,Wc as s,Yn as c,_n as l,bn as u,fn as d,gn as f,hn as p,jr as m,kr as h,rr as g,vn as ee}from"./control-ui-core-UWR2ANgr.js";import{K as _,Q as v,W as y,Y as b,nt as x}from"./lit-runtime-D5xZwgO1.js";import{i as te,r as ne}from"./control-ui-foundation-Dgui328h.js";import{A as re,D as ie,R as ae,St as S,Ut as oe,Wt as se,Y as ce,Z as le,_ as ue,bt as de,jt as fe,v as pe,wt as me}from"./control-ui-core-DDTXn_ud.js";import{At as he,Dt as C,Mt as w}from"./control-ui-foundation-DkfOBVsU.js";import{i as ge,o as T,t as E}from"./control-ui-core-BCL4Sy8S.js";import{G as _e,N as ve,P as ye,pt as D,vt as O,yt as be}from"./control-ui-core-DS6N4FyQ.js";import{f as xe}from"./control-ui-shared-jMm55vwq.js";import{n as Se,t as Ce}from"./poll-controller-BnQs2EZr.js";import{n as we,t as Te}from"./wizard-step-controls-9QekdMY8.js";import{n as Ee,t as De}from"./settings-workspace-BbyrBOFl.js";import{_ as Oe,f as k,i as A,n as ke,s as Ae,t as j,u as M,v as je}from"./settings-ui-Ci_wwIOc.js";import{n as Me,t as Ne}from"./gateway-page-controller-jbE-wF7H.js";import{a as Pe,c as Fe,i as Ie,s as Le}from"./presentation-BFOHOIy5.js";import{c as Re,l as ze,n as Be,o as Ve,t as He,u as Ue}from"./config-form-Cy8Ovk7m.js";async function N(e,t){let n=new AbortController,r=setTimeout(()=>n.abort(new DOMException(`Nostr profile request timed out after 30 seconds`,`TimeoutError`)),F);try{let r=await fetch(e,{...t,signal:n.signal}),i=null;try{i=await r.json()}catch(e){if(n.signal.aborted)throw n.signal.reason??e}return{data:i,response:r}}finally{clearTimeout(r)}}function We(e){if(!Array.isArray(e))return{};let t={};for(let n of e){if(typeof n!=`string`)continue;let[e,...r]=n.split(`:`);if(!e||r.length===0)continue;let i=e.trim(),a=r.join(`:`).trim();i&&a&&(t[i]=a)}return t}function P(e,t=``){return`/api/channels/nostr/${encodeURIComponent(e)}/profile${t}`}async function Ge(e){return await N(P(e.accountId),{method:`PUT`,headers:{"Content-Type":`application/json`,...e.headers},body:JSON.stringify(e.values)})}async function Ke(e){return await N(P(e.accountId,`/import`),{method:`POST`,headers:{"Content-Type":`application/json`,...e.headers},body:JSON.stringify({autoMerge:!0})})}var F,qe=e((()=>{F=3e4}));function Je(e){let{values:t,original:n}=e;return t.name!==n.name||t.displayName!==n.displayName||t.about!==n.about||t.picture!==n.picture||t.banner!==n.banner||t.website!==n.website||t.nip05!==n.nip05||t.lud16!==n.lud16}function Ye(e){let{state:t,callbacks:n,accountId:r}=e,i=Je(t),a=(e,r,i={})=>{let{type:a=`text`,placeholder:o,maxLength:s,help:c}=i,l=t.values[e]??``,u=t.fieldErrors[e],d=`nostr-profile-${e}`,f=a===`textarea`?b`
            <textarea
              id="${d}"
...
//# sourceMappingURL=channels-page-D2EW54tl.js.map