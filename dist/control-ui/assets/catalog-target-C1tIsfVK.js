import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{_s as t,fs as n}from"./control-ui-core-CrKLOOVi.js";import{K as r,W as i,Y as a}from"./lit-runtime-D5xZwgO1.js";import{o,t as s}from"./control-ui-core-DkYXaYTI.js";import{vt as c,yt as l}from"./control-ui-core-CTll8UdE.js";function u(e){return JSON.stringify([e?.requestedAgentId??``,e?.catalogId??``])}function d(e){return!!e?.catalogId}function f(e){return!!(e?.catalogId&&e.model&&e.catalogLabel)}function p(e,n,r){let i=e?.agentId?.trim();if(!i)return t(r);let a=t(i);return n.some(e=>t(e.id)===a)?a:t(r)}function m(e,t){return!d(e)||f(e)&&!!t}async function h(e,t,n){try{let r=(await e.request(`sessions.catalog.list`,{...n?{agentId:n}:{},catalogId:t,limitPerHost:1})).catalogs.find(e=>e.id===t),i=r?.capabilities.createSession?.model.trim();return r&&i?{model:i,catalogLabel:r.label}:void 0}catch{return}}function g(e){if(!d(e))return r;let t=f(e),n=e?.catalogLabel||e?.catalogId||``;return a`<span
...
//# sourceMappingURL=catalog-target-C1tIsfVK.js.map