import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{b as t,y as n}from"./control-ui-foundation-OE0aAIzW.js";import{Kc as r,Wc as i}from"./control-ui-core-CrKLOOVi.js";import{E as a,K as o,O as s,Q as c,W as l,Y as u,a as d,it as f,nt as p,o as m,q as h}from"./lit-runtime-D5xZwgO1.js";import{f as g,g as _,m as v,p as y}from"./control-ui-foundation-Dgui328h.js";import{o as b,t as x}from"./control-ui-core-DkYXaYTI.js";import{vt as S,yt as C}from"./control-ui-core-CTll8UdE.js";import{t as w}from"./web-awesome-tabs-Ct-trtla.js";import{g as T,h as E,m as D}from"./chat-message-LFk-poAG.js";import{a as O,f as k,i as A,n as j,p as M,s as N,t as P}from"./split-drop-zone-B4cZIMIX.js";function F(e){if(!e?.trim())return null;try{let t=new URL(e);return t.protocol===`https:`||t.protocol===`http:`?t.href:null}catch{return null}}function I(e){let t=F(e);if(!t)return null;let n=new URL(t);if(n.origin===window.location.origin)return null;if(n.searchParams.get(`openclawHostTheme`)!==`1`||!/^\/embed\/(?:channel|thread)\/[^/]+\/[^/]+\/?$/u.test(n.pathname))return n.href;n.searchParams.set(`theme`,document.documentElement.dataset.themeMode===`light`?`light`:`dark`),n.searchParams.set(`hostOrigin`,window.location.origin);let r=D().tokens;return Object.keys(r).length>0&&n.searchParams.set(`themeTokens`,JSON.stringify(r)),n.href}var L,R=e((()=>{g(),l(),c(),x(),r(),E(),t(),L=class extends i{constructor(...e){super(...e),this.sessionKey=``,this.loadInfo=null,this.openDiscussion=null,this.onStateChange=null,this.canOpen=!0,this.sourceGeneration=0,this.openingDiscussion=null,this.themeObserver=null,this.discussionTask=new y(this,{args:()=>[this.sessionKey.trim(),this.loadInfo,this.openDiscussion,this.sourceGeneration,this.canOpen],task:async([e,t,n,r,i],{signal:a})=>{if(!t||!e)return null;let o=await t(e);a.throwIfAborted();let s={sessionKey:e,loader:t,opener:n,sourceGeneration:r,canOpen:i};if(!this.isOpeningCurrent(s))return v;let c=o;if(o.state===`available`&&i&&n){if(this.openingDiscussion=s,this.publish(e,o),!this.isOpeningCurrent(s))return v;c=await n(e)??o}return a.throwIfAborted(),this.isOpeningCurrent(s)?{sessionKey:e,info:c}:v},onComplete:e=>{this.openingDiscussion=null,e&&this.publish(e.sessionKey,e.info)},onError:()=>{this.openingDiscussion=null}}),this.handleDiscussionFrameLoad=e=>{let t=e.currentTarget;t instanceof HTMLIFrameElement&&this.postDiscussionTheme(t)}}isOpeningCurrent(e){return e.sessionKey===this.sessionKey.trim()&&e.loader===this.loadInfo&&e.opener===this.openDiscussion&&e.sourceGeneration===this.sourceGeneration&&e.canOpen===this.canOpen}connectedCallback(){super.connectedCallback(),!(typeof MutationObserver>`u`)&&(this.themeObserver=new MutationObserver(()=>this.postDiscussionTheme()),this.themeObserver.observe(document.documentElement,{attributes:!0,attributeFilter:[`data-theme`,`data-theme-mode`,`style`]}))}disconnectedCallback(){this.themeObserver?.disconnect(),this.themeObserver=null,super.disconnectedCallback()}postDiscussionTheme(e=this.querySelector(`.session-discussion__frame`)){e?.isConnected&&T(e,new URL(e.src).origin)}publish(e,t){e===this.sessionKey.trim()&&this.onStateChange?.(e,t.state,F(t.openUrl))}renderOpen(e){let t=I(e.embedUrl),n=F(e.openUrl);return u`
    ...
    </div>`}renderHeader(e,t,n){let r=e.panels.find(e=>e.id===t)??e.panels[0];if(!r)return o;let i=this.panelOpenUrls[r.slot];return u`
      <div
      ...
      >
        ...
        >
          ${e.panels.map(e=>{let t=!n&&this.canMutatePanel(e.slot);return u`
              <wa-tab
                ...
                data-panel-id=${e.id}
                .draggable=${t}
                title=${t?b(`chat.sidebarColumns.drag`,{panel:z(e.slot)}):o}
        ...
        <div class="sidebar-column__actions">
          ${i?u`<a
                ...
                target="_blank"
                rel="noopener"
                aria-label=${b(`chat.sessionDiscussion.openExternal`)}
                title=${b(`chat.sessionDiscussion.openExternal`)}
                >${S.externalLink}</a
              >`:o}
          ${this.canMutatePanel(r.slot)?u`<button
                class="btn btn--ghost btn--icon"
                type="button"
                aria-label=${b(`chat.sidebarColumns.close`,{panel:z(r.slot)})}
                title=${b(`chat.sidebarColumns.close`,{panel:z(r.slot)})}
...
//# sourceMappingURL=chat-sidebar-region.runtime-DSTtNTCT.js.map