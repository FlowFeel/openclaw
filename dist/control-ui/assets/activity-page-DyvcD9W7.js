import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{b as t,y as n}from"./control-ui-foundation-OE0aAIzW.js";import{As as r,Bc as i,Hc as a,Jn as o,Kc as s,Vc as c,Wc as l,ar as u,er as d,fs as f,nr as p,pa as ee,rr as m,za as te}from"./control-ui-core-BUddgKjW.js";import{K as h,Q as ne,W as g,Y as _,nt as v}from"./lit-runtime-D5xZwgO1.js";import{i as y,r as b}from"./control-ui-foundation-Dgui328h.js";import{A as x,D as S,Wt as re,_ as ie,jt as ae,v as oe}from"./control-ui-core-Ct5CBwjl.js";import{Zt as se,en as C}from"./control-ui-foundation-DkfOBVsU.js";import{o as w,t as ce}from"./control-ui-core-s0pW0mau.js";import{vt as le,yt as ue}from"./control-ui-core-vLOElyFQ.js";import{n as de,t as fe}from"./settings-workspace-BbyrBOFl.js";import{c as T,f as E,p as D,t as O}from"./settings-ui-Bko7fBdZ.js";import{n as k,t as A}from"./stream-auto-follow-controller-DZ9E9o4h.js";function j(e){return typeof e==`string`&&e.trim()||null}function M(e){return e&&typeof e==`object`?e:null}function N(e,t=Date.now()){let n=M(e),r=j(n?.runId),i=M(n?.data),a=n?.stream===`tool`,o=n?.stream===`item`&&j(i?.kind)===`answer_candidate`;if(!n||!a&&!o||!r||!i)return null;let s=j(n.sessionKey),c=j(n.agentId);return{stream:a?`tool`:`item`,runId:r,ts:typeof n.ts==`number`?n.ts:t,receivedAt:t,...s?{sessionKey:s}:{},...c?{agentId:c}:{},data:i}}function P(e){if(typeof e==`string`)return e;if(typeof e==`number`||typeof e==`boolean`)return String(e);let t=M(e);if(!t)return null;if(typeof t.text==`string`)return t.text;let n=t.content;if(!Array.isArray(n))return null;let r=n.map(e=>{let t=M(e);return t?.type===`text`&&typeof t.text==`string`?t.text:null}).filter(e=>!!e);return r.length>0?r.join(`
...
//# sourceMappingURL=activity-page-DyvcD9W7.js.map