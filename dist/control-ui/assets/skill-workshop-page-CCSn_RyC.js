import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{b as t,y as n}from"./control-ui-foundation-OE0aAIzW.js";import{Bc as r,Da as i,Gc as a,Kc as o,Oa as s,Qn as c,Vc as l,Wc as u,Yc as d,_s as f,as as p,da as m,fs as ee,is as te,pa as ne,qc as h,rr as re,sa as ie,za as g}from"./control-ui-core-BUddgKjW.js";import{$ as _,C as ae,E as oe,K as v,O as se,Q as y,W as b,Y as x,ct as ce,it as S,w as le}from"./lit-runtime-D5xZwgO1.js";import{f as ue,i as de,m as fe,p as pe,r as me}from"./control-ui-foundation-Dgui328h.js";import{A as he,D as ge,_ as _e,ln as ve,rn as ye,v as be}from"./control-ui-core-Ct5CBwjl.js";import{At as xe,Dt as C,Et as w,wt as T}from"./control-ui-foundation-DkfOBVsU.js";import{o as E,t as D}from"./control-ui-core-s0pW0mau.js";import{I as Se,P as Ce,gt as O,pt as k,vt as A,yt as we}from"./control-ui-core-vLOElyFQ.js";import{n as Te,t as Ee}from"./hub-tabs-DByyIl3h.js";import{i as De,n as Oe,r as ke,t as Ae}from"./plugins-BWbHh7YV.js";import{countSkillWorkshopProposals as je,createSkillWorkshopState as Me,requestSkillWorkshopRevision as Ne,runSkillWorkshopEvaluation as Pe,runSkillWorkshopLifecycleAction as j,selectSkillWorkshopProposal as Fe,t as Ie}from"./proposals-BvnLr1hz.js";import{loadSkillWorkshopPageData as Le,n as Re,r as ze,runSkillWorkshopPageHistoryScan as Be,t as Ve}from"./history-scan-page-controller-j7jKreK9.js";function M(e,t,n){let r=n.trim().toLowerCase();return e.filter(e=>!(t!==`all`&&e.status!==t||r&&!`${e.name} ${e.oneLine} ${e.slug}`.toLowerCase().includes(r)))}var N=e((()=>{}));function He(e){return C(C(C(e.skills)?.workshop)?.autonomous)?.mode!==`off`}function Ue(e,t,n){let r=p(e?.state.configSnapshot);return r?{enabled:He(r),busy:t,error:n}:null}async function We(e,t){let n={raw:{skills:{workshop:{autonomous:{mode:t?`auto`:`off`}}}},note:t?`Enable Skill Workshop self-learning`:`Disable Skill Workshop self-learning`},r=await e.patch(n);if(!r&&e.state.lastError?.includes(P)){if(await e.refresh(),e.state.lastError)return e.state.lastError;r=await e.patch(n)}return r?(await e.refresh(),null):e.state.lastError??E(`skillWorkshop.selfLearning.updateError`)}function Ge(e,t){return e?x`
    <label
...
//# sourceMappingURL=skill-workshop-page-CCSn_RyC.js.map