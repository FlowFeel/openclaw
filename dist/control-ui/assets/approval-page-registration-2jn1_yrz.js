import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{b as t,y as n}from"./control-ui-foundation-OE0aAIzW.js";import{Kc as r,Wc as i}from"./control-ui-core-BUddgKjW.js";import{K as a,Q as o,W as s,Y as c,it as l,nt as u}from"./lit-runtime-D5xZwgO1.js";import{i as d,r as f}from"./control-ui-foundation-Dgui328h.js";import{Gt as p,Tt as m,_ as h,lt as g,qt as _,ut as v,v as y,wt as b}from"./control-ui-core-Ct5CBwjl.js";import{At as x,jt as S}from"./control-ui-foundation-DkfOBVsU.js";import{i as C,o as w,t as T}from"./control-ui-core-s0pW0mau.js";import{i as E,n as D,t as O}from"./approval-result-validators-B2fWxcKH.js";var k=e((()=>{}));function A(e){return e instanceof g?(S(e.details)?e.details.reason:void 0)===`APPROVAL_NOT_FOUND`||e.gatewayCode===`APPROVAL_NOT_FOUND`||e.gatewayCode===`INVALID_REQUEST`:!1}function j(e){return new Intl.DateTimeFormat(C.getLocale(),{dateStyle:`medium`,timeStyle:`short`}).format(new Date(e))}function M(e){switch(e){case`allow-once`:return w(`execApproval.allowOnce`);case`allow-always`:return w(`execApproval.alwaysAllow`);case`deny`:return w(`execApproval.deny`)}return e}function N(e,t){return e.applied?t===`deny`?e.approval.status===`denied`:e.approval.status===`allowed`&&e.approval.decision===t:!0}function P(e,t){return t?c`<div class="approval-page__meta-row">
        <dt>${e}</dt>
...
//# sourceMappingURL=approval-page-registration-2jn1_yrz.js.map