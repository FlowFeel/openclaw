import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{K as t,W as n,Y as r,Z as i,ct as a}from"./lit-runtime-D5xZwgO1.js";import{t as o}from"./web-awesome-tabs-Ct-trtla.js";function s(e){let n=n=>r`
    <button
      slot=${n?`nav`:t}
      class="tabstrip-new"
      type="button"
  ...
  `}var c,l,u,d=e((()=>{n(),o(),c=i`<svg viewBox="0 0 16 16" width="14" height="14" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"><path d="M4 4l8 8M12 4l-8 8" /></svg>`,l=i`<svg viewBox="0 0 16 16" width="13" height="13" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"><path d="M8 3v10M3 8h10" /></svg>`,u=a`
  .tabstrip {
    --track-width: 0;
    display: block;
...
//# sourceMappingURL=panel-tab-strip-TSZRTlvQ.js.map