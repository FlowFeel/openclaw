import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{Cs as t,Da as n,Ho as r,In as i,Ln as a,Oa as o,Rn as s,Ro as c,_s as l,fs as u,us as d}from"./control-ui-core-ChU36mQ7.js";import{C as f,K as p,W as m,Y as h,_ as g,b as _,w as v}from"./lit-runtime-D5xZwgO1.js";import{C as ee,Et as y,Rt as b,S as x,Wt as S,jt as C,rn as te,sn as ne,x as re}from"./control-ui-core-CmlLmVZa.js";import{o as w,t as T}from"./control-ui-core-M4uhXYSJ.js";import{at as E,ct as D,m as ie,ot as O,st as k,vt as A,yt as j}from"./control-ui-core-pXkCFtVv.js";import{i as ae,n as oe}from"./gateway-runtime-DWs8EJ0W.js";import{a as M,i as N,o as P}from"./app-sidebar-session-types-CqA-b62a.js";import{i as F,r as I,t as L}from"./app-sidebar-nav-menus-DnhST3x2.js";import{l as R,u as z}from"./session-pull-requests-C3lY3Ce7.js";import{f as B,u as V}from"./question-prompt-pK1Cf8QO.js";import{n as H,t as U}from"./open-external-url-CRt_G15-.js";import{i as W,n as G,r as K}from"./agent-select-VqHcVm5e.js";function q(){return/Mac|iPhone|iPad|iPod/u.test(globalThis.navigator?.platform??``)}function se(e){let{agents:t,activeId:n}=e,i=new Set(t.map(e=>l(e.id))),a=new Set(e.pinnedAgentIds.map(e=>l(e)).filter(e=>i.has(e))),o=t.toSorted((e,t)=>!a.has(l(e.id))-+!a.has(l(t.id)));if(t.length<=Y)return{rows:o,showFilter:!1};let s=e.filter.trim().toLowerCase();if(s)return{rows:o.filter(t=>{let n=l(t.id);return n.toLowerCase().includes(s)||(e.identities.get(n)?.name?.trim()||r(t)).toLowerCase().includes(s)}),showFilter:!0};if(a.size>0)return{rows:o.filter(e=>{let t=l(e.id);return a.has(t)||t===n}),showFilter:!0};let c=o.slice(0,Y);if(!c.some(e=>l(e.id)===n)){let e=o.find(e=>l(e.id)===n);e&&(c=[...c.slice(0,Y-1),e])}return{rows:c,showFilter:!0}}function ce(e,t){let n=l(e.id),i=t.identities.get(n)??null,a=i?.name?.trim()||r(e),o=n===t.activeId,s=o?0:t.agentUnreadCount(n),c=t.agentApprovalCount(n),u=w(c===1?`execApproval.agentPendingOne`:`execApproval.agentPending`,{count:String(c)}),d={value:n,label:a,agent:e};return h`
    <wa-dropdown-item
...
//# sourceMappingURL=sidebar-menus-render-CV0Qu_0z.js.map