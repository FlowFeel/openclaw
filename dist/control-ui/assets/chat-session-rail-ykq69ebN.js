import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{b as t,y as n}from"./control-ui-foundation-OE0aAIzW.js";import{$n as r,Jn as i,Kc as a,Wc as o,bt as s,er as c,rr as l,vt as u,yt as d}from"./control-ui-core-CrKLOOVi.js";import{K as f,Q as p,W as m,Y as h,_ as g,b as _,g as v,it as y,m as b,nt as x}from"./lit-runtime-D5xZwgO1.js";import{o as S,t as C}from"./control-ui-core-DkYXaYTI.js";import{gt as w,vt as T,yt as E}from"./control-ui-core-CTll8UdE.js";import{n as D,t as O}from"./markdown-CTmZm9Ts.js";import{Nn as k,Pn as A}from"./chat-message-LFk-poAG.js";function j(e){return e.digest?e.running?e.activeRunId&&e.digest.runId===e.activeRunId?e.digest:null:e.digest:null}function M(e,t){return(e.health===`done`||e.health===`failed`)&&(t??0)<e.updatedAt}function N(e){return S(`chat.rail.health.${e}`)}function P(e){return S(`chat.pullRequests.${e===`draft`?`draft`:e}`)}function F(e){let t=e.checks;return t?t.state===`passing`?S(`chat.rail.checksPassing`,{count:String(t.passed)}):t.state===`failing`?S(`chat.rail.checksFailing`,{count:String(t.failed)}):S(`chat.rail.checksPending`,{count:String(t.running)}):null}function I(e){let t=e.status===`completed`?`✓`:e.status===`in_progress`?`→`:`·`;return h`
...
//# sourceMappingURL=chat-session-rail-ykq69ebN.js.map