import { L as DiscordGuildEntry, P as DiscordAccountConfig, R as DiscordIntentsConfig, lt as ReplyToMode, n as OpenClawConfig } from "./types.openclaw-DlZm98yj.js";
import { d as RuntimeEnv$1 } from "./manifest-registry-5AqPUfeS.js";
import { D as ChannelIngressQueue, G as NativeCommandSpec } from "./types-CHzJhI3f.js";
import { Lt as HistoryEntry, Ut as InboundEventKind, W as ChannelRuntimeSurface } from "./setup-wizard-types-C6GPHZpk.js";
import { o as resolveAgentRoute } from "./pairing-messages-Bmb_MajG.js";
import { t as SessionBindingRecord } from "./session-binding.types-C-CoXBTs.js";
import { M as GatewayPresenceUpdate, P as ChannelType, _ as GatewayPresenceUpdateData, a as Command, b as GatewayVoiceStateUpdateData, d as Guild, f as User, h as DiscordCommandDeployHashStore, i as Plugin, j as APIGatewayBotInfo, k as APIMessage, n as MessageCreateListener, r as Client, t as DiscordMessageDispatchData, v as GatewayReceivePayload, x as APIVoiceState, y as GatewaySendPayload } from "./discord-B3FRtvAS.js";
import { f as ThreadBindingManager } from "./thread-bindings.manager-ES8NtHa0.js";
import { t as MediaPlaceholderTextFact } from "./channel-inbound-Ce-Lrw5d.js";
