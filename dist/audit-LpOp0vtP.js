import { a as normalizeLowercaseStringOrEmpty, c as normalizeOptionalString, s as normalizeOptionalLowercaseString, t as hasNonEmptyString } from "./string-coerce-DW4mBlAt.js";
...
import { a as inspectPathPermissions, i as formatPermissionRemediation, r as formatPermissionDetail } from "./permissions-CvYj0JYg.js";
import { c as resolveUserPath } from "./home-dir-Cs7bTrwJ.js";
import "./utils-Bs67j6-3.js";
import { C as resolveStateDir, d as resolveConfigPath } from "./paths-CL43LNS6.js";
import { t as formatCliCommand } from "./command-format-C5kg4XY_.js";
import { h as tryResolveDefaultAgentId, n as listAgentEntries, t as hasAgentRosterProperty, u as resolveAgentWorkspaceDir } from "./agent-scope-config-Dusa8eSA.js";
...
import { o as listRiskyConfiguredSafeBins } from "./exec-safe-bin-trust-DHudQEAW.js";
import "./audit-fs-8uj3r-Aa.js";
...
import { H as resolveExecModePolicy, K as loadExecApprovals } from "./exec-approvals-sCmCk_jQ.js";
import { l as isInterpreterLikeAllowlistPattern } from "./risks-DVvbIVRa.js";
import { t as DEFAULT_GATEWAY_HTTP_TOOL_DENY } from "./dangerous-tools-wzbtc-0z.js";
import { i as resolveMergedSafeBinProfileFixtures, n as listInterpreterLikeSafeBins } from "./exec-safe-bin-runtime-policy-DNHNJ1Ti.js";
import { t as resolveExecDefaults } from "./exec-defaults-gfkJ3dUQ.js";
import { r as materializeGatewayAuthSecretRefs, t as canMaterializeGatewayAuthSecretRefsWithoutExec } from "./auth-config-utils-BKlSF0Ow.js";
import { n as normalizeConfiguredTrustedSafeBinDirs, t as normalizeConfiguredSafeBins } from "./exec-safe-bin-config-DS5NzKX9.js";
import { o as readControlUiDeviceAuthMigrationState } from "./control-ui-device-auth-migration-BFMHIHyr.js";
import { t as resolveGatewayAuthTokenSourceConflict } from "./auth-token-source-conflict-BxNmm58g.js";
import { r as collectCoreInsecureOrDangerousFlags } from "./dangerous-config-flags-current-Bmu2mmnH.js";
import { t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-D7LZRfBc.js";
import { t as collectExecFilesystemPolicyDriftHits } from "./exec-filesystem-policy-BDiJEXWD.js";
...
const loadReadOnlyChannelPlugins = createLazyRuntimeModule(() => import("./read-only-3mffokCu.js"));
...
const loadPluginMetadataRegistryLoaderModule = createLazyRuntimeModule(() => import("./metadata-registry-loader-ilMeT3LI.js"));
const loadPluginAutoEnableModule = createLazyRuntimeModule(() => import("./plugin-auto-enable-BUGd6Bn4.js"));
const loadChannelPluginIdsModule = createLazyRuntimeModule(() => import("./channel-plugin-ids-CBmAmC0M.js"));
const loadPluginRuntimeModule = createLazyRuntimeModule(() => import("./runtime-BePs-mh1.js"));
const loadGatewayProbeDeps = createLazyRuntimeModule(() => Promise.all([
	import("./call-ujGvHIZc.js"),
	import("./probe-auth-ogRKK_kl.js"),
	import("./probe-DRuXaWv9.js")
...
function collectControlUiDeviceAuthMigrationFindings(params) {
	if (readControlUiDeviceAuthMigrationState({ env: {
		...params.env,
	...
	return [{
		...
		detail: "The retired device-auth bypass was imported into pending migration state. Device-less Control UI sessions with valid shared auth can still connect for remediation until an operator browser completes pairing.",
		remediation: "Reopen the Control UI over HTTPS or localhost and click Secure this browser to complete pairing and end the compatibility window."
	}];
}
...
async function createAuditExecutionContext(opts) {
	...
	const workspaceDir = opts.workspaceDir ?? (defaultAgentId ? resolveAgentWorkspaceDir(cfg, defaultAgentId) : configuredDefaultWorkspace ? resolveUserPath(configuredDefaultWorkspace, env) : resolveDefaultAgentWorkspaceDir(env));
...
async function runSecurityAudit(opts) {
	...
	findings.push(...collectControlUiDeviceAuthMigrationFindings({
		env,
		stateDir
	}));
