...
import { r as shouldAttemptTtsPayload } from "./tts-config-CmCjJpyF.js";
import { g as resolveSessionAgentId } from "./agent-scope-DyEposw2.js";
import { a as actionHasResourceReference, c as resolveActionDeliveryTargetAlias, l as hasPotentialPluginActionParam, o as actionHasTarget, r as applyTargetToParams, s as actionRequiresTarget } from "./channel-target-KnDtF-PX.js";
...
import { _ as readStringParam, h as readStringArrayParam, p as readPositiveIntegerParam, y as readSnakeCaseParamRaw } from "./common-yW0U9cHP.js";
...
import { C as normalizeOutboundLocation } from "./reply-payload-BE_j43tQ.js";
import { a as resolveSendableOutboundReplyParts } from "./reply-payload-parts-Djg03PGA.js";
import { d as normalizeLegacyInteractiveReply, f as normalizeMessagePresentation, n as hasLegacyInteractiveReplyBlocks, o as hasReplyPayloadContent, r as hasMessagePresentationBlocks, v as renderMessagePresentationFallbackText } from "./payload-BofbwVaq.js";
import { u as stripUnsupportedCitationControlMarkers } from "./payloads-6G4VluOK.js";
...
import { a as normalizeTargetForProvider } from "./target-normalization-DbGxFWuk.js";
import { n as getAgentScopedMediaLocalRoots } from "./local-roots-DY1lg2k6.js";
import { _ as readBooleanParam, a as isDeliveredCurrentSourceReplyAction, c as dispatchChannelMessageAction, d as collectActionMediaSourceHints, f as hydrateAttachmentParamsForAction, g as parseJsonMessageParam, h as parseInteractiveParam, i as isDeliveredCurrentSourceReply, l as prepareExternalMessageActionTargetForResolution, m as normalizeSandboxMediaParams, n as cancelTerminalSourceReplyDelivery, p as normalizeSandboxMediaList, r as isCurrentSourceReplyActionName, s as reconcileTerminalSourceReplyDelivery, t as beginTerminalSourceReplyDelivery, u as shouldDeferExternalMessageActionTargetResolution, v as resolveAttachmentMediaPolicy, y as resolveExtraActionMediaSourceParamKeys } from "./source-reply-mirror-C9PGpODM.js";
import { i as enforceMessageActionAllowlist, n as buildCrossContextDecoration, o as resolveEffectiveMessageToolsConfig, r as enforceCrossContextPolicy, s as shouldApplyCrossContextMarker, t as applyCrossContextDecoration } from "./outbound-policy-DuF3pLM0.js";
import { n as resolveAgentIdentity, o as resolveResponsePrefix } from "./identity-DxC7SNFJ.js";
import { d as throwIfAborted } from "./deliver-prepare-BY6KbNM2.js";
import { r as resolveOutboundChannelPlugin } from "./channel-resolution-DCE36-h8.js";
import { t as resolveAgentScopedOutboundMediaAccess } from "./read-capability-C9gKg3tL.js";
import { r as resolvePollMaxSelections } from "./polls-C-v11_tu.js";
import { n as listConfiguredMessageChannels, r as resolveMessageChannelSelection } from "./channel-selection-9UF9FMip.js";
import { n as sendPoll, r as resolveOutboundMessageGatewayOptions, t as sendMessage } from "./message-BLsSjs_0.js";
import { n as ensureOutboundSessionEntry, r as resolveOutboundSessionRoute } from "./outbound-session-BNtSdGwc.js";
...
async function handleBroadcastAction(input, params) {
	...
	const targetChannels = channelHint && normalizeOptionalLowercaseString(channelHint) !== "all" ? [await resolveChannel(input.cfg, { channel: channelHint }, input.toolContext)] : input.broadcastAccountPlan ? input.broadcastAccountPlan.candidateChannels : await (async () => {
...
async function handleSendAction(ctx) {
	...
	if (gatewayPluginAction) return markDeliveredCurrentSourceReply(withSendNormalization(gatewayPluginAction, sendPayload.normalization), {
		cfg,
		actionParams: params,
		channel,
		accountId,
	...
	return markDeliveredCurrentSourceReply(withSendNormalization({
		kind: "send",
		channel,
		action,
		to,
...
async function runMessageAction(input) {
	...
	const resolvedTarget = defersExternalTargetResolution ? void 0 : await resolveActionTarget({
		cfg,
		channel,
		action,
		args: params,
	...
	if (action === "send") return handleSendAction(context);
	if (action === "poll") return handlePollAction(context);
