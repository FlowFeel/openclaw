...
import { l as parseOpenAIQuicksilverEvent, n as boundOpenAIQuicksilverDelegationResult, o as chunkOpenAIQuicksilverAppendText, t as boundOpenAIQuicksilverContextItems } from "./realtime-quicksilver-wire-CV3PtOvs.js";
...
var OpenAIQuicksilverDelegationController = class {
	...
	launchDelegation(delegation) {
		...
		this.runDelegation(delegation, signal).catch((error) => this.fail(toError(error))).finally(() => {
