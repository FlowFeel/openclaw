...
import { a as resolveCliRuntimeOwnerFingerprint, i as resolveCliRuntimeArtifactFingerprint } from "./cli-auth-epoch-B8qvN1lA.js";
import { _ as isFailoverErrorMessage, i as classifyFailoverReason } from "./errors-Bujrccyt.js";
import { c as isFailoverError, d as isTimeoutError, p as resolveFailoverStatus, t as FailoverError, u as isSignalTimeoutReason } from "./failover-error-DBKQENP4.js";
import { n as appendExactAssistantMessageToSessionTranscript } from "./transcript-DPcNCFvI.js";
...
import { d as waitForDeferredTurnMaintenanceForSession, i as bootstrapHarnessContextEngine, l as runHarnessContextEngineMaintenance, n as runAgentEndSideEffects, s as finalizeHarnessContextEngineTurn, t as awaitAgentEndSideEffects } from "./agent-end-side-effects--ABMNPXa.js";
...
import { a as runAgentHarnessLlmInputHook, o as runAgentHarnessLlmOutputHook, s as buildAgentHookContext } from "./lifecycle-hook-helpers-B_MyvJob.js";
...
import { u as hashCliReseedPrompt } from "./cli-session-history.claude-Mbvb4UVx.js";
import { o as shouldUseClaudeLiveSession } from "./claude-live-session-CU8M79P4.js";
import { v as cliBackendLog, y as formatCliBackendOutputDigest } from "./helpers-Dc_1XotW.js";
import { n as getCliMessagingDeliveryEvidence, t as attachCliMessagingDeliveryEvidence } from "./delivery-evidence-Cmz7UHq4.js";
import { i as loadCliSessionHistoryMessages, l as claudeCliSessionTranscriptHasContent, r as loadCliSessionContextEngineMessages, s as buildAgentHookConversationMessages } from "./session-history-GeqGdQSG.js";
...
async function runCliAgentInternal(params, diagnosticLifecycle) {
	...
	if (params.cleanupCliLiveSessionOnRunEnd === true) try {
		const { closeClaudeLiveSessionForContext } = await import("./claude-live-session-DZl-SVk5.js");
		await closeClaudeLiveSessionForContext(context);
	} catch (error) {
		recordCleanupError(error);
	}
	if (params.cleanupBundleMcpOnRunEnd === true) try {
		const { retireSessionMcpRuntime } = await import("./agent-bundle-mcp-tools-CcV3eLnB.js");
