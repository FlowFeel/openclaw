...
import { s as repairCurrentTokenStorageMetaDeviceId } from "./storage-B0onFYxL.js";
//#region extensions/matrix/src/matrix/client/config.ts
const loadMatrixAuthClientDeps = createLazyRuntimeModule(() => Promise.all([import("./sdk-BXmmnD6w.js"), import("./logging-CyKmY_R0.js")]).then(([sdkModule, loggingModule]) => ({
