...
import { _ as readLoggingConfig, c as redactSensitiveText, n as getDefaultRedactPatterns } from "./redact-DUpJZuMu.js";
...
import { r as isCliRuntimeAlias } from "./model-runtime-aliases-D6C4F5xr.js";
import { r as externalCliDiscoveryForProviders } from "./external-cli-discovery-WL3vnn14.js";
import { t as isCliProvider } from "./model-selection-cli-CYqAnhSh.js";
import { o as getApiErrorPayloadFingerprint } from "./sanitize-user-facing-text-Ba4C3tZ5.js";
import { o as classifyProviderRuntimeFailureKind } from "./errors-B811vGBl.js";
import { n as isLikelyContextOverflowError } from "./context-overflow-DNey-WOn.js";
import { a as describeFailoverError, h as resolveModelFallbackError, l as isFatalProviderExhaustionError, n as buildFailoverRemediationHint, t as FailoverError, u as isNonProviderRuntimeCoordinationError, v as MissingAgentHarnessError, y as isAgentHarnessPreflightError } from "./failover-error-U3al4tnA.js";
import { c as isAgentRunDirectAbortReason, l as isAgentRunRestartAbortReason } from "./run-termination-7xcnysfe.js";
...
import { n as isCronTerminalAbortReasonText } from "./execution-errors-nWe2GBKd.js";
import { n as isOpenClawAbortableWrapper } from "./abortable-wb3haGdv.js";
import { t as isSandboxProvisioningError } from "./provisioning-error-BdOep9IC.js";
import { c as suspendSession, o as runWithDeferredSessionSuspension } from "./session-suspension-pn3EIaA1.js";
...
async function runFallbackCandidate(params) {
	try {
		...
		if (fallbackError.kind === "coordination" || isFatalProviderExhaustionError(err, params.provider) || fallbackError.kind === "failover" && isFatalProviderExhaustionError(fallbackError.error, params.provider) || isTerminalAbort(params.abortSignal) || isCallerAbortSignal(params.abortSignal) || isAgentRunDirectAbortReason(err) || isAgentRunRestartAbortReason(err) || isTerminalAbortFromError(err)) throw err;
		return {
			ok: false,
