...
import { n as matrixSetupAdapter } from "./setup-core-CXp10w32.js";
import { t as withResolvedActionClient } from "./client-BJUBZ8e_.js";
import { r as resolveMatrixAuthContext } from "./config-CjddSpCO.js";
...
async function addMatrixAccount(params) {
	...
	if (accountConfig.encryption === true) {
		const { maybeBootstrapNewEncryptedMatrixAccount } = await import("./setup-bootstrap-DvZ_nlWH.js");
...
const loadMatrixActionClientModule = createLazyRuntimeModule(() => import("./client-CX_j5tFr.js"));
