...
import "./session-binding-runtime-CfB_YBgu.js";
import { a as resolveMatrixAccountConfig } from "./account-config-OygLNK0j.js";
import { a as extractMatrixReactionAnnotation } from "./reaction-common-BWj4zGM5.js";
import { i as resolveMatrixApprovalReactionTargetWithPersistence, o as unregisterMatrixApprovalReactionTargetsForApproval } from "./approval-reactions-B17hvNbE.js";
import { i as resolveMatrixThreadRouting, r as resolveMatrixThreadRootId, t as resolveMatrixInboundRoute } from "./route-DBWuEria.js";
//#region extensions/matrix/src/matrix/monitor/reaction-events.ts
const loadApprovalReactionAuth = createLazyRuntimeModule(() => import("./approval-reaction-auth-3UD_9YhE.js"));
const loadExecApprovalResolver = createLazyRuntimeModule(() => import("./exec-approval-resolver-X3EBvMjn.js"));
const loadMatrixSend = createLazyRuntimeModule(() => import("./send-D1giSPpV.js"));
