...
import { o as isErrno } from "./errors-Cg_yT1Sv.js";
import { n as resolveCliName } from "./cli-name-CVj-3DWf.js";
import { t as note } from "./note-uiKX_qfX.js";
import { a as installCompletion, c as resolveCompletionCachePath, d as resolveShellFromEnv, f as usesSlowDynamicCompletion, i as formatCompletionReloadCommand, l as resolveCompletionProfileHint, n as COMPLETION_SKIP_PLUGIN_COMMANDS_ENV, o as isCompletionInstalled, r as completionCacheExists, u as resolveCompletionProfilePath } from "./completion-runtime-ciaYhinV.js";
...
async function installCompletionForDoctor(shell, cliName, action) {
	try {
		...
		note(`Shell completion ${action}. Restart your shell or run: ${formatCompletionReloadCommand(shell, resolveCompletionProfileHint(shell))}`, "Shell completion");
	} catch (err) {
