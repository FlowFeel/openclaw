...
import { i as emitAgentEvent, u as onAgentEvent } from "./agent-events-COCf-9-O.js";
import { d as retainGatewayRootWorkAdmissionContinuation } from "./gateway-work-admission-D_DdbtmL.js";
import { F as toOpenAiChatCompletionsUsage } from "./session-accessor.sqlite-B9iW7DOt.js";
import { n as estimateBase64DecodedBytes } from "./base64-KcXAb-1x.js";
import "./stream-message-shared-Cyrn1UHN.js";
import { r as isClientToolNameConflictError } from "./agent-tool-definition-adapter-7Nq7adCY.js";
import { a as extractImageContentFromSource, n as DEFAULT_INPUT_IMAGE_MIMES, o as normalizeMimeList, r as DEFAULT_INPUT_TIMEOUT_MS, t as DEFAULT_INPUT_IMAGE_MAX_BYTES } from "./input-files-DbN9ZpGg.js";
import { r as agentCommandFromIngress } from "./agent-command-Dr-CXQcL.js";
import { t as createDefaultDeps } from "./deps-DjEsu1aS.js";
import "./agent-CW_7-Ej5.js";
import { m as resolveOpenAiCompatibleHttpSenderIsOwner, p as resolveOpenAiCompatibleHttpOperatorScopes, r as authorizeOpenAiCompatibleHttpModelOverride } from "./http-auth-utils-DxGFDYKW.js";
import { h as writeDone, l as sendMissingScopeForbidden, m as watchClientDisconnect, p as setSseHeaders, s as sendJson } from "./http-common-BAY0nK4S.js";
import { c as resolveOpenAiCompatModelOverride, i as isUnknownGatewayAgentError, r as isGatewaySessionKeyOverrideError, s as resolveGatewayRequestContext } from "./http-utils-DttOh8gu.js";
import { t as handleGatewayPostJsonEndpoint } from "./http-endpoint-helpers-B0BsjcZH.js";
import { a as validateOpenAiSamplingParams, c as IMAGE_ONLY_USER_MESSAGE, d as resolveAssistantStreamDeltaText, f as resolveAssistantStreamSnapshotText, i as resolveOpenAiCompatError, l as buildAgentMessageFromConversationEntries, n as resolveUnsatisfiedToolChoiceMessage, o as resolveAgentRunUsage, r as toolChoiceConstraintPrompt, s as normalizeInputHostnameAllowlist, t as isToolChoiceConstraintSatisfied, u as isReplaceableAssistantStreamEvent } from "./openai-tool-choice-DDXgVbZh.js";
...
async function handleOpenAiHttpRequest(req, res, opts) {
	...
	try {
		...
		sendJson(res, 400, { error: {
			message: formatErrorMessage(err).trim(),
