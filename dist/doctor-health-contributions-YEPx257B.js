...
import { i as createDoctorHealthContribution, n as runCoreHealthFindingNote, r as runStructuredHealthRepairs, t as runCoreContributionHealth } from "./doctor-health-contribution-core-BASpt6lx.js";
...
async function runStartupChannelMaintenanceHealth(ctx) {
	const { maybeRunDoctorStartupChannelMaintenance } = await import("./doctor-startup-channel-maintenance-CYz0D0WM.js");
...
const loadDoctorStateIntegrityModule$1 = async () => await import("./doctor-state-integrity-B3lmgA0J.js");
async function runActiveToolSchemaWarningsHealth(ctx) {
	if (!ctx.prompter.shouldRepair) return;
	const { collectActiveToolSchemaProjectionWarnings } = await import("./active-tool-schema-warnings-QUZJGoRv.js");
...
async function runWorkspaceStatusHealth(ctx) {
	...
	const { noteWorkspaceStatus } = await import("./doctor-workspace-status-6XY8Dzjn.js");
...
async function runHeartbeatCadenceMigrationHealth(ctx) {
	const { maybeMigrateHeartbeatCadenceToCron } = await import("./doctor-heartbeat-cadence-migration-CvsV_uSx.js");
...
async function runHeartbeatScratchMigrationHealth(ctx) {
	const { maybeMigrateHeartbeatFilesToScratch } = await import("./doctor-heartbeat-scratch-migration-RhalvWga.js");
...
async function runHeartbeatTaskMigrationHealth(ctx) {
	const { maybeMigrateHeartbeatTasksToCron } = await import("./doctor-heartbeat-task-migration--xqzCp6P.js");
	...
	return [
		...
		createDoctorHealthContribution({
			...
			healthChecks: [{
				...
				defaultEnabled: false,
				async detect(ctx) {
					const { collectChannelPreviewWarningHealthFindings } = await import("./doctor-startup-channel-maintenance-CYz0D0WM.js");
		...
		createDoctorHealthContribution({
			...
			healthChecks: {
				...
				defaultEnabled: false,
				async detect(ctx) {
					const { collectWorkspaceStatusHealthFindings } = await import("./doctor-workspace-status-6XY8Dzjn.js");
					const pluginVersionDrift = await collectWorkspaceStatusPluginVersionDrift({
						cfg: ctx.cfg,
						options: {
							nonInteractive: true,
		...
		createDoctorHealthContribution({
			...
			healthChecks: {
				...
				defaultEnabled: true,
				async detect(ctx) {
					const { collectHeartbeatCadenceMigrationFindings } = await import("./doctor-heartbeat-cadence-migration-CvsV_uSx.js");
		...
		createDoctorHealthContribution({
			...
			healthChecks: {
				...
				defaultEnabled: true,
				async detect(ctx) {
					const { collectHeartbeatScratchMigrationFindings } = await import("./doctor-heartbeat-scratch-migration-RhalvWga.js");
		...
		createDoctorHealthContribution({
			...
			healthChecks: {
				...
				defaultEnabled: true,
				async detect(ctx) {
					const { collectHeartbeatTaskMigrationFindings } = await import("./doctor-heartbeat-task-migration--xqzCp6P.js");
...
const loadDoctorStateIntegrityModule = async () => await import("./doctor-state-integrity-B3lmgA0J.js");
...
async function runReleaseConfiguredPluginInstallsHealth(ctx) {
	...
	const { maybeRunConfiguredPluginInstallReleaseStep } = await import("./release-configured-plugin-installs-Br1TUHfs.js");
	const { note } = await import("./terminal-core/note.js");
...
async function runTelegramGeneralTopicConversationHealth(ctx) {
	const { runCoreContributionHealth } = await import("./doctor-health-contribution-core-DUPgxplH.js");
	...
	return [
		...
		createDoctorHealthContribution({
			...
			healthChecks: {
				...
				defaultEnabled: false,
				async detect(ctx) {
					const { detectConfiguredPluginInstallHealthIssues, configuredPluginInstallIssueToHealthFinding } = await import("./missing-configured-plugin-install-CjxW1A4z.js");
				...
				repair: legacyOwnedRepair(async (ctx) => {
					const { detectConfiguredPluginInstallHealthIssues, configuredPluginInstallIssueToRepairEffect } = await import("./missing-configured-plugin-install-CjxW1A4z.js");
					return (await detectConfiguredPluginInstallHealthIssues({
						cfg: ctx.cfg,
						env: process.env
		...
		createDoctorHealthContribution({
			...
			healthChecks: {
				...
				defaultEnabled: false,
				async detect(ctx) {
					const { detectStateIntegrityHealthIssues, stateIntegrityIssueToHealthFinding } = await import("./doctor-state-integrity-B3lmgA0J.js");
				...
				repair: legacyOwnedRepair(async (ctx) => {
					const { detectStateIntegrityHealthIssues, stateIntegrityIssueToRepairEffect } = await import("./doctor-state-integrity-B3lmgA0J.js");
					return detectStateIntegrityHealthIssues(ctx.cfg, {
						configPath: ctx.configPath,
						env: process.env
...
const loadDoctorCoreChecksModule = async () => await import("./doctor-core-checks-CPMzx7E8.js");
...
async function resolveDoctorContributionHealthChecks() {
	const { createCoreHealthChecks } = await import("./doctor-core-checks-CPMzx7E8.js");
