...
import { _ as basenameFromMediaSource } from "./path-D8zNGPJM.js";
...
import { l as hasPotentialPluginActionParam } from "./channel-target-KnDtF-PX.js";
...
import { o as resolveSandboxedMediaSource, t as assertMediaNotDataUrl } from "./sandbox-paths-Cwxd9MU0.js";
...
import { o as resolveChannelPluginRegistration, t as getChannelPlugin } from "./registry-DOSZ6AfI.js";
import "./plugins-DYLnGbXq.js";
import { i as hasActiveRestartRecoverySourceClaim, o as hasRestartRecoveryTerminalRun } from "./session-entry-slot-keys-DPRQmSpa.js";
...
import { _ as readStringParam, b as resolveSnakeCaseParamKey, h as readStringArrayParam } from "./common-yW0U9cHP.js";
import "./store-QVlUiM0_.js";
import { r as resolveChannelThreadAddressing } from "./thread-addressing-BBzvuxPZ.js";
...
import { o as resolveChannelMessageToolMediaSourceParamKeys } from "./message-action-discovery-BLGLSVzQ.js";
import { l as createBoundedOutboundMediaReadFile, n as loadWebMedia } from "./web-media-DG7t3WQ-.js";
import { t as resolveChannelAccountMediaMaxMb } from "./configured-max-bytes-BA_x-zfE.js";
...
import { t as resolveOutboundAttachmentFromBuffer } from "./outbound-attachment-DuTNMGSI.js";
...
const BUNDLED_PROVIDER_READ_GATE_ACTIONS = /* @__PURE__ */ new Map([["mattermost", /* @__PURE__ */ new Set(["read"])], ["telegram", /* @__PURE__ */ new Set([
	"react",
	"edit",
	"delete"
])]]);
...
function resolveMessageActionReadEnforcement(params) {
	if (params.pluginOrigin === "bundled" && (BUNDLED_CHANNELS_WITH_PROVIDER_READ_GATES.has(params.channel) || BUNDLED_PROVIDER_READ_GATE_ACTIONS.get(params.channel)?.has(params.action) === true)) return { kind: "provider-owned" };
	return {
...
//#endregion
export { readBooleanParam as _, isDeliveredCurrentSourceReplyAction as a, dispatchChannelMessageAction as c, collectActionMediaSourceHints as d, hydrateAttachmentParamsForAction as f, parseJsonMessageParam as g, parseInteractiveParam as h, isDeliveredCurrentSourceReply as i, prepareExternalMessageActionTargetForResolution as l, normalizeSandboxMediaParams as m, cancelTerminalSourceReplyDelivery as n, mirrorDeliveredSourceReplyToTranscript as o, normalizeSandboxMediaList as p, isCurrentSourceReplyActionName as r, reconcileTerminalSourceReplyDelivery as s, beginTerminalSourceReplyDelivery as t, shouldDeferExternalMessageActionTargetResolution as u, resolveAttachmentMediaPolicy as v, resolveExtraActionMediaSourceParamKeys as y };
