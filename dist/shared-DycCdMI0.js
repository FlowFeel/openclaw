...
import { n as resolveMatrixAuth, r as resolveMatrixAuthContext } from "./config-C_Eu4qJs.js";
...
const loadMatrixCreateClientDeps = createLazyRuntimeModule(() => import("./create-client-u1LE1IDz.js").then((runtime) => ({ createMatrixClient: runtime.createMatrixClient })));
