...
import { f as parseThreadSessionSuffix } from "./session-key-utils-02xWdGSz.js";
import { n as normalizeAccountId, t as DEFAULT_ACCOUNT_ID } from "./account-id-CIVg1QNG.js";
import { _ as readStringParam, i as createActionGate, p as readPositiveIntegerParam, t as ToolAuthorizationError } from "./common-yW0U9cHP.js";
import { n as sanitizeAssistantVisibleText } from "./assistant-visible-text-DONkuTGN.js";
import { l as createScopedDmSecurityResolver, t as adaptScopedAccountAccessor } from "./channel-config-helpers-BwgkzH7b.js";
...
import { i as createChatChannelPlugin, n as buildThreadAwareOutboundSessionRoute, t as buildChannelOutboundSessionRoute } from "./core-QIH5yboB.js";
import { n as resolveApprovalRequestSessionConversation } from "./exec-approval-session-target-eqDsn2qP.js";
import { r as createChannelNativeOriginTargetResolver } from "./approval-native-helpers-BKBXZ2E2.js";
import { a as splitChannelApprovalCapability, i as createChannelApprovalCapability, n as createApproverRestrictedNativeApprovalCapability } from "./approval-delivery-helpers-BykUTGU5.js";
...
import { c as collectStatusIssuesFromLastError, d as createDefaultChannelRuntimeState, i as buildProbeChannelStatusSummary, u as createComputedAccountStatusAdapter } from "./status-helpers-CSowaqvB.js";
...
import { E as createAllowlistProviderOpenWarningCollector, N as projectAccountConfigWarningCollector, d as resolveScopeRequireMention, f as resolveScopeToolsPolicy } from "./channel-policy-BgbKncah.js";
import { i as createResolvedDirectoryEntriesLister } from "./directory-config-helpers-DAQqtnAv.js";
...
import { n as requiresExplicitMatrixDefaultAccount } from "./account-selection-GIBMiG30.js";
import { a as resolveMatrixAccountConfig } from "./account-config-OygLNK0j.js";
import { i as resolveMatrixAccount, r as resolveDefaultMatrixAccountId, t as listMatrixAccountIds } from "./accounts-CqEd0FYU.js";
import { n as normalizeMatrixUserId } from "./allowlist-DYcR_rvX.js";
import { t as normalizeMatrixApproverId } from "./approval-ids-CQb2nSpw.js";
import { a as isMatrixExecApprovalAuthorizedSender, c as shouldHandleMatrixApprovalRequest, d as matrixApprovalAuth, i as isMatrixApprovalClientEnabled, l as shouldSuppressLocalMatrixExecApprovalPrompt, n as getMatrixExecApprovalApprovers, o as isMatrixExecApprovalClientEnabled, r as isMatrixAnyApprovalClientEnabled, s as resolveMatrixExecApprovalTarget, t as getMatrixApprovalApprovers, u as getMatrixApprovalAuthApprovers } from "./exec-approvals-10YLY7bH.js";
import { a as resolveMatrixTargetIdentity, i as resolveMatrixDirectUserId, n as normalizeMatrixMessagingTarget, r as normalizeMatrixResolvableTarget, t as isMatrixQualifiedUserId } from "./target-ids-CFN4hb1k.js";
import { t as matrixPluginBase } from "./channel.setup-DZsePS7d.js";
import { n as normalizeCompatibilityConfig, t as legacyConfigRules } from "./doctor-contract-T6Tac2Df.js";
import { r as resolveMatrixRoomScopePath, t as buildMatrixRoomScopeTree } from "./rooms-8ZEH_tYS.js";
import { d as setMatrixThreadBindingIdleTimeoutBySessionKey, p as setMatrixThreadBindingMaxAgeBySessionKey } from "./thread-bindings-shared-CXo3zvhw.js";
import { n as collectRuntimeConfigAssignments, r as secretTargetRegistryEntries } from "./secret-contract-C6X8sFR7.js";
import { t as resolveMatrixStoredSessionMeta } from "./session-store-metadata-BfhXxlfR.js";
import { n as resolveMatrixInboundConversation, t as defaultTopLevelPlacement } from "./thread-binding-api-CYG_4Vyx.js";
...
const matrixNativeApprovalCapability = createApproverRestrictedNativeApprovalCapability({
	...
	nativeRuntime: createLazyChannelApprovalNativeRuntimeAdapter({
		...
		load: async () => (await import("./approval-handler.runtime-B1BL37d9.js")).matrixApprovalNativeRuntime
	})
});
...
const loadMatrixChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-Blv93Zqs.js"), "matrixChannelRuntime");
const loadMatrixDoctorModule = createLazyRuntimeModule(() => import("./doctor-DYQ7hJ4m.js"));
...
const matrixPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			...
			try {
				monitorMatrixProvider = (await import("./monitor-CZjrRG0d.js")).monitorMatrixProvider;
			} finally {
				releaseLock();
			}
