...
import { n as ensureCodexRuntimePluginForModelSelection, t as CODEX_RUNTIME_PLUGIN_ID } from "./codex-runtime-plugin-install-DSfuVhlQ.js";
...
import { t as ensureCopilotRuntimePluginForModelSelection } from "./copilot-runtime-plugin-install-CbJWz21I.js";
...
async function applyNonInteractivePluginProviderChoice(params) {
	...
	if (!providerChoice) {
		...
		const { ensureOnboardingPluginInstalled } = await import("./onboarding-plugin-install-Bd70vv1l.js");
