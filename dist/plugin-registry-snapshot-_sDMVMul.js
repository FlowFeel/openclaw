import { f as safeRealpathSync, i as isPathInside } from "./path-D8zNGPJM.js";
import { d as listBundledSourceOverlayDirs, p as buildLegacyBundledRootPath } from "./discovery-B47lmslh.js";
import { f as resolveDefaultAgentId, u as resolveAgentWorkspaceDir } from "./agent-scope-config-Dusa8eSA.js";
import { a as getPackageManifestMetadata } from "./manifest-BUOsMMgJ.js";
...
import { _ as safeHashFile, c as hasOptionalMissingPluginManifestFile, g as safeFileSignature, i as loadInstalledPluginIndexWithDiscovery, n as isInstalledPluginEnabled, p as resolveInstalledPluginIndexPolicyHash, t as getInstalledPluginRecord, u as resolvePluginDoctorContractArtifactPath } from "./installed-plugin-index-CqNI0grC.js";
import { c as normalizePluginsConfig } from "./config-state-B6-Feb6H.js";
import { a as refreshPersistedInstalledPluginIndex, d as hasMissingConfigPathActivationMetadata, i as readPersistedInstalledPluginIndexSync, t as inspectPersistedInstalledPluginIndex } from "./installed-plugin-index-store-wgyw6sCS.js";
import { t as loadPluginManifestRegistryForInstalledIndex } from "./manifest-registry-installed-IiDreJJT.js";
...
function refreshPluginRegistry(params) {
	const workspaceDir = params.workspaceDir ?? (params.config ? resolveAgentWorkspaceDir(params.config, resolveDefaultAgentId(params.config), params.env) : void 0);
	return refreshPersistedInstalledPluginIndex(workspaceDir === void 0 ? params : {
		...params,
		workspaceDir
	});
}
//#endregion
export { loadPluginRegistrySnapshotWithMetadata as a, loadPluginRegistrySnapshot as i, inspectPluginRegistry as n, refreshPluginRegistry as o, isPluginEnabled as r, createPluginRegistryIdNormalizer as s, getPluginRecord as t };
