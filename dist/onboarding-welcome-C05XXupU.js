...
import { t as formatSystemAgentOnboardingWelcome } from "./overview-8mY9XHbo.js";
...
async function buildOnboardingWelcome(params) {
	...
	const localSetup = params.localRecovery === true && overview.config.exists && overview.config.valid && authoredConfig !== void 0 && authoredConfig?.gateway?.mode !== "remote" ? (await import("./local-onboarding-state-BDRTwv4h.js")).readLocalOnboardingStateForConfig(overview.config.path, authoredConfig) : void 0;
