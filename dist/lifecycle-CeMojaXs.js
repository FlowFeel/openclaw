...
import { D as readSqliteTranscriptStatsSync, S as loadSqliteTranscriptHeaderSync } from "./session-accessor.sqlite-transcript-store-Si6-bv-m.js";
import { E as isTerminalSessionStatus } from "./session-entry-slot-keys-DR5d2mKt.js";
...
function readSessionHeaderStartedAtMs(params) {
	...
	try {
		const header = loadSqliteTranscriptHeaderSync({
			agentId,
			sessionId,
