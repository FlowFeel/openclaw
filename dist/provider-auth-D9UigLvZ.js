...
import "./external-cli-sync-CELhQFMz.js";
import { f as loadAuthProfileStoreForSecretsRuntime, i as ensureAuthProfileStore, p as loadAuthProfileStoreWithoutExternalProfiles, s as findPersistedAuthProfileCredential } from "./store-C8MGqOG3.js";
...
import "./models-config.providers.secrets-hHIfdhcD.js";
...
import "./repair-B9E8U86g.js";
import { r as resolveStoredCredentialReadOnlyAvailability } from "./read-only-availability-BhjnXuO8.js";
import { b as resolveProviderEntryApiKeyProfileReference, l as profileTypeToAuthMode, m as resolveDirectProviderCredentialMode, v as resolveProviderConfig, x as resolveUsableCustomProviderApiKey } from "./model-auth-provider-config-CaDHRX5w.js";
import { n as resolveManagedSecretRefRuntimeProviderAuth } from "./model-auth-runtime-config-C8rk-Iv8.js";
import "./provider-auth-helpers-CuJGpUMn.js";
import "./provider-auth-input-DNzGlXUB.js";
import "./provider-api-key-auth-4oVEsed6.js";
import "./provider-auth-result-BAaK9_2_.js";
...
async function resolveCopilotTokenCache(params) {
	...
	const { createCorePluginStateSyncKeyedStore } = await import("./plugin-state-store-Dtyw0KNC.js");
