...
import { S as requireActivePluginRegistry, w as resolveDirectPluginRegistrationOwner } from "./runtime-yJAYArQt.js";
...
function buildSynchronousMemoryPromptSection(params) {
	const registry = requireActivePluginRegistry();
	return {
		primary: normalizeMemoryPromptLines(resolveMemoryCapabilityRegistration(registry.memoryCapabilities)?.capability.promptBuilder?.(params) ?? []),
