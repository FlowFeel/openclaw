...
import { i as resolveOsHomeDir, t as expandHomePrefix } from "./home-dir-Cs7bTrwJ.js";
import { d as resolveConfigDir, h as shortenHomePath } from "./utils-Bs67j6-3.js";
...
import { Dt as hydrateSessionStoreSkillPromptRefs } from "./session-entry-slot-keys-DPRQmSpa.js";
import { t as resolveBundledSkillsDir } from "./bundled-dir-BfHNzP7v.js";
import { t as note } from "./note-uiKX_qfX.js";
import { i as updateLegacySessionStore } from "./state-migrations.legacy-session-store-Ca_XBZjo.js";
...
function resolveExpectedBundledSkillPath(params) {
	...
	const expandedCachedPath = osHomeDir ? expandHomePrefix(params.cachedPath, { home: osHomeDir }) : params.cachedPath;
...
async function noteSessionSnapshotHealth(params) {
	...
	if (params?.shouldRepair) {
		...
		for (const [storePath, findings] of findingsByStore) try {
			const repairResult = await updateLegacySessionStore(storePath, async (store) => {
