...
import { _ as attachOpenClawTranscriptMeta } from "./session-transcript-readers-O8pyQfzE.js";
import { r as normalizeCliSessionReseedReceipt, t as getCliSessionBinding } from "./cli-session-binding-F7hyyN-U.js";
...
function readClaudeCliSessionMessages(params) {
	...
	return coalesceClaudeCliToolMessages(messages).map((message) => redactTranscriptMessage(message));
}
