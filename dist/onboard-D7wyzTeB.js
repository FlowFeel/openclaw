...
import { Q as ConfigMutationConflictError, l as readConfigFileSnapshot } from "./io-BsQc3Kgy.js";
...
import { n as resolveConfiguredSecretInputWithFallback } from "./resolve-configured-secret-input-string-DJX-j6lE.js";
import { t as resolveGatewayAuthToken } from "./auth-token-resolution-BHduu4FR.js";
import { t as randomToken } from "./random-token-B1woZa_H.js";
import { r as formatInvalidPortOption } from "./error-format-BZ5G9eas.js";
import { r as resolveLocalControlUiProbeLinks } from "./control-ui-links-Ci1IGfKN.js";
import { r as resolveManifestProviderAuthChoices } from "./provider-auth-choices-_vLe6VPC.js";
import { g as waitForGatewayReachable, l as normalizeGatewayTokenInput, n as applyWizardMetadata, s as handleReset, t as DEFAULT_WORKSPACE } from "./onboard-helpers-CEgpoKqW.js";
...
import { i as resolveProviderMatch } from "./provider-auth-choice-helpers-CMYuemdL.js";
import { n as resolveProviderInstallCatalogEntries } from "./provider-install-catalog-B69Hv4PV.js";
import { o as normalizeTokenProviderInput } from "./provider-auth-input-BZW5CuzH.js";
import { r as logConfigUpdated } from "./logging-ClQ5051I.js";
import { r as formatAuthChoiceChoicesForCli } from "./auth-choice-options-CAS1RRFE.js";
import { i as resolveDeprecatedAuthChoiceReplacement, n as isDeprecatedAuthChoice, r as normalizeLegacyOnboardAuthChoice, t as formatDeprecatedNonInteractiveAuthChoiceError } from "./auth-choice-legacy-CVNMK8Hu.js";
import { t as resolvePluginProviders } from "./provider-auth-choice.runtime-jG-DhFcA.js";
import { c as parseNonInteractiveCustomApiFlags, d as resolveCustomProviderId, n as applyCustomApiConfig, t as CustomApiError } from "./onboard-custom-config-DG8Khpop.js";
import { n as validateGatewayWebSocketUrl } from "./onboard-remote-BVc1SCCK.js";
...
import { t as runGuidedOnboarding } from "./onboard-guided-XylD8H0I.js";
...
import { n as runInteractiveSetup } from "./onboard-interactive-G39suguC.js";
import { t as inferAuthChoiceFromFlags } from "./auth-choice-inference-CSo6MG9l.js";
import { n as resolveNonInteractiveApiKey, t as createNonInteractiveLoggingPrompter } from "./non-interactive-prompter-DTAo2C3L.js";
...
async function commitNonInteractiveOnboardConfig(params) {
	const { writeWizardConfigFile } = await import("./setup.shared-B1YQd8f0.js");
...
async function runNonInteractiveLocalSetup(params) {
	...
	const inferredAuthChoice = opts.authChoice ? void 0 : (await import("./auth-choice-inference-BhMuDFHm.js")).inferAuthChoiceFromFlags(opts, {
		config: nextConfig,
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-CerK_IYU.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-z0Qhgkb2.js");
	...
	if (!opts.skipHealth) {
		const { healthCommand } = await import("./health-HDtUQc0M.js");
...
async function runNonInteractiveMigrationImport(params) {
	...
	const { detectSetupMigrationSources, runSetupMigrationImport } = await import("./setup.migration-import-DDwIQqmc.js");
