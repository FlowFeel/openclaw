...
const loadMainSessionRestartRecoveryModule = createLazyRuntimeModule(() => import("./main-session-restart-recovery-BFXPLv6x.js"));
const loadMainSessionRestartRecoveryMarkingModule = createLazyRuntimeModule(() => import("./main-session-restart-recovery-marking-vkKqeB06.js"));
...
const loadGatewayRestartSentinelModule = createLazyRuntimeModule(() => import("./server-restart-sentinel-pGr1gj-D.js"));
...
const defaultGatewayPostAttachRuntimeDeps = {
	...
	scheduleGatewayUpdateCheck: async (...args) => (await import("./update-startup-BQ0dTYya.js")).scheduleGatewayUpdateCheck(...args),
...
async function startGatewayPostAttachRuntime(params, runtimeDeps = defaultGatewayPostAttachRuntimeDeps) {
	...
	const sidecarsPromise = params.minimalTestGateway ? Promise.resolve({
		...
		try {
			const { scheduleSubagentRegistrySweep } = await import("./subagent-registry-XK4iQvAp.js");
