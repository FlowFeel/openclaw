...
import { _ as pathExists, o as walkDirectory, r as root } from "./fs-safe-DVaClkIX.js";
import { r as readLocalFileSafely } from "./root-impl-DYBxk3hn.js";
import { h as getNodeSqliteKysely, m as executeSqliteQueryTakeFirstSync } from "./node-sqlite-B_0DgpUE.js";
import { h as runOpenClawStateWriteTransaction } from "./openclaw-state-db-D9eH245j.js";
import { a as sha256Hex } from "./crypto-digest-CmUwt1S-.js";
import { n as ok, t as err } from "./result-BQGgYouL.js";
import { A as SKILL_WORKSHOP_ROLLBACK_SCHEMA, B as stripProposalFrontmatterForSkill, C as databaseOptions, E as assertSkillProposalEvaluationWithinLimit, F as normalizeSkillProposalCorrelationId, G as isWorkspaceSkillMutationApplied, H as MAX_WORKSPACE_SKILL_SUPPORT_FILE_BYTES, I as runSkillProposalEvaluators, J as prepareWorkspaceSkillMutation, K as isWorkspaceSkillMutationRestored, L as hashSkillProposalRevision, M as createSkillProposalEvent, N as dispatchSkillProposalChanged, P as hasSkillProposalEvaluators, R as readProposalFrontmatter, S as updateProposal, T as assertProposalId, U as applyWorkspaceSkillMutation, V as hashSkillProposalContent, W as assertInsideWorkspace, X as readWorkspaceSupportFile, Y as readWorkspaceSkillFile, Z as restoreWorkspaceSkillMutation, _ as clearSkillProposalRollback, a as readSkillProposal, b as parseSkillProposalRow, c as replaceSkillProposalDraft, d as writeSkillProposal, f as withSkillProposalTargetLock, g as listStoredSkillProposalEvents, h as appendSkillProposalEvent, i as readProposalSupportFiles, j as SKILL_WORKSHOP_SCHEMA, l as resolveSkillProposalTarget, m as readCommittedSkillProposalTransition, nt as normalizeSkillIndexName, o as readSkillProposalManifest, p as commitPendingSkillProposalTransition, q as normalizeWorkspaceSkillSupportPath, r as prepareSkillProposalSupportFiles, s as readSkillProposalRecord, t as createSkillProposalId, u as updateSkillProposalRecord, w as ensureSkillWorkshopSchema, x as readStoredProposal, y as writeSkillProposalRollback, z as renderProposalMarkdown } from "./store-wPr8539E.js";
import { i as bumpSkillsSnapshotVersion, n as resolveAllowedSkillSymlinkTargetRealPaths } from "./symlink-targets-BsIBLVmY.js";
import { t as resolveSkillWorkshopConfig } from "./config-DFolTFBo.js";
import { b as hasCommittedSkillChangeHooks, x as snapshotCommittedSkillArtifactBestEffort, y as dispatchCommittedSkillChangeBestEffort } from "./clawhub-CxehPxLh.js";
import { n as resolveSkillStatusEntry, t as buildWorkspaceSkillStatus } from "./status-CsptEi4i.js";
import { a as scanSource, i as scanSkillContent } from "./scanner-XYZIWI3P.js";
...
async function applySkillProposalTransition(input, dependencies) {
	...
	const result = await withSkillProposalLifecycleDispatch(input, withSkillProposalTargetLock(evaluated.record, async () => {
...
async function listSkillProposals(options = {}) {
	return await readSkillProposalManifest(storeOptions$1(options.env), {
...
async function inspectSkillProposal(proposalId, options = {}) {
	const read = await readSkillProposal(proposalId, storeOptions$1(options.env), options);
	if (!read) return null;
...
async function resolvePendingSkillProposal(input) {
	...
	if (proposalId) {
		const direct = await readRequiredProposal(proposalId, input.workspaceDir, input.env, input.agentId);
	...
	const matched = await readRequiredProposal(expectDefined(matches[0], "matches capture group 0").id, input.workspaceDir, input.env, input.agentId);
...
//#endregion
export { quarantineSkillProposal as a, evaluateSkillProposal as c, inspectSkillProposal as d, listSkillProposals as f, readSkillProposalDraftFile as h, proposeUpdateSkill as i, listSkillProposalEvents as l, readSkillProposalDraftDirectory as m, listWritableWorkspaceSkillSummaries as n, rejectSkillProposal as o, resolvePendingSkillProposal as p, proposeCreateSkill as r, reviseSkillProposal as s, applySkillProposal as t, getSkillProposalRunProgress as u };
