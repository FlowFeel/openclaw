...
import { n as discoverOpenClawPlugins } from "./discovery-BwgYKZ4p.js";
...
import { c as normalizePluginsConfig, l as resolveEffectiveEnableState, u as resolveEffectivePluginActivationState } from "./config-state-DrPZVhOu.js";
...
const PLUGIN_COMPAT_RECORDS = [
	...
	MEDIA_LEGACY_PROJECTION_COMPAT_RECORD,
	{
		...
		replacement: "declare `ContextEngineInfo.acceptedHostParams`; full host params after the window",
	...
	},
	{
		...
		removeAfter: "2026-08-30",
		replacement: "plugin-owned config schemas plus generic `openclaw/plugin-sdk/channel-config-schema` and `openclaw/plugin-sdk/setup-runtime` primitives",
		docsPath: "/plugins/sdk-migration#published-channel-setup-compatibility",
		surfaces: [
...
//#endregion
export { safeHashFile as _, refreshInstalledPluginIndex as a, hasOptionalMissingPluginManifestFile as c, extractPluginInstallRecordsFromInstalledPluginIndex as d, resolveCompatRegistryVersion as f, safeFileSignature as g, hashJson as h, loadInstalledPluginIndexWithDiscovery as i, describePluginInstallSource as l, getPluginCompatRecord as m, isInstalledPluginEnabled as n, INSTALLED_PLUGIN_INDEX_WARNING as o, resolveInstalledPluginIndexPolicyHash as p, loadInstalledPluginIndex as r, collectPluginManifestCompatCodes as s, getInstalledPluginRecord as t, resolvePluginDoctorContractArtifactPath as u };
