...
import { a as resolveCliBackendLiveSessionRequirement, i as resolveCliBackendConfig } from "./cli-backends-CmZ252m-.js";
import { t as areRuntimeModelRefsEquivalent } from "./model-runtime-aliases-D6C4F5xr.js";
import { t as loadAgentRuntimePluginRegistryHandle } from "./runtime-plugins-Dh4gVGup.js";
import { u as normalizeAuthProfileCredential } from "./profiles-C4bFcrKC.js";
...
import { a as resolveSystemAgentVerifiedInferenceRoute, n as createSystemAgentVerifiedInferenceBinding, r as hasCurrentSystemAgentOwnerPluginArtifacts, t as captureSystemAgentOwnerPluginArtifacts } from "./verified-inference-Dm9ykO8f.js";
import { t as CliExecutionAuthProfileError } from "./cli-execution-auth-CLKLKoCi.js";
import { a as sameDefaultInferenceRoute, n as projectInferenceRoute, r as resolveSystemAgentConfiguredRouteFromConfig, t as projectDefaultInferenceRoute } from "./inference-route-fxRKzhD7.js";
...
import { i as createSystemAgentModelSelectionUpdater, r as createQuickstartNotePrompter, t as applySystemAgentModelSelection } from "./setup-apply-BUwSvEvk.js";
import { a as describeFailoverError } from "./failover-error-U3al4tnA.js";
import { a as runProviderPluginAuthMethodUnpersisted, n as applyProviderPluginAuthMethodResultConfig } from "./provider-auth-choice-D9YWugmJ.js";
...
async function reloadCodexRegistryAfterActivation(params) {
	...
	try {
		(params.deps.ensurePluginRegistryLoaded ?? (await import("./runtime-registry-loader-C1VY-cVP.js")).ensurePluginRegistryLoaded)({
			scope: "all",
...
async function runSetupInferenceTest(params) {
	...
	try {
		...
		let result;
		if (plan.runner === "cli") result = await (deps.runCliAgent ?? (await import("./cli-runner-CUWjD261.js")).runCliAgent)({
			sessionId,
			sessionKey,
			sessionManager,
		...
		else result = await (deps.runEmbeddedAgent ?? (await import("./embedded-agent-A4lbfjQj.js")).runEmbeddedAgent)({
			sessionId,
			sessionKey,
			sessionManager,
			agentId: effectiveAgentId,
...
async function persistActivatedSetupInference(input) {
	...
	const { stripPendingPluginInstallRecords } = await import("./install-record-commit-B54Qq6Ut.js");
	...
	const transformConfig = deps.transformConfigWithPendingPluginInstalls ?? (await import("./install-record-commit-B54Qq6Ut.js")).transformConfigWithPendingPluginInstalls;
...
async function activateSetupInferenceUnredacted(params, codexCliApiKey) {
	...
	try {
		...
		if (params.kind === "codex-cli") {
			...
			const ensured = await (deps.ensureCodexRuntimePlugin ?? (await import("./codex-runtime-plugin-install-CPdSqNVS.js")).ensureCodexRuntimePluginForModelSelection)({
