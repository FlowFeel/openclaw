...
import { r as registerNativeHookRelay } from "./native-hook-relay-C_lKX44y.js";
import { D as shouldAutoApproveCodexAppServerApprovals, I as resolveOpenClawExecPolicyForCodexAppServer, P as readCodexPluginConfig, j as resolveCodexModelBackedReviewerPolicyContext, k as canUseCodexModelBackedApprovalsReviewerForModel, v as sessionBindingIdentity, x as resolveCodexAppServerHomeScope } from "./session-binding-Dl6kaOMx.js";
import { K as isCodexAppServerApprovalRequest, Y as isCodexAppServerIndeterminateRequestCancellationError, _ as withLeasedCodexAppServerClientStartSelectionRetry, at as isJsonObject, j as resolveCodexAppServerPreparedAuthHandoff, s as getLeasedSharedCodexAppServerClient, u as releaseCodexAppServerClientLease, w as readRecentCodexRateLimits, x as ensureCodexAppServerClientRuntime } from "./shared-client-D2F1gOgp.js";
import { _ as readCodexNotificationTurnId, d as unsubscribeCodexThreadBestEffort, g as readCodexNotificationThreadId, s as isCodexAlreadyTerminalInterruptError, u as retireUnsafeCodexTurnClientBestEffort } from "./thread-resume-BTrJDDVj.js";
import { l as readCodexTurn, o as assertCodexTurnStartResponse, r as assertCodexThreadForkResponse, s as readCodexDynamicToolCallParams } from "./protocol-validators-Cf6MSlge.js";
import { B as buildCodexPluginAppsConfigPatchFromPolicyContext, C as readCodexSupportedReasoningEfforts, S as resolveReasoningEffort, W as mergeCodexThreadConfigs, _ as CODEX_NATIVE_PERSONALITY_NONE, f as buildCodexRuntimeThreadConfig, h as resolveCodexWebSearchPlan, k as resolveCodexDynamicToolsLoading, v as resolveCodexAppServerModelProvider, w as filterCodexDynamicTools, x as resolveCodexBindingModelProviderFallback, y as resolveCodexAppServerRequestModelSelection } from "./thread-lifecycle-nCTQ_rzK.js";
import { n as formatCodexUsageLimitErrorMessage } from "./rate-limits-1zYSqsJz.js";
import { t as resolveCodexAppServerForModelProvider } from "./app-server-policy-DdLJ7th4.js";
import { n as resolveCodexNativeExecutionBlock } from "./sandbox-guard-gphn8P0A.js";
import { n as resolveCodexBindingAppServerConnection, t as requireCodexSupervisionModelSelection } from "./binding-connection-BByEwxSI.js";
import { C as filterToolsForVisionInputs, E as CODEX_NATIVE_HOOK_RELAY_EVENTS, F as handleDynamicToolCallWithTimeout, G as resolveCodexToolAbortTerminalReason, O as buildCodexNativeHookRelayConfig, T as CodexNativeToolLifecycleProjector, a as emitDynamicToolStartedDiagnostic, b as shouldEnableCodexAppServerNativeToolSurface, c as resolveCodexProviderWebSearchSupportForClient, i as emitDynamicToolErrorDiagnostic, j as emitCodexNativePreToolUseFailureDiagnostic, k as buildCodexNativeHookRelayDisabledConfig, n as handleCodexAppServerApprovalRequest, o as emitDynamicToolTerminalDiagnostic, r as handleCodexAppServerElicitationRequest, t as createCodexDynamicToolBridge, v as resolveCodexMessageToolProvider, z as resolveDynamicToolCallTimeoutMs } from "./dynamic-tools-18OTvbt5.js";
...
async function cleanupCodexSideThread(client, params) {
	...
	if (params.interrupt && params.turnId !== void 0) try {
