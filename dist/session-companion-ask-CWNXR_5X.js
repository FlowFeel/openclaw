...
import { i as resolveSimpleCompletionSelectionForAgent } from "./simple-completion-runtime-DHa5sPdN.js";
...
async function defaultRun(params) {
	...
	const { prepareInternalSessionEffectsSession, removeInternalSessionEffectsSession } = await import("./internal-session-effects-B5cRsydp.js");
	...
	try {
		const [{ SessionManager }, { runEmbeddedAgent }] = await Promise.all([import("./sessions-q028bxXp.js"), import("./embedded-agent-CZpATf5T.js")]);
