...
import { Q as ConfigMutationConflictError, b as createConfigIO, d as readConfigFileSnapshotForWrite, r as getRuntimeConfig } from "./io-BsQc3Kgy.js";
...
import { o as resolvePluginContributionOwners } from "./plugin-registry-contributions-B0602V_s.js";
import "./plugin-registry-6MbhJA7X.js";
import "./mutate-dYcqgG_5.js";
import "./config-BBVHtcXg.js";
import { a as isNonFatalSystemdInstallProbeError } from "./systemd-CE12Te8p.js";
import { n as gatewayInstallErrorHint, t as buildGatewayInstallPlan } from "./daemon-install-helpers-CMXjlDpv.js";
import { n as GATEWAY_DAEMON_RUNTIME_OPTIONS, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-CHOL1Kuf.js";
import { t as resolveGatewayInstallToken } from "./gateway-install-token-BPMUlezN.js";
import { a as findTailscaleBinary } from "./tailscale-xOVRir9b.js";
import { t as randomToken } from "./random-token-B1woZa_H.js";
import { a as resolveGatewayService, t as describeGatewayServiceRestart } from "./service-CbbYL0ZH.js";
import { o as formatPortRangeHint } from "./error-format-BZ5G9eas.js";
import { t as parsePort } from "./parse-port-BAdnLGe2.js";
import { r as resolveLocalControlUiProbeLinks, t as resolveAdvertisedControlUiLinks } from "./control-ui-links-Ci1IGfKN.js";
import { t as formatWindowsGatewayFirewallGuidance } from "./windows-gateway-firewall-diagnostics-iMdCiFmV.js";
...
import { f as probeGatewayReachable, g as waitForGatewayReachable, h as validateGatewayPasswordInput, l as normalizeGatewayTokenInput, n as applyWizardMetadata, o as guardCancel, p as summarizeExistingConfig, t as DEFAULT_WORKSPACE } from "./onboard-helpers-CEgpoKqW.js";
...
import { t as commitConfigWithPendingPluginInstalls } from "./install-record-commit-BuloUnQI.js";
...
import { i as applyAuthChoice } from "./auth-choice-Chfb6I7-.js";
import { t as resolvePreferredProviderForAuthChoice } from "./provider-auth-choice-preference-BIrP25iY.js";
...
import { n as mergeWizardConfigOntoLatest } from "./setup.shared-CenLq3Go.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-BavbnZyZ.js";
import { n as loadStaticManifestCatalogRowsForList } from "./list.manifest-catalog-CiMY1ZqF.js";
import { i as promptModelAllowlist, n as applyModelFallbacksFromSelection, r as promptDefaultModel, t as applyModelAllowlist } from "./model-picker-DO4EKFt4.js";
import { t as promptCustomApiConfig } from "./onboard-custom-CqglrKhD.js";
import { a as validateDottedDecimalIPv4Input, i as maybeAddTailnetOriginToControlUiAllowedOrigins, n as TAILSCALE_EXPOSURE_OPTIONS, r as TAILSCALE_MISSING_BIN_NOTE_LINES, t as TAILSCALE_DOCS_LINES } from "./gateway-config-prompts.shared-C2LPAQH7.js";
import { r as formatHealthCheckFailure } from "./health-format-Zuwkge8R.js";
import { a as healthCommand } from "./health-BsOpUrCw.js";
import { t as promptRemoteGatewayConfig } from "./onboard-remote-BVc1SCCK.js";
import { t as setupSkills } from "./onboard-skills-Bhl77Dko.js";
...
const setupPluginConfigModuleLoader = createLazyImportLoader(() => import("./setup.plugin-config-p9pdlrGc.js"));
...
async function promptWebToolsConfig(nextConfig, runtime, prompter) {
	...
	const { isCodexNativeWebSearchRelevant } = await import("./codex-native-web-search-BQs3-Bef.js");
	...
	if (enableSearch) {
		...
		if (configureManagedProvider) {
			const { resolveSearchProviderOptions, runSearchSetupFlow } = await import("./search-setup-D9t5LPIq.js");
