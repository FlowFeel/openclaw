...
import { a as getPositiveIntFlagValue, c as hasFlag, i as getFlagValue, r as getCommandPositionalsWithRootOptions, s as getVerboseFlag } from "./argv-D6QuZiS5.js";
import { i as isValueToken } from "./cli-root-options-tXk2lfs9.js";
...
import { i as cliCommandCatalog, r as matchesCommandPath, t as resolveCliCommandPathPolicy } from "./command-path-policy-w8xXX0Qu.js";
import { i as parseStrictPositiveIntOrUndefined } from "./helpers-CXUPqDHh.js";
import { n as ensureCliExecutionBootstrap, r as resolveCliExecutionStartupContext, t as applyCliExecutionStartupPresentation } from "./command-execution-startup-BaGGRLe0.js";
...
function parseGatewayHealthRouteArgs(argv) {
	...
	if (timeout.value !== void 0 && parseStrictPositiveIntOrUndefined(timeout.value) === void 0) return null;
...
const configCliLoader = createLazyImportLoader(() => import("./config-cli-C1W93SAu.js"));
const agentsListCommandLoader = createLazyImportLoader(() => import("./agents.commands.list-C1IE_oxx.js"));
const modelsListCommandLoader = createLazyImportLoader(() => import("./list.list-command-BTUE2dcm.js"));
const modelsStatusCommandLoader = createLazyImportLoader(() => import("./list.status-command-D7XW1m3k.js"));
const tasksJsonCommandLoader = createLazyImportLoader(() => import("./tasks-json-Bakpz-7l.js"));
...
const routedCommandDefinitions = {
	...
	status: defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			if (args.json) {
				const { statusJsonCommand } = await import("./status-json-B8upryOj.js");
			...
			const { statusCommand } = await import("./status-BdGSQ5Pb.js");
	...
	"gateway-status": defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { runDaemonStatus } = await import("./status-q2FzCzLF.js");
	...
	"gateway-health": defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { runGatewayHealthJsonRoute } = await import("./health-route-W2k5LIok.js");
	...
	sessions: defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { sessionsCommand } = await import("./sessions-Bm2PwfnX.js");
	...
	"channels-list": defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { channelsListCommand } = await import("./list-K9UtkNt5.js");
	...
	"channels-status": defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { channelsStatusCommand } = await import("./status-DAr9zHKa.js");
