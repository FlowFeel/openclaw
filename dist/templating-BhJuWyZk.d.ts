...
import { S as ReplyToMode, h as DmScope } from "./types.base-BYV-OxM1.js";
...
import { b as SessionCreatedVia, c as SessionEntry, h as SessionRestartRecoveryState, i as InternalSessionEntry, v as SourceReplyDeliveryMode, y as SessionCreatedActor } from "./types-CJ2AFyfH.js";
import { l as MediaUnderstandingDecision, u as MediaUnderstandingOutput } from "./types-DUpcSR87.js";
import { n as MediaFact, r as MediaFactInput } from "./media-facts-D4qFhaJ1.js";
import { n as CommandArgs } from "./commands-args.types-zglMcgeO.js";
import { t as HistoryEntry } from "./history.types-abIvF_Ce.js";
...
type UserTurnInput = {
  text?: string | null;
  media?: readonly PersistedUserTurnMediaInput[] | null; /** Restart-safe native image placement; model-visible prompt bytes remain separate. */
  mediaImageLayout?: {
    slots: readonly {
...
//#endregion
export { PromptImageOrderEntry as A, isExplicitCommandTurn as C, PluginHookChannelChatContext as D, InputProvenance as E, PluginHookChannelContext as O, isAuthorizedTextSlashCommandTurn as S, isTextSlashCommandTurn as T, UserTurnInput as _, InboundSourceModality as a, CommandTurnKind as b, RuntimeMsgContext as c, UntrustedStructuredContextEntry as d, BlockReplyContext as f, TurnAdoptionLifecycle as g, TaskSuggestionDeliveryMode as h, FinalizedRuntimeMsgContext as i, InboundEventKind as j, PluginHookChannelSenderContext as k, SessionTranscriptContext as l, PartialReplyPayload as m, ChannelStructuredContextEntry as n, MentionSource as o, GetReplyOptions as p, FinalizedMsgContext as r, MsgContext as s, CanonicalInboundText as t, SupplementalContextFacts as u, UserTurnTranscriptRecorder as v, isNativeCommandTurn as w, createCommandTurnContext as x, CommandTurnContext as y };