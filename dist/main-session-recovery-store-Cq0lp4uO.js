...
import { i as transitionMainSessionRecovery, n as isMainSessionRecoveryPending, t as isMainRestartRecoveryCandidate } from "./main-session-recovery-state-BKrDbsUq.js";
import { a as scheduleMainSessionRecoveryMutation, i as retryMainSessionRecoveryMutation } from "./main-session-recovery-lifecycle-C6Ne5vip.js";
...
function scheduleMainSessionRecoveryOwnerRelease(lease) {
	scheduleMainSessionRecoveryMutation({
		mutation: () => releaseMainSessionRecoveryOwnerWithRetries(lease),
		onSuccess: async (pending) => {
			if (pending) {
				const { scheduleMainSessionRecoveryPendingTarget } = await import("./main-session-recovery-owner-release-ud8mDy36.js");
