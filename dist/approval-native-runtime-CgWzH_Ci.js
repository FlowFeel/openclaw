...
import { i as isApprovalMethod } from "./method-scopes-ChuOr7sh.js";
...
import { t as createOperatorApprovalsGatewayClient } from "./operator-approvals-client-BwcOuw9C.js";
...
function createChannelNativeApprovalRuntime(adapter) {
	...
	const routeReporter = (gatewayRuntime?.routeCoordinator.createReporter ?? createApprovalNativeRouteReporter)({
		...
		requestGateway: async (method, params) => {
			...
			const { callGatewayLeastPrivilege } = await import("./call-DctZOBCQ.js");
