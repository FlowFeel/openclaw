...
function reportSocketWatchError(directory, error) {
	log.warn(`linux canvas socket watcher unavailable for ${directory}; continuing with availability polling: ${String(error)}`);
}
