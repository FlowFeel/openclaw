...
async function runRemoteGatewayInferenceOnboarding(target, runtime = defaultRuntime, deps = {}) {
	...
	const runGuidedOnboarding = deps.runGuidedOnboarding ?? (await import("./onboard-guided-DUZJv8d5.js")).runGuidedOnboarding;
	...
	await runGuidedOnboarding({}, runtime, {
		...
		runSystemAgentChat: async () => {
			...
			await (deps.runTui ?? (await import("./tui-BTZu2HoQ.js")).runTui)({
				config: boundConfig,
				deliver: false,
