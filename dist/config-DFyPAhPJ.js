...
import { s as repairCurrentTokenStorageMetaDeviceId } from "./storage-CeoUNQh7.js";
//#region extensions/matrix/src/matrix/client/config.ts
const loadMatrixAuthClientDeps = createLazyRuntimeModule(() => Promise.all([import("./sdk-CPgZSX20.js"), import("./logging-CavCZ_SK.js")]).then(([sdkModule, loggingModule]) => ({
