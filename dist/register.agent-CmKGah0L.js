...
const loadAgentsBindModule = createLazyRuntimeModule(() => import("./agents.commands.bind-B3VJ756T.js"));
async function loadAgentsAddCommand() {
	return (await import("./agents.commands.add-frAEJuYl.js")).agentsAddCommand;
}
...
async function loadAgentsDeleteCommand() {
	return (await import("./agents.commands.delete-L4WbbYxn.js")).agentsDeleteCommand;
}
async function loadAgentsSetIdentityCommand() {
	return (await import("./agents.commands.identity-BrHmzQqx.js")).agentsSetIdentityCommand;
}
async function loadAgentsListCommand() {
	return (await import("./agents.commands.list-f-QzHDur.js")).agentsListCommand;
}
async function loadAgentsActionRuntime() {
	const [{ defaultRuntime }, { runCommandWithRuntime }] = await Promise.all([import("./runtime-BpncsYKr.js"), import("./cli-utils-V6IH9hI4.js")]);
	return {
		defaultRuntime,
