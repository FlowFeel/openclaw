import { A as buildAgentRunTerminalReplySnapshot, M as normalizeAgentRunTerminalReplySnapshot } from "./openclaw-state-db-BU55lNCH.js";
...
import { n as buildAgentRunTerminalOutcome } from "./agent-run-terminal-outcome-9kJP3Yn1.js";
...
function buildTerminal(params) {
	...
	const metadata = {};
	metadata.terminalReply = normalizeAgentRunTerminalReplySnapshot(meta.terminalReply) ?? buildAgentRunTerminalReplySnapshot({
