...
import { a as hasAvailableAuthForProvider, c as createRuntimeProviderAuthLookup, l as hasRuntimeAvailableProviderAuth } from "./model-auth-D32HIbZ7.js";
...
async function buildCurrentProviderAuthStateSnapshot(cfg, options = {}) {
	...
	for (const agentId of listAgentIds(cfg)) {
		...
		const { loadPreparedModelCatalogOwnerSnapshot } = await import("./prepared-model-catalog-ClbAcHfK.js");
