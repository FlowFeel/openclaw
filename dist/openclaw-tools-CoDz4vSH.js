...
import { R as isEmbeddedMode, U as listChannelSupportedActions, V as listAllChannelSupportedActions, u as wrapToolWithBeforeToolCallHook } from "./agent-tools.before-tool-call-Cp_0kD4x.js";
...
import { C as listFreshTasksForOwnerKey, E as listTaskRecordsUnsorted, k as listTasksForOwnerKey } from "./task-registry-C6MCtVnT.js";
...
import { t as cancelDetachedTaskRunById } from "./task-executor-_l80YOGk.js";
import { d as registerGeneratedMediaTaskActivity, u as clearGeneratedMediaTaskActivity } from "./task-status-access-D8bnycbU.js";
import { c as recordTaskRunProgressByRunId, i as failTaskRunByRunId, r as createRunningTaskRun, t as completeTaskRunByRunId } from "./detached-task-runtime-DMrgTp9S.js";
...
import { t as buildTaskStatusSnapshotForRelatedSessionKeyForOwner } from "./task-owner-access-BAXOqENW.js";
...
import { o as getInProcessGatewayRequestContext, r as dispatchGatewayMethodInProcess, u as hasInProcessGatewayContext } from "./server-plugins-Dw5hvH9r.js";
...
import { n as SWARM_CODE_MODE_REQUEST_FINGERPRINT, r as createAgentsWaitTool, t as SWARM_CODE_MODE_IDEMPOTENCY_KEY } from "./swarm-code-mode-lkpG_0y7.js";
...
import { n as listRuntimeImageGenerationProviders, r as resolveImageGenerationMaxInputImages, t as generateImage } from "./runtime-CSSpWEKP.js";
...
import { t as removeCronRunContinuationSessionIfIdle } from "./cron-run-continuation-cleanup-I5xoxh5I.js";
...
import { t as runWithImageModelFallback } from "./model-fallback-image-OCjAkido.js";
...
import { o as listControlledSubagentRuns, s as resolveSubagentController, t as MAX_RECENT_MINUTES } from "./subagent-control-ClBtvPAs.js";
...
import { a as resolveVideoGenerationModeCapabilities, i as resolveVideoGenerationMode, n as listRuntimeVideoGenerationProviders, r as listSupportedVideoGenerationModes, t as generateVideo } from "./runtime-BJucWGh-.js";
...
const defaultAgentStepDeps = {
	agentCommandFromIngress: (async (...args) => {
		const { agentCommandFromIngress } = await import("./agent-DUpnKpuj.js");
...
const acpSpawnModuleLoader = createLazyImportLoader(() => import("./acp-spawn-9COzSdHI.js"));
	...
	const tools = [
		...
		createSessionsYieldTool({
			...
			onBeforeYield: requesterSessionKey && requesterTurnRunId ? async () => {
				const { markRequesterTurnYielded } = await import("./subagent-registry-CYpnAYTA.js");
