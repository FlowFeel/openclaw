...
import { d as redactToolPayloadTextWithConfig, o as redactSensitiveFieldValueWithConfig, r as isSensitiveFieldKey } from "./redact-DUpJZuMu.js";
import { t as getGlobalHookRunner } from "./hook-runner-global-CRNklGqK.js";
import { St as publishSqliteTranscriptUpdate } from "./session-accessor.sqlite-B9iW7DOt.js";
...
import { bt as takeRuntimeUserTurnTranscriptContext, xt as takeRuntimeUserTurnTranscriptRecorder, yt as attachRuntimeUserTurnTranscriptRecorder } from "./sessions-Cj7BqXHP.js";
...
import { a as countRawToolCallBlocks, c as hasToolCallId, d as isRawToolCallBlock, f as isReplaySafeThinkingAssistantTurn, h as sanitizeToolCallBlock, i as assistantHasToolCalls, l as hasToolCallInput, m as normalizeLegacyToolResultId, n as repairToolUseResultPairing, o as hasPartialJson, p as makeMissingToolResult, r as RAW_TOOL_CALL_BLOCK_TYPES, s as hasSessionsSpawnAttachmentToolCall, u as isFinalizedOpenAIResponsesToolCall } from "./repair-h5r9ZjXr.js";
...
import { i as applyInputProvenanceToUserMessage } from "./input-provenance-CYGbY89H.js";
import { l as restorePreparedUserTurnOperationalMetaForRuntime, o as mergePreparedUserTurnMessageForRuntime } from "./user-turn-transcript-Cd8sokau.js";
import { i as setRawSessionAppendMessage, r as getRawSessionAppendMessage } from "./transcript-runtime-state-DyDUrArH.js";
import { i as resolveLiveToolResultMaxChars, t as DEFAULT_MAX_LIVE_TOOL_RESULT_CHARS } from "./tool-result-limits-DjIhjsDF.js";
import { d as truncateToolResultMessage, t as projectAgentHarnessTranscriptMessageForDisplay, x as formatContextLimitTruncationNotice } from "./transcript-visibility-DWT7LD0k.js";
//#region src/agents/session-transcript-repair/sanitize.ts
...
function installSessionToolResultGuard(sessionManager, opts) {
	...
	const appendMessageAndCacheTranscriptSeq = (message, options) => {
		...
		if (!sessionTarget) return { entryId };
		return {
			entryId,
			sessionTarget,
	...
	*/
	...
	const guardedAppend = (message, callerOptions) => {
		...
		const { entryId: result, messageSeq, sessionTarget } = appendMessageAndCacheTranscriptSeq(finalMessage, { invalidateSerializedPrefixCache: callerInvalidatesCache || transformedMessage !== nextMessage || finalWrite.changed });
		if (sessionTarget) publishSqliteTranscriptUpdate(sessionTarget, {
...
//#endregion
export { sanitizeToolCallInputs as n, sanitizeToolUseResultPairing as r, guardSessionManager as t };
