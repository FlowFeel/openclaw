...
import { N as normalizeExecutableToken, d as resolveShellWrapperTransportArgv, l as isShellWrapperExecutable, t as POSIX_PARSEABLE_SHELL_WRAPPERS } from "./shell-wrapper-resolution-4V1pkTCa.js";
import { t as callGatewayTool } from "./gateway-B5H4NIb8.js";
import { n as DEFAULT_APPROVAL_TIMEOUT_MS, t as DEFAULT_APPROVAL_REQUEST_TIMEOUT_MS } from "./bash-tools.exec-runtime-BOxSsjY5.js";
...
*/
const POSIX_COMMAND_HIGHLIGHT_SHELLS = POSIX_PARSEABLE_SHELL_WRAPPERS;
...
async function resolveRegisteredExecApprovalDecision(params) {
	...
	try {
		...
		if (isApprovalNotFoundError(err)) return null;
		throw err;
	}
}
