...
import { E as resolveConfigIncludes, w as readConfigIncludeFileWithGuards } from "./redact-BGqyyKN9.js";
...
import { C as resolveStateDir, _ as resolveIncludeRoots, d as resolveConfigPath, g as resolveGatewayPort } from "./paths-CL43LNS6.js";
import { t as createAbortError } from "./abort-signal-DEbc_zqk.js";
import { n as VERSION } from "./version-CeFj_iGk.js";
import { c as resolvePreauthHandshakeTimeoutMs, l as resolveSafeTimeoutDelayMs } from "./timeouts-Dbj-IGQf.js";
import { f as isLoopbackIpAddress } from "./ip-DorYMgxW.js";
import { t as applyConfigEnvVars } from "./config-env-vars-Dh6msnxE.js";
...
import { n as isGatewaySecretRefUnavailableError } from "./credentials-BmHaFDWQ.js";
...
import { n as loadDeviceAuthToken } from "./device-auth-store-CjxJ6zbn.js";
import { r as loadOrCreateDeviceIdentity } from "./device-identity-BOrXxcUy.js";
import { t as loadGatewayTlsRuntime } from "./gateway-DquHjBUP.js";
...
import { r as isGatewayConnectAssemblyError } from "./client-qrqst037.js";
...
import { a as isGatewayMethodClassified, s as resolveLeastPrivilegeOperatorScopesForMethod, t as CLI_DEFAULT_OPERATOR_SCOPES } from "./method-scopes-BPNMlnDQ.js";
...
async function readGatewayDispatchConfigWithShellEnvFallback(options = {}) {
	...
	const { loadShellEnvFallback, resolveShellEnvFallbackTimeoutMs, shouldDeferShellEnvFallback, shouldEnableShellEnvFallback } = await import("./shell-env-DtnVbC-V.js");
...
//#endregion
export { readGatewayDispatchConfigWithShellEnvFallback as S, isGatewayTransportError as _, GatewayTransportError as a, testing as b, callGateway as c, ensureExplicitGatewayAuth as d, formatGatewayAuthErrorJson as f, isGatewayExplicitAuthRequiredError as g, isGatewayCredentialsRequiredError as h, GatewayStoredDeviceAuthUnavailableError as i, callGatewayCli as l, formatGatewayTransportErrorJson as m, GatewayExplicitAuthRequiredError as n, buildGatewayConnectionDetails as o, formatGatewayClientRequestErrorJson as p, GatewayLocalBackendSharedAuthUnavailableError as r, buildGatewayProbeConnectionDetails as s, GatewayCredentialsRequiredError as t, callGatewayLeastPrivilege as u, randomIdempotencyKey as v, readGatewayDispatchConfig as x, resolveExplicitGatewayAuth as y };
