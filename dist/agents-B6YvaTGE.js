...
import { d as movePathToTrash, r as root } from "./fs-safe-DVaClkIX.js";
import { c as resolveUserPath } from "./home-dir-Cs7bTrwJ.js";
import "./utils-Bs67j6-3.js";
import { c as resolveAgentDir, f as resolveDefaultAgentId, i as listAgentIds, u as resolveAgentWorkspaceDir } from "./agent-scope-config-Dusa8eSA.js";
import { n as normalizeAgentId } from "./agent-id-DDgUze4y.js";
import { r as LEGACY_IMPLICIT_AGENT_ID } from "./session-key-DtTE9-Tg.js";
import "./path-guards-C3glTcy2.js";
import { a as unregisterResolvedAgentDir, i as resolveRegisteredAgentIdForDir, n as normalizeAgentDirRegistryPath, r as registerResolvedAgentDir, t as isPathOwnedByAnotherRegisteredAgent } from "./agent-dir-registry-DBWwXoA1.js";
import { d as readConfigFileSnapshotForWrite } from "./io-BsQc3Kgy.js";
import { z as resolveSqliteDatabaseFilePaths } from "./openclaw-state-db-D9eH245j.js";
import "./agent-scope-DyEposw2.js";
import { o as withConfigMutationExclusive } from "./mutate-dYcqgG_5.js";
...
import { s as readAgentDeletionJournal } from "./agent-deletion-journal-CwmdlLOX.js";
import { $ as unregisterOpenClawAgentDatabase, at as assertNoOpenClawAgentDatabaseLeases, et as listOpenClawRegisteredAgentDatabases, i as closeOpenClawAgentDatabaseByPath, it as resolveOpenClawAgentSqlitePath } from "./openclaw-agent-db-DemdumbZ.js";
import { c as resolveSessionTranscriptsDirForAgent } from "./paths-DSnYpBD3.js";
import { a as validateAgentsDeleteParams, c as validateAgentsFilesSetParams, i as validateAgentsCreateParams, l as validateAgentsListParams, o as validateAgentsFilesGetParams, s as validateAgentsFilesListParams, u as validateAgentsUpdateParams } from "./src-BSn6va4B.js";
import { a as errorShape, s as formatValidationErrors } from "./error-codes-P4fBo0lR.js";
import { _ as isWorkspaceSetupCompleted, h as isExpectedAbsentBootstrapFile, i as DEFAULT_IDENTITY_FILENAME, n as DEFAULT_BOOTSTRAP_FILENAME, p as ensureAgentWorkspace, u as WORKSPACE_BOOTSTRAP_FILENAMES } from "./workspace-aPJlJwqC.js";
import { i as deleteWorkspaceState, s as prepareWorkspaceStateDeletion } from "./workspace-state-store-CqdzARee.js";
import { c as prepareLegacyWorkspaceStateReset, l as removeLegacyWorkspaceStateForReset } from "./workspace-legacy-state-iROqOwNn.js";
import "./sessions-BqBqRT1f.js";
import { t as purgeAgentSessionStoreEntries } from "./cleanup-service-C9r0tlXy.js";
import { x as listAgentsForGateway } from "./session-utils-row-Br8x7LNG.js";
import "./session-utils-P5pxtsqu.js";
import { i as claimCompletedAgentDeletion, n as AgentDeletionCommitUncertainError, r as beginAgentDeletion, t as AgentDeletionAuthorityRollbackError } from "./agent-lifecycle-registry-BIgOsVbj.js";
import { $ as withAgentExecApprovalsRemoved } from "./exec-approvals-sCmCk_jQ.js";
import { n as resolveAgentIdentity } from "./identity-DxC7SNFJ.js";
import { a as mergeIdentityMarkdownContent, o as normalizeIdentityForFile, s as sanitizeAgentIdentityLine, t as createAgentIdentityConfig } from "./identity-file-2Pg8zrft.js";
import "./browser-maintenance-aCZbubnD.js";
...
import { i as updateAgentConfigEntry, n as deleteAgentConfigEntry, r as isConfiguredAgent, t as AgentConfigPreconditionError } from "./agents-config-mutations-BMGSXmmm.js";
...
const agentsHandlers = {
	...
	"agents.delete": async ({ params, respond, context }) => {
		...
		const agentId = normalizeAgentId(params.agentId);
		if (agentId === "main") {
			respond(false, void 0, errorShape(ErrorCodes.INVALID_REQUEST, `"${LEGACY_IMPLICIT_AGENT_ID}" cannot be deleted`));
			return;
		}
		...
		if (agentId === resolveDefaultAgentId(cfg)) {
			respond(false, void 0, errorShape(ErrorCodes.INVALID_REQUEST, `Agent "${agentId}" is the default and cannot be deleted. Reassign default first.`));
			return;
		}
		...
		try {
			respond(true, await withConfigMutationExclusive(async (lockedConfig) => {
				...
				if (agentId === resolveDefaultAgentId(lockedConfig)) throw new AgentConfigPreconditionError(`agent "${agentId}" is the default; reassign default first`);
