...
import { T as SANDBOX_STATE_DIR } from "./constants-BdVrBvbE.js";
import { o as resolveMaterializedSandboxSkillsWorkspaceDir } from "./workspace-mounts-DEtZw7ZS.js";
...
function resolveSandboxScopeKey(scope, sessionKey, workspaceDir) {
	...
	return `agent:${resolveAgentIdFromSessionKey(trimmed)}${workspaceSuffix}`;
}
...
function resolveSandboxWorkspaceLayoutPaths(params) {
	...
	const scopeKey = resolveSandboxScopeKey(params.cfg.scope, params.rawSessionKey, agentWorkspaceDir);
