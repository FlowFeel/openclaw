...
import { _ as readStringParam, g as readStringOrNumberParam, h as readStringArrayParam, m as readReactionParams, p as readPositiveIntegerParam } from "./common-yW0U9cHP.js";
import { t as jsonResult } from "./tool-results-BCM3fdVS.js";
import { C as normalizeOutboundLocation } from "./reply-payload-BE_j43tQ.js";
import { f as normalizeMessagePresentation, v as renderMessagePresentationFallbackText } from "./payload-BofbwVaq.js";
...
import { n as sendDurableMessageBatch } from "./channel-outbound-sjGCUxtt.js";
import { a as resolveDefaultTelegramAccountId, c as resolveTelegramPollActionGateState, t as createTelegramActionGate } from "./accounts-CAnRRRPr.js";
...
import { d as resolveTelegramMessageCacheScope } from "./sent-message-cache-BxR6Sn3u.js";
...
import { r as resolveTelegramInteractiveTextFallback } from "./interactive-fallback-z0ldm4hg.js";
import { t as resolveTelegramReactionLevel } from "./reaction-level-F0HdrF6b.js";
import { f as getCacheStats, h as searchStickers, o as resolveTopicNameCacheScope, s as updateTopicName } from "./topic-name-cache-Dg8v7oIv.js";
import "./sticker-cache-CEqW-Uye.js";
import { A as createForumTopicTelegram, F as reactMessageTelegram, H as createTelegramMessageCache, N as deleteMessageTelegram, P as pinMessageTelegram, U as hasProviderObservedTelegramThreadBinding, f as editMessageReplyMarkupTelegram, i as sendMessageTelegram, j as editForumTopicTelegram, n as sendPollTelegram, p as editMessageTelegram, r as sendStickerTelegram } from "./send-DbbI0aPE.js";
...
async function resolveTelegramMessageMutationChatId(params) {
	...
	if (!hasProviderObservedTelegramThreadBinding(await createTelegramMessageCache({ scope: resolveTelegramMessageCacheScope(resolveStorePath(params.cfg.session?.store, { agentId: params.cfg.agents ? resolveDefaultAgentId(params.cfg) : "main" })) }).get({
