...
import { i as getBundledChannelSetupPlugin } from "./bundled-Wqb8B5b_.js";
...
import { a as normalizeChannelId, n as getLoadedChannelPlugin, t as getChannelPlugin } from "./registry-DOSZ6AfI.js";
import "./plugins-DYLnGbXq.js";
import { r as parseOptionalDelimitedEntries } from "./helpers-B381bECH.js";
import { s as moveSingleAccountChannelSectionToDefaultAccount } from "./setup-helpers-t3GC4Z1N.js";
...
import { n as resolveChannelSetupCliOptionMetadata } from "./cli-add-options-iYh2Aiq0.js";
import { t as requireValidConfigFileSnapshot } from "./config-validation-CVZ-qE0d.js";
import { c as shouldUseWizard } from "./shared-D4VTmqS4.js";
...
const channelSetupPluginInstallLoader = createLazyImportLoader(() => import("./plugin-install-DrTmzwHC.js"));
const onboardChannelsLoader = createLazyImportLoader(() => import("./onboard-channels-yrpTV2ON.js"));
...
async function resolveCatalogChannelEntry(raw, cfg) {
	...
	if (!trimmed) return;
	return (cfg ? await import("./trusted-catalog-BL1H5Etm.js").then(({ listTrustedChannelPluginCatalogEntries }) => listTrustedChannelPluginCatalogEntries({
		cfg,
		workspaceDir: resolveAgentWorkspaceDir(cfg, resolveDefaultAgentId(cfg))
	})) : await import("./catalog-BbzfUXIN.js").then(({ listRawChannelPluginCatalogEntries }) => listRawChannelPluginCatalogEntries({ excludeWorkspace: true }))).find((entry) => {
...
async function channelsAddCommandImpl(opts, runtime, params) {
	...
	if (shouldUseWizard(params)) {
		const { resolveInitialWizardChannel, runChannelsAddWizardFlow } = await import("./add-wizard-ygkGvr3Z.js");
	...
	if (catalogEntry) {
		...
		const { isCatalogChannelInstalled } = await import("./discovery-DnMqkCc3.js");
