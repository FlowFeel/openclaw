...
import { t as isBrowserMachineOutput } from "./cli-output-mode-Brd5DK2D.js";
...
import { r as parseBrowserTabToolBinding, t as describeBrowserTool } from "./browser-tool-description-WpMYl0TC.js";
...
function registerBrowserPlugin(api) {
	...
	api.registerCli(async ({ program }) => {
		const { registerBrowserCli } = await import("./browser-cli-DcKHadKr.js");
	...
	api.registerHttpRoute({
		...
		handleUpgrade: async (req, socket, head) => {
			const { handleGatewayExtensionUpgrade } = await import("./gateway-relay-route-DfHykOAs.js");
