...
import { u as withTimeout$1 } from "./fs-safe-DVaClkIX.js";
import { t as readSecretFile } from "./secret-read-async-C6OiYF_j.js";
...
import { f as loadAuthProfileStoreForSecretsRuntime, h as resolvePersistedAuthProfileOwnerAgentDir, i as ensureAuthProfileStore, s as findPersistedAuthProfileCredential } from "./store-BWT5kQzj.js";
import { n as resolveApiKeyForProfile, t as refreshOAuthCredentialForRuntime } from "./oauth-C49bIJuK.js";
import { h as AgentHarnessPreflightError } from "./failover-error-DBKQENP4.js";
...
import "./secret-file-CyWaUExj.js";
...
import { o as createDeferred } from "./extension-shared-CyJFAMlE.js";
import "./text-utility-runtime-Dwuhfjgs.js";
import { A as resolveCodexAppServerUserHomeDir, C as resolveCodexAppServerStartOptionsForAgent, S as resolveCodexAppServerRuntimeOptions, l as isCodexAppServerNativeAuthProfile, w as resolveCodexComputerUseConfig, y as codexAppServerStartOptionsKey } from "./session-binding-Boew56yn.js";
...
const CODEX_APP_SERVER_VERSION = "0.146.0";
...
function assertSupportedCodexAppServerVersion(response) {
	...
	if (detectedVersion !== "0.146.0") throw new CodexAppServerVersionError(detectedVersion);
...
async function resolveCodexAppServerPreparedAuthHandoff(params) {
	...
	if (usesNativeHome || params.authRequirement !== "subscription") return {
		authProfileId,
		nativeAuthProfile
	};
...
async function assertNativeCodexAccountMatchesRoute(client, authRequirement) {
	...
	const accountType = isJsonObject$1(response.account) ? response.account.type : void 0;
...
async function retainCodexAppServerLiveThread(client, threadId, releasePreviousThread, configFingerprint) {
	const runtime = configuredClients.get(client);
	if (!runtime) return;
	if (runtime.retainedThreadRelease) await runtime.retainedThreadRelease;
	...
	if (previousThreadId && previousThreadId !== threadId && releasePreviousThread) {
		...
		try {
			...
			runtime.retainedThreadId = void 0;
			runtime.retainedThreadConfigFingerprint = void 0;
			throw error;
		} finally {
			if (runtime.retainedThreadRelease === release) runtime.retainedThreadRelease = void 0;
		}
	}
...
async function consumeCodexAppServerLiveThread(client, threadId, configFingerprint) {
	...
	if (runtime.retainedThreadRelease) await runtime.retainedThreadRelease;
	if (runtime.retainedThreadId !== threadId || configFingerprint !== void 0 && runtime.retainedThreadConfigFingerprint !== configFingerprint) return false;
	runtime.retainedThreadId = void 0;
	runtime.retainedThreadConfigFingerprint = void 0;
	return true;
}
...
async function startInitializedCodexAppServerClient(params) {
	...
	for (const [index, startOptions] of startOptionsCandidates.entries()) {
		const runtimeArtifactModule = params.runtimeArtifactMode ? await import("./runtime-artifact-DymhEMQa.js") : void 0;
...
//#endregion
export { isUnsupportedCodexAppServerVersionError as $, resolveCodexAppServerPreparedApiKeyCacheKey as A, resolveCodexTurnAssistantCompletionIdleTimeoutMs as B, readCodexRateLimitsRevision as C, resolveCodexAppServerAuthProfileId as D, resolveCodexAppServerAuthAccountCacheKey as E, CodexAppServerStartupError as F, getCodexAppServerClientInstanceId as G, resolveCodexTurnTerminalIdleTimeoutMs as H, isCodexAppServerStartupError as I, isCodexAppServerConnectionClosedError as J, isCodexAppServerApprovalRequest as K, resolveCodexGatewayTimeoutWithGraceMs as L, resolveFirstExistingMacOSDesktopCodexBundledMarketplacePath as M, resolveCodexAppServerHomeDir as N, resolveCodexAppServerAuthProfileIdForAgent as O, CODEX_POST_REASONING_REPLY_IDLE_TIMEOUT_MS as P, isCodexAppServerRequestTimeoutError as Q, resolveCodexPostToolRawAssistantCompletionIdleTimeoutMs as R, retainCodexAppServerLiveThread as S, rememberCodexRateLimitsRead as T, withCodexStartupTimeout as U, resolveCodexTurnCompletionIdleTimeoutMs as V, CodexAppServerRpcError as W, isCodexAppServerIndeterminateTransportError as X, isCodexAppServerIndeterminateRequestCancellationError as Y, isCodexAppServerPrewriteRequestCancellationError as Z, withLeasedCodexAppServerClientStartSelectionRetry as _, clearSharedCodexAppServerClientIfCurrentAndWait as a, isJsonObject$1 as at, consumeCodexAppServerLiveThread as b, getSharedCodexAppServerClient as c, releaseLeasedSharedCodexAppServerClient as d, resolveCodexAppServerClientInstanceId as et, resolveCodexAppServerSpawnIdentity as f, retireSharedCodexAppServerClientIfCurrent as g, retainSharedCodexAppServerClientIfCurrent as h, clearSharedCodexAppServerClientIfCurrentAndUnclaimed as i, flattenCodexDynamicToolFunctions as it, resolveCodexAppServerPreparedAuthHandoff as j, resolveCodexAppServerFallbackApiKeyCacheKey as k, isCodexAppServerStartSelectionChangedError as l, retainSharedCodexAppServerClientByInstanceId as m, clearSharedCodexAppServerClientAndWait as n, CODEX_INTERACTIVE_THREAD_SOURCE_KINDS as nt, createIsolatedCodexAppServerClient as o, resolveCodexNativeConfigFenceKey as p, isCodexAppServerBrokenPipeError as q, clearSharedCodexAppServerClientIfCurrent as r, CODEX_OPENCLAW_DIRECT_DYNAMIC_TOOL_NAMESPACE as rt, getLeasedSharedCodexAppServerClient as s, assertCodexAppServerClientStartSelectionCurrent as t, CODEX_INTERACTIVE_CUSTOM_THREAD_SOURCES as tt, releaseCodexAppServerClientLease as u, withTimeout as v, readRecentCodexRateLimits as w, ensureCodexAppServerClientRuntime as x, acquireCodexNativeConfigFence as y, resolveCodexStartupTimeoutMs as z };
