...
import { d as isTimeoutError } from "./failover-error-CMC-wGmM.js";
import { u as recordSessionCreated } from "./session-state-events-MWtkoPhW.js";
import { V as mapAgentRunTerminalOutcomeToTaskStatus } from "./task-registry-BbNCFm_L.js";
import { n as buildAgentRunTerminalOutcome, o as classifyAgentRunTerminalOutcome, p as normalizeAgentRunTimeoutPhase } from "./agent-run-terminal-outcome-Bl2pG_Kc.js";
...
import { C as retainEmbeddedAgentRunAbortabilityForRunId, i as clearEmbeddedAgentRunAbortabilityForRunId, l as isEmbeddedAgentRunAbortableForRunId } from "./runs-ehu0VRUR.js";
...
import { a as releaseMainSessionRecoveryOwner, n as commitMainSessionRecovery } from "./main-session-recovery-store-D-TyDWit.js";
...
import { r as validateStructuredOutputSchema } from "./openclaw-tools-dPoXkP5n.js";
import { l as consumeSubagentCompletionToolHandoff } from "./server-plugins-D7VUfDQ7.js";
...
import { f as updateChatRunProvider, l as resolveAgentRunExpiresAtMs, s as registerChatAbortController } from "./chat-abort-dteij8GM.js";
import { a as emitGatewaySessionEndPluginHook, c as performGatewaySessionReset, o as emitGatewaySessionStartPluginHook } from "./session-reset-service-BbpxogWI.js";
import { n as agentCommandFromGatewayIngress } from "./agent-command-DXzdqaCR.js";
...
import { n as waitForAgentJob, t as setGatewayDedupeEntry } from "./agent-job-BCBO2DsL.js";
...
import { a as parseMessageWithAttachments, i as logAttachmentFailure, n as MediaOffloadError, t as normalizeRpcAttachmentsToChatAttachments } from "./attachment-normalize-BJjpAKdr.js";
...
import { t as reactivateCompletedSubagentSession } from "./session-subagent-reactivation-CW7LWwcB.js";
...
async function registerPluginSubagentRunFromGateway(params) {
	...
	const { registerSubagentRun } = await import("./subagent-registry-XK4iQvAp.js");
	registerSubagentRun({
		runId: params.runId,
		childSessionKey,
