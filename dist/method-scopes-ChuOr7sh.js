...
import { g as getActivePluginSessionExtensionRegistry, l as getActivePluginHttpRouteRegistry } from "./runtime-yJAYArQt.js";
...
import { a as isDynamicOperatorGatewayMethod, i as isCoreNodeGatewayMethod, l as resolveCoreOperatorGatewayMethodScope, r as isCoreGatewayMethodClassified } from "./core-descriptors-Bngx0C2m.js";
...
function resolveSessionsPatchRequiredScope(params) {
	...
	return Object.keys(params).every((key) => SESSIONS_PATCH_WRITE_SCOPE_FIELDS.has(key)) ? "operator.write" : "operator.admin";
}
function resolveSessionsCreateRequiredScope(params) {
	if (!isRecord(params)) return "operator.write";
	if (params.incognito === true || typeof params.key === "string" && isIncognitoSessionKey(params.key) || typeof params.parentSessionKey === "string" && isIncognitoSessionKey(params.parentSessionKey) || Object.hasOwn(params, "cwd") || Object.hasOwn(params, "execNode")) return "operator.admin";
