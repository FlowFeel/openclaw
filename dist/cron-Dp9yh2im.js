...
import { f as AGENT_HARNESS_SESSION_ID_LOCKED_MESSAGE, h as isAgentHarnessSessionKey, p as AGENT_HARNESS_SESSION_KEY_RESERVED_MESSAGE, x as resolveAgentHarnessSessionStoreEntryError } from "./session-entry-slot-keys-DPRQmSpa.js";
import { at as validateCronAddParams, ca as validateWakeParams, ct as validateCronRemoveParams, dt as validateCronScratchGetParams, ft as validateCronScratchSetParams, lt as validateCronRunParams, mt as validateCronUpdateParams, ot as validateCronGetParams, pt as validateCronStatusParams, st as validateCronListParams, ut as validateCronRunsParams } from "./src-BSn6va4B.js";
import { a as errorShape } from "./error-codes-P4fBo0lR.js";
import { a as validateTargetProviderPrefix, t as resolveTargetPrefixedChannel } from "./channel-target-prefix-VFVVF5j7.js";
import { t as cronStoreKey } from "./key-BBZ40bDq.js";
import { r as normalizeCronJobPatch, t as normalizeCronJobCreate } from "./normalize-CupkFhHE.js";
import { t as parseAbsoluteTimeMs } from "./parse-mvoz8PbH.js";
import { n as createTrustedCronScheduledToolPolicy, t as createAccountCronScheduledToolPolicy } from "./scheduled-tool-policy-wGs9bS6c.js";
...
import { n as resolveCronDeliveryPlan, t as hasExplicitCronDeliveryTarget } from "./delivery-plan-CCXNSnwf.js";
...
import { i as readCronTaskRunHistoryPage, n as isInvalidCronTaskRunJobIdError, s as resolveFailureAlert, t as resolveCronListSnapshotRevision } from "./list-snapshot-revision-S5usKMOy.js";
import { n as applyJobPatch } from "./jobs-DscVQvMI.js";
import { n as cronJobUsesToolRuntime } from "./tools-allow-BSqnFkMT.js";
...
function assertCronDoesNotTargetAgentHarness(input) {
	...
	const loaded = loadSessionEntryReadOnly(targetSessionKey, input.agentId?.trim() ? { agentId: input.agentId.trim() } : {});
...
const cronHandlers = {
	...
	"cron.add": async ({ params, respond, context, client }) => {
		...
		try {
			result = await context.cron.add(jobCreate, {
				...
				...cronJobUsesToolRuntime(jobCreate) ? { scheduledToolPolicy: resolveCronScheduledToolPolicyForCaller(callerScope) } : {}
			});
		} catch (err) {
	...
	"cron.update": async ({ params, respond, context, client }) => {
		...
		try {
			...
			}, cronPatchTouchesToolRuntime(patch) ? { scheduledToolPolicy: resolveCronScheduledToolPolicyForCaller(callerScope) } : void 0);
		} catch (err) {
