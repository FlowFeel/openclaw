...
import "./browser-network-BG6jdrVm.js";
import { p as DEFAULT_SANDBOX_WORKSPACE_ROOT, t as DEFAULT_SANDBOX_BROWSER_AUTOSTART_TIMEOUT_MS } from "./constants-BdVrBvbE.js";
...
function resolveSandboxConfigForAgent(cfg, agentId) {
	...
	const scopedAgentDocker = scope === "shared" ? void 0 : agentSandbox?.docker;
	return {
		...
		dockerTmpfsSource: scopedAgentDocker?.tmpfs === void 0 && agent?.docker?.tmpfs === void 0 ? "default" : "configured",
