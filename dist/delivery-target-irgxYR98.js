...
import { r as stripTargetProviderPrefix } from "./channel-target-prefix-DsuLTMRz.js";
...
import { t as resolveOutboundTargetWithPlugin } from "./targets-resolve-shared-CAxj1pFi.js";
...
async function resolveDeliveryTarget(cfg, agentId, jobPayload, options) {
	...
	const threadEntry = threadSessionKey ? loadSqliteSessionEntryReadOnly({
		agentId,
		sessionKey: threadSessionKey,
		storePath
	}) : void 0;
	const mainEntry = loadSqliteSessionEntryReadOnly({
		agentId,
