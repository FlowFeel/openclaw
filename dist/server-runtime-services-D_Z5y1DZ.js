...
import { c as startSessionDeliveryRuntime, o as schedulePendingSessionDeliveries } from "./subagent-completion-delivery-C4p_WAFF.js";
import { n as resolveHeartbeatIntervalMs } from "./heartbeat-summary-S-VZc34p.js";
import "./embedded-agent-SSHfXmvH.js";
import { n as startHeartbeatRunner, o as resolveHeartbeatAgents } from "./heartbeat-runner-dTqOqkYP.js";
...
function startPendingSessionDeliveryRuntime(params) {
	...
	const timer = setTimeout(() => {
		runWithGatewayIndependentRootWorkAdmission(async () => {
			const { deliverQueuedSessionDelivery, recoverPendingRestartContinuationDeliveries, settleQueuedSessionDelivery } = await import("./server-restart-sentinel-jFjsNKIh.js");
			if (stopped) return;
