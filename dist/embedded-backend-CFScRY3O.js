...
import { F as EmbeddedPluginApprovalBroker, I as clearEmbeddedPluginApprovalBroker, L as setEmbeddedPluginApprovalBroker, z as setEmbeddedMode } from "./agent-tools.before-tool-call-BwKgu8k0.js";
...
import { t as buildAllowedModelSet } from "./model-selection-4mvNeCA1.js";
import { i as buildAgentRunTerminalOutcomeFromLifecycleEvent, o as classifyAgentRunTerminalOutcome, t as AGENT_RUN_TERMINAL_RETRY_GRACE_MS } from "./agent-run-terminal-outcome-9kJP3Yn1.js";
...
import { _ as queueEmbeddedAgentMessageWithOutcomeAsync } from "./runs-Bw__iUSb.js";
...
import { C as loadSessionEntryReadOnly, S as loadSessionEntry, T as resolveCanonicalGatewaySessionStoreKey, j as getSessionDefaults, k as resolveGatewaySessionStoreTarget, x as listAgentsForGateway } from "./session-utils-row-BDvhdN3C.js";
import { r as ensureContextWindowCacheLoaded } from "./context-DKZWKZZE.js";
...
import { i as buildGatewaySessionInfo, r as listSessionsFromStoreAsync } from "./session-utils-list-PF9PlJs5.js";
...
import { c as performGatewaySessionReset } from "./session-reset-service-BY3TcxCJ.js";
import { c as getMaxChatHistoryMessagesBytes } from "./server-constants-DKuFNbQH.js";
import { r as agentCommandFromIngress } from "./agent-command-BoD6qpqv.js";
import { t as createDefaultDeps } from "./deps-DjEsu1aS.js";
import { t as loadGatewayModelCatalog } from "./server-model-catalog-C7KfZJq9.js";
import { a as enforceChatHistoryFinalBudget, i as CHAT_HISTORY_MAX_SINGLE_MESSAGE_BYTES, n as enrichChatHistoryCompactionMarkers, o as replaceOversizedChatHistoryMessages, r as readChatHistoryPage } from "./chat-CTZ5CEHu.js";
import { a as isAgentLifecycleYieldedWaiting } from "./session-lifecycle-state-BoFtWO_a.js";
import { n as createGatewaySession } from "./session-create-service-BprkyaHU.js";
import { n as projectSessionsPatchEntry } from "./sessions-patch-BeO7rXKb.js";
import { d as formatTuiErrorMessage, t as resolveLocalRunShutdownGraceMs } from "./local-run-shutdown-DD0ePPyL.js";
...
var EmbeddedTuiBackend = class {
	...
	start() {
		...
		this.ready = (async () => {
			const { runSessionStartupMigration } = await import("./startup-migration-By4Rd2O9.js");
	...
	async runBtwTurn(params) {
		...
		const { runBtwSideQuestion } = await import("./btw-urc_Ra0n.js");
