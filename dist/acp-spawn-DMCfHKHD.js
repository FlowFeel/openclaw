...
import { t as formatThinkingLevels } from "./thinking-CTxMHCzD.js";
import { r as logVerbose } from "./globals-Cw62Mq_M.js";
import "./config-BBVHtcXg.js";
import { c as callGateway } from "./call-B_qeDbXh.js";
import { _ as runOpenClawAgentWriteTransaction } from "./openclaw-agent-db-DemdumbZ.js";
...
import { Ct as buildSessionCreationStamp, ct as loadSqliteSessionEntryReadOnly, nt as listSqliteSessionEntriesReadOnly, st as loadSqliteSessionEntry, vt as upsertSqliteSessionEntry } from "./session-accessor.sqlite-CtCo5VZ6.js";
import { i as normalizeAssistantPhase } from "./chat-message-content-DwX2R88T.js";
import { i as resolveSessionTranscriptRuntimeTarget } from "./session-accessor-D5Or7WgI.js";
import { n as resolveThinkingDefault } from "./model-thinking-default-BwLqoppi.js";
import { o as resolveConfiguredSubagentSpawnModelSelection } from "./model-selection-CZlE_kEq.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-CS3ZCTG9.js";
import { t as getAcpSessionManager } from "./manager-BxJ_8HLx.js";
import { m as recordSubagentSpawned, u as recordSessionCreated } from "./session-state-events-COmXZrBv.js";
import { a as requestHeartbeat, r as areHeartbeatsEnabled } from "./heartbeat-wake-D9__uym3.js";
import { a as enqueueSystemEvent } from "./system-events-BNZxjP0P.js";
import { k as listTasksForOwnerKey } from "./task-registry-Bs8cA6Tm.js";
import { n as isSessionBindingError, t as getSessionBindingService } from "./session-binding-service-DfYoR_Na.js";
import "./runtime-internal-grPJIfa5.js";
import { c as recordTaskRunProgressByRunId } from "./detached-task-runtime-BImEfMLT.js";
...
import { a as inheritedToolAllowPatch, i as formatAcpInheritedToolDenyError, n as findAcpUnsupportedInheritedToolDeny, o as inheritedToolDenyPatch, r as formatAcpInheritedToolAllowError, t as findAcpUnsupportedInheritedToolAllow } from "./inherited-tool-deny-CDzxUNVk.js";
...
import { j as resolveChannelStreamingProgressCommentary } from "./streaming-Df3LUUGR.js";
...
import { u as getSubagentRunByChildSessionKey } from "./subagent-registry-C4ALZQd0.js";
...
import { i as routeToDeliveryFields, n as routeFromBindingRecord, t as formatConversationTarget } from "./route-projection-Cv8ipUUx.js";
...
import { i as resolveSpawnedWorkspaceInheritance } from "./spawned-context-ClhbZdeK.js";
import { i as resolveThreadBindingThreadName, r as resolveThreadBindingIntroText } from "./thread-bindings-messages-C6JmokKM.js";
import { n as resolveAcpProjectionSettings, t as isAcpTagVisible } from "./acp-stream-settings-BMrsDuZu.js";
...
//#endregion
//#region src/agents/acp-spawn-admission.ts
...
//#endregion
//#region src/agents/acp-spawn-bootstrap-delivery.ts
...
function hasConfiguredPreviewStreamMode(entry) {
	return asObjectRecord(entry.streaming)?.mode !== void 0;
}
...
//#endregion
//#region src/agents/acp-spawn-heartbeat.ts
...
function hasSessionLocalHeartbeatRelayRoute(params) {
	...
	const parentDeliveryContext = deliveryContextFromSession(loadSqliteSessionEntryReadOnly({
...
//#endregion
//#region src/agents/acp-spawn-requester.ts
...
function validateAcpResumeSessionOwnership(params) {
	...
	for (const { sessionKey, entry } of listSqliteSessionEntriesReadOnly({
		storePath,
		clone: false
	})) {
...
//#endregion
//#region src/agents/acp-spawn-runtime.ts
...
async function initializeAcpSpawnRuntime(params) {
	const storePath = resolveStorePath(params.cfg.session?.store, { agentId: params.targetAgentId });
	let sessionEntry = loadSqliteSessionEntry({
		storePath,
		sessionKey: params.sessionKey,
		clone: false
	});
...
//#endregion
//#region src/agents/acp-spawn-target.ts
...
async function spawnAcpDirect(params, ctx) {
	...
	const parentAgentId = parentSessionKey ? resolveAgentIdFromSessionKey(parentSessionKey, resolveDefaultAgentId(cfg)) : void 0;
	const parentDeliveryCtx = effectiveStreamToParent && parentSessionKey ? deliveryContextFromSession(loadSqliteSessionEntryReadOnly({
	...
	const adapter = {
		async initialize() {
			...
			childCreationEntry = await upsertSqliteSessionEntry({
				storePath,
				sessionKey
			}, {
				...creationStamp,
...
//#endregion
export { spawnAcpDirect as a, resolveAcpSpawnRuntimePolicyError as i, ACP_SPAWN_STREAM_TARGETS as n, resolveRuntimeCwdForAcpSpawn as o, isSpawnAcpAcceptedResult as r, cleanupFailedAcpSpawn as s, ACP_SPAWN_MODES as t };
