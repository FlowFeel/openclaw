...
import { t as isValidAgentId } from "./agent-id-DDgUze4y.js";
...
import { _ as loadLatestSqliteAssistantText } from "./session-accessor.sqlite-transcript-store-BCfOcQgE.js";
import "./session-accessor-D5Or7WgI.js";
import { t as withTimeout } from "./with-timeout-DLevvI3c.js";
import { a as getDiagnosticSessionActivitySnapshot, f as startDiagnosticRunActivityTracking, i as getDiagnosticEmbeddedRunActivitySequence, p as stopDiagnosticRunActivityTracking, r as clearDiagnosticEmbeddedRunActivityForSession, t as BLOCKED_TOOL_CALL_ABORT_FLOOR_MS, u as resetDiagnosticRunActivityForTest } from "./diagnostic-run-activity-3mcrQxEA.js";
...
import { a as logMessageQueuedWithBacklogPolicy, n as getLastDiagnosticActivityAt, o as markDiagnosticActivity, s as resetDiagnosticActivityForTest, t as diagnosticLogger } from "./diagnostic-runtime-D23gjKvk.js";
import { i as resetDiagnosticStabilityRecorderForTest, o as startDiagnosticStabilityRecorder, s as stopDiagnosticStabilityRecorder } from "./diagnostic-stability-DpsPXVnc.js";
import { c as writeDiagnosticMemoryPressureBundleSync, o as resetDiagnosticStabilityBundleForTest, r as installDiagnosticStabilityFatalHook, s as uninstallDiagnosticStabilityFatalHook } from "./diagnostic-stability-bundle-ci7X-pAc.js";
...
import { c as resolveCronJobsStorePath, r as loadCronJobsStoreSync } from "./store-BwY4XtES.js";
...
function resolveThresholds(thresholds, heapSizeLimitBytes) {
	const hasHeapLimit = typeof heapSizeLimitBytes === "number" && Number.isFinite(heapSizeLimitBytes) && heapSizeLimitBytes > 0;
...
function emitDiagnosticMemorySample(options) {
	...
	const thresholds = resolveThresholds(options?.thresholds, options?.heapSizeLimitBytes ?? getHeapStatistics().heap_size_limit);
...
function resolveCronSessionDiagnosticContext(params) {
	...
	try {
		...
		if (loadSqliteSessionEntryReadOnly(sessionScope)?.sessionId === activeSessionId) context.lastAssistant = loadLatestSqliteAssistantText({
			...sessionScope,
