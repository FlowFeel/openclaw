...
import { a as normalizeOptionalTrimmedStringList, d as normalizeTrimmedStringList } from "./string-normalization-CRyoFBPt.js";
...
import { i as normalizeModelCatalogProviderId, n as buildModelCatalogRef, t as buildModelCatalogMergeKey } from "./model-catalog-refs-C_8nyypZ.js";
import { n as ENV_SECRET_REF_ID_RE } from "./types.secrets-BvApkFoj.js";
import { r as createPluginCacheKey, t as PluginLruCache } from "./plugin-cache-primitives-Dz0npwxC.js";
import { t as normalizeManifestCommandAliases } from "./manifest-command-aliases-B8DIagnu.js";
...
function normalizeOwnedProviderMap(value, ownedProvidersRaw, normalizePolicy) {
	...
	const ownedProviders = new Set([...ownedProvidersRaw].map((provider) => normalizeModelCatalogProviderId(provider)).filter(Boolean));
	const providers = {};
...
function loadPluginManifest(rootDir, rejectHardlinks = true, rootRealPath) {
	...
	const manifestBeforeDashboard = {
		...
		providerAuthAliases: normalizeStringRecord(raw.providerAuthAliases),
...
//#endregion
export { getPackageManifestMetadata as a, normalizeManifestChannelCommandDefaults as c, MODEL_CATALOG_APIS as d, MODEL_CATALOG_THINKING_LEVELS as f, DEFAULT_PLUGIN_ENTRY_CANDIDATES as i, normalizeModelCatalog as l, isCoreReservedPluginId as n, resolvePackageExtensionEntries as o, loadPluginManifest as r, normalizeManifestActivation as s, PLUGIN_MANIFEST_FILENAME as t, normalizeModelCatalogProviderRows as u };
