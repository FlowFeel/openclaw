...
import { n as createProviderOperationDeadline } from "./shared-3S5SOCXx.js";
...
function buildFalVideoGenerationProvider() {
	return {
		...
		async generateVideo(req) {
			...
			return {
				videos: [await downloadFalVideo(url, policy, resolveGeneratedMediaMaxBytes(req.cfg, "video"))],
				model,
				metadata: {
