...
import { r as loadDeviceAuthTokens } from "./device-auth-store-C0rVjVQr.js";
import { n as loadDeviceIdentityIfPresent } from "./device-identity-P-Q23TDZ.js";
...
import { d as listDevicePairing, u as listApprovedPairedDeviceRoles, w as summarizeDeviceTokens } from "./device-pairing-pwb3Oe75.js";
...
function readLocalDeviceAuthTokens(deviceId, env = process.env) {
	try {
		return loadDeviceAuthTokens({
			deviceId,
			env
		});
	} catch {
...
async function collectLegacyPairingStoreIssues(cfg) {
	...
	const { listLegacyDevicePairingStoreFiles } = await import("./device-pairing-migration-Bjr0pxcK.js");
