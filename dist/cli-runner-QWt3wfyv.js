...
import { c as isFailoverError, d as isTimeoutError, p as resolveFailoverStatus, t as FailoverError, u as isSignalTimeoutReason } from "./failover-error-CMC-wGmM.js";
...
import { d as waitForDeferredTurnMaintenanceForSession, i as bootstrapHarnessContextEngine, l as runHarnessContextEngineMaintenance, n as runAgentEndSideEffects, s as finalizeHarnessContextEngineTurn, t as awaitAgentEndSideEffects } from "./agent-end-side-effects-OmZZY1Jt.js";
...
import { o as shouldUseClaudeLiveSession } from "./claude-live-session-Djr5QRAZ.js";
...
async function runCliAgentInternal(params, diagnosticLifecycle) {
	...
	if (params.cleanupCliLiveSessionOnRunEnd === true) try {
		const { closeClaudeLiveSessionForContext } = await import("./claude-live-session-WOUkMLQ9.js");
