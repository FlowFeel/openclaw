...
import { n as openLocalFileSafely, r as readLocalFileSafely } from "./root-impl-DYBxk3hn.js";
...
import { c as getImageMetadata, f as readImageProbeFromHeader, s as createImageProcessor } from "./image-ops-BtojRCsZ.js";
import { n as probePlaybackMediaFileDescriptor } from "./media-probe-BL-Ub3TA.js";
import "./media-services-Ii2z0iaY.js";
import { d as saveMediaSource, s as getMediaDir, t as MEDIA_MAX_BYTES, u as saveMediaBuffer } from "./store-QVlUiM0_.js";
import { u as readSessionMessagesWithSourceAsync, y as resolveSessionHistoryTranscriptPathAsync } from "./session-transcript-readers-O8pyQfzE.js";
...
import { a as resolveLocalMediaRoots, n as assertLocalMediaAllowed } from "./local-media-access-CfOl4jrn.js";
import { m as resolveOpenAiCompatibleHttpSenderIsOwner, n as authorizeGatewayHttpRequestOrReply, p as resolveOpenAiCompatibleHttpOperatorScopes } from "./http-auth-utils-3kt7C83x.js";
import { c as sendMethodNotAllowed, l as sendMissingScopeForbidden, s as sendJson } from "./http-common-C1Esyf5_.js";
...
async function getSessionManagedOutgoingAttachmentIndex(sessionKey, cache, agentId) {
	...
	const { storePath, entry } = loadSessionEntryReadOnly(sessionKey, sessionKey === "global" && agentId ? { agentId } : void 0);
...
async function resolveManagedOutgoingMediaArtifactDownloadForRecord(record) {
	if (!await recordMatchesTranscriptMessage(record)) return null;
	const kind = resolveManagedRecordKind(record);
	if (!kind) return null;
