...
const DEFAULT_BROWSER_EXTRACT_TIMEOUT_MS = 6e4;
/** Minimum accepted extraction budget after clamping. */
const MIN_BROWSER_EXTRACT_TIMEOUT_MS = 5e3;
/** Maximum accepted extraction budget after clamping. */
const MAX_BROWSER_EXTRACT_TIMEOUT_MS = 12e4;
/**
...
*/
const BROWSER_TAB_UNREACHABLE_RETIRE_MS = 1440 * 60 * 1e3;
...
*/
const BROWSER_EXTRACT_MAX_CHARS = 8e4;
/** Reject unusually large serialized DOMs before transport and Markdown conversion. */
const BROWSER_EXTRACT_MAX_HTML_CHARS = 2e6;
/** Visible line appended when page markdown is shortened to the extraction budget. */
const BROWSER_EXTRACT_TRUNCATION_MARKER = "[PAGE CONTENT TRUNCATED]";
//#endregion
export { DEFAULT_OPENCLAW_BROWSER_ENABLED as _, DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS as a, MIN_BROWSER_EXTRACT_TIMEOUT_MS as b, DEFAULT_BROWSER_DEFAULT_PROFILE_NAME as c, DEFAULT_BROWSER_EXTRACT_TIMEOUT_MS as d, DEFAULT_BROWSER_LOCAL_CDP_READY_TIMEOUT_MS as f, DEFAULT_OPENCLAW_BROWSER_COLOR as g, DEFAULT_BROWSER_SNAPSHOT_TIMEOUT_MS as h, BROWSER_TAB_UNREACHABLE_RETIRE_MS as i, DEFAULT_BROWSER_DOWNLOAD_TIMEOUT_MS as l, DEFAULT_BROWSER_SCREENSHOT_TIMEOUT_MS as m, BROWSER_EXTRACT_MAX_HTML_CHARS as n, DEFAULT_AI_SNAPSHOT_MAX_CHARS as o, DEFAULT_BROWSER_LOCAL_LAUNCH_TIMEOUT_MS as p, BROWSER_EXTRACT_TRUNCATION_MARKER as r, DEFAULT_BROWSER_ACTION_TIMEOUT_MS as s, BROWSER_EXTRACT_MAX_CHARS as t, DEFAULT_BROWSER_EVALUATE_ENABLED as u, DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME as v, MAX_BROWSER_EXTRACT_TIMEOUT_MS as y };
