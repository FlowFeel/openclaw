...
import { n as hasActiveGatewayExecCredential, t as resolveDoctorWorkspaceSuggestionScopes } from "./doctor-workspace-suggestion-scopes-DNFjVKFI.js";
import { l as isLegacyParentWritableUpdateDoctorPass } from "./update-phase-BxFkFmnw.js";
import { i as createDoctorHealthContribution, n as runCoreHealthFindingNote, r as runStructuredHealthRepairs, t as runCoreContributionHealth } from "./doctor-health-contribution-core-sJd6ajTS.js";
...
async function runWriteConfigHealth(ctx, options = {}) {
	const { applyWizardMetadata } = await import("./onboard-helpers-Dxm_i9Uy.js");
	const { replaceConfigFile } = await import("./config/config.js");
	const { logConfigUpdated } = await import("./logging-l6OoqoUS.js");
	...
	if (ctx.configResult.retiredPhoneControlStateCleanupPending === true) {
		const { finalizeRetiredPhoneControlCleanup } = await import("./doctor-retired-phone-control-D7bbpiag.js");
	...
	const { repairCronCodexModelRefsAfterConfigWrite } = await import("./legacy-repair-CNHyQhcP.js");
...
async function runClaudeCliHealth(ctx) {
	const { noteClaudeCliHealth } = await import("./doctor-claude-cli-DakNcoIf.js");
...
async function runGatewayServicesHealth(ctx) {
	...
	const { maybeRepairGatewayServiceConfig, maybeResolveDuelingSystemdGatewayScopes, maybeScanExtraGatewayServices } = await import("./doctor-gateway-services-Cwy-Ncvl.js");
	const { noteMacLaunchAgentOverrides, noteMacLaunchctlGatewayEnvOverrides, noteMacStaleOpenClawUpdateLaunchdJobs } = await import("./doctor-platform-notes-DEZ6dEvd.js");
...
async function runStartupChannelMaintenanceHealth(ctx) {
	const { maybeRunDoctorStartupChannelMaintenance } = await import("./doctor-startup-channel-maintenance-C0-aazNr.js");
...
async function runSecurityHealth(ctx) {
	const { noteInstallPolicyHealth } = await import("./doctor-install-policy-BBnBrBvm.js");
	const { noteSecurityWarnings } = await import("./doctor-security-DFL3cRBa.js");
...
async function runWebFetchProxyHealth(ctx) {
	...
	const { noteWebFetchProxyDiagnostic } = await import("./doctor-web-fetch-proxy-C9MTdlAy.js");
...
async function runBrowserHealth(ctx) {
	const { noteChromeMcpBrowserReadiness } = await import("./doctor-browser-DTdT0WOu.js");
...
async function runDevicePairingHealth(ctx) {
	const { noteDevicePairingHealth } = await import("./doctor-device-pairing-DmTHdAwH.js");
...
async function runGatewayDaemonHealth(ctx) {
	if (!isDefaultInstallIdentity(ctx.env ?? process.env)) return;
	const { maybeRepairGatewayDaemon } = await import("./doctor-gateway-daemon-flow-D4Xo7VpN.js");
...
const loadDoctorStateIntegrityModule$1 = async () => await import("./doctor-state-integrity-BnZUtM-v.js");
async function runActiveToolSchemaWarningsHealth(ctx) {
	if (!ctx.prompter.shouldRepair) return;
	const { collectActiveToolSchemaProjectionWarnings } = await import("./active-tool-schema-warnings-PSe6u4Jp.js");
...
async function runHooksModelHealth(ctx) {
	...
	const { loadPreparedModelCatalog } = await import("./prepared-model-catalog-ClbAcHfK.js");
	const { getModelRefStatus, resolveConfiguredModelRef, resolveHooksGmailModel } = await import("./model-selection-ChsC3QwE.js");
	const { note } = await import("./terminal-core/note.js");
...
async function collectWorkspaceStatusPluginVersionDrift(params) {
	...
	try {
		const { gatherDaemonStatus } = await import("./status.gather-Bg0rca7r.js");
...
async function runWorkspaceStatusHealth(ctx) {
	...
	const { noteWorkspaceStatus } = await import("./doctor-workspace-status-C1_PixjD.js");
	noteWorkspaceStatus(ctx.cfg, { pluginVersionDrift });
}
async function runSkillsHealth(ctx) {
	const { maybeRepairSkillReadiness } = await import("./doctor-skills-CMByqDqB.js");
...
async function runBootstrapSizeHealth(ctx) {
	const { noteBootstrapFileSize } = await import("./doctor-bootstrap-size-DW_9y-xI.js");
	await noteBootstrapFileSize(ctx.cfg);
}
async function runHeartbeatCadenceMigrationHealth(ctx) {
	const { maybeMigrateHeartbeatCadenceToCron } = await import("./doctor-heartbeat-cadence-migration-CPJE_Um4.js");
...
async function runHeartbeatScratchMigrationHealth(ctx) {
	const { maybeMigrateHeartbeatFilesToScratch } = await import("./doctor-heartbeat-scratch-migration-y8bbst4P.js");
...
async function runToolsMdMigrationHealth(ctx) {
	const { maybeMigrateToolsMd } = await import("./doctor-tools-md-migration-DPUbO2B9.js");
...
async function runHeartbeatTaskMigrationHealth(ctx) {
	const { maybeMigrateHeartbeatTasksToCron } = await import("./doctor-heartbeat-task-migration-Dn31TVHq.js");
...
async function runMemorySearchHealthContribution(ctx) {
	const { maybeRepairMemoryRecallHealth, noteMemoryRecallHealth, noteMemorySearchHealth } = await import("./doctor-memory-search-cTu6rK97.js");
...
async function collectMemorySearchHealthFindings(ctx) {
	const { noteMemorySearchHealth } = await import("./doctor-memory-search-cTu6rK97.js");
	const notes = [];
...
async function runWorkspaceSuggestionsHealth(ctx) {
	...
	const { MEMORY_SYSTEM_PROMPT, shouldSuggestMemorySystem } = await import("./doctor-workspace-Bc2wqDee.js");
	const { note } = await import("./terminal-core/note.js");
	...
	return [
		...
		createDoctorHealthContribution({
			...
			healthChecks: {
				...
				async detect(ctx) {
					const { collectMissingDefaultAccountBindingWarnings, collectMissingExplicitDefaultAccountWarnings } = await import("./default-account-warnings-C9J_SrAP.js");
		...
		createDoctorHealthContribution({
			...
			healthChecks: [{
				...
				defaultEnabled: false,
				async detect(ctx) {
					const { channelPluginBlockerHitToHealthFinding, scanConfiguredChannelPluginBlockers } = await import("./channel-plugin-blockers-C7YQkIDy.js");
				...
				defaultEnabled: false,
				async detect(ctx) {
					const { collectChannelPreviewWarningHealthFindings } = await import("./doctor-startup-channel-maintenance-C0-aazNr.js");
		...
		createDoctorHealthContribution({
			...
			healthChecks: {
				...
				defaultEnabled: false,
				async detect(ctx) {
					const { collectWorkspaceStatusHealthFindings } = await import("./doctor-workspace-status-C1_PixjD.js");
					const pluginVersionDrift = await collectWorkspaceStatusPluginVersionDrift({
						cfg: ctx.cfg,
						options: {
							nonInteractive: true,
		...
		createDoctorHealthContribution({
			...
			healthChecks: {
				...
				defaultEnabled: false,
				async detect() {
					const { getSkillCuratorDoctorWarning } = await import("./curator-BXy46CMQ.js");
		...
		createDoctorHealthContribution({
			...
			healthChecks: {
				...
				defaultEnabled: true,
				async detect(ctx) {
					const { collectHeartbeatCadenceMigrationFindings } = await import("./doctor-heartbeat-cadence-migration-CPJE_Um4.js");
		...
		createDoctorHealthContribution({
			...
			healthChecks: {
				...
				defaultEnabled: true,
				async detect(ctx) {
					const { collectHeartbeatScratchMigrationFindings } = await import("./doctor-heartbeat-scratch-migration-y8bbst4P.js");
		...
		createDoctorHealthContribution({
			...
			healthChecks: {
				...
				defaultEnabled: true,
				async detect(ctx) {
					const { collectToolsMdMigrationFindings } = await import("./doctor-tools-md-migration-DPUbO2B9.js");
		...
		createDoctorHealthContribution({
			...
			healthChecks: {
				...
				defaultEnabled: true,
				async detect(ctx) {
					const { collectHeartbeatTaskMigrationFindings } = await import("./doctor-heartbeat-task-migration-Dn31TVHq.js");
		...
		createDoctorHealthContribution({
			...
			healthChecks: {
				...
				defaultEnabled: false,
				async detect(ctx) {
					const { collectDevicePairingHealthFindings } = await import("./doctor-device-pairing-DmTHdAwH.js");
...
const loadDoctorStateIntegrityModule = async () => await import("./doctor-state-integrity-BnZUtM-v.js");
async function runLegacyPluginManifestHealth(ctx) {
	const { maybeRepairLegacyPluginManifestContracts } = await import("./doctor-plugin-manifests-K4YxmJh1.js");
...
async function runPluginRegistryHealth(ctx) {
	const { maybeRepairPluginRegistryState } = await import("./doctor-plugin-registry-PrJ5HgXJ.js");
...
async function runReleaseConfiguredPluginInstallsHealth(ctx) {
	...
	const { maybeRunConfiguredPluginInstallReleaseStep } = await import("./release-configured-plugin-installs-CNujw5BZ.js");
	const { note } = await import("./terminal-core/note.js");
...
async function runDatabaseBloatHealth(ctx) {
	const { noteSqliteDatabaseBloat } = await import("./doctor-db-bloat-CxrWl2VX.js");
	noteSqliteDatabaseBloat(ctx.cfg);
}
async function runAgentMemorySchemaHealth(ctx) {
	const { noteDoctorAgentMemorySchemaHealth } = await import("./doctor-agent-memory-schema-DiDvcFlv.js");
...
async function runChannelIngressDeadLettersHealth() {
	const { noteChannelIngressDeadLetters } = await import("./doctor-channel-ingress-BNRNc5c6.js");
...
async function runCodexSessionRouteHealth(ctx) {
	const { maybeRepairCodexSessionRoutes } = await import("./codex-route-warnings-NdXKn7y8.js");
	const { note } = await import("./terminal-core/note.js");
...
async function runSessionLocksHealth(ctx) {
	const { noteSessionLockHealth } = await import("./doctor-session-locks-v0MXAiCU.js");
...
async function runSessionTranscriptsHealth(ctx) {
	const { noteSessionTranscriptHealth } = await import("./doctor-session-transcripts-CuCFdcTm.js");
...
async function runSessionTranscriptHeadersHealth(ctx) {
	const { noteSessionTranscriptHeaderHealth } = await import("./doctor-session-transcript-headers-CcqOnHDF.js");
...
async function runSessionTranscriptLabelsHealth(ctx) {
	const { noteSessionTranscriptLabelHealth } = await import("./doctor-session-transcript-labels-DAGfUf8U.js");
...
async function runSessionSnapshotsHealth(ctx) {
	const { noteSessionSnapshotHealth } = await import("./doctor-session-snapshots-BuIBNn8a.js");
...
async function runConfigAuditScrubHealth(ctx) {
	const { maybeRepairLegacyRuntimeFiles } = await import("./doctor-usage-cost-cache-DPPaTH4O.js");
	await maybeRepairLegacyRuntimeFiles(ctx.prompter.shouldRepair, ctx.env);
}
async function runLegacyCronHealth(ctx) {
	const { maybeRepairLegacyCronStore, noteLegacyWhatsAppCrontabHealthCheck } = await import("./cron-D65moqK_.js");
...
async function runSandboxHealth(ctx) {
	const { maybeRepairSandboxImages, maybeRepairSandboxRegistryFiles, noteSandboxScopeWarnings } = await import("./doctor-sandbox-C-qCb-u0.js");
...
async function runTelegramGeneralTopicConversationHealth(ctx) {
	const { runCoreContributionHealth } = await import("./doctor-health-contribution-core-B3MAr93B.js");
	...
	return [
		...
		createDoctorHealthContribution({
			...
			healthChecks: {
				...
				defaultEnabled: false,
				async detect(ctx) {
					const { collectAuthProfileHealthFindings } = await import("./doctor-auth-D6qW19Dp.js");
		...
		createDoctorHealthContribution({
			...
			healthChecks: {
				...
				defaultEnabled: false,
				async detect() {
					const { detectSessionTranscriptHealthIssues, sessionTranscriptIssueToHealthFinding } = await import("./doctor-session-transcripts-CuCFdcTm.js");
					return (await detectSessionTranscriptHealthIssues()).map(sessionTranscriptIssueToHealthFinding);
				},
				repair: legacyOwnedRepair(async () => {
					const { detectSessionTranscriptHealthIssues, sessionTranscriptIssueToRepairEffect } = await import("./doctor-session-transcripts-CuCFdcTm.js");
		...
		createDoctorHealthContribution({
			...
			healthChecks: {
				...
				defaultEnabled: false,
				async detect(ctx) {
					const { collectLegacyPluginManifestContractMigrations, legacyPluginManifestContractMigrationToHealthFinding } = await import("./doctor-plugin-manifests-K4YxmJh1.js");
		...
		createDoctorHealthContribution({
			...
			healthChecks: {
				...
				defaultEnabled: false,
				async detect(ctx) {
					const { detectConfiguredPluginInstallHealthIssues, configuredPluginInstallIssueToHealthFinding } = await import("./missing-configured-plugin-install-pA4VfEHx.js");
				...
				repair: legacyOwnedRepair(async (ctx) => {
					const { detectConfiguredPluginInstallHealthIssues, configuredPluginInstallIssueToRepairEffect } = await import("./missing-configured-plugin-install-pA4VfEHx.js");
					return (await detectConfiguredPluginInstallHealthIssues({
						cfg: ctx.cfg,
						env: process.env
		...
		createDoctorHealthContribution({
			...
			healthChecks: {
				...
				defaultEnabled: false,
				async detect(ctx) {
					const { detectPluginRegistryHealthIssues, pluginRegistryIssueToHealthFinding } = await import("./doctor-plugin-registry-PrJ5HgXJ.js");
				...
				repair: legacyOwnedRepair(async (ctx) => {
					const { detectPluginRegistryHealthIssues, pluginRegistryIssueToRepairEffect } = await import("./doctor-plugin-registry-PrJ5HgXJ.js");
					return (await detectPluginRegistryHealthIssues({
						config: ctx.cfg,
						env: process.env,
						prompter: { shouldRepair: false }
		...
		createDoctorHealthContribution({
			...
			healthChecks: {
				...
				defaultEnabled: false,
				async detect(ctx) {
					const { detectStateIntegrityHealthIssues, stateIntegrityIssueToHealthFinding } = await import("./doctor-state-integrity-BnZUtM-v.js");
				...
				repair: legacyOwnedRepair(async (ctx) => {
					const { detectStateIntegrityHealthIssues, stateIntegrityIssueToRepairEffect } = await import("./doctor-state-integrity-BnZUtM-v.js");
					return detectStateIntegrityHealthIssues(ctx.cfg, {
						configPath: ctx.configPath,
						env: process.env
		...
		createDoctorHealthContribution({
			...
			healthChecks: {
				...
				defaultEnabled: false,
				async detect(ctx) {
					const { detectSessionSnapshotHealthIssues, sessionSnapshotIssueToHealthFinding } = await import("./doctor-session-snapshots-BuIBNn8a.js");
				...
				repair: legacyOwnedRepair(async (ctx) => {
					const { detectSessionSnapshotHealthIssues, sessionSnapshotIssueToRepairEffect } = await import("./doctor-session-snapshots-BuIBNn8a.js");
					return (await detectSessionSnapshotHealthIssues({
						cfg: ctx.cfg,
						env: process.env
		...
		createDoctorHealthContribution({
			...
			healthChecks: {
				...
				defaultEnabled: false,
				async detect() {
					const { configAuditScrubToHealthFinding, detectConfigAuditScrubIssue } = await import("./doctor-config-audit-scrub-X9cVU3vD.js");
					const result = await detectConfigAuditScrubIssue();
					return result.rewritten > 0 ? [configAuditScrubToHealthFinding(result)] : [];
				},
				repair: legacyOwnedRepair(async () => {
					const { configAuditScrubToRepairEffect, detectConfigAuditScrubIssue } = await import("./doctor-config-audit-scrub-X9cVU3vD.js");
					const result = await detectConfigAuditScrubIssue();
		...
		createDoctorHealthContribution({
			...
			healthChecks: {
				...
				async detect() {
					const { detectLegacySandboxRegistryFileIssues, legacySandboxRegistryInspectionToHealthFinding } = await import("./doctor-sandbox-C-qCb-u0.js");
					return (await detectLegacySandboxRegistryFileIssues()).map(legacySandboxRegistryInspectionToHealthFinding);
				},
				repair: legacyOwnedRepair(async () => {
					const { detectLegacySandboxRegistryFileIssues, legacySandboxRegistryInspectionToRepairEffect } = await import("./doctor-sandbox-C-qCb-u0.js");
...
const loadDoctorCoreChecksModule = async () => await import("./doctor-core-checks-4m0CwBy8.js");
const loadNoteModule = async () => await import("./terminal-core/note.js");
const loadOnboardHelpersModule = async () => await import("./onboard-helpers-Dxm_i9Uy.js");
...
async function runAuthProfileHealth(ctx) {
	const { maybeMigrateAuthProfileJsonStoresToSqlite } = await import("./doctor-auth-flat-profiles-CjxyVRb7.js");
	const { maybeRepairLegacyOAuthProfileIds } = await import("./doctor-auth-legacy-oauth-BuFklI8j.js");
	const { maybeRepairLegacyOAuthSidecarProfiles } = await import("./doctor-auth-oauth-sidecar-DoAYpJQj.js");
	const { maybeMigrateLegacyPluginModelCatalogs } = await import("./doctor-plugin-model-catalog-BWeGxdhF.js");
	const { noteAuthProfileHealth, noteLegacyCodexProviderOverride } = await import("./doctor-auth-D6qW19Dp.js");
	const { buildGatewayConnectionDetails } = await import("./call-DctZOBCQ.js");
	const { note } = await loadNoteModule();
...
async function runGatewayAuthHealth(ctx) {
	...
	const { resolveGatewayAuth } = await import("./auth-BXRaFjK8.js");
	const { resolveGatewayAuthToken } = await import("./auth-token-resolution-DtnCoZyK.js");
	const { note } = await loadNoteModule();
...
async function runLegacyStateHealth(ctx) {
	const { detectLegacyStateMigrations, runLegacyStateMigrations } = await import("./doctor-state-migrations-NUAm1xeS.js");
	const { note } = await loadNoteModule();
...
async function runSystemdLingerHealth(ctx) {
	...
	const { resolveGatewayService } = await import("./service-DvDTRHke.js");
	const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-BAJqwD80.js");
	const { note } = await loadNoteModule();
...
async function detectSystemdLingerFindings(ctx) {
	...
	if (!loaded) return [];
	const { isSystemdUserServiceAvailable, readSystemdUserLingerStatus } = await import("./systemd-CSqbUz-r.js");
...
async function runShellCompletionHealth(ctx) {
	const { doctorShellCompletion } = await import("./doctor-completion-DsB52nIQ.js");
...
async function runGatewayHealthChecks(ctx) {
	...
	const { checkGatewayHealth, probeGatewayMemoryStatus } = await import("./doctor-gateway-health-Cs_ARkG_.js");
...
async function resolveDoctorContributionHealthChecks() {
	const { createCoreHealthChecks } = await import("./doctor-core-checks-4m0CwBy8.js");
