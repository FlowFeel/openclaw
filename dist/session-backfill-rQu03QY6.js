...
import { f as listSessionTranscriptCorpusEntriesForAgent } from "./engine-qmd-Bfljp0eq.js";
import "./memory-core-host-engine-qmd-ujGlWOto.js";
import { C as writeMemoryCoreWorkspaceEntry, b as readMemoryCoreWorkspaceEntries, m as deleteMemoryCoreWorkspaceEntry, o as SESSION_BACKFILL_REWIND_NAMESPACE } from "./dreaming-state-CswYxS-h.js";
...
import { a as mergeTrackedMessageHashes, c as sessionIngestionSourceFromCorpus, d as writeSessionIngestionState, i as foreignSessionIngestionSource, n as SESSION_INGESTION_SCORE, o as readSessionIngestionState, r as appendSessionCorpusLines, s as scanSessionIngestionSource, t as SESSION_CORPUS_RELATIVE_DIR, u as trimTrackedSessionScopes } from "./session-ingestion-VzrfcI6J.js";
import { l as readShortTermRecallEntries, r as removeGroundedShortTermCandidates, u as recordGroundedShortTermCandidates } from "./short-term-promotion-DcwUg1Fk.js";
...
async function listSessionBackfillSources(params) {
	const sources = (await listSessionTranscriptCorpusEntriesForAgent(params.agentId, { includeRetainedSqlite: true })).map(sessionIngestionSourceFromCorpus).filter((entry) => entry !== null && !entry.buildOptions.generatedByDreamingNarrative && !entry.buildOptions.generatedByCronRun);
...
function uniqueGroundedItems(results) {
...
async function applySessionBackfillDays(params) {
	...
	for (const day of params.days) {
		const grounded = uniqueGroundedItems(await appendSessionCorpusLines({
			workspaceDir: params.workspaceDir,
			day: day.day,
			lines: day.candidates
		}));
...
//#endregion
export { normalizeSessionBackfillSelection as i, executeSessionBackfillBatch as n, runSessionBackfill as r, executeSessionBackfill as t };
