import { i as normalizeProviderIdForAuth, n as findNormalizedProviderValue, r as normalizeProviderId } from "./provider-id-BIcU_2-A.js";
...
import { _ as toProviderModelAuthReadiness, a as selectOpenAIModelRouteAuth, d as resolveProviderModelRouteAuthRequirement, g as fromProviderModelAuthReadiness, h as buildProviderModelAuthSourcePlan, m as buildProviderModelAuthDirectSource, p as selectProviderModelAuthSources, r as resolveConfiguredOpenAIAuthMode, t as createOpenAIModelRoutesResolver, y as resolveMergedModelProviderConfig } from "./openai-model-routes-NsaPlbzf.js";
...
import { i as isAuthCooldownBypassedForProvider, o as isProfileInCooldown, s as resolveProfileUnusableUntil } from "./usage-state-C6UiSWt7.js";
import { a as resolveAuthProfileOrderWithMetadata, r as resolveAuthProfileEligibility, t as isConfiguredAwsSdkAuthProfileForProvider } from "./order-DCEZOH-n.js";
import { g as resolveProviderEnvAuthLookupMaps, h as listProviderEnvAuthLookupKeys, s as isKnownEnvApiKeyMarker, u as isSecretRefHeaderValueMarker } from "./model-auth-markers-Co0rjfKm.js";
import { r as resolveExternalCliAuthProfiles } from "./external-cli-sync-CELhQFMz.js";
import { r as resolveProviderEnvAuthEvidence } from "./model-auth-env-Bb6w1-EL.js";
import { n as resolveSecretRefReadOnlyAvailability, r as resolveStoredCredentialReadOnlyAvailability, t as hasMalformedSecretInputSyntax } from "./read-only-availability-BhjnXuO8.js";
import { a as hasSyntheticLocalProviderAuthConfig, b as resolveProviderEntryApiKeyProfileReference, o as hasUsableCustomProviderApiKey, w as shouldPreferExplicitConfigApiKeyAuth } from "./model-auth-provider-config-CaDHRX5w.js";
import { n as resolveManagedSecretRefRuntimeProviderAuth } from "./model-auth-runtime-config-C8rk-Iv8.js";
...
function createModelAuthAvailabilityResolver(params) {
	...
	const unprofiledEvaluation = (provider, target) => {
		...
		const inlineUsageStats = isAuthCooldownBypassedForProvider(provider) ? void 0 : store.usageStats?.[`inline-api-key:${normalizeProviderId(provider)}`];
		const inlineKeyUnusableUntil = inlineUsageStats ? resolveProfileUnusableUntil(inlineUsageStats) : null;
	...
	const directSource = (evaluation, authorization = "declared") => buildProviderModelAuthDirectSource({
	...
	const directPolicy = (provider, target) => {
		...
		const ambientEnvironmentCredential = !required && environmentMode !== void 0 && environmentMode !== "aws-sdk" ? !hasDirectMaterial : false;
		...
		}) : ((evaluation) => directSource(evaluation, evaluation.evidence === "environment" && !hasDirectMaterial ? "ambient" : "declared"))(unprofiledEvaluation(provider, target));
		return {
			binding,
			direct,
			hasDirectMaterial,
