...
import { s as isNixMode } from "./paths-CL43LNS6.js";
import { f as readConfigFileSnapshotWithPluginMetadata, z as applyConfigOverrides } from "./io-BsQc3Kgy.js";
import { a as measureDiagnosticsTimelineSpan } from "./diagnostics-timeline-BxwfDTJ-.js";
import { t as createInvalidConfigError } from "./io.invalid-config-Chuupwwv.js";
...
import { c as hasLegacyAuthProfileSourcesForStartup } from "./legacy-source-diagnostic-BXz4yX3z.js";
import { a as prepareSecretsRuntimeFastPathSnapshot, n as collectCandidateAgentDirs } from "./runtime-fast-path-DG4G5qpD.js";
import { t as applyPluginAutoEnable } from "./plugin-auto-enable-Bs1CK1Hn.js";
import { a as classifySecretResolutionErrorDegradations, c as isRetryableSecretDegradationReason, d as listSecretResolutionErrorOwners, f as redactSecretDegradationReason, t as SECRET_DEGRADATION_RETRY_HINT } from "./runtime-degraded-state-V0p9ck6P.js";
import { t as resolveAuthProfileSecretOwnerId } from "./runtime-auth-profile-owner-DOoBlxrq.js";
import { c as getActiveSecretsRuntimeSnapshotRevision, d as graftActiveSecretsRuntimeAuthState, f as hasActiveSecretsRuntimeSnapshotLineage, h as hasSameSecretReloadContract, p as hasCurrentAuthStoreCredentialsRevision, s as getActiveSecretsRuntimeSnapshot, t as activateSecretsRuntimeSnapshotState } from "./runtime-state-DhF-BA9k.js";
import { n as evaluateGatewayAuthSurfaceStates, t as GATEWAY_AUTH_SURFACE_PATHS } from "./runtime-gateway-auth-surfaces-GEqqHFRh.js";
import { r as registerProviderAuthRuntimeSnapshotActivationOwner } from "./runtime-provider-auth-activation-Q1nw7laN.js";
import { i as assertGatewayAuthNotKnownWeak, n as mergeGatewayAuthConfig, r as mergeGatewayTailscaleConfig, t as ensureGatewayStartupAuth } from "./startup-auth-Dc9f--5L.js";
...
function createRuntimeSecretsActivator(params) {
	...
	const loadSecretsRuntime = createLazyPromise(() => import("./runtime-6RXfdk6s.js"), { cacheRejections: true });
	const loadAuthProfiles = createLazyPromise(() => import("./auth-profiles-BKxSA2s6.js"), { cacheRejections: true });
