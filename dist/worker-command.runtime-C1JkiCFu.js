...
async function runWorkerDescriptor(descriptor, options = {}) {
	...
	try {
		...
		const [{ runWorkerEmbeddedTurn }, { createWorkerInferenceStreamAdapter }] = await Promise.all([import("./embedded-agent.runtime-DrpOvNKo.js"), import("./inference-stream.runtime.js")]);
