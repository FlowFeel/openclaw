...
import { C as resolveStateDir, d as resolveConfigPath, g as resolveGatewayPort, i as isDefaultInstallIdentity } from "./paths-CL43LNS6.js";
import { b as createConfigIO } from "./io-BsQc3Kgy.js";
import { n as VERSION } from "./version-CeFj_iGk.js";
import { g as resolveConfiguredLogFilePath } from "./logger-Cv9z4NYi.js";
...
import { r as trimToUndefined } from "./credential-planner-iu6FQ85p.js";
import "./credentials-BmHaFDWQ.js";
import { _ as resolveGatewayRequiredListenHosts } from "./net-B22ilI8B.js";
import { a as formatPortDiagnostics, n as inspectPortUsage, r as inspectPortUsages, t as inspectPortConnections } from "./ports-inspect-CrH88LRj.js";
import "./ports-Dvltmmu1.js";
import { o as isGatewayExternallySupervised } from "./gateway-supervision-D_xpxHux.js";
import { a as resolveGatewayService, i as readGatewayServiceState } from "./service-CbbYL0ZH.js";
import { c as pickProbeHostForBind, o as normalizeListenerAddress, s as parsePortFromArgs } from "./shared-C4IIJkT8.js";
import { t as gatewaySecretInputPathCanWin } from "./credentials-secret-inputs--DP0-Ggc.js";
import { a as readGatewaySecretInputValue, t as ALL_GATEWAY_SECRET_INPUT_PATHS } from "./secret-input-paths-BqHb6OmN.js";
import { a as resolveGatewayProbeCredentialConfig } from "./probe-auth-CN36-mge.js";
import { n as readLastGatewayErrorLine } from "./diagnostics-DNkYhwW-.js";
import { r as resolveBestEffortGatewayBindHostForDisplay, t as inspectBestEffortPrimaryTailnetIPv4 } from "./network-discovery-display-DVcaHD-k.js";
import { t as resolveAdvertisedControlUiLinks } from "./control-ui-links-Ci1IGfKN.js";
import { r as readGatewayRestartHandoffSync } from "./restart-handoff-BzS44iP7.js";
import { n as inspectWindowsGatewayFirewall } from "./windows-gateway-firewall-diagnostics-iMdCiFmV.js";
import { t as detectPluginVersionDrift } from "./plugin-version-drift-D-cJxRJb.js";
import fs from "node:fs/promises";
import JSON5 from "json5";
//#region src/cli/daemon-cli/status.gather.ts
const gatewayProbeAuthModuleLoader = createLazyImportLoader(() => import("./probe-auth-ogRKK_kl.js"));
const daemonInspectModuleLoader = createLazyImportLoader(() => import("./inspect-D9Whg19p.js"));
const launchdModuleLoader = createLazyImportLoader(() => import("./launchd-C-0BDrM8.js"));
const serviceAuditModuleLoader = createLazyImportLoader(() => import("./service-audit-XKS0M1e-.js"));
const gatewayTlsModuleLoader = createLazyImportLoader(() => import("./gateway-mxpwATm2.js"));
const daemonProbeModuleLoader = createLazyImportLoader(() => import("./probe-BdkdCxgY.js"));
const restartHealthModuleLoader = createLazyImportLoader(() => import("./restart-health-B6TGxXj-.js"));
...
async function gatherDaemonStatus(opts) {
	...
	const { command, env: serviceEnv, loaded, runtime } = await readGatewayServiceState(service, {
		env: process.env,
		timeoutMs
	});
	const useNativeServiceTargetContext = isDefaultInstallIdentity(process.env) && !isGatewayExternallySupervised(process.env);
