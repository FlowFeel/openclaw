...
import { c as isGatewayWorkAdmissionClosed, m as runWithGatewayIndependentRootWorkAdmission } from "./gateway-work-admission-BaRJo64l.js";
import { ct as loadSqliteSessionEntryReadOnly, yt as resolveSessionStorePathForScope } from "./session-accessor.sqlite-CtCo5VZ6.js";
import "./session-accessor-D5Or7WgI.js";
import { f as recordSessionHumanDirectMessage, p as recordSessionStateEvent } from "./session-state-events-COmXZrBv.js";
import { i as updateSessionUpstreamLinkMarker, n as listWatchedSessionUpstreamLinks, r as readSessionUpstreamLink, t as deleteSessionUpstreamLink } from "./session-upstream-links-UhsYefUG.js";
import { u as isEmbeddedAgentRunActive } from "./runs-Bdk5tY9J.js";
import { i as readRecentUserAssistantTextForSession } from "./transcript-DPcNCFvI.js";
import { t as computeBackoffMs } from "./delivery-recovery.shared-CehMLTLc.js";
import { c as startSessionDeliveryRuntime, o as schedulePendingSessionDeliveries } from "./subagent-completion-delivery-BMQur0_a.js";
import { n as resolveHeartbeatIntervalMs } from "./heartbeat-summary-S-VZc34p.js";
import "./embedded-agent-Cr03LQ3-.js";
import { n as startHeartbeatRunner, o as resolveHeartbeatAgents } from "./heartbeat-runner-ByanrMPP.js";
import { r as createNoopHeartbeatRunner } from "./server-runtime-startup-services-DAoeVBi2.js";
import "./server-idle-task-BfjT2Jhx.js";
...
function startPendingOutboundDeliveryRecovery(params) {
	...
	const recover = (startup) => {
		...
		const settled = runWithGatewayIndependentRootWorkAdmission(async () => {
			if (stopped) return;
			const { drainPendingDeliveries, recoverPendingDeliveries } = await import("./delivery-queue-C98BSeGR.js");
			const { deliverOutboundPayloadsInternal } = await import("./deliver-CFDx6irL.js");
			if (stopped) return;
...
function startPendingSessionDeliveryRuntime(params) {
	...
	const timer = setTimeout(() => {
		runWithGatewayIndependentRootWorkAdmission(async () => {
			const { deliverQueuedSessionDelivery, recoverPendingRestartContinuationDeliveries, settleQueuedSessionDelivery } = await import("./server-restart-sentinel-Bc6wMe2f.js");
			if (stopped) return;
