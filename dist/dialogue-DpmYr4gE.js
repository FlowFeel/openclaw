...
import { a as parseSystemAgentOperation, n as describeSystemAgentPersistentOperation } from "./operations-9m6TOUCP.js";
...
async function resolveSystemAgentOperation(input, runtime, opts) {
	...
	const planner = opts.planWithAssistant ?? (await import("./assistant-DHITTDLN.js")).planSystemAgentCommand;
	let plan;
	try {
		plan = await planner({
			input,
