...
import { c as stripLegacyBracketToolCallBlocks, l as stripMinimaxToolCallXml, m as stripFinalTags, o as stripAssistantInternalTraceLines, u as stripToolCallXmlTags } from "./assistant-visible-text-DONkuTGN.js";
...
function sanitizeUserFacingText(text, opts) {
	...
	const withoutToolCallBlocks = stripPlainTextToolCallBlocks(stripLegacyBracketToolCallBlocks(errorContext ? stripAssistantInternalTraceLines(withoutPlaceholder) : withoutPlaceholder), { resolveProtectedRanges: findCodeRegions });
...
//#endregion
export { matchesFormatErrorPattern as C, parseExecApprovalResultText as E, isTimeoutErrorMessage as S, isExecDeniedResultText as T, isOverloadedErrorMessage as _, formatTransportErrorCopy as a, isRateLimitErrorMessage as b, isLikelyHttpErrorText as c, sanitizeUserFacingText as d, coerceChatContentText as f, isBillingErrorMessage as g, isAuthPermanentErrorMessage as h, formatRateLimitOrOverloadedErrorCopy as i, isRawApiErrorPayload as l, isAuthErrorMessage as m, formatBillingErrorMessage as n, getApiErrorPayloadFingerprint as o, extractTextFromChatContent as p, formatDiskSpaceErrorCopy as r, isInvalidStreamingEventOrderError as s, BILLING_ERROR_USER_MESSAGE as t, isStreamingJsonParseError as u, isPeriodicUsageLimitErrorMessage as v, formatExecDeniedUserMessage as w, isServerErrorMessage as x, isProviderCompletedErrorFinishReasonMessage as y };
