...
import { n as getRegisteredAgentHarness, r as listRegisteredAgentHarnesses } from "./registry-DkL0MuB5.js";
import { a as unwrapSecretSentinelsForProviderEgress, i as unwrapModelHeaderSentinelsForProviderEgress } from "./provider-secret-egress-BR0AKHwJ.js";
import { f as resolveProviderRefOwnership } from "./providers-YwyHR_AL.js";
import { i as isCliRuntimeAliasForProvider } from "./model-runtime-aliases-D1mCKu2G.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-CS3ZCTG9.js";
import { _ as MissingAgentHarnessError, b as recordAgentHarnessPreflightOwner } from "./failover-error-DBKQENP4.js";
import { d as projectAgentRunAttemptTerminal, u as normalizeAgentRunAttemptTerminal } from "./agent-run-terminal-outcome-C9bgFmfC.js";
import { t as resolveAgentHarnessAutoSelectionHint } from "./auto-selection-Cid2o--p.js";
import { c as resolveAgentHarnessPreparedAuthSupport, l as resolveAgentHarnessPreparedRouteSupport, o as buildAgentHarnessSupportContext, s as compareHarnessSupport } from "./thinking-runtime-Ct74CGZn.js";
import { t as createOpenClawAgentHarness } from "./builtin-openclaw-0050ajkS.js";
import { r as assertContextEngineHostSupport } from "./host-compat-BibWlia2.js";
import { i as resolveGroupToolPolicy } from "./agent-tools.policy-7CMM1SfU.js";
...
import { t as assertSettledTurnFinalizationResult } from "./settled-turn-finalization-result-BmhJQmHW.js";
...
async function runSelectedAgentHarnessAttempt(params) {
	...
	if (internalParams.systemAgentTool && !isSystemAgentOnlyAllowlist(internalParams.toolsAllow)) throw new Error("OpenClaw host authority requires toolsAllow: [\"openclaw\"]");
	const ringZeroTools = internalParams.systemAgentTool ? [(await import("./system-agent-tool-BxF6SjGD.js")).createSystemAgentTool(internalParams.systemAgentTool)] : [];
