...
import { l as readResponseTextSnippet, p as readChunkWithIdleTimeout, u as readResponseWithLimit } from "./http-body-DhB9daEt.js";
import { n as buildTimeoutAbortSignal } from "./fetch-timeout-COlTo1hD.js";
import { a as withStrictGuardedFetchMode, r as fetchWithSsrFGuard, s as withTrustedExplicitProxyGuardedFetchMode } from "./fetch-guard-CPWMHcWe.js";
...
import { n as detectMime, r as extensionForMime } from "./mime-Ir6g3Vae.js";
...
async function fetchGuardedMediaResponse(options) {
	const { url, fetchImpl, requestInit, maxRedirects, timeoutMs, responseHeaderTimeoutMs = DEFAULT_MEDIA_RESPONSE_HEADER_TIMEOUT_MS, ssrfPolicy, lookupFn, dispatcherPolicy, dispatcherAttempts, shouldRetryFetchError, trustExplicitProxyDns } = options;
