...
import { k as compileSafeRegex } from "./redact-DUpJZuMu.js";
import { n as findNormalizedProviderValue, r as normalizeProviderId } from "./provider-id-BIcU_2-A.js";
import { a as parseModelCatalogRef, t as buildModelCatalogMergeKey } from "./model-catalog-refs-C_8nyypZ.js";
import { n as listAgentEntries } from "./agent-scope-config-Dusa8eSA.js";
import { i as listModelRefsFromConfigValue, r as collectConfiguredModelRefs } from "./configured-model-refs-XCtO9k7W.js";
import { t as planEffectiveModelCatalogRows } from "./model-catalog-BEn_zNk0.js";
import { c as readResponseTextPrefix } from "./http-body-DhB9daEt.js";
import { y as ssrfPolicyFromHttpBaseUrlAllowedHostname } from "./ssrf-C889LYfv.js";
...
import { S as requireActivePluginRegistry } from "./runtime-yJAYArQt.js";
import { n as normalizeConfiguredSpeechProviderIdForStartup, t as collectConfiguredSpeechProviderIds } from "./gateway-startup-speech-providers-D5MWaJ4Z.js";
import { t as splitTrailingAuthProfile } from "./model-ref-profile-BIKs-96s.js";
import { t as collectConfiguredAgentHarnessRuntimes } from "./harness-runtimes-C8_R8wpu.js";
import { h as hashJson } from "./installed-plugin-index-CqNI0grC.js";
import { i as normalizePluginsConfigWithResolver } from "./config-normalization-shared-B5KhIpWf.js";
import { o as normalizePluginId, u as resolveEffectivePluginActivationState } from "./config-state-B6-Feb6H.js";
import { t as isPluginEnabledByDefaultForPlatform } from "./default-enablement-CEIbpabL.js";
import "./installed-plugin-index-store-wgyw6sCS.js";
...
import { s as createPluginRegistryIdNormalizer } from "./plugin-registry-snapshot-_sDMVMul.js";
import { s as normalizePluginIdScope } from "./current-plugin-metadata-snapshot-krwg-Yx5.js";
import { r as normalizePluginsConfigWithRegistry } from "./plugin-registry-contributions-DAYph4GM.js";
import { n as hasExplicitChannelConfig, o as listExplicitConfiguredChannelIdsForConfig } from "./channel-presence-policy-DhrCS5Fz.js";
import { C as resolveMemoryDreamingPluginConfig, S as resolveMemoryDreamingConfig, l as DEFAULT_MEMORY_DREAMING_PLUGIN_ID, w as resolveMemoryDreamingPluginId } from "./dreaming-CisvAHct.js";
import { t as readBundledDiscoveryMode } from "./bundled-discovery-state-WuR9rZhk.js";
import { t as collectPluginConfigContractMatches } from "./config-contract-matches-Ceh4tTIp.js";
import "./config-contracts-8KMGFuDY.js";
import { i as normalizeWorkerProviderIds, r as manifestOwnsWorkerProvider, t as collectConfiguredWorkerProviderIds } from "./worker-provider-registry-db6cfAVj.js";
...
function listPotentialEnabledChannelIds(config, env, ambientEnvTriggers = "allow") {
	const disabled = new Set(listExplicitlyDisabledChannelIdsForConfig(config));
	return sortUniquePluginIds([...listPotentialConfiguredChannelIds(config, env, {
...
function collectConfiguredStartupChannelIds(params) {
	return sortUniquePluginIds([...listPotentialEnabledChannelIds(params.config, params.env, params.ambientEnvTriggers), ...listPotentialEnabledChannelIds(params.activationSourceConfig, params.env, params.ambientEnvTriggers)]);
}
...
function resolveGatewayStartupPluginPlanFromRegistry(params) {
	...
	const configuredChannelIds = new Set(listPotentialEnabledChannelIds(params.config, params.env, params.ambientEnvTriggers));
