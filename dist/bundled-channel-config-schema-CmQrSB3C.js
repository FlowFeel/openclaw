...
import { F as SecretRefSchema, J as requireOpenAllowFrom, _ as DmPolicySchema, p as ChannelDeliveryStreamingConfigSchema, q as requireAllowlistAllowFrom } from "./zod-schema.agent-runtime-CaWcMFul.js";
import { n as sensitive } from "./zod-schema.sensitive-OPEpgIMg.js";
import { o as buildGroupEntrySchema } from "./config-schema-CPBvH4gM.js";
...
import { l as buildChannelReactionShape, r as ChannelSendReadReceiptsSchema, s as buildChannelAllowBotsSchema, t as ChannelDangerouslyAllowNameMatchingSchema, u as buildCommonChannelAccountShape } from "./channel-config-schema-DElcW4F1.js";
...
function loadBundledConfigSchema(dirName, exportName) {
	const schema = loadBundledPluginPublicSurfaceModuleSync({
		dirName,
