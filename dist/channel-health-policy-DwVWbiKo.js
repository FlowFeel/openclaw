...
function resolveChannelHealthState(snapshot, evaluation) {
...
function evaluateChannelHealth(snapshot, policy) {
	...
	if ((snapshot.lifecycle === "starting" || snapshot.lifecycle === "recovering") && lastStartAt != null && policy.now - lastStartAt < policy.channelConnectGraceMs) return {
		healthy: true,
	...
	if (snapshot.lifecycle === void 0 && lastStartAt != null) {
