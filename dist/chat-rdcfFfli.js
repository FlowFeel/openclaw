...
import { C as loadSessionEntryReadOnly, S as loadSessionEntry, j as getSessionDefaults, x as listAgentsForGateway } from "./session-utils-row-Cby7i9PV.js";
import { t as listGatewayAgentsBasic } from "./agent-list-c7Bg3rPD.js";
import { i as buildGatewaySessionInfo } from "./session-utils-list-Ci5hylG_.js";
...
import { d as resolveInFlightRunSnapshot, i as boundInFlightRunSnapshotForChatHistory } from "./chat-abort-dteij8GM.js";
...
import { n as resolveChatHistoryWithCliSessionImports } from "./cli-session-history-BO3gNY_B.js";
import { C as scheduleChatHistoryManagedMediaCleanup, L as normalizeOptionalChatText, o as appendAssistantTranscriptMessage } from "./chat-abort-runtime-iIaJzH0Q.js";
import { t as assertValidParams } from "./validation-DyQ6nhKI.js";
import { t as handleChatAbortRequest } from "./chat-abort-handler-rOGJ5uw3.js";
import { a as sendGlobalAwareNodeChatPayload, n as resolveRequestedChatAgentId, r as validateChatSelectedAgent, t as handleChatSend } from "./chat-send-handler-gItQ3AxV.js";
...
async function buildChatStartupMetadataResult(params) {
	...
	try {
		const { buildModelsListResult } = await import("./models-list-result-BeC7LT8X.js");
...
async function buildChatMetadataResult(params) {
	const [{ buildModelsListResult }, { buildCommandsListResult }] = await Promise.all([import("./models-list-result-BeC7LT8X.js"), import("./commands-list-result-CHA-z0pW.js")]);
...
async function buildChatStartupModelCatalogProjection(params) {
	const { createGatewayAgentModelCatalogProjector } = await import("./models-list-result-BeC7LT8X.js");
...
const chatHandlers = {
	...
	"chat.toolTitles": async ({ params, respond, context }) => {
		...
		const { generateToolCallTitles } = await import("./chat-tool-titles-D9hYWEXL.js");
