...
import { l as createApprovalReactionTargetStore } from "./approval-reaction-runtime-BErcJRtn.js";
...
const reportPersistentApprovalReactionError = createPluginStateErrorReporter(getOptionalMatrixRuntime, "matrix", "approval-reaction-state", "Matrix persistent approval reaction state failed");
