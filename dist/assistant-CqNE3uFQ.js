...
async function runConfiguredSystemAgentText(params) {
	...
	try {
		...
		text = extractPlannerResultText(route.runner === "cli" ? await (params.deps?.runCliAgent ?? (await import("./cli-runner-DDsvZuYF.js")).runCliAgent)({
			...shared,
			executionMode: "side-question",
			cleanupCliLiveSessionOnRunEnd: true
		}) : await (params.deps?.runEmbeddedAgent ?? (await import("./embedded-agent-D3IzfMqr.js")).runEmbeddedAgent)({
			...shared,
			toolsAllow: [],
