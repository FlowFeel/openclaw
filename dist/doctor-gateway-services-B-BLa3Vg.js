...
import { g as resolveGatewayPort, i as isDefaultInstallIdentity, v as resolveIsNixMode } from "./paths-CL43LNS6.js";
...
import { i as readWindowsProcessArgsSync } from "./windows-port-pids-DA0cG5BM.js";
import { _ as uninstallLegacySystemdUnits, c as isSystemdUnitActive, k as readManagedServiceEnvKeysFromEnvironment, n as findSystemdGatewayInstallation, o as isSystemUnitActiveAndEnabled, y as uninstallUserSystemdGatewayUnit } from "./systemd-CE12Te8p.js";
import { t as OPENCLAW_WRAPPER_ENV_KEY } from "./program-args-Cz_xMqj6.js";
...
import { a as resolveSystemNodeInfo, r as renderSystemNodeWarning } from "./runtime-paths-Cq-e39KV.js";
...
import "./launchd-DT4INyGN.js";
import { h as isLaunchctlNotLoaded } from "./launchd-system-D_F_vqDz.js";
import { a as readEmbeddedGatewayToken, i as needsNodeRuntimeMigration, n as auditGatewayServiceConfig, t as SERVICE_AUDIT_CODES } from "./service-audit-iHiQAYcV.js";
import { n as NON_DEFAULT_INSTALL_SERVICE_SKIP_REASON } from "./gateway-supervision-D_xpxHux.js";
import { a as resolveGatewayService } from "./service-CbbYL0ZH.js";
import { d as readWindowsStartupFallbackRuntimeForUpdate } from "./schtasks-CBjn0Lrl.js";
import { i as renderGatewayServiceCleanupHints, n as findExtraGatewayServices } from "./inspect-Oof9mNlI.js";
import { t as note } from "./note-uiKX_qfX.js";
import { i as UPDATE_PARENT_ALLOWS_GATEWAY_SERVICE_REPAIR_ENV, r as UPDATE_PARENT_ALLOWS_GATEWAY_ACTIVATION_ENV } from "./update-phase-Br5TVkeJ.js";
...
import { t as isDoctorUpdateRepairMode } from "./doctor-repair-mode-DIFaTbao.js";
...
const runLaunchctlQuietly = async (args, timeoutMs = DOCTOR_LAUNCHCTL_TIMEOUT_MS) => {
	try {
		return {
			status: "succeeded",
			...await runExec("launchctl", args, {
				logOutput: false,
				timeoutMs
			})
		};
		...
		return {
			...
			timedOut: record.timedOut === true || record.noOutputTimedOut === true || /\bcommand timed out\b/i.test(message)
		};
	}
};
async function confirmLegacyLaunchdServiceUnloaded(serviceTarget) {
	...
	while (Date.now() < deadline) {
		...
		const probe = await runLaunchctlQuietly(["print", serviceTarget], Math.min(DOCTOR_LAUNCHCTL_TIMEOUT_MS, remainingMs));
		if (probe.status === "failed") return !probe.timedOut && isLaunchctlNotLoaded(probe);
...
async function maybeResolveDuelingSystemdGatewayScopes(runtime, prompter) {
	...
	note(["The system-scope unit is the active or boot-enabled supervisor and is", "treated as authoritative; the user-scope unit is the redundant leftover."].join("\n"), "System-scope unit owns the gateway");
