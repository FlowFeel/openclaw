...
import { c as resolveAuthProfileDatabasePath, f as resolveSharedMainAuthAgentDir } from "./sqlite-DQLy89x1.js";
...
var AuthProfileStoreUnreadableError = class extends Error {
	constructor(agentDir) {
		super(`Auth profile store ${shortenHomePath(resolveAuthProfileDatabasePath(agentDir))} is unreadable; run ${AUTH_PROFILE_MIGRATION_COMMAND}.`);
