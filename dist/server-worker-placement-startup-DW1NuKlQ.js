...
import { M as hasNonzeroUsage, P as normalizeUsage, p as withSqliteTranscriptWriteTransaction, st as loadSqliteSessionEntry } from "./session-accessor.sqlite-B9iW7DOt.js";
import { _t as interruptSessionWorkAdmissions, lt as SESSION_WORK_ADMISSION_DRAIN_TIMEOUT_MS, wt as runExclusiveSessionStoreWrite, xt as runExclusiveSessionLifecycleMutation } from "./session-entry-slot-keys-DR5d2mKt.js";
...
import { N as convertToLlm } from "./agent-core-DwxIhy3z.js";
...
import { n as projectConversationToolNames } from "./conversation-tool-policy-pipeline-BiWQNhd3.js";
...
import { S as mergeUsageIntoAccumulator, a as buildUsageAgentMetaFields, b as createUsageAccumulator, v as resolveReportedModelRef } from "./helpers-DOU3STAD.js";
...
import { n as recoverWorkerWorkspaceReconciliation } from "./workspace-reconcile-DRy0gf8w.js";
import { a as deleteWorkerWorkspaceResultCleanupRefs, c as moveStagedWorkerWorkspaceResultToCleanup, d as workerWorkspaceResultRef, i as deleteStagedWorkerWorkspaceResult, l as preparedWorkerWorkspaceResultRef, n as applyStagedWorkerWorkspaceResult, o as hasWorkerWorkspaceResultRef, r as cleanupWorkerWorkspaceResultRef, s as isWorkerWorkspaceResultCleanupRef, t as WorkerTunnelOwnerDisconnectedError, u as restoreStagedWorkerWorkspaceResultFromCleanup } from "./tunnel-contract-HJ3wADfR.js";
import { n as workerEnvironmentIdForIdempotencyKey } from "./service-YmCKFsS6.js";
...
import { t as ActiveTurnClaimError } from "./placement-turn-claims-BNwUEWk7.js";
...
const loadWorkerPlacementSessionRuntimeModule = createLazyRuntimeModule(async () => {
	const [placementSessionRuntime, { managedWorktrees }, sessionUtils] = await Promise.all([
		import("./placement-session-runtime-Bc0PBtn0.js"),
		import("./service-BKr2mJcS.js"),
