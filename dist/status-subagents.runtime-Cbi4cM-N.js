...
import { n as buildControlledSubagentRunsReadContext } from "./subagent-control-DeOJbVi3.js";
...
function formatActiveSubagentDetail(params) {
	...
	const duration = formatDurationCompact(Math.max(0, (entry.execution.endedAt && pendingDescendants === 0 ? entry.execution.endedAt : now) - startedAt), { spaced: true }) ?? "0s";
