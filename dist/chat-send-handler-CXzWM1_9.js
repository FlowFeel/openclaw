...
import { a as shouldComputeCommandAuthorized } from "./command-detection-DwmuMNEC.js";
import { n as resolveAgentTimeoutMs } from "./timeout-BEGWfRGM.js";
import { h as isReplyRunAbortableForSignal, w as replyRunRegistry } from "./reply-run-registry-CA3-OJtf.js";
import { f as listActiveEmbeddedRunSessionIds } from "./run-state-D3E5NYGs.js";
...
import { i as dispatchInboundMessageWithProjectedDispatcher } from "./dispatch-BgmlHFIk.js";
import { t as chatAbortMarkerTimestampMs } from "./server-chat-state-C8AVcQU8.js";
import { f as updateChatRunProvider, o as isChatStopCommandText, s as registerChatAbortController, u as resolveChatRunExpiresAtMs } from "./chat-abort-BvCyxb9W.js";
...
import { a as parseMessageWithAttachments, i as logAttachmentFailure, n as MediaOffloadError, o as persistInboundImagesForTranscript, r as UnsupportedAttachmentError, s as stripImageMediaMarkers, t as normalizeRpcAttachmentsToChatAttachments } from "./attachment-normalize-n86LTUwu.js";
import { i as maybeGenerateDashboardSessionTitle, r as isDashboardSessionTitleCandidate } from "./dashboard-session-title-0E220cUn.js";
import { _ as gatewayClientSenderFields } from "./session-sharing-CSGmZX63.js";
import { t as emitSessionsChanged } from "./session-change-event-BvS0Y-TK.js";
import { i as persistGatewaySessionLifecycleEvent } from "./session-lifecycle-state-BpTfI1qG.js";
...
async function resolveDurableChatClaim(params) {
	...
	if (isAdoptedRestartRecoveryClaim(entry, params.clientRunId) && entry.status === "running" && entry.abortedLastRun === true) {
		...
		try {
			const { retryRestartAbortedMainSessionRecovery } = await import("./main-session-restart-recovery-BESfitEw.js");
