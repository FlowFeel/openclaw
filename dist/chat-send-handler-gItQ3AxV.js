...
import { a as shouldComputeCommandAuthorized } from "./command-detection-DYoTJurA.js";
import { n as resolveAgentTimeoutMs } from "./timeout-BEGWfRGM.js";
import { h as isReplyRunAbortableForSignal, w as replyRunRegistry } from "./reply-run-registry-DHsv7Iln.js";
import { f as listActiveEmbeddedRunSessionIds } from "./run-state-VfGqytOx.js";
...
import { i as dispatchInboundMessageWithProjectedDispatcher } from "./dispatch-B1tBw145.js";
import { t as chatAbortMarkerTimestampMs } from "./server-chat-state-C8AVcQU8.js";
import { f as updateChatRunProvider, o as isChatStopCommandText, s as registerChatAbortController, u as resolveChatRunExpiresAtMs } from "./chat-abort-dteij8GM.js";
...
import { a as parseMessageWithAttachments, i as logAttachmentFailure, n as MediaOffloadError, o as persistInboundImagesForTranscript, r as UnsupportedAttachmentError, s as stripImageMediaMarkers, t as normalizeRpcAttachmentsToChatAttachments } from "./attachment-normalize-BJjpAKdr.js";
...
import { i as persistGatewaySessionLifecycleEvent } from "./session-lifecycle-state-Bx2dmMgx.js";
...
async function resolveDurableChatClaim(params) {
	...
	if (isAdoptedRestartRecoveryClaim(entry, params.clientRunId) && entry.status === "running" && entry.abortedLastRun === true) {
		...
		try {
			const { retryRestartAbortedMainSessionRecovery } = await import("./main-session-restart-recovery-BFXPLv6x.js");
