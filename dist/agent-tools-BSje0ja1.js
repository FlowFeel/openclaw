...
import { H as listChannelAgentTools, l as rewrapToolWithBeforeToolCallHook, u as wrapToolWithBeforeToolCallHook } from "./agent-tools.before-tool-call-Cp_0kD4x.js";
import { B as hasOnlyCrlfLineEndings, H as restoreLineEndings, L as withFileMutationQueue, R as withFileMutationQueues, T as createReadTool, V as normalizeToLF, v as createCodingTools, z as decodeUtf8File } from "./sessions-Digi7ATr.js";
...
import { i as getPluginToolMeta, s as appendRuntimePluginToolGrant } from "./tools-DfrDsxdD.js";
...
import { b as isToolWrappedWithBeforeToolCallHook, c as wrapToolWithGatewayCallerIdentity, l as copyAgentToolMetadata } from "./gateway-CRcKH8Wu.js";
import { S as TOOL_SEARCH_CODE_MODE_TOOL_NAME, b as TOOL_CALL_RAW_TOOL_NAME, r as createToolSearchTools, s as resolveToolSearchConfig, w as TOOL_SEARCH_RAW_TOOL_NAME, x as TOOL_DESCRIBE_RAW_TOOL_NAME } from "./tool-search-D5dHCO-e.js";
...
import { C as wrapToolWorkspaceRootGuard, E as withMemoryWriteProvenance, S as wrapToolMemoryFlushAppendOnlyWrite, T as createMemoryWriteProvenanceObserver, _ as createOpenClawReadTool, b as createSandboxedWriteTool, g as createHostWorkspaceWriteTool, h as createHostWorkspaceEditTool, m as resolveOpenClawPluginToolsForOptions, p as filterToolsByClientCaps, t as createOpenClawTools, v as createSandboxedEditTool, w as wrapToolWorkspaceRootGuardWithOptions, x as wrapReadToolWithSkillContent, y as createSandboxedReadTool } from "./openclaw-tools-CoDz4vSH.js";
...
import { s as shouldSuppressManagedWebSearchTool } from "./codex-native-web-search-core-BFrvKxD-.js";
import "./codex-native-web-search-wQUWrRah.js";
...
const bashToolsModuleLoader$1 = createLazyImportLoader(() => import("./bash-tools-Ce8FJhA1.js"));
...
const bashToolsModuleLoader = createLazyImportLoader(() => import("./bash-tools-Ce8FJhA1.js"));
