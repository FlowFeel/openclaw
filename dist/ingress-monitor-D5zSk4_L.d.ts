import { c as ChannelIngressQueue, l as ChannelIngressQueueClaim, n as CreateChannelIngressDrainOptions, p as ChannelIngressQueueRecord } from "./ingress-drain-B5QzvPtQ.js";
...
type CreateChannelIngressMonitorOptions<TRaw, TBody, TStoredPayload, TMetadata> = {
  ...
  waitForDeliveryIdleOnStop?: boolean; /** Tracks deferred reply ownership through stop, abort, or an explicit channel-owned wait. */
