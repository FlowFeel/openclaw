...
import { n as resolveManifestProviderAuthChoice, t as resolveManifestDeprecatedProviderAuthChoice } from "./provider-auth-choices-_vLe6VPC.js";
import { t as applyAutoLocalModelLean } from "./local-model-lean-auto-DK4EDa6q.js";
import { r as resolveProviderInstallCatalogEntry, t as resolveDeprecatedProviderInstallCatalogEntry } from "./provider-install-catalog-B69Hv4PV.js";
import { a as normalizeSecretInputModeInput } from "./provider-auth-input-BZW5CuzH.js";
import { r as formatAuthChoiceChoicesForCli } from "./auth-choice-options-CAS1RRFE.js";
import { i as resolveDeprecatedAuthChoiceReplacement, n as isDeprecatedAuthChoice, t as formatDeprecatedNonInteractiveAuthChoiceError } from "./auth-choice-legacy-CVNMK8Hu.js";
import { t as resolvePreferredProviderForAuthChoice } from "./provider-auth-choice-preference-BIrP25iY.js";
import { t as normalizeApiKeyTokenProviderAuthChoice } from "./auth-choice.apply.api-providers-CcTQX1ya.js";
import { n as ensureCodexRuntimePluginForModelSelection, t as CODEX_RUNTIME_PLUGIN_ID } from "./codex-runtime-plugin-install-DmF2gONd.js";
...
import { t as ensureCopilotRuntimePluginForModelSelection } from "./copilot-runtime-plugin-install-Dd9scNM1.js";
...
async function applyNonInteractivePluginProviderChoice(params) {
	...
	if (!providerChoice) {
		...
		const { ensureOnboardingPluginInstalled } = await import("./onboarding-plugin-install-qxY2v61f.js");
	...
	if (codexInstall.installed) {
		const { offerPostInstallMigrations } = await import("./setup.post-install-migration-CFDOCVZw.js");
