...
import { d as OLLAMA_LOCAL_CONTEXT_TOKENS, i as OLLAMA_DEFAULT_BASE_URL, o as OLLAMA_DEFAULT_COST, s as OLLAMA_DEFAULT_MAX_TOKENS } from "./defaults-h8fOLDCy.js";
...
function isKnownOllamaCloudReasoningModel(modelId) {
	const normalized = modelId.trim().toLowerCase().replace(/:cloud$/, "");
...
//#endregion
export { resolveOllamaApiBase as _, buildOllamaProvider as a, enrichOllamaCompletionModels as c, fetchOllamaModels as d, isOllamaCloudModel as f, readOllamaModelShowInfo as g, queryOllamaModelShowInfo as h, buildOllamaModelDefinition as i, enrichOllamaModelsWithContext as l, queryOllamaContextWindow as m, buildDefaultOllamaCloudModelDefinition as n, capLocalOllamaModelContext as o, isReasoningModelHeuristic as p, buildOllamaBaseUrlSsrFPolicy as r, capLocalOllamaProviderContext as s, readProviderBaseUrl as t, fetchLoadedOllamaModelNames as u, throwIfOllamaRequestAborted as v };
