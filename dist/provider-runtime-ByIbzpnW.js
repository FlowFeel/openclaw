...
import { n as applyPluginTextReplacements, r as mergePluginTextTransforms, t as resolveRuntimeTextTransforms } from "./text-transforms.runtime-CzlkCllE.js";
...
import { c as resolveProviderHookPlugin, i as resolveLoadedProviderRuntimePlugin, l as resolveProviderPluginsForHooks, n as ensureProviderRuntimePluginHandle, t as clearProviderRuntimePluginCacheForTest, u as resolveProviderRuntimePlugin } from "./provider-hook-runtime-CJN_HH27.js";
...
async function resolveProviderUsageSnapshotWithPlugin(params) {
	...
	if (!harness) {
		...
		const { ensureSelectedAgentHarnessPlugin } = await import("./runtime-plugin-C9xqVwzQ.js");
