...
import { a as listUsableProviderAuthProfileIds } from "./provider-auth-Cot2SGgW.js";
import { c as resolveTimeoutSeconds, i as readCache, l as writeCache, o as resolveCacheTtlMs, r as normalizeCacheKey } from "./web-shared-GN7fVb2k.js";
...
import { i as resolveProviderWebSearchPluginConfig, r as mergeScopedSearchConfig, t as getScopedCredentialValue } from "./web-search-provider-config-CZc1Mkyg.js";
import { t as resolveWebSearchProviderCredential } from "./provider-web-search-Cw9nqgAP.js";
...
import { n as setPluginXSearchConfigValue, t as resolveEffectiveXSearchConfig } from "./x-search-config-_AHlY_PG.js";
import { a as requireXaiResponseTextCitationsAndInline, n as buildXaiResponsesToolBody, o as resolveXaiResponsesEndpoint, r as extractXaiWebSearchContent } from "./responses-tool-shared-CiwtsHL1.js";
import { t as XAI_DEFAULT_X_SEARCH_MODEL } from "./x-search-shared-DlMjfY6M.js";
...
async function requestXaiWebSearch(params) {
	...
	return await postTrustedWebToolsJson({
		...
		return requireXaiResponseTextCitationsAndInline(await readProviderJsonObjectResponse(response, "xAI web search failed"), "xAI web search failed", params.inlineCitations, XAI_WEB_SEARCH_MAX_CONTENT_CHARS);
	}).catch((error) => {
