...
import { r as buildConfiguredAgentSystemPrompt, t as buildSystemPromptParams } from "./system-prompt-params-DHodj0v2.js";
import { n as detectImageReferences, t as detectAndLoadPromptImages } from "./images-B2Oatti_.js";
...
async function prepareCliPromptImagePayload(params) {
	...
	const imageResult = params.imagePrompt !== void 0 || Boolean(params.media?.length) || !params.images?.length && detectImageReferences(imagePrompt).length > 0 ? await detectAndLoadPromptImages({
		prompt: imagePrompt,
		media: params.media,
		workspaceDir: params.workspaceDir,
