...
import { n as getLoadedChannelPlugin, t as getChannelPlugin } from "./registry-DOSZ6AfI.js";
import "./plugins-DYLnGbXq.js";
import { t as describeBinding } from "./agents.binding-format-C3S9Mq5U.js";
import { t as applyAgentBindings } from "./agents.bindings-DILqpWR6.js";
...
async function loadOnboardChannels() {
	return await import("./onboard-channels-yrpTV2ON.js");
}
...
async function resolveInitialWizardChannel(raw, cfg) {
	...
	const [{ listActiveChannelSetupPlugins }, { resolveChannelSetupEntries }] = await Promise.all([import("./setup-registry-CwPJJ-zX.js"), import("./discovery-DnMqkCc3.js")]);
...
async function runChannelsAddWizardFlow(params) {
	...
	const [{ buildAgentSummaries }, onboardChannels] = await Promise.all([import("./agents.config-D98gR2Q-.js"), loadOnboardChannels()]);
