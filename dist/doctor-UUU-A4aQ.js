...
import { n as formatConsoleDiagnosticLine } from "./json-console-line-On_OD80Q.js";
...
import { i as withDoctorSqliteMaintenanceLock, r as isDestructiveDoctorSessionSqliteMode } from "./doctor-sqlite-maintenance-lock-rpLk9K-Z.js";
...
async function doctorCommand(runtime, options) {
	if (options?.stateSqlite) {
		...
		const { runDoctorStateSqliteCompact } = await import("./doctor-state-sqlite-compact-BXRlSjFr.js");
	...
	await (await import("./doctor-health-bzUE_7LY.js")).doctorCommand(runtime, options);
}
