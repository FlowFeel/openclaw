...
import { m as readProviderJsonResponse, p as readProviderJsonObjectResponse } from "./provider-http-errors-Dm9G78mz.js";
import { d as resolveProviderRequestHeaders } from "./provider-request-config-DZemMjbU.js";
import { n as PROVIDER_LABELS, o as providerUsageLabel, r as clampPercent, s as resolveProviderUsageDisplayName$1 } from "./provider-usage.shared-C4x5KiVT.js";
...
function buildUsageErrorSnapshot(provider, error) {
	return {
		provider,
		displayName: resolveProviderUsageDisplayName$1(provider),
		windows: [],
		error
	};
}
