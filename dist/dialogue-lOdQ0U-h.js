...
import { a as parseSystemAgentOperation, n as describeSystemAgentPersistentOperation } from "./operations-BtNayaH5.js";
...
async function resolveSystemAgentOperation(input, runtime, opts) {
	...
	const planner = opts.planWithAssistant ?? (await import("./assistant-CqNE3uFQ.js")).planSystemAgentCommand;
	let plan;
	try {
		plan = await planner({
			input,
