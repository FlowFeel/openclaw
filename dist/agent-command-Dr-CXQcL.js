...
import { c as resolveAgentDir, f as resolveDefaultAgentId, i as listAgentIds, n as listAgentEntries, o as resolveAgentConfig, u as resolveAgentWorkspaceDir } from "./agent-scope-config-Dusa8eSA.js";
import { n as normalizeAgentId } from "./agent-id-DDgUze4y.js";
import { a as isSubagentSessionKey } from "./session-key-utils-02xWdGSz.js";
import { c as classifySessionKeyShape, f as resolveAgentIdFromSessionKey, g as scopeLegacySessionKeyToAgent, l as isUnscopedSessionKeySentinel } from "./session-key-DtTE9-Tg.js";
import { d as readConfigFileSnapshotForWrite, r as getRuntimeConfig } from "./io-DCw4R0kD.js";
...
import { f as stripInternalRuntimeContext, l as hasInternalRuntimeContext } from "./internal-runtime-context-s8_TwHnQ.js";
import { u as isSecretRef } from "./types.secrets-BvApkFoj.js";
import { g as withAgentRunLifecycleGeneration, i as emitAgentEvent, n as captureAgentRunLifecycleGeneration, t as assertAgentRunLifecycleGenerationCurrent } from "./agent-events-COCf-9-O.js";
import { p as registerAgentRunContext, r as clearAgentRunContext } from "./agent-run-registry-BluEqSPq.js";
import { A as withPluginRuntimeGatewayRequestScope, S as requireActivePluginRegistry, k as getPluginRuntimeGatewayRequestScope } from "./runtime-yJAYArQt.js";
import { a as listOpenAIAuthProfileProvidersForAgentRuntime } from "./openai-routing-G4z6ipSe.js";
import { t as modelKey } from "./model-key-BaNhQShd.js";
import { D as hasSessionAutoModelFallbackProvenance, O as resolveSessionModelOverrideRouteResolution, S as resolveEffectiveAgentSkillFilter, a as markAutoFallbackPrimaryProbe, g as resolveSessionAgentId, i as hasLegacyAutoFallbackWithoutOrigin, m as resolveEffectiveModelFallbacks, n as entryMatchesAutoFallbackPrimaryProbe, o as resolveAgentEffectiveModelPrimary, p as resolveAutoFallbackPrimaryProbe, t as clearAutoFallbackPrimaryProbeSelection } from "./agent-scope-DyEposw2.js";
...
import { w as setRuntimeConfigSnapshot } from "./runtime-snapshot-DLOCFXOE.js";
import { n as DEFAULT_MODEL, r as DEFAULT_PROVIDER } from "./defaults-CdX9UGcX.js";
import { n as isThinkingLevelSupported, t as formatThinkingLevels } from "./thinking-CLPqbAwx.js";
import { C as resolveModelRefFromString, S as resolveModelAliasFromPair, a as buildModelAliasIndex, b as resolveConfiguredModelRef, i as buildConfiguredModelCatalog } from "./model-selection-shared-BDTPW9Jk.js";
import { a as normalizeConfiguredProviderCatalogModelId, o as normalizeModelRef, s as normalizeProviderId } from "./model-ref-shared-BCBRWGJh.js";
import { w as resolveDefaultModelForAgent } from "./codex-route-model-ref-B7v0y8up.js";
import { r as discoverConfigSecretTargetsByIds } from "./target-registry-query-Dzi3tmBI.js";
import "./target-registry-BfTxQydT.js";
import { n as isStoredCredentialCompatibleWithAuthProvider } from "./order-DCEZOH-n.js";
import { a as getReplyPayloadMetadata } from "./reply-payload-BtIUrr9c.js";
import { d as sessionDeliveryOrigin, s as normalizeDeliveryContext, u as sessionDeliveryChannel } from "./delivery-context.shared-B-QSuGw_.js";
import "./message-channel-constants-76XnXM8q.js";
import { M as hasNonzeroUsage, lt as patchSqliteSessionEntry } from "./session-accessor.sqlite-B9iW7DOt.js";
import { o as resolveMessageChannel, t as isDeliverableMessageChannel } from "./message-channel-normalize-Bmutiks_.js";
import "./message-channel-1n7hD5_u.js";
import { d as AGENT_HARNESS_MODEL_RUN_FORBIDDEN_MESSAGE, n as buildRestartRecoveryClaimCleanupPatch, ut as beginSessionWorkAdmission, v as isValidAgentHarnessSessionStoreEntry, y as resolveAgentHarnessSessionContextError } from "./session-entry-slot-keys-DR5d2mKt.js";
...
import { s as loadResolvedPublishedModelCatalogOwner, t as getPreparedModelCatalogSnapshot } from "./prepared-model-catalog-BuSADUR3.js";
import { a as findConfiguredModelProvider, i as allowsPluginModelNormalization } from "./model-fallback-candidates-BpLgl8mT.js";
import { n as resolveThinkingDefault, t as resolveConfiguredThinkingDefault } from "./model-thinking-default-VKKhnMLC.js";
import "./model-selection-D5gxVbBh.js";
import { p as ensureAgentWorkspace } from "./workspace-CelKqYGr.js";
import { t as ensureSelectedAgentHarnessPlugin } from "./runtime-plugin-q2V_5kgr.js";
import { f as recordSessionHumanDirectMessage, n as classifySessionStateActor } from "./session-state-events-MWtkoPhW.js";
import "./agent-run-terminal-outcome-DXPF-TAc.js";
import { c as isAgentRunDirectAbortReason, d as resolveAgentRunErrorLifecycleFields, l as isAgentRunRestartAbortReason, o as createAgentRunRestartAbortError, p as throwAgentRunRestartAbortReason, u as resolveAgentRunAbortLifecycleFields } from "./run-termination-nrLSEQ_b.js";
...
import { c as resolveCronJobsStorePath } from "./store-865CL89i.js";
...
import { a as resolveEffectiveAgentRuntime, i as resolveCandidateThinkingLevel, n as hasResolvedThinkingCatalogEntry, r as normalizeThinkingCatalogProviders } from "./thinking-runtime-1FRCPyWR.js";
import { t as resolveFastModeState } from "./fast-mode-DRb2pnqM.js";
import { o as isAgentMediatedCompletionSourceTool } from "./input-provenance-CYGbY89H.js";
import { a as normalizePendingFinalRecoveryPayloads, i as normalizePendingFinalDeliveryPayloads, r as buildRecoverablePendingFinalDeliveryText } from "./pending-final-delivery-BzZojDaN.js";
import { r as repairMainSessionRecoveryMutation } from "./main-session-recovery-lifecycle-CrLAHQ2O.js";
import { a as releaseMainSessionRecoveryOwner, i as refreshMainSessionRecoveryOwner, r as inspectMainSessionRecoveryRequired, t as claimMainSessionRecoveryOwner } from "./main-session-recovery-store-BLi4qSF0.js";
import { n as resolveSendPolicy } from "./send-policy-BKJvZqJK.js";
import { t as scheduleMainSessionRecoveryPendingTarget } from "./main-session-recovery-owner-release-pRGcuSbR.js";
import { a as createUserTurnTranscriptRecorder } from "./user-turn-transcript-Cd8sokau.js";
import { i as hasVisibleAgentPayload } from "./message-visibility-Cv_6nt4F.js";
import { a as isAgentDeletionBlocked } from "./agent-lifecycle-registry-BngfIWZE.js";
import { t as buildOutboundSessionContext } from "./session-context-DdqCb4cM.js";
import { _ as hasVisibleCommittedMessagingToolDeliveryEvidence, c as hasCommittedOutboundDeliveryEvidence, g as hasUnaccountedMessagingToolAggregateEvidence, i as collectMessagingToolDeliveredMediaUrls, r as collectDeliveredMediaUrls } from "./delivery-evidence-hC0w28qO.js";
import { j as isHeartbeatLifecycleRunKind } from "./openclaw-tools-CoDz4vSH.js";
import { n as removeInternalSessionEffectsSession, r as resolveInternalSessionEffectsTarget, t as prepareInternalSessionEffectsSession } from "./internal-session-effects-CITLquy1.js";
import { a as isModelSelectionLocked, i as applyModelOverrideToSessionEntry, o as repairProviderWrappedModelOverride, r as ModelSelectionLockedError, t as MODEL_SELECTION_LOCKED_MESSAGE } from "./model-overrides-BT6Lelev.js";
import { t as AGENT_LANE_SUBAGENT } from "./lanes-CI0_P-yC.js";
import { l as formatAgentInternalEventsForPlainPrompt, u as formatAgentInternalEventsForPrompt } from "./subagent-announce-delivery-CmKxHjJp.js";
...
import { n as clearRotatedSessionMetadata, r as resolveSession } from "./session-KmhKDbsn.js";
import { f as getScopedChannelsCommandSecretTargets, n as getAgentRuntimeOptionalCommandSecretPaths, t as getAgentRuntimeCommandSecretTargetIds } from "./command-secret-targets-DIFshlpq.js";
import { n as createModelVisibilityPolicy } from "./model-visibility-policy-BnYDbXrZ.js";
import { n as normalizeSpawnedRunMetadata } from "./spawned-context-ClhbZdeK.js";
import { t as createTrajectoryRuntimeRecorder } from "./runtime-DfPrTYmB.js";
import { r as resolveAvailableAgentHarnessPolicy } from "./selection-C25zbbCu.js";
import { t as mergeAttemptToolMediaPayloads } from "./tool-media-payloads-DU0JbpS6.js";
import { r as mergeSessionSnapshotChanges } from "./session-snapshot-merge-Bi3PsSDQ.js";
import { t as CronService } from "./service-Bw53zrjn.js";
import { t as resolveChannelModelOverride } from "./model-overrides-B3jI4eCi.js";
import { i as createChatRunState } from "./server-chat-state-C8AVcQU8.js";
import { t as ensureSessionDiffBaseline } from "./session-diff-baseline-DEG0opbr.js";
import { t as clearSessionAuthProfileOverride } from "./session-override-BpRa-tg3.js";
import { r as resolveInlineAgentImageAttachments } from "./agent-turn-attachments-BAynlKQS.js";
import { t as NodeRegistry } from "./node-registry-Cjgq3zo7.js";
import { t as measureAgentStartup } from "./startup-timing-CwHkMhpW.js";
import { n as resolveAgentExplicitRecipientSession, r as resolveAgentOutboundTarget, t as resolveAgentDeliveryPlanWithSessionRoute } from "./agent-delivery-O5aIsBdt.js";
import { n as acquireWorktreeRunLease, o as resolveWorktreeIdForPath } from "./run-lease-DWTpSPs-.js";
import { t as runEmbeddedAgentEntry } from "./run-entry-Bu-ex-nW.js";
import { n as applyVerboseOverride } from "./level-overrides-C6SPQ_cO.js";
import { t as resolveAgentRunContext } from "./run-context-G_0uiGlc.js";
...
function createLocalGatewayRequestContext(params) {
	...
	const loadModelCatalogOwner = async ({ agentId, agentDir, readOnly, workspaceDir } = {}) => loadResolvedPublishedModelCatalogOwner({
		...agentId ? { agentId } : {},
		...agentDir ? { agentDir } : {},
	...
	return {
		...
		loadGatewayModelCatalog: async (loadParams) => (await loadModelCatalogOwner(loadParams)).modelCatalog.entries,
		...
		readPreparedGatewayModelCatalog: async (loadParams) => getPreparedModelCatalogSnapshot({
			...loadParams,
			config: params.getRuntimeConfig(),
			readOnly: true
		})?.entries,
...
async function resolveAgentRuntimeConfig(runtime, params) {
	...
	const sourceConfig = await measureAgentStartup("config-source", async () => {
		try {
	...
	const secretsRuntime = await measureAgentStartup("secrets-runtime-import", () => import("./runtime-C8iuPxtH.js"), { config: cfg });
...
const acpRuntimeErrorsRuntimeLoader = createLazyImportLoader(() => import("./errors-BKMH5ROx.js"));
...
const cliCompactionRuntimeLoader = createLazyImportLoader(() => import("./cli-compaction-D4vLrvkX.js"));
...
const cliDepsRuntimeLoader = createLazyImportLoader(() => import("./deps-AeaJv5Cz.js"));
const execDefaultsRuntimeLoader = createLazyImportLoader(() => import("./exec-defaults-Bu-FrQ6k.js"));
const skillsRuntimeLoader = createLazyImportLoader(async () => {
	const [remote, sessionSnapshot] = await Promise.all([import("./remote-CMP617yQ.js"), import("./session-snapshot-DYeL9V6H.js")]);
	return {
...
async function persistSessionEntry$1(params) {
	...
	const persisted = await patchSqliteSessionEntry({
...
async function resolveEmbeddedModelSelection(params) {
	...
	if (params.pluginsEnabled && primaryConfiguredThinkLevel !== "off" && !hasResolvedThinkingCatalogEntry({
		...
		const { loadPreparedModelCatalogSnapshot } = await import("./agents/model-catalog.runtime.js");
		const runtimeCatalog = normalizeThinkingCatalogProviders((await loadPreparedModelCatalogSnapshot({
			config: params.cfg,
			agentId: params.sessionAgentId,
			workspaceDir: params.workspaceDir
		})).entries);
...
async function persistPendingFinalDeliveryMarker(params) {
	...
	return {
		...
		pendingFinalDeliveryMarkerPersisted: persisted?.pendingFinalDelivery?.kind === "replayable" && persisted.pendingFinalDelivery.text === recoverableText,
		hasSendableFinalPayload
	};
}
//#endregion
...
async function finalizeEmbeddedAgentCommand(params) {
	...
	try {
		...
		if (sessionStore && sessionKey && !isSubagentSessionKey(sessionKey) && !params.suppressVisibleSessionEffects && !sessionReboundDuringRun) {
			...
			if (deliveryResult?.deliverySucceeded === true || clearStaleTransportOnly) sessionEntry = await persistSessionEntry({
				sessionStore,
				sessionKey,
				storePath,
				initialEntry: entry,
	...
	try {
		...
		return await sessionWorkAdmission.run(async () => {
			...
			if (sessionEntry && sessionKey && !suppressVisibleSessionEffects) try {
				...
				log.warn(`session diff baseline capture failed; continuing without attribution filtering: ${error instanceof Error ? error.message : String(error)}`);
			}
...
async function agentCommand(opts, runtime = defaultRuntime, deps) {
	const resolvedDeps = await measureAgentStartup("command-dependencies", () => resolveAgentCommandDeps(deps));
	...
	return await withAgentRunLifecycleGeneration(lifecycleGeneration, () => withLocalGatewayRequestScope({
		...
		prepare: async (preparedOpts) => await measureAgentStartup("command-prepare", () => prepareAgentCommandExecution(preparedOpts, runtime)),
