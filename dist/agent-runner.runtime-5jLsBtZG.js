...
import { f as resolveAgentIdFromSessionKey, l as isUnscopedSessionKeySentinel } from "./session-key-DtTE9-Tg.js";
...
import "./strip-inbound-meta-BOGiSpdi.js";
...
import { g as withAgentRunLifecycleGeneration, i as emitAgentEvent, n as captureAgentRunLifecycleGeneration, u as onAgentEvent } from "./agent-events-COCf-9-O.js";
import { p as registerAgentRunContext, r as clearAgentRunContext } from "./agent-run-registry-BluEqSPq.js";
import { c as resolveContextConfigProviderForRuntime, u as resolveOpenAIRuntimeProvider } from "./openai-routing-G4z6ipSe.js";
import { t as modelKey } from "./model-key-BaNhQShd.js";
import { D as hasSessionAutoModelFallbackProvenance, O as resolveSessionModelOverrideRouteResolution, a as markAutoFallbackPrimaryProbe, g as resolveSessionAgentId, n as entryMatchesAutoFallbackPrimaryProbe, p as resolveAutoFallbackPrimaryProbe, r as hasConfiguredModelFallbacks, t as clearAutoFallbackPrimaryProbeSelection } from "./agent-scope-DyEposw2.js";
import { d as resolveEffectiveResponseUsage, u as normalizeVerboseLevel } from "./thinking.shared-k6K-6JHM.js";
...
import { a as measureDiagnosticsTimelineSpan } from "./diagnostics-timeline--Yi1HEPC.js";
...
import { i as legacyModelKey } from "./model-ref-shared-BCBRWGJh.js";
import { r as logVerbose } from "./globals-DHQUG86L.js";
import "./config-UtpOr1Uw.js";
import { t as GatewayDrainingError } from "./gateway-work-admission-D_DdbtmL.js";
import { t as normalizeChatType } from "./chat-type-BARlA53h.js";
import { i as resetRegisteredAgentHarnessSessions } from "./registry-BjwLx-0R.js";
...
import { s as normalizeDeliveryContext, u as sessionDeliveryChannel } from "./delivery-context.shared-B-QSuGw_.js";
import { o as isAudioFileName } from "./mime-Ir6g3Vae.js";
import { l as resolveStorePath } from "./paths-DSnYpBD3.js";
import { M as hasNonzeroUsage, P as normalizeUsage, ct as loadSqliteSessionEntryReadOnly, j as deriveSessionTotalTokens, k as deriveContextPromptTokens, lt as patchSqliteSessionEntry, o as appendSqliteTranscriptMessage, st as loadSqliteSessionEntry, yt as resolveSessionStorePathForScope } from "./session-accessor.sqlite-B9iW7DOt.js";
import { o as resolveMessageChannel } from "./message-channel-normalize-Bmutiks_.js";
import { a as isInternalMessageChannel, o as isMarkdownCapableMessageChannel } from "./message-channel-1n7hD5_u.js";
import { a as resolveGroupSessionKey } from "./store-entry-shape-DB6qjwcl.js";
import { S as selectSessionTranscriptLeafControlledPath } from "./session-transcript-index-cy-aJty7.js";
import { $ as parseSessionThreadInfoFast, A as resolveFreshSessionTotalTokens, M as resolveSessionPluginTraceLines, a as hasRestartRecoverySourceClaim, j as resolveSessionPluginStatusLines } from "./session-entry-slot-keys-DR5d2mKt.js";
import { K as updateSessionEntry, N as persistSessionResetLifecycle, c as readRecentSessionTranscriptActiveEvents, d as readSessionTranscriptActiveStats } from "./session-accessor-t3qUoTeV.js";
import { o as isIngressAdoptionLostError } from "./ingress-drain-2RTV7UdL.js";
...
import { i as isCliRuntimeAliasForProvider, s as resolveCliRuntimeExecutionProvider, t as areRuntimeModelRefsEquivalent } from "./model-runtime-aliases-D6C4F5xr.js";
import { u as estimateMessagesTokens } from "./compaction-planning-CEkjkWXf.js";
import { i as classifyOAuthRefreshFailureError, r as classifyOAuthRefreshFailure } from "./oauth-refresh-failure-BUReLFib.js";
...
import { c as resolvePersistedOverrideModelRef } from "./model-selection-4mvNeCA1.js";
import { _ as isOverloadedErrorMessage, b as isRateLimitErrorMessage, d as sanitizeUserFacingText, g as isBillingErrorMessage, i as formatRateLimitOrOverloadedErrorCopy } from "./sanitize-user-facing-text-Ba4C3tZ5.js";
import { b as isTransientHttpError, h as isCompactionFailureError } from "./errors-B811vGBl.js";
...
import { n as isLikelyContextOverflowError, t as isContextOverflowError } from "./context-overflow-DNey-WOn.js";
import { c as stripLegacyBracketToolCallBlocks } from "./assistant-visible-text-DONkuTGN.js";
import { c as isFailoverError, p as resolveFailoverReasonFromError } from "./failover-error-U3al4tnA.js";
import { i as isSessionWriteLockLeaseLostError } from "./session-write-lock-error-5gHYmvxH.js";
import { a as enqueueSystemEvent } from "./system-events-fsxpbPNB.js";
import { d as resolveAgentRunErrorLifecycleFields, i as AGENT_RUN_RESTART_ABORT_STOP_REASON, l as isAgentRunRestartAbortReason, o as createAgentRunRestartAbortError, u as resolveAgentRunAbortLifecycleFields } from "./run-termination-7xcnysfe.js";
import { c as resolveFastModeForElapsed, n as formatFastModeAutoProgressText } from "./fast-mode-BORk623r.js";
import { a as resolveSourceReplyVisibilityPolicy } from "./source-reply-delivery-mode-DBkd7D2I.js";
import { a as hasNewGeneratedMediaTaskForSessionKey, r as getGeneratedMediaTaskIdsForSessionKey } from "./task-status-access-CeK79h8b.js";
import { S as markReplyOperationGlobalLaneWaitProgress, j as runAfterReplyOperationClear, w as replyRunRegistry } from "./reply-run-registry-tXvcNkN4.js";
import { f as logSessionTurnCreated } from "./diagnostic-Ba_lpTat.js";
import { c as resolveCronJobsStorePath, n as loadCronJobsStore } from "./store-865CL89i.js";
...
import { c as readSessionMessagesAsync, r as readLatestSessionUsageFromTranscriptAsync } from "./session-transcript-readers-O3pZVV3x.js";
import { n as resolveSessionModelRef } from "./session-model-ref-SCzh_dh2.js";
import { i as resolveModelCostConfig, n as formatUsd, t as estimateUsageCost } from "./usage-format-DqSzIzj_.js";
import { n as resolvePersistedSessionRuntimeId, r as resolveSessionRuntimeOverrideForProvider } from "./session-runtime-compat-CDBgUbgw.js";
import { a as resolveEffectiveAgentRuntime, i as resolveCandidateThinkingLevel } from "./thinking-runtime-93ZQ8Ibj.js";
import { o as resolveContextTokensForModel } from "./context-DKZWKZZE.js";
import { t as resolveFastModeState } from "./fast-mode-DRb2pnqM.js";
import { d as completeFollowupRunLifecycle, f as isFollowupRunAborted, h as resolveFollowupAbortSignal, l as FollowupRunDeferredError, s as refreshQueuedFollowupSession, u as admitFollowupRunLifecycle } from "./state-CRjZ_OD8.js";
import { d as shouldPreserveUserFacingSessionStateForInputProvenance } from "./input-provenance-CYGbY89H.js";
...
import { d as mergeReactionDirectiveChannelData, f as parseReplyDirectives } from "./payloads-BRd0B8mC.js";
import { a as resolveReplyThreadingPayloads, i as isRenderablePayload, n as applyReplyThreading, t as applyReplyTagsToPayload } from "./reply-payloads-NZz6alPO.js";
import { n as createReplyToModeFilterForChannel, o as resolveReplyToMode, t as createReplyDeliveryContext } from "./reply-threading-DWyGycTp.js";
import "./embedded-agent-helpers-zm6jLxdk.js";
import { y as readPostCompactionContext } from "./builtin-openclaw-BtmzbRwt.js";
import { a as resolveMessagingToolPayloadDedupe, n as filterMessagingToolMediaDuplicates, t as filterMessagingToolDuplicates } from "./reply-payloads-dedupe-CrDHl82Z.js";
...
import { i as normalizePendingFinalDeliveryPayloads, n as buildPendingFinalDeliveryText, o as sanitizePendingFinalDeliveryText, r as buildRecoverablePendingFinalDeliveryText } from "./pending-final-delivery-BzZojDaN.js";
import { i as transitionMainSessionRecovery } from "./main-session-recovery-state-CUJxZLgx.js";
import { d as isTrustedMessageActionTurnIngress, f as mintMessageActionTurnCapability, h as revokeMessageActionTurnCapability, m as resolveMessageActionTurnCapabilityLifetime } from "./code-mode-control-tools-B1t6Lt9X.js";
import { n as resolveSendPolicy } from "./send-policy-BKJvZqJK.js";
import { t as CommandLaneClearedError } from "./command-queue-Cl58ne2E.js";
import { g as leaseMcpAppModelContextForTurn, s as peekSessionMcpRuntime } from "./agent-bundle-mcp-manager-api-BO7-Y1u4.js";
import "./agent-bundle-mcp-runtime-BkjLnt6Q.js";
import { i as getMcpAppViewLease } from "./mcp-ui-resource-CL8a9Qyv.js";
...
import { _ as hasVisibleCommittedMessagingToolDeliveryEvidence, d as hasCompletedSourceReplyDeliveryEvidence, f as hasCompletedTerminalDeliveryEvidence, l as hasCommittedSourceReplyDeliveryEvidence, v as hasVisibleOutboundDeliveryEvidence } from "./delivery-evidence-hC0w28qO.js";
import { a as isMessagingToolSendAction } from "./embedded-agent-messaging-BHU1Makt.js";
import { d as extractToolResultText } from "./embedded-agent-subscribe.tools-D7tyhgah.js";
import { u as inferToolMetaFromArgs } from "./embedded-agent-utils-BYrAMdPg.js";
import { s as resolveBootstrapWarningSignaturesSeen } from "./bootstrap-budget-U6QVxuxs.js";
import { n as clearBootstrapSnapshotOnSessionBoundary } from "./bootstrap-cache-8R0DvXGI.js";
import { S as globalAttributionRing } from "./subagent-spawn-cleanup-DhDgnQvU.js";
import { a as isModelSelectionLocked, n as MODEL_SELECTION_LOCKED_RESET_MESSAGE, r as ModelSelectionLockedError } from "./model-overrides-BT6Lelev.js";
import { t as getCliSessionBinding } from "./cli-session-binding-F7hyyN-U.js";
import { n as routeReply, t as isRoutableChannel } from "./route-reply-Dus8nGcU.js";
import { s as scheduleFollowupDrain } from "./cleanup-BVUOa8It.js";
import { n as enqueueFollowupRun, t as resolveQueueSettings } from "./queue-DIufyn8Z.js";
import { l as buildReplyUsageState, u as recordReplyUsageState } from "./deliver-prepare-WWZ8N40u.js";
import { i as LiveSessionModelSwitchError } from "./failover-policy-CREBEvs_.js";
import { i as isFallbackSummaryError } from "./model-fallback-attempt-C8uP1hXj.js";
import { c as shouldClearFailedCliSessionBinding, n as clearCliSession, o as setCliSessionBinding, s as setCliSessionId, t as clearAllCliSessions } from "./cli-session-BYqPb4bQ.js";
import { a as createAgentPatchedSessionModelFallback } from "./session-model-patch-origin-6p5iNAyq.js";
...
import "./settled-turn-finalization-result-C2xKQp6X.js";
import "./sandbox-BHXEMQc2.js";
import { a as isBenignCompactionSkipResult } from "./compact-reasons-BdRFPqua.js";
import { t as runEmbeddedAgent } from "./embedded-agent-B188BQ_l.js";
import { i as withBeforeAgentReplyObserver, n as buildHandledBeforeAgentReplyPayloads, r as runBeforeAgentReplyForTurn } from "./payloads-BlG-06MU.js";
import { r as buildControlUiAgentFailureText } from "./agent-runner-failure-copy-BY7A6uy5.js";
import { n as hasDeliberateSilentTerminalReply } from "./result-fallback-classifier-Cn7gPY3u.js";
import { t as buildAgentRuntimeDeliveryPlan } from "./build-Ezvlnd0e.js";
import { r as consolidateLiveModelSwitchAfterRun } from "./tool-media-payloads-vIlJ9_JC.js";
import { i as withLocalSessionPlacementTurnAdmission } from "./session-placement-admission-BEJd445g.js";
import { n as readChannelSourceTurnId, t as buildChannelSourceTurnId } from "./source-turn-id-DBX5_no8.js";
...
import { n as createBlockReplyContentKey, r as createBlockReplyPipeline, t as createAudioAsVoiceBuffer } from "./block-reply-pipeline-CpHTf1YD.js";
import { a as createReplyTimingTracker, c as resolveReplyTurnKind, i as resolveEffectiveReplyRoute, n as createReplySessionEntryHandle, o as isReplyProfilerEnabled, s as admitReplyTurn, t as ReplySessionGenerationInvalidatedError } from "./session-entry-handle-nOo0NulB.js";
import { _ as resolveExternalRunFailureTextForConversation, a as buildEmptyInteractiveReplyPayload, c as buildPreflightCompactionFailureText, d as hasBillingAttemptSummary, f as isNonDirectConversationContext, g as resolveBillingFailureReplyText, h as markAgentRunFailureReplyPayload, i as buildAuthProfileFailoverFailureText, l as buildRateLimitCooldownMessage, m as isVerboseFailureDetailEnabled, n as isDuplicateRestartRecoverySource, o as buildExternalRunFailureReply, p as isPureTransientRateLimitSummary, r as retireTerminalRestartRecoverySourceClaim, s as buildKnownAgentRunFailureReplyPayload, t as createReplyRestartRecoveryClaimController, u as buildTerminalAgentRunFailureReplyPayload, y as classifyProviderRequestError } from "./restart-recovery-claim-tLc-tnBo.js";
import { n as resolveRoutedDeliveryThreadId } from "./routed-delivery-thread-0bKUtkYC.js";
...
import { r as enqueueCommitmentExtraction } from "./runtime-BSHkP6mJ.js";
import { n as resolveEffectiveBlockStreamingConfig } from "./block-streaming-B6qHjcBF.js";
import { t as REPLY_RUN_STILL_SHUTTING_DOWN_TEXT } from "./get-reply-run-queue-stNf2ypN.js";
import { l as resolveActiveRunQueueAction, n as createTypingSignaler, s as refreshActiveGoalContext, t as resolveCurrentTurnImages } from "./current-turn-images-3Y2C1neI.js";
import { t as runEmbeddedAgentEntry } from "./run-entry-DNV630oQ.js";
import { n as runCliAgent } from "./cli-runner-D2lGvln5.js";
import { t as createReplyMediaContext } from "./reply-media-paths.runtime-jUsRBQ4y.js";
import { t as formatProviderModelRef } from "./model-runtime-CT6T4rg0.js";
import { t as emitAgentRunStatusEvent } from "./agent-run-status-events-CF-IBIeP.js";
import { a as resolveQueuedReplyExecutionConfig, c as resolveModelFallbackOptions, i as isBunFetchSocketError, l as resolveFallbackCandidateRun, n as buildThreadingToolContext, o as resolveQueuedReplyRuntimeConfig, r as formatBunFetchSocketError, s as resolveRunFastModeForFallbackCandidate, t as buildEmbeddedRunExecutionParams, u as resolveRunAuthProfile } from "./agent-runner-utils-Bc2rq7Rl.js";
...
import { t as createMcpAppStandaloneTicket } from "./mcp-app-standalone-Dl9kx0me.js";
...
function refreshSessionEntryFromStore(params) {
	...
	try {
		const latestEntry = loadSqliteSessionEntryReadOnly({
			storePath,
			sessionKey
		});
...
function isSessionLeaseLoss(error) {
	const pending = [error];
	const seen = /* @__PURE__ */ new Set();
	for (const candidate of pending) {
		if (!candidate || seen.has(candidate)) continue;
		seen.add(candidate);
		if (isSessionWriteLockLeaseLostError(candidate)) return true;
		if (candidate instanceof Error && "cause" in candidate && candidate.cause !== void 0) pending.push(candidate.cause);
	}
	return false;
}
async function handleAgentExecutionError(params) {
	...
	if (err instanceof LiveSessionModelSwitchError) {
		...
		const switchErrorText = params.shouldSurfaceToControlUi ? buildControlUiAgentFailureText("model switch could not be completed. The requested model may be temporarily unavailable.") : isVerboseFailureDetailEnabled(turn.resolvedVerboseLevel) ? "⚠️ Agent failed before reply: model switch could not be completed. The requested model may be temporarily unavailable. Please try again shortly." : "⚠️ Model switch could not be completed. The requested model may be temporarily unavailable. Please try again shortly.";
	...
	if (isSessionLeaseLoss(err) && await turn.confirmRestartRecoveryArmedAfterLeaseLoss?.() === true) {
	...
	const userFacingMessage = isTransientHttp ? sanitizeUserFacingText(message, { errorContext: true }) : message;
	...
	const userVisibleFallbackText = resolveExternalRunFailureTextForConversation({
		text: isBilling ? resolveBillingFailureReplyText(err) : isRateLimit && !isOverloaded ? buildRateLimitCooldownMessage(err) : rateLimitOrOverloadedCopy ? rateLimitOrOverloadedCopy : isContextOverflow ? "⚠️ Context overflow — prompt too large for this model. Try a shorter message or a larger-context model." : params.shouldSurfaceToControlUi ? buildControlUiAgentFailureText(userFacingMessage) : externalRunFailureReply?.text ?? (turn.isHeartbeat ? "⚠️ Heartbeat check failed before it could produce an update. The main chat session remains available." : "⚠️ Something went wrong while processing your request. Please try again, or use /new to start a fresh session."),
		sessionCtx: turn.sessionCtx,
...
function readToolResultText(value) {
	...
	return value.map((block) => readStringValue(readRecordValue(block)?.text)).filter((part) => part !== void 0).join("\n").trim() || void 0;
}
...
function buildCommandOutputFromToolResultEvent(evt) {
	...
	if (!name || !isCommandToolName(name)) return;
	...
	const title = readStringValue(evt.data.title) ?? (args ? inferToolMetaFromArgs(name, args, { detailMode: "explain" }) : void 0);
	return {
		...
		return runCliAgentWithLifecycle({
			...
			onAssistantText: async (text) => {
				...
				if (!params.preserveProgressCallbackStartOrder) {
					...
					if (sanitized.skip || !sanitized.text || !turn.opts?.onPartialReply) return;
				...
				await params.presentation.startPresentationWhileTyping(turn.typingSignals.signalTextDelta(textForTyping), () => turn.opts?.onPartialReply?.({ text: sanitized.text }));
			},
	...
	try {
		...
		const result = await params.timing.measure("embedded_run", () => runEmbeddedAgent({
			...
			onPartialReply: async (payload) => {
				...
				if (!params.preserveProgressCallbackStartOrder) {
					await turn.typingSignals.signalTextDelta(textForTyping);
					if (!turn.opts?.onPartialReply) return;
					await turn.opts.onPartialReply(partialPayload);
					return;
				}
				await params.presentation.startPresentationWhileTyping(turn.typingSignals.signalTextDelta(textForTyping), () => turn.opts?.onPartialReply?.(partialPayload));
			},
...
async function settleAgentFallbackCycle(params) {
	...
	if (embeddedError?.kind === "role_ordering") {
		...
		return {
			kind: "final",
			payload: markAgentRunFailureReplyPayload({ text: cycle.shouldSurfaceToControlUi ? buildControlUiAgentFailureText(embeddedErrorText) : providerRequestError?.userMessage ?? "⚠️ The model provider rejected the conversation state. Please try again, or use /new to start a fresh session." })
		};
	}
...
async function executeAgentTurnInternalWithRetryState(params, commitTerminalOutcome, overloadRetryState, commitMcpAppModelContext) {
...
async function executeAgentTurnInternal(params, commitTerminalOutcome, commitMcpAppModelContext) {
	...
	try {
		return await executeAgentTurnInternalWithRetryState(params, commitTerminalOutcome, overloadRetryState, commitMcpAppModelContext);
	} finally {
...
function resolveResponsesServerCompactionThreshold(params) {
	...
	const sources = [
		asOptionalRecord(providerConfig?.params),
		asOptionalRecord(providerModelConfig?.params),
		asOptionalRecord(params.cfg?.agents?.defaults?.params),
		asOptionalRecord(modelConfig?.params)
	];
...
const embeddedAgentRuntimeLoader = createLazyImportLoader(() => import("./embedded-agent-D3IzfMqr.js"));
...
async function runPreflightCompactionIfNeeded(params) {
	...
	const compactionStorePath = resolveSessionStorePathForScope({
		...
		storePath: params.storePath ?? resolveStorePath(params.cfg.session?.store, { agentId: compactionAgentId })
	});
...
async function runMemoryFlushIfNeeded(params) {
	...
	const shouldReadTurnTaint = Boolean(canAttemptFlush && entry && memoryFlushPlan.recordWriteProvenance);
	...
	const memoryFlushAbsolutePath = path.join(params.followupRun.run.workspaceDir, memoryFlushWritePath);
	const readMemoryFlushContent = () => fs.promises.readFile(memoryFlushAbsolutePath, "utf8").catch((error) => {
	...
	try {
		...
		if (!isAbortError(err) && params.storePath && params.sessionKey) try {
			const failedEntry = await memoryDeps.updateSessionEntry({
				...
				skipMaintenance: true,
				takeCacheOwnership: true,
				update: async (sessionEntry) => ({ memoryFlush: {
					kind: "failed",
					...sessionEntry.memoryFlush?.compactionCount !== void 0 ? { compactionCount: sessionEntry.memoryFlush.compactionCount } : {},
					failureCount: (sessionEntry.memoryFlush?.kind === "failed" ? sessionEntry.memoryFlush.failureCount : 0) + 1
				} })
			});
			if (failedEntry) {
...
async function accountAgentTurn(context) {
	...
	if (sessionKey) {
		...
		const lastCall = lastCallUsage ?? runResult.meta?.agentMeta?.lastCallUsage;
		const cacheHit = Boolean(lastCall && Boolean(lastCall.cacheRead) || lastCall && typeof lastCall.cachedPromptTokens === "number" && lastCall.cachedPromptTokens > 0);
		const compactionFired = Boolean(preflightCompactionApplied || typeof autoCompactionCount === "number" && autoCompactionCount > 0 || typeof compactions === "number" && compactions > 0);
...
function shouldWarnAboutPrivateMessageToolFinal(params) {
	...
	if (estimatedChars >= LONG_PRIVATE_FINAL_MIN_CHARS) return true;
	const sentenceTerminatorCount = countSentenceLikeTerminators(trimmed);
	return estimatedChars >= MULTI_SENTENCE_PRIVATE_FINAL_MIN_CHARS && sentenceTerminatorCount >= MULTI_SENTENCE_TERMINATOR_MIN_COUNT;
}
/**
...
function resolveStrandedReplyRecovery(params) {
	if (params.isHeartbeat || params.isRoomEvent || params.sourceReplyDeliveryMode !== "message_tool_only" || params.sendPolicyDenied || params.successfulSourceReplyDelivery) return { kind: "none" };
	...
	if (!shouldWarn) return { kind: "none" };
	return {
		kind: "retry",
...
async function prepareReplyAgentPayloads(state) {
	...
	const { activeSessionStore, blockReplyPipeline, blockStreamingEnabled, cfg, commandBody, followupRun, isHeartbeat, opts, replyMediaContext, replyOperation, replyRouteThreadId, replyThreadingOverride, replyToChannel, replyToMode, returnWithQueuedFollowupDrain, runStartedAt, runtimePolicySessionKey, sessionCtx, sessionKey, storePath, typingSignals } = context;
	const { configuredFallbackModel, contextTokensUsed, directlySentBlockKeys, directlySentBlockPayloads, fallbackAttempts, fallbackExhausted, fallbackTransition, hasBillableUsageBuckets, modelUsed, payloadArray, preserveUserFacingSessionState, promptTokens, providerUsed, replyUsageState, runId, runResult, selectedModel, selectedProvider, terminalFailurePayload, usage, verboseEnabled } = accounting;
...
async function admitFollowupTurn(params) {
	...
	try {
		...
		const admittedEntry = replySessionKey ? params.defaults.storePath ? loadSqliteSessionEntry({
			storePath: params.defaults.storePath,
			sessionKey: replySessionKey
		...
		const readTurnSessionEntry = () => replySessionKey && params.defaults.storePath ? loadSqliteSessionEntry({
			storePath: params.defaults.storePath,
			sessionKey: replySessionKey
		...
		const notifyPreflightCompaction = turn.sendPolicy === "allow" && queued.currentInboundEventKind !== "room_event" && shouldNotifyUserAboutCompaction(config) ? async (phase) => {
			if (phase !== "start") {
...
async function executeFollowupTurn(params) {
	...
	const currentVerboseLevel = () => {
		...
		if (session.kind === "session" && session.storePath) try {
			const loadedEntry = loadSqliteSessionEntryReadOnly({
	...
	const progressOpts = {
		...
		onCommandOutput: sourceOpts?.onCommandOutput ? (output) => enqueueProgress(async () => {
			if (!shouldEmitToolResult()) return;
			if (await sourceOpts.onCommandOutput?.(output) !== false && (output.status === "failed" || output.status === "error" || typeof output.exitCode === "number" && output.exitCode !== 0)) visibleToolError = true;
		}) : void 0,
		onItemEvent: sourceOpts?.onItemEvent ? (item) => enqueueProgress(async () => {
			if (!shouldEmitToolResult()) return;
			if (await sourceOpts.onItemEvent?.(item) !== false && (item.phase === "error" || item.status === "failed" || item.status === "error")) visibleToolError = true;
		}) : void 0,
		...
		onCompactionStart: sourceOpts?.onCompactionStart ? () => enqueueProgress(() => progressAllowed() ? sourceOpts.onCompactionStart?.() : void 0) : void 0,
		onCompactionEnd: sourceOpts?.onCompactionEnd ? () => enqueueProgress(() => progressAllowed() ? sourceOpts.onCompactionEnd?.() : void 0) : void 0,
		onReasoningStream: wrap(sourceOpts?.onReasoningStream),
		onReasoningProgress: wrap(sourceOpts?.onReasoningProgress),
		onReasoningEnd: sourceOpts?.onReasoningEnd ? () => enqueueProgress(() => progressAllowed() ? sourceOpts.onReasoningEnd?.() : void 0) : void 0,
		...
		onToolResult: async (payload) => {
			await enqueueProgress(async () => {
				...
				if (turn.queued.run.sourceReplyDeliveryMode === "message_tool_only" && !toolResultProgressVisible) return;
				if (channelToolResultProgress && !verboseToolResult) await channelToolResultProgress(payload);
				else await params.onToolResult(payload, { runId: turn.runId });
				if (payload.isError === true) visibleToolError = true;
			});
		}
	};
...
function createReplyAgentRestartRecoveryController(context) {
	...
	const { admitUserTurn, beginBeforeAgentReply, checkpointBeforeAgentReply, clear: clearRestartRecoveryDeliveryClaim, confirmRestartRecoveryArmedAfterLeaseLoss, isArmed: isRestartRecoveryArmed } = createReplyRestartRecoveryClaimController({
...
async function runReplyAgent(params) {
	...
	const restartRecoveryEntry = sessionKey && storePath ? loadSqliteSessionEntry({
		storePath,
		sessionKey,
		clone: false,
	...
	const { admitUserTurn, beginBeforeAgentReply, checkpointBeforeAgentReply, clear: clearRestartRecoveryDeliveryClaim, confirmRestartRecoveryArmedAfterLeaseLoss, isArmed: isRestartRecoveryArmed } = createReplyAgentRestartRecoveryController({
		activeSessionStore,
		cfg,
		followupRun,
