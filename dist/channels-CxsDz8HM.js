...
import { s as getChannelsCommandSecretTargetIds } from "./command-secret-targets-IDxJd0Jh.js";
...
import { t as resolveInstallableChannelPlugin } from "./channel-plugin-resolution-Do7WkVoI.js";
...
import { i as prepareChannelAccountRemoval, n as channelLabel, r as applyPreparedChannelAccountRemoval, t as channelsAddCommand } from "./add-BiOmalU6.js";
import { c as shouldUseWizard, o as formatChannelAccountLabel, s as requireValidConfig } from "./shared-Cz3fubo5.js";
import { t as channelsListCommand } from "./list-DtEISOlf.js";
import { t as channelsStatusCommand } from "./status-D1P9jIrn.js";
...
async function channelsRemoveCommand(opts, runtime = defaultRuntime, params) {
	...
	const resolvedPluginState = Boolean(lookupChannel || channel) ? await (async () => {
		const { resolveInstallableChannelPlugin } = await import("./channel-plugin-resolution-e2Pqi18I.js");
