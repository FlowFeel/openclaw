...
import { t as withResolvedActionClient } from "./client-BhgPb9lI.js";
import { r as resolveMatrixAuthContext } from "./config-C_Eu4qJs.js";
...
async function addMatrixAccount(params) {
	...
	if (accountConfig.encryption === true) {
		const { maybeBootstrapNewEncryptedMatrixAccount } = await import("./setup-bootstrap-Bb_BrX9X.js");
...
const loadMatrixActionClientModule = createLazyRuntimeModule(() => import("./client-C502hrAn.js"));
