...
async function maybeMigrateLegacyStorage(params) {
	...
	const syncCache = hasAccountScopedLegacyStorageFile ? await import("./file-sync-store-AA8QUhdm.js") : null;
...
async function migrateLegacySyncCacheToSqlite(params) {
	const syncCache = await import("./file-sync-store-AA8QUhdm.js");
