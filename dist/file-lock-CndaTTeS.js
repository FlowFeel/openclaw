...
import { i as resetFileLockManagerForTest, r as drainFileLockManagerForTest, t as acquireFileLock$1 } from "./file-lock-CLjy2n00.js";
import { t as getFileLockProcessStartTime } from "./pid-alive-ClLrY9h9.js";
import { n as shouldRemoveDeadOwnerOrExpiredLock, t as isLockOwnerDefinitelyStale } from "./stale-lock-file-CEuvanrm.js";
...
async function acquireFileLock(filePath, options) {
	...
	try {
		const lock = await acquireFileLock$1(filePath, {
			...
			shouldReclaim: (params) => staleRecovery === "fail-closed" ? isLockOwnerDefinitelyStale({ payload: asLockPayload(params.payload) }) : shouldRemoveDeadOwnerOrExpiredLock({
