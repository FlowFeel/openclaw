...
import { i as resolveSafeInstallDir } from "./install-safe-path-DL8AfrFO.js";
import { r as formatErrorMessage } from "./errors-Cg_yT1Sv.js";
import { c as tryReadJson, r as readJsonIfExists, u as writeJson } from "./json-C-CW4mQo.js";
import "./json-files-v5WP3doI.js";
import { E as resolveClawHubBaseUrl, S as normalizeClawHubSha256Integrity, T as reportClawHubSkillInstallTelemetry, _ as fetchClawHubSkillInstallResolution, b as isDefaultClawHubBaseUrl, g as fetchClawHubSkillDetail, i as downloadClawHubGitHubSkillArchive, j as searchClawHubSkills, n as CLAWHUB_SKILLS_SH_TRUST_STATE, o as downloadClawHubSkillArchive, s as downloadClawHubSkillArchiveUrl, t as CLAWHUB_SKILLS_SH_TRUST_LABEL, y as fetchClawHubSkillVerification } from "./clawhub-DDwXNACq.js";
...
import { i as withExtractedArchiveRoot, t as installPackageDir } from "./install-package-dir-DP9cOOeX.js";
import { t as evaluateSkillInstallPolicy } from "./install-security-scan-Rm0IC18V.js";
import { n as ensureClawHubPackageTrustAcknowledged } from "./clawhub-install-trust-Dgg9MNPX.js";
...
async function snapshotCommittedSkillArtifact(params) {
	...
	const frontmatter = parseSkillFrontmatter(await fs$1.readFile(skillFile));
...
function normalizeClawHubSkillOrigin(raw) {
	...
	if (requestedReferenceRaw) try {
		...
		if (normalizeOptionalStringValue(raw.trustState) !== "not-scanned-by-clawhub") return null;
		trustState = CLAWHUB_SKILLS_SH_TRUST_STATE;
	} catch {
		return null;
	}
...
async function performClawHubSkillInstall(params) {
	try {
		...
		try {
			...
			const sourceUrl = (resolution?.installKind === "github" ? normalizeOptionalStringValue(resolution.github.sourceUrl) : void 0) ?? readVerifiedClawHubSkillSourceUrl(verification?.provenance);
...
//#endregion
export { resolveWorkspaceSkillInstallDir as _, resolveClawHubSkillStatusLinkSync as a, hasCommittedSkillChangeHooks as b, searchSkillsFromClawHub as c, readClawHubSkillsLockfileStatusSync as d, readTrackedClawHubSkillSlugs as f, normalizeTrackedSkillSlug as g, installSkillArchiveFromPath as h, readLocalSkillCardContentSync as i, readVerifiedClawHubSkillSourceUrl as l, installExtractedSkillRoot as m, preflightSkillFromClawHub as n, resolveClawHubSkillVerificationTarget as o, untrackClawHubSkill as p, updateSkillsFromClawHub as r, resolveLocalSkillCardStatusSync as s, installSkillFromClawHub as t, digestClawHubSkillTree as u, validateRequestedSkillSlug as v, snapshotCommittedSkillArtifactBestEffort as x, dispatchCommittedSkillChangeBestEffort as y };
