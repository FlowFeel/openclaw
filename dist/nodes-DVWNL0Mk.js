...
import { c as isForbiddenBrowserProxyMutation } from "./method-scopes-BPNMlnDQ.js";
...
import { p as replaceRemoteNodeSkills } from "./workspace-D7s0sLcF.js";
import { a as isForegroundRestrictedPluginNodeCommand, c as normalizeDeclaredNodeCommands, l as resolveNodeCommandAllowlist, o as isNodeCommandAllowed, t as DEFAULT_DANGEROUS_NODE_COMMANDS, u as resolveNodePairingCommandAllowlist } from "./node-command-policy-BdDcKUU6.js";
import { _ as removePairedDeviceRole, d as listDevicePairing, s as getPairedDevice, u as listApprovedPairedDeviceRoles, x as resolveNodePairingState } from "./device-pairing-D3ZJFObN.js";
import { a as listNodePairing, c as rejectNodePairing, i as getPendingNodePairing, o as projectNodePairing, t as approveNodePairing, u as renamePairedNode } from "./node-pairing-CthjYRqK.js";
...
import { i as respondUnavailableOnThrow, r as respondUnavailableOnNodeInvokeErrorWithProvenance, t as respondInvalidParams } from "./nodes.helpers-C0b28TGW.js";
...
import { c as loadApnsRegistration, g as resolveApnsRelayConfigFromEnv, i as clearApnsRegistrationIfCurrent } from "./push-apns-store-ChR3wFuA.js";
import { c as resolveApnsAuthConfigFromEnv, n as sendApnsBackgroundWake, s as shouldClearStoredApnsRegistration, t as sendApnsAlert } from "./push-apns-owoosUSI.js";
import { t as EXEC_APPROVAL_RESOLVED_ENTRY_GRACE_MS } from "./exec-approval-manager-5dZjZ1MP.js";
import { a as removePendingNodeAction, i as listPendingNodeActions, n as clearRemovedNodeRuntimeState, o as replacePendingNodeActionsForGeneration, r as enqueuePendingNodeAction, t as acknowledgePendingNodeActions } from "./node-runtime-state-0dPtJ4Z8.js";
...
import { n as getKnownNode, r as listKnownNodes, t as createKnownNodeCatalog } from "./node-catalog-DG5PcaN0.js";
import { a as isNodePairingGenerationCurrent, n as captureNodePairingGeneration, r as captureNodePairingState } from "./node-pairing-state-DzJGcHd2.js";
import { t as applyPluginNodeInvokePolicy } from "./node-invoke-plugin-policy-u-LWwJro.js";
...
const nodeEventHandlers = { "node.event": async ({ params, respond, context, client }) => {
	...
	await respondUnavailableOnThrow(respond, async () => {
		...
		const { handleNodeEvent } = await import("./server-node-events-D5toC5ZU.js");
