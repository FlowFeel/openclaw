...
import { t as createOpenClawAgentHarness } from "./builtin-openclaw-CwRqpfi2.js";
...
async function runSelectedAgentHarnessAttempt(params) {
	...
	if (internalParams.systemAgentTool && !isSystemAgentOnlyAllowlist(internalParams.toolsAllow)) throw new Error("OpenClaw host authority requires toolsAllow: [\"openclaw\"]");
	const ringZeroTools = internalParams.systemAgentTool ? [(await import("./system-agent-tool-Csen7ezU.js")).createSystemAgentTool(internalParams.systemAgentTool)] : [];
