...
import { yt as resolveSessionStorePathForScope } from "./session-accessor.sqlite-CtCo5VZ6.js";
...
async function loadBeforeResetTranscript(params) {
	...
	try {
		return {
			sessionFile: params.sessionFile,
			messages: parseTranscriptMessages(await loadSqliteTranscriptEvents({
