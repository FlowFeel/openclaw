...
import { a as assertProviderBinaryResponseContent, m as readProviderJsonResponse, r as assertOkOrThrowHttpError } from "./provider-http-errors-Cj7zfu8U.js";
...
import { h as resolveProviderOperationTimeoutMs, i as fetchProviderDownloadResponse, l as postMultipartRequest, n as createProviderOperationDeadline, o as fetchWithTimeoutGuarded, p as resolveProviderHttpRequestConfig, r as createProviderOperationTimeoutResolver, s as pollProviderOperationJson } from "./shared-3S5SOCXx.js";
...
async function downloadOpenAIVideo(params) {
	...
	try {
		...
		if (buffer.byteLength === 0) throw new Error(`${deadline.label}: malformed video response`);
		return {
			buffer,
			mimeType,
