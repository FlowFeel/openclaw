...
import { f as setGatewaySigusr1RestartPolicy, p as setPreRestartDeferralCheck } from "./restart-CdJcfKC4.js";
...
import { C as stopDiagnosticHeartbeat, S as startDiagnosticHeartbeat } from "./diagnostic-D_EA4nFT.js";
import { l as resolveCronJobsStorePathFromConfig } from "./store-865CL89i.js";
import { d as getActiveEmbeddedRunCount, m as resolveActiveEmbeddedRunSessionId } from "./run-state-VfGqytOx.js";
...
import "./server-plugins-D7VUfDQ7.js";
...
import { a as terminateCompactionPlanningPool, o as TopicAffineWorkerPool, s as WorkerPoolError } from "./compaction-planning-worker-DIJ6HAIL.js";
import { t as installSessionPlacementAdmissionProvider } from "./session-placement-admission-BEJd445g.js";
import { n as applyGatewayLaneConcurrency, r as resolveGatewayLaneConcurrency, t as resolveHookClientIpConfig } from "./hook-client-ip-config-DqnP3v1t.js";
...
import { a as incrementPresenceVersion, i as getPresenceVersion, n as getHealthCache, o as refreshGatewayHealthSnapshot, r as getHealthVersion } from "./health-state-n2ZsBJgJ.js";
...
async function startGatewayCoreRuntime(input) {
	...
	const [{ startGatewayEventSubscriptions }, { startGatewayRuntimeServices }] = await startupTrace.measure("runtime.post-early-imports", () => Promise.all([import("./server-runtime-subscriptions-D4zHozIy.js"), import("./server-runtime-startup-services-CarEcSE8.js")]));
	...
	const { execApprovalManager, cancelRunBoundApprovals, forwardPluginApprovalRequest, pluginApprovalIosPushDelivery, pluginApprovalManager, systemAgentApprovalManager, extraHandlers, coreGatewayHandlers } = await startupTrace.measure("gateway.handlers", async () => {
		const [{ createGatewayAuxHandlers }, { coreGatewayHandlers: coreGatewayHandlersLocal }] = await Promise.all([import("./server-aux-handlers-CdXJjjKX.js"), import("./server-methods-DzUoJE4L.js")]);
		return {
...
function createLazyGatewayCronState(params) {
	...
	const cronStateLoader = createLazyPromiseLoader(() => import("./server-cron-CWKWPv1-.js").then(({ buildGatewayCronService }) => {
		loaded = {
	...
	const createCloseHandler = () => async (optsValue) => {
		...
		await createGatewayCloseHandler({
			...
			markMainSessionsAbortedForRestart: async ({ sessionKeys, sessionIds, activeRuns, reason, isActiveRun }) => {
				...
				const { markRestartAbortedMainSessions } = await import("./main-session-restart-recovery-BFXPLv6x.js");
...
const getOpenAiHttpModule = createLazyRuntimeModule(() => import("./openai-http-CwV4ja8N.js"));
const getOpenResponsesHttpModule = createLazyRuntimeModule(() => import("./openresponses-http-BnOVnUXU.js"));
const getSessionHistoryHttpModule = createLazyRuntimeModule(() => import("./sessions-history-http-BUfHAuRR.js"));
const getSessionKillHttpModule = createLazyRuntimeModule(() => import("./session-kill-http-ISG9FLux.js"));
const getToolsInvokeHttpModule = createLazyRuntimeModule(() => import("./tools-invoke-http-DwlsmlS3.js"));
	...
	const handleHooksRequest = async (req, res) => {
		...
		return await runWithGatewayHttpWorkAdmission(res, async () => {
			if (!loadedHooksRequestHandler) {
				const { createGatewayHooksRequestHandler } = await import("./hooks-Du447_f3.js");
...
async function prepareGatewayRuntimeState(params) {
	...
	const { runDefaultChannelSetupWizard, runDefaultSetupWizard } = await import("./wizard-Bj0L0cPN.js");
...
async function prepareGatewayServerBootstrap(input) {
	...
	const loadStartupPluginsModule = createLazyPromise(() => import("./server-startup-plugins-Bkd1H4kH.js"), { cacheRejections: true });
...
async function finishGatewayStartup(params) {
	...
	const sessionChangeSidecar = { stop: async () => {
		const { flushPendingSessionsChangedEvents } = await import("./session-change-event-BUhRuCBx.js");
	...
	const { createGatewayInstanceRuntime } = await import("./server-instance-runtime-D-VVE-jD.js");
	...
	const [{ attachGatewayWsHandlers }, { listPluginNodeCapabilities }] = await startupTrace.measure("gateway.ws-imports", () => Promise.all([import("./server-ws-runtime-C_HzaaKg.js"), import("./route-capability-Cjzy-wRF.js")]));
	...
	const loadScheduledServicesModule = createLazyPromise(() => import("./server-runtime-services-BydMZivX.js"), { cacheRejections: true });
	...
	activateScheduledServicesWhenReady();
	const { startManagedGatewayConfigReloader } = await import("./server-reload-handlers-CjBeZGyX.js");
...
const loadWorkerPlacementStartupModule = createLazyRuntimeModule(() => import("./server-worker-placement-startup-BFpnGgIR.js"));
...
const loadGatewayStartupEarlyModule = createLazyRuntimeModule(() => import("./server-startup-early-cG0GCR6v.js"));
const loadGatewayStartupPostAttachModule = createLazyRuntimeModule(() => import("./server-startup-post-attach-WcEhpbTh.js"));
const log = createSubsystemLogger("gateway");
const logDiscovery = log.child("discovery");
const logTailscale = log.child("tailscale");
const logChannels = log.child("channels");
const getChannelRuntime = createLazyRuntimeModule(() => import("./runtime-channel-9Ar3LGSy.js").then(({ createRuntimeChannel }) => createRuntimeChannel()));
...
const loadGatewayPluginBootstrapModule = createLazyRuntimeModule(() => import("./server-plugin-bootstrap-yNP_9Ar9.js"));
...
async function stopTaskRegistryMaintenanceOnDemand() {
	const { stopTaskRegistryMaintenance } = await import("./task-registry.maintenance-CRcbbTme.js");
