...
import { t as discoverConfiguredPluginLoadPaths } from "./discovery-BwgYKZ4p.js";
import { n as resolveEffectiveHomeDir } from "./home-dir-Cs7bTrwJ.js";
import { C as resolveStateDir, d as resolveConfigPath, y as resolveLegacyStateDirs } from "./paths-CL43LNS6.js";
...
import { i as inspectPluginStartupMetadata, r as inspectBundledPluginStartupMetadata, t as configMayRequireStartupPluginConvergence } from "./startup-plugin-convergence-plan-CyXdDRmO.js";
...
function hasOnlyMigrationSafeInternalHooks(config) {
	...
	return Object.values(internal.entries).every((entry) => {
		...
		return isRecord(entry.env) && Object.values(entry.env).every((value) => typeof value === "string");
	});
}
