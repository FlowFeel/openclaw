...
function sanitizeHostExecEnvWithDiagnostics(params) {
	...
	for (const [key, value] of listNormalizedEnvEntries(baseEnv)) {
		if (isScopedBlockedHostExecEnvVarName(key)) continue;
...
//#endregion
export { normalizeEnvVarKey as a, sanitizeHostExecEnvWithDiagnostics as c, isDangerousHostInheritedEnvVarName as i, sanitizeSystemRunEnvOverrides as l, isDangerousHostEnvOverrideVarName as n, normalizeHostOverrideEnvVarKey as o, isDangerousHostEnvVarName as r, sanitizeHostExecEnv as s, inspectHostExecEnvOverrides as t, withHostExecInheritedEnvOmitted as u };
