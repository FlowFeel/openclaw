...
import { i as loadSystemAgentOverview, n as formatSystemAgentOverview } from "../overview-DsJBt9ai.js";
import { a as resolveSystemAgentVerifiedInferenceRoute } from "../verified-inference-CoZPCL8-.js";
import { a as parseSystemAgentOperation, i as isPersistentSystemAgentOperation, t as executeSystemAgentOperation } from "../operations-BeipxqwO.js";
...
import { n as resolveSystemAgentOperation } from "../dialogue-V6eitvjA.js";
...
async function runSystemAgent(opts, runtime = defaultRuntime) {
	...
	const runInteractiveTui = boundOpts.runInteractiveTui ?? (await import("../tui-backend-D-ncoQjG.js")).runSystemAgentTui;
	boundOpts.onReady?.();
