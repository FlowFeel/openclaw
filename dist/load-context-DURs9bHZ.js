...
import { n as fingerprintPluginAutoEnableConfig, r as fingerprintPluginAutoEnableEnv, t as applyPluginAutoEnable } from "./plugin-auto-enable-Bs1CK1Hn.js";
...
function resolvePluginRuntimeLoadContext(options) {
	...
	const initialMetadataSnapshot = options?.metadataSnapshot ?? (options?.manifestRegistry === void 0 ? resolvePluginMetadataSnapshot({
		config: rawConfig,
		env,
