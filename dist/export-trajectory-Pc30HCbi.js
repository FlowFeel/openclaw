...
import { i as redactSecrets, u as redactToolPayloadText } from "./redact-BGqyyKN9.js";
...
import { ct as loadSqliteSessionEntryReadOnly, st as loadSqliteSessionEntry } from "./session-accessor.sqlite-CtCo5VZ6.js";
import { n as parseSqliteSessionFileMarker } from "./legacy-sqlite-marker-COPKCuIN.js";
import { b as scanSessionTranscriptTree, m as isCanonicalSessionTranscriptEntry } from "./session-transcript-index-NEbbnqMc.js";
import { y as loadSqliteTranscriptEvents } from "./session-accessor.sqlite-transcript-store-BCfOcQgE.js";
import { a as resolveTrajectoryFilePath, i as TRAJECTORY_RUNTIME_FILE_MAX_BYTES, o as resolveTrajectoryPointerFilePath, s as safeTrajectorySessionFileName, t as TRAJECTORY_POINTER_FILE_MAX_BYTES } from "./paths-BeLXoJjn.js";
import { i as hasMeaningfulRetiredMediaCarrier, t as PERSISTED_LEGACY_MEDIA_KEYS } from "./media-facts-D_wLZOa9.js";
import { $ as listSessionEntries, n as resolveSessionTranscriptReadTarget } from "./session-accessor-D5Or7WgI.js";
...
import { r as loadSqliteTrajectoryRuntimeEvents } from "./runtime-store.sqlite-CSXefN-H.js";
import { n as redactSupportString } from "./diagnostic-support-redaction-Dks684Cj.js";
import { a as writeSupportBundleDirectory, i as textSupportBundleFile, n as jsonlSupportBundleFile, r as supportBundleContents, t as jsonSupportBundleFile } from "./diagnostic-support-bundle-Bz7U_IuS.js";
...
async function readSessionEntries(params) {
	...
	if (completeTarget) {
		...
		return collectSessionEntries((await loadSqliteTranscriptEvents({
			agentId: completeTarget.agentId,
	...
	const targetKeyEntry = incompleteTarget?.sessionKey && marker ? loadSqliteSessionEntry({
	...
	const suppliedKeyEntry = params.sessionKey ? loadSqliteSessionEntry({
		agentId: marker.agentId,
