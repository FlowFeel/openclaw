...
import "./openclaw-state-db-D9eH245j.js";
...
import { Mt as onSessionLifecycleEvent } from "./session-accessor.sqlite-CtCo5VZ6.js";
...
import { i as buildAgentRunTerminalOutcomeFromLifecycleEvent, l as mergeAgentRunTerminalOutcome, o as classifyAgentRunTerminalOutcome } from "./agent-run-terminal-outcome-C9bgFmfC.js";
...
import { c as removeChatAbortControllerEntry } from "./chat-abort-B1M0lO2h.js";
import { n as onGatewaySessionReset } from "./session-reset-notifications-Is8h_Auo.js";
import { a as terminalHealthFor, i as readFiniteNumber, n as flushSessionActivityAssistantNote, r as noteSessionActivityEvent, t as createSessionActivityNoteState } from "./session-activity-notes-BcL00ri7.js";
...
function startGatewayEventSubscriptions(params) {
	...
	const agentEventHandlerLoader = createLazyPromiseLoader(() => {
		return Promise.all([import("./server-chat-CaK944KI.js"), import("./server-session-key-BfZuJIv4.js")]).then(([{ createAgentEventHandler }, { resolveSessionKeyForRun }]) => createAgentEventHandler({
	...
	const getSessionEventsModule = createLazyPromise(() => import("./server-session-events-tZBfNFVY.js"), { cacheRejections: true });
	...
	const taskObserverRuntimePromise = import("./task-registry.store-Bbp9Dwjq.js").then((module) => {
