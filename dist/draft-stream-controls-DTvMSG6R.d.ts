...
import { S as MessageReceipt, y as LiveMessageState } from "./types-DZ4POeRA.js";
...
declare function createDraftStreamLoop<T = string>(params: {
  throttleMs: number;
  isStopped: () => boolean;
  sendOrEditStreamMessage: (value: T) => Promise<void | boolean>; /** Empty sentinel and predicate for non-string payloads. */
  emptyValue?: T;
