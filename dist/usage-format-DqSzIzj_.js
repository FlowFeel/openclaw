...
import { c as resolveAgentDir, f as resolveDefaultAgentId, n as listAgentEntries } from "./agent-scope-config-Dusa8eSA.js";
import { n as getRemoteModelCatalogPricing, t as planEffectiveModelCatalogRows } from "./model-catalog-BEn_zNk0.js";
...
import { n as isInstalledPluginEnabled } from "./installed-plugin-index-CqNI0grC.js";
import { a as resolvePluginMetadataSnapshot } from "./plugin-metadata-snapshot-DtW_P3kZ.js";
import { o as normalizeModelRef, s as normalizeProviderId } from "./model-ref-shared-BCBRWGJh.js";
...
function resolveCostAgentDir(config, agentDir) {
	...
	if (config && listAgentEntries(config).length > 0) return resolveAgentDir(config, resolveDefaultAgentId(config));
