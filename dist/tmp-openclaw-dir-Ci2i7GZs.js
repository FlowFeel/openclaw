...
import { x as findExistingAncestor } from "./pinned-write-CO4XA8tE.js";
import { f as pathScope } from "./fs-safe-DVaClkIX.js";
import { i as hasProxyEnvConfigured } from "./proxy-env-sKZhlk0j.js";
import { _ as resolvePinnedHostnameWithPolicy, d as isPrivateNetworkAllowedByPolicy, t as SsrFBlockedError } from "./ssrf-C889LYfv.js";
...
import { n as registerManagedProxyBrowserCdpBypass } from "./proxy-lifecycle-QXGsYfJj.js";
...
import { p as DEFAULT_BROWSER_LOCAL_LAUNCH_TIMEOUT_MS } from "./constants-BoWgRtg0.js";
import "./ssrf-runtime-internal-aIPsql-v.js";
...
async function withCdpSocket(wsUrl, fn, opts) {
	...
	for (let attempt = 0;; attempt += 1) {
		...
		if (opts?.signal?.aborted) abortHandshake();
		try {
			await openPromise;
		} catch (err) {
			/* c8 ignore next */
...
//#endregion
export { BrowserValidationError as A, PLAYWRIGHT_TARGET_INFO_TIMEOUT_MS as B, BrowserError as C, BrowserResourceExhaustedError as D, BrowserResetUnsupportedError as E, CHROME_BOOTSTRAP_PREFS_TIMEOUT_MS as F, withManagedProxyForCdpUrl as G, resolveCdpReachabilityTimeouts as H, CHROME_LAUNCH_READY_WINDOW_MS as I, ensureAbsoluteDirectory as J, withNoProxyForCdpUrl as K, CHROME_MCP_ATTACH_READY_WINDOW_MS as L, toBrowserErrorResponse as M, CDP_JSON_NEW_TIMEOUT_MS as N, BrowserTabNotFoundError as O, CHROME_BOOTSTRAP_EXIT_TIMEOUT_MS as P, CHROME_STDERR_HINT_MAX_CHARS as R, BrowserConflictError as S, BrowserProfileUnavailableError as T, usesFastLoopbackCdpProbeClass as U, PROFILE_ATTACH_RETRY_TIMEOUT_MS as V, assertManagedProxyAllowsCdpUrl as W, withTimeout as Y, normalizeBrowserTimerDelayMs as _, fetchJson as a, BROWSER_ERROR_REASONS as b, isDirectCdpWebSocketEndpoint as c, openCdpWebSocket as d, redactCdpErrorText as f, withCdpSocket as g, stripCdpUrlCredentials as h, fetchCdpChecked as i, parseBrowserErrorPayload as j, BrowserTargetAmbiguousError as k, isWebSocketUrl as l, scopeCdpPolicyToConfiguredEndpoint as m, assertCdpEndpointAllowed as n, fetchOk as o, resolveCdpTabOwnership as p, rawDataToString as q, closeTrackedCdpTarget as r, getHeadersWithAuth as s, appendCdpPath as t, normalizeCdpHttpBaseForJsonEndpoints as u, withExactHostnamePolicy as v, BrowserProfileNotFoundError as w, BrowserCdpEndpointBlockedError as x, resolveBrowserRateLimitMessage as y, CHROME_STOP_TIMEOUT_MS as z };
