...
import { d as ensureExplicitGatewayAuth, o as buildGatewayConnectionDetails, y as resolveExplicitGatewayAuth } from "./call-B_qeDbXh.js";
...
import { t as resolveGatewayInteractiveSurfaceAuth } from "./auth-surface-resolution-DnXmeZfA.js";
	...
	constructor(connection) {
		...
		this.client = new GatewayClient({
			...
			onClose: (_code, reason) => {
				...
				if (this.pendingConnectError && this.onConnectError) return;
