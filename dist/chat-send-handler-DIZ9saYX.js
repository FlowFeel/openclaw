...
import { a as measureDiagnosticsTimelineSpan, n as emitDiagnosticsTimelineEvent, o as measureDiagnosticsTimelineSpanSync } from "./diagnostics-timeline-BxwfDTJ-.js";
...
import { d as sessionDeliveryOrigin, n as deliveryContextFromSession, u as sessionDeliveryChannel } from "./delivery-context.shared-DR6KpKlV.js";
...
import { c as isOperatorUiClient, i as isGatewayCliClient, l as isWebchatClient, n as isBrowserOperatorUiClient, t as isBrowserCopilotClient } from "./message-channel-Bo27VP7K.js";
import { h as isAgentHarnessSessionKey, n as buildRestartRecoveryClaimCleanupPatch, o as hasRestartRecoveryTerminalRun, ut as beginSessionWorkAdmission, w as resolveMissingAgentHarnessSessionError } from "./session-entry-slot-keys-DPRQmSpa.js";
import { n as estimateBase64DecodedBytes } from "./base64-KcXAb-1x.js";
import { I as resolveSessionTranscriptActiveLeafEntryId, a as readSessionTranscriptWatermark, u as readSessionTranscriptActiveLeafEvents } from "./session-accessor-D5Or7WgI.js";
...
import { i as deleteMediaBuffer, t as MEDIA_MAX_BYTES } from "./store-QVlUiM0_.js";
import { i as parseInboundMediaUri } from "./media-reference-sxufFF1B.js";
...
import { d as isPluginOwnedSessionBindingRecord } from "./conversation-binding-BN-i7DFo.js";
import { a as shouldComputeCommandAuthorized } from "./command-detection-DovQ96XW.js";
import { n as resolveAgentTimeoutMs } from "./timeout-BEGWfRGM.js";
import { h as isReplyRunAbortableForSignal, w as replyRunRegistry } from "./reply-run-registry-CFY_Ts2Y.js";
import { f as listActiveEmbeddedRunSessionIds } from "./run-state-oGYwHnd-.js";
...
import { o as readSessionMessageByIdAsync } from "./session-transcript-readers-O8pyQfzE.js";
...
import { s as normalizeMediaReferenceForComparison } from "./reply-payloads-dedupe-B4sXvswH.js";
import { t as findRestartRecoveryUnsafeChatAdmissionHook } from "./restart-recovery-hook-safety-C1ETZhtA.js";
...
import { n as assertLocalMediaAllowed, t as LocalMediaAccessError } from "./local-media-access-CfOl4jrn.js";
import { n as runAgentHarnessBeforeMessageWriteHook } from "./hook-helpers-DbM1YFe0.js";
import { n as resolveSessionEntryResetFreshness } from "./entry-freshness-XqgLgFgg.js";
import { t as ensureSandboxWorkspaceForSession } from "./context-BSQua5VL.js";
import { t as projectChatDisplayMessage } from "./chat-display-projection-BiWlQzhw.js";
import { n as isSuppressedControlReplyText } from "./control-reply-text-BXkKqW89.js";
import { i as dispatchInboundMessageWithProjectedDispatcher } from "./dispatch-CesChjj3.js";
import { t as chatAbortMarkerTimestampMs } from "./server-chat-state-C8AVcQU8.js";
import { f as updateChatRunProvider, o as isChatStopCommandText, s as registerChatAbortController, u as resolveChatRunExpiresAtMs } from "./chat-abort-B1M0lO2h.js";
...
import { a as parseMessageWithAttachments, i as logAttachmentFailure, n as MediaOffloadError, o as persistInboundImagesForTranscript, r as UnsupportedAttachmentError, s as stripImageMediaMarkers, t as normalizeRpcAttachmentsToChatAttachments } from "./attachment-normalize-CKQigle-.js";
import { i as maybeGenerateDashboardSessionTitle, r as isDashboardSessionTitleCandidate } from "./dashboard-session-title-bu6ZzXU0.js";
import { _ as gatewayClientSenderFields } from "./session-sharing-BuGIPH6F.js";
import { t as emitSessionsChanged } from "./session-change-event-CX3Vh0EN.js";
import { i as persistGatewaySessionLifecycleEvent } from "./session-lifecycle-state-B3C1oG12.js";
...
async function resolveDurableChatClaim(params) {
	...
	if (isAdoptedRestartRecoveryClaim(entry, params.clientRunId) && entry.status === "running" && entry.abortedLastRun === true) {
		...
		try {
			const { retryRestartAbortedMainSessionRecovery } = await import("./main-session-restart-recovery-DMkyfztr.js");
