...
import { a as coerceStatusIssueAccountId, d as readStatusIssueFields, n as buildPassiveProbedChannelStatusSummary } from "./extension-shared-CyJFAMlE.js";
...
import { d as resolveScopeRequireMention, f as resolveScopeToolsPolicy } from "./channel-policy-BgbKncah.js";
import { a as createEmptyChannelResult } from "./channel-send-result-BFAnsv6z.js";
import { a as checkZcaAuthenticated, c as resolveZalouserAccountSync, i as writeQrDataUrlToTempFile, o as listZalouserAccountIds, r as zalouserSetupContract, s as resolveDefaultZalouserAccountId, t as createZalouserSetupWizardProxy } from "./setup-core-Y5bIeeRE.js";
...
const loadZalouserChannelRuntime$1 = createLazyRuntimeModule(() => import("./channel.runtime-qSHoXuaq.js"));
...
const loadZalouserChannelRuntime = createLazyRuntimeModule(() => import("./channel.runtime-qSHoXuaq.js"));
const zalouserSetupWizardProxy = createZalouserSetupWizardProxy(async () => (await import("./setup-surface-KV7IhJWI.js")).zalouserSetupWizard);
	...
	base: {
		...
		gateway: {
			startAccount: async (ctx) => {
				...
				const { monitorZalouserProvider } = await import("./monitor-sy_BSWzW.js");
