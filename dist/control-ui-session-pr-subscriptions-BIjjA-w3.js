...
import { l as CONTROL_UI_SESSION_PULL_REQUESTS_CHANGED_EVENT } from "./control-ui-contract-ByeBOCHr.js";
...
async function loadSessionPullRequests(params) {
	const { loadControlUiSessionPullRequests } = await import("./control-ui-session-prs-D4w6v94v.js");
