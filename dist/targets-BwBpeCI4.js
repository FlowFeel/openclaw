...
import { n as buildHostnameAllowlistPolicyFromSuffixAllowlist } from "./ssrf-policy-CHmrygRA.js";
...
import { i as resolveGoogleChatAccount, o as MAX_GOOGLE_CHAT_SERVICE_ACCOUNT_FILE_BYTES } from "./accounts-DKymd4E9.js";
...
async function loadGoogleAuthRuntime() {
	googleAuthRuntimePromise ??= import("./src-Dp44d--f.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)).catch((error) => {
...
const GOOGLE_CHAT_MEDIA_RESPONSE_MAX_BYTES = 20 * 1024 * 1024;
