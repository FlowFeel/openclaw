...
import { r as formatErrorMessage, t as collectErrorGraphCandidates } from "./errors-Cg_yT1Sv.js";
import { n as normalizeAgentId$1 } from "./agent-id-DDgUze4y.js";
import { n as normalizeAccountId } from "./account-id-CIVg1QNG.js";
import { i as installRequestBodyLimitGuard } from "./http-body-CcNaNPg0.js";
...
import { d as sendMediaWithLeadingCaption, u as resolveTextChunksWithFallback } from "./reply-payload-BE_j43tQ.js";
import { a as resolveSendableOutboundReplyParts } from "./reply-payload-parts-Djg03PGA.js";
import { T as resolveChannelStreamingBlockEnabled, _ as resolveChannelPreviewStreamMode, d as isChannelProgressDraftWorkToolName, s as formatChannelProgressDraftLineForEntry } from "./streaming-Df3LUUGR.js";
import { l as formatReasoningMessage } from "./embedded-agent-utils-Brq3aP9h.js";
import { a as resolveInboundLastRouteSessionKey, i as resolveAgentRoute } from "./resolve-route-DkCGGMmz.js";
...
import { n as resolveAgentOutboundIdentity } from "./identity-CwExPwp9.js";
...
import { a as resolveEnvelopeFormatOptions, t as formatAgentEnvelope } from "./envelope-DYPQHVWk.js";
import { t as evaluateSupplementalContextVisibility } from "./context-visibility-C5CaKMWO.js";
import { f as formatInboundMediaUnavailableText, g as toInboundMediaFactsWithMetadata, s as recordChannelBotPairLoopAndCheckSuppression } from "./kernel-CyB9GCRw.js";
...
import { n as resolveConfiguredBindingRoute, r as resolveRuntimeConversationBindingRoute, t as ensureConfiguredBindingRouteReady } from "./binding-routing-BKaLXZp2.js";
...
import { n as channelBlockedPatch, r as channelReadyPatch } from "./gateway-runtime-BM4_lec6.js";
...
import { n as fanInChannelIngressLifecycles } from "./channel-ingress-runtime-Zqqr2Y7k.js";
import { n as createChannelIngressError, r as createChannelIngressMonitor } from "./ingress-monitor-BG80PaNl.js";
...
import { t as createChannelReplayGuard } from "./persistent-dedupe-BwoXHcgm.js";
import "./text-utility-runtime-Dwuhfjgs.js";
import { c as readWebhookBodyOrReject, r as applyBasicWebhookRequestGuards } from "./webhook-request-guards-cY_xufKf.js";
import { a as createFixedWindowRateLimiter, o as createWebhookAnomalyTracker, r as WEBHOOK_RATE_LIMIT_DEFAULTS, t as WEBHOOK_ANOMALY_COUNTER_DEFAULTS } from "./webhook-ingress-CNHkUY93.js";
import { _ as requestFeishuApi, d as extractReplyText, g as readString$1, h as parseCommentContentElements, l as resolveFeishuRuntimeAccount, m as normalizeString, p as isRecord$1, s as resolveFeishuAccount, u as encodeQuery, v as buildFeishuCommentTarget, y as normalizeCommentFileType } from "./accounts-9P32R9R0.js";
import { i as resolveReceiveIdType } from "./targets-CYvuU_k1.js";
import { A as resolveFeishuChatType, C as resolveFeishuDmIngressAccess, E as resolveFeishuGroupSenderActivationIngressAccess, M as buildFeishuCardActionTextFallback, N as createFeishuCardInteractionEnvelope, O as resolveFeishuReplyPolicy, P as decodeFeishuCardAction, S as normalizeFeishuAllowEntry, T as resolveFeishuGroupConversationIngressAccess, d as chunkFeishuPostMarkdown, f as materializeFeishuPostMarkdownSoftBreaks, k as normalizeFeishuChatType$2, o as resolveFeishuCardTemplate, w as resolveFeishuGroupConfig, x as hasExplicitFeishuGroupConfig } from "./send-result-CUChe1dA.js";
import { n as normalizeFeishuWebhookPath } from "./webhook-path-CdNjPCi8.js";
import { o as resolveConfiguredFeishuGroupSessionScope, t as buildFeishuConversationId } from "./conversation-id-DG-b0jtV.js";
import { i as getFeishuUserAgent, n as createFeishuClient, o as resolveConfiguredHttpTimeoutMs, r as createFeishuWSClient, t as createEventDispatcher } from "./client-DUDRSoSv.js";
import { t as getFeishuRuntime } from "./runtime-zwHao5bm.js";
import { i as createCommentTypingReactionLifecycle, s as getChatInfo, t as deliverCommentThreadText } from "./drive-CMSjKyGv.js";
import { t as createFeishuThreadBindingManager } from "./thread-bindings-foHibL6N.js";
import "./runtime-api-BKN6eOy4.js";
import { t as readFeishuJsonResponse } from "./json-response-aaXF20Uh.js";
import { _ as buildFeishuMediaFallbackText, a as getMessageFeishu, d as extractMentionTargets, f as isFeishuBroadcastMention, g as normalizeFeishuExternalKey, h as parsePostContent, l as sendMessageFeishu, m as isFeishuGroupChatType, n as sendMediaFeishu, o as listFeishuThreadMessages, p as isMentionForwardRequest, r as shouldSuppressFeishuTextForVoiceMedia, s as sendCardFeishu, t as saveMessageResourceFeishu, u as sendStructuredCardFeishu, v as resolveFeishuIdentityEmoji } from "./media-Ma36SWvo.js";
import { i as waitForAbortableDelay, r as raceWithTimeoutAndAbort } from "./probe-Bn6DFcAv.js";
import { t as fetchBotIdentityForMonitor } from "./monitor.startup-8x6IM1oF.js";
...
const SENDER_NAME_NEGATIVE_TTL_MS = 1800 * 1e3;
	...
	return {
		...
		delivery: {
			...
			deliver: async (payload, info) => {
				...
				preparedDeliveryAssistantMessageIndex = void 0;
				if (info?.kind === "final" || skippedFinalReason !== "silent" || skippedFinalAssistantMessageIndex === void 0 || deliveryAssistantMessageIndex === void 0 || deliveryAssistantMessageIndex >= skippedFinalAssistantMessageIndex) {
					skippedFinalReason = null;
					skippedFinalAssistantMessageIndex = void 0;
				}
...
async function handleFeishuMessage(params) {
	...
	try {
		...
		const inboundMedia = await toInboundMediaFactsWithMetadata(mediaList, { transcribed: (_media, index) => index === preflightAudioIndex });
...
async function resolveDriveCommentEventCore(params) {
	...
	const context = await fetchDriveCommentContext({
		client: createClient ? createClient(account ?? { accountId }) : createFeishuClient((await import("./accounts-C9E3ixfR.js")).resolveFeishuAccount({
			cfg,
			accountId
		})),
		fileToken,
				...
				dispatch: async (admissionLifecycle) => {
					...
					try {
						if (activeEntries.length === 1) {
							await dispatchFeishuMessage(last.event, resolveFeishuMessageDedupeKey(last.event), last.processingClaim, admissionLifecycle);
							await settle();
							return;
						}
...
async function resolveReactionSyntheticEvent(params) {
	...
	const { resolveFeishuAccount } = await import("./accounts-C9E3ixfR.js");
...
function parseFeishuBotAddedEventPayload(value) {
	if (!isRecord$1(value) || !readString$1(value.chat_id) || !isRecord$1(value.operator_id)) return null;
	return value;
}
