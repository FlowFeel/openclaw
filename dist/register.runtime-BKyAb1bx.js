...
import { l as upsertAuthProfileWithLock } from "./profiles-C4bFcrKC.js";
import { n as suggestOAuthProfileIdForLegacyDefault } from "./repair-B9E8U86g.js";
import { t as applyAuthProfileConfig } from "./provider-auth-helpers-Cy_Bi6JW.js";
...
import { a as buildProviderReplayFamilyHooks, c as modelCostsEqual, p as cloneFirstTemplateModel } from "./provider-model-shared-BPWEhHPG.js";
import "./cli-runtime-i8MaZLnW.js";
import { i as buildOpenAICompatibleProviderCatalog } from "./provider-catalog-live-runtime-DxjbP9IU.js";
import { r as buildManifestModelProviderConfig } from "./provider-catalog-shared-BFBHaHNZ.js";
import { n as readClaudeCliCredentialsForSetup, r as readClaudeCliCredentialsForSetupNonInteractive } from "./cli-auth-seam-Bvrm-3wJ.js";
...
import { t as buildAnthropicCliMigrationResult } from "./cli-migration-o9fLOQY5.js";
...
import { t as acceptsAnthropicLiveModelContract } from "./live-model-contract-gate-q1-_E0ko.js";
import { t as anthropicMediaUnderstandingProvider } from "./media-understanding-provider-BNx14jt7.js";
import { n as resolveClaudeCliSyntheticAuth } from "./provider-discovery-CpWgXplA.js";
import { n as createClaudeSessionNodeInvokePolicies } from "./session-catalog-node-commands-CkrWMyDg.js";
import { t as registerClaudeSessionDiscovery } from "./session-catalog-registration-B8BC-s3N.js";
import { c as wrapAnthropicProviderStream, i as isAnthropicOAuthApiKey } from "./stream-wrappers-C52Lm7Eu.js";
import { n as resolveAnthropicUsageAuth, t as fetchAnthropicUsage } from "./usage-BeZwUoBg.js";
...
let anthropicManifestCompatIndex;
function resolveAnthropicManifestCompat(provider, modelId) {
	if (!anthropicManifestCompatIndex) {
		anthropicManifestCompatIndex = /* @__PURE__ */ new Map();
		const providers = modelCatalog?.providers ?? {};
		for (const [providerId, catalog] of Object.entries(providers)) for (const model of catalog.models ?? []) {
			const compat = model.compat;
			if (compat) anthropicManifestCompatIndex.set(`${providerId}/${model.id}`, compat);
		}
	}
