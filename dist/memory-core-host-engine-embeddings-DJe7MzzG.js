...
import { b as estimateUtf8Bytes, h as runMemoryHostTasksWithConcurrency, v as hasNonTextEmbeddingParts, x as splitTextToUtf8ByteLimit } from "./internal-CYxvuRJj.js";
...
const resolveApiKeyForProvider = async (...args) => {
	return (await import("./model-auth-BR9AFEUL.js")).resolveApiKeyForProvider(...args);
};
//#endregion
