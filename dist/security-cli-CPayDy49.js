...
import { n as formatIcaclsResetCommand, t as createIcaclsResetCommand } from "./permissions-CvYj0JYg.js";
...
import { h as tryResolveDefaultAgentId, n as listAgentEntries } from "./agent-scope-config-Dusa8eSA.js";
...
import { p as getSecurityAuditCommandSecretTargetIds } from "./command-secret-targets-DIFshlpq.js";
import { t as formatHelpExamples } from "./help-format-CAcwboTs.js";
import { t as runSecurityAudit } from "./audit-qKgg5OBR.js";
...
async function collectChannelSecurityConfigFixMutation(params) {
	...
	const collectPlugins = async () => {
		...
		try {
			...
			const { listBundledChannelPlugins } = await import("./bundled-VYpZpMxR.js");
