...
import { Dt as validateExecApprovalGetParams, Ot as validateExecApprovalRequestParams, kt as validateExecApprovalResolveParams } from "./src-BSn6va4B.js";
import { a as errorShape } from "./error-codes-P4fBo0lR.js";
import { N as DEFAULT_EXEC_APPROVAL_TIMEOUT_MS, O as normalizeExecApprovalUnavailableDecisions, j as resolveExecApprovalRequestAllowedDecisions } from "./exec-approvals-sCmCk_jQ.js";
import { i as detectCommandCarrierArgv, o as detectInlineEvalInSegments } from "./risks-DVvbIVRa.js";
import { t as resolveExecCommandHighlighting } from "./exec-command-highlighting-DRFd3jkG.js";
import { i as sanitizeExecApprovalWarningText, n as sanitizeExecApprovalDisplayText, r as sanitizeExecApprovalDisplayTextWithStatus, t as resolveExecApprovalCommandDisplay } from "./exec-approval-command-display-BtRPbRj9.js";
import { t as analyzeCommandForPolicy } from "./policy-BIuMa4nV.js";
import { a as buildSystemRunApprovalEnvBinding, i as buildSystemRunApprovalBinding } from "./system-run-command-BnpjDuob.js";
import { n as resolveSystemRunApprovalRequestContext } from "./system-run-approval-context-ClRO-ZUk.js";
import { t as assertValidParams } from "./validation-DyQ6nhKI.js";
import { r as InvalidApprovalIdError } from "./exec-approval-manager-5dZjZ1MP.js";
import { a as handleApprovalResolve, d as resolveApprovalDecisionParams, f as resolvePendingApprovalRecord, i as buildRequestedApprovalEvent, l as listVisiblePendingApprovalRequests, m as respondPendingApprovalLookupError, n as bindApprovalReviewerDeviceIds, o as handleApprovalWaitDecision, s as handlePendingApprovalRequest, t as bindApprovalRequesterMetadata, u as registerPendingApprovalRecord } from "./approval-shared-DXraVglW.js";
import { t as runApprovalRequestDeliveries } from "./approval-request-delivery-DROxoijh.js";
...
async function explainCommandForDisplay(command) {
	try {
		const { explainShellCommand } = await import("./extract-BCVxY_Dt.js");
