...
import { J as failFlow, O as listTasksForFlowId, W as createManagedTaskFlow, X as finishFlow, at as setFlowWaiting, it as resumeFlow, nt as requestFlowCancel } from "./task-registry-ZiNcN-Vv.js";
import "./runtime-internal-bRqSw-VA.js";
import { _ as findLatestTaskFlowForOwner, b as resolveTaskFlowForLookupTokenForOwner, d as getFlowTaskSummary, m as runTaskInFlowForOwner, r as cancelFlowByIdForOwner, t as cancelDetachedTaskRunById, v as getTaskFlowByIdForOwner, y as listTaskFlowsForOwner } from "./task-executor-MxYrmS19.js";
...
import { c as listRuntimeMusicGenerationProviders, s as generateMusic } from "./openclaw-tools-DDu2b20y.js";
import { a as getTaskByIdForOwner, o as listTasksForRelatedSessionKeyForOwner, r as findLatestTaskForRelatedSessionKeyForOwner, s as resolveTaskForLookupTokenForOwner } from "./task-owner-access-CKSwWrkq.js";
...
import { n as listRuntimeVideoGenerationProviders, t as generateVideo } from "./runtime-DeQum4cZ.js";
import { i as listWebSearchProviders, o as runWebSearch } from "./runtime-CLK7mhcF.js";
...
import { t as createRuntimeChannel } from "./runtime-channel-DR3v7_hu.js";
...
async function createSessionEntry(params) {
	const [{ createGatewaySession }, { resolveGatewaySessionStoreTarget }, { readAcpSessionMetaForEntry, upsertAcpSessionMeta }] = await Promise.all([
		import("./session-create-service-Dlfb2iuW.js"),
		import("./session-utils-CrHOjJ4j.js"),
...
const runHeartbeatOnceInternal = createLazyRuntimeMethod(createLazyRuntimeModule(() => import("./heartbeat-runner-BtQ_Ofm5.js")), (runtime) => runtime.runHeartbeatOnce);
...
const loadTtsRequestRuntime = createLazyRuntimeModule(() => import("./runtime-tts-request-3JIw6x9K.js"));
const loadMediaUnderstandingRuntime = createLazyRuntimeModule(() => import("./runtime-CUZHXFmI.js"));
const loadModelAuthRuntime = createLazyRuntimeModule(() => import("./runtime-model-auth.runtime.js"));
const loadGatewayPluginRuntime = createLazyRuntimeModule(() => import("./server-plugins-CVC0s6j1.js"));
