...
import { i as hasLegacyAutoFallbackWithoutOrigin } from "./agent-scope-DyEposw2.js";
...
import { S as resolveModelAliasFromPair, i as buildConfiguredModelCatalog } from "./model-selection-shared-V7VmYFPH.js";
import { i as legacyModelKey, o as normalizeModelRef, s as normalizeProviderId } from "./model-ref-shared-BEKlpylb.js";
...
import { u as resolveReasoningDefault } from "./model-selection-CZlE_kEq.js";
import { n as SessionWorkStartInvalidatedError } from "./lifecycle-Dw-f5gZg.js";
import { i as applyModelOverrideToSessionEntry } from "./model-overrides-BT6Lelev.js";
import { n as createModelVisibilityPolicy, t as RUNTIME_MODEL_VISIBILITY_NORMALIZATION } from "./model-visibility-policy-D0F7CqUd.js";
...
import { i as resolveStoredModelOverride, n as normalizeStoredRuntimeModelRef, r as resolveDirectStoredModelOverride, t as isStaleHeartbeatAutoFallbackOverride } from "./stored-model-override-CIi2XjrS.js";
import { t as clearSessionAuthProfileOverride } from "./session-override-CqXr7YEI.js";
import "./model-selection-directive-Bj8Ksp0z.js";
import "./model-selection-context-CdOpSj6c.js";
...
const sessionPersistenceRuntimeLoader = createLazyImportLoader(() => import("./session-entry-persistence-ZHs58yBd.js"));
...
async function createModelSelectionState(params) {
	...
	const loadRuntimeCatalogSnapshot = async () => params.preparedModelCatalog ?? await (await loadPreparedModelCatalogRuntime()).loadPreparedModelCatalogSnapshot(catalogScope);
