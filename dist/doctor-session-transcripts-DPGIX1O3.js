...
import { o as isLegacyCodexProviderId } from "./codex-route-model-ref-B7v0y8up.js";
import { E as parseSqliteSessionEntryRecord, _ as runOpenClawAgentWriteTransaction, f as isOpenClawAgentDatabaseOpen, h as openOpenClawAgentDatabase, i as closeOpenClawAgentDatabaseByPath } from "./openclaw-agent-db--PLC25lY.js";
import { n as deliveryContextFromSession, u as sessionDeliveryChannel } from "./delivery-context.shared-B-QSuGw_.js";
...
import { C as selectSessionTranscriptTreePathNodes, _ as mergeSessionTranscriptTreePaths, b as scanSessionTranscriptTree, h as isSessionTranscriptLeafControl, v as mergeSessionTranscriptVisiblePathWithOpaqueAppendPath } from "./session-transcript-index-cy-aJty7.js";
...
import { n as normalizeLegacySessionEntryDelivery } from "./state-migrations.legacy-session-store-RXXUZyiq.js";
import { i as withDoctorSqliteMaintenanceLock, t as DoctorSqliteMaintenanceLockUnavailableError } from "./doctor-sqlite-maintenance-lock-rpLk9K-Z.js";
import { f as resolveTargetSqlitePath } from "./doctor-session-sqlite-readers-zf89VAIM.js";
import { t as runDoctorAgentDatabaseOperation } from "./doctor-agent-database-operation-Df13LGBQ.js";
...
async function noteSessionSqliteMigrationHealth(params) {
	const { runDoctorSessionSqlite } = await import("./doctor-session-sqlite-BdESs3sy.js");
