...
import { _ as readStringParam, d as readNonNegativeIntegerParam, o as imageResultFromFile, p as readPositiveIntegerParam } from "./common-yW0U9cHP.js";
...
import { t as startLazyPluginServiceModule } from "./plugin-runtime-CoyXDM_Q.js";
import { t as safeParseJson } from "./server-json-CwSvRDkn.js";
import { n as respondUnavailableOnNodeInvokeError } from "./nodes.helpers-C0b28TGW.js";
import { t as describeImageFile } from "./runtime-DEX1Whtn.js";
...
import { n as BrowserToolSchema, t as BrowserToolOutputSchema } from "./browser-tool.schema-C1CFYjh8.js";
import { a as resolveProfile, l as resolveExistingUploadPaths, r as resolveBrowserConfig } from "./config-B2k8sZ1m.js";
import { Y as withTimeout } from "./tmp-openclaw-dir-BK3eq-mf.js";
import "./errors-Cb3-8IJ1.js";
import { N as parseBrowserNavigationUrl } from "./chrome-CObhw6aD.js";
import { t as getBrowserProfileCapabilities } from "./profile-capabilities-DqO0AgW7.js";
import "./sdk-setup-tools-BpwkGBkq.js";
import { C as fetchBrowserJson, S as BrowserServiceError, _ as browserStatus, a as untrackSessionBrowserTab, d as browserImportProfile, f as browserOpenTab, g as browserStart, h as browserSnapshot, i as trackSessionBrowserTab, l as browserDoctor, o as browserCloseTab, p as browserProfiles, r as touchSessionBrowserTab, u as browserFocusTab, v as browserStop, x as browserTabs, y as browserSystemProfiles } from "./session-tab-registry-CPen4hh5.js";
import { _ as isBrowserProxyUploadRequest, a as persistBrowserProxyFiles, b as parseBrowserProxyFailure, c as browserPdfSave, d as browserArmFileChooser, f as browserDownload, h as browserWaitForDownload, i as applyBrowserProxyPaths, l as browserAct, m as browserScreenshotAction, o as browserConsoleMessages, p as browserNavigate, s as browserPageContent, u as browserArmDialog, v as prepareBrowserProxyUploadRequest, y as BROWSER_PROXY_ERROR_ENVELOPE } from "./core-api-1VgVUcJH.js";
import { o as normalizeBrowserScreenshot, r as parseSystemProfileDomains } from "./routes-CyOyRQ6d.js";
import { a as describeBrowserScreenshot, c as stageBrowserScreenshotForSharing, n as executeExtractAction, o as neutralizeMediaDirectives, s as resolveRuntimeImageSanitization } from "./browser-extract-Dhvn_-A8.js";
import { n as createBrowserControlContext } from "./plugin-enabled-cxFNJ65P.js";
import { a as resolveRequestedBrowserProfile, n as isBrowserHostLocalRoute, r as isPersistentBrowserProfileMutation, t as createBrowserRouteDispatcher } from "./dispatcher-N4dsYguE.js";
...
function createBrowserPluginService() {
	...
	return {
		id: "browser-control",
		start: async () => {
			const pageShare = await import("./page-share-B6h0zrD6.js");
			...
			handle = await startLazyPluginServiceModule({
				...
				loadDefaultModule: async () => await import("./server-BCbdk5NT.js"),
		...
		stop: async () => {
			const { setPageShareSink } = await import("./page-share-B6h0zrD6.js");
			...
			const { stopBrowserControlService } = await import("./control-service-X9JvOb3B.js");
