...
import { c as postJsonRequest, h as resolveProviderOperationTimeoutMs, i as fetchProviderDownloadResponse, n as createProviderOperationDeadline, p as resolveProviderHttpRequestConfig, r as createProviderOperationTimeoutResolver, s as pollProviderOperationJson } from "./shared-3S5SOCXx.js";
...
async function downloadRunwayVideos(params) {
	...
	for (const [index, url] of params.urls.entries()) {
		...
		if (buffer.byteLength === 0) throw new Error("Runway generated video download: malformed video response");
		videos.push({
			buffer,
			mimeType,
