...
import { c as generateHexPkceVerifierChallenge } from "./provider-auth-SalgjzRl.js";
...
import { n as generateOAuthState } from "./provider-auth-runtime-y5vTf3MK.js";
import { D as resolveGoogleMeetGatewayOperationTimeoutMs, O as buildGoogleMeetCalendarDayWindow, _ as resolveSpaceFromParams, h as resolveMeetingFromParams, k as listGoogleMeetCalendarEvents, m as resolveGoogleMeetTokenFromParams, p as resolveArtifactQueryFromParams } from "./plugin-helpers-DvJMTZ6F.js";
import { _ as endGoogleMeetActiveConference, g as createGoogleMeetSpace, h as fetchGoogleMeetAttendance, m as fetchGoogleMeetArtifacts, p as buildGoogleMeetPreflightReport, v as fetchGoogleMeetSpace, y as fetchLatestGoogleMeetConferenceRecord } from "./chrome-create-BHUUfKGt.js";
import { i as waitForGoogleMeetAuthCode, n as exchangeGoogleMeetAuthCode, r as resolveGoogleMeetAccessToken, t as buildGoogleMeetAuthUrl } from "./oauth-BjfJqkvu.js";
import { i as resolveCreateSpaceConfig, r as hasCreateSpaceConfigInput } from "./create-DhJQCy1A.js";
...
function registerGoogleMeetArtifactCommands(context) {
	...
	addGoogleMeetArtifactOptions(root.command("artifacts").description("List Meet conference records and available participant/artifact metadata")).option("--no-transcript-entries", "Skip structured transcript entry lookup").option("--include-doc-bodies", "Export linked transcript and smart-note Google Docs text").option("--format <format>", "Output format: summary or markdown", "summary").option("--output <path>", "Write output to a file instead of stdout").option("--json", "Print JSON output", false).action(async (options) => {
		...
		writeStdoutLine("token source: %s", resolved.token.refreshed ? "refresh-token" : "cached-access-token");
	});
