...
import { E as resolveConfigIncludes } from "./redact-BGqyyKN9.js";
...
import { l as pathExists$1 } from "./utils-Bs67j6-3.js";
import { r as resolveConfigEnvVars } from "./env-substitution-acZl0cGf.js";
import { h as resolveGatewayWindowsTaskName, i as GATEWAY_SERVICE_RUNTIME_PID_ENV, m as resolveGatewaySystemdServiceName } from "./constants-Qf4OESGR.js";
import { _ as resolveIncludeRoots, g as resolveGatewayPort, n as DEFAULT_GATEWAY_PORT, t as CONFIG_PATH } from "./paths-CL43LNS6.js";
...
import { D as createPreUpdateConfigSnapshot, G as asResolvedSourceConfig, K as asRuntimeConfig, et as parseConfigJson5, l as readConfigFileSnapshot, p as readSourceConfigBestEffort } from "./io-BsQc3Kgy.js";
import { n as VERSION } from "./version-CeFj_iGk.js";
import { r as theme } from "./theme-vjDs9tao.js";
import { a as getWindowsSystem32ExePath, t as getWindowsCmdExePath } from "./windows-install-roots-BTRBDwn4.js";
import { s as OPENCLAW_DATABASE_SCHEMA_DOCS_URL } from "./openclaw-state-db.paths-2PkDmkRl.js";
import { r as readJsonIfExists, u as writeJson } from "./json-C-CW4mQo.js";
import "./json-files-v5WP3doI.js";
import { a as nodeVersionSatisfiesEngine, o as parseSemver } from "./runtime-guard-V6qd1oW6.js";
...
import { i as resolveTrustedSourceLinkedOfficialNpmSpec, r as resolveTrustedSourceLinkedOfficialClawHubSpec } from "./official-external-install-records-CO8NpWPj.js";
import { r as readPersistedInstalledPluginIndex } from "./installed-plugin-index-store-DNgZ08xP.js";
...
import "./daemon-cli-CM0VGkB2.js";
import { n as resolveGatewayTaskScriptPath } from "./paths-DsnYGLDu.js";
import { i as resolveGatewayInstallEntrypoint } from "./gateway-entrypoint-DWio2H4p.js";
import { n as runExec, r as runCommandWithTimeout } from "./exec-SGTX01mL.js";
import { r as getSelfAndAncestorPidsSync } from "./restart-stale-pids-_QQFBHSU.js";
import { t as disableCurrentOpenClawUpdateLaunchdJob } from "./launchd-DT4INyGN.js";
import { f as resolveLaunchAgentLabel, o as renderSystemLaunchDaemonOwnershipShellProbe } from "./launchd-system-D_F_vqDz.js";
import { a as resolveGatewayRestartLogPath, r as renderPosixRestartLogSetup, s as shellEscapeRestartLogValue } from "./restart-logs-BBbMF07G.js";
import { a as formatExternalSupervisorUpdateRequired, o as isGatewayExternallySupervised, r as assertGatewayServiceMutationAllowed } from "./gateway-supervision-D_xpxHux.js";
import { a as resolveGatewayService, i as readGatewayServiceState } from "./service-CbbYL0ZH.js";
import { a as resumeScheduledTaskAutoStartAfterUpdate, c as suspendScheduledTaskAutoStartForUpdate } from "./schtasks-CBjn0Lrl.js";
import { n as runDaemonInstall } from "./install-BlCtSyaR.js";
import { a as recoverInstalledLaunchAgent, t as runDaemonRestart } from "./lifecycle-BKj6q_LY.js";
import { n as waitForGatewayHealthyRestart, o as renderRestartDiagnostics, r as terminateStaleGatewayPids } from "./restart-health-yUBf9tud.js";
import { a as withPluginInstallRecords, o as withoutPluginInstallRecords, s as writePersistedInstalledPluginIndexInstallRecords } from "./installed-plugin-index-records-BkPV4HdU.js";
import { n as stylePromptMessage } from "./prompt-style-BQVvtDcR.js";
import { d as trimLogTail } from "./restart-sentinel-C6_-wnpH.js";
import { n as registerSignalExitGate, r as waitForSignalExitBarriers, t as registerSignalExitBarrier } from "./signal-exit-barrier-Bs6DKn5_.js";
...
import { a as installCompletion, n as COMPLETION_SKIP_PLUGIN_COMMANDS_ENV } from "./completion-runtime-ciaYhinV.js";
import { r as ensureCompletionCacheExists, t as checkShellCompletionStatus } from "./doctor-completion-CMiniG3c.js";
import { t as formatHelpExamples } from "./help-format-CAcwboTs.js";
import { i as commitPluginInstallRecordsWithConfig } from "./install-record-commit-BuloUnQI.js";
...
import { t as listPersistedBundledPluginLocationBridges } from "./plugins-location-bridges-BpC1gOVU.js";
import { n as updateNpmInstalledPlugins, r as isClawHubTrustSkippedOutcome, t as syncPluginsForUpdateChannel } from "./update-BKikhBgq.js";
import { t as createLowDiskSpaceWarning } from "./disk-space-CzASwJhY.js";
import { n as readPackageName, r as readPackageVersion } from "./package-json-DkVfRSR1.js";
import { a as resolveExtendedStablePackage, n as compareSemverStrings, o as resolveNpmChannelTag, r as fetchNpmTagVersion, s as fetchNpmPackageTargetStatus, t as checkUpdateStatus } from "./update-check-Bsv2CsmK.js";
import { i as resolveUpdateAvailability, n as formatUpdateOneLiner, t as formatUpdateAvailableHint } from "./status.update-B9S--R_k.js";
import { a as resolveUpdateDoctorExecutionPolicy, c as createGlobalInstallEnv, d as globalInstallArgs, f as resolveGlobalInstallSpec, h as normalizePackageTagInput, i as runGlobalPackageUpdateSteps, l as detectGlobalInstallManagerByPresence, m as resolvePnpmGlobalDirFromGlobalRoot, o as canResolveRegistryVersionForPackageTarget, p as resolveGlobalInstallTarget, r as markPackagePostInstallDoctorAdvisory, s as cleanupGlobalRenameDirs, t as runGatewayUpdate, u as detectGlobalInstallManagerForRoot } from "./update-runner-D56IdcOg.js";
import { c as writeControlPlaneUpdateRestartSentinel, i as buildControlPlaneUpdateRestartHealthPendingResult, o as markControlPlaneUpdateRestartSentinelFailure, s as readControlPlaneUpdateSentinelMeta } from "./update-control-plane-sentinel-BLl4Loor.js";
import { n as cleanupStaleManagedServiceUpdateHandoffs } from "./update-managed-service-handoff-cleanup-DiOrEHy2.js";
import { n as printResult, t as createUpdateProgress } from "./progress-wG3cChAI.js";
import { i as consumeUpdatePostInstallDoctorResult, o as createUpdatePostInstallDoctorResultPath, r as UPDATE_POST_INSTALL_DOCTOR_RESULT_PATH_ENV } from "./update-doctor-result-1XHqpyPR.js";
import { n as preflightOpenClawDatabaseSchemas } from "./openclaw-database-preflight-Blk_AHuG.js";
import { t as doctorCommand } from "./doctor-CCa2ZKLi.js";
import { a as UPDATE_PARENT_SUPPORTS_DOCTOR_CONFIG_WRITE_ENV, i as UPDATE_PARENT_ALLOWS_GATEWAY_SERVICE_REPAIR_ENV, o as UPDATE_PARENT_SUPPORTS_GATEWAY_RESTART_ENV, r as UPDATE_PARENT_ALLOWS_GATEWAY_ACTIVATION_ENV, s as UPDATE_POST_CORE_CONVERGENCE_ENV, t as UPDATE_DEFER_CONFIGURED_PLUGIN_INSTALL_REPAIR_ENV } from "./update-phase-Br5TVkeJ.js";
import { t as summarizeGatewayServiceLayout } from "./service-layout-DYMJsLnW.js";
import { n as POST_CORE_UPDATE_SOURCE_CONFIG_PATH_ENV, t as POST_CORE_UPDATE_ENV } from "./update-post-core-context-DkRK1V7Q.js";
import { a as validateBundleInstallRecordPayload, n as resolveBundleInstallRecordPayload, t as hasNativePackageInstallPayload } from "./plugin-payload-validation-BowwsKxA.js";
import { n as runPostCorePluginConvergence, t as convergenceWarningsToOutcomes } from "./post-core-plugin-convergence-AGL-GQpy.js";
...
async function maybeRepairLegacyConfigForUpdateChannel(params) {
	...
	const { repairLegacyConfigForUpdateChannel } = await import("./legacy-config-repair-DJfDlRoY.js");
...
async function renderLinuxUserBusRepair(env) {
	...
	try {
		...
		if (!(await fs$1.stat(path.join(socketRuntimeDir, "bus"))).isSocket()) return "";
	} catch {
		return "";
	}
...
const CLI_NAME$5 = resolveCliName();
...
function formatPostUpdateGatewayRecoveryLine(platform) {
	const restartCommand = replaceCliName(formatCliCommand("openclaw gateway restart"), CLI_NAME$5);
	const installCommand = replaceCliName(formatCliCommand("openclaw gateway install --force"), CLI_NAME$5);
	const statusCommand = replaceCliName(formatCliCommand("openclaw gateway status --deep"), CLI_NAME$5);
...
function formatPostUpdateGatewayRecoveryInstructions(result, platform = process.platform) {
	...
	if (isPackageManagerUpdateMode(result.mode) && beforeVersion) lines.push(`Rollback: reinstall OpenClaw ${beforeVersion} with the same package manager, then rerun \`${replaceCliName(formatCliCommand("openclaw gateway install --force"), CLI_NAME$5)}\`.`);
	return lines;
}
//#endregion
...
async function maybeStopManagedServiceBeforeMutableUpdate(params) {
	const serviceMutationSkipMessage = resolveGatewayServiceManagementBlockMessageForUpdate(process.env);
	...
	try {
		...
		if (err instanceof GatewayServiceUpdateOwnershipError) return {
			stopped: false,
			inspected: false,
			runtimeInspected: false,
			running: false,
...
async function resolveManagedServicePackageUpdateRoot(params) {
	if (!isGatewayServiceManagementAllowedForUpdate(process.env)) return null;
...
async function gatewayServiceCommandUsesRoot(params) {
	...
	const layout = await summarizeGatewayServiceLayout(params.command === void 0 ? isGatewayServiceManagementAllowedForUpdate(params.env ?? process.env) ? await resolveGatewayService().readCommand(params.env ?? process.env).catch(() => null) : null : params.command);
	const serviceRoot = layout?.packageRoot;
...
async function maybeRestartService(params) {
	if (params.shouldRestart && (!isGatewayServiceManagementAllowedForUpdate(process.env) || !isGatewayServiceManagementAllowedForUpdate(params.serviceEnv ?? process.env))) {
		const message = resolveGatewayServiceManagementBlockMessageForUpdate(process.env) ?? resolveGatewayServiceManagementBlockMessageForUpdate(params.serviceEnv ?? process.env);
		if (message) defaultRuntime.error(message);
		return false;
	}
	...
	if (params.serviceMutationSkipMessage) {
		if (params.opts.json) defaultRuntime.error(params.serviceMutationSkipMessage);
		else {
			defaultRuntime.log("");
			defaultRuntime.log(theme.warn(`Gateway: restart skipped: ${params.serviceMutationSkipMessage}`));
		}
		return true;
	}
	if (!params.opts.json) {
...
function applyPostPluginConfigValidation(pluginUpdate, configValid) {
	if (configValid || pluginUpdate.status === "error" && pluginUpdate.reason !== "post-plugin-doctor-execution-failed") return pluginUpdate;
	return {
		...pluginUpdate,
		status: "error",
...
function withUpdateFinalizationEnv(run) {
	...
	return run().finally(() => {
		...
		if (previousPostCoreConvergence === void 0) delete process.env[UPDATE_POST_CORE_CONVERGENCE_ENV];
		else process.env[UPDATE_POST_CORE_CONVERGENCE_ENV] = previousPostCoreConvergence;
	});
}
...
function createPostPluginDoctorExecutionFailure(pluginUpdate, reason) {
	return {
		...pluginUpdate,
		status: "error",
...
async function applyFreshPostPluginDoctor(params) {
	...
	if (!entryPath) return {
		pluginUpdate: createPostPluginDoctorExecutionFailure(params.pluginUpdate, "Updated OpenClaw entrypoint not found for post-plugin doctor"),
		configValid: false
	};
...
async function completePostCorePluginUpdate(params) {
	...
	pluginUpdate = applyPostPluginConfigValidation(pluginUpdate, freshConfigValid ?? configSnapshot.valid);
	return {
		pluginUpdate,
		configSnapshot
	};
...
function didCoreUpdateChangeInstall(result) {
	if (isPackageManagerUpdateMode(result.mode)) return true;
...
function shouldResumePostCoreUpdateInFreshProcess(params) {
	return params.result.status === "ok" && !params.downgradeRisk && (params.installKindChanged === true || didCoreUpdateChangeInstall(params.result));
}
...
async function finishUpdate(params) {
	...
	if (params.result.status === "error") {
		...
		if (params.result.recovery?.serviceRestartSafe === false) {
			if (!params.opts.json) defaultRuntime.log(theme.warn(`Managed gateway remains stopped because update recovery could not prove a runnable installation (${params.result.recovery.reason}).`));
		} else await maybeRestartServiceAfterFailedMutableUpdate({
	...
	if (!pluginsUpdatedInFreshProcess) await withPluginLifecycleLease({}, async () => {
		...
		try {
			...
			const completedPluginUpdate = await completePostCorePluginUpdate({
				root: postUpdateRoot,
				pluginUpdate: initialPluginUpdate,
				freshDoctorRequired: didCoreUpdateChangeInstall(params.result) || initialPluginUpdate.sync.changed || initialPluginUpdate.npm.changed,
	...
	if (postCorePluginUpdate?.status === "error") {
		...
		if (postCorePluginUpdate.reason === "post-plugin-doctor-execution-failed") await maybeRestartServiceAfterFailedMutableUpdate({
			preManagedServiceStop: params.preManagedServiceStop,
			jsonMode: Boolean(params.opts.json)
		});
	...
	const restartConfigSnapshot = postUpdateConfigSnapshot ?? await readConfigFileSnapshot({
		skipPluginValidation: true,
		suppressFutureVersionWarning: shouldResumePostCoreInFreshProcess
	});
	...
	const serviceMutationAllowed = params.preManagedServiceStop?.serviceMutationAllowed !== false && isGatewayServiceManagementAllowedForUpdate(process.env) && isGatewayServiceManagementAllowedForUpdate(serviceStateReadEnv);
	const serviceMutationSkipMessage = params.shouldRestart && !serviceMutationAllowed ? params.preManagedServiceStop?.serviceMutationSkipMessage ?? resolveGatewayServiceManagementBlockMessageForUpdate(process.env) ?? resolveGatewayServiceManagementBlockMessageForUpdate(serviceStateReadEnv) : void 0;
	let gatewayPort = resolveUpdatedGatewayRestartPort({
		config: restartConfigSnapshot.valid ? restartConfigSnapshot.config : void 0,
		processEnv: process.env
	});
	if (params.shouldRestart && serviceMutationAllowed) try {
...
async function resumePostCoreUpdateUnlocked(params) {
	...
	const pluginInstallRecords = Object.keys(currentPluginInstallRecords).length > 0 || Boolean(persistedPluginIndex && hasForwardedUpdateStart && updateStartedAtMs !== void 0 && persistedPluginIndex.generatedAtMs >= updateStartedAtMs) ? currentPluginInstallRecords : parentPluginInstallRecords;
	const initialPluginUpdate = await updatePluginsAfterCoreUpdate({
		root: params.root,
		channel: params.channel,
		configSnapshot: restoredConfig.snapshot,
...
function rejectUnsupportedInheritedUpdateDryRun(command) {
	if (!inheritOptionFromParent(command, "dryRun")) return false;
	defaultRuntime.error(`--dry-run is not supported for \`openclaw update ${command.name()}\`. Run \`openclaw update --dry-run\` instead.`);
	defaultRuntime.exit(1);
	return true;
}
function registerUpdateFinalizationCommand(update, name, hidden) {
	update.command(name, { hidden }).description("Repair post-update doctor and plugin convergence").option("--json", "Output result as JSON", false).option("--channel <stable|extended-stable|beta|dev>", "Persist update channel before repair").option("--timeout <seconds>", "Timeout for update repair steps in seconds (default: 1800)").option("--yes", "Skip confirmation prompts (non-interactive)", false).option("--acknowledge-clawhub-risk", "Acknowledge ClawHub release trust warnings during post-update plugin sync", false).option("--no-restart", "Accepted for update command parity; repair never restarts").addHelpText("after", () => `\n${theme.heading("Examples:")}\n${formatHelpExamples([
		...
		try {
			if (rejectUnsupportedInheritedUpdateDryRun(actionCommand)) return;
...
${theme.muted("Docs:")} ${formatDocsLink("/cli/update", "docs.openclaw.ai/cli/update")}`;
	...
	update.command("wizard").description("Interactive update wizard").option("--timeout <seconds>", "Timeout for each update step in seconds (default: 1800)").addHelpText("after", `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/update", "docs.openclaw.ai/cli/update")}\n`).action(async (opts, command) => {
		try {
			if (rejectUnsupportedInheritedUpdateDryRun(command)) return;
