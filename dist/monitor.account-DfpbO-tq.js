...
import { r as formatErrorMessage, t as collectErrorGraphCandidates } from "./errors-D-7D3ZtF.js";
import { n as normalizeAgentId$1 } from "./agent-id-DDgUze4y.js";
import { n as normalizeAccountId } from "./account-id-CIVg1QNG.js";
import { i as installRequestBodyLimitGuard } from "./http-body-DhB9daEt.js";
...
import { T as resolveChannelStreamingBlockEnabled, _ as resolveChannelPreviewStreamMode, d as isChannelProgressDraftWorkToolName, s as formatChannelProgressDraftLineForEntry } from "./streaming-Byu76Sav.js";
import { l as formatReasoningMessage } from "./embedded-agent-utils-BYrAMdPg.js";
import { a as resolveInboundLastRouteSessionKey, i as resolveAgentRoute } from "./resolve-route-Dzy9k3m6.js";
...
import { f as formatInboundMediaUnavailableText, g as toInboundMediaFactsWithMetadata, s as recordChannelBotPairLoopAndCheckSuppression } from "./kernel-BmD9Chi3.js";
...
import { n as resolveConfiguredBindingRoute, r as resolveRuntimeConversationBindingRoute, t as ensureConfiguredBindingRouteReady } from "./binding-routing-B5DqVIPE.js";
...
import { n as channelBlockedPatch, r as channelReadyPatch } from "./gateway-runtime-BOoMLXP7.js";
...
import { n as fanInChannelIngressLifecycles } from "./channel-ingress-runtime-BvjO25l3.js";
import { n as createChannelIngressError, r as createChannelIngressMonitor } from "./ingress-monitor-Byj0Wgb8.js";
...
import { t as createChannelReplayGuard } from "./persistent-dedupe-ImNUIds4.js";
import "./text-utility-runtime-D52Cj1WO.js";
import { c as readWebhookBodyOrReject, r as applyBasicWebhookRequestGuards } from "./webhook-request-guards-CgiiFJiC.js";
import { a as createFixedWindowRateLimiter, o as createWebhookAnomalyTracker, r as WEBHOOK_RATE_LIMIT_DEFAULTS, t as WEBHOOK_ANOMALY_COUNTER_DEFAULTS } from "./webhook-ingress-CUghIwHZ.js";
import { _ as requestFeishuApi, d as extractReplyText, g as readString$1, h as parseCommentContentElements, l as resolveFeishuRuntimeAccount, m as normalizeString, p as isRecord$1, s as resolveFeishuAccount, u as encodeQuery, v as buildFeishuCommentTarget, y as normalizeCommentFileType } from "./accounts-BW1HCE31.js";
import { i as resolveReceiveIdType } from "./targets-CYvuU_k1.js";
import { A as resolveFeishuChatType, C as resolveFeishuDmIngressAccess, E as resolveFeishuGroupSenderActivationIngressAccess, M as buildFeishuCardActionTextFallback, N as createFeishuCardInteractionEnvelope, O as resolveFeishuReplyPolicy, P as decodeFeishuCardAction, S as normalizeFeishuAllowEntry, T as resolveFeishuGroupConversationIngressAccess, d as chunkFeishuPostMarkdown, f as materializeFeishuPostMarkdownSoftBreaks, k as normalizeFeishuChatType$2, o as resolveFeishuCardTemplate, w as resolveFeishuGroupConfig, x as hasExplicitFeishuGroupConfig } from "./send-result-Cv-i1H4L.js";
...
import { i as getFeishuUserAgent, n as createFeishuClient, o as resolveConfiguredHttpTimeoutMs, r as createFeishuWSClient, t as createEventDispatcher } from "./client-Bo7Vh_HA.js";
import { t as getFeishuRuntime } from "./runtime-zwHao5bm.js";
import { i as createCommentTypingReactionLifecycle, s as getChatInfo, t as deliverCommentThreadText } from "./drive-D9edkLuF.js";
import { t as createFeishuThreadBindingManager } from "./thread-bindings-CJv2i9FO.js";
import "./runtime-api-ltPpH9YM.js";
import { t as readFeishuJsonResponse } from "./json-response-D5BIxLuI.js";
import { _ as buildFeishuMediaFallbackText, a as getMessageFeishu, d as extractMentionTargets, f as isFeishuBroadcastMention, g as normalizeFeishuExternalKey, h as parsePostContent, l as sendMessageFeishu, m as isFeishuGroupChatType, n as sendMediaFeishu, o as listFeishuThreadMessages, p as isMentionForwardRequest, r as shouldSuppressFeishuTextForVoiceMedia, s as sendCardFeishu, t as saveMessageResourceFeishu, u as sendStructuredCardFeishu, v as resolveFeishuIdentityEmoji } from "./media-RObWX3en.js";
import { i as waitForAbortableDelay, r as raceWithTimeoutAndAbort } from "./probe-oqu0LAk-.js";
import { t as fetchBotIdentityForMonitor } from "./monitor.startup-BgdJ_HZf.js";
...
async function resolveDriveCommentEventCore(params) {
	...
	const context = await fetchDriveCommentContext({
		client: createClient ? createClient(account ?? { accountId }) : createFeishuClient((await import("./accounts-DVCcUGnc.js")).resolveFeishuAccount({
			cfg,
			accountId
		})),
		fileToken,
...
async function resolveReactionSyntheticEvent(params) {
	...
	const { resolveFeishuAccount } = await import("./accounts-DVCcUGnc.js");
