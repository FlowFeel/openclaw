...
import { d as writeStorageMeta, l as resolveMatrixStoragePaths, r as maybeMigrateLegacyStorage } from "./storage-CuNEL1Zh.js";
import "./config-C_Eu4qJs.js";
import fs from "node:fs";
//#region extensions/matrix/src/matrix/client/create-client.ts
const loadMatrixCreateClientRuntimeDeps = createLazyRuntimeModule(() => Promise.all([import("./sdk-BvapOiMd.js"), import("./logging-CThOHQyQ.js")]).then(([sdkModule, loggingModule]) => ({
