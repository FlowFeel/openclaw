...
import { At as boolean, Rn as string, Tn as object, dn as literal, wn as number, yt as _enum } from "./schemas-CZ9Toj_c.js";
import { n as VERSION } from "./version-CeFj_iGk.js";
import { t as runTasksWithConcurrency } from "./run-with-concurrency-BHgpSCM6.js";
import { r as extractFirstTextBlock } from "./chat-message-content-DwX2R88T.js";
import { c as readMcpOAuthCredentialsStatus, d as runMcpOAuthLogin, f as buildMcpHttpFetch, m as withoutMcpAuthorizationHeader, o as resolveMcpTransportConfig, p as withSameOriginMcpHttpHeaders, s as clearMcpOAuthCredentials } from "./mcp-auth-profile-DmNkcn0y.js";
import { t as createSessionMcpRuntime } from "./agent-bundle-mcp-runtime-BkjLnt6Q.js";
...
import { a as updateConfiguredMcpServerTools, i as updateConfiguredMcpServer, n as setConfiguredMcpServer, r as unsetConfiguredMcpServer, t as listConfiguredMcpServers } from "./mcp-config-2xsKbArn.js";
import { t as resolveGatewayAuthOptions } from "./gateway-secret-options-BJeim01A.js";
...
var OpenClawChannelBridge = class {
	...
	async start() {
		...
		const [{ resolveGatewayClientBootstrap }, { GatewayClient: GatewayClientCtor }, { startGatewayClientWhenEventLoopReady }, { APPROVALS_SCOPE, READ_SCOPE, WRITE_SCOPE }, { GATEWAY_CLIENT_CAPS, GATEWAY_CLIENT_MODES, GATEWAY_CLIENT_NAMES }] = await Promise.all([
			import("./client-bootstrap-DLZJZrwU.js"),
			import("./client-Be4UNi7e.js"),
			import("./client-start-readiness-BeYeBjo6.js"),
			import("./method-scopes-CXFO65kS.js"),
			import("./client-info-BUgeYlw8.js")
		]);
