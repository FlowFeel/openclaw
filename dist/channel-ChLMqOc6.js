...
import { _ as readStringParam, i as createActionGate, p as readPositiveIntegerParam, t as ToolAuthorizationError } from "./common-RkLs-2lL.js";
...
import { r as createChannelNativeOriginTargetResolver } from "./approval-native-helpers-tS4fVsGH.js";
import { a as splitChannelApprovalCapability, i as createChannelApprovalCapability, n as createApproverRestrictedNativeApprovalCapability } from "./approval-delivery-helpers-iwE37gkl.js";
...
import { E as createAllowlistProviderOpenWarningCollector, N as projectAccountConfigWarningCollector, d as resolveScopeRequireMention, f as resolveScopeToolsPolicy } from "./channel-policy-DDPgHZTe.js";
...
import { n as requiresExplicitMatrixDefaultAccount } from "./account-selection-BObnVAfj.js";
import { a as resolveMatrixAccountConfig } from "./account-config-BFrkzWp4.js";
import { i as resolveMatrixAccount, r as resolveDefaultMatrixAccountId, t as listMatrixAccountIds } from "./accounts-oeV3IBG_.js";
...
import { t as matrixPluginBase } from "./channel.setup-4p5pxpAG.js";
import { n as normalizeCompatibilityConfig, t as legacyConfigRules } from "./doctor-contract-s-3inccd.js";
import { r as resolveMatrixRoomScopePath, t as buildMatrixRoomScopeTree } from "./rooms-DinFROXD.js";
...
const matrixNativeApprovalCapability = createApproverRestrictedNativeApprovalCapability({
	...
	nativeRuntime: createLazyChannelApprovalNativeRuntimeAdapter({
		...
		load: async () => (await import("./approval-handler.runtime-ZghV2JN5.js")).matrixApprovalNativeRuntime
	})
});
...
const loadMatrixChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-DhSiF88v.js"), "matrixChannelRuntime");
const loadMatrixDoctorModule = createLazyRuntimeModule(() => import("./doctor-CNBTgfkF.js"));
...
const matrixPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			...
			try {
				monitorMatrixProvider = (await import("./monitor-AngzLogO.js")).monitorMatrixProvider;
			} finally {
				releaseLock();
			}
