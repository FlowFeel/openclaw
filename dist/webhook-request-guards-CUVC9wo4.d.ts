...
//#endregion
//#region src/gateway/origin-check.d.ts
/** Return the request Origin only when the Gateway's canonical browser policy accepts it. */
declare function resolveAcceptedBrowserOrigin(params: {
  req: IncomingMessage;
  cfg?: OpenClawConfig;
}): string | undefined;
//#endregion
...
//#endregion
export { WEBHOOK_RATE_LIMIT_DEFAULTS as _, applyBasicWebhookRequestGuards as a, createFixedWindowRateLimiter as b, isJsonContentType as c, runDetachedWebhookWork as d, resolveAcceptedBrowserOrigin as f, WEBHOOK_ANOMALY_STATUS_CODES as g, WEBHOOK_ANOMALY_COUNTER_DEFAULTS as h, WebhookInFlightLimiter as i, readJsonWebhookBodyOrReject as l, FixedWindowRateLimiter as m, WEBHOOK_IN_FLIGHT_DEFAULTS as n, beginWebhookRequestPipelineOrReject as o, BoundedCounter as p, WebhookBodyReadProfile as r, createWebhookInFlightLimiter as s, WEBHOOK_BODY_READ_DEFAULTS as t, readWebhookBodyOrReject as u, WebhookAnomalyTracker as v, createWebhookAnomalyTracker as x, createBoundedCounter as y };