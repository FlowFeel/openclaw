...
import { $n as uuid, Nn as record, Rn as string, Tn as object, dn as literal, wn as number } from "./schemas-CZ9Toj_c.js";
import { h as readProviderTextResponse } from "./provider-http-errors-Dm9G78mz.js";
...
import { $ as hexToBytes, A as isNegativeLE, B as bytesToNumberLE, C as createKeygen, D as wNAF, E as normalizeZ, F as abool, J as sha512, K as validateObject, M as mod, N as pow2, P as aInRange, Q as concatBytes, S as createCurveFields, U as memoized, V as copyBytes, W as numberToBytesLE, Y as abytes, Z as bytesToHex, a as gcm, d as bytesToHex$1, et as isBytes, q as sha256, r as hkdf, tt as randomBytes$1, y as utf8ToBytes } from "./hkdf-C7rH9AZE.js";
import { r as normalizeReefTarget } from "./config-schema-DEI_3Fvv.js";
import { i as matchesReefPeerIdentity, n as ReefPeerIdentitySchema, o as sameReefPeerIdentity, r as ReefPeerTrustSchema, t as ReefAutonomySchema } from "./friend-types-BXCwAc8D.js";
...
function edwards(params, extraOpts = {}) {
	...
	*/
	...
	class Point {
		...
		static ZERO = new Point(_0n$1, _1n$2, _1n$2, _0n$1);
		static Fp = Fp;
		static Fn = Fn;
		X;
		Y;
...
//#endregion
export { PipelineError as $, reefReplayStoreKey as A, parseReefSetupSession as B, REEF_REVIEWS_MAX_ENTRIES as C, loadKeys as D, generateAndStoreKeys as E, clearReefSetupSession as F, REEF_AUDIT_HEAD_NAMESPACE as G, reserveReefIdentityBinding as H, finalizeReefIdentityBinding as I, REEF_AUDIT_MIGRATION_NAMESPACE as J, REEF_AUDIT_MAX_ENTRIES as K, loadReefIdentityBinding as L, REEF_REGISTRATION_NAMESPACE as M, REEF_REGISTRATION_SESSION_KEY as N, openStores$1 as O, assertReefIdentityBinding as P, reefAuditEntryKey as Q, loadReefSetupSession as R, REEF_REPLAY_TTL_MS as S, ReefInboxCursorStore as T, saveReefSetupSession as U, releaseReefIdentityReservation as V, REEF_AUDIT_HEAD_KEY as W, REEF_AUDIT_STORE_MAX_ENTRIES as X, REEF_AUDIT_NAMESPACE as Y, parseReefAuditHead as Z, REEF_KEYS_MIGRATION_KEY as _, canonicalBytes as _t, REEF_OUTBOUND_DELIVERY_TTL_MS as a, createAnthropicGuard as at, REEF_REPLAY_MAX_ENTRIES as b, isReefPairingApprovalToken as c, bodyHash as ct, REEF_DELIVERED_MAX_ENTRIES as d, parseHandleEpoch as dt, composeInbound as et, REEF_DELIVERED_NAMESPACE as f, signDeviceRequest as ft, REEF_KEYS_KEY as g, verifyChainSegment as gt, REEF_DURABLE_MIGRATION_NAMESPACE as h, verifyChain as ht, REEF_OUTBOUND_DELIVERY_MAX_ENTRIES as i, verifyReceipt as it, REEF_REGISTRATION_IDENTITY_KEY as j, parseReefKeys as k, openReefTrustStore as l, fingerprint as lt, REEF_DURABLE_MIGRATION_KEY as m, appendInboxRead as mt, legacyReefFileExists as n, InvalidDeliveryReceiptError as nt, REEF_TRUST_STORE_MAX_ENTRIES as o, createOpenAiGuard as ot, REEF_DELIVERED_TTL_MS as p, appendAudit as pt, REEF_AUDIT_MIGRATION_KEY as q, resolveLegacyReefStateDir as r, confirmDelivery as rt, REEF_TRUST_STORE_NAMESPACE as s, REEF_MAX_PLAINTEXT_BYTES as st, REEF_DURABLE_LEGACY_FILENAMES as t, composeOutbound as tt, resolveReefTrustStoreKey as u, formatHandleEpoch as ut, REEF_KEYS_MIGRATION_NAMESPACE as v, sha256Hex as vt, REEF_REVIEWS_NAMESPACE as w, REEF_REPLAY_NAMESPACE as x, REEF_KEYS_NAMESPACE as y, parseReefIdentityBinding as z };
