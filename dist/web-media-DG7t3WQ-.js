...
import { g as assertNoWindowsNetworkPath, r as isNotFoundPathError, x as safeFileURLToPath } from "./path-D8zNGPJM.js";
...
import { l as getActivePluginHttpRouteRegistry } from "./runtime-WkCmQTS9.js";
...
import { c as kindFromMime, i as getFileExtension, l as mimeTypeFromFilePath, n as detectMime, r as extensionForMime, u as normalizeMimeType } from "./mime-Ir6g3Vae.js";
import "./local-file-access-8uj3r-Aa.js";
import { d as readImageMetadataFromHeader, f as readImageProbeFromHeader, s as createImageProcessor } from "./image-ops-BtojRCsZ.js";
import "./media-services-Ii2z0iaY.js";
import { o as extractOriginalFilename, s as getMediaDir } from "./store-QVlUiM0_.js";
import { a as resolveInboundMediaReference, t as MediaReferenceError } from "./media-reference-sxufFF1B.js";
import { i as resolveCanvasHttpPathToLocalPath } from "./documents-sBi5jJce.js";
import { t as chunkItems } from "./chunk-items-2QWieLm-.js";
import { r as readRemoteMediaBuffer } from "./fetch-CNBCr8CY.js";
import { i as readLocalMediaFile, n as assertLocalMediaAllowed, t as LocalMediaAccessError } from "./local-media-access-CfOl4jrn.js";
...
async function resolveTrustedGeneratedHostReadHtml(filePath) {
	...
	return tmpRoot && isPathInsideRoot(resolvedFilePath, tmpRoot) ? { source: "temp-root" } : void 0;
}
...
async function markTrustedGeneratedHtmlPath(filePath, contents) {
	...
	if (!outboundRoot || !isPathInsideRoot(resolvedFilePath, outboundRoot)) throw new Error(`markTrustedGeneratedHtmlPath: refusing path outside outbound staging: ${resolvedFilePath}`);
...
async function loadWebMediaInternal(mediaUrlInput, options = {}) {
	...
	const sourceReadCap = maxBytes === void 0 ? defaultSourceReadCap : optimizeImages ? Math.max(maxBytes, defaultSourceReadCap) : maxBytes;
