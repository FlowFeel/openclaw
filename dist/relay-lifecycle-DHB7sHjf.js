...
import { a as resolveProfile } from "./config-Da5ffEih.js";
import { q as rawDataToString } from "./tmp-openclaw-dir-DQI4fBxj.js";
import "./bounded-utf8-tail-Dj_3LqJr.js";
import { a as getOrCreateProfileRuntime, m as withProfileOperationLease, o as getProfileLifecycle, s as isBrowserRuntimeRunning } from "./server-context.lifecycle-DZszx9yY.js";
import { r as deliverPageShare, t as PAGE_SHARE_GATEWAY_REQUIRED_ERROR } from "./page-share-Yy7X7P0P.js";
...
async function ensureExtensionRelayForProfile(state, profile) {
	for (;;) {
		...
		const { ensureExtensionRelayToken, readExtensionRelayToken } = await import("./relay-auth-BeVLMIq8.js");
