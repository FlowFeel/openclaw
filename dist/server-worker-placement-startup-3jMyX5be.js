...
import { N as convertToLlm } from "./agent-core-00z91UZG.js";
...
import { t as applyEmbeddedAttemptToolsAllow } from "./attempt-tool-construction-plan-Bf7wzZfB.js";
import { S as mergeUsageIntoAccumulator, a as buildUsageAgentMetaFields, b as createUsageAccumulator, v as resolveReportedModelRef } from "./helpers-CjOkrErD.js";
...
const loadWorkerPlacementSessionRuntimeModule = createLazyRuntimeModule(async () => {
	const [placementSessionRuntime, { managedWorktrees }, sessionUtils] = await Promise.all([
		import("./placement-session-runtime-B5Nga5Qy.js"),
