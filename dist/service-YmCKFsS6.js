...
import { c as redactSensitiveText, g as registerSecretValueForRedaction } from "./redact-DUpJZuMu.js";
...
import { o as validateCloudWorkerProfileSettings } from "./zod-schema-9ObLtj6p.js";
...
import { jt as onSessionIdentityMutation } from "./session-accessor.sqlite-B9iW7DOt.js";
...
import { a as WORKER_PROTOCOL_MAX_INFERENCE_PAYLOAD_BYTES, g as validateWorkerInferenceTerminalOutcome, h as validateWorkerInferenceTerminalFrame, p as validateWorkerInferenceEventFrame } from "./worker-inference-jzapa-pT.js";
import { t as boundedJsonUtf8Bytes } from "./json-utf8-bytes-C14lActR.js";
import { r as normalizeWorkerSshEndpoint, t as WorkerSessionAlreadyAttachedError } from "./store-BdupVJMT.js";
...
function createWorkerEnvironmentService(options) {
	...
	const reconcileRecord = async (initialRecord) => {
		...
		if (record.state === "attached") {
			if (currentBundle && (!record.bootstrapReceipt || !verifyWorkerAdmissionHandshake(record.bootstrapReceipt, currentBundle))) await finishDestroy(record, provider).catch(() => void 0);
			return;
		}
