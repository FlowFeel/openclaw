import { A as Transport, C as ThinkingBudgets, S as TextContent, _ as SimpleStreamOptions, c as Context, d as Model, i as AssistantMessageEvent, j as Usage, l as ImageContent, r as AssistantMessage, s as CompleteSimpleFn, u as Message, v as StopReason, y as StreamFn } from "./types-xx0UXBU1.js";
import { S as ToolExecutionMode, a as AgentEvent, b as StreamFn$1, c as AgentMessage, g as BeforeToolCallResult, h as BeforeToolCallContext, i as AgentContext, l as AgentState, m as BashExecutionMessage, n as AfterToolCallResult, o as AgentLoopConfig, r as AfterToolOutcomeContext, s as AgentLoopTurnUpdate, t as AfterToolCallContext, v as PrepareNextTurnContext, x as ThinkingLevel, y as QueueMode } from "./types-BzdPB1fv.js";
//#endregion
...
interface AgentOptions {
  ...
  afterToolOutcome?: (context: AfterToolOutcomeContext, signal?: AbortSignal) => Promise<AfterToolCallResult | undefined>;
...
//#endregion
export { buildSessionContext as A, runAgentLoop as B, BranchPreparation as C, prepareBranchEntries as D, generateBranchSummary as E, BRANCH_SUMMARY_PREFIX as F, __exportAll as H, BRANCH_SUMMARY_SUFFIX as I, COMPACTION_SUMMARY_PREFIX as L, FileOperations as M, SessionTreeEntry as N, serializeConversation as O, Result as P, COMPACTION_SUMMARY_SUFFIX as R, shouldCompact as S, collectEntriesForBranchSummaryFromBranches as T, AgentOptions as V, findCutPoint as _, streamProxy as a, getLastAssistantUsage as b, CompactionPreparation as c, ContextUsageEstimate as d, DEFAULT_COMPACTION_SETTINGS as f, estimateTokens as g, estimateContextTokens as h, ProxyStreamOptions as i, BranchSummaryResult as j, uuidv7 as k, CompactionResult as l, compact as m, openClawAgentCoreRuntime as n, CompactionConvergence as o, calculateContextTokens as p, ProxyAssistantMessageEvent as r, CompactionDetails as s, Agent as t, CompactionSettings as u, findTurnStartIndex as v, BranchSummaryDetails as w, prepareCompaction as x, generateSummary as y, bashExecutionToText as z };