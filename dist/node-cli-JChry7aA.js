...
import { _ as resolveNodeLaunchAgentLabel, l as formatNodeServiceDescription, v as resolveNodeSystemdServiceName, y as resolveNodeWindowsTaskName } from "./constants-Qf4OESGR.js";
...
import { i as resolveExecutableFromPathEnv } from "./executable-path-o28FX7qn.js";
import { l as sanitizeSystemRunEnvOverrides, s as sanitizeHostExecEnv, t as inspectHostExecEnvOverrides } from "./host-env-security-D4EXCIbD.js";
...
import { N as withPluginRuntimeRegistryScope, d as getActivePluginRegistry } from "./runtime-WkCmQTS9.js";
import { l as resolveCommandResolutionFromArgv, s as resolveApprovalAuditTrustPath } from "./exec-command-resolution-BcEGhdwN.js";
import { C as extractEnvAssignmentKeysFromDispatchWrappers, D as unwrapKnownDispatchWrapperInvocation, F as splitShellArgs, N as normalizeExecutableToken, a as extractShellWrapperCommand, c as isBlockedShellWrapperCommand, d as resolveShellWrapperTransportArgv, f as unwrapKnownShellMultiplexerInvocation, h as advancePosixInlineOptionScan, m as POSIX_INLINE_COMMAND_FLAGS, n as POSIX_SHELL_WRAPPERS, t as POSIX_PARSEABLE_SHELL_WRAPPERS, u as isShellWrapperInvocation, x as resolveInlineCommandMatch } from "./shell-wrapper-resolution-4V1pkTCa.js";
import { r as normalizeConfiguredMcpServers } from "./mcp-config-normalize-UWWF1cpp.js";
import "./config-BBVHtcXg.js";
import { t as formatDocsLink } from "./links-ClIwBcy4.js";
import { r as resolveNodeProgramArguments } from "./program-args-Cz_xMqj6.js";
import { u as buildNodeServiceEnvironment } from "./runtime-paths-Cq-e39KV.js";
...
import { r as resolveSafeChildProcessInvocation } from "./windows-command-DkNKhCLn.js";
import { n as resolveDaemonInstallRuntimeInputs, r as resolveDaemonNodeBinDir, t as emitDaemonInstallRuntimeWarning } from "./daemon-install-plan.shared-KEM5LP3v.js";
import { r as isGatewayDaemonRuntime, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-CHOL1Kuf.js";
import { n as formatInvalidConfigPort, r as formatInvalidPortOption } from "./error-format-BZ5G9eas.js";
import { n as buildPlatformServiceStartHints, t as buildPlatformRuntimeLogHints } from "./runtime-hints-DdAMOdVL.js";
import { a as filterDaemonEnv, d as resolveRuntimeStatusColor, n as createDaemonInstallActionContext, p as buildDaemonServiceSnapshot, r as failIfNixDaemonInstallMode, t as createCliStatusTextStyles, v as installDaemonServiceAndEmit } from "./shared-C4IIJkT8.js";
import { t as formatRuntimeStatus } from "./runtime-format-BGFsB9-l.js";
...
import { n as loadDeviceIdentityIfPresent, o as publicKeyRawBase64UrlFromPem, r as loadOrCreateDeviceIdentity } from "./device-identity-BOrXxcUy.js";
...
import { t as GatewayClient } from "./client-BzxvYlKl.js";
import { n as resolveGatewayCredentialsWithSecretInputs } from "./credentials-secret-inputs--DP0-Ggc.js";
import { a as NODE_EXEC_APPROVALS_COMMANDS, c as NODE_MCP_TOOLS_CALL_COMMAND, f as NODE_SYSTEM_RUN_COMMANDS, i as NODE_DUPLEX_INVOKE_IDLE_TIMEOUT_MS, p as NODE_TERMINAL_UPLOAD_COMMAND, r as NODE_DEVICE_APPS_COMMAND, s as NODE_FS_LIST_DIR_COMMAND, t as NODE_AGENT_CLI_CLAUDE_RUN_COMMAND, u as NODE_MCP_TOOL_CALL_TIMEOUT_MS } from "./node-commands-CeG5w7c2.js";
import { i as runServiceUninstall, n as runServiceStart, r as runServiceStop, t as runServiceRestart } from "./lifecycle-core-DFEyGXzj.js";
import { n as writeSecretInputToChild, t as addSecretInputStdio } from "./spawn-secret-input-CVOz2bFp.js";
import { a as createMcpJsonSchemaValidator, i as sanitizeMcpMetadataText, o as matchesMcpToolFilterPattern, r as collectMcpPaginatedItems, t as resolveMcpTransport } from "./mcp-transport-DzcoY4fK.js";
import { a as resolveMcpRequestTimeoutMs } from "./mcp-auth-profile-BllBNrDt.js";
import { t as mcpContentBlockToAgentContent } from "./mcp-content-WEFrHX9X.js";
import { t as createPendingRequestRegistry } from "./pending-request-registry-DlrpJG3c.js";
import { t as loadSkillsFromDirSafe } from "./local-loader-CM-ebHqh.js";
import { a as mergeExecApprovalsSocketDefaults } from "./exec-approvals-config-DrfE-I9X.js";
...
import { t as decodeClaudeCliNodeRunParams } from "./invoke-agent-cli-claude-params-BRD7zppt.js";
...
import { i as resolveExecAutoReviewDecision } from "./exec-auto-review-B7v9ialR.js";
import { c as normalizeSystemRunApprovalPlan, n as formatExecCommand, r as resolveSystemRunCommandRequest } from "./system-run-command-BnpjDuob.js";
import { a as loadNodeHostConfig, i as configureNodeHost } from "./config-BZ-Vdr68.js";
import { n as stageTerminalUpload, t as ensureTerminalUploadCleanup } from "./terminal-file-upload-DJjJPXZ6.js";
import { t as BoundedBuffer } from "./bounded-buffer-C08_hwby.js";
import { t as scanInstalledApps } from "./installed-apps-DSAQNeAF.js";
import { t as listHostDirectories } from "./host-directory-listing-Dsq7vChC.js";
import { _ as migrateLegacyDeviceAuth, g as detectLegacyDeviceAuth, h as detectLegacyDeviceIdentity, n as migrateLegacyExecApprovals, r as migrateLegacyDeviceIdentity, t as detectLegacyExecApprovals } from "./state-migrations.exec-approvals-Cqr-Fsq3.js";
import { t as resolveNodeService } from "./node-service-3dtIUWv2.js";
...
function writeStderrLine$1(message) {
...
function handleNodeHostReconnectPaused(info, deps = {}) {
	...
	(deps.writeLine ?? writeStderrLine$1)(formatNodeHostReconnectPausedMessage(info, { exiting: shouldExit }));
...
async function publishNodePluginTools(client, tools) {
	try {
		...
		writeStderrLine$1(`node host plugin tool publish failed: ${String(error)}`);
	}
}
async function publishNodeSkills(client, skills) {
	try {
		...
		writeStderrLine$1(`node host skill publish failed: ${String(error)}`);
	}
}
...
async function runNodeHost(opts) {
	await runStartupMigrations({ log: {
		info: writeStderrLine$1,
		warn: writeStderrLine$1
	} });
	...
	const client = new GatewayClient({
		...
		onHelloOk: () => {
			writeStderrLine$1(`node host gateway connected: ${url}`);
			gatewayHelloReceived = true;
			publishInventory();
		},
		onConnectError: (err) => {
			writeStderrLine$1(`node host gateway connect failed: ${err.message}`);
		},
		...
		onClose: (code, reason) => {
			...
			writeStderrLine$1(`node host gateway closed (${code}): ${reason}`);
		}
	});
...
function resolveNodeGatewayOptions(options, config) {
	...
	const port = options.port === void 0 ? savedPort : parsePort(options.port);
	const endpointChanged = host !== savedHost || port !== null && port !== savedPort;
	const tlsFingerprint = options.tls === false ? void 0 : normalizeOptionalString(options.tlsFingerprint) ?? (endpointChanged ? void 0 : config?.gateway?.tlsFingerprint);
	const tls = typeof options.tls === "boolean" ? options.tls : Boolean(tlsFingerprint) || (endpointChanged ? void 0 : config?.gateway?.tls);
	return {
		host,
		port,
		contextPath: normalizeOptionalString(options.contextPath) ?? (options.contextPath !== void 0 || endpointChanged ? void 0 : config?.gateway?.contextPath),
		tls,
		tlsFingerprint
	};
}
