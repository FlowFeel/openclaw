...
import { a as readAgentRosterProperty, m as toAgentEntriesRecord, n as listAgentEntries } from "./agent-scope-config-Dusa8eSA.js";
import { Y as normalizeProviderConfigForConfigDefaults } from "./io-BsQc3Kgy.js";
import { n as normalizeAgentModelRefForConfig, t as normalizeAgentModelMapForConfig } from "./model-input-BofPWz0k.js";
import { a as normalizeConfiguredProviderCatalogModelId, s as normalizeProviderId } from "./model-ref-shared-BEKlpylb.js";
...
function normalizeConfigModelRefsForWrite(cfg, providerConfigNormalizer) {
	...
	return {
		...
		agents: {
			...
			...nextAgentsList !== agentsList && roster?.kind === "entries" ? { entries: toAgentEntriesRecord(nextAgentsList) } : nextAgentsList !== agentsList && roster?.kind === "list" ? { list: nextAgentsList } : {}
		}
	};
}
