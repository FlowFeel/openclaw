...
import { c as DEFAULT_UPLOAD_DIR, l as resolveExistingUploadPaths, r as resolveBrowserConfig } from "./config-CJZl5XjK.js";
import { Y as withTimeout, j as parseBrowserErrorPayload } from "./tmp-openclaw-dir-DULFdmUv.js";
import "./control-auth-BoQf9xSI.js";
import "./chrome.executables-B2udiA_j.js";
import "./trash-C4NUNH38.js";
import { o as loadBrowserConfigForRuntimeRefresh } from "./server-context-U49yWU9w.js";
import "./sdk-setup-tools-ukKv3Pmz.js";
import { C as fetchBrowserJson, D as withBaseUrl, E as buildProfileQuery, T as setBridgeAuthForPort, w as deleteBridgeAuthForPort } from "./session-tab-registry-COLduo1q.js";
import "./routes-UzAAMTNS.js";
import { i as listenBrowserHttpServer, n as installBrowserAuthMiddleware, r as installBrowserCommonMiddleware, t as hasVerifiedBrowserAuth } from "./server-middleware-BSYy7NY4.js";
import { c as stopBrowserBridgeRuntime, n as createBrowserControlContext } from "./plugin-enabled-BFhPy1tz.js";
import { a as resolveRequestedBrowserProfile, i as normalizeBrowserRequestPath, n as isBrowserHostLocalRoute, r as isPersistentBrowserProfileMutation, t as createBrowserRouteDispatcher } from "./dispatcher-DsrR-WQK.js";
...
async function startBrowserBridgeServer(params) {
	...
	if (params.skipRouteRegistrationForTest) app.get("/", (_req, res) => {
		...
		const [{ createBrowserRouteContext }, { registerBrowserRoutes }] = await Promise.all([import("./server-context-De9t704w.js"), import("./routes-ku3iUh8z.js")]);
