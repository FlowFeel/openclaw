...
import { F as isProvisionalSubagentKillTask, U as SUBAGENT_KILL_TASK_ERROR } from "./task-registry-C6MCtVnT.js";
import { _ as isBlockedLivenessState, a as buildAgentRunTerminalOutcomeFromWaitResult, g as isAbandonedLivenessState, h as formatBlockedLivenessError, m as formatAbandonedLivenessError } from "./agent-run-terminal-outcome-DXPF-TAc.js";
import { s as isAbortedAgentStopReason } from "./run-termination-nrLSEQ_b.js";
import { a as finalizeTaskRunByRunId, i as failTaskRunByRunId, l as setDetachedTaskDeliveryStatusByRunId, n as createQueuedTaskRun, o as findDetachedTaskRun, r as createRunningTaskRun, t as completeTaskRunByRunId, u as startTaskRunByRunId } from "./detached-task-runtime-DMrgTp9S.js";
...
import { C as isSessionLifecycleChangedGatewayError, S as deleteSubagentSessionForCleanup, i as terminateAcceptedCollectorRun, o as readGatewayRunId, r as retrySubagentCleanup, u as applySubagentLaunchAuthorization, x as withSubagentOutcomeTiming } from "./subagent-spawn-cleanup-CeLRHtIi.js";
import { a as waitForAgentRun, n as isRecoverableAgentWaitError } from "./run-wait-DPJzrI0H.js";
...
const subagentAnnounceLoader = createLazyImportLoader(() => import("./subagent-announce-C_QOmgxk.js"));
...
const defaultSubagentRegistryDeps = {
	...
	maybeWakeRequesterAfterAllChildrenSettled: async (params) => (await import("./subagent-announce.requester-settle-wake-BLR0dSAG.js")).maybeWakeRequesterAfterAllChildrenSettled(params)
};
...
const subagentRegistryPluginRuntimeLoader = createLazyPromiseLoader(() => import("./runtime-plugins-DeslGTeX.js"));
