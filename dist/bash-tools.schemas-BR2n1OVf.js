...
const execSchema = Type.Object({
	...
	workdir: Type.Optional(Type.String({ description: "Working directory; omit for default. Blank/whitespace is invalid." })),
	env: Type.Optional(Type.Record(Type.String(), Type.String())),
	yieldMs: Type.Optional(Type.Number({ description: "Milliseconds before backgrounding; default 10000." })),
	background: Type.Optional(Type.Boolean({ description: "Run in background immediately" })),
	timeout: Type.Optional(Type.Number({ description: "Timeout in seconds; kills process on expiry." })),
	...
	security: Type.Optional(Type.String({ description: "Ignored per call; tools.exec.security and host approvals decide." })),
	ask: Type.Optional(Type.String({ description: "Uses tools.exec.ask and host approvals; channel-origin calls cannot override host ask=off." })),
