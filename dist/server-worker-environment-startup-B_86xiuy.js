...
import { a as getActiveSecretsRuntimeEnv, i as getActiveSecretsRuntimeConfigSnapshot } from "./runtime-state-CdeDRMxT.js";
...
const loadWorkerInferenceRuntimeModule = createLazyRuntimeModule(() => import("./inference-runtime-DjzciOEB.js"));
async function loadGatewayWorkerEnvironmentStartupState() {
	const [{ createWorkerEnvironmentStore }, { createWorkerSessionPlacementStore }] = await Promise.all([import("./store-B_oIlzeD.js"), import("./placement-store-CPeV6NCG.js")]);
...
async function createGatewayWorkerEnvironmentRuntime(params) {
	const [{ createWorkerEnvironmentService }, { createWorkerLiveEventReceiver }, { createWorkerSessionPlacementGate }, { createWorkerTranscriptCommitter }, { createWorkerTunnelManager }, { resolveWorkerProvider }] = await Promise.all([
		import("./service-CwSObHz9.js"),
		import("./live-events-B2uJTq3R.js"),
		import("./placement-worker-gate-CGYIVPSv.js"),
		import("./transcript-commit-D11FFGXw.js"),
		import("./tunnel-eFIeicIW.js"),
