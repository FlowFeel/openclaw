...
import { a as isCliRuntimeProvider, i as isCliRuntimeAliasForProvider } from "./model-runtime-aliases-D1mCKu2G.js";
...
import { D as resolveAgentRunSessionTarget } from "./builtin-openclaw-0050ajkS.js";
...
import { r as prepareAgentRuntimeAuth, t as agentRuntimeAuthPlanMatchesTarget } from "./prepare-auth-C8ecPbie.js";
...
async function resolveContextEngineCompactionSuccessor(params) {
	...
	if (successorFile) {
		...
		const keyedEntry = isSessionKey ? loadSqliteSessionEntry({
		...
		const retainedMarkerEntry = marker ? loadSqliteSessionEntry({
