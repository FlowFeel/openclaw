import { jg as PluginInstallRecord } from "./types.openclaw-_47ZKysp.js";
import { S as PluginManifestProviderRequestProvider, c as PluginPackageInstall, m as PluginDiagnostic, n as PluginManifestRegistry, o as OpenClawPackageBuild, r as PluginDiscoveryResult, s as PluginPackageChannel, t as PluginManifestRecord, x as PluginManifestProviderEndpoint } from "./manifest-registry-Cbr_emsE.js";

//#region src/plugins/compat/registry-records.d.ts
declare const PLUGIN_COMPAT_RECORDS: readonly [...({
  code: "plugin-sdk-channel-streaming-subpath" | "plugin-sdk-config-runtime-subpath" | "plugin-sdk-inbound-reply-dispatch-subpath" | "plugin-sdk-channel-reply-pipeline-subpath" | "plugin-sdk-infra-runtime-subpath" | "plugin-sdk-text-runtime-subpath" | "plugin-sdk-channel-secret-runtime-subpath" | "plugin-sdk-agent-config-primitives-subpath" | "plugin-sdk-matrix-subpath" | "plugin-sdk-channel-logging-subpath" | "plugin-sdk-channel-lifecycle-subpath" | "plugin-sdk-channel-message-subpath" | "plugin-sdk-group-access-subpath" | "plugin-sdk-zod-subpath";
  status: "deprecated";
  owner: "config" | "channel" | "sdk";
  introduced: string;
  deprecated: string;
  warningStarts: string;
  removeAfter: "2026-08-15" | "2026-09-01";
  replacement: "`openclaw/plugin-sdk/channel-outbound`" | "`api.pluginConfig`, `openclaw/plugin-sdk/config-mutation`, `openclaw/plugin-sdk/runtime-config-snapshot`, and `openclaw/plugin-sdk/config-contracts`" | "`openclaw/plugin-sdk/channel-inbound` and `openclaw/plugin-sdk/channel-outbound`" | "focused subpaths including `openclaw/plugin-sdk/delivery-queue-runtime`, `openclaw/plugin-sdk/diagnostic-runtime`, `openclaw/plugin-sdk/error-runtime`, `openclaw/plugin-sdk/exec-approvals-runtime`, `openclaw/plugin-sdk/fetch-runtime`, and `openclaw/plugin-sdk/ssrf-runtime`" | "`openclaw/plugin-sdk/logging-core`, `openclaw/plugin-sdk/text-chunking`, `openclaw/plugin-sdk/text-utility-runtime`, and `openclaw/plugin-sdk/string-coerce-runtime`" | "`openclaw/plugin-sdk/channel-secret-basic-runtime` and `openclaw/plugin-sdk/channel-secret-tts-runtime`" | "`openclaw/plugin-sdk/channel-config-schema`" | "`openclaw/plugin-sdk/run-command`" | "`openclaw/plugin-sdk/channel-outbound` and `openclaw/plugin-sdk/channel-inbound`" | "`openclaw/plugin-sdk/channel-ingress-runtime`" | "the direct `zod` package import";
  docsPath: string;
  surfaces: string[];
  diagnostics: string[];
  tests: string[];
  ...
  readonly deprecated: "2026-07-29";
  readonly warningStarts: "2026-07-29";
  readonly removeAfter: "2026-08-12";
  readonly replacement: "declare `ContextEngineInfo.acceptedHostParams`; full host params after the window";
  ...
  readonly diagnostics: readonly ["plugin compatibility registry and dated runtime removal marker"];
  ...
  readonly removeAfter: "2026-08-30";
  readonly replacement: "plugin-owned config schemas plus generic `openclaw/plugin-sdk/channel-config-schema` and `openclaw/plugin-sdk/setup-runtime` primitives";
  readonly docsPath: "/plugins/sdk-migration#published-channel-setup-compatibility";
...
type InstalledPluginIndexRecord = {
  ...
  manifestPath: string;
  manifestHash: string; /** Hash of the doctor-contract artifact selected by the runtime resolver. */
...
//#endregion
export { PluginMetadataSnapshotOwnerMaps as n, PluginCompatCode as r, PluginMetadataSnapshot as t };