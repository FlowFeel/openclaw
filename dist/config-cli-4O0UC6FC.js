...
import { G as isConfigSetJsonParseOnly, W as isConfigMachineOutput } from "./argv-D6QuZiS5.js";
...
import { d as resolveConfigPath, t as CONFIG_PATH } from "./paths-CL43LNS6.js";
import { a as hasErrnoCode } from "./errors-Cg_yT1Sv.js";
import { t as formatCliCommand } from "./command-format-C5kg4XY_.js";
import { a as writeRuntimeJson, o as writeRuntimeStdout, r as defaultRuntime, t as ExitError } from "./runtime-DOr96aVu.js";
import { o as collectManifestModelIdNormalizationPolicies } from "./plugin-metadata-lifecycle-NcA0EWhA.js";
import { f as resolveDefaultAgentId, h as tryResolveDefaultAgentId, n as listAgentEntries, r as listAgentEntriesWithSource, t as hasAgentRosterProperty } from "./agent-scope-config-Dusa8eSA.js";
import { n as normalizeAgentId } from "./agent-id-DDgUze4y.js";
import { $ as AUTO_MANAGED_CONFIG_META_PATHS, I as collectUnsupportedSecretRefPolicyIssues, M as validateConfigObjectRawWithPlugins, l as readConfigFileSnapshot } from "./io-BsQc3Kgy.js";
import { r as theme } from "./theme-vjDs9tao.js";
import { _ as resolveSecretInputRef, f as isValidEnvSecretRefId, s as coerceSecretRef, u as isSecretRef } from "./types.secrets-BvApkFoj.js";
import { i as resolveAgentModelPrimaryValue, n as normalizeAgentModelRefForConfig } from "./model-input-BofPWz0k.js";
import { c as resolveAgentExplicitModelPrimary, d as resolveAgentModelFallbacksOverride } from "./agent-scope-DyEposw2.js";
import { t as splitTrailingAuthProfile } from "./model-ref-profile-BIKs-96s.js";
import { P as SecretProviderSchema } from "./zod-schema.agent-runtime-CaWcMFul.js";
import { a as isValidFileSecretRefId, i as isValidExecSecretRefId, l as secretRefKey, o as isValidSecretProviderAlias, r as formatExecSecretRefIdValidationMessage, u as validateExecSecretRefId } from "./ref-contract-BVYOI0KD.js";
import { t as parseConfigPathArrayIndex } from "./path-array-index-CvEcUJa-.js";
import { r as loadPluginMetadataSnapshot } from "./plugin-metadata-snapshot-B_ZQ9Mbo.js";
...
import { C as resolveModelRefFromString, a as buildModelAliasIndex, b as resolveConfiguredModelRef } from "./model-selection-shared-V7VmYFPH.js";
import { w as resolveDefaultModelForAgent } from "./codex-route-model-ref-BDwklqCa.js";
import { i as normalizeConfigIssues, n as formatConfigIssueLines } from "./issue-format-NBZpPOU4.js";
import { n as isPluginPackagingRuntimeOutputInvalidConfigSnapshot } from "./recovery-policy-CsUZ07YX.js";
import { a as success, n as info, o as warn, t as danger } from "./globals-Cw62Mq_M.js";
import { r as replaceConfigFile } from "./mutate-dYcqgG_5.js";
import "./config-BBVHtcXg.js";
import { t as formatDocsLink } from "./links-ClIwBcy4.js";
import { a as isPluginIntegrationSecretProviderConfig, n as resolveSecretRefValue, s as resolveSecretProviderIntegrationConfig } from "./resolve-zGIf9IjE.js";
import { c as resolveConfigSecretTargetByPath, n as discoverConfigSecretTargets } from "./target-registry-query-CnPjWCNY.js";
import "./target-registry-BVDHguMA.js";
import { s as formatStrictJsonParseFailure } from "./error-format-BZ5G9eas.js";
...
import { t as diffConfigPaths } from "./config-diff-BMZsFOL1.js";
import { t as buildGatewayReloadPlan } from "./config-reload-plan-D9-y_jYl.js";
...
import { n as readBestEffortRuntimeConfigSchema } from "./runtime-schema-Di48XSCd.js";
import { t as normalizeSubmittedConfigModelRefs } from "./model-input-normalization-RKhrMUFC.js";
import { n as setCommandJsonMode } from "./json-mode-DBVhsnA-.js";
...
async function readConfigPatchInput(opts) {
	...
	if (stdin) raw = await readStdinText();
		...
		raw = readConfigMutationFileSync(file, "--file");
	} catch (err) {
...
function collectTouchedTextModelRefs(params) {
	...
	if (listedAgentEntries.map(({ entry }) => entry).filter((entry) => entry.default === true).length !== 1) return [];
	...
	const previousDefaultAgentId = params.previousConfig ? tryResolveDefaultAgentId(params.previousConfig) : void 0;
...
function expandInheritedDefaultRefs(config, refs) {
	...
	if (agentEntries.filter((entry) => entry.default === true).length !== 1) return refs;
	...
	for (const ref of refs) {
		...
		for (const { id: agentId } of agentEntries) {
			if (normalizeAgentId(agentId) === normalizeAgentId(defaultAgentId)) continue;
...
async function createRuntimeModelRefResolver() {
	const [agentScope, modelSelection] = await Promise.all([import("./agent-scope-Jqp3H3Rj.js"), import("./model-selection-Cmjka01x.js")]);
	const preparedByAgent = /* @__PURE__ */ new Map();
	let modelModules;
	const loadModelModules = () => modelModules ??= Promise.all([import("./model-r7k1OqGa.js"), import("./prepared-model-catalog-CDZ2A_-7.js")]);
...
function configApplyHintForOperations(operations, beforeConfig, afterConfig) {
	...
	if (paths.length === 0 || paths.some((path) => path === "plugins.entries" || path.startsWith("plugins.entries."))) return "Restart the gateway to apply.";
...
async function runConfigOperations(params) {
	...
	if (options.dryRun) {
		...
		if (requiresFullSchemaValidation) errors.push(...collectDryRunSchemaErrors(nextConfig));
...
async function runConfigGet(opts) {
	...
	try {
		...
		const res = getAtPath(redactConfigObject((await loadValidConfig(runtime, {
			observe: false,
			json: opts.json
		})).config), parsedPath);
		if (!res.found) {
...
async function runConfigUnset(opts) {
	...
	try {
		...
		await replaceConfigFile({
			nextConfig,
			...snapshot.hash !== void 0 ? { baseHash: snapshot.hash } : {},
			writeOptions: unsetResult.leafContainer === "array" ? { auditOrigin: "cli" } : {
				auditOrigin: "cli",
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Non-interactive config helpers (get/set/patch/unset/file/schema/validate). Run without subcommand for guided setup.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.openclaw.ai/cli/config")}\n`).option("--section <section>", "Configuration sections for guided setup (repeatable). Use with no subcommand.", collectOption, []).action(async (opts) => {
		const { configureCommandFromSectionsArg } = await import("./configure-3fkt8Db0.js");
