...
function buildProjectedAgentRunIndex() {
	...
	for (const context of state.contexts.values()) {
		...
		if (context.sessionKey !== void 0) sessionKeys.add(context.sessionKey);
		if (context.sessionId !== void 0) sessionIds.add(context.sessionId);
	}
	return {
		sessionKeys,
		sessionIds
...
function hasProjectedAgentRunForSession(params) {
	...
	return params.sessionKeys.some((sessionKey) => index.sessionKeys.has(sessionKey)) || params.sessionId !== void 0 && index.sessionIds.has(params.sessionId);
}
...
//#endregion
export { retainQueuedAgentRunContext as _, getAgentRunContext as a, recordAgentRunOutputTokens as b, getAgentRunLifecycleGeneration as c, readAgentRunIndexVersion as d, recordCronNextCheckProposal as f, resetAgentRunRegistryForTest as g, releaseAgentRunContext as h, consumeCronNextCheckProposal as i, hasProjectedAgentRunForSession as l, registerAgentRunSequenceResetHandler as m, claimAgentRunContext as n, getAgentRunContextOwnerStatus as o, registerAgentRunContext as p, clearAgentRunContext as r, getAgentRunContextOwnership as s, buildProjectedAgentRunIndex as t, listAgentRunsForSession as u, rotateAgentRunRegistryLifecycleGeneration as v, sweepStaleRunContexts as y };
