...
var SystemAgentInferenceUnavailableError = class extends Error {
	constructor(stage, failures = []) {
		super("OpenClaw could not reach working inference. Run `openclaw onboard` on the machine running OpenClaw to reconnect — it live-tests the route before saving it. Then try again.");
		this.stage = stage;
