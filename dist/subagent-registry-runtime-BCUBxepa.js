...
import { C as resolveRequesterForChildSessionFromRuns, S as listRunsForRequesterFromRuns, h as countPendingDescendantRunsFromRuns, i as getSubagentRunsSnapshotForRead, m as countPendingDescendantRunsExcludingRunFromRuns, v as hasDescendantRunAwaitingSettleFromRuns, w as shouldIgnorePostCompletionAnnounceForSessionFromRuns, y as isSubagentSessionRunActiveFromRuns } from "./subagent-registry-state-jajoFCVZ.js";
import { a as getLatestSubagentRunByChildSessionKey, r as countActiveDescendantRuns } from "./subagent-registry-read-CIgozRhQ.js";
...
async function replaceSubagentRunAfterSteer(params) {
	return (await import("./subagent-registry-BH3v6WwW.js")).replaceSubagentRunAfterSteer(params);
}
//#endregion
