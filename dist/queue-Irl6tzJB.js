...
import { t as resolveQueueSettings$1 } from "./settings-B9QZfJQM.js";
import { C as countPendingQueueItems, _ as peekRecentQueueMessageId, a as getFollowupQueue, b as applyQueueDropPolicy, c as trimSummaryElisionsToCap, d as completeFollowupRunLifecycle, f as isFollowupRunAborted, i as getExistingFollowupQueue, k as shouldSkipQueueItem, m as markFollowupRunEnqueued, v as recordRecentQueueMessageId, y as resetRecentQueuedMessageIdDedupe } from "./state-CRjZ_OD8.js";
import { a as resolveFollowupDeliveryContextKey, i as rememberFollowupDrainCallback, n as createOverflowSummaryRetrySource, o as resolveFollowupReplyAnchor, r as kickFollowupDrainIfIdle } from "./cleanup-CZuCnQnl.js";
...
function enqueueFollowupRun(key, run, settings, dedupeMode = "message-id", runFollowup, restartIfIdle = true, options = {}) {
	...
	if (recentMessageIdKey) recordRecentQueueMessageId(run, recentMessageIdKey);
