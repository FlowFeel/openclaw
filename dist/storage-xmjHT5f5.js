...
import { t as loadJsonFile } from "./json-store-BVGQY8xv.js";
import "./record-shared-DM43IPkv.js";
import { t as getMatrixRuntime } from "./runtime-Drg4hYqm.js";
import { n as resolveMatrixAccountStorageRoot } from "./storage-paths-HvTTKK7M.js";
import { c as migrateLegacyMatrixRecoveryKeyFileToStore, n as MATRIX_LEGACY_CRYPTO_MIGRATION_FILENAME, o as migrateLegacyMatrixLegacyCryptoMigrationFileToStore, r as MATRIX_RECOVERY_KEY_FILENAME, t as MATRIX_IDB_SNAPSHOT_FILENAME, v as scoreMatrixCryptoStateInStore, w as resolveMatrixSqliteStateEnv } from "./crypto-state-store-3ILKBeVs.js";
...
function scoreStorageRoot(rootDir, metadata = readStoredRootMetadata(rootDir)) {
	let score = 0;
...
async function maybeMigrateLegacyStorage(params) {
	...
	const syncCache = hasAccountScopedLegacyStorageFile ? await import("./file-sync-store-drIg5rB8.js") : null;
...
async function migrateLegacySyncCacheToSqlite(params) {
	const syncCache = await import("./file-sync-store-drIg5rB8.js");
