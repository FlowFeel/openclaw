...
import { a as createStreamIteratorWrapper, i as wrapStreamFnTextTransforms } from "./text-transforms.runtime-CzlkCllE.js";
...
import { A as COMPACTION_SUMMARY_PREFIX, M as bashExecutionToText, O as BRANCH_SUMMARY_PREFIX, j as COMPACTION_SUMMARY_SUFFIX, k as BRANCH_SUMMARY_SUFFIX } from "./agent-core-DwxIhy3z.js";
import { t as event_stream_exports } from "./event-stream-MHM-_qcK.js";
import { J as SettingsManager, K as wrapToolDefinition, i as DefaultResourceLoader, n as createAgentSessionForEmbeddedRunner } from "./sessions-Digi7ATr.js";
import { a as isSessionContextMetadataEntry } from "./session-manager-codec-qDky9Jof.js";
import { r as detectRuntimeShell } from "./shell-utils-DzYfAjux.js";
import { a as sanitizeToolCallInputs, c as hasOnlyAssistantReasoningContent, i as repairToolUseResultPairing, l as isReasoningOnlyLengthAssistantTurn, o as sanitizeToolUseResultPairing, s as stripToolResultDetails } from "./ai-transport-runtime-host-BuwNINnx.js";
...
import { a as buildHistoryPrunePlan, d as isOversizedForSummary, i as SUMMARIZATION_OVERHEAD_TOKENS, l as computeAdaptiveChunkRatio, n as MIN_CHUNK_RATIO, r as SAFETY_MARGIN, t as BASE_CHUNK_RATIO } from "./compaction-planning-C-JUoUqc.js";
import { o as resolveModelAuthMode } from "./model-auth-D32HIbZ7.js";
...
import { d as isTimeoutError, u as isSignalTimeoutReason } from "./failover-error-CMC-wGmM.js";
...
import { H as isTerminalTaskStatus } from "./task-registry-BbNCFm_L.js";
import { c as mergeAgentRunAttemptTerminal, d as projectAgentRunAttemptTerminal, f as setAgentRunAttemptTerminalFailure, r as buildAgentRunTerminalOutcomeFromAttempt } from "./agent-run-terminal-outcome-Bl2pG_Kc.js";
import { i as AGENT_RUN_RESTART_ABORT_STOP_REASON, l as isAgentRunRestartAbortReason, o as createAgentRunRestartAbortError } from "./run-termination-BeCPtaNS.js";
import { c as listTasksForOwnerOrRequesterSessionKeyForStatus, n as findTaskByRunIdForStatus } from "./task-status-access-Cl2Mqwif.js";
import { n as resolveAgentTimeoutMs } from "./timeout-BEGWfRGM.js";
import { j as resolveCompactionTimeoutMs } from "./diagnostic-D_EA4nFT.js";
import { h as setActiveEmbeddedRunLifecycleGeneration } from "./run-state-VfGqytOx.js";
import { T as updateActiveEmbeddedRunSnapshot, h as markActiveEmbeddedRunAbandoned, r as clearActiveEmbeddedRun, w as setActiveEmbeddedRun } from "./runs-ehu0VRUR.js";
...
import { i as getPluginToolMeta } from "./tools-DfrDsxdD.js";
import { o as readMcpAppChannelView } from "./mcp-ui-resource-3evILmy0.js";
import { r as materializeBundleMcpToolsForRun } from "./agent-bundle-mcp-materialize-x4v1hS9M.js";
...
import { f as buildContextEngineRuntimeSettings, i as bootstrapHarnessContextEngine, n as runAgentEndSideEffects, r as assembleHarnessContextEngine, s as finalizeHarnessContextEngineTurn, u as runContextEngineMaintenance } from "./agent-end-side-effects-OmZZY1Jt.js";
...
import { t as createBundleLspToolRuntime } from "./agent-bundle-lsp-runtime-Sz_v7QHK.js";
import { t as AgentRunTerminalOutcomeError } from "./agent-run-terminal-error-BLySVFXs.js";
import { l as copyAgentToolMetadata, m as getChannelAgentToolMeta } from "./gateway-CRcKH8Wu.js";
...
import { I as formatToolAggregate, h as normalizeAgentPlanSteps } from "./streaming-B45j2FQx.js";
...
import { n as rewriteTranscriptEntriesInSessionManager } from "./transcript-runtime-state-oJ_KPxv9.js";
import { n as resolveProcessToolScopeKey, t as createOpenClawCodingTools } from "./agent-tools-CpYejLH6.js";
import { r as wrapUntrustedPromptDataBlock, t as sanitizeForPromptLiteral } from "./sanitize-for-prompt-Drdy09dw.js";
import { A as settleRequesterAfterSessionSpawns, R as prependAgentSteeringPrompt, h as leasePendingAgentSteeringItems, t as ackPendingAgentSteeringItems, w as releasePendingAgentSteeringItems } from "./subagent-registry-DBvWqYln.js";
...
import { n as replaceWithEffectiveCronCreatorToolAllowlist } from "./cron-tool-BfYQxqA7.js";
import { p as mediaUrlsFromGeneratedAttachments } from "./subagent-announce-delivery-3IH1Gl4d.js";
import { t as abortable } from "./abortable-wb3haGdv.js";
import { _ as buildApiErrorObservationFields, v as buildTextObservationFields, y as shouldSuppressRawErrorConsoleSuffix } from "./model-fallback-attempt-DCerkT6E.js";
import { t as registerProviderStreamForModel } from "./provider-stream-DxaHNFPv.js";
import { t as buildSubagentList } from "./subagent-list-C-We1n9B.js";
import { o as listControlledSubagentRuns } from "./subagent-control-Cx7OHkhi.js";
...
import { n as normalizeAgentRuntimeTools, t as logAgentRuntimeToolDiagnostics } from "./tools-CnfMpH7Q.js";
...
import { t as applyFinalEffectiveToolPolicy } from "./effective-tool-policy-DUqTqJlH.js";
import { a as shouldCreateBundleMcpRuntimeForAttempt, i as shouldCreateBundleLspRuntimeForAttempt, n as mergeForcedEmbeddedAttemptToolsAllow, r as resolveEmbeddedAttemptToolConstructionPlan, t as applyEmbeddedAttemptToolsAllow } from "./attempt-tool-construction-plan-D4Oh4XYT.js";
import { n as claimHeartbeatOutcomeForRun, t as buildHeartbeatOutcomeContext } from "./heartbeat-outcome-store-CIMwR2LT.js";
import { S as isAnthropicModelRef, s as createCodexNativeWebSearchWrapper, x as isAnthropicFamilyCacheTtlEligible } from "./proxy-DpYaxGU4.js";
import { a as resolvePreparedExtraParams, n as resolveAgentTransportOverride, o as isGooglePromptCacheEligible, r as resolveExplicitSettingsTransport, s as resolveCacheRetention, t as applyExtraParamsToAgent } from "./extra-params-BeuHLfDA.js";
import { a as resolveEmbeddedAgentStreamFn, i as resolveEmbeddedAgentBaseStreamFn, n as describeEmbeddedAgentStreamStrategy, r as resolveEmbeddedAgentApiKey, t as wrapStreamFnWithDiagnosticModelCallEvents } from "./attempt.model-diagnostic-events-BNf9wl_S.js";
import { i as resolveLiveToolResultMaxChars } from "./tool-result-limits-DjIhjsDF.js";
import { _ as stripInvalidThinkingSignatures, a as resolveLiveToolResultAggregateMaxChars, b as wrapAnthropicStreamWithRecovery, f as truncateToolResultText, g as shouldPreserveLatestAssistantThinking, h as dropThinkingBlocks, i as resolveCacheTtlPruningSettings, l as truncateOversizedToolResultsInMessages, m as dropReasoningFromHistory, p as assessLastAssistantMessage, r as pruneExpiredCacheTtlToolResults, s as toolResultWarningDedupe, u as truncateOversizedToolResultsInSessionManager, v as stripStaleThinkingSignaturesForCompactionReplay, x as formatContextLimitTruncationNotice, y as stripThinkingBlocksFromMessage } from "./transcript-visibility-0PUROgcA.js";
import { t as estimateToolResultTextChars } from "./tool-result-text-budget-PVCMQFTx.js";
import { t as guardSessionManager } from "./session-tool-result-guard-wrapper-yRBItbvz.js";
...
import { c as buildInboundMediaNoteProjection, o as formatContextJsonBlock, r as hasPersistedMedia, t as isReasoningTagProvider } from "./provider-utils-CpMqd4Cc.js";
...
import { d as resolveFinalAssistantVisibleText, u as resolveFinalAssistantRawText, v as resolveReportedModelRef } from "./helpers-DOU3STAD.js";
...
import { a as toToolDefinitions, i as toClientToolDefinitions, n as findClientToolNameConflicts, t as createClientToolNameConflictError } from "./agent-tool-definition-adapter-BVm3rgD-.js";
import { n as isQueryStopWordToken, t as extractKeywords } from "./query-expansion-DzoKGtnD.js";
import { t as createAgentToolResultMiddlewareRunner } from "./tool-result-middleware-TepndI6l.js";
import { B as resolveCodeModeSkills } from "./code-mode-state-Bm5CmmFP.js";
import { i as createCodeModeTools, n as resolveAgentToolSurfacePlan, r as addClientToolsToCodeModeCatalog, t as applyAgentToolSurfaceCatalog } from "./tool-surface-plan-DnQrVYkH.js";
import { t as splitSdkTools } from "./tool-split-ed47AzDZ.js";
...
import { n as collectRuntimeChannelCapabilities, t as buildSystemPromptReport } from "./system-prompt-report-Bwgqsk2i.js";
import { r as resolveEmbeddedSandboxInfoExecPolicy, t as buildEmbeddedSandboxInfo } from "./sandbox-info-CKzCKg96.js";
import { t as completeWithPreparedSimpleCompletionModel } from "./simple-completion-runtime-o7vopKEW.js";
