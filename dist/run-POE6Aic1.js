...
async function runGatewayCommandOnce(opts, hooks = {}) {
	...
	const serverImportMeasurement = startupTrace.startMeasure("cli.server-import", () => import("./server-CNt1cRa2.js"));
...
async function runGatewayCommand(opts, hooks = {}, recoveryDeps) {
	try {
		...
		const { offerInvalidConfigRecovery } = await import("./invalid-config-recovery-DZe4PC0G.js");
