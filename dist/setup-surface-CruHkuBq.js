...
import { c as isPrivateOrLoopbackHost } from "./net-B22ilI8B.js";
import "./string-coerce-runtime-CLK2YdzD.js";
import { N as splitSetupEntries, S as promptAccountId, p as mergeAllowFromEntries } from "./setup-wizard-helpers-C8pTV3Ti.js";
...
import { r as resolveMatrixEnvAuthReadiness } from "./env-auth-BIeosnj3.js";
import { i as resolveMatrixAccount, r as resolveDefaultMatrixAccountId, t as listMatrixAccountIds } from "./accounts-CqEd0FYU.js";
import { n as updateMatrixAccountConfig } from "./config-update-N0JcFtKV.js";
import { r as moveSingleMatrixAccountConfigToNamedAccount, t as createMatrixSetupDmPolicy } from "./setup-dm-policy-CPB510mx.js";
import { n as validateMatrixHomeserverUrl, t as resolveValidatedMatrixHomeserverUrl } from "./url-validation-DOTAJVa5.js";
import { n as ensureMatrixSdkInstalled, r as isMatrixSdkAvailable } from "./deps-Dd4HQbwO.js";
...
async function promptMatrixAllowFrom(params) {
	...
	while (true) {
		...
		if (pending.length > 0) {
			const { resolveMatrixTargets } = await import("./resolve-targets-B7TFxRdU.js");
	...
	if (accessConfig) if (accessConfig.policy !== "allowlist") next = updateMatrixAccountConfig(next, params.accountId, { groupPolicy: accessConfig.policy });
		...
		if (accessConfig.entries.length > 0) try {
			...
			for (const entry of accessConfig.entries) {
				...
				const { listMatrixDirectoryGroupsLive } = await import("./directory-live-Di_66iGk.js");
...
const matrixOnboardingAdapter = {
	...
	afterConfigWritten: async ({ previousCfg, cfg, accountId, runtime }) => {
		const { runMatrixSetupBootstrapAfterConfigWrite } = await import("./setup-bootstrap-fUS_geOc.js");
