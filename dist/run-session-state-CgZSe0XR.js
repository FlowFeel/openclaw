...
import { Ct as buildSessionCreationStamp } from "./session-accessor.sqlite-B9iW7DOt.js";
import { D as readSqliteTranscriptStatsSync } from "./session-accessor.sqlite-transcript-store-Si6-bv-m.js";
import { bt as isSessionWorkAdmissionActive } from "./session-entry-slot-keys-DR5d2mKt.js";
...
function resolveHeartbeatAckMaxChars(_agentCfg) {
	return 300;
}
