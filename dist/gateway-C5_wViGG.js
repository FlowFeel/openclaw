...
import { r as resolveGatewayCredentialsFromConfig } from "./credentials-DnLJcD2p.js";
...
import { n as loadDeviceIdentityIfPresent, r as loadOrCreateDeviceIdentity } from "./device-identity-P-Q23TDZ.js";
...
import { p as resolveMessageActionTurnCapability, r as copyCodeModeControlToolIdentity } from "./code-mode-control-tools-B1t6Lt9X.js";
import { n as copyPluginToolMeta } from "./tools-CSTIF4SP.js";
import { t as mintAgentRuntimeIdentityToken } from "./agent-runtime-identity-token-BJQ1RVYB.js";
import { t as getOperatorApprovalRuntimeToken } from "./operator-approval-runtime-token-BooUz6U1.js";
...
async function withGatewayToolCallerIdentity(identity, run) {
	...
	return await gatewayToolCallerStorage.run({
		...
		...identity.cronSelfManagementJobId?.trim() ? { cronSelfManagementJobId: identity.cronSelfManagementJobId.trim() } : {},
...
//#endregion
export { BEFORE_TOOL_CALL_HOOK_CONTEXT as _, runWithGatewaySessionSpawnContext as a, isToolWrappedWithBeforeToolCallHook as b, wrapToolWithGatewayCallerIdentity as c, getToolTerminalPresentation as d, setToolTerminalPresentation as f, BEFORE_TOOL_CALL_DIAGNOSTIC_OPTIONS as g, setChannelAgentToolMeta as h, resolveMessageActionAgentRuntimeIdentityToken as i, copyAgentToolMetadata as l, getChannelAgentToolMeta as m, readGatewayCallOptions as n, createGatewayToolCallerWrapper as o, copyChannelAgentToolMeta as p, resolveGatewayOptions as r, withGatewayToolCallerIdentity as s, callGatewayTool as t, copyToolTerminalPresentation as u, BEFORE_TOOL_CALL_SOURCE_TOOL as v, setBeforeToolCallDiagnosticsEnabled as x, BEFORE_TOOL_CALL_WRAPPED as y };
