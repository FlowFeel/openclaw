...
import { i as resolveManifestContractOwnerPluginId } from "./plugin-registry-contributions-DAYph4GM.js";
import "./plugin-registry-BKsO1htA.js";
import "./config-UtpOr1Uw.js";
import { n as resolveSecretRefValue } from "./resolve-C2Qr40mZ.js";
...
import { n as getLoadedChannelPlugin } from "./registry-B1AiP2IQ.js";
...
import { j as resolveExecApprovalRequestAllowedDecisions } from "./exec-approvals-DpQk_nvk.js";
import { a as getActiveSecretsRuntimeEnv, c as getActiveSecretsRuntimeSnapshotRevision, s as getActiveSecretsRuntimeSnapshot } from "./runtime-state-CdeDRMxT.js";
import { t as analyzeCommandSecretAssignmentsFromSnapshot } from "./command-config-5tB5aufF.js";
import { t as resolveRuntimeWebTools } from "./runtime-web-tools-CmSxdnzG.js";
...
import { f as formatExecApprovalExpiresIn } from "./exec-approval-reply-NJpDn_K7.js";
import { t as createPendingApprovalRegistry } from "./pending-approval-registry-BP7u96lB.js";
import { i as sanitizeExecApprovalWarningText, t as resolveExecApprovalCommandDisplay } from "./exec-approval-command-display-Bz0QY5bu.js";
import { a as buildTypedApprovalPendingReplyPayload, i as buildPluginApprovalResolvedReplyPayload, n as buildApprovalResolvedReplyPayload, o as buildTypedPluginApprovalPendingReplyPayload } from "./approval-renderers-CJlZGDtG.js";
import { d as listDevicePairing, l as hasEffectivePairedDeviceRole } from "./device-pairing-pwb3Oe75.js";
import { g as resolveApnsRelayConfigFromEnv, i as clearApnsRegistrationIfCurrent, l as loadApnsRegistrations } from "./push-apns-store-DIKYgzVs.js";
import { n as closeOrphanedOperatorApprovals, u as pruneTerminalOperatorApprovals } from "./operator-approval-store-BJ5KGqT7.js";
import { t as resolveApprovalSessionAudienceWithFallback } from "./approval-session-audience-DgE4i4mR.js";
import { t as SYSTEM_AGENT_APPROVAL_DECISIONS } from "./system-agent-approvals-BczGX_94.js";
import { a as sendApnsPluginApprovalAlert, c as resolveApnsAuthConfigFromEnv, i as sendApnsExecApprovalResolvedWake, o as sendApnsPluginApprovalResolvedWake, r as sendApnsExecApprovalAlert, s as shouldClearStoredApnsRegistration } from "./push-apns-BPyUYCWp.js";
import { n as ExecApprovalManager } from "./exec-approval-manager-CiCCczJ0.js";
...
async function activateSecretsRuntimeSnapshotIfCurrent(snapshot, expectedRevision, options) {
	const runtime = await import("./runtime-BIMATdnS.js");
...
function createGatewayAuxHandlers(params) {
	...
	const loadExecApprovalHandlers = createLazyPromise(() => import("./exec-approval-CAvCKYa6.js").then(({ createExecApprovalHandlers }) => createExecApprovalHandlers(execApprovalManager, {
		forwarder: execApprovalForwarder,
		iosPushDelivery: execApprovalIosPushDelivery
	})), { cacheRejections: true });
	const questionManager = new QuestionManager();
	const loadQuestionHandlers = createLazyPromise(() => import("./question-BI7Fah8L.js").then(({ createQuestionHandlers }) => createQuestionHandlers(questionManager)), { cacheRejections: true });
	...
	const loadPluginApprovalHandlers = createLazyPromise(() => import("./plugin-approval-BNJ04uRo.js").then(({ createPluginApprovalHandlers }) => createPluginApprovalHandlers(pluginApprovalManager, {
		forwarder: execApprovalForwarder,
		iosPushDelivery: pluginApprovalIosPushDelivery
	})), { cacheRejections: true });
	const loadApprovalHandlers = createLazyPromise(() => import("./approval-CVuJlQym.js").then(({ createApprovalHandlers }) => createApprovalHandlers({
		execApprovalManager,
	...
	const loadSecretsHandlers = createLazyPromise(() => import("./secrets-5PvAl0nH.js").then(({ createSecretsHandlers }) => createSecretsHandlers({
