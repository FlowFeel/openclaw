...
import { Q as ConfigMutationConflictError } from "./io-DCw4R0kD.js";
...
import { c as formatPluginCompatibilityNotice, r as buildPluginCompatibilitySnapshotNotices } from "./status-Bule1fI7.js";
...
import { a as requireRiskAcknowledgement, i as readValidSetupConfigFile, o as resolveQuickstartGatewayDefaults, r as readSetupConfigFileSnapshot, s as writeWizardConfigFile, t as hasQuickstartGatewayOverrides } from "./setup.shared-D0iINifk.js";
import { a as runSetupModelAuthStep, i as offerLiveModelVerification, n as listSetupMigrationOptions, r as runSetupMigrationImport, t as detectSetupMigrationSources } from "./setup.migration-import-DRPsusjP.js";
import { t as resolveSetupWorkspaceSelection } from "./setup.workspace-BHi5WwA6.js";
import { isDeepStrictEqual } from "node:util";
//#region src/wizard/setup.ts
const loadConfigLoggingModule = createLazyRuntimeModule(() => import("./logging-l6OoqoUS.js"));
...
async function runSetupWizardOnce(opts, runtimeInput, prompter) {
	...
	const onboardHelpers = await import("./onboard-helpers-Dxm_i9Uy.js");
	...
	const remoteOnboard = seededRemoteUrl ? await import("./onboard-remote-CKPtOGxo.js") : null;
	...
	if (mode === "remote") {
		const { promptRemoteGatewayConfig } = remoteOnboard ?? await import("./onboard-remote-CKPtOGxo.js");
	...
	const onboard = (await import("./onboard-agent-C0hW7e2o.js")).ensureOnboardingConfig;
	...
	if (opts.skipChannels) await prompter.note(t("wizard.setup.skipChannels"), t("wizard.setup.channelsTitle"));
		...
		const { listChannelPlugins } = await import("./plugins-RHI6_iXx.js");
		const { setupChannels } = await import("./onboard-channels-CRCe6eBh.js");
	...
	if (opts.skipSearch) await prompter.note(t("wizard.setup.skipSearch"), t("wizard.setup.searchTitle"));
		...
		const { runSearchSetupFlow } = await import("./search-setup-B0GaBaJC.js");
	...
	if (opts.skipSkills) await prompter.note(t("wizard.setup.skipSkills"), t("wizard.setup.skillsTitle"));
		...
		const { setupSkills } = await import("./onboard-skills-DIXeo_Hv.js");
	...
	if (flow !== "quickstart") {
		const { setupOfficialPluginInstalls } = await import("./setup.official-plugins-C1XwLrsw.js");
		...
		const { setupAppRecommendations } = await import("./setup.app-recommendations-MwF2Mhxm.js");
		...
		const { setupPluginConfig } = await import("./setup.plugin-config-elJ3ufR_.js");
	...
	const { finalizeSetupWizard } = await import("./setup.finalize-zZGme3Em.js");
