...
function loadDefaultSummarizeTextDeps() {
	return defaultSummarizeTextDepsPromise ??= Promise.all([import("./simple-completion-runtime-Byat_1tR.js"), import("./model-auth-BR9AFEUL.js")]).then(([completionRuntime, { requireApiKey }]) => ({
