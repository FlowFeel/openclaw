...
import { n as clearRuntimeAuthProfileStoreSnapshot } from "./store-BMd0T0_g.js";
...
const loadAuthChoiceModule = createLazyRuntimeModule(() => import("./auth-choice-CPnnrHXp.js"));
const loadModelPickerModule = createLazyRuntimeModule(() => import("./model-picker-Do36Yst7.js"));
...
async function runSetupModelAuthStep(params) {
	...
	while (true) {
		...
		if (authChoice === "custom-api-key") {
			const { promptCustomApiConfig } = await import("./onboard-custom-CdZDNs1l.js");
...
const loadMigrationProviderRuntimeModule = createLazyRuntimeModule(() => import("./migration-provider-runtime-tsQ0HMcX.js"));
