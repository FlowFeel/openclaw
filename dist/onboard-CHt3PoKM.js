...
import { i as resolveProviderMatch } from "./provider-auth-choice-helpers-CXrCbTnC.js";
...
import { t as resolvePluginProviders } from "./provider-auth-choice.runtime-DRGVvJyB.js";
import { c as parseNonInteractiveCustomApiFlags, d as resolveCustomProviderId, n as applyCustomApiConfig, t as CustomApiError } from "./onboard-custom-config-C_xiXEHC.js";
...
import { t as runGuidedOnboarding } from "./onboard-guided-DEyQVUTU.js";
...
import { n as runInteractiveSetup } from "./onboard-interactive-DVJJXD7L.js";
import { t as inferAuthChoiceFromFlags } from "./auth-choice-inference-RuNqC507.js";
import { n as resolveNonInteractiveApiKey, t as createNonInteractiveLoggingPrompter } from "./non-interactive-prompter-Bax_Gsxo.js";
...
async function runNonInteractiveLocalSetup(params) {
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-CAgcm0F-.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-DIGRd1tH.js");
...
async function runNonInteractiveMigrationImport(params) {
	...
	const { detectSetupMigrationSources, runSetupMigrationImport } = await import("./setup.migration-import-Bnef7ufb.js");
