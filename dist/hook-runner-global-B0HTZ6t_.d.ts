import { Z as TtsAutoMode, r as OpenClawConfig } from "./types.openclaw-DqdTE9e3.js";
...
import { O as PluginHookChannelContext, r as FinalizedMsgContext } from "./templating-BhJuWyZk.js";
...
import { t as PluginConversationBinding } from "./conversation-binding.types-Cf59DwvU.js";
import { t as PluginSubagentRequesterContext } from "./subagent-requester-context-4kZDP5r2.js";
...
//#endregion
export { PluginHookMessageReceivedEvent as $, PluginAgentTurnPrepareResult as A, PluginHookSkillChangedEvent as B, PluginHookReplyPayloadSendingResult as C, PluginHookToolRequesterContext as D, PluginHookToolKind as E, PluginNextTurnInjectionRecord as F, PluginHookSkillProposalEvaluateResult as G, PluginHookSkillEvaluationFinding as H, PluginJsonValue as I, PluginHookInboundClaimContext as J, PluginHookSkillProposalEvaluationOutcome as K, PluginHookSkillArtifact as L, PluginHeartbeatPromptContributionResult as M, PluginNextTurnInjection as N, PluginToolMatcher as O, PluginNextTurnInjectionEnqueueResult as P, PluginHookMessageContext as Q, PluginHookSkillBundleFile as R, PluginHookReplyPayloadSendingEvent as S, PluginHookToolInputKind as T, PluginHookSkillProposalChangedEvent as U, PluginHookSkillContext as V, PluginHookSkillProposalEvaluateEvent as W, PluginHookInboundMessageMetadata as X, PluginHookInboundClaimEvent as Y, PluginHookMediaFact as Z, PluginHookReplyDispatchContext as _, PluginHookAgentContext as a, ReplyDispatchBeforeDeliverOptions as at, PluginHookReplyPayload as b, PluginHookBeforeToolCallEvent as c, ReplyDispatcher as ct, PluginHookInboundClaimResult as d, PluginHookMessageSentEvent as et, PluginHookLlmInputEvent as f, PluginHookRegistrationOptions as g, PluginHookRegistration as h, HookEntry as i, ReplyDispatchBeforeDeliver as it, PluginHeartbeatPromptContributionEvent as j, PluginAgentTurnPrepareEvent as k, PluginHookContextWindowSource as l, ReplyFollowupAdmissionBarrierTimeoutPolicy as lt, PluginHookName as m, initializeGlobalHookRunner as n, PluginApprovalResolution as nt, PluginHookAgentEndEvent as o, ReplyDispatchKind as ot, PluginHookLlmOutputEvent as p, PluginHookSkillProposalKind as q, resetGlobalHookRunner as r, PluginHookBeforeToolCallResult as rt, PluginHookBeforeAgentFinalizeEvent as s, ReplyDispatchRuntimeInfo as st, getGlobalHookRunner as t, MessageHookMediaFact as tt, PluginHookHandlerMap as u, PluginHookReplyDispatchEvent as v, PluginHookToolContext as w, PluginHookReplyPayloadSendingContext as x, PluginHookReplyDispatchResult as y, PluginHookSkillBundleSnapshot as z };