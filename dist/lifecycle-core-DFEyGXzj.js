...
import { l as readConfigFileSnapshot, s as readBestEffortConfig } from "./io-BsQc3Kgy.js";
import { d as isWSL } from "./undici-runtime-CXx9v98C.js";
import { h as resolveFutureConfigActionBlock } from "./config-env-vars-Dh6msnxE.js";
...
import { t as createGatewayCredentialPlan } from "./credential-planner-iu6FQ85p.js";
import { n as isGatewaySecretRefUnavailableError, t as GatewaySecretRefUnavailableError } from "./credentials-BmHaFDWQ.js";
import { t as resolveGatewayAuthToken } from "./auth-token-resolution-BHduu4FR.js";
import { t as appendGatewayLifecycleAuditLog } from "./restart-logs-BBbMF07G.js";
import { t as createGatewayLifecycleMutationReporter } from "./service-mutation-PgzR3-XQ.js";
import { r as checkTokenDrift } from "./service-audit-iHiQAYcV.js";
import { o as startGatewayService, r as inspectGatewayServiceStartRepair, t as describeGatewayServiceRestart } from "./service-CbbYL0ZH.js";
import { a as renderSystemdUnavailableHints } from "./runtime-hints-DdAMOdVL.js";
import { _ as emitDaemonScheduledRestart, g as emitDaemonAlreadyRunning, i as filterContainerGenericHints, m as createDaemonActionContext, p as buildDaemonServiceSnapshot } from "./shared-C4IIJkT8.js";
...
import { n as formatPluginPackagingRuntimeOutputRecoveryHint, t as formatInvalidConfigRecoveryHint } from "./config-recovery-hints-BqY7smyo.js";
import { l as listAuthProfileStoresRequiringMigration, t as AUTH_PROFILE_MIGRATION_COMMAND } from "./legacy-source-diagnostic-BXz4yX3z.js";
import { n as collectCandidateAgentDirs } from "./runtime-fast-path-DG4G5qpD.js";
...
const GATEWAY_LAUNCHING_ACTIONS = /* @__PURE__ */ new Set(["start", "restart"]);
...
*/
function resolveAuthProfileMigrationBlock(action, snapshot) {
	if (!GATEWAY_LAUNCHING_ACTIONS.has(action) || !snapshot.valid) return null;
	let stores;
	try {
	...
	return {
		message: stores.length === 1 ? `Auth profile store ${stores[0]} requires legacy credential migration.` : `Auth profile stores ${stores.join(", ")} require legacy credential migration.`,
