...
import "./plugin-state-store-CeV9ciGZ.js";
import "./dangerous-name-matching-BzFYQ0Ix.js";
import "./uninstall-6WbfzFVM.js";
...
function defineChannelAliasMigration(spec) {
	...
	const normalizeChannelConfig = (params) => {
		...
		const accountsBefore = spec.accountStreamingInheritsDefaultAccount ? asObjectRecord(entry.accounts) : null;
...
//#endregion
//#region src/plugin-sdk/runtime-doctor.ts
/**
...
function collectChannelAccountScopes(params) {
	...
	const channel = asObjectRecord(asObjectRecord(params.cfg.channels)?.[params.channelId]);
...
//#endregion
export { defineChannelAliasMigration as a, normalizeChannelConfigEntries as c, hasLegacyAccountStreamingAliases as d, hasLegacyStreamingAliases as f, resolveLegacyAliasStreamingMode as h, formatPluginInstallPathIssue as i, stripRetiredChannelKeys as l, normalizeLegacyStreamingAliases as m, defineKeyMoveMigration as n, materializeInheritedAccountStreaming as o, normalizeLegacyChannelAliases as p, detectPluginInstallPathIssue as r, normalizeChannelAccounts as s, collectChannelAccountScopes as t, asObjectRecord as u };
