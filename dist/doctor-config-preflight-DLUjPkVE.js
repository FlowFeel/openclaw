...
import { _ as recoverConfigFromLastKnownGood, a as preserveConfigSnapshotAsClobbered, et as parseConfigJson5, f as readConfigFileSnapshotWithPluginMetadata, g as recoverConfigFromJsonRootSuffix, l as readConfigFileSnapshot } from "./io-DCw4R0kD.js";
import { c as normalizePluginsConfig, l as resolveEffectiveEnableState } from "./config-state-B6-Feb6H.js";
import { n as cloneEnvWithPlatformSemantics } from "./config-env-vars-DwleMuU3.js";
...
import { r as noteIncludeConfinementWarning } from "./doctor-config-analysis-CiHr9ksG.js";
import { t as findDoctorLegacyConfigIssues } from "./legacy-config-issues-CzkcqBbh.js";
import { t as migrateLegacyConfig } from "./legacy-config-migrate-vYtlP2_M.js";
...
const loadInstalledPluginIndexStore = createLazyRuntimeModule(() => import("./installed-plugin-index-store-C8ijDPTS.js"));
...
async function planStartupPluginVerification(params) {
	const { planStartupPluginConvergence } = await measureDoctorConfigPreflightStep("plugin-plan-import", () => import("./startup-plugin-convergence-plan-DqZE-7n4.js"), params.measure);
...
async function runStartupUpgradeConvergence(params) {
	...
	const { runPostCorePluginConvergence } = await measureDoctorConfigPreflightStep("plugin-convergence-import", () => import("./post-core-plugin-convergence-D6LfkX_f.js"), params.measure);
...
async function refreshStartupPluginQuarantine(params) {
	...
	const { runActivePluginPayloadSmokeCheck } = await measureDoctorConfigPreflightStep("plugin-payload-verification-import", () => import("./active-plugin-payload-validation-F9eoIuYI.js"), params.measure);
...
const loadDoctorStateMigrations = createLazyRuntimeModule(() => import("./doctor-state-migrations-s_dghjDj.js"));
const loadLegacyCronRepair = createLazyRuntimeModule(() => import("./legacy-repair-CNHyQhcP.js"));
...
async function runDoctorConfigPreflight(options = {}) {
	...
	const migrationCheckpoint = gatewayStartupCheckpointRequired || options.requireStateMigrationCheckpoint === true ? await measurePreflightStep("startup-checkpoint-import", () => import("./startup-migration-checkpoint-Q_im2_IC.js")) : void 0;
	let stateMigrations;
	...
	try {
		if (migrationCheckpoint && !skipPristineStartupStateMigrations) {
			const { planPristineStartupStateMigrations } = await measurePreflightStep("pristine-state-plan-import", () => import("./pristine-startup-state-DESn_rkn.js"));
