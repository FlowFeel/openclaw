...
import { _ as uniqueStrings, h as normalizeUniqueTrimmedStringList } from "./string-normalization-CRyoFBPt.js";
import { r as defaultRuntime } from "./runtime-DOr96aVu.js";
import { f as resolveDefaultAgentId } from "./agent-scope-config-Dusa8eSA.js";
import { i as isCronSessionKey, r as isCronRunSessionKey } from "./session-key-utils-02xWdGSz.js";
...
import { N as sanitizeAgentRunTerminalReplyText } from "./openclaw-state-db-D9eH245j.js";
import { n as INTERNAL_RUNTIME_CONTEXT_END, s as escapeInternalRuntimeContextDelimiters, t as INTERNAL_RUNTIME_CONTEXT_BEGIN } from "./internal-runtime-context-s8_TwHnQ.js";
import { r as getLoadedChannelPluginForRead } from "./registry-loaded-DSocaiGy.js";
import "./config-BBVHtcXg.js";
import "./call-B_qeDbXh.js";
...
import { a as mergeDeliveryContext, n as deliveryContextFromSession, s as normalizeDeliveryContext, u as sessionDeliveryChannel } from "./delivery-context.shared-DR6KpKlV.js";
...
import { L as completionRequiresMessageToolDelivery } from "./task-registry-Bs8cA6Tm.js";
import { i as stripTargetTopicSuffix, n as stripTargetKindPrefix, r as stripTargetProviderPrefix } from "./channel-target-prefix-VFVVF5j7.js";
import { i as resolveConversationIdFromTargets } from "./conversation-binding-context-wqCfEwJw.js";
...
import { _ as queueEmbeddedAgentMessageWithOutcomeAsync, a as formatEmbeddedAgentQueueFailureSummary, m as isEmbeddedRunAbandoned, u as isEmbeddedAgentRunActive } from "./runs-Bdk5tY9J.js";
import "./sessions-BqBqRT1f.js";
import { d as shouldPreserveUserFacingSessionStateForInputProvenance, o as isAgentMediatedCompletionSourceTool } from "./input-provenance-CYGbY89H.js";
import { o as sanitizePendingFinalDeliveryText } from "./pending-final-delivery-DL2bB7Gi.js";
import { i as hasVisibleAgentPayload, r as hasIntentionalSilentAgentPayload } from "./message-visibility-Cv_6nt4F.js";
import { c as getSubagentDepthFromSessionStore } from "./subagent-capabilities-D5Uipe-C.js";
import { r as hasGeneratedMediaCompletionEvent, t as resolveRequesterStoreKey } from "./subagent-requester-store-key-B70nPXG0.js";
import { S as sourceDeliveryTargetsMatch, a as getAgentCommandDeliveryFailure, c as hasCommittedOutboundDeliveryEvidence, g as hasUnaccountedMessagingToolAggregateEvidence, h as hasPayloadOutcomeSendEvidence, l as hasCommittedSourceReplyDeliveryEvidence, o as getGatewayAgentResult, p as hasMessagingToolDeliveryEvidence, y as resolveExplicitFinalSourceReplyDeliveryEvidence } from "./delivery-evidence-B4xUQS62.js";
import { r as dispatchGatewayMethodInProcess } from "./server-plugins-I6ua_jgC.js";
import { n as wrapPromptDataBlock, t as sanitizeForPromptLiteral } from "./sanitize-for-prompt-Drdy09dw.js";
import { u as enqueueClaimedSessionDelivery, v as releaseSessionDeliveryClaim } from "./session-delivery-queue-COwVOsBb.js";
import { i as isOutboundDeliveryError } from "./deliver-types-BGUCRKo2.js";
import { s as scheduleSessionDelivery, t as admitCorrelatedSubagentSessionDelivery } from "./subagent-completion-delivery-BMQur0_a.js";
...
import { i as routeToDeliveryFields, r as routeFromConversationRef } from "./route-projection-Cv8ipUUx.js";
...
const defaultSubagentAnnounceDeliveryDeps = {
	...
	loadSessionEntry: loadSqliteSessionEntryReadOnly,
...
async function resolveActiveWakeWithRetries(sessionId, message, wakeOptions, signal, isSourceSessionEffectsAllowed) {
	...
	const attemptWake = (options) => isSourceSessionEffectsAllowed?.() === false ? SOURCE_OWNER_CHANGED : resolveQueueEmbeddedAgentMessageOutcome(sessionId, message, options);
...
async function deliverCompletionDirect(params) {
	...
	const agentId = resolveAgentIdFromSessionKey(params.requesterSessionKey, resolveDefaultAgentId(params.cfg));
...
async function sendSubagentAnnounceDirectly(params) {
	...
	try {
		...
		if (params.expectsCompletionMessage && params.isCompletionOwnedByRequesterYield?.()) return {
			delivered: false,
			path: "none",
		...
		if (params.expectsCompletionMessage && requesterActivity.sessionId && requesterActivity.isActive) {
			...
			const wakeOutcome = await resolveActiveWakeWithRetries(requesterActivity.sessionId, params.triggerMessage, wakeOptions, params.signal, params.isSourceSessionEffectsAllowed);
			if (wakeOutcome === SOURCE_OWNER_CHANGED) return sourceOwnerChangedResult();
		...
		if (params.expectsCompletionMessage && isCronRunSessionKey(canonicalRequesterSessionKey) && !resolveRequesterSessionActivity(canonicalRequesterSessionKey).isActive && !agentMediatedCompletion) return {
			delivered: true,
			path: "none"
		};
		if (params.signal?.aborted) return {
		...
		if (params.expectsCompletionMessage && shouldDeliverAgentFinal && isSubagentCompletion && !hasVisibleGatewayPayload && !hasMessagingToolDelivery) {
			const textDelivery = await tryTextCompletionDirectDelivery();
			if (textDelivery) return textDelivery;
		...
		if (params.expectsCompletionMessage && requiresMessageToolDelivery && !hasMessagingToolDelivery && (!hasIntentionalSilentCompletionReply || subagentDirectMessageCompletionRequiresMessageTool)) {
			if (hasFailedSubagentNoOutputCompletion(params.internalEvents)) return {
				delivered: false,
				path: "direct",
				reason: "visible_reply_missing",
...
//#endregion
export { resolveSubagentAnnounceTimeoutMs as a, resolveSubagentCompletionOrigin as c, formatGeneratedMediaDeliveryRetryForPrompt as d, formatGeneratedAttachmentLines as f, loadSessionEntryByKey as i, formatAgentInternalEventsForPlainPrompt as l, sanitizeGeneratedMediaDisplayText as m, isInternalAnnounceRequesterSession as n, runAnnounceDeliveryWithRetry as o, mediaUrlsFromGeneratedAttachments as p, loadRequesterSessionEntry as r, resolveAnnounceOrigin as s, deliverSubagentAnnouncement as t, formatAgentInternalEventsForPrompt as u };
