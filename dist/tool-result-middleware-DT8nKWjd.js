...
import { r as isDeliveredMessagingToolResult, t as hasMessagingDeliveryReceipt } from "./embedded-agent-message-tool-source-reply-x3_0ZuNB.js";
...
function createAgentToolResultMiddlewareRunner(ctx, handlers) {
	...
	const resolvedHandlersLoader = createLazyPromiseLoader(async () => {
		const { loadAgentToolResultMiddlewaresForRuntime } = await import("./agent-tool-result-middleware-loader-KPSsraxY.js");
