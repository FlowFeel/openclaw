...
import { h as parseConfiguredModelVisibilityEntries, i as buildConfiguredModelCatalog } from "./model-selection-shared-BDTPW9Jk.js";
...
async function loadCatalogForBrowse(params) {
	...
	if (requiresFullDiscovery && !shouldTimeoutFullDiscovery) return await params.loadCatalog({ readOnly: false });
	let timeout;
