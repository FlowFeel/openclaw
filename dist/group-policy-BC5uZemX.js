...
function resolveChannelGroupToolsPolicy(params) {
	...
	const defaultConfig = groups?.["*"];
	const groupSenderPolicy = params.senderPolicyMode === "never" ? void 0 : resolveToolsBySender({
	...
	const defaultSenderPolicy = params.senderPolicyMode === "never" ? void 0 : resolveToolsBySender({
