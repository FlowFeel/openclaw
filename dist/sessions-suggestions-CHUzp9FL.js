...
import { Bn as validateSessionSuggestionsAddParams, Hn as validateSessionSuggestionsResolveParams, Un as validateSessionTypingParams, Vn as validateSessionSuggestionsListParams } from "./src-BSn6va4B.js";
import { a as errorShape } from "./error-codes-P4fBo0lR.js";
import { a as listSessionSuggestions, i as finalizeSessionSuggestionClaim, n as addSessionSuggestion, o as releaseSessionSuggestionDispatch, r as claimSessionSuggestionDispatch, t as SESSION_SUGGESTION_DISPATCH_CLAIM_TTL_MS } from "./sessions-CBo4LOdS.js";
import { a as isSessionWorkStartInvalidatedError, s as resolveSessionWorkStartError } from "./lifecycle-CeMojaXs.js";
import { i as updateTypingConnections, r as liveViewerIdentities, t as broadcastTypingThrottled } from "./session-typing-state-CJxhp501.js";
import { t as assertValidParams } from "./validation-DyQ6nhKI.js";
import { t as handleChatSend } from "./chat-send-handler-KvKqvUS4.js";
import { a as authorizeSessionSharingTarget, h as resolveSessionVisibility, m as resolveSessionSharingTarget, p as resolveSessionSharingRole, r as authorizeIncognitoSessionTarget, s as canManageSessionSharing, v as gatewayClientSessionCreator } from "./session-sharing-C3cQJ56a.js";
import { t as appendSessionAudit } from "./session-audit-B8ROFYMH.js";
...
function resolutionAuditAction(resolution) {
	switch (resolution) {
		case "send": return "sent a suggestion immediately";
		case "queue": return "queued a suggestion";
		case "edit": return "moved a suggestion into the composer";
		case "dismiss": return "dismissed a suggestion";
	}
	throw new Error(`unsupported suggestion resolution: ${String(resolution)}`);
}
function actorIdentity(client) {
	return gatewayClientSessionCreator(client) ?? {
		type: "system",
		id: "operator.admin",
		label: "Administrator"
	};
...
const sessionSuggestionHandlers = {
	"session.suggestions.add": ({ params, respond, client, context }) => {
		...
		if (!target) return;
		if (requireVisibleSuggestionRole({
			client,
			sessionKey: params.sessionKey,
			target,
			respond
