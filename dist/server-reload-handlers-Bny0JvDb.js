...
import { l as clearLoadInstalledPluginIndexInstallRecordsCache, n as loadInstalledPluginIndexInstallRecords, r as loadInstalledPluginIndexInstallRecordsSync } from "./installed-plugin-index-record-reader-COVyHO2A.js";
...
import { C as setRuntimeConfigAppliedHash, c as getRuntimeConfigSourceSnapshot, o as getRuntimeConfigSnapshotMetadata, u as hashRuntimeConfigValue, y as resolveConfigWriteFollowUp } from "./runtime-snapshot-DLOCFXOE.js";
...
import { i as getActiveGatewayRootWorkCount, m as runWithGatewayIndependentRootWorkAdmission, p as runOutsideGatewayRootWorkAdmission } from "./gateway-work-admission-D_DdbtmL.js";
import { f as setGatewaySigusr1RestartPolicy, l as resolveGatewayRestartDeferralTimeoutMs, r as deferGatewayRestartUntilIdle } from "./restart-Btxr3FFZ.js";
...
import { l as refreshPreparedModelRuntimeSnapshots, o as markPreparedModelRuntimeSnapshotsStale, u as rejectPendingPreparedModelRuntimeReplacement } from "./prepared-model-runtime-BoxOFkXM.js";
import { r as clearCurrentProviderAuthState } from "./model-provider-auth-state-DW_JYm-o.js";
import { i as warmCurrentProviderAuthStateOffMainThread } from "./model-provider-auth--zFKdDbJ.js";
import { d as getActiveEmbeddedRunCount } from "./run-state-D3E5NYGs.js";
import { a as refreshContextWindowCache } from "./context-CuDuj0gh.js";
...
import { c as getTotalQueueSize } from "./command-queue-BbrEP4i9.js";
import { n as getInspectableActiveTaskRestartBlockers } from "./task-registry.maintenance-CYPljZ2A.js";
...
import { r as resetDirectoryCache } from "./target-resolver-Dmfs1wnc.js";
import { t as commitHooksConfigReload, y as resolveHooksConfig } from "./hooks-CL8DwVPZ.js";
import { b as setSecretsRuntimeSourceSnapshotIfCurrent, c as getActiveSecretsRuntimeSnapshotRevision, f as hasActiveSecretsRuntimeSnapshotLineage, h as hasSameSecretReloadContract, r as clearSecretsRuntimeSnapshot, s as getActiveSecretsRuntimeSnapshot, v as restoreSecretsRuntimeSourceSnapshotIfLineageCurrent } from "./runtime-state-CdeDRMxT.js";
import { t as buildGatewayCronService } from "./server-cron-BFNFDDS6.js";
...
import { i as startGatewayCronWithLogging } from "./server-runtime-services-BSX3v6v8.js";
import { t as startGatewayChannelHealthMonitor } from "./server-runtime-startup-services-CBEA8_iu.js";
import { t as invalidateConfigGetResponseCache } from "./config-get-response-Bj_U3TD9.js";
import { n as diffGatewayReloadPaths, t as diffConfigPaths } from "./config-diff-BMZsFOL1.js";
import { i as listPluginInstallWholeRecordPaths, n as isNoopGatewayReloadPlan, r as listPluginInstallTimestampMetadataPaths, t as buildGatewayReloadPlan } from "./config-reload-plan-_MQI2IDT.js";
...
import { r as publishRuntimeSecretsStateTransition } from "./server-startup-config-BhPTU93d.js";
		...
		if (plan.restartGmailWatcher) {
			...
			try {
				...
				if (!restartAbortController.signal.aborted) {
					const [{ stopGmailWatcher }, { startGmailWatcherWithLogs }] = await Promise.all([import("./gmail-watcher-CxvgeP6g.js"), import("./gmail-watcher-lifecycle-BvSiLESb.js")]);
...
async function restoreSecretsRuntimeSnapshotIfCurrent(snapshot, expectedRevision, ownedSnapshot, options) {
	if (!(await import("./runtime-C8iuPxtH.js")).restoreSecretsRuntimeSnapshotIfCurrent(snapshot, expectedRevision, ownedSnapshot, { runtimeSourceConfig: options?.runtimeSourceConfig })) return false;
	options?.onActivated?.();
	return true;
}
