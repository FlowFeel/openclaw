...
import { i as resolveCliBackendConfig, o as resolveCliRuntimeCanonicalProvider } from "./cli-backends-CEDdjYXx.js";
...
import { n as prepareSimpleCompletionModel } from "./simple-completion-runtime-DHa5sPdN.js";
...
async function resolveHarness(runtime) {
	if (runtime === "openclaw") {
		const { createOpenClawAgentHarness } = await import("./builtin-openclaw-Ddg89HeE.js");
