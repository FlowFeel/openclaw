...
import { f as resolveDefaultAgentId, i as listAgentIds, l as resolveAgentEntry, o as resolveAgentConfig, p as resolveMutableAgentEntry, u as resolveAgentWorkspaceDir } from "./agent-scope-config-Dusa8eSA.js";
...
function resolveRunModelFallbacksOverride(params) {
	...
	const agentId = explicitAgentId ? normalizeAgentId(explicitAgentId) : parseAgentSessionKey(params.sessionKey)?.agentId ?? (listAgentIds(params.cfg).length > 0 ? resolveDefaultAgentId(params.cfg) : void 0);
...
//#endregion
export { resolveEffectiveAgentSkillsLimits as C, hasSessionAutoModelFallbackProvenance as D, hasSessionActiveAutoModelFallback as E, resolveSessionModelOverrideRouteResolution as O, resolveEffectiveAgentSkillFilter as S, normalizeSkillFilter as T, resolveSessionAgentIds as _, markAutoFallbackPrimaryProbe as a, setAgentEffectiveModelPrimary as b, resolveAgentExplicitModelPrimary as c, resolveAgentModelFallbacksOverride as d, resolveAgentSkillsFilter as f, resolveSessionAgentId as g, resolveRunModelFallbacksOverride as h, hasLegacyAutoFallbackWithoutOrigin as i, resolveAgentIdByWorkspacePath as l, resolveEffectiveModelFallbacks as m, entryMatchesAutoFallbackPrimaryProbe as n, resolveAgentEffectiveModelPrimary as o, resolveAutoFallbackPrimaryProbe as p, hasConfiguredModelFallbacks as r, resolveAgentExecutionContract as s, clearAutoFallbackPrimaryProbeSelection as t, resolveAgentIdsByWorkspacePath as u, resolveSubagentModelConfigSelectionResult as v, matchesSkillFilter as w, isSessionSkillEnabled as x, resolveSubagentModelFallbacksOverride as y };
