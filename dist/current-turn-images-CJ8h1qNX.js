...
import { t as getLoadedChannelPluginById } from "./registry-loaded-DSocaiGy.js";
...
import { i as MAX_CONTEXT_JSON_STRING_CHARS, o as formatContextJsonBlock, s as neutralizeMarkdownFences } from "./provider-utils-DQdO9BDc.js";
import { a as normalizeAttachments, n as isImageAttachment } from "./attachments.normalize-qZn2-M5R.js";
import { n as formatEnvelopeTimestamp } from "./envelope-DYPQHVWk.js";
import { t as stripExtractedFileImageMetadata } from "./extracted-file-images-CdmNdoIK.js";
import { n as resolveAgentTurnAttachments } from "./agent-turn-attachments-vUEkb1VJ.js";
...
function buildInboundUserContextPrefix(ctx, envelope, sessionEntry) {
	...
	else if (replyToBody && !chatWindowCoversReplyContext && !currentMessageContext) blocks.push(formatContextJsonBlock(markInboundContextLabel("Reply target of current user message:"), {
...
//#endregion
export { buildInboundUserContextPrefix as a, resolveInboundUserContextPromptJoiner as c, buildInboundMetaSystemPrompt as i, resolveActiveRunQueueAction as l, createTypingSignaler as n, formatActiveGoalContext as o, resolveTypingMode as r, refreshActiveGoalContext as s, resolveCurrentTurnImages as t };
