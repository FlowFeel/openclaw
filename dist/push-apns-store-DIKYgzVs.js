...
import { i as loadOrCreateProcessDeviceIdentity, s as signDevicePayload } from "./device-identity-P-Q23TDZ.js";
import { F as nextApnsRegistrationVersion, j as loadPairedDevicePairingStoreRecordFromDatabase } from "./device-bootstrap-D36P889E.js";
import { b as resolveNodePairingGeneration } from "./device-pairing-pwb3Oe75.js";
...
async function registerApnsRegistration(params) {
	...
	return runOpenClawStateWriteTransaction(({ db }) => {
		if (params.expectedPairingGeneration) {
			if (resolveNodePairingGeneration(loadPairedDevicePairingStoreRecordFromDatabase(db, nodeId))?.key !== params.expectedPairingGeneration) throw new ApnsRegistrationPairingChangedError();
		}
...
//#endregion
export { sendApnsRelayPush as _, isLikelyApnsToken as a, loadApnsRegistration as c, normalizeApnsNodeId as d, normalizeApnsToken as f, resolveApnsRelayConfigFromEnv as g, registerApnsRegistration as h, clearApnsRegistrationIfCurrent as i, loadApnsRegistrations as l, normalizeCanonicalApnsRegistration as m, apnsRegistrationFromRow as n, isValidApnsNodeId as o, normalizeApnsTopic as p, apnsRegistrationToRow as r, isValidApnsTopic as s, ApnsRegistrationPairingChangedError as t, normalizeApnsEnvironment as u };
