import { r as buildOpenAIQuicksilverSession, s as createOpenAIQuicksilverCall } from "./realtime-quicksilver-wire-CV3PtOvs.js";
...
var OpenAIQuicksilverGatewayBridge = class {
	...
	sendAudio(audio) {
		...
		else if (!this.closed && !this.abortController.signal.aborted) this.pendingAudio = appendOpenAIQuicksilverPendingAudio(this.pendingAudio, audio);
	}
