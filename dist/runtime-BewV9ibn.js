...
import { i as getChildLogger, s as isFileLogLevelEnabled } from "./logger-CEPY5_jR.js";
...
import { c as resolveThinkingProfile } from "./thinking-CLPqbAwx.js";
import { C as resolveModelRefFromString, a as buildModelAliasIndex, i as buildConfiguredModelCatalog } from "./model-selection-shared-BDTPW9Jk.js";
...
import { i as shouldLogVerbose } from "./globals-DHQUG86L.js";
import { r as replaceConfigFile, t as mutateConfigFile } from "./mutate-j69oSRi2.js";
...
import { G as rollbackSqlitePluginOwnedSessionEntryLifecycle, H as deleteSqliteSessionEntryLifecycle, W as rollbackSqliteAgentHarnessSessionEntryLifecycle, ct as loadSqliteSessionEntryReadOnly, lt as patchSqliteSessionEntry, nt as listSqliteSessionEntriesReadOnly, pt as replaceSqliteSessionEntry } from "./session-accessor.sqlite-B9iW7DOt.js";
import { W as normalizeResolvedMaintenanceConfigInput, bt as isSessionWorkAdmissionActive, ut as beginSessionWorkAdmission, xt as runExclusiveSessionLifecycleMutation } from "./session-entry-slot-keys-DR5d2mKt.js";
import { r as onSessionTranscriptUpdate } from "./transcript-events-BG9Ai61T.js";
import { $ as listSessionEntries$1, K as updateSessionEntry } from "./session-accessor-t3qUoTeV.js";
...
import { J as failFlow, O as listTasksForFlowId, W as createManagedTaskFlow, X as finishFlow, at as setFlowWaiting, it as resumeFlow, nt as requestFlowCancel } from "./task-registry-C6MCtVnT.js";
import "./runtime-internal-CRNvpCAc.js";
import { _ as findLatestTaskFlowForOwner, b as resolveTaskFlowForLookupTokenForOwner, d as getFlowTaskSummary, m as runTaskInFlowForOwner, r as cancelFlowByIdForOwner, t as cancelDetachedTaskRunById, v as getTaskFlowByIdForOwner, y as listTaskFlowsForOwner } from "./task-executor-_l80YOGk.js";
...
import { a as resolveEffectiveAgentRuntime, t as concretizeAgentRuntime } from "./thinking-runtime-1FRCPyWR.js";
import { a as resolveInheritedToolPolicyForSession, o as resolveSubagentToolPolicyForSession, r as resolveEffectiveToolPolicy } from "./agent-tools.policy-Bw6_eMDn.js";
import { z as normalizeExecTarget } from "./exec-approvals-DpQk_nvk.js";
import { n as loadWebMedia } from "./web-media-GPm5irud.js";
import { c as listRuntimeMusicGenerationProviders, s as generateMusic } from "./openclaw-tools-CoDz4vSH.js";
import { a as getTaskByIdForOwner, o as listTasksForRelatedSessionKeyForOwner, r as findLatestTaskForRelatedSessionKeyForOwner, s as resolveTaskForLookupTokenForOwner } from "./task-owner-access-BAXOqENW.js";
import { o as resolveEffectiveSessionToolsVisibility } from "./session-visibility-uYeEbYS1.js";
import { n as listRuntimeImageGenerationProviders, t as generateImage } from "./runtime-CSSpWEKP.js";
...
import { i as listWebSearchProviders, o as runWebSearch } from "./runtime-B9u5Z5Ps.js";
import { t as resolveEmbeddedCliBackendDispatchEligibility } from "./cli-backend-dispatch-eligibility-Bl2Skaux.js";
import { t as RequestScopedSubagentRuntimeError } from "./error-runtime-Nqb-RQG4.js";
import { t as createRuntimeChannel } from "./runtime-channel-CUYV7jO9.js";
...
async function createSessionEntry(params) {
	const [{ createGatewaySession }, { resolveGatewaySessionStoreTarget }, { readAcpSessionMetaForEntry, upsertAcpSessionMeta }] = await Promise.all([
		import("./session-create-service-BB3w1h97.js"),
		import("./session-utils-CQWeY-cX.js"),
		import("./session-meta-jq2cl29z.js")
	]);
...
const runHeartbeatOnceInternal = createLazyRuntimeMethod(createLazyRuntimeModule(() => import("./heartbeat-runner-BHcNyl9z.js")), (runtime) => runtime.runHeartbeatOnce);
...
const loadTtsRequestRuntime = createLazyRuntimeModule(() => import("./runtime-tts-request-CDj0Okgh.js"));
const loadMediaUnderstandingRuntime = createLazyRuntimeModule(() => import("./runtime-CPEAClG1.js"));
const loadModelAuthRuntime = createLazyRuntimeModule(() => import("./runtime-model-auth.runtime.js"));
const loadGatewayPluginRuntime = createLazyRuntimeModule(() => import("./server-plugins-C5KnkXFw.js"));
...
function createRuntimeLlmFacade() {
	const loadAcquireLocalService = createLazyRuntimeMethod(() => import("./provider-local-service-RGFeIypZ.js"), (runtime) => runtime.createConfiguredProviderLocalServiceAcquirer(getRuntimeConfig));
...
function createRuntimeWorktrees() {
	const loadService = () => import("./service-BKr2mJcS.js");
	return {
		async resolveCheckoutRoot(params) {
			const { findGitCheckoutRoot } = await import("./git-M20rT7ZZ.js");
			return findGitCheckoutRoot(params.path) ?? void 0;
		},
		async hasSelfContainedCheckoutMetadata(params) {
			const { hasSelfContainedGitMetadata } = await import("./git-M20rT7ZZ.js");
...
function createRuntimeSandbox(agent) {
	...
	return {
		...
		async prepareWorkspaceAuthority(params) {
			...
			const { resolveSandboxContext } = await import("./context-e5XlFrJE.js");
