...
import { n as resolveRootPath } from "./root-path-B97MrUcQ.js";
...
import { o as resolveAgentConfig, r as listAgentEntriesWithSource } from "./agent-scope-config-Dusa8eSA.js";
...
import { l as secretRefKey } from "./ref-contract-BVYOI0KD.js";
import { c as isPlainCommandExitFailure, s as spawnCommand } from "./exec-Bcu-_3pW.js";
import "./path-alias-guards-8uj3r-Aa.js";
import { n as loadActivatedBundledPluginPublicSurfaceModuleSync } from "./facade-runtime-aiGYP9iC.js";
import { n as SecretSurfaceUnavailableError } from "./runtime-degraded-state-V0p9ck6P.js";
import { x as SANDBOX_COMMAND_MAX_BUFFER_BYTES } from "./constants-Bx1otCol.js";
import { i as resolveSandboxConfigForAgent } from "./config-Cp0gVUpH.js";
import { t as buildDockerExecArgs } from "./bash-tools.shared-0H8_zJuj.js";
...
import { n as runtimeSandboxSecretOwnerId, t as assertRuntimeSandboxSecretOwnerAvailable } from "./runtime-sandbox-secret-owner-BPooRXEY.js";
import { a as isExistingWorkspaceSkillMountSource, o as resolveMaterializedSandboxSkillsWorkspaceDir } from "./workspace-mounts-CCr3SGIJ.js";
import { A as execContainerRaw, D as DOCKER_SANDBOX_ENGINE, E as validateSandboxContainerEngineTarget, O as PODMAN_SANDBOX_ENGINE, T as resolvePodmanSandboxRuntimeInfo, k as execContainer, n as containerState, o as ensureSandboxContainer, w as bindPodmanSandboxEngine } from "./docker-BEBl8MGb.js";
import { t as hashTextSha256 } from "./hash-DZK-8tRm.js";
import { n as sanitizeEnvVars } from "./sanitize-env-vars-CFjdcS_D.js";
import { n as resolveSandboxAgentId } from "./shared-Ckksfird.js";
import { t as parseSshTarget } from "./ssh-tunnel-ohPVg6Lx.js";
...
function assertSshConfigLineValue(value, field) {
	if (value && /[\r\n]/.test(value)) throw new Error(`SSH sandbox ${field} must not contain line breaks.`);
}
...
//#endregion
export { buildPinnedMkdirpPlan as A, parseSandboxStatMtimeMs as C, resolveWritableRenameTargetsForBridge as D, resolveWritableRenameTargets as E, runDockerSandboxShellCommand as F, buildPinnedRenamePlan as M, buildPinnedWritePlan as N, buildPinnedCopyPlan as O, dockerSandboxBackendManager as P, createRemoteShellSandboxFsBridge as S, createWritableRenameTargetResolver as T, disposeSshSandboxSession as _, getSandboxBackendFactory as a, uploadDirectoryToSshTarget as b, registerSandboxBackend as c, buildRemoteCommand as d, buildRemoteWorkdirValidationCommand as f, createSshSandboxSessionFromSettings as g, createSshSandboxSessionFromConfigText as h, startBrowserBridgeServer as i, buildPinnedRemovePlan as j, buildPinnedCreatePlan as k, requireSandboxBackendFactory as l, buildValidatedExecRemoteCommand as m, stopCachedBrowserBridge as n, getSandboxBackendManager as o, buildSshSandboxArgv as p, stopCachedBrowserBridgesForContainer as r, getSandboxBackendWorkdirResolver as s, BROWSER_BRIDGES as t, buildExecRemoteCommand as u, runSshSandboxCommand as v, parseSandboxStatSize as w, assertSshSandboxSecretOwnerAvailable as x, shellEscape as y };
