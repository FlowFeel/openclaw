...
import { t as runDoctorConfigPreflight } from "./doctor-config-preflight-DLUjPkVE.js";
...
async function loadAndMaybeMigrateDoctorConfig(params) {
	...
	if (shouldRepair) {
		const { runDoctorRepairSequence } = await import("./repair-sequencing-C6cK6IUj.js");
		...
		const { collectDoctorPreviewNotes } = await import("./preview-warnings-B2VNtWKn.js");
