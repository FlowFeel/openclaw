...
import { c as isWithinDir, x as safeFileURLToPath } from "./path-D8zNGPJM.js";
import "./fs-safe-DVaClkIX.js";
import { n as openLocalFileSafely } from "./root-impl-DYBxk3hn.js";
import { i as openRootFileSync, n as matchRootFileOpenFailure } from "./root-file-dEMp_-h5.js";
import { c as resolveUserPath } from "./home-dir-Cs7bTrwJ.js";
import "./utils-Bs67j6-3.js";
import { n as readFileDescriptorBounded } from "./boundary-file-read-CPk48AYJ.js";
import { s as resolveRuntimeServiceVersion } from "./version-CeFj_iGk.js";
import { c as resolveAvatarMime, l as AVATAR_MAX_BYTES } from "./avatar-policy-BX3hGmH_.js";
...
import { r as AUTH_RATE_LIMIT_SCOPE_DEVICE_TOKEN, s as AUTH_RATE_LIMIT_SCOPE_SHARED_SECRET } from "./auth-rate-limit-D67GPKfj.js";
import { n as authorizeHttpGatewayConnect } from "./auth-B6R6zmCG.js";
import { n as authorizeOperatorScopesForMethod } from "./method-scopes-BPNMlnDQ.js";
...
import { c as kindFromMime, n as detectMime } from "./mime-Ir6g3Vae.js";
import "./local-file-access-8uj3r-Aa.js";
import { n as probePlaybackMediaFileDescriptor } from "./media-probe-BL-Ub3TA.js";
import { o as extractOriginalFilename } from "./store-QVlUiM0_.js";
import { o as resolveMediaReferenceLocalPath, s as resolveMediaReferenceLocalPathInfo } from "./media-reference-sxufFF1B.js";
import { n as getAgentScopedMediaLocalRoots } from "./local-roots-DY1lg2k6.js";
import { n as assertLocalMediaAllowed, r as getDefaultLocalRoots } from "./local-media-access-CfOl4jrn.js";
import { t as isTerminalConfigEnabled } from "./enabled-BSjeiWpO.js";
import { n as resolvePublicAgentAvatarSource } from "./identity-avatar-QelBHHiY.js";
import { d as verifyPairingToken } from "./device-bootstrap-DYEV7gvD.js";
import { D as verifyDeviceToken, d as listDevicePairing } from "./device-pairing-D3ZJFObN.js";
import { n as CONTROL_UI_BOOTSTRAP_CONFIG_PATH, t as CONTROL_UI_BASE_PATH_ATTRIBUTE, u as CONTROL_UI_TERMINAL_ENABLED_ATTRIBUTE } from "./control-ui-contract-ByeBOCHr.js";
import { _ as setControlUiPluginAuthCookieForRequest, c as getBearerToken, d as resolveHttpBrowserOriginPolicy, g as resolveTrustedHttpOperatorScopes } from "./http-auth-utils-3kt7C83x.js";
import { a as sendGatewayAuthFailure, n as buildMissingScopeForbiddenBody } from "./http-common-C1Esyf5_.js";
import { t as resolveSharedGatewaySessionGeneration } from "./ws-shared-generation-8sA0oUQm.js";
import "./http-utils-DPp_WsEW.js";
import { a as replacePlaybackFileExtension, i as buildAssistantMediaContentDisposition, n as resolveByteResponse, o as resolvePlaybackModeForSource, r as writeByteHeaders, s as resolvePlaybackTranscode, t as createGatewayByteStream } from "./http-byte-range-2_S3cvF5.js";
import { n as resolveAssistantIdentity, t as DEFAULT_ASSISTANT_IDENTITY } from "./assistant-identity-BeK0sXRO.js";
import { n as resolveGatewayAssistantAvatar, t as openGatewayAssistantAvatar } from "./assistant-avatar-CtTtEwP4.js";
import { a as respondNotFound, i as isReadHttpMethod, n as isControlUiApprovalDocumentPath, o as respondPlainText, t as classifyControlUiRequest } from "./control-ui-routing-ec4rBi_L.js";
...
async function authorizeControlUiReadRequest(req, res, opts) {
	...
	if (!resolvedAuthResult.ok && token && opts.auth.mode !== "trusted-proxy" && opts.auth.mode !== "none") {
		...
		if (deviceRateCheck && !deviceRateCheck.allowed) resolvedAuthResult = {
			...
			} else await opts.rateLimiter?.recordFailureAndDelay(clientIp, AUTH_RATE_LIMIT_SCOPE_DEVICE_TOKEN);
		}
	}
	...
	try {
		...
		try {
			...
			try {
				...
				const bytesRead = sniffBuffer ? (await opened.handle.read(sniffBuffer, 0, sniffLength, 0)).bytesRead : 0;
