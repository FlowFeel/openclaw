...
import { a as getUserProfileListItem, i as getProfileAvatar, r as formatUserProfileAvatarEtag, t as UserProfileNotFoundError } from "./user-profiles-DoQoc9os.js";
import { n as matchUserProfileAvatarPath } from "./user-profiles-http-path-CvR7l2ks.js";
import { h as resolveSharedSecretHttpOperatorScopes, o as authorizeScopedUserProfileAvatarHttpRequestOrReply } from "./http-auth-utils-3kt7C83x.js";
import { c as sendMethodNotAllowed, s as sendJson } from "./http-common-C1Esyf5_.js";
...
async function handleUserProfileAvatarHttpRequest(req, res, pathname, opts) {
	...
	if (!await authorizeScopedUserProfileAvatarHttpRequestOrReply({
		req,
		res,
		auth: opts.auth,
