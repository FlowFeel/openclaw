import { C as SessionConfig, T as SessionResetConfig } from "./types.base-BYV-OxM1.js";
import { c as SessionEntry, t as AmbientTranscriptWatermark } from "./types-CJ2AFyfH.js";
import { f as ResolvedSessionMaintenanceConfigInput } from "./sessions-DoIJmoFN.js";
...
declare function resolveStorePath$1(store?: string, opts?: {
  agentId?: string;
 ...
 */
declare function resolveAmbientTranscriptWatermarkLegacyKey(scope: AmbientTranscriptWatermarkScope): string;
declare function updateAmbientTranscriptWatermark(params: {
  storePath: string;
  sessionKey: string;
  key: string; /** Alternative key to consult for the current value (pre-SL-14 migration). */
  legacyKey?: string;
  messageId: string;
  timestampMs?: number;
...
type ReadAmbientTranscriptWatermarkParams = SessionStoreReadParams & {
  key: string; /** Pre-SL-14 legacy JSON-composite key to fall back to for migration. */
  legacyKey?: string;
};
...
//#endregion
export { resolveAmbientTranscriptWatermarkLegacyKey as A, resolveStorePath$1 as B, clearSessionStoreCacheForTest as C, sqliteSessionFileMarkerMatchesSession as D, parseSqliteSessionFileMarker as E, SessionResetMode as F, evaluateSessionFreshness as I, resolveSessionResetPolicy as L, resolveChannelResetConfig as M, resolveSessionResetType as N, AmbientTranscriptWatermarkScope as O, resolveThreadFlag as P, SessionStoreAgentIdRequiredError as R, isValidAgentHarnessSessionStoreEntry as S, formatSqliteSessionFileMarker as T, resolveStorePath as _, deleteSessionEntry as a, updateSessionStoreEntry as b, loadSessionStore as c, readAmbientTranscriptWatermark as d, readSessionUpdatedAt as f, resolveSessionStoreEntry as g, resolveSessionStoreBackupPaths as h, cleanupSessionLifecycleArtifacts as i, updateAmbientTranscriptWatermark as j, resolveAmbientTranscriptWatermarkKey as k, loadTranscriptEventsSync as l, resolveSessionFilePath as m, SessionStoreTranscriptEvent as n, getSessionEntry as o, readTranscriptStatsSync as p, UpdateSessionStoreOptions as r, listSessionEntries as s, LoadSessionStoreOptions as t, patchSessionEntry as u, resolveTranscriptSessionKeyBySessionId as v, SqliteSessionFileMarker as w, upsertSessionEntry as x, updateSessionStore as y, resolveSessionTranscriptsDirForAgent as z };