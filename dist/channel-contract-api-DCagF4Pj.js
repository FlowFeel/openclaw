...
import { n as loadBundledPluginPublicArtifactModuleSync } from "./public-surface-loader-BqQMmTc2.js";
...
function listChannelSecretContractRecords(params) {
	const workspaceDir = listAgentEntries(params.config).length > 0 ? resolveAgentWorkspaceDir(params.config, resolveDefaultAgentId(params.config), params.env) : void 0;
