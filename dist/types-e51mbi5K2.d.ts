import { n as resolveChannelGroupRequireMention, r as ChannelId$2, t as resolveChannelGroupPolicy } from "./group-policy-D7MCPoN2.js";
import { $o as SecretRef, A as ModelProviderConfig, C as ModelApi, Ds as SilentReplyConversationType, E as ModelDefinitionConfig, Gi as SafeBinProfileFixture, Mi as ToolLoopDetectionConfig, O as ModelMediaInputConfig, Po as AgentModelConfig, Pt as TalkProviderConfig, T as ModelCompatConfig, Yo as SecretInput, _o as ReplyToMode, _s as SilentReplyPromptMode, ca as MentionPatternsPolicyConfig, co as DmScope, do as IdentityConfig, ei as ResolvedTtsPersona, gs as PromptMode, i as OpenClawConfig, k as ModelProviderAuthMode, mo as MarkdownTableMode$1, ni as TtsConfig, qn as ChannelImplicitMentionsConfig, ri as TtsMode, ro as ContextVisibilityMode, si as TtsProvider, t as ConfigFileSnapshot, ti as TtsAutoMode, uo as HumanDelayConfig, va as MemoryCitationsMode, vs as ChatType, wo as SessionScope } from "./types.openclaw-3lPuYQv-.js";
import { t as FastMode } from "./string-coerce-DJnd-JG-.js";
import { a as Context, c as Model, d as SimpleStreamOptions, f as StreamFn, g as Usage, i as AssistantMessageEventStreamContract, n as Api, o as ImageContent, r as AssistantMessage } from "./types-CwI9hEPH.js";
import { Ct as SessionsCompanionAskResult, F as SessionObserverDigest, jt as SessionsCompanionStateResult } from "./session-icon-B3YyxIx2.js";
import { n as SourceInfo, r as CronScheduledToolPolicy } from "./skill-contract-CGA9eqw_.js";
import { _ as ChannelRouteRef, a as SessionContextBudgetStatus, c as SessionScope$1, d as SessionCreatedActor, f as SessionCreatedVia, g as DeliveryContext, h as SourceReplyDeliveryMode, l as SessionSystemPromptReport, n as GroupKeyResolution, o as SessionEntry, p as HookExternalContentSource, s as SessionPluginJsonValue, t as CliSessionBinding, u as SessionToolOverrides } from "./types-Dt3tB0SE.js";
import { A as ExecTarget, C as PluginApprovalRequest, D as ExecAsk, E as ExecApprovalRequestPayload$1, F as ChannelThreadingToolContext, I as ConversationReadInvocationOrigin, M as ChannelAccountSnapshot, N as ChannelMessageActionAdapter, O as ExecMode, T as ExecApprovalDecision, _ as OutboundPayloadDeliveryOutcome, a as ChannelDeliveryCapabilities, b as RenderedMessageBatchPlanItem, c as OutboundDeliveryFormattingOptions, d as chunkMarkdownTextWithMode, f as chunkText, g as OutboundDeliveryResult, h as resolveTextChunkLimit, i as ChannelPairingAdapter, k as ExecSecurity, l as chunkByNewline, m as resolveChunkMode, n as WizardPrompter, o as ChannelOutboundAdapter, p as chunkTextWithMode, r as OperatorScope, s as OutboundIdentity, t as ChannelPlugin$1, u as chunkMarkdownText, v as OutboundPayloadDeliverySuppressionReason, w as PluginApprovalRequestPayload, x as OutboundSendDeps, y as MessageReceipt } from "./types.public-DXXzw640.js";
import { c as ToolExecutionMode, i as AgentToolUpdateCallback, n as AgentTool, r as AgentToolResult, s as StreamFn$1, t as AgentMessage } from "./types-ifNunyTs.js";
import { t as CompactionResult } from "./index-BkRwx6TK.js";
import { A as InboundEventKind, C as LegacyMediaContextKey, D as MediaUnderstandingOutput, E as MediaUnderstandingDecision, F as MessagePresentation, M as ReplyMediaAttachment, N as ReplyPayload, O as MediaUnderstandingProvider, P as LegacyInteractiveReply, R as ModelPickerAction, S as PluginHookChannelContext, T as PromptImageOrderEntry, _ as AgentPlanStep, a as MsgContext, b as CommandTurnContext, c as SupplementalContextFacts, d as GetReplyOptions, f as PartialReplyPayload, g as UserTurnTranscriptRecorder, h as TypingController, i as MentionSource, k as StructuredExtractionInput, m as TurnAdoptionLifecycle, n as FinalizedRuntimeMsgContext, p as TaskSuggestionDeliveryMode, r as InboundSourceModality, s as SessionTranscriptContext, t as FinalizedMsgContext, u as BlockReplyContext, v as HistoryEntry, w as MediaFact, x as CommandTurnKind, y as HistoryMediaEntry, z as ReplyPayloadDelivery } from "./templating-CXWZ_qCV.js";
import { s as mediaKindFromMime } from "./constants-Bjeg8sLB.js";
import { a as OAuthCredential$1, i as AuthProfileStore, n as AuthProfileCredential, t as ApiKeyCredential$1 } from "./types-D67e2Gtu.js";
...
import { C as PluginKind, D as UnifiedModelCatalogEntry, O as UnifiedModelCatalogKind, T as JsonSchemaObject, _ as PluginManifestDashboard, a as PluginDependencyStatus, b as PluginManifestMcpServer, f as PluginBundleFormat, g as PluginManifestContracts, h as PluginFormat, k as RuntimeEnv, m as PluginDiagnostic, o as PluginOrigin$1, p as PluginConfigUiHint, t as PluginManifestRecord, v as PluginManifestDashboardActionVerb, y as PluginManifestDashboardDataBinding } from "./manifest-registry-Dd29F7Rx.js";
import { Cx as SessionCatalogHost, Dw as RequestFrame, Jx as SessionsCatalogReadParams, Ns as WizardStep$1, Px as SessionsCatalogArchiveParams, Rx as SessionsCatalogContinueParams, Xx as SessionsCatalogReadResult, _s as WizardAnswer, ap as NodeSkillDescriptor, bh as WorkerEnvironmentState, gw as ConnectParams, iE as ApprovalPresentation, jE as SessionApprovalReplay, mg as SystemAgentChatQuestion, qf as NodePluginToolDescriptor, vw as ErrorShape } from "./index-k69zEGQI.js";
import { n as detectMime } from "./mime-Df2rY-9g.js";
import { i as RetryOptions } from "./index-sjwwl2uh.js";
import { t as AnyAgentTool } from "./common-CSwFw_Qd.js";
import { r as McpToolCatalog } from "./agent-bundle-mcp-types-BE146MUJ.js";
import { a as PluginCompatCode } from "./installed-plugin-index-types-COVojO1x.js";
import { i as PluginMetadataSnapshotOwnerMaps, n as PluginMetadataRegistryView, r as PluginMetadataSnapshot } from "./plugin-metadata-snapshot.types-C2GH8pkR.js";
import { G as ConfigReplaceResult, I as resolveStateDir, kt as ConfigWriteAfterWrite, nt as ConfigMutationBase } from "./config-d6m_KxcO.js";
import { _ as runCommandWithTimeout, a as PinnedDispatcherPolicy, d as SessionManager, f as resolveStorePath, i as LookupFn, l as SessionTranscriptDeliveryMirror, n as getImageMetadata, o as SsrFPolicy, p as SessionTranscriptRuntimeTarget, r as resizeToJpeg, t as loadWebMedia, u as ReadonlySessionManager, v as SpawnResult, x as ResolvedSessionMaintenanceConfigInput, y as CliDeps } from "./web-media-D8La7BDA.js";
import { C as ReplyDispatchBeforeDeliverOptions, D as ReplyFollowupAdmissionBarrierTimeoutPolicy, E as ReplyDispatcher, S as ReplyDispatchBeforeDeliver, T as ReplyDispatchRuntimeInfo, _ as PluginConversationBindingRequestParams, b as PluginHookBeforeToolCallResult, c as PluginSubagentRequesterContext, d as PluginHookReplyPayloadSendingContext, f as PluginHookToolContext, g as PluginConversationBinding, h as PluginJsonValue, l as PluginHookBeforeToolCallEvent, m as PluginToolMatcher, p as PluginHookToolRequesterContext, s as HookEntry, u as PluginHookRegistration$1, v as PluginConversationBindingRequestResult, w as ReplyDispatchKind, x as DiagnosticTraceContext, y as PluginConversationBindingResolvedEvent$1 } from "./hook-runner-global-CQ-mAvAM.js";
import { a as SkillTelemetrySource, i as SkillSnapshot, n as ScheduledToolPolicyContext, o as SkillUsagePath, r as SkillCommandSpec, s as RuntimePluginToolGrant, t as TrustedSubagentCompletionHandoff } from "./subagent-announce-handoff-CJ6c5ZQi.js";
import { t as OpenClawStateDatabaseOptions } from "./openclaw-state-db-contract-CNMm03J4.js";
import { c as ModelCatalogSnapshot, n as ProviderModelRouteRuntimePolicy, o as ResolvedProviderAuth, r as ProviderRouteOverridePresence, s as ModelCatalogEntry, t as ProviderModelRouteAuthRequirement } from "./provider-model-types-BbGdZNB-.js";
import { t as InternalHookHandler } from "./internal-hook-types-C9tKU4UB.js";
import { r as PluginActivationSource } from "./config-state-DrzFBlH7.js";
...
type ChannelChoice = ChannelId$2;
...
type RunCliAgentParams = {
  ...
  isolatedCompletion?: true; /** Persist the successful CLI assistant reply into the OpenClaw session transcript. */
  persistAssistantTranscript?: boolean; /** Session store path used when assistant transcript persistence is enabled. */
  storePath?: string; /** Canonical user-turn recorder shared with gateway/queue dispatch. */
  userTurnTranscriptRecorder?: UserTurnTranscriptRecorder; /** Skip current-turn user persistence when a retry/fallback already wrote it. */
  ...
  runId: string; /** Immutable lifecycle ownership captured when this execution was admitted. */
  lifecycleGeneration?: string;
  lane?: string;
  jobId?: string;
...
type HandleCommandsParams = {
  ...
  sessionEntry?: SessionEntry; /** Snapshot captured before command handlers mutate the active entry. */
  initialSessionEntry?: SessionEntry; /** True only when the current command owns first creation of this session row. */
...
//#endregion
export { getMemoryCapabilityRegistration as $, PluginRuntime as A, MemoryFlushPlan as B, ProviderAuthResult as C, rotateAgentEventLifecycleGeneration as Ct, PluginRegistryParams as D, EmbeddedAgentRunResult as Dt, PluginRegistry as E, QueuedChatTurnMap as Et, RunCliAgentParams as F, MemoryPluginRuntime as G, MemoryPluginCapability as H, ToolDefinition as I, PreparedMemoryPromptSection as J, MemoryPromptSectionBuilder as K, resolveCliBackendLiveSessionRequirement as L, DispatchReplyWithDispatcher as M, CommandContext as N, McpServerConnectionResolved as O, CommandHandler as P, getActivePreparedMemoryPromptSection as Q, MemoryCorpusSearchResult as R, provider_runtime_d_exports as S, ChatRunState as St, PreparedProviderStaticCatalog as T, ChannelChoice as Tt, MemoryPluginPublicArtifact as U, MemoryFlushPlanResolver as V, MemoryPluginPublicArtifactsProvider as W, buildMemoryPromptSection as X, RegisteredMemorySearchManager as Y, clearMemoryPluginState as Z, WebFetchProviderToolDefinition as _, TaskStatus as _t, WorkerProfile as a, listMemoryPromptSupplements as at, RunEmbeddedAgentParams as b, RestartRecoveryCandidate as bt, WorkerSshIdentity as c, registerMemoryCorpusSupplement as ct, HookContext as d, resolveMemoryCapabilityRegistration as dt, getMemoryRuntime as et, DiagnosticMemoryPressureEvent as f, resolveMemoryFlushPlan as ft, PluginWebFetchProviderEntry as g, TaskRecord as gt, OpenClawPluginToolContext as h, DetachedTaskTerminalState as ht, PluginCommandResult as i, listMemoryPromptPreparations as it, DispatchReplyWithBufferedBlockDispatcher$1 as j, CreatePluginRuntimeOptions as k, PluginLogger as l, registerMemoryPromptPreparation as lt, ContextEngine as m, setStandaloneMemoryManagerActive as mt, OpenClawPluginCommandDefinition as n, listActiveMemoryPublicArtifacts as nt, WorkerProvider as o, prepareMemoryPromptSection as ot, DiagnosticMemoryUsage as p, runWithPreparedMemoryPromptSection as pt, MemoryPromptSectionParams as q, PluginCommandContext as r, listMemoryCorpusSupplements as rt, WorkerSshEndpoint as s, registerMemoryCapability as st, ProviderPlugin as t, hasMemoryRuntime as tt, AgentHarnessAuthBindingFingerprintParams as u, registerMemoryPromptSupplement as ut, RuntimeWebFetchMetadata as v, GatewayRequestHandler as vt, loadManifestModelCatalog as w, SystemAgentOperation as wt, AgentHarnessRuntimeArtifactBinding as x, ChatRunEntry as xt, CurrentInboundPromptContext as y, ChatAbortControllerEntry as yt, MemoryCorpusSupplement as z };