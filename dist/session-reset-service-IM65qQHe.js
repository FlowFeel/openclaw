...
import { Ct as buildSessionCreationStamp, H as deleteSqliteSessionEntryLifecycle, U as resetSqliteSessionEntryLifecycle, wt as sessionEntryForkedFromParent } from "./session-accessor.sqlite-CtCo5VZ6.js";
import { t as formatSqliteSessionFileMarker } from "./legacy-sqlite-marker-COPKCuIN.js";
import { _t as interruptSessionWorkAdmissions, gt as hasOnlySessionLifecycleMutationKindActive, lt as SESSION_WORK_ADMISSION_DRAIN_TIMEOUT_MS, w as resolveMissingAgentHarnessSessionError, xt as runExclusiveSessionLifecycleMutation, yt as isSessionLifecycleMutationActive } from "./session-entry-slot-keys-DPRQmSpa.js";
import { a as errorShape } from "./error-codes-P4fBo0lR.js";
import { t as getAcpSessionManager } from "./manager-BxJ_8HLx.js";
import { a as handleSessionStateSessionDeleted, o as handleSessionStateSessionReset, u as recordSessionCreated } from "./session-state-events-COmXZrBv.js";
import { t as getSessionBindingService } from "./session-binding-service-DfYoR_Na.js";
import { t as getAcpRuntimeBackend } from "./registry-lioUSmxH.js";
import { c as writeAcpSessionMetaForMigration, r as readAcpSessionMeta, s as upsertAcpSessionMeta } from "./session-meta-jzIthKMh.js";
...
import { r as archiveSessionTranscriptsDetailed, s as resolveStableSessionEndTranscript } from "./session-transcript-files.fs-CvO34bUG.js";
import { n as resolveSessionModelRef } from "./session-model-ref-D_2SCgSv.js";
import { S as loadSessionEntry, k as resolveGatewaySessionStoreTarget } from "./session-utils-row-Br8x7LNG.js";
import "./session-utils-P5pxtsqu.js";
import { n as clearBootstrapSnapshotOnSessionBoundary, t as clearBootstrapSnapshot } from "./bootstrap-cache-Yis-5ymR.js";
...
import { r as stopSubagentsForRequester } from "./abort-BEhupjiU.js";
...
import { n as hasSessionAutoResetListeners, r as isSessionAutoResetReason, t as emitSessionAutoResetHook } from "./session-auto-reset-C9aI3svj.js";
import { n as runPluginHostCleanup } from "./host-hook-cleanup-iu4ScwL6.js";
...
async function ensureSessionRuntimeCleanup(params) {
	const [embeddedAgent, mcpTools, { clearFinishedSessionsForScopes }] = await Promise.all([
		import("./embedded-agent-CZpATf5T.js"),
		import("./agent-bundle-mcp-tools-CcV3eLnB.js"),
