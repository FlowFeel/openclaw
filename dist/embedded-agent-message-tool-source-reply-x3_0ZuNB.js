...
import { i as isMessagingToolDeliveryAction, n as isMessageToolSendActionName, t as isMessageToolConversationCreateActionName } from "./embedded-agent-messaging-Bc7tsqQd.js";
...
function isDeliveredMessageToolOnlySourceReplyResult(params) {
	...
	const hasConfirmedExplicitSourceRoute = params.allowExplicitSourceRoute === true || confirmedCurrentSourceRoute;
	if (hasExplicitMessageRoute(args) && !hasConfirmedExplicitSourceRoute) return false;
	return isDeliveredMessagingToolResult(params);
}
//#endregion
export { readMessageToolSourceReplyText as i, isDeliveredMessageToolOnlySourceReplyResult as n, isDeliveredMessagingToolResult as r, hasMessagingDeliveryReceipt as t };
