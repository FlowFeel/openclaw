...
import { c as resolveContextConfigProviderForRuntime, u as resolveOpenAIRuntimeProvider } from "./openai-routing-Db2edxk0.js";
...
import { a as measureDiagnosticsTimelineSpan } from "./diagnostics-timeline-BxwfDTJ-.js";
import "./defaults-CdX9UGcX.js";
import "./thinking-CTxMHCzD.js";
import { C as resolveModelRefFromString } from "./model-selection-shared-V7VmYFPH.js";
import { s as parseNonNegativeByteSize } from "./zod-schema-9ObLtj6p.js";
import { i as legacyModelKey } from "./model-ref-shared-BEKlpylb.js";
import { r as logVerbose } from "./globals-Cw62Mq_M.js";
import "./config-BBVHtcXg.js";
import { t as GatewayDrainingError } from "./gateway-work-admission-BaRJo64l.js";
import { t as normalizeChatType } from "./chat-type-BARlA53h.js";
import { i as resetRegisteredAgentHarnessSessions } from "./registry-DkL0MuB5.js";
...
import { s as normalizeDeliveryContext, u as sessionDeliveryChannel } from "./delivery-context.shared-DR6KpKlV.js";
import { o as isAudioFileName } from "./mime-Ir6g3Vae.js";
import { l as resolveStorePath } from "./paths-DSnYpBD3.js";
import { M as hasNonzeroUsage, P as normalizeUsage, ct as loadSqliteSessionEntryReadOnly, j as deriveSessionTotalTokens, k as deriveContextPromptTokens, lt as patchSqliteSessionEntry, o as appendSqliteTranscriptMessage, st as loadSqliteSessionEntry, yt as resolveSessionStorePathForScope } from "./session-accessor.sqlite-CtCo5VZ6.js";
import { o as resolveMessageChannel } from "./message-channel-normalize-Cs-kjMZm.js";
import { a as isInternalMessageChannel, o as isMarkdownCapableMessageChannel } from "./message-channel-Bo27VP7K.js";
import { a as resolveGroupSessionKey } from "./store-entry-shape-CTwpu-C_.js";
import { S as selectSessionTranscriptLeafControlledPath } from "./session-transcript-index-NEbbnqMc.js";
import { $ as parseSessionThreadInfoFast, A as resolveFreshSessionTotalTokens, M as resolveSessionPluginTraceLines, a as hasRestartRecoverySourceClaim, j as resolveSessionPluginStatusLines } from "./session-entry-slot-keys-DPRQmSpa.js";
import { K as updateSessionEntry, N as persistSessionResetLifecycle, c as readRecentSessionTranscriptActiveEvents, d as readSessionTranscriptActiveStats } from "./session-accessor-D5Or7WgI.js";
import { o as isIngressAdoptionLostError } from "./ingress-drain-DYX3uP7I.js";
import "./backoff-CCtTkmwj.js";
import { i as formatRawAssistantErrorForUi } from "./assistant-error-format-Dw1scAnL.js";
import { i as resolveCliBackendConfig } from "./cli-backends-CEDdjYXx.js";
import { i as isCliRuntimeAliasForProvider, s as resolveCliRuntimeExecutionProvider, t as areRuntimeModelRefsEquivalent } from "./model-runtime-aliases-D1mCKu2G.js";
import { u as estimateMessagesTokens } from "./compaction-planning-CK7RJNHD.js";
...
import { b as isTransientHttpError, h as isCompactionFailureError } from "./errors-Bujrccyt.js";
import { i as resolveSandboxConfigForAgent } from "./config-2sq8RTeT.js";
...
import { c as isFailoverError, f as resolveFailoverReasonFromError } from "./failover-error-DBKQENP4.js";
...
import { d as resolveAgentRunErrorLifecycleFields, i as AGENT_RUN_RESTART_ABORT_STOP_REASON, l as isAgentRunRestartAbortReason, o as createAgentRunRestartAbortError, u as resolveAgentRunAbortLifecycleFields } from "./run-termination-CczpQCyZ.js";
import { c as resolveFastModeForElapsed, n as formatFastModeAutoProgressText } from "./fast-mode-BORk623r.js";
import { a as resolveSourceReplyVisibilityPolicy } from "./source-reply-delivery-mode-Dp5l5GTP.js";
...
import { S as markReplyOperationGlobalLaneWaitProgress, j as runAfterReplyOperationClear, w as replyRunRegistry } from "./reply-run-registry-CFY_Ts2Y.js";
import { f as logSessionTurnCreated } from "./diagnostic-CdMjo2Fb.js";
import { c as resolveCronJobsStorePath, n as loadCronJobsStore } from "./store-BwY4XtES.js";
import { _ as queueEmbeddedAgentMessageWithOutcomeAsync, a as formatEmbeddedAgentQueueFailureSummary } from "./runs-Bdk5tY9J.js";
import { t as formatTokenCount } from "./token-format-D942KbWN.js";
import { v as resolveSessionGoalDisplayState } from "./sessions-BqBqRT1f.js";
import { c as readSessionMessagesAsync, r as readLatestSessionUsageFromTranscriptAsync } from "./session-transcript-readers-O8pyQfzE.js";
import { n as resolveSessionModelRef } from "./session-model-ref-D_2SCgSv.js";
import { i as resolveModelCostConfig, n as formatUsd, t as estimateUsageCost } from "./usage-format--pf0zzCz.js";
import { n as resolvePersistedSessionRuntimeId, r as resolveSessionRuntimeOverrideForProvider } from "./session-runtime-compat-CL7J1PGP.js";
import { a as resolveEffectiveAgentRuntime, i as resolveCandidateThinkingLevel } from "./thinking-runtime-Ct74CGZn.js";
import { o as resolveContextTokensForModel } from "./context-Bq_6Vo-L.js";
import { t as resolveFastModeState } from "./fast-mode-DRb2pnqM.js";
import { d as completeFollowupRunLifecycle, f as isFollowupRunAborted, h as resolveFollowupAbortSignal, l as FollowupRunDeferredError, s as refreshQueuedFollowupSession, u as admitFollowupRunLifecycle } from "./state-B9dZmpvI.js";
...
import { d as mergeReactionDirectiveChannelData, f as parseReplyDirectives } from "./payloads-6G4VluOK.js";
import { a as resolveReplyThreadingPayloads, i as isRenderablePayload, n as applyReplyThreading, t as applyReplyTagsToPayload } from "./reply-payloads-BZyXXDXi.js";
import { n as createReplyToModeFilterForChannel, o as resolveReplyToMode, t as createReplyDeliveryContext } from "./reply-threading-2qXVyLek.js";
import "./embedded-agent-helpers-dlCGQLQ2.js";
import { y as readPostCompactionContext } from "./builtin-openclaw-0050ajkS.js";
import { a as resolveMessagingToolPayloadDedupe, n as filterMessagingToolMediaDuplicates, t as filterMessagingToolDuplicates } from "./reply-payloads-dedupe-B4sXvswH.js";
...
import { i as normalizePendingFinalDeliveryPayloads, n as buildPendingFinalDeliveryText, o as sanitizePendingFinalDeliveryText, r as buildRecoverablePendingFinalDeliveryText } from "./pending-final-delivery-DL2bB7Gi.js";
import { i as transitionMainSessionRecovery } from "./main-session-recovery-state-BKrDbsUq.js";
import { d as isTrustedMessageActionTurnIngress, f as mintMessageActionTurnCapability, h as revokeMessageActionTurnCapability, m as resolveMessageActionTurnCapabilityLifetime } from "./code-mode-control-tools-Bts-Jy9S.js";
import { n as resolveSendPolicy } from "./send-policy-B6JlTwra.js";
import { t as CommandLaneClearedError } from "./command-queue-DxY-0HMA.js";
import { g as leaseMcpAppModelContextForTurn, s as peekSessionMcpRuntime } from "./agent-bundle-mcp-manager-api-D2GddaSc.js";
import "./agent-bundle-mcp-runtime-C1c78bIy.js";
import { i as getMcpAppViewLease } from "./mcp-ui-resource-CHdOzPZi.js";
import { _ as resolveMemoryFlushPlan } from "./memory-state-D_cMOwNA.js";
import { I as formatToolAggregate, h as normalizeAgentPlanSteps } from "./streaming-Df3LUUGR.js";
import { _ as hasVisibleCommittedMessagingToolDeliveryEvidence, d as hasCompletedSourceReplyDeliveryEvidence, f as hasCompletedTerminalDeliveryEvidence, l as hasCommittedSourceReplyDeliveryEvidence, v as hasVisibleOutboundDeliveryEvidence } from "./delivery-evidence-B4xUQS62.js";
import { a as isMessagingToolSendAction } from "./embedded-agent-messaging-Bc7tsqQd.js";
import { d as extractToolResultText } from "./embedded-agent-subscribe.tools-agHp_6fR.js";
import { u as inferToolMetaFromArgs } from "./embedded-agent-utils-Brq3aP9h.js";
import { s as resolveBootstrapWarningSignaturesSeen } from "./bootstrap-budget-U6QVxuxs.js";
import { n as clearBootstrapSnapshotOnSessionBoundary } from "./bootstrap-cache-Yis-5ymR.js";
...
import { n as routeReply, t as isRoutableChannel } from "./route-reply-D4inBfdd.js";
import { s as scheduleFollowupDrain } from "./cleanup-CYBjc1T_.js";
import { n as enqueueFollowupRun, t as resolveQueueSettings } from "./queue-BZLakrew.js";
import { l as buildReplyUsageState, u as recordReplyUsageState } from "./deliver-prepare-BY6KbNM2.js";
...
import { c as shouldClearFailedCliSessionBinding, n as clearCliSession, o as setCliSessionBinding, s as setCliSessionId, t as clearAllCliSessions } from "./cli-session-C2qHGe2r.js";
import { a as createAgentPatchedSessionModelFallback } from "./session-model-patch-origin-ClIOVw7R.js";
...
import "./settled-turn-finalization-result-BmhJQmHW.js";
import "./sandbox-C8V7Nism.js";
import { a as isBenignCompactionSkipResult } from "./compact-reasons-BdRFPqua.js";
import { t as runEmbeddedAgent } from "./embedded-agent-Cr03LQ3-.js";
import { i as withBeforeAgentReplyObserver, n as buildHandledBeforeAgentReplyPayloads, r as runBeforeAgentReplyForTurn } from "./payloads-ECValbU0.js";
import { r as buildControlUiAgentFailureText } from "./agent-runner-failure-copy-BY7A6uy5.js";
import { n as hasDeliberateSilentTerminalReply } from "./result-fallback-classifier-C2AZaw2h.js";
import { t as buildAgentRuntimeDeliveryPlan } from "./build-BykyiSkJ.js";
import { r as consolidateLiveModelSwitchAfterRun } from "./tool-media-payloads-lamEIh5q.js";
import { i as withLocalSessionPlacementTurnAdmission } from "./session-placement-admission-BEJd445g.js";
import { n as readChannelSourceTurnId, t as buildChannelSourceTurnId } from "./source-turn-id-raOki4r6.js";
...
import { r as enqueueCommitmentExtraction } from "./runtime-jcvdUS_k.js";
import { n as resolveEffectiveBlockStreamingConfig } from "./block-streaming-BhQhhRSe.js";
import { t as REPLY_RUN_STILL_SHUTTING_DOWN_TEXT } from "./get-reply-run-queue-BpRZxGwG.js";
import { l as resolveActiveRunQueueAction, n as createTypingSignaler, s as refreshActiveGoalContext, t as resolveCurrentTurnImages } from "./current-turn-images-CJ8h1qNX.js";
import { t as runEmbeddedAgentEntry } from "./run-entry-Pa0zrXj8.js";
import { n as runCliAgent } from "./cli-runner-DOgDZQjY.js";
import { t as createReplyMediaContext } from "./reply-media-paths.runtime-BmW_0g-d.js";
...
import { t as createMcpAppStandaloneTicket } from "./mcp-app-standalone-CZ2C0CFm.js";
...
const embeddedAgentRuntimeLoader = createLazyImportLoader(() => import("./embedded-agent-CZpATf5T.js"));
