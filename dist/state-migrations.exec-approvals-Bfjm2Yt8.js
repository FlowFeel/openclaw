...
import { i as resetLegacyDeviceAuthPresenceCache } from "./device-auth-store-C0rVjVQr.js";
import { d as readStoredDeviceIdentityReadOnly, f as repairInvalidStoredDeviceIdentity, h as acquireDeviceIdentityCoordinator, l as DeviceIdentityStorageError, m as validateStoredDeviceIdentity, p as resolveDeviceIdentityStore, u as generateStoredDeviceIdentity } from "./device-identity-P-Q23TDZ.js";
...
import { c as resolveExecApprovalsPath, d as tryParsePersistedExecApprovals } from "./exec-approvals-config-DrfE-I9X.js";
import { a as readExecApprovalsConfigRow, c as writeExecApprovalsConfigRow, o as serializeExecApprovals } from "./exec-approvals-sqlite-Dw7Ztd0n.js";
import { i as recordLegacyMigrationReceipt, n as readLegacyMigrationReceipt, r as readLegacyMigrationReceiptFromDatabase, s as resolveLegacyMigrationSourceKey, t as markLegacyMigrationSourceRemoved } from "./state-migrations.receipts-BV0HPXiq.js";
...
function detectLegacyDeviceIdentity(params) {
	...
	return {
		...
		claimPath,
		nativeClaimPath,
		hasLegacy: doctorAuthorized && (pathMayExist(claimPath) || pathMayExist(nativeClaimPath) || pathMayExist(sourcePath)),
		hasInvalidCanonical
	};
}
...
async function cleanupReceiptSources(params) {
	...
	if (warnings.length === 0 && (!params.receipt.removedSource || removed > 0)) markLegacyMigrationSourceRemoved(params.receipt.sourceKey, params.env);
