...
import { m as initSubagentRegistry } from "./subagent-registry-DBvWqYln.js";
...
async function runGatewayStartupMaintenance(params) {
	...
	if (!params.minimalTestGateway || startupMaintenanceConfig.channels !== void 0) {
		...
		if (!params.minimalTestGateway) {
			const { runStartupSessionMigration } = await import("./server-startup-session-migration-Cy_6IGbL.js");
...
async function loadGatewayStartupPluginRuntime(params) {
	const { loadGatewayStartupPlugins } = await import("./server-plugin-bootstrap-yNP_9Ar9.js");
