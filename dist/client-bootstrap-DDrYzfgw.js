...
import { t as getActiveMatrixClient } from "./active-client-Em4bZMXV.js";
import { t as isBunRuntime } from "./runtime-BefyhPWv.js";
//#region extensions/matrix/src/matrix/client-bootstrap.ts
const loadMatrixSharedClientRuntimeDeps = createLazyRuntimeModule(() => Promise.all([import("./client-Dx4GzlGS.js"), import("./shared-hrtWzm_n.js")]).then(([clientModule, sharedModule]) => ({
