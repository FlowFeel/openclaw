...
const loadAgentsBindModule = createLazyRuntimeModule(() => import("./agents.commands.bind-DXOI-L-x.js"));
async function loadAgentsAddCommand() {
	return (await import("./agents.commands.add-DaIZfKhF.js")).agentsAddCommand;
}
...
async function loadAgentsDeleteCommand() {
	return (await import("./agents.commands.delete-DSFZfXO3.js")).agentsDeleteCommand;
}
async function loadAgentsSetIdentityCommand() {
	return (await import("./agents.commands.identity-Ba6FOItT.js")).agentsSetIdentityCommand;
}
async function loadAgentsListCommand() {
	return (await import("./agents.commands.list-B05oBxAT.js")).agentsListCommand;
}
async function loadAgentsActionRuntime() {
	const [{ defaultRuntime }, { runCommandWithRuntime }] = await Promise.all([import("./runtime-BpncsYKr.js"), import("./cli-utils-De1Y8OZt.js")]);
	return {
		defaultRuntime,
