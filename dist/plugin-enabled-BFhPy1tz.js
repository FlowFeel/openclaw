...
import { T as BrowserProfileUnavailableError } from "./tmp-openclaw-dir-DULFdmUv.js";
import "./config-Dl1LELdv.js";
import { d as markBrowserRuntimeStopping, r as beginProfileTransition, s as isBrowserRuntimeRunning } from "./server-context.lifecycle-DWK0oyzZ.js";
import { a as getExtensionRelayModule, t as createBrowserRouteContext } from "./server-context-U49yWU9w.js";
import { n as sweepTrackedBrowserTabs } from "./session-tab-registry-COLduo1q.js";
...
async function stopBrowserRuntimeInternal(params, finalizeGlobalAdapters) {
	...
	if (finalizeGlobalAdapters) try {
		const { disposeGatewayExtensionRelay } = await import("./gateway-relay-route-BEw2u2cR.js");
