...
import { t as startLazyPluginServiceModule } from "./plugin-runtime-DZdM-MKU.js";
...
import { a as resolveProfile, l as resolveExistingUploadPaths, r as resolveBrowserConfig } from "./config-Da5ffEih.js";
import { Y as withTimeout } from "./tmp-openclaw-dir-DQI4fBxj.js";
import "./errors-BWF2OQEQ.js";
import { N as parseBrowserNavigationUrl } from "./chrome-BQ4tX2WU.js";
import { t as getBrowserProfileCapabilities } from "./profile-capabilities-DqO0AgW7.js";
import "./sdk-setup-tools-DRxyA9La.js";
import { C as fetchBrowserJson, S as BrowserServiceError, _ as browserStatus, a as untrackSessionBrowserTab, d as browserImportProfile, f as browserOpenTab, g as browserStart, h as browserSnapshot, i as trackSessionBrowserTab, l as browserDoctor, o as browserCloseTab, p as browserProfiles, r as touchSessionBrowserTab, u as browserFocusTab, v as browserStop, x as browserTabs, y as browserSystemProfiles } from "./session-tab-registry-DzvuLxVk.js";
import { _ as isBrowserProxyUploadRequest, a as persistBrowserProxyFiles, b as parseBrowserProxyFailure, c as browserPdfSave, d as browserArmFileChooser, f as browserDownload, h as browserWaitForDownload, i as applyBrowserProxyPaths, l as browserAct, m as browserScreenshotAction, o as browserConsoleMessages, p as browserNavigate, s as browserPageContent, u as browserArmDialog, v as prepareBrowserProxyUploadRequest, y as BROWSER_PROXY_ERROR_ENVELOPE } from "./core-api-XY8zKrbN.js";
import { o as normalizeBrowserScreenshot, r as parseSystemProfileDomains } from "./routes-Bo5sbKnu.js";
import { a as describeBrowserScreenshot, c as stageBrowserScreenshotForSharing, n as executeExtractAction, o as neutralizeMediaDirectives, s as resolveRuntimeImageSanitization } from "./browser-extract-BXOLmrMN.js";
import { n as createBrowserControlContext } from "./plugin-enabled-Dz4t-PS_.js";
import { a as resolveRequestedBrowserProfile, n as isBrowserHostLocalRoute, r as isPersistentBrowserProfileMutation, t as createBrowserRouteDispatcher } from "./dispatcher-YJ7S2lZb.js";
...
function createBrowserPluginService() {
	...
	return {
		id: "browser-control",
		start: async () => {
			const pageShare = await import("./page-share-DojFdRew.js");
			...
			handle = await startLazyPluginServiceModule({
				...
				loadDefaultModule: async () => await import("./server-CoRfWjcT.js"),
		...
		stop: async () => {
			const { setPageShareSink } = await import("./page-share-DojFdRew.js");
			...
			const { stopBrowserControlService } = await import("./control-service-C-IgMl9U.js");
