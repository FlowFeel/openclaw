...
import { i as buildConfiguredModelCatalog } from "./model-selection-shared-V7VmYFPH.js";
...
import { J as applySessionPatchProjection } from "./session-accessor-D5Or7WgI.js";
import { F as EmbeddedPluginApprovalBroker, I as clearEmbeddedPluginApprovalBroker, L as setEmbeddedPluginApprovalBroker, z as setEmbeddedMode } from "./agent-tools.before-tool-call-uaLOAHZ3.js";
...
import { t as buildAllowedModelSet } from "./model-selection-CZlE_kEq.js";
import { i as buildAgentRunTerminalOutcomeFromLifecycleEvent, o as classifyAgentRunTerminalOutcome, t as AGENT_RUN_TERMINAL_RETRY_GRACE_MS } from "./agent-run-terminal-outcome-C9bgFmfC.js";
...
import { _ as queueEmbeddedAgentMessageWithOutcomeAsync } from "./runs-Bdk5tY9J.js";
...
import { C as loadSessionEntryReadOnly, S as loadSessionEntry, T as resolveCanonicalGatewaySessionStoreKey, j as getSessionDefaults, k as resolveGatewaySessionStoreTarget, x as listAgentsForGateway } from "./session-utils-row-Br8x7LNG.js";
import { r as ensureContextWindowCacheLoaded } from "./context-Bq_6Vo-L.js";
import { t as resolveQueueSettings } from "./settings-DAWZCttJ.js";
import { A as waitForQueueDebounce, D as previewQueueSummaryPrompt, S as buildCollectPrompt, b as applyQueueDropPolicy } from "./state-B9dZmpvI.js";
import { i as buildGatewaySessionInfo, r as listSessionsFromStoreAsync } from "./session-utils-list-Cf4VExhd.js";
...
import { u as resolveEffectiveChatHistoryMaxChars } from "./chat-display-projection-BiWlQzhw.js";
import { i as parseGoalCommand, t as executeSessionGoalCommand } from "./commands-goal-xCDJy0Gz.js";
...
import { c as performGatewaySessionReset } from "./session-reset-service-IM65qQHe.js";
...
import { t as loadGatewayModelCatalog } from "./server-model-catalog-Dm2KJA9o.js";
import { a as enforceChatHistoryFinalBudget, i as CHAT_HISTORY_MAX_SINGLE_MESSAGE_BYTES, n as enrichChatHistoryCompactionMarkers, o as replaceOversizedChatHistoryMessages, r as readChatHistoryPage } from "./chat-Bz6gypcV.js";
import { a as isAgentLifecycleYieldedWaiting } from "./session-lifecycle-state-B3C1oG12.js";
import { n as createGatewaySession } from "./session-create-service-46E63uaP.js";
import { n as projectSessionsPatchEntry } from "./sessions-patch-nAcfcf1t.js";
import { d as formatTuiErrorMessage, t as resolveLocalRunShutdownGraceMs } from "./local-run-shutdown-DwCidCNe.js";
...
var EmbeddedTuiBackend = class {
	...
	start() {
		...
		this.ready = (async () => {
			const { runSessionStartupMigration } = await import("./startup-migration-Dm1EMvhp.js");
	...
	async runBtwTurn(params) {
		...
		const { runBtwSideQuestion } = await import("./btw-mvDTUw-F.js");
