...
import { i as redactSecrets } from "./redact-BGqyyKN9.js";
...
import { r as TRAJECTORY_RUNTIME_EVENT_MAX_BYTES } from "./paths-BeLXoJjn.js";
...
import { t as appendSqliteTrajectoryRuntimeEvents } from "./runtime-store.sqlite-CSXefN-H.js";
...
function createSqliteTrajectoryRuntimeSink(params) {
	...
	const completeTargetKeyEntry = completeTarget && target?.agentId && target.sessionKey && target.storePath ? loadSqliteSessionEntry({
	...
	const targetKeyEntry = target?.sessionKey && legacyMarker && !completeTarget ? loadSqliteSessionEntry({
