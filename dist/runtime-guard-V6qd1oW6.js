...
function currentRuntimeProvidesNodeSqlite() {
	try {
...
function runtimeSatisfies(details) {
	...
	if (details.kind === "bun") return details.hasNodeSqlite;
	return false;
}
...
//#endregion
export { nodeVersionSatisfiesEngine as a, isSupportedNodeVersion as i, isAtLeast as n, parseSemver as o, isCurrentRuntimeSupported as r, assertSupportedRuntime as t };
