...
import { a as defineImportedCommandGroupSpec, i as buildCommandGroupEntries, o as defineImportedProgramCommandGroupSpecs } from "./register.subclis-core-DxDT2mrG.js";
...
const coreEntrySpecs = [
	...withProgramOnlySpecs(defineImportedProgramCommandGroupSpecs([
		{
			...
			loadModule: () => import("./register.setup-DfCFvCFq.js"),
			exportName: "registerSetupCommand"
		},
		{
			commandNames: ["onboard"],
			loadModule: () => import("./register.onboard-BGXjEG4X.js"),
		...
		},
		{
			...
			loadModule: () => import("./register.maintenance-DahlHwfy.js"),
	...
	defineImportedCommandGroupSpec(["agent"], () => import("./register.agent-turn-C7-7DwQ2.js"), (mod, { program, ctx }) => {
	...
	...withProgramOnlySpecs(defineImportedProgramCommandGroupSpecs([{
		...
		loadModule: () => import("./register.status-health-sessions-BWCPi3Iv.js"),
