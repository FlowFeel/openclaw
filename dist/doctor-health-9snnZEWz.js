...
async function doctorCommand(runtime, options = {}) {
	...
	const { createDoctorPrompter } = await import("./doctor-prompter-Bk8GUxAD.js");
	...
	const { maybeOfferUpdateBeforeDoctor } = await import("./doctor-update-DdnGwhHE.js");
	...
	const { maybeRepairUiProtocolFreshness } = await import("./doctor-ui-DPkhtPAz.js");
	...
	const { noteStartupOptimizationHints } = await import("./doctor-platform-notes-CSj0MTF4.js");
	await maybeRepairUiProtocolFreshness(effectiveRuntime, prompter);
	noteSourceInstallIssues(root);
	await noteStalePluginRuntimeSymlinks(root);
	noteStartupOptimizationHints();
	const { loadAndMaybeMigrateDoctorConfig } = await import("./doctor-config-flow-BYR3CjTw.js");
	...
	const { runDoctorHealthContributions } = await import("./doctor-health-contributions-D55robY3.js");
