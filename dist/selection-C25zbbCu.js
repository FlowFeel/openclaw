...
import { _ as MissingAgentHarnessError, b as recordAgentHarnessPreflightOwner } from "./failover-error-BSBBvfXF.js";
import { d as projectAgentRunAttemptTerminal, u as normalizeAgentRunAttemptTerminal } from "./agent-run-terminal-outcome-DXPF-TAc.js";
...
import { t as createOpenClawAgentHarness } from "./builtin-openclaw-voNo-gIX.js";
...
import { t as assertSettledTurnFinalizationResult } from "./settled-turn-finalization-result--gesCUtm.js";
...
async function runSelectedAgentHarnessAttempt(params) {
	...
	if (internalParams.systemAgentTool && !isSystemAgentOnlyAllowlist(internalParams.toolsAllow)) throw new Error("OpenClaw host authority requires toolsAllow: [\"openclaw\"]");
	const ringZeroTools = internalParams.systemAgentTool ? [(await import("./system-agent-tool-DAlXvWiF.js")).createSystemAgentTool(internalParams.systemAgentTool)] : [];
