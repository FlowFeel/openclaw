import { i as OpenClawConfig, n as ConfigValidationIssue, t as ConfigFileSnapshot } from "./types.openclaw-3lPuYQv-.js";
...
//#endregion
export { transformConfigFileWithRetry as $, resolveIncludeRoots as A, ConfigWriteFollowUp as At, ConfigMutationCommitParams as B, resolveConfigWriteFollowUp as Bt, resolveCanonicalConfigPath as C, BestEffortConfigSnapshot as Ct, resolveDeliveryQueueMediaDir as D, ConfigWriteResult as Dt, resolveDefaultConfigCandidates as E, ConfigWriteNotification as Et, resolveOAuthDir as F, getRuntimeConfigSnapshotMetadata as Ft, ConfigReplaceResult as G, setRuntimeConfigSnapshot as Gt, ConfigMutationContext as H, selectApplicableRuntimeConfig as Ht, resolveStateDir as I, getRuntimeConfigSourceSnapshot as It, TransformConfigFileWithRetryParams as J, ConfigTransformResult as K, setRuntimeConfigSnapshotRefreshHandler as Kt, NixModeConfigMutationError as L, hashRuntimeConfigValue as Lt, resolveLegacyStateDirs as M, clearRuntimeConfigSnapshot as Mt, resolveNativeServiceProfileConflict as N, getRuntimeConfigAppliedHash as Nt, resolveGatewayLockDir as O, ReadConfigFileSnapshotWithPluginMetadataResult as Ot, resolveNewStateDir as P, getRuntimeConfigSnapshot as Pt, transformConfigFile as Q, assertConfigWriteAllowedInCurrentMode as R, resetConfigRuntimeState as Rt, pinRuntimePaths as S, createConfigIO as St, resolveConfigPathCandidate as T, ConfigSnapshotReadOptions as Tt, ConfigMutationIO as U, setAppliedRuntimeConfigSnapshot as Ut, ConfigMutationCommitResult as V, resolveRuntimeConfigCacheKey as Vt, ConfigMutationResult as W, setRuntimeConfigAppliedHash as Wt, mutateConfigFileWithRetry as X, mutateConfigFile as Y, replaceConfigFile as Z, isDefaultInstallIdentity as _, recoverConfigFromLastKnownGood as _t, applyConfigOverrides as a, getRuntimeConfig as at, isNixMode as b, parseConfigJson5 as bt, resetConfigOverrides as c, readBestEffortConfig as ct, isPluginLocalInvalidConfigSnapshot as d, readConfigFileSnapshotForWrite as dt, withConfigMutationExclusive as et, isPluginPackagingRuntimeOutputInvalidConfigSnapshot as f, readConfigFileSnapshotWithPluginMetadata as ft, STATE_DIR as g, recoverConfigFromJsonRootSuffix as gt, DEFAULT_GATEWAY_PORT as h, readSourceConfigSnapshotForWrite as ht, validateConfigObjectRaw as i, clearConfigCache as it, resolveIsNixMode as j, RuntimeConfigSnapshotMetadata as jt, resolveGatewayPort as k, ConfigWriteAfterWrite as kt, setConfigOverride as l, readBestEffortConfigSnapshot as lt, CONFIG_PATH as m, readSourceConfigSnapshot as mt, validateConfigObjectWithPlugins as n, ConfigMutationBase as nt, captureConfigOverrideApplier as o, loadConfig as ot, shouldAttemptLastKnownGoodRecovery as p, readSourceConfigBestEffort as pt, TransformConfigFileParams as q, validateConfigObject as r, projectConfigOntoRuntimeSourceSnapshot as rt, getConfigOverrides as s, promoteConfigSnapshotToLastKnownGood as st, validateConfigObjectRawWithPlugins as t, ConfigMutationConflictError as tt, unsetConfigOverride as u, readConfigFileSnapshot as ut, isDefaultStateDir as v, registerConfigWriteListener as vt, resolveConfigPath as w, ConfigRuntimeRefreshError as wt, normalizeStateDirEnv as x, resolveConfigSnapshotHash as xt, isNamedProfile as y, writeConfigFile as yt, ConfigMutationCommit as z, resolveConfigWriteAfterWrite as zt };