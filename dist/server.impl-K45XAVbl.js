...
import { f as setGatewaySigusr1RestartPolicy, p as setPreRestartDeferralCheck } from "./restart-Btxr3FFZ.js";
...
import { r as installModelExecutionPort } from "./sessions-Digi7ATr.js";
import { a as enqueueSystemEvent } from "./system-events-fsxpbPNB.js";
import { C as stopDiagnosticHeartbeat, S as startDiagnosticHeartbeat } from "./diagnostic-DiTvyQCh.js";
import { l as resolveCronJobsStorePathFromConfig } from "./store-865CL89i.js";
import { d as getActiveEmbeddedRunCount, m as resolveActiveEmbeddedRunSessionId } from "./run-state-D3E5NYGs.js";
...
import { c as getTotalQueueSize, d as isGatewayDraining } from "./command-queue-BbrEP4i9.js";
...
import "./server-plugins-Dw5hvH9r.js";
import { i as getActiveSecretsRuntimeConfigSnapshot, r as clearSecretsRuntimeSnapshot } from "./runtime-state-CdeDRMxT.js";
import { t as clearSessionSuspensionTimers } from "./session-suspension-DUbfGECM.js";
import { t as isTerminalConfigEnabled } from "./enabled-BSjeiWpO.js";
import { a as terminateCompactionPlanningPool, o as TopicAffineWorkerPool, s as WorkerPoolError } from "./compaction-planning-worker-CitjIvjs.js";
import { t as installSessionPlacementAdmissionProvider } from "./session-placement-admission-BEJd445g.js";
import { n as applyGatewayLaneConcurrency, r as resolveGatewayLaneConcurrency, t as resolveHookClientIpConfig } from "./hook-client-ip-config-S2vEc-R5.js";
...
import { c as canReceiveSessionEvent } from "./session-sharing-CSGmZX63.js";
...
import { a as incrementPresenceVersion, i as getPresenceVersion, n as getHealthCache, o as refreshGatewayHealthSnapshot, r as getHealthVersion } from "./health-state-BUN2e4QL.js";
import { t as resolveGatewayPluginConfig } from "./runtime-plugin-config-CwjSnlUj.js";
import { t as createControlUiSessionPullRequestSubscriptions } from "./control-ui-session-pr-subscriptions-D8w6T1U2.js";
...
async function startGatewayCoreRuntime(input) {
	...
	const [{ startGatewayEventSubscriptions }, { startGatewayRuntimeServices }] = await startupTrace.measure("runtime.post-early-imports", () => Promise.all([import("./server-runtime-subscriptions-DQ-Dt77A.js"), import("./server-runtime-startup-services-CarEcSE8.js")]));
	...
	const { execApprovalManager, cancelRunBoundApprovals, forwardPluginApprovalRequest, pluginApprovalIosPushDelivery, pluginApprovalManager, systemAgentApprovalManager, extraHandlers, coreGatewayHandlers } = await startupTrace.measure("gateway.handlers", async () => {
		const [{ createGatewayAuxHandlers }, { coreGatewayHandlers: coreGatewayHandlersLocal }] = await Promise.all([import("./server-aux-handlers-CdXJjjKX.js"), import("./server-methods-Bn33NGIO.js")]);
		return {
...
function createLazyGatewayCronState(params) {
	...
	const cronStateLoader = createLazyPromiseLoader(() => import("./server-cron-C_AZsExi.js").then(({ buildGatewayCronService }) => {
		loaded = {
	...
	const createCloseHandler = () => async (optsValue) => {
		...
		await createGatewayCloseHandler({
			...
			markMainSessionsAbortedForRestart: async ({ sessionKeys, sessionIds, activeRuns, reason, isActiveRun }) => {
				...
				const { markRestartAbortedMainSessions } = await import("./main-session-restart-recovery-BESfitEw.js");
...
const getControlUiModule = createLazyRuntimeModule(() => import("./control-ui-DYRBnC36.js"));
...
const getEmbeddingsHttpModule = createLazyRuntimeModule(() => import("./embeddings-http-D7nv5M2C.js"));
const getManagedMediaAttachmentsModule = createLazyRuntimeModule(() => import("./managed-image-attachments-BIdch0nJ.js"));
const getMcpAppStandaloneModule = createLazyRuntimeModule(() => import("./mcp-app-standalone-CutsTLOy.js"));
const getPluginIconHttpModule = createLazyRuntimeModule(() => import("./plugin-icon-http-DnX0N126.js"));
const getModelsHttpModule = createLazyRuntimeModule(() => import("./models-http-DK1qbM35.js"));
const getOpenAiHttpModule = createLazyRuntimeModule(() => import("./openai-http-D8qgjJpf.js"));
const getOpenResponsesHttpModule = createLazyRuntimeModule(() => import("./openresponses-http-Bp6yhe8Q.js"));
const getSessionHistoryHttpModule = createLazyRuntimeModule(() => import("./sessions-history-http-BUfHAuRR.js"));
const getSessionKillHttpModule = createLazyRuntimeModule(() => import("./session-kill-http-CaNPffo6.js"));
const getToolsInvokeHttpModule = createLazyRuntimeModule(() => import("./tools-invoke-http---MvaiqD.js"));
const getUserProfilesHttpModule = createLazyRuntimeModule(() => import("./user-profiles-http-CgIyCSO2.js"));
	...
	const handleHooksRequest = async (req, res) => {
		...
		return await runWithGatewayHttpWorkAdmission(res, async () => {
			if (!loadedHooksRequestHandler) {
				const { createGatewayHooksRequestHandler } = await import("./hooks-C6EnfUUi.js");
...
async function prepareGatewayRuntimeState(params) {
	...
	const { runDefaultChannelSetupWizard, runDefaultSetupWizard } = await import("./wizard-BtFCxWIQ.js");
...
async function prepareGatewayServerBootstrap(input) {
	...
	const startupConfigModulePromise = import("./server-startup-config-C-nivQXg.js");
	const loadStartupPluginsModule = createLazyPromise(() => import("./server-startup-plugins-CKEzLaig.js"), { cacheRejections: true });
...
async function finishGatewayStartup(params) {
	...
	const sessionChangeSidecar = { stop: async () => {
		const { flushPendingSessionsChangedEvents } = await import("./session-change-event-D8zOKjfe.js");
	...
	const { createGatewayInstanceRuntime } = await import("./server-instance-runtime-oDAURKmQ.js");
	...
	const [{ attachGatewayWsHandlers }, { listPluginNodeCapabilities }] = await startupTrace.measure("gateway.ws-imports", () => Promise.all([import("./server-ws-runtime-3eAvms04.js"), import("./route-capability-Cjzy-wRF.js")]));
	...
	const loadScheduledServicesModule = createLazyPromise(() => import("./server-runtime-services-CVvhYQzN.js"), { cacheRejections: true });
	...
	activateScheduledServicesWhenReady();
	const { startManagedGatewayConfigReloader } = await import("./server-reload-handlers-CpJBxA3c.js");
...
const loadGatewayModelCatalogModule = createLazyRuntimeModule(() => import("./server-model-catalog-DDYuBrzX.js"));
const loadWorkerEnvironmentStartupModule = createLazyRuntimeModule(() => import("./server-worker-environment-startup-YNih5TD1.js"));
const loadWorkerPlacementStartupModule = createLazyRuntimeModule(() => import("./server-worker-placement-startup-DW1NuKlQ.js"));
...
const loadGatewayStartupEarlyModule = createLazyRuntimeModule(() => import("./server-startup-early-DLwcQWT3.js"));
const loadGatewayStartupPostAttachModule = createLazyRuntimeModule(() => import("./server-startup-post-attach--evGqE2P.js"));
const log = createSubsystemLogger("gateway");
const logDiscovery = log.child("discovery");
const logTailscale = log.child("tailscale");
const logChannels = log.child("channels");
const getChannelRuntime = createLazyRuntimeModule(() => import("./runtime-channel-DIpQ4Zij.js").then(({ createRuntimeChannel }) => createRuntimeChannel()));
...
const loadGatewayPluginBootstrapModule = createLazyRuntimeModule(() => import("./server-plugin-bootstrap-BEjqknDH.js"));
...
async function stopTaskRegistryMaintenanceOnDemand() {
	const { stopTaskRegistryMaintenance } = await import("./task-registry.maintenance-ee3nZWCU.js");
