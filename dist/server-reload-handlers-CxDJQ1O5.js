...
import { f as setGatewaySigusr1RestartPolicy, l as resolveGatewayRestartDeferralTimeoutMs, r as deferGatewayRestartUntilIdle } from "./restart-CuyhHAIM.js";
...
import { l as refreshPreparedModelRuntimeSnapshots, o as markPreparedModelRuntimeSnapshotsStale, u as rejectPendingPreparedModelRuntimeReplacement } from "./prepared-model-runtime-CXHnGzH_.js";
import { r as clearCurrentProviderAuthState } from "./model-provider-auth-state-DW_JYm-o.js";
import { i as warmCurrentProviderAuthStateOffMainThread } from "./model-provider-auth-JeoSk7wI.js";
import { d as getActiveEmbeddedRunCount } from "./run-state-ewY1D1VR.js";
import { a as refreshContextWindowCache } from "./context-DKZWKZZE.js";
...
import { c as getTotalQueueSize } from "./command-queue-Cl58ne2E.js";
import { n as getInspectableActiveTaskRestartBlockers } from "./task-registry.maintenance-BZ0PIik2.js";
...
import { t as buildGatewayCronService } from "./server-cron-Ds3_tm5C.js";
...
import { i as startGatewayCronWithLogging } from "./server-runtime-services-DVjELDs_.js";
...
import { r as publishRuntimeSecretsStateTransition } from "./server-startup-config-CThETZ6M.js";
...
async function restoreSecretsRuntimeSnapshotIfCurrent(snapshot, expectedRevision, ownedSnapshot, options) {
	if (!(await import("./runtime-BIMATdnS.js")).restoreSecretsRuntimeSnapshotIfCurrent(snapshot, expectedRevision, ownedSnapshot, { runtimeSourceConfig: options?.runtimeSourceConfig })) return false;
	options?.onActivated?.();
	return true;
}
