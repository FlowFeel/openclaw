...
import { i as isValueToken, n as consumeRootOptionToken, r as getRootOptionAwareCommandPath } from "./cli-root-options-tXk2lfs9.js";
...
function isDoctorMachineOutput(params) {
	return hasMachineOutputOption(params.argv, "--lint") && (hasMachineOutputOption(params.argv, "--json") || !params.stdoutIsTTY);
}
//#endregion
...
function shouldMigrateStateFromPath(path) {
	...
	if (primary === "health" || primary === "logs" || primary === "sessions") return false;
	if (primary === "gateway" && secondary === "call") return false;
	if (primary === "update" && secondary === "status") return false;
	if (primary === "config" && (secondary === "get" || secondary === "unset")) return false;
	return true;
}
//#endregion
export { consumeGatewayRunOptionToken as A, collectUniqueCommandDescriptors as B, isSystemMachineOutput as C, isModelsStatusJsonOutput as D, isNodesMachineOutput as E, getCoreCliCommandDescriptors as F, isConfigSetJsonParseOnly as G, sanitizeCommandDescriptorDescription as H, getCoreCliCommandNames as I, isNodeRuntime as J, isMachineOutputStdoutTTY as K, getCoreCliCommandsWithSubcommands as L, resolveGatewayRunPreBootstrapOptions as M, isDevicesMachineOutput as N, isGatewayMachineOutput as O, isCronMachineOutput as P, getCoreCliParentDefaultHelpCommands as R, loadPrivateQaCliModule as S, isProxyMachineOutput as T, isDoctorMachineOutput as U, normalizeCommandDescriptorName as V, isConfigMachineOutput as W, normalizeRootNoColorArgv as _, getPositiveIntFlagValue as a, getSubCliEntries as b, hasFlag as c, isRootHelpInvocation as d, isRootVersionInvocation as f, normalizeRootLogLevelArgv as g, normalizeRootHelpTargetArgv as h, getFlagValue as i, resolveGatewayCatalogCommandPath as j, consumeGatewayFastPathRootOptionToken as k, hasRootVersionAlias as l, normalizeGeneratedHelpCommandArgv as m, getCommandPathWithRootOptions as n, getPrimaryCommand as o, isSimpleCommandHelpInvocation as p, isBunRuntime as q, getCommandPositionalsWithRootOptions as r, getVerboseFlag as s, buildParseArgv as t, isHelpOrVersionInvocation as u, shouldMigrateStateFromPath as v, isSkillsMachineOutput as w, getSubCliParentDefaultHelpCommands as x, getSubCliCommandsWithSubcommands as y, addCommandDescriptorsToProgram as z };
