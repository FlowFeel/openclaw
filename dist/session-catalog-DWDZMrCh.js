...
import "./session-upstream-links-UhsYefUG.js";
import "./input-provenance-CYGbY89H.js";
import { p as withSessionTranscriptWriteLock } from "./session-transcript-runtime-DHJ9kAoW.js";
import { d as parseCliReseedPrompt, n as parseClaudeCliHistoryEntry, o as resolveClaudeCliPromptTextCandidates, s as resolveClaudeCliTimestampMs } from "./cli-session-history.claude-Mbvb4UVx.js";
...
function importedSessionCatalogMessage(params) {
	const parsedTimestamp = params.item.timestamp ? Date.parse(params.item.timestamp) : NaN;
