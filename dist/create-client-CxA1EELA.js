...
import { d as writeStorageMeta, l as resolveMatrixStoragePaths, r as maybeMigrateLegacyStorage } from "./storage-CeoUNQh7.js";
import "./config-DFyPAhPJ.js";
import fs from "node:fs";
//#region extensions/matrix/src/matrix/client/create-client.ts
const loadMatrixCreateClientRuntimeDeps = createLazyRuntimeModule(() => Promise.all([import("./sdk-CPgZSX20.js"), import("./logging-CavCZ_SK.js")]).then(([sdkModule, loggingModule]) => ({
