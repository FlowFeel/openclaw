...
import { a as isSubagentSessionKey, c as parseAgentSessionKey, l as parseCronRunScopeSuffix, n as isAcpSessionKey } from "./session-key-utils-02xWdGSz.js";
import { r as getRuntimeConfig } from "./io-DCw4R0kD.js";
import { n as logError } from "./logger-DGpe8sSn.js";
...
import { a as getAgentRunContext, o as getAgentRunContextOwnerStatus } from "./agent-run-registry-BluEqSPq.js";
import "./agent-scope-DyEposw2.js";
import { u as normalizeVerboseLevel } from "./thinking.shared-k6K-6JHM.js";
import "./thinking-CLPqbAwx.js";
import { wt as sessionEntryForkedFromParent } from "./session-accessor.sqlite-B9iW7DOt.js";
import { o as resolveAssistantEventPhase } from "./chat-message-content-DwX2R88T.js";
import { d as isTimeoutError, f as resolveFailoverReasonFromError } from "./failover-error-CMC-wGmM.js";
...
import { o as resolveToolSearchCodeDisplayTarget } from "./tool-display-Cz3bW8uZ.js";
import { h as normalizeAgentPlanSteps } from "./streaming-B45j2FQx.js";
...
import { a as createSessionEventSubscriberRegistry, c as isChatAbortMarkerCurrent, d as resolveAssistantLiveChatInput, f as resolveMergedAssistantText, i as createChatRunState, n as createChatAbortMarker, o as createSessionMessageSubscriberRegistry, p as shouldSuppressAssistantEventForLiveChat, r as createChatRunRegistry, s as createToolEventRecipientRegistry, u as projectLiveAssistantBufferedText } from "./server-chat-state-C8AVcQU8.js";
...
import { a as isAgentLifecycleYieldedWaiting, i as persistGatewaySessionLifecycleEvent, n as isRestartRecoveryLifecycleEvent, r as isStaleLifecycleEventForSession, t as deriveGatewaySessionLifecycleProjectionPatch } from "./session-lifecycle-state-Bx2dmMgx.js";
...
function createAgentEventHandler({ broadcast, broadcastToConnIds, nodeSendToSession, agentRunSeq, chatRunState, resolveSessionKeyForRun, clearAgentRunContext, toolEventRecipients, sessionEventSubscribers, sessionMessageSubscribers, loadGatewaySessionRowForSnapshot = loadGatewaySessionRow, lifecycleErrorRetryGraceMs = AGENT_LIFECYCLE_ERROR_RETRY_GRACE_MS, isChatSendRunActive = () => false, clearTrackedActiveRun, markTrackedRunTerminalPersisted, trackTrackedRunTerminalPersistence, resolveActiveLifecycleGenerationForRun = () => void 0, updateRunToolErrorSummary, resolveSessionActiveRunState }) {
	...
	const agentTextThrottleStreams = ["assistant", "thinking"];
	...
	const finalizeLifecycleEvent = (evt, opts) => {
		...
		if (!suppressRestartRecoveryProjection && sessionKey && (isControlUiVisible || (deliverySessionKey ? sessionMessageSubscribers.get(deliverySessionKey).size > 0 : false))) if (!isAborted) {
			...
			const terminalState = CHAT_STATE_BY_TERMINAL_CLASSIFICATION[classifyAgentRunTerminalOutcome(terminalOutcome)];
	...
	const flushBufferedAgentDeltaIfNeeded = (clientRunId, stream) => {
		...
		const bufferedEntries = (stream ? [stream] : agentTextThrottleStreams).flatMap((currentStream) => {
