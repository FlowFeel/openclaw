...
import { r as isDeliveredMessagingToolResult, t as hasMessagingDeliveryReceipt } from "./embedded-agent-message-tool-source-reply-DOQB4HRp.js";
...
function createAgentToolResultMiddlewareRunner(ctx, handlers) {
	...
	const resolvedHandlersLoader = createLazyPromiseLoader(async () => {
		const { loadAgentToolResultMiddlewaresForRuntime } = await import("./agent-tool-result-middleware-loader-CxorUfMh.js");
