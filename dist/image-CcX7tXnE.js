...
import { u as resolveProviderModelMaterializationAuthMode } from "./openai-model-routes-NsaPlbzf.js";
...
import { o as getModelProviderRequestTransport, t as applyPreparedRuntimeAuthToModel } from "./provider-request-config-DZemMjbU.js";
import { a as unwrapSecretSentinelsForProviderEgress, i as unwrapModelHeaderSentinelsForProviderEgress, t as protectPreparedProviderRuntimeAuth } from "./provider-secret-egress-J5B4EL1L.js";
...
import { i as getApiKeyForModel, r as applySecretRefHeaderSentinels, s as resolveApiKeyForProvider } from "./model-auth-D32HIbZ7.js";
import "./model-selection-D5gxVbBh.js";
import { r as resolveModelAsync } from "./model-DdLCu9LE.js";
import { r as providerUsesCredentialScopedModelMetadata } from "./credential-scoped-model-CjrMvAKP.js";
import { n as normalizeMediaProviderId } from "./provider-id-DSbuCFIb.js";
import { r as minimaxUnderstandImage, t as isMinimaxVlmModel } from "./minimax-vlm-C1va_sOg.js";
import { i as hasImageReasoningOnlyResponse, t as coerceImageAssistantText } from "./image-tool.helpers-DSG2O6wz.js";
...
async function resolveImageRuntime(params) {
	...
	try {
		...
		if ((await resolveModelAsync(resolvedRef.provider, resolvedRef.model, preparedParams.agentDir, preparedParams.cfg, {
			...
			const normalizedResolved = await resolveModelAsync(resolvedRef.provider, resolvedRef.model, preparedParams.agentDir, preparedParams.cfg, resolveOptions);
...
async function describeImagesWithModelInternal(params, options = {}) {
	...
	try {
		...
		const completeImage = async (onPayload) => {
			...
			const task = providerStreamFn ? (async () => await (await providerStreamFn(requestModel, context, streamOptions)).result())() : complete(requestModel, context, streamOptions);
