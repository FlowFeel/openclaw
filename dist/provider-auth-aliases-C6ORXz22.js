...
function clearProviderAuthAliasMapCache() {
...
if (process.env.VITEST || false) globalThis[Symbol.for("openclaw.providerAuthAliasesTestApi")] = { resetProviderAuthAliasMapCacheForTest: clearProviderAuthAliasMapCache };
