...
import { c as DEFAULT_UPLOAD_DIR, l as resolveExistingUploadPaths, r as resolveBrowserConfig } from "./config-B2k8sZ1m.js";
import { Y as withTimeout, j as parseBrowserErrorPayload } from "./tmp-openclaw-dir-BK3eq-mf.js";
import "./control-auth-wBqEDAjN.js";
import "./chrome.executables-B2udiA_j.js";
import "./trash-BJi77wmF.js";
import { o as loadBrowserConfigForRuntimeRefresh } from "./server-context-CirUoj7g.js";
import "./sdk-setup-tools-BpwkGBkq.js";
import { C as fetchBrowserJson, D as withBaseUrl, E as buildProfileQuery, T as setBridgeAuthForPort, w as deleteBridgeAuthForPort } from "./session-tab-registry-CPen4hh5.js";
import "./routes-CyOyRQ6d.js";
import { i as listenBrowserHttpServer, n as installBrowserAuthMiddleware, r as installBrowserCommonMiddleware, t as hasVerifiedBrowserAuth } from "./server-middleware-BVinf9PV.js";
import { c as stopBrowserBridgeRuntime, n as createBrowserControlContext } from "./plugin-enabled-cxFNJ65P.js";
import { a as resolveRequestedBrowserProfile, i as normalizeBrowserRequestPath, n as isBrowserHostLocalRoute, r as isPersistentBrowserProfileMutation, t as createBrowserRouteDispatcher } from "./dispatcher-N4dsYguE.js";
...
async function startBrowserBridgeServer(params) {
	...
	if (params.skipRouteRegistrationForTest) app.get("/", (_req, res) => {
		...
		const [{ createBrowserRouteContext }, { registerBrowserRoutes }] = await Promise.all([import("./server-context-ZNsYDn2d.js"), import("./routes-HQ7Bx06I.js")]);
