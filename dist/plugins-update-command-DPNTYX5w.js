...
import { Q as ConfigMutationConflictError, d as readConfigFileSnapshotForWrite, r as getRuntimeConfig } from "./io-BsQc3Kgy.js";
...
import { n as formatInvalidConfigDetails, t as createInvalidConfigError } from "./io.invalid-config-Chuupwwv.js";
...
import { a as withPluginInstallRecords, l as configReferencesNpmInstallPath, o as withoutPluginInstallRecords } from "./installed-plugin-index-records-BkPV4HdU.js";
import { i as commitPluginInstallRecordsWithConfig, r as commitPluginInstallRecordsOnly } from "./install-record-commit-BuloUnQI.js";
import { n as refreshPluginRegistryAfterConfigMutation } from "./registry-refresh-Cg60AEHC.js";
import { a as selectInstallMutationWriteOptions, i as resolveInstallConfigMutationPreflights, r as resolveCombinedPluginAndHookConfigMutationPreflight, t as containsConfigIncludeDirective } from "./install-persistence-DKIhWexy.js";
import { t as withPluginLifecycleLease } from "./plugin-lifecycle-lease-Cmmxy1R1.js";
import { i as resolveHookInstallDir, n as installHooksFromNpmSpec } from "./install-CrlvMbdJ.js";
...
import { n as recordHookInstall, t as readHookInstalls } from "./installs-Bl_WDcAP.js";
import { r as readInstalledPackageVersion, t as expectedIntegrityForUpdate } from "./package-update-utils-Dl9s-yCQ.js";
import { a as pluginInstallRecordMayMigrateConfigId, i as isPluginInstallRecordUpdateSource, n as updateNpmInstalledPlugins, r as isClawHubTrustSkippedOutcome } from "./update-BKikhBgq.js";
import { t as notifyGatewayPluginMetadataChanged } from "./plugins-update-gateway-signal-CvA8rJ_U.js";
...
async function runPluginUpdateCommandUnlocked(params) {
	...
	const pluginResult = pluginSelection.pluginIds.length > 0 ? await updateNpmInstalledPlugins({
		...
		officialPluginUpdateChannel: params.opts.all ? resolveRegistryUpdateChannel({
