...
import { l as peekSystemEventEntries } from "./system-events-fsxpbPNB.js";
...
import { n as normalizeTrimmedString, t as includesSystemEventToken } from "./dreaming-shared-8l3nTpoP.js";
...
async function runShortTermDreamingPromotionIfTriggered(params) {
	...
	const [{ writeDeepDreamingReport }, { appendFallbackNarrativeEntry, runDreamNarrative }, { runDreamingSweepPhases }, { applyShortTermPromotions, repairShortTermPromotionArtifacts, rankShortTermPromotionCandidates }] = await Promise.all([
		import("./dreaming-markdown-C7mY7pVU.js"),
		import("./dreaming-narrative-C0TgbGM9.js"),
		import("./dreaming-phases-DjMnYulM.js"),
		import("./short-term-promotion-B0k4jz8R.js")
	]);
...
function registerShortTermPromotionDreaming(api) {
	...
	const startDreamingSessionCleanup = async (config, generation, startupStartedAtMs) => {
		const { DREAMING_ORPHAN_MIN_AGE_MS, scrubDreamingNarrativeArtifacts } = await import("./dreaming-session-cleanup-C_27vYir.js");
