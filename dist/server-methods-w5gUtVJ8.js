...
const CORE_GATEWAY_HANDLER_MODULES = {
	agent: () => import("./agent-y16q7OGj.js").then((module) => module.agentHandlers),
	...
	artifacts: () => import("./artifacts-bAXu6kEr.js").then((module) => module.artifactsHandlers),
	board: () => import("./board-DcCwJMrj.js").then((module) => module.boardHandlers),
	...
	attach: () => import("./attach-BxLItQsE.js").then((module) => module.attachHandlers),
	...
	chat: () => import("./chat-uPRsEYCE.js").then((module) => module.chatHandlers),
	commands: () => import("./commands-CCDqHZFr.js").then((module) => module.commandsHandlers),
	config: () => import("./config-4VfSr7t2.js").then((module) => module.configHandlers),
	...
	health: () => import("./health-xIP5xCv1.js").then((module) => module.healthHandlers),
	...
	"models-auth-status": () => import("./models-auth-status-BusR7qKZ.js").then((module) => module.modelsAuthStatusHandlers),
	models: () => import("./models-BTD4lPza.js").then((module) => module.modelsHandlers),
	"models-probe": () => import("./models-probe-B-JBmtX_.js").then((module) => module.modelsProbeHandlers),
	"native-hook-relay": () => import("./native-hook-relay-DU-M03CD.js").then((module) => module.nativeHookRelayHandlers),
	"nodes-pending": () => import("./nodes-pending-Bz1zS0yz.js").then((module) => module.nodePendingHandlers),
	nodes: () => import("./nodes-Bk9tRkaf.js").then((module) => module.nodeHandlers),
	...
	restart: () => import("./restart-BlqCjpiy.js").then((module) => module.restartHandlers),
	suspend: () => import("./suspend-Dtu9RtrT.js").then((module) => module.suspendHandlers),
	...
	"sessions-abort": () => import("./sessions-abort-BiaBjXnk.js").then((module) => module.sessionAbortHandlers),
	"sessions-compact": () => import("./sessions-compact-Cm3VQhjD.js").then((module) => module.sessionCompactHandlers),
	"sessions-compaction-checkpoints": () => import("./sessions-compaction-checkpoints-1rn_bkNP.js").then((module) => module.sessionCheckpointHandlers),
	"sessions-compaction-queries": () => import("./sessions-compaction-queries-tddKAAYS.js").then((module) => module.sessionCheckpointQueryHandlers),
	"sessions-create": () => import("./sessions-create-CBdEpSmn.js").then((module) => module.sessionCreateHandlers),
	"sessions-delete": () => import("./sessions-delete-BqWgEG7X.js").then((module) => module.sessionDeleteHandlers),
	"sessions-dispatch": () => import("./sessions-dispatch-F_vTBjZk.js").then((module) => module.sessionDispatchHandlers),
	"sessions-groups": () => import("./sessions-groups-DdPzV3UO.js").then((module) => module.sessionGroupHandlers),
	"sessions-messaging": () => import("./sessions-messaging-Cl5Hsvca.js").then((module) => module.sessionMessagingHandlers),
	"sessions-mutations": () => import("./sessions-mutations-D27raa33.js").then((module) => module.sessionMutationHandlers),
	"sessions-read": () => import("./sessions-read-B7n4FbKG.js").then((module) => module.sessionReadHandlers),
	"sessions-rewind": () => import("./sessions-rewind-OELMMcVi.js").then((module) => module.sessionRewindHandlers),
	"sessions-sharing": () => import("./sessions-sharing-X1ryamFg.js").then((module) => module.sessionSharingHandlers),
	"sessions-subscriptions": () => import("./sessions-subscriptions-JfR-mjcq.js").then((module) => module.sessionSubscriptionHandlers),
	"sessions-suggestions": () => import("./sessions-suggestions-B5N-eG8l.js").then((module) => module.sessionSuggestionHandlers),
	"session-catalog": () => import("./session-catalog-CP_mqskv.js").then((module) => module.sessionCatalogHandlers),
	"session-discussion": () => import("./session-discussion-C-E09QPF.js").then((module) => module.sessionDiscussionHandlers),
	"session-observer-rpc": () => import("./session-observer-rpc-B0fBqz9q.js").then((module) => module.sessionObserverHandlers),
	"session-companion-rpc": () => import("./session-companion-rpc-4bwOaFWR.js").then((module) => module.sessionCompanionHandlers),
	"hooks-status": () => import("./hooks-status-DOI02mN_.js").then((module) => module.hooksStatusHandlers),
	skills: () => import("./skills-BK3bHvOM.js").then((module) => module.skillsHandlers),
	system: () => import("./system-D1-MyRs0.js").then((module) => module.systemHandlers),
	talk: () => import("./talk-CyRvP7gH.js").then((module) => module.talkHandlers),
	tasks: () => import("./tasks-CglQCBeC.js").then((module) => module.tasksHandlers),
	"task-suggestions": () => import("./task-suggestions-CgGcg7FS.js").then((module) => module.taskSuggestionsHandlers),
	"tools-catalog": () => import("./tools-catalog-o8GHR2Od.js").then((module) => module.toolsCatalogHandlers),
	"tools-effective": () => import("./tools-effective-Cbs7cTDm.js").then((module) => module.toolsEffectiveHandlers),
	"tools-invoke": () => import("./tools-invoke-BbRricQx.js").then((module) => module.toolsInvokeHandlers),
	...
	update: () => import("./update-uMXi6uaM.js").then((module) => module.updateHandlers),
	...
	"system-agent": () => import("./system-agent-C1yhV2Tz.js").then((module) => module.systemAgentHandlers),
	"system-changes": () => import("./system-changes-CQ0LRloY.js").then((module) => module.systemChangesHandlers),
	wizard: () => import("./wizard-Bj0L0cPN.js").then((module) => module.wizardHandlers)
};
