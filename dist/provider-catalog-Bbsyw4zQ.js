...
import { i as resolveGoogleStaticModelId, t as isGoogleTextGenerationModelId } from "./provider-models-CPb4cNty.js";
...
function readPositiveInteger(row, key) {
	const value = row[key];
	return typeof value === "number" && Number.isSafeInteger(value) && value > 0 ? value : void 0;
}
function googleLiveModelInput(id) {
	if (!id.startsWith("gemma-")) return ["text", "image"];
