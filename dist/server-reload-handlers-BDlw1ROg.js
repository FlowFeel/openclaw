...
import { l as clearLoadInstalledPluginIndexInstallRecordsCache, n as loadInstalledPluginIndexInstallRecords, r as loadInstalledPluginIndexInstallRecordsSync } from "./installed-plugin-index-record-reader-DA9P0iII.js";
...
import { C as setRuntimeConfigAppliedHash, c as getRuntimeConfigSourceSnapshot, o as getRuntimeConfigSnapshotMetadata, u as hashRuntimeConfigValue, y as resolveConfigWriteFollowUp } from "./runtime-snapshot-Bzqj8IgJ.js";
import { t as getConfigValueAtPath } from "./config-paths-H__p5Mi7.js";
...
import { i as getActiveGatewayRootWorkCount, m as runWithGatewayIndependentRootWorkAdmission, p as runOutsideGatewayRootWorkAdmission } from "./gateway-work-admission-BaRJo64l.js";
import { f as setGatewaySigusr1RestartPolicy, l as resolveGatewayRestartDeferralTimeoutMs, r as deferGatewayRestartUntilIdle } from "./restart-Cneg3xRO.js";
...
import { l as refreshPreparedModelRuntimeSnapshots, o as markPreparedModelRuntimeSnapshotsStale, u as rejectPendingPreparedModelRuntimeReplacement } from "./prepared-model-runtime-Cbe86whM.js";
import { r as clearCurrentProviderAuthState } from "./model-provider-auth-state-DW_JYm-o.js";
import { i as warmCurrentProviderAuthStateOffMainThread } from "./model-provider-auth-CMsi2FUx.js";
import { d as getActiveEmbeddedRunCount } from "./run-state-oGYwHnd-.js";
import { a as refreshContextWindowCache } from "./context-Bq_6Vo-L.js";
...
import { c as getTotalQueueSize } from "./command-queue-DxY-0HMA.js";
import { n as getInspectableActiveTaskRestartBlockers } from "./task-registry.maintenance-DrCML_Ju.js";
import { t as formatActiveTaskRestartBlocker } from "./task-restart-blocker-D04cCKR2.js";
import { n as disposeAllSessionMcpRuntimes } from "./agent-bundle-mcp-manager-api-D2GddaSc.js";
import "./agent-bundle-mcp-tools-DIqqH-eP.js";
import { r as resetDirectoryCache } from "./target-resolver-BRdj-hLk.js";
import { t as commitHooksConfigReload, y as resolveHooksConfig } from "./hooks-kjOfgOL9.js";
import { b as setSecretsRuntimeSourceSnapshotIfCurrent, c as getActiveSecretsRuntimeSnapshotRevision, f as hasActiveSecretsRuntimeSnapshotLineage, h as hasSameSecretReloadContract, r as clearSecretsRuntimeSnapshot, s as getActiveSecretsRuntimeSnapshot, v as restoreSecretsRuntimeSourceSnapshotIfLineageCurrent } from "./runtime-state-DhF-BA9k.js";
import { t as buildGatewayCronService } from "./server-cron-DJsF313a.js";
...
import { i as startGatewayCronWithLogging } from "./server-runtime-services-AMAyk0Fl.js";
import { t as startGatewayChannelHealthMonitor } from "./server-runtime-startup-services-DAoeVBi2.js";
import { t as invalidateConfigGetResponseCache } from "./config-get-response-Bj_58a1Q.js";
import { n as diffGatewayReloadPaths, t as diffConfigPaths } from "./config-diff-BMZsFOL1.js";
import { i as listPluginInstallWholeRecordPaths, n as isNoopGatewayReloadPlan, r as listPluginInstallTimestampMetadataPaths, t as buildGatewayReloadPlan } from "./config-reload-plan-D9-y_jYl.js";
...
import { r as publishRuntimeSecretsStateTransition } from "./server-startup-config-LBsU8BBc.js";
		...
		if (plan.restartGmailWatcher) {
			...
			try {
				...
				if (!restartAbortController.signal.aborted) {
					const [{ stopGmailWatcher }, { startGmailWatcherWithLogs }] = await Promise.all([import("./gmail-watcher-iu2ZXRma.js"), import("./gmail-watcher-lifecycle-CWlcMbNP.js")]);
...
async function restoreSecretsRuntimeSnapshotIfCurrent(snapshot, expectedRevision, ownedSnapshot, options) {
	if (!(await import("./runtime-6RXfdk6s.js")).restoreSecretsRuntimeSnapshotIfCurrent(snapshot, expectedRevision, ownedSnapshot, { runtimeSourceConfig: options?.runtimeSourceConfig })) return false;
	options?.onActivated?.();
	return true;
}
...
//#endregion
export { abortPendingChannelReloads as a, GatewayHotReloadRecoveryError as i, createGatewayReloadHandlers as n, GatewayHotReloadCancelledError as r, startManagedGatewayConfigReloader as t };
