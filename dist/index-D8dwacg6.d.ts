import { c as CompactionPreparation, l as CompactionResult } from "./agent-core-MNgR-7Gr.js";
import { S as TextContent, _ as SimpleStreamOptions, a as AssistantMessageEventStreamContract, c as Context, d as Model, i as AssistantMessageEvent, k as ToolResultMessage, l as ImageContent, n as Api } from "./types-xx0UXBU1.js";
import { S as ToolExecutionMode, _ as CustomMessage, b as StreamFn, c as AgentMessage, f as AgentToolResult, p as AgentToolUpdateCallback, u as AgentTool, x as ThinkingLevel } from "./types-BzdPB1fv.js";
import { u as SourceInfo } from "./types-C-ie8uJb.js";
import { n as PluginMetadataSnapshot, r as PluginMetadataSnapshotOwnerMaps } from "./plugin-metadata-snapshot.types-CKqzUu4R.js";
import { c as SessionEntry, n as SessionManager, o as BranchSummaryEntry, s as CompactionEntry, t as ReadonlySessionManager } from "./session-manager-m-0UfCAc.js";
import { i as OAuthLoginCallbacks$1, l as OAuthProviderInterface, r as OAuthCredentials$1, s as OAuthProviderId } from "./provider-oauth-runtime-BK6L07z2.js";
import { Static, TSchema, Type } from "typebox";
import { AutocompleteItem, AutocompleteProvider, Component, EditorComponent, EditorTheme, KeyId, KeybindingsConfig, KeybindingsManager, OverlayHandle, OverlayOptions, TUI } from "@earendil-works/pi-tui";
