...
import { C as resolveExpiresAtMsFromDurationMs, b as parseStrictPositiveInteger, f as clampTimerTimeoutMs, j as resolveTimerTimeoutMs, m as isFutureDateTimestampMs, o as asDateTimestampMs, p as finiteSecondsToTimerSafeMilliseconds, s as asFiniteNumber } from "./number-coercion-Crk_c9KW.js";
...
import { i as redactSecrets, m as isSecretValueRegisteredForRedaction } from "./redact-DUpJZuMu.js";
import { n as consumeRootOptionToken } from "./cli-root-options-tXk2lfs9.js";
...
import { r as isCloudModelRef } from "./model-catalog-refs-C_8nyypZ.js";
import { c as resolveAgentDir, f as resolveDefaultAgentId, s as resolveAgentContextLimits } from "./agent-scope-config-Dusa8eSA.js";
import { a as isSubagentSessionKey, c as parseAgentSessionKey, r as isCronRunSessionKey } from "./session-key-utils-02xWdGSz.js";
...
import { E as getActiveDiagnosticTraceContext, S as createDiagnosticTraceContext, T as freezeDiagnosticTraceContext, o as emitTrustedDiagnosticEvent, s as emitTrustedDiagnosticEventWithPrivateData, x as createChildDiagnosticTraceContext } from "./diagnostic-events-Dt41CZkD.js";
import { t as createSubsystemLogger } from "./subsystem-Cr19cPPQ.js";
import { n as ensureGlobalUndiciDispatcherStreamTimeouts, r as ensureGlobalUndiciEnvProxyDispatcher, t as DEFAULT_UNDICI_STREAM_TIMEOUT_MS } from "./undici-global-dispatcher-JoeybKmw.js";
import { P as stripInternalMetadataForDisplay } from "./openclaw-state-db-BU55lNCH.js";
import { t as resolveCommitHash } from "./git-commit-BNs9G2AE.js";
import { d as stripHistoricalRuntimeContextCustomMessages, p as stripRuntimeContextCustomMessages, u as relocateCurrentRuntimeContextCarrierToTail } from "./internal-runtime-context-s8_TwHnQ.js";
import { o as markInboundContextLabel, r as stripInboundMetadata } from "./strip-inbound-meta-BOGiSpdi.js";
...
import { i as emitAgentEvent, n as captureAgentRunLifecycleGeneration, o as emitAgentEventIfCurrent } from "./agent-events-COCf-9-O.js";
import { b as recordAgentRunOutputTokens } from "./agent-run-registry-BluEqSPq.js";
import { S as requireActivePluginRegistry, d as getActivePluginRegistry, v as listImportedRuntimePluginIds } from "./runtime-yJAYArQt.js";
import { a as readRootJsonObjectSync } from "./json-C-CW4mQo.js";
import "./json-files-v5WP3doI.js";
import { _ as resolveSessionAgentIds, s as resolveAgentExecutionContract } from "./agent-scope-DyEposw2.js";
import { o as sha256HexPrefix } from "./crypto-digest-CmUwt1S-.js";
import { a as resolveEffectivePluginActivationState, i as normalizePluginsConfigWithResolver } from "./manifest-registry-L5aUEg9C.js";
...
import { r as loadPluginMetadataSnapshot, t as isPluginMetadataSnapshotCompatible } from "./plugin-metadata-snapshot-DtW_P3kZ.js";
import { t as DEFAULT_CONTEXT_TOKENS } from "./defaults-CdX9UGcX.js";
import { F as splitShellArgs, P as hasTopLevelShellControlOperator } from "./shell-wrapper-resolution-4V1pkTCa.js";
import { s as normalizeProviderId$1 } from "./model-ref-shared-BCBRWGJh.js";
...
import { f as couldNormalizeToolNamePrefixToAllowedTool, h as normalizeToolName, l as replaceWithEffectiveToolAllowlist, m as normalizeToolList } from "./tool-policy-CrjVfI-s.js";
import { r as isToolAllowedByPolicyName, t as isRuntimeToolAllowed } from "./tool-policy-match-BJgxicXr.js";
import { t as applyMergePatch } from "./merge-patch-DNAwVDQs.js";
import "./config-UtpOr1Uw.js";
import { a as createStreamIteratorWrapper, i as wrapStreamFnTextTransforms } from "./text-transforms.runtime-DmbU-LdP.js";
import { a as resolveSecretSentinel, i as mintSecretSentinel, r as looksLikeSecretSentinel } from "./sentinel-DVfNmxPl.js";
import { t as describeProviderRequestRoutingSummary } from "./provider-attribution-D6GRQEFS.js";
...
import { M as hasNonzeroUsage, N as makeZeroUsageSnapshot, P as normalizeUsage, nt as listSqliteSessionEntriesReadOnly, st as loadSqliteSessionEntry } from "./session-accessor.sqlite-B9iW7DOt.js";
...
import { a as parseAssistantTextSignature, s as resolveAssistantMessagePhase } from "./chat-message-content-DwX2R88T.js";
...
import { $ as parseSessionThreadInfoFast, J as resolveQuotaSuspensionEntryMaintenance } from "./session-entry-slot-keys-DR5d2mKt.js";
import { t as emitSessionTranscriptUpdate } from "./transcript-events-BG9Ai61T.js";
import { d as readPersistedMediaFacts, g as stripLegacyMediaContextFields, p as readRuntimePromptMediaFacts } from "./media-facts-D_wLZOa9.js";
import { $ as listSessionEntries, E as withOwnedSessionTranscriptWrites, K as updateSessionEntry, i as resolveSessionTranscriptRuntimeTarget, r as resolveSessionTranscriptRuntimeReadTarget, w as bindOwnedSessionTranscriptWrites } from "./session-accessor-t3qUoTeV.js";
import { l as listRegisteredPluginAgentPromptGuidance } from "./command-registration-BVqPh9mZ.js";
import { B as finalizeToolTerminalPresentation, J as consumePreExecutionBlockedToolCall, K as resolveChannelReactionGuidance, Q as peekPreExecutionBlockedToolCall, R as isEmbeddedMode, U as listChannelSupportedActions, W as resolveChannelMessageToolHints, X as consumeTrackedToolExecutionStarted, Y as consumeStructuredReplaySafeToolCall, Z as peekAdjustedParamsForToolCall, c as recordStructuredReplayTrustForToolCall, q as consumeAdjustedParamsForToolCall } from "./agent-tools.before-tool-call-BwKgu8k0.js";
import { d as resolveProviderRuntimePluginHandle } from "./provider-hook-runtime-YtpQDbub.js";
import { M as resolveProviderSystemPromptContribution, N as resolveProviderTextTransforms, U as transformProviderSystemPrompt, W as validateProviderReplayTurnsWithPlugin, w as resolveProviderCacheTtlEligibility, z as sanitizeProviderReplayHistoryWithPlugin } from "./provider-runtime-pe0BhJuO.js";
import { t as sanitizeForConsole } from "./console-sanitize-NjY4pEOW.js";
import { t as buildGuardedModelFetch } from "./provider-transport-fetch-CpJ8peau.js";
import { a as resolveToolCallArgumentsEncoding, n as extractModelCompat } from "./provider-model-compat-Czzl4McI.js";
import { A as COMPACTION_SUMMARY_PREFIX, M as bashExecutionToText, O as BRANCH_SUMMARY_PREFIX, j as COMPACTION_SUMMARY_SUFFIX, k as BRANCH_SUMMARY_SUFFIX } from "./agent-core-00z91UZG.js";
import { t as event_stream_exports } from "./event-stream-MHM-_qcK.js";
import { J as SettingsManager, K as wrapToolDefinition, i as DefaultResourceLoader, n as createAgentSessionForEmbeddedRunner } from "./sessions-Cj7BqXHP.js";
import { a as isSessionContextMetadataEntry } from "./session-manager-codec-DRZh7P2-.js";
import { r as detectRuntimeShell } from "./shell-utils-DzYfAjux.js";
import { i as isReasoningOnlyLengthAssistantTurn, r as hasOnlyAssistantReasoningContent } from "./ai-transport-runtime-host-DwMiqDOL.js";
...
import { i as sanitizeToolCallIdsForCloudCodeAssist, n as extractToolResultId, r as extractToolResultIds, s as isThinkingLikeBlock, t as extractToolCallsFromAssistant } from "./tool-call-id-BrrPYNyX.js";
import { g as stripToolResultDetails, n as repairToolUseResultPairing } from "./repair-h5r9ZjXr.js";
import { n as sanitizeToolCallInputs, r as sanitizeToolUseResultPairing, t as guardSessionManager } from "./session-tool-result-guard-wrapper-04yd5fAd.js";
...
import { a as readToolResultDetails, n as isToolResultError } from "./tool-result-error-D4i-Z2FR.js";
import { n as normalizeGoogleApiBaseUrl } from "./google-api-base-url-UBNiBOzj.js";
import { a as buildHistoryPrunePlan, d as isOversizedForSummary, i as SUMMARIZATION_OVERHEAD_TOKENS, l as computeAdaptiveChunkRatio, n as MIN_CHUNK_RATIO, r as SAFETY_MARGIN, t as BASE_CHUNK_RATIO } from "./compaction-planning-CEkjkWXf.js";
import { o as resolveModelAuthMode } from "./model-auth-D-tc_3Dn.js";
import "./model-selection-4mvNeCA1.js";
import { C as MAX_WORKSPACE_BOOTSTRAP_FILE_BYTES, g as isWorkspaceBootstrapPending, n as DEFAULT_BOOTSTRAP_FILENAME, w as readWorkspaceBootstrapFile } from "./workspace-CelKqYGr.js";
import { r as resolveOpenClawReferencePaths } from "./docs-path-CIMgdwYZ.js";
import { E as parseExecApprovalResultText, f as coerceChatContentText, p as extractTextFromChatContent } from "./sanitize-user-facing-text-Ba4C3tZ5.js";
import { i as classifyFailoverReason, m as isCloudCodeAssistFormatError, u as formatUserFacingAssistantErrorText } from "./errors-B811vGBl.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-BsZayE7D.js";
import { a as projectScrubbedPlainTextToolCallMessage, i as normalizePlainTextToolCallStreamEvents, n as createPromotedPlainTextToolCallEvents, r as projectStandalonePlainTextToolCallMessage } from "./src-BCj7auhV.js";
import { t as findCodeRegions } from "./code-regions-B1zlXqqO.js";
import { d as hasOrphanReasoningCloseBoundary, p as findFinalTagMatches, s as stripDowngradedToolCallText } from "./assistant-visible-text-DONkuTGN.js";
import { d as isSignalTimeoutReason, f as isTimeoutError } from "./failover-error-U3al4tnA.js";
import { r as isSessionWriteLockAcquireError } from "./session-write-lock-error-5gHYmvxH.js";
import { l as recordSessionCompacted } from "./session-state-events-MWtkoPhW.js";
import { H as isTerminalTaskStatus } from "./task-registry-ZiNcN-Vv.js";
import { c as mergeAgentRunAttemptTerminal, d as projectAgentRunAttemptTerminal, f as setAgentRunAttemptTerminalFailure, r as buildAgentRunTerminalOutcomeFromAttempt } from "./agent-run-terminal-outcome-9kJP3Yn1.js";
import { i as AGENT_RUN_RESTART_ABORT_STOP_REASON, l as isAgentRunRestartAbortReason, o as createAgentRunRestartAbortError } from "./run-termination-7xcnysfe.js";
import { c as listTasksForOwnerOrRequesterSessionKeyForStatus, n as findTaskByRunIdForStatus } from "./task-status-access-B5dtG_ZY.js";
import { n as resolveAgentTimeoutMs } from "./timeout-BEGWfRGM.js";
import { j as resolveCompactionTimeoutMs } from "./diagnostic-Ba_lpTat.js";
import { h as setActiveEmbeddedRunLifecycleGeneration } from "./run-state-ewY1D1VR.js";
import { T as updateActiveEmbeddedRunSnapshot, h as markActiveEmbeddedRunAbandoned, r as clearActiveEmbeddedRun, w as setActiveEmbeddedRun } from "./runs-Bw__iUSb.js";
import { i as scanFenceSpans } from "./fences-rLVnT2kD.js";
import { t as parseInlineDirectives } from "./directive-tags-XkukyPkv.js";
import { a as hasInterSessionUserProvenance, r as annotateInterSessionPromptText, t as INTER_SESSION_PROMPT_PREFIX_BASE, u as normalizeInputProvenance } from "./input-provenance-CYGbY89H.js";
...
import { f as parseReplyDirectives, p as splitMediaFromOutput } from "./payloads-BRd0B8mC.js";
import { a as sanitizeGoogleTurnOrdering } from "./bootstrap-DOyGG4hV.js";
import { n as sanitizeSessionMessagesImages } from "./embedded-agent-helpers-zm6jLxdk.js";
import { l as isMessagingToolDuplicateNormalized, u as normalizeTextForComparison } from "./reply-payloads-dedupe-CrDHl82Z.js";
...
import { t as buildLateMediaAttachedProjection } from "./user-turn-transcript-Cd8sokau.js";
import { n as isAgentToolReplaySafe, r as isAgentToolRestartSafe, t as collectReplaySafeToolNames } from "./tool-replay-safety-CRqM1och.js";
import { a as getOrCreateSessionMcpRuntime, b as loadEmbeddedAgentMcpConfig } from "./agent-bundle-mcp-manager-api-BO7-Y1u4.js";
import { i as getPluginToolMeta } from "./tools-CSTIF4SP.js";
import { o as readMcpAppChannelView } from "./mcp-ui-resource-CL8a9Qyv.js";
import { r as materializeBundleMcpToolsForRun } from "./agent-bundle-mcp-materialize-CoC89udA.js";
...
import { d as prepareMemoryPromptSection } from "./memory-state-CngllfdS.js";
import { t as resolvePreferredSessionKeyForSessionIdMatches } from "./session-id-resolution-joL8CTWk.js";
import { f as buildContextEngineRuntimeSettings, i as bootstrapHarnessContextEngine, n as runAgentEndSideEffects, r as assembleHarnessContextEngine, s as finalizeHarnessContextEngineTurn, u as runContextEngineMaintenance } from "./agent-end-side-effects-BZnAfuJ0.js";
import { a as messageToolOwnsVisibleReply, i as resolveLocalModelLeanPreserveToolNames, n as filterLocalModelLeanTools, r as isLocalModelLeanEnabled } from "./local-model-lean-CeG7_aMD.js";
...
import { t as createBundleLspToolRuntime } from "./agent-bundle-lsp-runtime-DFNJwxvC.js";
import { t as AgentRunTerminalOutcomeError } from "./agent-run-terminal-error-BLySVFXs.js";
import { l as copyAgentToolMetadata, m as getChannelAgentToolMeta } from "./gateway-C5_wViGG.js";
...
import { i as isSameToolMutationAction, t as buildToolMutationState } from "./tool-mutation-BmnNoynG.js";
import { C as TOOL_SEARCH_CONTROL_TOOL_NAMES, S as TOOL_SEARCH_CODE_MODE_TOOL_NAME, a as buildToolSchemaDirectoryPrompt, b as TOOL_CALL_RAW_TOOL_NAME, g as createToolSearchCatalogRef, m as collectUniqueCatalogToolNames, o as resolveToolSearchCatalogTool, p as clearToolSearchCatalog, t as addClientToolsToToolSearchCatalog, u as projectToolSearchTargetTranscriptMessages, w as TOOL_SEARCH_RAW_TOOL_NAME, x as TOOL_DESCRIBE_RAW_TOOL_NAME, y as restrictToolSearchCatalog } from "./tool-search-CjWdLqBa.js";
import { t as log$5 } from "./logger-BeJ7WAxI.js";
import { o as normalizeHeartbeatToolResponse } from "./heartbeat-tool-response-7o9KGNyQ.js";
import { I as formatToolAggregate, h as normalizeAgentPlanSteps } from "./streaming-Byu76Sav.js";
import { g as parseJsonMessageParam, h as parseInteractiveParam } from "./source-reply-mirror-Crvb6bnm.js";
import { C as hasAcceptedSessionSpawn, p as hasMessagingToolDeliveryEvidence, s as hasCommittedMessagingToolDeliveryEvidence, w as normalizeAcceptedSessionSpawnResult } from "./delivery-evidence-hC0w28qO.js";
import { a as isMessagingToolSendAction, o as isMessagingToolTargetEvidenceAction, r as isMessagingTool } from "./embedded-agent-messaging-BHU1Makt.js";
import { t as collectTextContentBlocks } from "./content-blocks-DRK0dze4.js";
import { a as extractMessagingToolSend, c as extractToolErrorCode, d as extractToolResultText, f as filterToolResultMediaUrls, g as truncateLiveExecOutput, h as sanitizeToolResult, i as collectMessagingMediaUrlsFromToolResult, l as extractToolErrorMessage, m as sanitizeToolArgs, n as capLiveExecResult, o as extractMessagingToolSendResult, p as isToolResultTimedOut, r as collectMessagingMediaUrlsFromRecord, s as extractMessagingToolSourceReplyPayload, t as buildToolLifecycleErrorResult, u as extractToolResultMediaArtifact } from "./embedded-agent-subscribe.tools-D7tyhgah.js";
import { i as readMessageToolSourceReplyText, n as isDeliveredMessageToolOnlySourceReplyResult, r as isDeliveredMessagingToolResult } from "./embedded-agent-message-tool-source-reply-DOQB4HRp.js";
import { a as extractAssistantThinking, c as extractThinkingFromTaggedText, d as isAssistantMessage, f as promoteThinkingTagsToBlocks, i as extractAssistantText, n as createThinkingTagStreamState, o as extractAssistantVisibleText, p as sanitizeAssistantVisibleStreamText, r as extractAssistantCommentaryText, s as extractThinkingFromTaggedStream, t as THINKING_TAG_SCAN_RE, u as inferToolMetaFromArgs } from "./embedded-agent-utils-BYrAMdPg.js";
import { A as resolveWorkspaceBootstrapRouting, B as claimPendingAgentQuestionAnswer, F as normalizeAskUserParams, H as buildAgentHarnessQuestionPromptPayload, I as reserveAskUserPromptDelivery, L as settleAskUserPromptDelivery, N as cancelAskUserPromptDelivery, R as waitForAskUserPromptReady, a as supportsModelTools, f as invalidateComputerFrameIfMissing, i as buildModelToolsUnavailablePrompt, j as isHeartbeatLifecycleRunKind, k as isPrimaryBootstrapRun, z as cancelPendingAgentQuestionForSession } from "./openclaw-tools-DDu2b20y.js";
import { i as summarizeToolValidationError, t as createToolValidationErrorSummary } from "./tool-error-summary-DDV0ZoKC.js";
import { a as buildBootstrapPromptWarningNotice, o as buildBootstrapTruncationReportMeta, r as buildBootstrapBudgetState } from "./bootstrap-budget-U6QVxuxs.js";
import { i as makeBootstrapWarn, n as buildBootstrapContextForFiles, o as resolveBootstrapFilesForRun, r as hasCompletedBootstrapTurn, s as resolveContextInjectionMode, t as FULL_BOOTSTRAP_COMPLETED_CUSTOM_TYPE } from "./bootstrap-files-BmlEwlGk.js";
import { a as prependSystemPromptAddition, c as resolvePromptBuildHookResult, d as shouldWarnOnOrphanedUserRepair, i as mergeOrphanedTrailingUserPrompt, l as resolvePromptModeForSession, n as buildAfterTurnRuntimeContextFromUsage, o as resolveAttemptFsWorkspaceOnly, s as resolveAttemptMediaTaskSystemPromptAddition, t as buildAfterTurnRuntimeContext, u as shouldInjectHeartbeatPrompt, v as resolveHeartbeatPromptForSystemPrompt, y as listActiveProcessSessionReferences } from "./attempt.prompt-helpers-CG_QLe7_.js";
import { n as rewriteTranscriptEntriesInSessionManager } from "./transcript-runtime-state-DyDUrArH.js";
import { n as resolveProcessToolScopeKey, t as createOpenClawCodingTools } from "./agent-tools-Ske_S_5A.js";
import { r as wrapUntrustedPromptDataBlock, t as sanitizeForPromptLiteral } from "./sanitize-for-prompt-Drdy09dw.js";
import { A as settleRequesterAfterSessionSpawns, R as prependAgentSteeringPrompt, h as leasePendingAgentSteeringItems, t as ackPendingAgentSteeringItems, w as releasePendingAgentSteeringItems } from "./subagent-registry-QAwU6DFV.js";
...
import { p as mediaUrlsFromGeneratedAttachments } from "./subagent-announce-delivery-DzmvwrYx.js";
import { t as abortable } from "./abortable-wb3haGdv.js";
import { _ as buildApiErrorObservationFields, v as buildTextObservationFields, y as shouldSuppressRawErrorConsoleSuffix } from "./model-fallback-attempt-C8uP1hXj.js";
...
import { o as listControlledSubagentRuns } from "./subagent-control-CEnGPaCH.js";
import { r as markdownToIR } from "./construct-fallbacks-BR_o1n_g.js";
...
import { n as normalizeAgentRuntimeTools, t as logAgentRuntimeToolDiagnostics } from "./tools-CgK1Uzk2.js";
import { n as filterRuntimeCompatibleTools } from "./tool-schema-projection-ZrMdwk4s.js";
import { r as recordPersistedRuntimeToolSchemaQuarantine, t as clearRecoveredPersistedRuntimeToolSchemaQuarantines } from "./tool-schema-quarantine-health-Dk3iOhWB.js";
import { t as applyFinalEffectiveToolPolicy } from "./effective-tool-policy-CTuFwEiq.js";
import { a as shouldCreateBundleMcpRuntimeForAttempt, i as shouldCreateBundleLspRuntimeForAttempt, n as mergeForcedEmbeddedAttemptToolsAllow, r as resolveEmbeddedAttemptToolConstructionPlan, t as applyEmbeddedAttemptToolsAllow } from "./attempt-tool-construction-plan-Bf7wzZfB.js";
import { n as claimHeartbeatOutcomeForRun, t as buildHeartbeatOutcomeContext } from "./heartbeat-outcome-store-CIMwR2LT.js";
import { S as isAnthropicModelRef, s as createCodexNativeWebSearchWrapper, x as isAnthropicFamilyCacheTtlEligible } from "./proxy-DeYWfVN-.js";
import { a as resolvePreparedExtraParams, n as resolveAgentTransportOverride, o as isGooglePromptCacheEligible, r as resolveExplicitSettingsTransport, s as resolveCacheRetention, t as applyExtraParamsToAgent } from "./extra-params-CL25FmLk.js";
import { a as resolveEmbeddedAgentStreamFn, i as resolveEmbeddedAgentBaseStreamFn, n as describeEmbeddedAgentStreamStrategy, r as resolveEmbeddedAgentApiKey, t as wrapStreamFnWithDiagnosticModelCallEvents } from "./attempt.model-diagnostic-events-Bas7iJGm.js";
import { i as resolveLiveToolResultMaxChars } from "./tool-result-limits-DjIhjsDF.js";
import { _ as stripInvalidThinkingSignatures, a as resolveLiveToolResultAggregateMaxChars, b as wrapAnthropicStreamWithRecovery, f as truncateToolResultText, g as shouldPreserveLatestAssistantThinking, h as dropThinkingBlocks, i as resolveCacheTtlPruningSettings, l as truncateOversizedToolResultsInMessages, m as dropReasoningFromHistory, p as assessLastAssistantMessage, r as pruneExpiredCacheTtlToolResults, s as toolResultWarningDedupe, u as truncateOversizedToolResultsInSessionManager, v as stripStaleThinkingSignaturesForCompactionReplay, x as formatContextLimitTruncationNotice, y as stripThinkingBlocksFromMessage } from "./transcript-visibility-DWT7LD0k.js";
import { t as estimateToolResultTextChars } from "./tool-result-text-budget-PVCMQFTx.js";
...
import { _ as applyAgentCompactionSettingsFromConfig, g as applyAgentAutoCompactionGuard, v as isSilentOverflowProneModel, y as resolveEffectiveCompactionMode } from "./config-utils-bVWMjALM.js";
import { t as filterHeartbeatTranscriptArtifacts } from "./heartbeat-filter-DUXErom1.js";
import { a as buildModelIdentityPromptLine, c as prepareProjectMemoryBootstrap, i as appendModelIdentitySystemPrompt, o as resolveAgentPromptSurfaceForSessionKey, r as buildConfiguredAgentSystemPrompt, s as buildProjectMemoryWriteInstruction, t as buildSystemPromptParams } from "./system-prompt-params-DDR52kg-.js";
import { n as prepareWatchedSessionsPrompt } from "./watched-sessions-prompt-jkq9d9dZ.js";
import { i as shouldPersistCompletedBootstrapTurn, n as composeSystemPromptWithHookContext, r as resolveAttemptSpawnWorkspaceDir, t as appendAttemptCacheTtlIfNeeded } from "./attempt.thread-helpers-CM0JLs3S.js";
import { c as buildInboundMediaNoteProjection, o as formatContextJsonBlock, r as hasPersistedMedia, t as isReasoningTagProvider } from "./provider-utils-y6gc_xvb.js";
import { i as readPersistedMediaImageLayout, r as hydratePromptMediaMessages, t as detectAndLoadPromptImages } from "./images-B2Oatti_.js";
...
import { a as runAgentCleanupStep, c as estimateLlmBoundaryTokenPressure, d as shouldPreemptivelyCompactBeforePrompt, f as resolveContextWindowTokens, g as shouldAllowProviderOwnedThinkingReplay, h as resolveTranscriptPolicy, i as buildEmbeddedAttemptToolRunContext, l as estimateRenderedLlmBoundaryTokenPressure, m as providerRequiresSignedThinking, n as projectSettledTurnFinalizationAttemptResult, o as PREEMPTIVE_OVERFLOW_ERROR_TEXT, p as summarizeInStages, s as buildPrePromptContextBudgetStatus, u as formatPrePromptPrecheckLog } from "./settled-turn-finalization-result-C2xKQp6X.js";
import { i as computeAdaptiveChunkRatioWithWorker } from "./compaction-planning-worker-4bCm00Vh.js";
import { n as buildRuntimeContextCustomMessage, r as resolveRuntimeContextPromptParts, t as buildCurrentInboundPrompt } from "./runtime-context-prompt-DCxhCjxM.js";
import { t as sanitizeDiagnosticPayload } from "./payload-redaction-BCo-KKmQ.js";
import { t as safeJsonStringify } from "./safe-json-CY5cd4H1.js";
import { n as toTrajectoryToolDefinitions, t as createTrajectoryRuntimeRecorder } from "./runtime-DfPrTYmB.js";
...
import { a as sanitizeSupportSnapshotValue, t as redactPathForSupport } from "./diagnostic-support-redaction-BhF7FUEH.js";
import { d as resolveFinalAssistantVisibleText, u as resolveFinalAssistantRawText, v as resolveReportedModelRef } from "./helpers-CjOkrErD.js";
import { i as resolveSessionWriteLockOptions, n as resolveSessionLockMaxHoldFromTimeout, o as resolveSessionWriteLockTargetKey, t as acquireSessionWriteLock } from "./session-write-lock-Cd3jxq-d.js";
import "./tool-loop-detection-C17xfF8b.js";
import { i as runAgentHarnessBeforeAgentFinalizeHook } from "./lifecycle-hook-helpers-CVo05dyc.js";
...
import { a as toToolDefinitions, i as toClientToolDefinitions, n as findClientToolNameConflicts, t as createClientToolNameConflictError } from "./agent-tool-definition-adapter-BwIuPB8Y.js";
import { n as isQueryStopWordToken, t as extractKeywords } from "./query-expansion-DzoKGtnD.js";
import { t as createAgentToolResultMiddlewareRunner } from "./tool-result-middleware-DZdwDKaS.js";
import { B as resolveCodeModeSkills } from "./code-mode-state-Beg8-76R.js";
import { i as createCodeModeTools, n as resolveAgentToolSurfacePlan, r as addClientToolsToCodeModeCatalog, t as applyAgentToolSurfaceCatalog } from "./tool-surface-plan-B0dbDJzr.js";
import { t as splitSdkTools } from "./tool-split-21E7Va09.js";
import { n as resolveSandboxContext } from "./context-C139Uthy.js";
import "./sandbox-BHXEMQc2.js";
import { i as resolveEmbeddedRunSkillEntries, n as mapSandboxSkillUsagePaths, r as resolveSandboxSkillRuntimeInputs, t as mapSandboxSkillEntriesForPrompt } from "./sandbox-skills-D8IoWhrH.js";
import { n as applySkillEnvOverridesFromSnapshot, t as applySkillEnvOverrides } from "./env-overrides-B2rkClCo.js";
import { t as getMachineDisplayName } from "./machine-name-BrgyEOxu.js";
import { n as collectRuntimeChannelCapabilities, t as buildSystemPromptReport } from "./system-prompt-report-C5lhUCuO.js";
import { r as resolveEmbeddedSandboxInfoExecPolicy, t as buildEmbeddedSandboxInfo } from "./sandbox-info-CKzCKg96.js";
import { t as completeWithPreparedSimpleCompletionModel } from "./simple-completion-runtime-CxQ3y0xz.js";
...
* telemetry.
*/
const execApprovalReplyModuleLoader = createLazyImportLoader(() => import("./exec-approval-reply-VMNP4XKd.js"));
...
async function handleToolExecutionEnd(ctx, evt) {
	...
	if (didDeliverMessagingResult && isDeliveredMessageToolOnlySourceReplyResult({
...
function createEmbeddedAttemptRunAbort(input) {
	...
	return (isTimeout = false, reason) => {
		...
		releaseEmbeddedAttemptSessionLockForAbort({
			...
			terminal: isTimeout || !isSessionsYieldAbortError(reason) && !isSessionsYieldAbortReason(reason)
		});
	};
}
/**
...
function releaseEmbeddedAttemptSessionLockForAbort(params) {
	params.sessionLockController.releaseHeldLockForAbort({
...
async function prepareEmbeddedAttemptBundleTools(params) {
	const { cronCreatorToolAllowlist, effectiveToolsAllow, inheritedToolAllowlist, localModelLeanPreserveToolNames, runtimeCapabilityProfile, toolsEnabled, toolsRaw } = params.preparedToolBase;
...
const PROMPT_DISPOSE_SETTLE_TIMEOUT_MS = 5e3;
function createPromptSubmissionAbortError(reason) {
	if (reason instanceof Error) return reason;
	return reason === void 0 ? /* @__PURE__ */ new Error("attempt aborted before prompt submission") : new Error("attempt aborted before prompt submission", { cause: reason });
}
...
async function acquireEmbeddedAttemptSessionFileOwner(params) {
	...
	return {
		sessionFileKey: params.sessionFile,
		release() {}
	};
}
...
async function createEmbeddedAttemptSessionLockController(params) {
	...
	let promptSubmissionBlockedError;
	let takeoverDetected = false;
	const assertInitialLockOwned = () => {
		try {
			noOpLock.assertOwned?.();
		} catch (error) {
			if (isSessionWriteLockAcquireError(error)) takeoverDetected = true;
			throw error;
		}
	};
	...
	let reloadFailure;
	let disposePromise;
	let cleanupReleasePromise;
	let cleanupLockGranted = false;
	let cleanupOwnershipReleased;
	let resolveCleanupOwnershipReleased;
	let rejectCleanupOwnershipReleased;
	const activeWriteOperations = /* @__PURE__ */ new Set();
	const activeWriteOperation = new AsyncLocalStorage();
	...
	const drainLifecycleOwner = async (owner) => {
		...
		while (owner.pendingOperations.size > 0) {
			...
			const rejection = (await Promise.allSettled(pending)).find((result) => result.status === "rejected");
	...
	const runLifecycleOwner = async (owner, run) => {
		...
		if (primaryFailed) {
			if (drainFailed && drainError !== primaryError && primaryError instanceof Error && primaryError.cause === void 0) try {
	...
	const reloadPromptReleasedState = async () => {
		if (reloadFailed) throw reloadFailure;
		try {
			...
			reloadFailed = true;
			reloadFailure = error;
			if (error instanceof EmbeddedAttemptSessionTakeoverError) takeoverDetected = true;
			throw error;
		}
	};
	const settlePromptRelease = () => {
	...
	return {
		...
		readTrustedCurrentSessionFileSnapshot: async () => void 0,
		releaseForPrompt: async () => {
			if (disposed) throw new Error("attempt disposed before prompt submission");
			await serializeLifecycle(() => {
				if (disposed) throw new Error("attempt disposed before prompt submission");
				if (promptSubmissionBlockedError) throw promptSubmissionBlockedError;
				if (cleanupStarted) throw new Error("attempt cleanup started before prompt submission");
				assertInitialLockOwned();
				promptAborted = false;
				promptReleaseNeedsReload = true;
				promptSettled = new Promise((resolve) => {
					settlePrompt = resolve;
				});
			});
		},
		isPromptSubmissionBlockedError: (error) => promptSubmissionBlockedError !== void 0 && error === promptSubmissionBlockedError,
		releaseHeldLockForAbort: async (options) => {
			promptAborted = true;
			if (options?.terminal !== false && !promptSubmissionBlockedError) promptSubmissionBlockedError = createPromptSubmissionAbortError(options?.reason);
		},
		...
		reacquireAfterPrompt: async () => {
			...
			await serializeLifecycle(async () => {
				try {
					if (disposed || cleanupStarted || promptAborted && !promptReleaseNeedsReload) return;
		...
		withSessionWriteLock: (run) => {
			...
			const activeDescendant = Boolean(parentWriteOperation?.active && activeWriteOperations.has(parentWriteOperation));
			if (disposed && !activeDescendant) return rejectWrite(/* @__PURE__ */ new Error("attempt disposed before transcript write"));
			if (cleanupStarted) return rejectWrite(/* @__PURE__ */ new Error("attempt cleanup started before transcript write"));
			const writeOperation = {
				active: true,
				started: false
			};
			const operation = serializeLifecycle(async () => {
				if (disposed && !activeDescendant) throw new Error("attempt disposed before transcript write");
				if (cleanupStarted) throw new Error("attempt cleanup started before transcript write");
				if (reloadFailed) throw reloadFailure;
				assertInitialLockOwned();
		...
		acquireForCleanup: async () => {
			...
			if (currentWriteOperation?.active && activeWriteOperations.has(currentWriteOperation)) throw new Error("cannot start attempt cleanup inside a transcript write callback");
			if (disposed) throw new Error("attempt disposed before cleanup");
			await serializeLifecycle(async () => {
				if (disposed) throw new Error("attempt disposed before cleanup");
				if (cleanupStarted) throw new Error("attempt cleanup already started");
				cleanupStarted = true;
				if (promptReleaseNeedsReload) try {
					if (!disposed) await reloadPromptReleasedState();
				} finally {
					settlePromptRelease();
				}
			});
			...
			cleanupOwnershipReleased = new Promise((resolve, reject) => {
				resolveCleanupOwnershipReleased = resolve;
				rejectCleanupOwnershipReleased = reject;
			});
			cleanupOwnershipReleased.catch(() => {});
			return { release: () => {
				cleanupReleasePromise ??= (async () => {
					try {
						while (activeWriteOperations.size > 0) await Promise.all([...activeWriteOperations].flatMap((operation) => operation.settlement ? [operation.settlement] : []));
		...
		dispose: async () => {
			const currentWriteOperation = activeWriteOperation.getStore();
			if (currentWriteOperation?.active && activeWriteOperations.has(currentWriteOperation)) throw new Error("cannot dispose an attempt from inside a transcript write callback");
			disposePromise ??= (async () => {
				...
				try {
					await Promise.race([(async () => {
						...
						while (true) {
							const pendingWrites = [...activeWriteOperations].flatMap((operation) => operation.settlement ? [operation.settlement] : []);
					...
					while (true) {
						const startedWrites = [...activeWriteOperations].filter((operation) => operation.started).flatMap((operation) => operation.settlement ? [operation.settlement] : []);
						if (startedWrites.length === 0) break;
...
function attachPromptSettlementError(promptError, settlementError) {
	if (promptError instanceof Error && promptError.cause === void 0 && settlementError !== promptError) try {
...
function installPromptSubmissionLockRelease(params) {
	...
	if (currentStreamFn.openclawSessionLockPromptReleaseInstalled === true) return;
	...
	const wrappedStreamFn = async (...args) => {
		...
		let promptResult;
		try {
			if (params.sessionFile && params.withSessionWriteLock) promptResult = await withOwnedSessionTranscriptWrites({
			...
			else promptResult = await originalStreamFn(...args);
		} catch (error) {
			promptFailed = true;
			promptError = error;
		}
		...
		if (promptFailed) {
			if (settlementFailed) attachPromptSettlementError(promptError, settlementError);
			throw promptError;
		}
...
async function resolveExistingAttemptTranscriptState(params) {
	...
	const storePath = normalizeOptionalString(params.sessionTarget?.storePath) ?? resolveStorePath(params.config?.session?.store, { agentId });
	...
	if (storePath && sessionKey) try {
		hasBootstrapTranscriptState = (await loadSqliteTranscriptEvents({
			agentId,
			sessionId,
			sessionKey,
			storePath
...
//#endregion
//#region src/agents/embedded-agent-runner/run/attempt-prompt-tool-policy.ts
function applyResolvedToolPromptFinalizer(params) {
	if (!params.finalize) return params.prompt;
	return params.finalize({
		prompt: params.prompt,
		messageToolAvailable: params.activeToolNames.some((toolName) => normalizeToolName(toolName) === "message")
	});
}
...
function applyPromptBuildToolsAllow(params) {
	...
	const allowedActiveNames = new Set(applyToolsAllow(params.baseline.activeToolNames.map((name) => ({ name })), toolsAllow).map((tool) => normalizeToolName(tool.name)));
	for (const tool of [
...
async function prepareEmbeddedAttemptPromptAssembly(input) {
	...
	const promptCacheTools = input.cache.tools.filter((tool) => promptCacheToolNameSet.has(normalizeToolName(tool.name)));
	...
	let leasedSteering;
	if (attempt.sessionKey && !input.isRawModelRun && !isSettledTurnFinalization && attempt.bootstrapContextRunKind !== "commitment-only") {
...
function truncateToolResultToChars(msg, maxChars, cache) {
	...
	if (!rawText) return replaceToolResultText(msg, formatContextLimitTruncationNotice(Math.max(1, estimateBudgetToRawChars(Math.max(estimatedChars - maxChars, 1)))));
	if (maxChars <= 0) return replaceToolResultText(msg, formatContextLimitTruncationNotice(rawText.length));
	return replaceToolResultText(msg, truncateToolResultText(rawText, maxChars, {
		minKeepChars: 0,
		minimumRawWeight: 2,
...
function prepareEmbeddedAttemptPromptContext(input) {
	...
	const maxResultCharsOverride = resolveAgentContextLimits(attempt.config, input.sessionAgentId)?.maxResultChars;
...
async function prepareEmbeddedAttemptPromptPreflight(input) {
	...
	if (preemptiveCompaction) {
		...
		const ratio = preemptiveCompaction.promptBudgetBeforeReserve > 0 ? (preemptiveCompaction.estimatedPromptTokens / preemptiveCompaction.promptBudgetBeforeReserve).toFixed(2) : "?";
		log$5.info(`[context-pressure-diagnostic] sessionKey=${attempt.sessionKey ?? attempt.sessionId ?? "?"} provider=${attempt.provider}/${attempt.modelId} route=${preemptiveCompaction.route} estimatedPromptTokens=${preemptiveCompaction.estimatedPromptTokens} promptBudgetBeforeReserve=${preemptiveCompaction.promptBudgetBeforeReserve} ratio=${ratio}` + (preemptiveCompaction.overflowTokens > 0 ? ` overflowTokens=${preemptiveCompaction.overflowTokens}` : ""));
	} else if (!shouldSkipPrecheck) {
		const ratio = input.contextTokenBudget > 0 ? (llmBoundaryTokenPressure / input.contextTokenBudget).toFixed(2) : "?";
		log$5.info(`[context-pressure-diagnostic] sessionKey=${attempt.sessionKey ?? attempt.sessionId ?? "?"} provider=${attempt.provider}/${attempt.modelId} route=fits estimatedPromptTokens=${llmBoundaryTokenPressure} promptBudgetBeforeReserve=${input.contextTokenBudget} ratio=${ratio}`);
	}
	return {
		...input.state,
		contextBudgetStatus
...
async function runEmbeddedAttemptPromptPhase(input) {
	...
	if (pendingMidTurnPrecheckRequest) await input.withOwnedSessionWriteLock(() => {
...
function shouldRetrySilentErrorAssistantTurn(params) {
	...
	if ((params.attempt.currentAttemptReplayMetadata ?? params.attempt.replayMetadata).hadPotentialSideEffects) return false;
...
function resolveSettledToolTerminalContinuationInstruction(params) {
	...
	const requestedToolCalls = Array.isArray(assistant?.content) ? assistant.content.flatMap((item) => {
		const block = item;
	...
	const allToolsProvenSettled = params.attempt.itemLifecycle?.activeCount === 0 && requestedToolCalls.length > 0 && requestedToolCalls.every(({ id, name }) => id !== null && name !== null && settledToolResults.get(id)?.toolName === name);
	...
	if (params.payloadCount !== 0 || params.hasTerminalToolPresentation || params.aborted || params.promptError != null || params.timedOut || (assistant?.stopReason === "toolUse" ? !allToolsProvenSettled : !emptyStopAfterSettledTools) || hasUnsettledToolError || hasSettledTerminalToolFailure && (hasAsyncStartedToolActivity(params.attempt.toolMetas) || hasAcceptedSessionSpawn(params.attempt.acceptedSessionSpawns)) || params.attempt.clientToolCalls || params.attempt.yieldDetected || params.attempt.didSendDeterministicApprovalPrompt) return null;
...
async function completeEmbeddedAttemptAfterTurn(input) {
	...
	if (!state.beforeAgentFinalizeRevisionReason) await input.withOwnedSessionWriteLock(async () => {
		const lifecycleState = input.readLifecycleState();
...
async function finalizeEmbeddedAttemptStreamPhase(input) {
	...
	if (beforeAgentFinalizeRevisionReason && beforeAgentFinalizeRevisionEntryId) await withOwnedSessionWriteLock(() => {
	...
	let settledStream;
	try {
		if (input.repairedRejectedThinkingReplay && !rewoundBeforeAgentFinalizeRevision) activeSession.agent.state.messages = sessionManager.buildSessionContext().messages;
		try {
			await sessionLockController.releaseForPrompt();
		} catch (err) {
			const lifecycle = input.settle.readLifecycleState();
			const expectedAbortError = isRunnerAbortError(err) || sessionLockController.isPromptSubmissionBlockedError(err);
			if (!lifecycle.aborted || !expectedAbortError) throw err;
		}
		...
		if (rewoundBeforeAgentFinalizeRevision) await withOwnedSessionWriteLock(() => {
	...
	if (input.isRawModelRun) {
		...
		if (attempt.sessionKey && !isSettledTurnFinalization) {
			...
			if (sessionEntry && suspension?.state === "resuming") {
				const subagents = listSqliteSessionEntriesReadOnly({
					storePath,
					clone: false
		...
		const limited = (() => {
			...
			return input.transcriptPolicy.repairToolUseResultPairing ? repairAttemptToolUseResultPairing(truncated, input.isOpenAIResponsesApi) : truncated;
		})();
...
function handleCompactionEnd(ctx, evt) {
	...
	if (willRetry) {
		...
		if (Array.isArray(messages)) stripStaleAssistantUsageBeforeLatestCompaction(messages, {
			mutate: true,
...
function steerActiveSession(activeSession, text, images, userTurnTranscriptRecorder, media, imageOrder) {
	if (media?.length) return activeSession.steer(text, images, userTurnTranscriptRecorder, media, imageOrder);
...
*/
async function steerAndWaitForTranscriptCommit(activeSession, text, timeoutMs, userTurnTranscriptRecorder, images, media, imageOrder) {
	await new Promise((resolve, reject) => {
		let settled = false;
		let terminalTimer;
		const finish = (err) => {
		...
		const rejectAfterCancellation = (message) => {
			cancelQueuedSteeringMessage(activeSession, text).then((removed) => {
				if (!removed) log$5.warn("failed to find queued steering message for cancellation");
			}).catch((err) => {
				log$5.warn(`failed to cancel queued steering message: ${String(err)}`);
			}).finally(() => {
		...
		steerActiveSession(activeSession, text, images, userTurnTranscriptRecorder, media, imageOrder).catch((err) => {
			finish(err);
		});
	});
}
...
async function steerActiveSessionWithOptionalDeliveryWait(activeSession, text, options, sessionKey) {
	...
	if (options?.waitForTranscriptCommit !== true) {
		await steerActiveSession(activeSession, text, options?.images, options?.userTurnTranscriptRecorder, options?.media, options?.imageOrder);
		return;
	}
	await steerAndWaitForTranscriptCommit(activeSession, text, options.deliveryTimeoutMs ?? DEFAULT_QUEUE_TRANSCRIPT_COMMIT_TIMEOUT_MS, options.userTurnTranscriptRecorder, options.images, options.media, options.imageOrder);
}
//#endregion
...
function prepareEmbeddedAttemptStream(input) {
	...
	const queueHandle = {
		...
		queueMessage: async (text, options) => {
			if (!acceptingSteerMessages) throw new Error("active session is finalizing");
		...
		const wrapped = (model, context, options) => {
			...
			const nextOnPayload = (payload) => {
				...
				record({
					...
					payloadDigest: digest$2(redactedPayload)
				});
...
function summarizeMessages(messages) {
	const messageFingerprints = messages.map((msg) => digest$1(msg));
	return {
		messageCount: messages.length,
		messageRoles: messages.map((msg) => msg.role),
		messageFingerprints,
		messagesDigest: digest$1(messageFingerprints.join("|"))
	};
}
...
function createCacheTrace(params) {
	...
	const recordStage = (stage, payload = {}) => {
		...
		if (payload.system !== void 0 && cfg.includeSystem) {
			...
			event.systemDigest = digest$1(payload.system);
		}
...
function repairRejectedThinkingReplayInSessionManager(params) {
	...
	log$5.warn(`[session-recovery] stripped thinking blocks after provider rejected replay: repaired=${rewriteResult.rewrittenEntries} sessionKey=${params.sessionKey ?? params.sessionId ?? "unknown"}`);
	return {
		repaired: true,
	...
	if (input.transcriptPolicy.preserveSignatures || input.transcriptPolicy.dropThinkingBlocks || input.transcriptPolicy.dropReasoningFromHistory) session.agent.streamFn = wrapAnthropicStreamWithRecovery(session.agent.streamFn, {
		...
		onRecoveredAnthropicThinking: () => {
			if (!input.sessionManager) {
				log$5.warn(`[session-recovery] unable to repair rejected thinking replay: session manager unavailable sessionId=${session.sessionId}`);
				return;
			}
			...
			log$5.warn(`[session-recovery] rejected thinking replay retry succeeded but transcript repair made no changes: sessionId=${session.sessionId} reason=${repair.reason ?? "unknown"}`);
		}
	});
...
async function prepareEmbeddedAttemptStreamRuntime(input) {
	...
	const promptActiveSession = (prompt, options) => withOwnedSessionTranscriptWrites(input.ownedTranscriptWriteContext, async () => {
		if (input.runAbortController.signal.aborted) return abortable$1(Promise.resolve());
		return abortable$1(input.trackPromptSettlePromise(activeSession.prompt(prompt, options)));
	});
...
async function runEmbeddedAttemptExecutionPhase(input) {
	...
	const preparedStreamRuntime = await prepareEmbeddedAttemptStreamRuntime({
		...
		lifecycle: {
			...
			markIdleTimedOut: () => mergeTerminal({
				kind: "timeout",
				phase: "prompt",
				source: "idle"
			}),
...
async function cleanupEmbeddedAttemptSessionPhase(input) {
	...
	if (shouldPreservePromptError) {
		log$5.warn(`embedded attempt cleanup detected session takeover after prompt failure; preserving prompt error: runId=${attempt.runId} sessionId=${attempt.sessionId} promptError=${formatErrorMessage(finalState.promptError)} cleanupError=${formatErrorMessage(cleanupFailure)}`);
...
async function resolveAgentRunSessionTarget(params) {
	...
	const compatibilitySessionKey = plainCompatibilitySessionKey || legacySessionFile?.startsWith("agent:") || legacySessionFile?.startsWith("in-memory:") ? legacySessionFile : void 0;
	const markerEntries = legacyMarker && !hasCompleteTypedTarget ? listSessionEntries({
	...
	const sessionKey = targetSessionKey ?? suppliedSessionKey ?? compatibilitySessionKey ?? markerSessionKey ?? normalizeOptionalString(sessionId);
	...
	const effectiveAgentId = agentId ?? resolveAgentIdFromSessionKey(sessionKey, resolveDefaultAgentId(params.config ?? {}));
	if (sessionTarget && sessionKey) {
		const storePath = targetStorePath ?? legacyMarker?.storePath ?? resolveStorePath(params.config?.session?.store, { agentId: effectiveAgentId });
...
var ProviderPromptRetryNoProgressError = class extends Error {
	constructor(payloadBytes) {
		super(`Context overflow: refusing to resend the byte-identical provider payload after a context rejection (payloadBytes=${payloadBytes}).`);
...
function createProviderPromptState() {
	return {};
}
...
function assertProviderPromptRetryProgress(state, candidate) {
	...
	if (!rejected || rejected.scopeDigest !== candidate.scopeDigest) return;
	if (rejected.digest === candidate.digest) throw new ProviderPromptRetryNoProgressError(candidate.byteWeight);
}
function beginProviderPromptAttempt(state) {
	state.lastAttempt = void 0;
}
function recordProviderPromptAttempt(state, snapshot) {
...
function wrapStreamFnWithProviderPromptState(params) {
	return async (model, context, options) => {
		...
		return await params.streamFn(model, context, {
			...options,
...
function installEmbeddedAttemptContextGuards(input) {
	...
	const toolResultMaxChars = resolveLiveToolResultMaxChars({
		contextWindowTokens: contextTokenBudget,
		...resolveAgentContextLimits(attempt.config, input.sessionAgentId)?.maxResultChars ? { maxResultCharsOverride: resolveAgentContextLimits(attempt.config, input.sessionAgentId)?.maxResultChars } : {}
	});
...
function extractOpaqueIdentifiers(text) {
	return uniqueStrings((text.match(/([A-Fa-f0-9]{8,}|https?:\/\/\S+|\/[\w.-]{2,}(?:\/[\w.-]+)+|[A-Za-z]:\\[\w\\.-]+|(?<![A-Za-z0-9._-])[A-Za-z0-9._-]+\.[A-Za-z0-9._/-]+:\d{1,5}|\b\d{6,}\b)/g) ?? []).map((value) => normalizeOpaqueIdentifier(sanitizeExtractedIdentifier(value))).filter((value) => value.length >= 4)).slice(0, MAX_EXTRACTED_IDENTIFIERS);
}
...
function assembleSuffix(parts) {
	const suffix = Object.values(parts).reduce((summary, section) => appendSummarySection(summary, section ?? ""), "");
...
function formatContextSection(messages, heading) {
...
function compactionSafeguardExtension(api) {
	api.on("session_before_compact", async (event, ctx) => {
		...
		const finalizeSummary = async (body, sections) => ({ compaction: {
			summary: capCompactionSummaryPreservingSuffix(body, assembleSuffix({
				...sections,
				toolFailureSection,
				fileOpsSummary,
			...
			if (compactionProvider) try {
				...
				if (typeof providerResult === "string" && providerResult.trim()) {
					...
					return await finalizeSummary(providerResult, {
						splitTurnSection: preparation.isSplitTurn ? formatSplitTurnContextSection(turnPrefixMessages) : "",
		...
		try {
			...
			const identifiers = extractOpaqueIdentifiers(allMessages.slice(-10).map(extractMessageText).filter(Boolean).join("\n"));
			...
			for (let attempt = 0; attempt < totalAttempts; attempt += 1) {
				...
				if (!qualityGuardEnabled || !canRegenerate) break;
...
async function prepareEmbeddedAttemptAgentSession(input) {
	...
	}, { contextOverflowRecoveryOwner: attempt.contextTokenBudget === void 0 ? "session" : "caller" })).session;
...
async function prepareEmbeddedAttemptSystemPrompt(params) {
	...
	const promptMode = attempt.promptMode ?? (params.isRawModelRun ? "none" : configPromptMode ?? resolvePromptModeForSession(attempt.sessionKey));
...
async function runEmbeddedAttempt(params) {
	...
	try {
		...
		let sessionManager;
		const { compactionTimeoutMs, ownedTranscriptWriteContext, sessionLockController, withOwnedSessionWriteLock } = await measureEmbeddedAgentPreparation("attempt.session-lock", () => prepareEmbeddedAttemptSessionLock({
			attempt: params,
		...
		try {
			...
			log$5.error(`failed to release retained session lock on attempt teardown: runId=${params.runId} ${String(releaseErr)}`);
		}
...
//#endregion
export { createToolTerminalObserver as $, flushPendingToolResultsAfterIdle as A, resolveSilentToolResultReplyPayload as B, clearProviderPromptState as C, resolveAgentRunSessionTarget as D, applyAgentRunSessionTargetIdentity as E, resolveIncompleteTurnPayloadText as F, createMessageCharEstimateCache as G, shouldRetrySilentErrorAssistantTurn as H, resolveReasoningOnlyRetryInstruction as I, validateReplayTurns as J, estimateMessageCharsCached as K, resolveReplayInvalidFlag as L, hasAttemptTerminalState as M, hasYieldContinuationEvidence as N, getHistoryLimitFromSessionKey as O, resolveEmptyResponseRetryInstruction as P, logRuntimeToolSchemaQuarantine as Q, resolveRunLivenessState as R, createPreparedEmbeddedAgentSettingsManager as S, markLastProviderPromptContextRejected as T, shouldTreatEmptyAssistantReplyAsSilent as U, shouldRetryMissingAssistantTurn as V, isStrictAgenticExecutionContractActive as W, timestampOptsFromConfig as X, injectTimestamp as Y, applyResolvedToolPromptFinalizer as Z, hasMeaningfulConversationContent as _, resolveAttemptWorkspaceSandbox as a, downgradeOpenAIFunctionCallReasoningPairs as at, consumeCompactionSafeguardCancelReason as b, createEmbeddedRunStageTracker as c, collectRegisteredToolNames as d, createEmbeddedRunReplayState as et, toSessionToolAllowlist as f, buildEmbeddedExtensionFactories as g, createEmbeddedAgentResourceLoader as h, prepareAgentMemoryPrompt as i, validateGeminiTurns as it, YIELD_DIAGNOSTIC_TEXT as j, limitHistoryTurns as k, formatEmbeddedRunStageSummary as l, buildEmbeddedSystemPrompt as m, measureEmbeddedAgentPreparation as n, emitAgentItemEvent as nt, EMBEDDED_RUN_ATTEMPT_DISPATCH_STAGE as o, downgradeOpenAIReasoningBlocks as ot, applySystemPromptToSession as p, sanitizeSessionHistory as q, buildEmbeddedMessageActionDiscoveryInput as r, validateAnthropicTurns as rt, createEmbeddedRunStageSummaryEmitter as s, normalizeOpenAIResponsesToolCallIds as st, createOpenClawAgentHarness as t, observeReplayMetadata as tt, collectAllowedToolNames as u, isRealConversationMessage as v, getProviderPromptState as w, setCompactionSafeguardCancelReason as x, readPostCompactionContext as y, resolveSettledToolTerminalContinuationInstruction as z };
