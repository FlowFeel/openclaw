...
import { h as resolveGatewayWindowsTaskName, m as resolveGatewaySystemdServiceName, u as resolveGatewayLaunchAgentLabel } from "./constants-Qf4OESGR.js";
import { t as formatCliCommand } from "./command-format-C5kg4XY_.js";
import { i as refreshRemoteModelCatalog, r as REMOTE_MODEL_CATALOG_TTL_MS } from "./model-catalog-BEn_zNk0.js";
import { n as VERSION } from "./version-CeFj_iGk.js";
import { h as getNodeSqliteKysely, m as executeSqliteQueryTakeFirstSync, p as executeSqliteQuerySync, r as resolveNodeSqliteLocation } from "./node-sqlite-BJTPe7U8.js";
...
import { r as detectRespawnSupervisor, t as SUPERVISOR_HINT_ENV_VARS } from "./supervisor-markers-quX8NeI9.js";
import { a as channelToNpmTag, l as normalizeUpdateChannel } from "./update-channels-CQNa2YMG.js";
import { n as compareSemverStrings, o as resolveNpmChannelTag, t as checkUpdateStatus } from "./update-check-B-a-Gbo1.js";
import { r as CONTROL_PLANE_UPDATE_SENTINEL_META_ENV, t as CONTROL_PLANE_UPDATE_HANDOFF_STARTED_REASON } from "./update-control-plane-sentinel-CqWvq7zf.js";
...
function scheduleGatewayUpdateCheck(params) {
	...
	if ((normalizeUpdateChannel(params.cfg.update?.channel) ?? "stable") === "extended-stable" && params.cfg.update?.checkOnStart === false) return stopRemoteCatalogRefresh;
	let stopped = false;
	let timer = null;
	let running = false;
	const tick = async () => {
