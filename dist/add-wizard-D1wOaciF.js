...
import { t as applyAgentBindings } from "./agents.bindings-BmuS4uWQ.js";
...
async function loadOnboardChannels() {
	return await import("./onboard-channels-CRCe6eBh.js");
}
...
async function resolveInitialWizardChannel(raw, cfg) {
	...
	const [{ listActiveChannelSetupPlugins }, { resolveChannelSetupEntries }] = await Promise.all([import("./setup-registry-CyOT7DZt.js"), import("./discovery-CZtoPgzJ.js")]);
...
async function runChannelsAddWizardFlow(params) {
	...
	const [{ buildAgentSummaries }, onboardChannels] = await Promise.all([import("./agents.config-CCQnextq.js"), loadOnboardChannels()]);
