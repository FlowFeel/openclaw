...
import { i as resolveMatrixAccount } from "./accounts-CqEd0FYU.js";
import { n as updateMatrixAccountConfig, t as resolveMatrixConfigPath } from "./config-update-N0JcFtKV.js";
import { n as matrixSetupAdapter } from "./setup-core-BN2DBiT4.js";
import { t as withResolvedActionClient } from "./client-Zl9qQirE.js";
import { r as resolveMatrixAuthContext } from "./config-BTkVuYGB.js";
...
async function addMatrixAccount(params) {
	...
	if (accountConfig.encryption === true) {
		const { maybeBootstrapNewEncryptedMatrixAccount } = await import("./setup-bootstrap-fUS_geOc.js");
...
const loadMatrixActionClientModule = createLazyRuntimeModule(() => import("./client-BP-44IAx.js"));
