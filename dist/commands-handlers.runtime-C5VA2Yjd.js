import { a as normalizeLowercaseStringOrEmpty, c as normalizeOptionalString, i as normalizeFastMode, s as normalizeOptionalLowercaseString, t as hasNonEmptyString } from "./string-coerce-DW4mBlAt.js";
...
import { q as isBunRuntime } from "./argv-D6QuZiS5.js";
import { r as stripAnsi } from "./ansi-DbP9Z_r_.js";
...
import { r as clampInt } from "./utils-Bs67j6-3.js";
...
import { c as resolveAgentDir, o as resolveAgentConfig } from "./agent-scope-config-Dusa8eSA.js";
...
import { H as resetConfigOverrides, N as validateConfigObjectWithPlugins, U as setConfigOverride, V as getConfigOverrides, W as unsetConfigOverride, at as resolveOwnerPromptNumbers, d as readConfigFileSnapshotForWrite, l as readConfigFileSnapshot } from "./io-BsQc3Kgy.js";
...
import { a as getActivePluginChannelRegistry } from "./runtime-WkCmQTS9.js";
...
import { c as resolveContextConfigProviderForRuntime } from "./openai-routing-Db2edxk0.js";
import { _ as resolveSessionAgentIds, g as resolveSessionAgentId } from "./agent-scope-DyEposw2.js";
import { d as resolveEffectiveResponseUsage, i as isSessionDefaultDirectiveValue, l as normalizeUsageDisplay } from "./thinking.shared-k6K-6JHM.js";
import { t as resolveAgentHarnessPolicy } from "./policy-hKMGXdHG.js";
import { n as loadInstalledPluginIndexInstallRecords } from "./installed-plugin-index-record-reader-DA9P0iII.js";
import { t as parseDurationMs } from "./parse-duration-Be19e01j.js";
import { h as redactSensitiveArgv } from "./io.audit-CRLY6_C7.js";
import "./thinking-CTxMHCzD.js";
import { i as unsetConfigValueAtPath, n as parseConfigPath, r as setConfigValueAtPath, t as getConfigValueAtPath } from "./config-paths-H__p5Mi7.js";
import { t as setPluginEnabledInConfig } from "./toggle-config-bI9T0dnd.js";
...
import { a as transformConfigFileWithRetry } from "./mutate-dYcqgG_5.js";
import "./config-BBVHtcXg.js";
import { n as isRestartEnabled, t as isCommandFlagEnabled } from "./commands.flags-DOAG7Eoj.js";
import { d as scheduleGatewaySigusr1Restart, m as triggerOpenClawRestart } from "./restart-Cneg3xRO.js";
import { t as normalizeChatType } from "./chat-type-BARlA53h.js";
import "./installed-plugin-index-records-BkPV4HdU.js";
import { c as normalizeSessionDeliveryState, d as sessionDeliveryOrigin, n as deliveryContextFromSession } from "./delivery-context.shared-DR6KpKlV.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, l as resolveStorePath, r as resolveDefaultSessionStorePath } from "./paths-DSnYpBD3.js";
import { ct as loadSqliteSessionEntryReadOnly, lt as patchSqliteSessionEntry, yt as resolveSessionStorePathForScope } from "./session-accessor.sqlite-CtCo5VZ6.js";
...
import { t as resolveChannelApprovalAdapter } from "./plugins-DYLnGbXq.js";
...
import { b as scanSessionTranscriptTree } from "./session-transcript-index-NEbbnqMc.js";
...
import { J as applySessionPatchProjection, K as updateSessionEntry } from "./session-accessor-D5Or7WgI.js";
import { t as extractDeliveryInfo } from "./delivery-info-DXQpZ0K1.js";
import { o as migrateSessionEntries } from "./session-manager-codec-MEinfCA8.js";
import "./session-manager-Dn9JwolR.js";
...
import { i as isCliRuntimeAliasForProvider, s as resolveCliRuntimeExecutionProvider } from "./model-runtime-aliases-D1mCKu2G.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-CS3ZCTG9.js";
import { n as formatTaskStatusDetail, r as formatTaskStatusTitle, t as buildTaskStatusSnapshot } from "./task-status-Bo-Cq_rI.js";
import { a as isNativeCommandTurn, s as resolveCommandTurnContext } from "./command-turn-context-chpcv6RY.js";
...
import { i as resolveTextCommand, r as normalizeCommandBody } from "./commands-registry-normalize-BaFSffsi.js";
import { i as setAbortMemory, r as isAbortTrigger } from "./abort-primitives-BReFL4mn.js";
import { l as listTasksForSessionKeyForStatus, s as listTasksForAgentIdForStatus } from "./task-status-access-C-YIcrT5.js";
import { a as readAcpSessionMetaForEntry } from "./session-meta-jzIthKMh.js";
import { w as replyRunRegistry } from "./reply-run-registry-CFY_Ts2Y.js";
import { m as resolveActiveEmbeddedRunSessionId } from "./run-state-oGYwHnd-.js";
import { _ as queueEmbeddedAgentMessageWithOutcomeAsync, a as formatEmbeddedAgentQueueFailureSummary, u as isEmbeddedAgentRunActive } from "./runs-Bdk5tY9J.js";
import { t as formatTokenCount } from "./token-format-D942KbWN.js";
import "./sessions-BqBqRT1f.js";
import { r as readLatestAssistantTextFromSessionTranscript } from "./transcript-DPcNCFvI.js";
import { c as readSessionMessagesAsync } from "./session-transcript-readers-O8pyQfzE.js";
import { n as formatUsd } from "./usage-format--pf0zzCz.js";
import { I as deriveSessionTitle } from "./session-utils-row-Br8x7LNG.js";
...
import { i as resolveBootstrapTotalMaxChars, r as resolveBootstrapMaxChars } from "./bootstrap-DOyGG4hV.js";
import { G as createMessageCharEstimateCache, K as estimateMessageCharsCached, v as isRealConversationMessage } from "./builtin-openclaw-0050ajkS.js";
import { d as isTrustedMessageActionTurnIngress, f as mintMessageActionTurnCapability, h as revokeMessageActionTurnCapability } from "./code-mode-control-tools-Bts-Jy9S.js";
import { c as getFinishedSession, l as getSession } from "./bash-process-registry--IqPmVga.js";
import { a as formatDoctorNonInteractiveHint, f as writeRestartSentinel, n as clearRestartSentinel, t as buildRestartSuccessContinuation } from "./restart-sentinel-C6_-wnpH.js";
...
import { t as analyzeBootstrapBudget } from "./bootstrap-budget-U6QVxuxs.js";
...
import { n as routeReply } from "./route-reply-D4inBfdd.js";
import { t as clearSessionQueues } from "./cleanup-CYBjc1T_.js";
import "./queue-BZLakrew.js";
import { _ as authorizeConfigWriteShared, b as resolveConfigWriteTargetFromPathShared, v as canBypassConfigWritePolicyShared, x as resolveExplicitConfigWriteTargetShared, y as formatConfigWriteDeniedMessageShared } from "./channel-config-helpers-BwgkzH7b.js";
...
import { i as getSpeechProvider, o as listSpeechProviders, r as canonicalizeSpeechProviderId } from "./directives-DnFNXuz_.js";
import { a as getTtsMaxLength, c as isSummarizationEnabled, g as resolveTtsConfig, l as isTtsEnabled, o as getTtsPersona, u as listTtsPersonas, v as resolveTtsPrefsPath } from "./tts-settings-C8VLk2jJ.js";
import { C as getResolvedSpeechProviderConfig, _ as setTtsProvider, c as getLastTtsAttempt, d as setLastTtsAttempt, f as setSummarizationEnabled, g as setTtsPersona, h as setTtsMaxLength, m as setTtsEnabled, t as getTtsProvider, w as isTtsProviderConfigured } from "./runtime-api-D5D5wy1P.js";
import { n as textToSpeech } from "./tts-DJSjy-po.js";
import { n as redactConfigObject, r as redactConfigSnapshot, t as REDACTED_SENTINEL } from "./redact-snapshot-Ce9_WB-z.js";
import "./sandbox-C8V7Nism.js";
import { t as buildSystemPromptReport } from "./system-prompt-report-BhiWei2a.js";
import { n as agentHarnessExposesOpenClawTools, s as selectAgentHarness } from "./selection-DSP58ux_.js";
import { a as isBenignCompactionSkipResult, n as classifyCompactionReason } from "./compact-reasons-BdRFPqua.js";
import { o as sessionSnapshotChangesApplied } from "./session-snapshot-merge-Bi3PsSDQ.js";
import { a as markCommandSessionMetadataChanged, n as handleGoalCommand } from "./commands-goal-xCDJy0Gz.js";
import { r as resolveConversationBindingContextFromAcpCommand } from "./conversation-binding-input-5YJ3bL_E.js";
import "./commands-registry-agOYACto.js";
import { n as applyCommandTextToParams } from "./command-context-rewrite-DyA5NUca.js";
import { a as rejectNonOwnerCommand, c as requireGatewayClientScope, i as matchCommandPrefix, n as commandReply, o as rejectUnauthorizedCommand, r as defineAuthorizedTextCommand, s as requireCommandFlagEnabled, t as buildDisabledCommandReply } from "./command-gates-BOwjvdvY.js";
...
import { n as formatAbortReplyText, r as stopSubagentsForRequester, t as abortSessionRunTargetWithOutcome } from "./abort-BEhupjiU.js";
import { n as formatTimeAgo } from "./format-relative-Dd106CpA.js";
import { n as setChannelConversationBindingMaxAgeBySessionKey, t as setChannelConversationBindingIdleTimeoutBySessionKey } from "./conversation-bindings-D8R39qKk.js";
import { l as removeChannelAllowFromStoreEntry, n as addChannelAllowFromStoreEntry, s as readChannelAllowFromStore } from "./pairing-store-CNA_dhgo.js";
import { n as formatNonClawHubInstallWarning, t as NON_CLAWHUB_INSTALL_FORCE_FLAG } from "./install-provenance-B5aa9rpU.js";
import { t as handleSystemAgentCommand } from "./commands-system-agent-BLVn8YJt.js";
import { n as resolveSkillWorkshopToolPolicyAvailability } from "./tool-policy-diagnostic-gbLOFvF1.js";
...
import { a as resolveSkillCommandInvocation, t as listSkillCommandsForAgents } from "./chat-commands-Cx9y1U0p.js";
import { t as persistReplySessionEntry } from "./session-entry-persistence-BnKc-1eY.js";
import { n as resolveEffectiveToolInventory, t as resolveConfiguredModelCompat } from "./tools-effective-inventory-qqe1xxdf.js";
import { t as extractBtwQuestion } from "./btw-command-BebB9vbl.js";
import { r as handleModelsCommand } from "./commands-models-D12TEuxb.js";
import { n as buildCommandsMessagePaginated, r as buildHelpMessage, t as buildCommandsMessage } from "./command-status-builders-C3vLifmx.js";
import { t as codexChannelLoginRuntime } from "./provider-auth-login-flow-runtime-BCA3EROs.js";
import { r as createExecTool } from "./bash-tools-BOFA-MJ7.js";
import { t as runBtwSideQuestion } from "./btw-Dn9W8Od7.js";
import { a as loadCostUsageSummary, n as loadSessionCostSummary } from "./session-cost-usage-BhR_rUA-.js";
import { n as buildThreadingToolContext } from "./agent-runner-utils-DPJVdEXA.js";
import { C as stopWithText, b as resolveAcpAction, d as COMMAND, x as resolveAcpHelpText } from "./shared-tV_jsXaL.js";
import { a as resolveHandledPrefix, c as resolveSubagentsAction, l as stopWithText$1, o as resolveRequesterSessionKey } from "./shared-Dd6sVZF-.js";
import { t as buildToolsMessage } from "./status-B4zkwMSU.js";
import { n as resolveCommandSurfaceChannel, t as resolveChannelAccountId } from "./channel-context-CzHBLQ-g.js";
import { t as handleApproveCommand } from "./commands-approve-BycmO3uM.js";
import { t as buildConfigSchema } from "./schema-4_J7u0cW.js";
import { t as loadGatewayRuntimeConfigSchema } from "./runtime-schema-Di48XSCd.js";
...
import { n as buildStatusReply, t as buildStatusPluginsReply } from "./commands-status-D0AMHplE.js";
import { n as setConfiguredMcpServer, r as unsetConfiguredMcpServer, t as listConfiguredMcpServers } from "./mcp-config-D9zh1f4a.js";
import { n as refreshPluginRegistryAfterConfigMutation } from "./registry-refresh-Cg60AEHC.js";
import { a as buildPluginDiagnosticsReport, c as formatPluginCompatibilityNotice, o as buildPluginInspectReport, t as buildAllPluginInspectReports } from "./status-DBhSQc1q.js";
import { t as buildPluginRegistrySnapshotReport } from "./status-snapshot-DbeROQy-.js";
import { a as selectInstallMutationWriteOptions, i as resolveInstallConfigMutationPreflights } from "./install-persistence-DKIhWexy.js";
import { t as withPluginLifecycleLease } from "./plugin-lifecycle-lease-Cmmxy1R1.js";
import { r as resolvePluginInstallSourcePlan } from "./plugin-install-plan-B0dOu6aB.js";
import { n as createPluginInstallLogger } from "./plugins-command-helpers-B1awJZft.js";
import { t as CLAWHUB_INSTALL_ERROR_CODE } from "./clawhub-error-codes-OgrR1N6P.js";
import "./clawhub-BBoMPCcf.js";
import { a as installManagedPluginSource } from "./management-service-DX2CuUsy.js";
...
const lifecycleHandlersLoader = createLazyImportLoader(() => import("./lifecycle-DKIvth5f.js"));
const runtimeOptionHandlersLoader = createLazyImportLoader(() => import("./runtime-options-DlooXO9u.js"));
const diagnosticHandlersLoader = createLazyImportLoader(() => import("./diagnostics-ogHAipww.js"));
...
async function handleBashChatCommand(params) {
	...
	if (request.action === "stop") {
		...
		const { killProcessTree } = await import("./kill-tree-BXZQeSb9.js");
		killProcessTree(pid);
...
function formatCompactionReason(reason) {
	...
	switch (classification) {
		...
		case "already_compacted": return "session is already compacted";
		default: return text;
	}
}
...
const handleCompactCommand = async (params) => {
	...
	const compactionStorePath = resolveSessionStorePathForScope({
		agentId: sessionAgentId,
		sessionKey: params.sessionKey,
		storePath: params.storePath ?? resolveStorePath(params.cfg.session?.store, { agentId: sessionAgentId })
	});
	const result = await runtime.compactEmbeddedAgentSession({
		...
		contextTokenBudget,
		agentHarnessId: targetSessionEntry.modelSelectionLocked === true ? resolvePersistedSessionRuntimeId(targetSessionEntry) : selectedRuntime ?? (targetSessionEntry.agentRuntimeOverride ? void 0 : targetSessionEntry.agentHarnessId),
...
async function resolveContextReport(params) {
	...
	const { resolveCommandsSystemPromptBundle } = await import("./commands-system-prompt-CnECoDSO.js");
...
async function persistAbortTargetEntry(params) {
	...
	if (storePath) await patchSqliteSessionEntry({
		storePath,
		sessionKey: key
	}, (nextEntry) => {
...
async function readSessionDataFromIdentity(params) {
	const { entries, warnings } = filterSessionEntriesWithWarnings(await loadSqliteTranscriptEvents(params));
...
const handlePluginCommand = async (params, allowTextCommands) => {
	...
	const sessionTarget = targetSessionEntry?.sessionId ? {
		...
		storePath: resolveSessionStorePathForScope({
			agentId: targetAgentId,
			sessionKey: params.sessionKey,
			storePath: params.storePath ?? resolveStorePath(cfg.session?.store, { agentId: targetAgentId })
		})
	} : void 0;
	if (!allowTextCommands) return null;
		...
		const sessionSummary = await loadSessionCostSummary({
			...
			...targetSessionEntry?.sessionId && params.sessionKey ? { sessionTarget: {
				...
				storePath: resolveSessionStorePathForScope({
					agentId: usageAgentId,
					sessionKey: params.sessionKey,
					storePath: params.storePath ?? resolveStorePath(params.cfg.session?.store, { agentId: usageAgentId })
				})
			} } : {},
			config: params.cfg,
			agentId: usageAgentId
...
const actionAgentsLoader = createLazyImportLoader(() => import("./action-agents-8bJ-l0By.js"));
const actionFocusLoader = createLazyImportLoader(() => import("./action-focus-Dbqk4OPB.js"));
const actionHelpLoader = createLazyImportLoader(() => import("./action-help-DrFU7i5D.js"));
const actionInfoLoader = createLazyImportLoader(() => import("./action-info-T-8qbwJd.js"));
const actionListLoader = createLazyImportLoader(() => import("./action-list-Bipuem5j.js"));
const actionLogLoader = createLazyImportLoader(() => import("./action-log-C-NcQfcA.js"));
const actionUnfocusLoader = createLazyImportLoader(() => import("./action-unfocus-BXoVSfca.js"));
