...
import "./worker-admission-cYaTLkLk.js";
import { t as WORKER_INFERENCE_MAX_CONTEXT_MESSAGES } from "./worker-inference-jzapa-pT.js";
import { J as SettingsManager, i as DefaultResourceLoader, mt as AuthStorage, rt as ModelRegistry, t as createAgentSession } from "./sessions-Cj7BqXHP.js";
import { t as guardSessionManager } from "./session-tool-result-guard-wrapper-04yd5fAd.js";
import { t as SessionManager } from "./session-manager-dOl3u7vE.js";
import { t as DEFAULT_AGENTS_FILENAME, y as loadWorkspaceBootstrapFiles } from "./workspace-CelKqYGr.js";
import { t as getProcessSupervisor } from "./supervisor-CT1BR809.js";
import { n as buildBootstrapContextForFiles } from "./bootstrap-files-BmlEwlGk.js";
import { t as createOpenClawCodingTools } from "./agent-tools-Ske_S_5A.js";
import { a as toToolDefinitions } from "./agent-tool-definition-adapter-BwIuPB8Y.js";
import { n as createNativeModelOwnedRuntimeModel } from "./setup-DsVBMia4.js";
import { t as WORKER_LOCAL_TOOL_NAMES } from "./tool-authority-CJ-HJhS-.js";
import { a as toWorkerTranscriptMessage, i as isWorkerTranscriptMessageFrameSafe, n as cloneTextContent, r as cloneUsage, t as cloneImageContent } from "./transcript-message-oguPQDoF.js";
...
async function runWorkerEmbeddedTurn(params) {
	...
	for (const toolName of WORKER_LOCAL_TOOL_NAMES) if (!discoveredToolNames.has(toolName)) throw new Error(`Worker coding tool unavailable: ${toolName}`);
