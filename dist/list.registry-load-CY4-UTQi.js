...
import { l as normalizeDiscoveredAgentModel } from "./prepared-model-runtime.facts-jIGnnAPL.js";
import { mt as AuthStorage } from "./sessions-Cj7BqXHP.js";
import { f as PreparedModelRuntimeOwnerNotPublishedError, n as acquireReadOnlyPreparedModelRuntime, s as prepareModelRuntimeSnapshot } from "./prepared-model-runtime-CXHnGzH_.js";
...
async function loadModelRegistry(cfg, opts) {
	...
	const { config: runtimeConfig, registry } = await loadPreparedAgentModelRegistry(cfg, {
