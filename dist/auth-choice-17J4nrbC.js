...
import { c as resolveAgentDir, d as resolveDefaultAgentDir, f as resolveDefaultAgentId, u as resolveAgentWorkspaceDir } from "./agent-scope-config-Dusa8eSA.js";
import "./agent-scope-DyEposw2.js";
import { o as canonicalizeProviderModelId } from "./openai-model-routes-NsaPlbzf.js";
...
import { c as publishPreparedModelRuntimeSnapshot } from "./prepared-model-runtime-CXHnGzH_.js";
...
import { r as prepareAuthChoiceLoadedPluginProvider } from "./provider-auth-choice-DHTal3VW.js";
import { t as buildProviderAuthRecoveryHint } from "./provider-auth-recovery-hint-DQlA-4A9.js";
import "./provider-auth-choice-preference-QOMG_HOH.js";
...
async function normalizeLegacyChoice(authChoice, params) {
	...
	const { normalizeLegacyOnboardAuthChoice } = await import("./auth-choice-legacy-Dyt7E88i.js");
...
async function normalizeTokenProviderChoice(params) {
	...
	const { normalizeApiKeyTokenProviderAuthChoice } = await import("./auth-choice.apply.api-providers-CAQ-fDqz.js");
...
async function formatDeprecatedProviderChoiceError(authChoice, params) {
	...
	const { resolveManifestDeprecatedProviderAuthChoice } = await import("./provider-auth-choices-W1tcpoPy.js");
	...
	const { resolveDeprecatedProviderInstallCatalogEntry } = await import("./provider-install-catalog-Cba7gtUl.js");
