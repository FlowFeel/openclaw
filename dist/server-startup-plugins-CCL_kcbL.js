...
import { g as collectUnregisteredConfiguredMemoryEmbeddingProviders, h as collectRegisteredEmbeddingProviderIds } from "./gateway-startup-plugin-ids-C6NYFwsv.js";
import { E as setActivePluginRegistry, I as createEmptyPluginRegistry, d as getActivePluginRegistry } from "./runtime-yJAYArQt.js";
import "./loader-BmgwYkg7.js";
import "./agent-scope-DyEposw2.js";
import { r as listAmbientOnlyConfiguredChannelIds } from "./channel-presence-policy-DhrCS5Fz.js";
import "./channel-plugin-ids-DnoOYgMp.js";
import { t as loadPluginLookUpTable } from "./plugin-lookup-table-C32fpUrq.js";
import { m as initSubagentRegistry } from "./subagent-registry-DYNpeCqO.js";
import { r as resolveGatewayStartupPluginActivationConfig } from "./plugin-activation-runtime-config-Cd8hUI0Q.js";
import { n as listGatewayMethods } from "./server-methods-list-BqH1fA41.js";
...
async function runGatewayStartupMaintenance(params) {
	...
	if (!params.minimalTestGateway || startupMaintenanceConfig.channels !== void 0) {
		const { runChannelPluginStartupMaintenance } = await import("./lifecycle-startup-DD2nWWhd.js");
		...
		if (!params.minimalTestGateway) {
			const { runStartupSessionMigration } = await import("./server-startup-session-migration-CzkfK-Tj.js");
			startupTasks.push(runStartupSessionMigration({
				cfg: params.cfgAtStart,
				env: process.env,
				log: params.log
			}));
			const { migrateLegacyDevicePairingStore } = await import("./device-pairing-migration-Bjr0pxcK.js");
			const { migrateLegacyNodePairingStore } = await import("./node-pairing-migration-D7oR0X9m.js");
...
async function loadGatewayStartupPluginRuntime(params) {
	const { loadGatewayStartupPlugins } = await import("./server-plugin-bootstrap-u7Zeh5yO.js");
