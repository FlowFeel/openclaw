...
import { s as readBestEffortConfig } from "./io-BsQc3Kgy.js";
import { n as isRich, r as theme } from "./theme-vjDs9tao.js";
import "./config-BBVHtcXg.js";
import { t as formatDocsLink } from "./links-ClIwBcy4.js";
import "./method-scopes-BPNMlnDQ.js";
import { n as APPROVALS_SCOPE, t as ADMIN_SCOPE } from "./operator-scopes-Dw7Gu2cA.js";
...
import { J as readExecApprovalsSnapshot, Q as updateExecApprovals, t as normalizeExecApprovals } from "./exec-approvals-sCmCk_jQ.js";
...
import { n as collectExecPolicyScopeSnapshots, t as SESSION_EXEC_OVERRIDES_NOTE } from "./exec-approvals-effective-B2jH3OH5.js";
import { a as nodesCallOpts, d as resolveNodeId } from "./rpc-PLf3iGqH.js";
...
function buildEffectivePolicyReport(params) {
	...
	if (!params.approvals) return {
		scopes: [],
		note: params.nativePolicy ? "This node enforces a host-native exec policy; OpenClaw approvals-file policy math does not apply." : "Host approvals policy unavailable."
	};
	if (params.source === "node") {
		...
		return {
			...
			note: "Effective exec policy is the node host approvals policy intersected with gateway tools.exec policy. " + SESSION_EXEC_OVERRIDES_NOTE
		};
	}
	if (!cfg) return {
		scopes: [],
	...
	return {
		...
		note: "Effective exec policy is the host approvals policy intersected with requested tools.exec policy. " + SESSION_EXEC_OVERRIDES_NOTE
	};
}
