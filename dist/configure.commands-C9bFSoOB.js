...
import { g as resolveGatewayPort, t as CONFIG_PATH } from "./paths-CL43LNS6.js";
...
import { Q as ConfigMutationConflictError, b as createConfigIO, d as readConfigFileSnapshotForWrite, r as getRuntimeConfig } from "./io-DCw4R0kD.js";
import { f as isValidEnvSecretRefId, u as isSecretRef } from "./types.secrets-BvApkFoj.js";
...
import { o as resolvePluginContributionOwners } from "./plugin-registry-contributions-DAYph4GM.js";
import "./plugin-registry-BKsO1htA.js";
import "./mutate-j69oSRi2.js";
import "./config-UtpOr1Uw.js";
import { a as isNonFatalSystemdInstallProbeError } from "./systemd-CwfIwjqs.js";
import { n as gatewayInstallErrorHint, t as buildGatewayInstallPlan } from "./daemon-install-helpers-BxEqbMrR.js";
import { n as GATEWAY_DAEMON_RUNTIME_OPTIONS, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-CHOL1Kuf.js";
import { t as resolveGatewayInstallToken } from "./gateway-install-token-B3a0ecWZ.js";
import { a as findTailscaleBinary } from "./tailscale-CDFP6Kpp.js";
import { t as randomToken } from "./random-token-B1woZa_H.js";
import { a as resolveGatewayService, t as describeGatewayServiceRestart } from "./service-BUC2FMQ8.js";
import { o as formatPortRangeHint } from "./error-format-BZ5G9eas.js";
import { t as parsePort } from "./parse-port-BAdnLGe2.js";
import { r as resolveLocalControlUiProbeLinks, t as resolveAdvertisedControlUiLinks } from "./control-ui-links-opBk-Hn5.js";
import { t as formatWindowsGatewayFirewallGuidance } from "./windows-gateway-firewall-diagnostics-DcuyYuX-.js";
...
import { f as probeGatewayReachable, g as waitForGatewayReachable, h as validateGatewayPasswordInput, l as normalizeGatewayTokenInput, n as applyWizardMetadata, o as guardCancel, p as summarizeExistingConfig, t as DEFAULT_WORKSPACE } from "./onboard-helpers-BlDftc97.js";
import { n as ensureOnboardingAgentWorkspace, r as resolveOnboardingAgentTarget } from "./onboard-agent-target-B75RdAGh.js";
import { t as describeCodexNativeWebSearch } from "./codex-native-web-search.shared-BAxh5I0Z.js";
...
import { t as commitConfigWithPendingPluginInstalls } from "./install-record-commit-DrWxHVRD.js";
...
import { n as promptAuthChoiceGrouped } from "./auth-choice-prompt-B-L7096b.js";
import { i as applyAuthChoice } from "./auth-choice-DuozU0GY.js";
import { t as resolvePreferredProviderForAuthChoice } from "./provider-auth-choice-preference-D5QuahNY.js";
import { i as setupChannels } from "./onboard-channels-DnQUOPm6.js";
import { t as resolveSetupSecretInputString } from "./setup.secret-input-B3-TUniE.js";
import { n as mergeWizardConfigOntoLatest } from "./setup.shared-D0iINifk.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-9a7R3b7C.js";
import { n as loadStaticManifestCatalogRowsForList } from "./list.manifest-catalog-Au9HfECs.js";
import { i as promptModelAllowlist, n as applyModelFallbacksFromSelection, r as promptDefaultModel, t as applyModelAllowlist } from "./model-picker-CcohJr1L.js";
import { t as promptCustomApiConfig } from "./onboard-custom-BZgVu4MB.js";
import { a as validateDottedDecimalIPv4Input, i as maybeAddTailnetOriginToControlUiAllowedOrigins, n as TAILSCALE_EXPOSURE_OPTIONS, r as TAILSCALE_MISSING_BIN_NOTE_LINES, t as TAILSCALE_DOCS_LINES } from "./gateway-config-prompts.shared-BgVACWlT.js";
import { r as formatHealthCheckFailure } from "./health-format-eGOFBXrJ.js";
import { a as healthCommand } from "./health-DRgbeQyw.js";
import { t as promptRemoteGatewayConfig } from "./onboard-remote-BFppbWUD.js";
import { t as setupSkills } from "./onboard-skills-C4DPE5Cp.js";
...
const setupPluginConfigModuleLoader = createLazyImportLoader(() => import("./setup.plugin-config-elJ3ufR_.js"));
...
async function promptWebToolsConfig(nextConfig, runtime, prompter) {
	...
	const { isCodexNativeWebSearchRelevant } = await import("./codex-native-web-search-w9kJmqcg.js");
	...
	if (enableSearch) {
		...
		if (configureManagedProvider) {
			const { resolveSearchProviderOptions, runSearchSetupFlow } = await import("./search-setup-_GwBF9uB.js");
...
async function runConfigureWizard(opts, runtime = defaultRuntime) {
	try {
		...
		const promptGatewayRunMode = async () => {
			...
			const localProbePromise = (async () => {
				...
				return probeGatewayReachable({
					...
					password: normalizeOptionalString(process.env.OPENCLAW_GATEWAY_PASSWORD) ?? baseLocalProbePassword,
		...
		const configureWorkspace = async () => {
			...
			nextConfig = targetEntry?.workspace !== void 0 ? {
				...nextConfig,
				agents: {
					...nextConfig.agents,
					entries: {
		...
		if (selectedSections) {
			...
			for (const section of [
				...
				"plugins",
				"skills"
			]) if (selectedSections.includes(section)) await sectionActions[section]();
			await persistConfig();
			...
			while (true) {
				...
				if (choice !== "daemon" && choice !== "health") await persistConfig();
			}
			if (!ranSection) {
		...
		const newPassword = normalizeOptionalString(process.env.OPENCLAW_GATEWAY_PASSWORD) ?? await resolveGatewaySecretInputForWizard({
			cfg: nextConfig,
			value: nextConfig.gateway?.auth?.password,
			path: "gateway.auth.password"
		});
		const oldPassword = normalizeOptionalString(process.env.OPENCLAW_GATEWAY_PASSWORD) ?? await resolveGatewaySecretInputForWizard({
			cfg: baseConfig,
			value: baseConfig.gateway?.auth?.password,
			path: "gateway.auth.password"
		});
		const token = normalizeOptionalString(process.env.OPENCLAW_GATEWAY_TOKEN) ?? await resolveGatewaySecretInputForWizard({
			cfg: nextConfig,
