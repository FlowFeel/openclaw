...
import { t as matrixPluginBase } from "./channel.setup-CQ8HMpou.js";
import { n as normalizeCompatibilityConfig, t as legacyConfigRules } from "./doctor-contract-s-3inccd.js";
import { r as resolveMatrixRoomScopePath, t as buildMatrixRoomScopeTree } from "./rooms-MA4iSP9b.js";
...
const matrixNativeApprovalCapability = createApproverRestrictedNativeApprovalCapability({
	...
	nativeRuntime: createLazyChannelApprovalNativeRuntimeAdapter({
		...
		load: async () => (await import("./approval-handler.runtime-Ch_bFpju.js")).matrixApprovalNativeRuntime
	})
});
...
const loadMatrixChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-CsercOdY.js"), "matrixChannelRuntime");
...
const matrixPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			...
			try {
				monitorMatrixProvider = (await import("./monitor-DVyThNvK.js")).monitorMatrixProvider;
			} finally {
				releaseLock();
			}
