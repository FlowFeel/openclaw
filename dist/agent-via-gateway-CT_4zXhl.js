...
import { S as readGatewayDispatchConfigWithShellEnvFallback, _ as isGatewayTransportError, c as callGateway, g as isGatewayExplicitAuthRequiredError, h as isGatewayCredentialsRequiredError, v as randomIdempotencyKey, x as readGatewayDispatchConfig } from "./call-YSl9HPoR.js";
...
async function startOneShotDiagnosticsExporters(params) {
	...
	const [{ loadOpenClawPlugins }, { startPluginServices }] = await Promise.all([import("./plugins/loader.js"), import("./services-CDjhPJ6J.js")]);
...
const embeddedAgentCommandLoader = createLazyPromiseLoader(() => import("./agent-COlyptaf.js").then((module) => module.agentCommand), { cacheRejections: true });
const agentSessionModuleCache = createLazyPromiseLoader(() => agentSessionModuleLoader(), { cacheRejections: true });
const runtimeConfigModuleLoader = createLazyPromiseLoader(() => import("./io-KBO9NxB7.js"), { cacheRejections: true });
