...
import { _ as runOpenClawAgentWriteTransaction, it as resolveOpenClawAgentSqlitePath } from "./openclaw-agent-db-DemdumbZ.js";
import { f as runExclusiveSqliteSessionWrite, p as toDatabaseOptions, u as resolveSqliteTranscriptReadScope } from "./session-accessor.sqlite-scope-G-CS03gJ.js";
import { c as deletePreparedSessionTranscriptProjectionChunkInTransaction, i as listSessionsNeedingTranscriptIndexReconcile, l as finalizePreparedSessionTranscriptProjectionInTransaction, o as appendPreparedSessionTranscriptProjectionChunkInTransaction, s as claimPreparedSessionTranscriptProjectionInTransaction, t as deleteOrphanedTranscriptIndexRowsInTransaction } from "./session-transcript-index-NEbbnqMc.js";
...
async function waitForSessionTranscriptProjection(scope) {
	await waitForSessionTranscriptIndexReconcile(toDatabaseOptions(resolveSqliteTranscriptReadScope(scope)));
}
//#endregion
