...
import { l as resolveSafeTimeoutDelayMs, r as MAX_SAFE_TIMEOUT_DELAY_MS } from "./timeouts-Dbj-IGQf.js";
...
import { i as readMissingScopeError } from "./gateway-error-details-mJ5vWsi5.js";
...
async function probeGateway(opts) {
	...
	const deviceIdentity = await (async () => {
		try {
			...
			const { loadDeviceIdentityIfPresent } = await import("./device-identity-CoYeIYnk.js");
