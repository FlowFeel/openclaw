...
import { t as packageNameMatchesId } from "./install-safe-path-DL8AfrFO.js";
...
import { a as isPrereleaseResolutionAllowed, l as validateRegistryNpmSpec, n as formatPrereleaseResolutionError, o as isPrereleaseSemverVersion, r as isExactSemverVersion, s as parseRegistryNpmSpec, t as compareOpenClawReleaseVersions } from "./npm-registry-spec-CCN1EPEy.js";
import { o as sha256HexPrefix } from "./crypto-digest-CmUwt1S-.js";
import { a as resolveDefaultPluginNpmDir, f as safePluginInstallFileName, n as matchesExpectedPluginId, p as validatePluginId, t as encodePluginInstallDirName } from "./install-paths-D18EkQi8.js";
...
import { a as resolveNpmPackArchiveMetadata, n as createNpmMetadataEnv, o as resolveNpmSpecMetadata } from "./install-source-utils-YrpMqgeA.js";
import { n as createSafeNpmInstallEnv, t as createSafeNpmInstallArgs } from "./safe-package-install-CCGE7D0Q.js";
import { r as preflightPluginNpmInstallPolicy } from "./install-security-scan-Rm0IC18V.js";
import { A as resolveEffectiveInstallMode, B as listMissingRequiredPlatformPackages, C as ensureInstallTargetAvailableForMode, D as installPluginDirectoryIntoExtensions, E as hasPackageRuntimeDependencies, F as validateOpenClawPackageInstallCompatibility, G as resolveManagedNpmRootDependencySpec, H as readManagedNpmRootPeerDependencySnapshot, K as syncManagedNpmRootPeerDependencies, M as runInstallSourceScan, N as sourceFamilyForInstallPolicyKind, O as loadPluginInstallRuntime, P as sourceFamilyForInstallPolicySource, S as emitSuccessfulPluginInstallSecurityEvent, T as formatUnresolvedOpenClawPeerLinkError, U as readOpenClawManagedNpmRootOverrides, V as readManagedNpmRootInstalledDependency, W as repairManagedNpmRootOpenClawPeer, _ as resolveRequiredPlatformPackageNames, a as formatManagedNpmProjectQuarantineArtifacts, b as buildDirectoryInstallResult, c as listManagedNpmRootPackageNames, d as removeEmptyDirectoryIfPresent, f as resolveManagedNpmGenerationUseForInstall, g as resolveManagedNpmRootPackageDir, h as resolveManagedNpmRootForInstall, i as createManagedNpmPluginInstallRollbackSnapshot, j as resolvePreparedDirectoryInstallTarget, k as readOptionalPackageManifest, l as listNewManagedNpmRootPackageDirs, m as resolveManagedNpmRootDependencySpecForInstall, n as cleanupManagedNpmPluginInstallRollbackSnapshot, o as formatNpmCommandFailureOutput, p as resolveManagedNpmInstallRoot, q as upsertManagedNpmRootDependency, r as cleanupManagedNpmRootPreparedDependency, s as isManagedNpmProjectCorruptionInstallFailure, t as classifyNpmManagedOverrideCompatibilityError, u as quarantineManagedNpmProjectRebuildArtifacts, v as rollbackManagedNpmPluginInstall, w as ensureOpenClawExtensions, x as defaultLogger, y as rollbackManagedNpmRootPreparedDependency, z as PLUGIN_INSTALL_ERROR_CODE } from "./install-managed-npm-state-DKGeDQRx.js";
import { i as linkOpenClawPeerDependencies, o as relinkOpenClawPeerDependenciesInManagedNpmRoot, t as auditDeclaredOpenClawHostDependency } from "./plugin-peer-link-DXF9ykyQ.js";
...
async function installPluginFromSourceDir(params) {
	...
	if (nativePackageManifest) return await installPluginFromPackageDir({
		packageDir: params.sourceDir,
