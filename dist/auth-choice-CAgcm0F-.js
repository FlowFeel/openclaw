...
import { t as normalizeApiKeyTokenProviderAuthChoice } from "./auth-choice.apply.api-providers-BHqbe7fN.js";
...
async function applyNonInteractivePluginProviderChoice(params) {
	...
	if (codexInstall.installed) {
		const { offerPostInstallMigrations } = await import("./setup.post-install-migration-B2ejGZuz.js");
