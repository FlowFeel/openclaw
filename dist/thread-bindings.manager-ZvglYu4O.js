	...
	const manager = {
		...
		bindTarget: async (bindParams) => {
			...
			const record = {
				...
				targetKind,
				targetSessionKey,
				agentId: normalizeOptionalString(bindParams.agentId) ?? normalizeOptionalString(existingValue?.agentId) ?? resolveAgentIdFromSessionKey(targetSessionKey, resolveDefaultAgentId(cfg)),
...
//#endregion
export { isThreadArchived as a, resolveThreadBindingPersonaFromRecord as c, testing as i, createThreadBindingManager as n, resolveChannelIdForBinding as o, getThreadBindingManager as r, resolveThreadBindingPersona as s, createNoopThreadBindingManager as t };
