...
import { _ as saveDelegatedTokens, g as resolveMSTeamsCredentials, m as hasConfiguredMSTeamsCredentials } from "./graph-users-Cu2e0M9X.js";
import { d as resolveMSTeamsChannelAllowlist, p as resolveMSTeamsUserAllowlist, s as parseMSTeamsTeamEntry } from "./resolve-allowlist-B9H8xdlS.js";
	...
	finalize: async (params) => {
		...
		if (finalCreds?.type === "secret") {
			if (await params.prompter.confirm({
				...
				let oauthModule;
				try {
					oauthModule = await import("./oauth-YGIYr-E-.js");
				} catch (err) {
