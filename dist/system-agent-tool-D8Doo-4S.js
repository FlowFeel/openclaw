...
import { _ as readStringParam, n as ToolInputError } from "./common-yW0U9cHP.js";
import { n as textResult } from "./tool-results-BCM3fdVS.js";
import { s as stringEnum } from "./typebox-H9BhzMVW.js";
import { i as isPersistentSystemAgentOperation, o as validateSystemAgentPluginInstallSpec, t as executeSystemAgentOperation } from "./operations-CPFqirC1.js";
...
function directiveForOperation(operation) {
	...
	if (operation.kind === "skills-setup" || operation.kind === "search-setup" || operation.kind === "gateway-config-setup" || operation.kind === "memory-import") return operation;
...
const SystemAgentToolSchema = Type.Object({
	...
	target: Type.Optional(stringEnum([
		...
		"search",
		"gateway"
	], { description: "Setup target for open_setup. channels/search/gateway open masked terminal flows; guided/classic require exiting OpenClaw and running openclaw onboard." })),
