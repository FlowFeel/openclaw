...
import { d as readConfigFileSnapshotForWrite, r as getRuntimeConfig } from "./io-BsQc3Kgy.js";
...
import { A as withPluginRuntimeGatewayRequestScope, S as requireActivePluginRegistry, k as getPluginRuntimeGatewayRequestScope } from "./runtime-WkCmQTS9.js";
...
import { w as setRuntimeConfigSnapshot } from "./runtime-snapshot-Bzqj8IgJ.js";
import { n as DEFAULT_MODEL, r as DEFAULT_PROVIDER } from "./defaults-CdX9UGcX.js";
import { n as isThinkingLevelSupported, t as formatThinkingLevels } from "./thinking-CTxMHCzD.js";
import { C as resolveModelRefFromString, S as resolveModelAliasFromPair, a as buildModelAliasIndex, b as resolveConfiguredModelRef, i as buildConfiguredModelCatalog } from "./model-selection-shared-V7VmYFPH.js";
import { a as normalizeConfiguredProviderCatalogModelId, o as normalizeModelRef, s as normalizeProviderId } from "./model-ref-shared-BEKlpylb.js";
import { w as resolveDefaultModelForAgent } from "./codex-route-model-ref-BDwklqCa.js";
import { r as discoverConfigSecretTargetsByIds } from "./target-registry-query-CnPjWCNY.js";
import "./target-registry-BVDHguMA.js";
import { n as isStoredCredentialCompatibleWithAuthProvider } from "./order-DvicXirV.js";
import { a as getReplyPayloadMetadata } from "./reply-payload-BtIUrr9c.js";
import { d as sessionDeliveryOrigin, s as normalizeDeliveryContext, u as sessionDeliveryChannel } from "./delivery-context.shared-DR6KpKlV.js";
import "./message-channel-constants-76XnXM8q.js";
import { M as hasNonzeroUsage, lt as patchSqliteSessionEntry } from "./session-accessor.sqlite-CtCo5VZ6.js";
import { o as resolveMessageChannel, t as isDeliverableMessageChannel } from "./message-channel-normalize-Cs-kjMZm.js";
import "./message-channel-Bo27VP7K.js";
import { d as AGENT_HARNESS_MODEL_RUN_FORBIDDEN_MESSAGE, n as buildRestartRecoveryClaimCleanupPatch, ut as beginSessionWorkAdmission, v as isValidAgentHarnessSessionStoreEntry, y as resolveAgentHarnessSessionContextError } from "./session-entry-slot-keys-DPRQmSpa.js";
...
import { s as loadResolvedPublishedModelCatalogOwner, t as getPreparedModelCatalogSnapshot } from "./prepared-model-catalog-DJrhvpj1.js";
import { a as findConfiguredModelProvider, i as allowsPluginModelNormalization } from "./model-fallback-candidates-04-xfJ0g.js";
...
import { f as recordSessionHumanDirectMessage, n as classifySessionStateActor } from "./session-state-events-COmXZrBv.js";
import "./agent-run-terminal-outcome-C9bgFmfC.js";
import { c as isAgentRunDirectAbortReason, d as resolveAgentRunErrorLifecycleFields, l as isAgentRunRestartAbortReason, o as createAgentRunRestartAbortError, p as throwAgentRunRestartAbortReason, u as resolveAgentRunAbortLifecycleFields } from "./run-termination-CczpQCyZ.js";
...
import { c as resolveCronJobsStorePath } from "./store-BwY4XtES.js";
...
import { a as resolveEffectiveAgentRuntime, i as resolveCandidateThinkingLevel, n as hasResolvedThinkingCatalogEntry, r as normalizeThinkingCatalogProviders } from "./thinking-runtime-Ct74CGZn.js";
...
import { a as normalizePendingFinalRecoveryPayloads, i as normalizePendingFinalDeliveryPayloads, r as buildRecoverablePendingFinalDeliveryText } from "./pending-final-delivery-DL2bB7Gi.js";
import { r as repairMainSessionRecoveryMutation } from "./main-session-recovery-lifecycle-C6Ne5vip.js";
import { a as releaseMainSessionRecoveryOwner, i as refreshMainSessionRecoveryOwner, r as inspectMainSessionRecoveryRequired, t as claimMainSessionRecoveryOwner } from "./main-session-recovery-store-Cq0lp4uO.js";
...
import { a as createUserTurnTranscriptRecorder } from "./user-turn-transcript-BTXVzeiZ.js";
import { i as hasVisibleAgentPayload } from "./message-visibility-Cv_6nt4F.js";
import { a as isAgentDeletionBlocked } from "./agent-lifecycle-registry-BIgOsVbj.js";
import { t as buildOutboundSessionContext } from "./session-context-DdqCb4cM.js";
import { _ as hasVisibleCommittedMessagingToolDeliveryEvidence, c as hasCommittedOutboundDeliveryEvidence, g as hasUnaccountedMessagingToolAggregateEvidence, i as collectMessagingToolDeliveredMediaUrls, r as collectDeliveredMediaUrls } from "./delivery-evidence-B4xUQS62.js";
import { j as isHeartbeatLifecycleRunKind } from "./openclaw-tools-B_OHwLQN.js";
import { n as removeInternalSessionEffectsSession, r as resolveInternalSessionEffectsTarget, t as prepareInternalSessionEffectsSession } from "./internal-session-effects-B2ckt_x5.js";
...
import { l as formatAgentInternalEventsForPlainPrompt, u as formatAgentInternalEventsForPrompt } from "./subagent-announce-delivery-Y0rI4Ahg.js";
...
import { n as clearRotatedSessionMetadata, r as resolveSession } from "./session-Col3TC3v.js";
import { f as getScopedChannelsCommandSecretTargets, n as getAgentRuntimeOptionalCommandSecretPaths, t as getAgentRuntimeCommandSecretTargetIds } from "./command-secret-targets-B23ZqGNS.js";
...
import { r as resolveAvailableAgentHarnessPolicy } from "./selection-DSP58ux_.js";
import { t as mergeAttemptToolMediaPayloads } from "./tool-media-payloads-lamEIh5q.js";
import { r as mergeSessionSnapshotChanges } from "./session-snapshot-merge-Bi3PsSDQ.js";
import { t as CronService } from "./service-DFnY1hkL.js";
...
import { t as clearSessionAuthProfileOverride } from "./session-override-CqXr7YEI.js";
import { r as resolveInlineAgentImageAttachments } from "./agent-turn-attachments-vUEkb1VJ.js";
import { t as NodeRegistry } from "./node-registry-BLwZIK15.js";
import { t as measureAgentStartup } from "./startup-timing-BfoU6-Bu.js";
...
import { n as acquireWorktreeRunLease, o as resolveWorktreeIdForPath } from "./run-lease-7G9F1Hoj.js";
import { t as runEmbeddedAgentEntry } from "./run-entry-Pa0zrXj8.js";
import { n as applyVerboseOverride } from "./level-overrides-sYAj3j2q.js";
import { t as resolveAgentRunContext } from "./run-context-BXq17B90.js";
...
async function resolveAgentRuntimeConfig(runtime, params) {
	...
	const secretsRuntime = await measureAgentStartup("secrets-runtime-import", () => import("./runtime-6RXfdk6s.js"), { config: cfg });
...
const acpRuntimeErrorsRuntimeLoader = createLazyImportLoader(() => import("./errors-VkYTpzrw.js"));
...
const cliCompactionRuntimeLoader = createLazyImportLoader(() => import("./cli-compaction-B-lAcvcG.js"));
...
const cliDepsRuntimeLoader = createLazyImportLoader(() => import("./deps-BnEJ_uuR.js"));
const execDefaultsRuntimeLoader = createLazyImportLoader(() => import("./exec-defaults-B34sIRCt.js"));
const skillsRuntimeLoader = createLazyImportLoader(async () => {
	const [remote, sessionSnapshot] = await Promise.all([import("./remote-C8LIJzXv.js"), import("./session-snapshot-C4G00D05.js")]);
	return {
