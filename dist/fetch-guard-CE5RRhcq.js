...
import { n as createHttp1EnvHttpProxyAgent, r as createHttp1ProxyAgent, t as createHttp1Agent } from "./undici-runtime-CXx9v98C.js";
import { _ as resolvePinnedHostnameWithPolicy, a as createPinnedDispatcher, i as closeDispatcher, n as assertHostnameAllowedWithPolicy, p as matchesHostnameAllowlist, t as SsrFBlockedError, v as resolveSsrFPolicyForUrl } from "./ssrf-CLKoEH8E.js";
import { i as isMockedFetch, n as fetchWithRuntimeDispatcher } from "./runtime-fetch-Bx21NODb.js";
import { o as globalUndiciStreamTimeoutMs } from "./undici-global-dispatcher-B0fHhkhz.js";
...
async function captureGuardedFetchExchange(params) {
	...
	const { captureHttpExchange, isDebugProxyGlobalFetchPatchInstalled } = await import("./runtime-CqBDgNjK.js");
	...
	captureHttpExchange({
		...
		meta: {
			...
			...params.capture?.meta,
			...params.capture?.sensitiveRequestHeaderNames ? { sensitiveRequestHeaderNames: params.capture.sensitiveRequestHeaderNames } : {}
		}
	});
}
...
//#endregion
export { withStrictGuardedFetchMode as a, retainSafeHeadersForCrossOriginRedirect$1 as c, retainSafeHeadersForCrossOriginRedirectHeaders as i, fetchConfiguredLocalOriginWithSsrFGuard as n, withTrustedEnvProxyGuardedFetchMode as o, fetchWithSsrFGuard as r, withTrustedExplicitProxyGuardedFetchMode as s, GUARDED_FETCH_MODE as t };
