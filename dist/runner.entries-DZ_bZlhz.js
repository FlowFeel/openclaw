...
import { t as buildRandomTempFilePath } from "./temp-download-4BiKWArR.js";
import { d as listOfficialExternalProviderCatalogEntries, i as getOfficialExternalPluginCatalogManifest } from "./official-external-plugin-catalog-D2YYNHlE.js";
import { i as shouldLogVerbose, r as logVerbose } from "./globals-DHQUG86L.js";
import { n as runExec } from "./exec-Bcu-_3pW.js";
import { n as CUSTOM_LOCAL_AUTH_MARKER } from "./model-auth-markers-Co0rjfKm.js";
import { c as mergeModelProviderRequestOverrides, m as sanitizeConfiguredProviderRequest, p as sanitizeConfiguredModelProviderRequest } from "./provider-request-config-DZemMjbU.js";
...
import { a as resolveInboundMediaReference, n as classifyMediaReferenceSource, r as normalizeMediaReferenceSource } from "./media-reference-B9JOS1br.js";
import { r as readRemoteMediaBuffer, t as MediaFetchError } from "./fetch-CFjJOQmb.js";
...
import { n as resolveOfficialExternalPluginRepairHint } from "./official-external-plugin-repair-hints-0VqPEfEj.js";
import { r as providerOperationRetryConfig } from "./operation-retry-D0h2PXUu.js";
import { t as describeImageWithModel } from "./image-runtime-C8xbV1aR.js";
import { a as DEFAULT_TIMEOUT_SECONDS, l as getMediaUnderstandingProvider, n as DEFAULT_MAX_BYTES, o as DEFAULT_VIDEO_MAX_BASE64_BYTES, s as MIN_AUDIO_FILE_BYTES, t as CLI_OUTPUT_MAX_BUFFER } from "./defaults.constants-CM5ca1gG.js";
import { t as assertRuntimeMediaRequestSecretOwnerAvailable } from "./runtime-media-secret-owner-C-EJ4rYa.js";
import { c as resolveTimeoutMs, n as resolveMaxBytes, o as resolvePrompt, r as resolveMaxChars } from "./resolve-19I0nqBl.js";
...
import { a as extractImageContentFromSource, s as normalizeMimeType } from "./input-files-DbN9ZpGg.js";
...
import { a as resolveRequestedLocalAudioBackend, i as recordLocalAudioBackendObservation } from "./local-audio-BZ6KL61K.js";
import { n as executeWithApiKeyRotation, t as collectProviderApiKeysForExecution } from "./api-key-rotation-DkWCcM4H.js";
import { i as resolveProxyFetchFromEnv } from "./proxy-fetch-BL7q39ur.js";
...
const loadModelAuth = createLazyRuntimeModule(async () => await import("./model-auth-CK2I_VyC.js"));
...
async function runProviderEntry(params) {
	...
	if (capability === "audio") {
		...
		const model = entry.model?.trim() || (await import("./defaults-ucax1TUm.js")).resolveDefaultMediaModel({
			cfg,
			providerId,
			capability: "audio",
			workspaceDir: params.workspaceDir
