...
import { _ as saveDelegatedTokens, g as resolveMSTeamsCredentials, m as hasConfiguredMSTeamsCredentials } from "./graph-users-CHQxnUR3.js";
import { d as resolveMSTeamsChannelAllowlist, p as resolveMSTeamsUserAllowlist, s as parseMSTeamsTeamEntry } from "./resolve-allowlist-DsATyO6X.js";
import { r as formatUnknownError } from "./errors-CsOB5fAM.js";
	...
	finalize: async (params) => {
		...
		if (finalCreds?.type === "secret") {
			if (await params.prompter.confirm({
				...
				let oauthModule;
				try {
					oauthModule = await import("./oauth-D2McO9E6.js");
				} catch (err) {
