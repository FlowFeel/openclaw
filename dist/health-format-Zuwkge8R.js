...
import { _ as isGatewayTransportError } from "./call-B_qeDbXh.js";
...
const formatHealthChannelLines = (summary, opts = {}) => {
	...
	for (const channelId of channelOrder) {
		...
		const inactiveState = statusState === "disabled" || statusState === "unconfigured" ? formatChannelStatusState(statusState) : configured === false ? "not configured" : null;
