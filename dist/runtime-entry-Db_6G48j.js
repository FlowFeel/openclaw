...
import { M as createTalkSessionController, P as recordTalkObservabilityEvent, T as resolveRealtimeVoiceAgentConsultToolsAllow, _ as buildRealtimeVoiceAgentConsultPolicyInstructions, d as assertRealtimeVoiceAgentConsultModelSelectionUnlocked, f as consultRealtimeVoiceAgent, m as REALTIME_VOICE_AGENT_CONSULT_TOOL_NAME, w as resolveRealtimeVoiceAgentConsultTools } from "./realtime-session-harness-BwpuC40T.js";
import { r as resolveRealtimeVoiceFastContextConsult } from "./realtime-voice-Bx9kWxXN.js";
import { t as resolveConfiguredCapabilityProvider } from "./provider-selection-runtime-DGqZaqbE.js";
import { i as convertPcmToMulaw8k } from "./audio-energy-o8vC-5VK.js";
import "./text-utility-runtime-Dwuhfjgs.js";
import { a as createWebhookInFlightLimiter, t as WEBHOOK_BODY_READ_DEFAULTS } from "./webhook-request-guards-cY_xufKf.js";
import "./webhook-ingress-CNHkUY93.js";
import { n as normalizeWebhookPath } from "./webhook-targets-B3Re0cee.js";
import "./api-BWLU5DPh.js";
import { a as resolveTwilioAuthToken, c as resolveVoiceCallNumberRouteKeyForCall, i as normalizeVoiceCallConfig, l as resolveVoiceCallSessionKey, n as resolveCallAgentId, o as resolveVoiceCallConfig, s as resolveVoiceCallEffectiveConfig, t as resolveVoiceResponseModel, u as validateProviderConfig } from "./response-model-BXZwgvur.js";
import { _ as releaseRejectedProviderCall, b as setVoiceCallStateRuntime, d as loadActiveCallsFromStore, g as appendCallReplayKey, l as findCallMatchesInStore, p as persistCallRecord, t as resolveDefaultVoiceCallStoreDir, u as getCallHistoryFromStore, v as rememberManagerReplayKey, x as TerminalStates, y as reserveRejectedProviderCall } from "./store-path-CjCPRD3H.js";
import { n as mapVoiceToPolly, t as escapeXml } from "./voice-mapping-FYLlYlJW.js";
import { t as isProviderStatusTerminal } from "./call-status-D-zn_jpo.js";
import { n as getHeader, t as normalizeProxyIp } from "./proxy-ip-BGDYS7mz.js";
import { t as canonicalizeVoiceCallMediaBase64 } from "./media-base64-CNM6qyTM.js";
...
const loadResponseGeneratorModule = createLazyRuntimeModule(() => import("./response-generator-DestPwGK.js"));
...
const loadTelnyxProvider = createLazyRuntimeModule(() => import("./telnyx-C-j4F_oP.js"));
const loadTwilioProvider = createLazyRuntimeModule(() => import("./twilio-CHrtKjc8.js"));
const loadPlivoProvider = createLazyRuntimeModule(() => import("./plivo-BTrDX1Ab.js"));
const loadMockProvider = createLazyRuntimeModule(() => import("./mock-CjDSdegK.js"));
const loadRealtimeVoiceRuntime = createLazyRuntimeModule(() => import("./realtime-voice.runtime.js"));
const loadRealtimeHandler = createLazyRuntimeModule(() => import("./realtime-handler-Dp3DcLFJ.js"));
