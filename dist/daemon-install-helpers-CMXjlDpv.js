...
import { u as resolveGatewayLaunchAgentLabel } from "./constants-Qf4OESGR.js";
...
import { _ as resolveSecretInputRef, s as coerceSecretRef } from "./types.secrets-BvApkFoj.js";
import { n as loadPluginManifestRegistry } from "./manifest-registry-xP2DL3Xg.js";
import { A as writeManagedServiceEnvKeysToEnvironment, O as readEnvironmentValueSource, T as hasEnvironmentFileSource, j as collectDurableServiceEnvVarSources, k as readManagedServiceEnvKeysFromEnvironment, w as formatManagedServiceEnvKeys } from "./systemd-CE12Te8p.js";
import { n as resolveGatewayTaskScriptPath, t as resolveGatewayStateDir } from "./paths-DsnYGLDu.js";
import { i as resolveOpenClawWrapperPath, n as resolveGatewayProgramArguments, t as OPENCLAW_WRAPPER_ENV_KEY } from "./program-args-Cz_xMqj6.js";
import { d as buildServiceEnvironment, s as isNonMinimalServicePathEntry } from "./runtime-paths-Cq-e39KV.js";
import { a as isPluginIntegrationSecretProviderConfig, s as resolveSecretProviderIntegrationConfig } from "./resolve-zGIf9IjE.js";
import { i as createResolverContext } from "./runtime-shared-Br87CeOH.js";
import { t as collectPluginConfigAssignments } from "./runtime-config-collectors-plugins-D1usVlPC.js";
import { n as discoverConfigSecretTargets } from "./target-registry-query-CnPjWCNY.js";
import "./target-registry-BVDHguMA.js";
import { i as resolveDaemonServicePathDirs, n as resolveDaemonInstallRuntimeInputs, t as emitDaemonInstallRuntimeWarning } from "./daemon-install-plan.shared-KEM5LP3v.js";
...
function collectExistingEnvironmentFileManagedServiceEnvVars(params) {
	...
	for (const [rawKey, rawValue] of Object.entries(params.existingEnvironment)) {
		...
		if (isDangerousHostEnvVarName(key) || isDangerousHostEnvOverrideVarName(key)) continue;
		if (!hasEnvironmentFileSource(readEnvironmentValueSource(params.existingEnvironmentValueSources, normalizedKey))) continue;
		const value = rawValue?.trim();
		if (!value) continue;
		preserved[key] = value;
	}
