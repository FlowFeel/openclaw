...
import { n as CHANNEL_TARGET_DESCRIPTION, t as CHANNEL_TARGETS_DESCRIPTION } from "./channel-target-KnDtF-PX.js";
import { l as resolveDiscoverableScopedChannelPluginIds, s as resolveConfiguredChannelPluginIds } from "./channel-presence-policy-BjX2SvLo.js";
...
import { o as runGlobalGatewayStopSafely } from "./hook-runner-global-BNa5TLJ4.js";
...
async function messageCommand(opts, deps, runtime) {
	...
	const { formatMessageCliText } = await import("./message-format-DRGfxsnZ.js");
...
function createMessageCliHelpers(message, messageChannelOptions) {
	...
	const runMessageAction = async (action, opts) => {
		...
		if (!ACTIONS_WITHOUT_STOP_HOOKS.has(action)) await withPluginRuntimeRegistryScope(pluginRegistry, runPluginStopHooks);
