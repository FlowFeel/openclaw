...
import { c as recordTaskRunProgressByRunId, i as failTaskRunByRunId, n as createQueuedTaskRun, t as completeTaskRunByRunId, u as startTaskRunByRunId } from "./detached-task-runtime-DMrgTp9S.js";
import { d as isGatewayDraining, r as enqueueCommandInLane } from "./command-queue-BbrEP4i9.js";
import { n as OPENCLAW_EMBEDDED_CONTEXT_ENGINE_HOST } from "./host-compat-BibWlia2.js";
import { v as runWithPreparedMemoryPromptSection } from "./memory-state-CngllfdS.js";
import { t as log$1 } from "./logger-BeJ7WAxI.js";
import { O as findActiveSessionTask } from "./openclaw-tools-CoDz4vSH.js";
import { c as updateTaskNotifyPolicyForOwner, i as findTaskByRunIdForOwner, n as cancelTaskByIdForOwner } from "./task-owner-access-BAXOqENW.js";
import { b as resolveContextEngineCapabilities, n as buildAfterTurnRuntimeContextFromUsage, t as buildAfterTurnRuntimeContext } from "./attempt.prompt-helpers-vAfr0YHA.js";
import { n as rewriteTranscriptEntriesInSessionManager, t as resolveRuntimeTranscriptReadTarget } from "./transcript-runtime-state-oJ_KPxv9.js";
import { r as runAgentHarnessAgentEndHook, t as awaitAgentHarnessAgentEndHook } from "./lifecycle-hook-helpers-CVo05dyc.js";
...
async function runCoreAgentEndSideEffects(params) {
	try {
		const { scheduleSkillExperienceReview } = await import("./experience-review-default-9_4VhfrG.js");
	...
	try {
		const { runSkillResearchAutoCapture } = await import("./autocapture-MJ8nJJE1.js");
