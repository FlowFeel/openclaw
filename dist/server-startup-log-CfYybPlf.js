...
import { b as resolveConfiguredModelRef, i as buildConfiguredModelCatalog } from "./model-selection-shared-BDTPW9Jk.js";
...
import { t as collectEnabledInsecureOrDangerousFlagsFromCurrentSnapshot } from "./dangerous-config-flags-current-DP72Z9Iq.js";
...
async function logGatewayStartup(params) {
	...
	const enabledDangerousFlags = collectEnabledInsecureOrDangerousFlagsFromCurrentSnapshot(params.cfg) ?? (await import("./dangerous-config-flags-gZTB7Gg_.js")).collectEnabledInsecureOrDangerousFlags(params.cfg);
...
async function collectConfiguredChannelStartupWarnings(params) {
	const [blockerModule, presencePolicyModule] = await Promise.all([import("./channel-plugin-blockers-C7YQkIDy.js"), import("./channel-presence-policy-tmyAbfz7.js")]);
