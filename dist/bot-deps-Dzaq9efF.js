...
import { c as readAmbientTranscriptWatermark, i as listSessionEntries, l as readSessionUpdatedAt, m as resolveStorePath, r as getSessionEntry } from "./session-store-runtime-DND3iX5-.js";
import "./error-runtime-Dbl9_3mW.js";
import "./runtime-env-DEukRWMB.js";
import "./string-coerce-runtime-CLK2YdzD.js";
import { f as isTelegramRateLimitError, l as isTelegramMessageNotModifiedError, m as readTelegramRetryAfterMs, o as isTelegramClientRejection, r as isSafeToRetrySendError, t as isRecoverableTelegramNetworkError } from "./network-errors-DPGlV01O.js";
...
import { t as dispatchReplyWithBufferedBlockDispatcher } from "./reply-dispatch-runtime-rpSMpiKx.js";
...
import { t as buildModelsProviderData } from "./commands-models-D12TEuxb.js";
import "./channel-inbound-DgZwCM1p.js";
import { a as takeMessageIdAfterStop, i as createFinalizableDraftStreamControlsForState } from "./draft-stream-controls-BdFDCUzw.js";
import { t as deliverInboundReplyWithMessageSendContext } from "./channel-outbound-sjGCUxtt.js";
import "./models-provider-runtime-DwJSjpSS.js";
import "./skill-commands-runtime-gnY3RCQg.js";
import { a as wasSentByBot, f as normalizeTelegramReplyToMessageId } from "./sent-message-cache-BxR6Sn3u.js";
import { X as escapeTelegramHtml, Z as markdownToTelegramChunks, g as buildTelegramThreadParams, nt as splitTelegramHtmlChunks, rt as telegramHtmlToPlainTextFallback } from "./prompt-context-projection-BI7UvPeR.js";
import { t as TELEGRAM_TEXT_CHUNK_LIMIT } from "./outbound-adapter-CKa77z6Q.js";
import { r as normalizeTelegramCommandName, t as TELEGRAM_COMMAND_NAME_PATTERN } from "./command-config-PZry_aTC.js";
import { D as inputRichBlocksToPlainText, R as recordOutboundMessageForPromptContext, _ as buildTelegramRichMarkdownPlan, _t as isTelegramHtmlParseError, dt as withTelegramApiErrorLogging, gt as buildTelegramPlainFallbackPlan, h as buildTelegramRichBlocksPlan, m as TELEGRAM_RICH_TEXT_LIMIT, p as editMessageTelegram, v as getTelegramRichRawApi, vt as splitTelegramPlainTextChunks, w as splitTelegramRichBlocks, yt as warnTelegramRichBlocksDegradations } from "./send-DbbI0aPE.js";
	...
	const sendMessageTransportPreview = async (page, sendGeneration) => {
		...
		if (typeof targetMessageId === "number") {
			...
			if (page.richMessage) {
				...
				await editMessageTextWithPreview(targetMessageId, page.sourceText, { parse_mode: "HTML" });
			} catch (err) {
				if (!isTelegramHtmlParseError(err)) throw err;
...
const defaultTelegramBotDeps = {
	...
	get resolveAmbientTranscriptWatermarkLegacyKey() {
		return resolveAmbientTranscriptWatermarkLegacyKey;
	},
