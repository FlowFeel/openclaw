...
import { a as addTimerTimeoutGraceMs, f as clampTimerTimeoutMs, j as resolveTimerTimeoutMs, n as MAX_TIMER_TIMEOUT_MS } from "./number-coercion-Crk_c9KW.js";
...
import { _ as readStringParam, d as readNonNegativeIntegerParam, o as imageResultFromFile, p as readPositiveIntegerParam } from "./common-RkLs-2lL.js";
...
import { t as startLazyPluginServiceModule } from "./plugin-runtime-BIaL3Knz.js";
...
import { t as describeImageFile } from "./runtime-BkT6t24f.js";
...
import { n as applyBrowserTabToolBinding, r as parseBrowserTabToolBinding, t as describeBrowserTool } from "./browser-tool-description-WpMYl0TC.js";
import { o as DEFAULT_AI_SNAPSHOT_MAX_CHARS, s as DEFAULT_BROWSER_ACTION_TIMEOUT_MS } from "./constants-BoWgRtg0.js";
import { l as resolveBrowserActRequestTimeoutMs } from "./act-policy-9AEfR1NQ.js";
import { n as BrowserToolSchema, t as BrowserToolOutputSchema } from "./browser-tool.schema-Ci7mf_6N.js";
import { a as resolveProfile, l as resolveExistingUploadPaths, r as resolveBrowserConfig } from "./config-DrBFz_Sl.js";
import { Y as withTimeout } from "./tmp-openclaw-dir-Ci2i7GZs.js";
import "./errors-ByWLK1t1.js";
import { N as parseBrowserNavigationUrl } from "./chrome-BncZf3mR.js";
import { t as getBrowserProfileCapabilities } from "./profile-capabilities-DqO0AgW7.js";
import "./sdk-setup-tools-BRa8kP0s.js";
import { C as fetchBrowserJson, S as BrowserServiceError, _ as browserStatus, a as untrackSessionBrowserTab, d as browserImportProfile, f as browserOpenTab, g as browserStart, h as browserSnapshot, i as trackSessionBrowserTab, l as browserDoctor, o as browserCloseTab, p as browserProfiles, r as touchSessionBrowserTab, u as browserFocusTab, v as browserStop, x as browserTabs, y as browserSystemProfiles } from "./session-tab-registry-B1NUOYG-.js";
import { _ as isBrowserProxyUploadRequest, a as persistBrowserProxyFiles, b as parseBrowserProxyFailure, c as browserPdfSave, d as browserArmFileChooser, f as browserDownload, h as browserWaitForDownload, i as applyBrowserProxyPaths, l as browserAct, m as browserScreenshotAction, o as browserConsoleMessages, p as browserNavigate, s as browserPageContent, u as browserArmDialog, v as prepareBrowserProxyUploadRequest, y as BROWSER_PROXY_ERROR_ENVELOPE } from "./core-api-CRK7HQAx.js";
import { o as normalizeBrowserScreenshot, r as parseSystemProfileDomains } from "./routes-BDQes0bG.js";
import { a as describeBrowserScreenshot, c as stageBrowserScreenshotForSharing, n as executeExtractAction, o as neutralizeMediaDirectives, s as resolveRuntimeImageSanitization } from "./browser-extract-CxRkvj7T.js";
import { n as createBrowserControlContext } from "./plugin-enabled-Uq8hpi8K.js";
import { a as resolveRequestedBrowserProfile, n as isBrowserHostLocalRoute, r as isPersistentBrowserProfileMutation, t as createBrowserRouteDispatcher } from "./dispatcher-Cw7kQe8B.js";
import { t as startBrowserControlServiceFromConfig } from "./control-service-CJHwzvJG.js";
	...
	return {
		...
		execute: async (_toolCallId, args, signal) => {
			...
			switch (action) {
				...
				case "extract": return await executeExtractAction({
					input: params,
					baseUrl,
					profile,
					proxyRequest,
...
function createBrowserPluginService() {
	...
	return {
		id: "browser-control",
		start: async () => {
			const pageShare = await import("./page-share-CNi1tHar.js");
			...
			handle = await startLazyPluginServiceModule({
				...
				loadDefaultModule: async () => await import("./server-B5sPsVSN.js"),
		...
		stop: async () => {
			const { setPageShareSink } = await import("./page-share-CNi1tHar.js");
			...
			const { stopBrowserControlService } = await import("./control-service-BCo-IYFf.js");
