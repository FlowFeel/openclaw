...
import { i as resolveSimpleCompletionSelectionForAgent } from "./simple-completion-runtime-CxQ3y0xz.js";
...
async function defaultRun(params) {
	...
	try {
		const [{ SessionManager }, { runEmbeddedAgent }] = await Promise.all([import("./sessions-Cu9ma92a.js"), import("./embedded-agent-D3IzfMqr.js")]);
