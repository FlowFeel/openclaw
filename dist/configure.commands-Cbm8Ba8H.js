...
import { i as applyAuthChoice } from "./auth-choice-B1VXBRwq.js";
import { t as resolvePreferredProviderForAuthChoice } from "./provider-auth-choice-preference-QOMG_HOH.js";
import { i as setupChannels } from "./onboard-channels-BabFYku2.js";
import { t as resolveSetupSecretInputString } from "./setup.secret-input-B3-TUniE.js";
import { n as mergeWizardConfigOntoLatest } from "./setup.shared-WvGMBt-N.js";
...
import { i as promptModelAllowlist, n as applyModelFallbacksFromSelection, r as promptDefaultModel, t as applyModelAllowlist } from "./model-picker-C_KCJpjU.js";
...
async function promptWebToolsConfig(nextConfig, runtime, prompter) {
	...
	if (enableSearch) {
		...
		if (configureManagedProvider) {
			const { resolveSearchProviderOptions, runSearchSetupFlow } = await import("./search-setup-BpgHiIq3.js");
