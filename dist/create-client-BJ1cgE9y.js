...
import { d as writeStorageMeta, l as resolveMatrixStoragePaths, r as maybeMigrateLegacyStorage } from "./storage-B0onFYxL.js";
import "./config-qJ5tyLJ8.js";
import fs from "node:fs";
//#region extensions/matrix/src/matrix/client/create-client.ts
const loadMatrixCreateClientRuntimeDeps = createLazyRuntimeModule(() => Promise.all([import("./sdk-BXmmnD6w.js"), import("./logging-CyKmY_R0.js")]).then(([sdkModule, loggingModule]) => ({
