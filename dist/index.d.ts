...
import { ot as loadConfig$1 } from "./config-BLaGc3tM.js";
...
declare function ensurePortAvailable$1(port: number, host?: string): Promise<void>;
 ...
 */
declare function loadSessionStore$1(storePath: string, options?: LegacySessionStoreLoadOptions): Record<string, SessionEntry>;
/**
 * @deprecated Legacy sessions.json compatibility for package-root consumers.
 * Use SQLite-backed session APIs. Remove after 2026-10-12, once the v2026.7.x
 * upgrade window no longer requires the legacy doctor importer.
