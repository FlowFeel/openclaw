...
import { r as drainActiveSessionsForShutdown } from "./session-reset-service-CU2i9sNz.js";
	...
	return async (opts) => {
		...
		try {
			...
			await shutdownStep("code-mode-runs", async () => {
				const { disposeAllCodeModeRuns } = await import("./code-mode-state-DHex9kEU.js");
