...
import { r as drainActiveSessionsForShutdown } from "./session-reset-service-DQU2Q6qx.js";
	...
	return async (opts) => {
		...
		try {
			...
			await shutdownStep("code-mode-runs", async () => {
				const { disposeAllCodeModeRuns } = await import("./code-mode-state-DepOwQG3.js");
