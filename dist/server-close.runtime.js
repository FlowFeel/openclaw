...
import { r as drainActiveSessionsForShutdown } from "./session-reset-service-CJ3Y34mA.js";
	...
	return async (opts) => {
		...
		try {
			...
			await shutdownStep("code-mode-runs", async () => {
				const { disposeAllCodeModeRuns } = await import("./code-mode-state-bUcVEIoT.js");
