...
import { r as drainActiveSessionsForShutdown } from "./session-reset-service-CSDK-C5l.js";
	...
	return async (opts) => {
		...
		try {
			...
			await shutdownStep("code-mode-runs", async () => {
				const { disposeAllCodeModeRuns } = await import("./code-mode-state-CDszHOiG.js");
