...
import { r as drainActiveSessionsForShutdown } from "./session-reset-service-B0sSG8_C.js";
	...
	return async (opts) => {
		...
		try {
			...
			await shutdownStep("code-mode-runs", async () => {
				const { disposeAllCodeModeRuns } = await import("./code-mode-state-CKQmwqZl.js");
