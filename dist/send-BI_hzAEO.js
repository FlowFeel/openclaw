...
import { c as MEDIA_FFMPEG_MAX_AUDIO_DURATION_SECS, i as parseFfprobeCodecAndSampleRate, o as runFfmpeg, s as runFfprobe } from "./media-probe-BL-Ub3TA.js";
import { r as loadWebMediaRaw } from "./web-media-DG7t3WQ-.js";
...
import { n as recordOutboundMessageIdentity } from "./outbound-echo-C7XAomlW.js";
...
import { a as unlinkIfExists } from "./media-runtime-CSmTPMNF.js";
...
import { At as listGuildEmojis, Bt as ChannelType, Ct as createGuildSticker, Dt as getGuildVoiceState, Et as getGuildMember, Ft as removeGuildMember, It as removeGuildMemberRole, Lt as timeoutGuildMember, Mt as listGuildScheduledEvents, Nt as moveGuildChannels, Ot as listGuildActiveThreads, Pt as putChannelPermission, St as createGuildScheduledEvent, Tt as getGuild, _ as RateLimitError, _t as unpinChannelMessage, at as deleteChannelMessage, b as readDiscordMessage, bt as createGuildChannel, ct as getChannel, dt as listChannelArchivedThreads, ft as listChannelMessages, g as DiscordError, gt as sendChannelTyping, ht as searchGuildMessages, it as deleteChannel, jt as listGuildRoles, kt as listGuildChannels, lt as getChannelMessage, mt as pinChannelMessage, nt as createChannelMessage, ot as editChannel, pt as listChannelPins, rt as createThread, st as editChannelMessage, v as isUnknownDiscordVoiceStateError, vt as addGuildMemberRole, wt as deleteChannelPermission, x as readRetryAfter, xt as createGuildEmoji, y as readDiscordCode, yt as createGuildBan } from "./discord-CyZ7vma7.js";
import { C as DISCORD_MAX_STICKER_BYTES, S as DISCORD_MAX_EVENT_COVER_BYTES, T as parseAndResolveChannelRecipient, g as createDiscordMessageNonce, l as resolveChannelId, o as normalizeEmojiName, t as buildDiscordSendError, x as DISCORD_MAX_EMOJI_BYTES } from "./send.shared-BxynlSmm.js";
import { t as parseDiscordRetryAfterBodySeconds } from "./retry-after-Deqr6ZFT.js";
import { h as DISCORD_REST_TIMEOUT_MS, m as resolveDiscordRest, p as resolveDiscordClientAccountContext, u as createDiscordClient } from "./send.permissions-CJ4AzObF.js";
import "./send.outbound-C-aSDkcb.js";
import { r as rewriteDiscordKnownMentions } from "./mentions-Bux5g6rF.js";
import { r as createDiscordSendResult } from "./send.receipt-Dq6F9Dmw.js";
import { i as recordDiscordMessageCreateAmbiguity, n as createDiscordRetryRunner, t as classifyDiscordDeliveryFailure } from "./retry-BVkJ40rM.js";
import { n as DISCORD_ATTACHMENT_TOTAL_TIMEOUT_MS } from "./timeouts-DB8J_ZTL.js";
import "./send.reactions-CtRkfW5_.js";
...
async function materializeVoiceMessageInput(mediaUrl, opts) {
...
async function sendVoiceMessageDiscord(to, audioPath, opts) {
	const { filePath: localInputPath, cleanup: cleanupLocalInput } = await materializeVoiceMessageInput(audioPath, opts);
	let oggPath = null;
