import { A as ModelProviderConfig, _o as ReplyToMode, co as DmScope, i as OpenClawConfig } from "./types.openclaw-3lPuYQv-.js";
import { t as FastMode } from "./string-coerce-DJnd-JG-.js";
import { o as ImageContent } from "./types-CwI9hEPH.js";
import { d as SessionCreatedActor, f as SessionCreatedVia, h as SourceReplyDeliveryMode, m as SessionRestartRecoveryState, o as SessionEntry, r as InternalSessionEntry } from "./types-Dt3tB0SE.js";
import { t as AgentMessage } from "./types-ifNunyTs.js";
import { a as MediaKind } from "./constants-Bjeg8sLB.js";
import { i as AuthProfileStore } from "./types-D67e2Gtu.js";
...
type TemplateContext = RuntimeMsgContext & {
  BodyStripped?: string;
  SessionId?: string;
  IsNewSession?: string; /** Local path for the attachment currently being processed. */
  AttachmentPath?: string; /** Original URL/reference for the attachment currently being processed. */
  AttachmentUrl?: string; /** MIME content type for the attachment currently being processed. */
  AttachmentContentType?: string; /** Directory containing AttachmentPath. */
  AttachmentDir?: string; /** Stable zero-based source fact index for the attachment currently being processed. */
  AttachmentIndex?: number; /** @deprecated Use AttachmentPath. */
  MediaPath?: string; /** @deprecated Use AttachmentUrl. */
  MediaUrl?: string; /** @deprecated Use AttachmentContentType. */
  MediaType?: string; /** @deprecated Use AttachmentDir. */
  MediaDir?: string;
};
declare function applyTemplate(str: string | undefined, ctx: TemplateContext): string;
//#endregion
export { InboundEventKind as A, ReplyPayloadDeliveryPin as B, LegacyMediaContextKey as C, MediaUnderstandingOutput as D, MediaUnderstandingDecision as E, MessagePresentation as F, MessagePresentationAction as I, MessagePresentationButton as L, ReplyMediaAttachment as M, ReplyPayload as N, MediaUnderstandingProvider as O, LegacyInteractiveReply as P, ModelPickerAction as R, PluginHookChannelContext as S, PromptImageOrderEntry as T, AgentPlanStep as _, MsgContext as a, CommandTurnContext as b, SupplementalContextFacts as c, GetReplyOptions as d, PartialReplyPayload as f, UserTurnTranscriptRecorder as g, TypingController as h, MentionSource as i, ReplyDeliveryContext as j, StructuredExtractionInput as k, applyTemplate as l, TurnAdoptionLifecycle as m, FinalizedRuntimeMsgContext as n, RuntimeMsgContext as o, TaskSuggestionDeliveryMode as p, InboundSourceModality as r, SessionTranscriptContext as s, FinalizedMsgContext as t, BlockReplyContext as u, HistoryEntry as v, MediaFact as w, CommandTurnKind as x, HistoryMediaEntry as y, ReplyPayloadDelivery as z };