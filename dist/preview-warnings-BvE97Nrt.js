...
async function resolveDoctorChannelPreviewConfig(params) {
	const [{ resolveCommandSecretRefsViaGateway }, { getConfiguredChannelsCommandSecretTargetIds }] = await Promise.all([import("./command-secret-gateway-BosMlywS.js"), import("./command-secret-targets-BHHuc6zd.js")]);
...
async function collectDoctorPreviewNotes(params) {
	...
	const { collectCodexRouteWarnings } = await import("./codex-route-warnings-CFKso5rE.js");
	...
	if (hasPluginConfig) {
		const { collectContextEngineHostCompatibilityWarnings } = await import("./context-engine-host-compat-DqU5q5i8.js");
	...
	const { collectStaleOAuthProfileShadowWarnings, scanStaleOAuthProfileShadows } = await import("./stale-oauth-profile-shadows-DR9tFVML.js");
	...
	const { collectStaleConfiguredAuthOrderWarnings } = await import("./stale-auth-order-Csk3tXBB.js");
