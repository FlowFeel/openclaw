...
function loadDefaultSummarizeTextDeps() {
	return defaultSummarizeTextDepsPromise ??= Promise.all([import("./simple-completion-runtime-CapmVK5N.js"), import("./model-auth-CK2I_VyC.js")]).then(([completionRuntime, { requireApiKey }]) => ({
