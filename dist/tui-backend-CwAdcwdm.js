...
import { x as runTui } from "./tui-CLURbN_7.js";
...
import { t as executeSystemAgentOperation } from "./operations-DStBH-DH.js";
...
import { i as assertLocalGatewaySetupMode, n as SystemAgentChatEngine, t as GATEWAY_SETUP_AFTER_WRITE } from "./chat-engine-CiYvSk-0.js";
...
async function runSetupHandoff(handoff, opts, runtime) {
	...
	if (handoff.target === "search") {
		...
		const [{ runSearchSetupFlow }, { createClackPrompter }, { readSetupConfigFileSnapshot, writeWizardConfigFile }] = await Promise.all([
			import("./search-setup-BpgHiIq3.js"),
			import("./clack-prompter-DyhRpF9c.js"),
			import("./setup.shared-B20Bo9O_.js")
		]);
		const snapshot = await readSetupConfigFileSnapshot();
	...
	await (opts.runChannelsAdd ?? (await import("./add-CqpUqYii.js")).channelsAddCommand)(handoff.channel ? { channel: handoff.channel } : {}, runtime, {
		hasFlags: false,
		beforePersistentEffect
	});
}
