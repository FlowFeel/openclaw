...
import { i as isApprovalMethod } from "./method-scopes-BPNMlnDQ.js";
...
import { n as createApprovalNativeRouteReporter } from "./approval-native-route-coordinator-BXI6mT2o.js";
import { t as buildChannelApprovalNativeTargetKey } from "./approval-native-target-key-BYyCDZbu.js";
import { t as createOperatorApprovalsGatewayClient } from "./operator-approvals-client-Rs3bk2Li.js";
...
function createChannelNativeApprovalRuntime(adapter) {
	...
	const routeReporter = (gatewayRuntime?.routeCoordinator.createReporter ?? createApprovalNativeRouteReporter)({
		...
		requestGateway: async (method, params) => {
			...
			const { callGatewayLeastPrivilege } = await import("./call-ujGvHIZc.js");
