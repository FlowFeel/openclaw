...
import { c as resolveAgentDir, f as resolveDefaultAgentId, i as listAgentIds, o as resolveAgentConfig, u as resolveAgentWorkspaceDir } from "./agent-scope-config-Dusa8eSA.js";
import { n as normalizeAgentId } from "./agent-id-DDgUze4y.js";
import { a as isSubagentSessionKey, i as isCronSessionKey, n as isAcpSessionKey } from "./session-key-utils-02xWdGSz.js";
...
import { E as resolveClawHubBaseUrl, g as fetchClawHubSkillDetail, v as fetchClawHubSkillSecurityVerdicts } from "./clawhub-Clykbwlp.js";
...
import "./archive-zip-preflight-Dnek-ZSK.js";
import "./archive-BeFCy_95.js";
import { f as MAX_PLUGIN_STATE_ENTRIES_PER_PLUGIN, t as createCorePluginStateSyncKeyedStore } from "./plugin-state-store-aPYaqCXn.js";
...
import { $r as validateSkillsSecurityVerdictsParams, Br as validateSkillsCuratorStatusParams, Gr as validateSkillsProposalEvaluateParams, Hr as validateSkillsInstallParams, Jr as validateSkillsProposalRequestRevisionParams, Kr as validateSkillsProposalEventsListParams, Qr as validateSkillsSearchParams, Rr as validateSkillsBinsParams, Sh as validateSkillsProposalHistoryStatusParams, Ur as validateSkillsProposalActionParams, Vr as validateSkillsDetailParams, Wr as validateSkillsProposalCreateParams, Xr as validateSkillsProposalUpdateParams, Yr as validateSkillsProposalReviseParams, Zr as validateSkillsProposalsListParams, ai as validateSkillsUploadCommitParams, ei as validateSkillsSkillCardParams, ii as validateSkillsUploadChunkParams, ni as validateSkillsUpdateParams, qr as validateSkillsProposalInspectParams, ri as validateSkillsUploadBeginParams, ti as validateSkillsStatusParams, v_ as buildClawHubTrustErrorDetails, xh as validateSkillsProposalHistoryScanParams, zr as validateSkillsCuratorActionParams } from "./src-BSn6va4B.js";
...
import { a as restoreCuratedSkill, i as pinCuratedSkill, r as getSkillCuratorStatus, s as unpinCuratedSkill } from "./curator-SRJ_8Uu1.js";
import { t as SessionManager } from "./session-manager-Rig6qOU_.js";
import { u as isEmbeddedAgentRunActive } from "./runs-ehu0VRUR.js";
...
import { c as searchSkillsFromClawHub, h as installSkillArchiveFromPath, i as readLocalSkillCardContentSync, r as updateSkillsFromClawHub, t as installSkillFromClawHub, v as validateRequestedSkillSlug } from "./clawhub-DgSLScUf.js";
import { t as buildWorkspaceSkillStatus } from "./status-v2W0ohF-.js";
import { o as loadWorkspaceSkillEntries } from "./workspace-D-nfQV8D.js";
import { a as quarantineSkillProposal, c as evaluateSkillProposal, d as inspectSkillProposal, f as listSkillProposals, i as proposeUpdateSkill, l as listSkillProposalEvents, o as rejectSkillProposal, r as proposeCreateSkill, s as reviseSkillProposal, t as applySkillProposal, u as getSkillProposalRunProgress } from "./service-CmvGStrk.js";
import { t as SKILL_AUTHORING_STANDARDS_PROMPT } from "./skill-authoring-standards-IFXk69XK.js";
import { i as isRealNonHeartbeatUserMessage, r as isHeartbeatUserMessage } from "./heartbeat-filter-DUXErom1.js";
import { n as redactConfigObject } from "./redact-snapshot-Ba1hEL2u.js";
import { n as resolveNodeExecEligibility } from "./exec-defaults-B7q-U3gd.js";
import { t as listAgentWorkspaceDirs } from "./workspace-dirs-DbyiYbZj.js";
import { t as getRemoteSkillEligibility } from "./remote-DPqRs_jZ.js";
import { t as assertValidParams } from "./validation-DyQ6nhKI.js";
import { n as installSkill } from "./install-tjv22nib.js";
import { n as formatSkillExperienceReviewTranscript } from "./experience-review-prompt-BzoC3cDN.js";
...
async function runSkillHistoryScanReview(params) {
	...
	try {
		...
		const { runEmbeddedAgent } = await import("./embedded-agent-C8PdYTWR.js");
...
async function readHistoryScanSession(params) {
	...
	if (!isSkillHistoryScanLocalTranscriptSizeEligible(readSqliteTranscriptStatsSync(transcriptScope).sizeBytes)) return;
...
function buildRevisionAgentInstruction(proposal, expectedRevisionHash) {
	if (!proposal) return "";
	return [
...
async function forwardSkillWorkshopRevisionToChatSend(opts, params) {
	const { chatHandlers } = await import("./chat-uPRsEYCE.js");
	...
	const chatParams = {
		...
		deliver: false,
		systemProvenanceReceipt: buildRevisionAgentInstruction(params.proposal, params.expectedRevisionHash),
...
const skillsHandlers = {
	...
	"skills.proposals.list": async ({ params, respond, context }) => {
		await runSkillsProposalWorkspaceHandler({
			...
			run: (_parsedParams, resolved) => listSkillProposals({
				agentId: resolved.agentId,
				workspaceDir: resolved.workspaceDir
			})
		});
	...
	"skills.proposals.requestRevision": async (opts) => {
		...
		await runSkillsProposalWorkspaceHandler({
			...
			run: async (parsedParams, resolved) => {
				...
				if (parsedParams.expectedRevisionHash && parsedParams.expectedRevisionHash !== proposal.revisionHash) {
					respond(false, void 0, errorShape(ErrorCodes.INVALID_REQUEST, `Skill proposal revision changed: ${parsedParams.proposalId}`));
					return SKILL_PROPOSAL_RESPONSE_HANDLED;
				}
