...
async function runRemoteGatewayInferenceOnboarding(target, runtime = defaultRuntime, deps = {}) {
	...
	const runGuidedOnboarding = deps.runGuidedOnboarding ?? (await import("./onboard-guided-GpNMODSA.js")).runGuidedOnboarding;
	...
	await runGuidedOnboarding({}, runtime, {
		...
		runSystemAgentChat: async () => {
			...
			await (deps.runTui ?? (await import("./tui-Zv0pEDOV.js")).runTui)({
				config: boundConfig,
				deliver: false,
