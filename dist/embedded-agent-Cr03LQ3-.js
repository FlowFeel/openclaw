...
import { N as withPluginRuntimeRegistryScope, S as requireActivePluginRegistry } from "./runtime-WkCmQTS9.js";
import { c as resolveContextConfigProviderForRuntime, d as resolveSelectedOpenAIRuntimeProvider, i as isOpenAIProvider, n as OPENAI_PROVIDER_ID, v as normalizeOptionalAgentRuntimeId } from "./openai-routing-Db2edxk0.js";
...
import { l as providerModelRouteAcceptsAuthMode } from "./openai-model-routes--NVfVZh4.js";
import { s as sleepWithAbort } from "./src-DKBD8PDy.js";
import { t as isPluginMetadataSnapshotCompatible } from "./plugin-metadata-snapshot-B_ZQ9Mbo.js";
...
import { nt as isIncognitoOpenClawAgentSqlitePath } from "./openclaw-agent-db-DemdumbZ.js";
import { r as resolveSubscriptionAuthModeForProfiles } from "./profile-list-C0Y7xLon.js";
import { o as isProfileInCooldown } from "./usage-state-C6UiSWt7.js";
import { a as resolveSecretSentinel, r as looksLikeSecretSentinel } from "./sentinel-DH6relF_.js";
...
import { c as resolveContextEngineOwnerPluginId, s as resolveContextEngine } from "./registry-DyBZw0Nd.js";
...
import { P as normalizeUsage, k as deriveContextPromptTokens, o as appendSqliteTranscriptMessage, st as loadSqliteSessionEntry } from "./session-accessor.sqlite-CtCo5VZ6.js";
import { i as normalizeMessageChannel } from "./message-channel-normalize-Cs-kjMZm.js";
import { o as isMarkdownCapableMessageChannel } from "./message-channel-Bo27VP7K.js";
...
import { $ as listSessionEntries, K as updateSessionEntry, r as resolveSessionTranscriptRuntimeReadTarget } from "./session-accessor-D5Or7WgI.js";
import "./backoff-CCtTkmwj.js";
import { a as resolveProviderAuthProfileId, d as resolveProviderRuntimePluginHandle } from "./provider-hook-runtime-C7-SJnLH.js";
import { x as prepareProviderRuntimeAuth } from "./provider-runtime-DlVC1wsY.js";
import { i as ensureAuthProfileStore, o as ensureAuthProfileStoreWithoutExternalProfiles } from "./store-BWT5kQzj.js";
...
import { a as markAuthProfileFailure, d as resolveProfilesUnavailableReason, o as markInlineProviderApiKeyFailure } from "./usage-D2WAMRv4.js";
import { Ct as classifyRateLimitWindow } from "./sessions-CxWGGmnA.js";
import { c as hasOnlyAssistantReasoningContent } from "./ai-transport-runtime-host-CchjIxjf.js";
...
import { n as isToolResultError } from "./tool-result-error-BI56-yEJ.js";
...
import { n as acquireReadOnlyPreparedModelRuntime, s as prepareModelRuntimeSnapshot, t as acquireAgentRunPreparedModelRuntime } from "./prepared-model-runtime-Cbe86whM.js";
import "./auth-profiles-67bIpdG9.js";
import { n as markAuthProfileSuccess } from "./profiles-Hfbx6aWI.js";
import { s as isConfigBackedInlineProviderApiKey } from "./model-auth-provider-config-Bf2cufz8.js";
import { i as getApiKeyForModel, n as applyLocalNoAuthHeaderOverride, t as applyAuthHeaderOverride } from "./model-auth-yfB4tyNY.js";
import { n as resolveThinkingDefault } from "./model-thinking-default-BwLqoppi.js";
...
import { j as resolveCompactionTimeoutMs, k as compactContextEngineWithSafetyTimeout } from "./diagnostic-CdMjo2Fb.js";
import { b as resolveActiveEmbeddedRunHandleSessionIdBySessionFile, d as isEmbeddedAgentRunHandleActive, r as clearActiveEmbeddedRun, w as setActiveEmbeddedRun, y as resolveActiveEmbeddedRunHandleSessionId } from "./runs-Bdk5tY9J.js";
import "./sessions-BqBqRT1f.js";
import { i as resolveModelCostConfig, t as estimateUsageCost } from "./usage-format--pf0zzCz.js";
import { c as resolveAgentHarnessPreparedAuthSupport, i as resolveCandidateThinkingLevel, l as resolveAgentHarnessPreparedRouteSupport } from "./thinking-runtime-Ct74CGZn.js";
...
import { o as getCommandLaneSnapshot, r as enqueueCommandInLane } from "./command-queue-DxY-0HMA.js";
import { l as retireSessionMcpRuntime, u as retireSessionMcpRuntimeForSessionKey } from "./agent-bundle-mcp-manager-api-D2GddaSc.js";
...
import { d as waitForDeferredTurnMaintenanceForSession, f as buildContextEngineRuntimeSettings, u as runContextEngineMaintenance } from "./agent-end-side-effects--ABMNPXa.js";
import { n as maybeCompactAgentHarnessSession, r as isRecoverableNativeHarnessBindingFailure, t as resolveContextEngineCompactionSuccessor } from "./compaction-successor-rRKFUzkK.js";
import { r as resolveModelAsync, t as createEmptyAgentDiscoveryStores } from "./model-weOUIm_9.js";
import { t as materializePreparedRuntimeModel } from "./materialize-model-DPDoen5v.js";
import { n as canRunPreparedAgentRuntimeAuthAttempt, r as prepareAgentRuntimeAuth } from "./prepare-auth-C8ecPbie.js";
import { i as resolveCredentialScopedAuthAttemptModelDecision, n as hasPreparedAuthAttemptModelMetadata, r as providerUsesCredentialScopedModelMetadata, t as createPreparedRuntimeModelMaterializer } from "./credential-scoped-model-DUzkuoku.js";
import { t as log$3 } from "./logger-PoK3sCV7.js";
import { m as hasOutboundDeliveryEvidence, p as hasMessagingToolDeliveryEvidence } from "./delivery-evidence-B4xUQS62.js";
import { n as isExecLikeToolName } from "./tool-error-summary-DDV0ZoKC.js";
import { b as resolveContextEngineCapabilities, f as buildEmbeddedCompactionRuntimeContext, p as resolveCompactionContextTokenBudget, r as forgetPromptBuildDrainCacheForRun, y as listActiveProcessSessionReferences } from "./attempt.prompt-helpers-BQhqL2Eu.js";
import { a as resolveDelegationCapability, n as resolveProcessToolScopeKey } from "./agent-tools-Df1_Fel3.js";
import { A as settleRequesterAfterSessionSpawns } from "./subagent-registry-C4ALZQd0.js";
...
import { _ as buildApiErrorObservationFields, y as shouldSuppressRawErrorConsoleSuffix } from "./model-fallback-attempt-CwT_ozOy.js";
import { a as resolveStoredSessionKeyForSessionId, i as resolveSessionKeyForRequest } from "./session-Col3TC3v.js";
import { a as resolveSessionSuspensionTarget, c as suspendSession, i as resolveSessionSuspensionReason } from "./session-suspension-A0HAqEj-.js";
...
import { c as truncateOversizedToolResultsInActiveTarget, o as sessionLikelyHasOversizedToolResults } from "./transcript-visibility-CJfcHiRn.js";
...
import { n as resolveSystemPromptRepoRoot } from "./system-prompt-params-BENSLgZq.js";
import { i as readPersistedMediaImageLayout, t as detectAndLoadPromptImages } from "./images-BC0m77Nb.js";
...
import { a as runAgentCleanupStep, r as resolveSettledTurnFinalizationText } from "./settled-turn-finalization-result-BmhJQmHW.js";
import { t as createTrajectoryRuntimeRecorder } from "./runtime-CSro6ugV.js";
import { S as mergeUsageIntoAccumulator, _ as resolveRateLimitProfileRotationLimit, a as buildUsageAgentMetaFields, b as createUsageAccumulator, c as resolveActiveErrorContext, d as resolveFinalAssistantVisibleText, f as resolveLatestCallUsage, g as resolveOverloadProfileRotationLimit, h as resolveOverloadFailoverBackoffMs, i as buildErrorAgentMeta, l as resolveEmbeddedAttemptBasePrompt, m as resolveNextSameModelRateLimitRetryCount, n as RUNTIME_AUTH_REFRESH_MIN_DELAY_MS, o as createCompactionDiagId, p as resolveMaxRunRetryIterations, r as RUNTIME_AUTH_REFRESH_RETRY_MS, s as isAssistantForModelRef, t as RUNTIME_AUTH_REFRESH_MARGIN_MS, u as resolveFinalAssistantRawText, v as resolveReportedModelRef, x as mergeAttemptRunStatsIntoAccumulator, y as resolveSameModelRateLimitRetryDelayMs } from "./helpers-BN65NIti.js";
import { a as runAgentHarnessAttempt, c as selectAgentHarnessForPreparedModelProviders, o as runAgentHarnessSettledTurnFinalization, s as selectAgentHarness, t as agentHarnessBuildsOpenClawTools } from "./selection-DSP58ux_.js";
import { t as DEFERRED_CONTEXT_ENGINE_COMPACTION_REASON } from "./compact-reasons-BdRFPqua.js";
import { d as persistCompactionCheckpoint, i as asCompactionHookRunner, l as runPostCompactionSideEffects, n as prepareCompactionHarnessAuth, r as resolveCompactionRuntimeSelection, t as resolveProjectKey, u as compactionCheckpointStore } from "./project-memory-scope-DulfZe6w.js";
import { n as buildHandledBeforeAgentReplyPayloads, r as runBeforeAgentReplyForTurn, t as buildEmbeddedRunPayloads } from "./payloads-ECValbU0.js";
import { n as resolveRunWorkspaceDir, t as redactRunIdentifier } from "./workspace-run-BwniLrLW.js";
import { r as stripOpenClawMcpToolPrefix } from "./tool-policy-Cq4UBQeI.js";
import { t as resolveEmbeddedCliBackendDispatchEligibility } from "./cli-backend-dispatch-eligibility-TPBQ8QJ-.js";
import { n as buildAgentRuntimePlan } from "./build-BykyiSkJ.js";
import { n as createAgentHarnessTaskRuntimeScope } from "./agent-harness-task-runtime-scope-DcTeGL4j.js";
import { a as resizeExecApprovalContinuationPrompt } from "./bash-tools.exec-approval-output-gUsadhCg.js";
import { i as shouldSwitchToLiveModel, n as clearLiveModelSwitchPending, t as mergeAttemptToolMediaPayloads } from "./tool-media-payloads-lamEIh5q.js";
import { a as resolveHookModelSelection, i as resolveEmbeddedRuntimeModelPolicy, n as createNativeModelOwnedRuntimeModel, o as resolveNativeModelOwnedHarnessId, r as resolveAgentHarnessRunAdmissionError, t as buildBeforeModelResolveAttachments } from "./setup-IDGWCcQn.js";
import { t as formatAuthProfileFailureMessage } from "./failure-copy-CgonVN2G.js";
import { t as resolveExternalCliAuthOverlayScopeFromSelection } from "./external-cli-auth-selection-C5fbUGzn.js";
import { a as withSessionPlacementTurnAdmission } from "./session-placement-admission-BEJd445g.js";
import { n as readChannelSourceTurnId, r as readChannelSourceTurnSameThreadRequired } from "./source-turn-id-raOki4r6.js";
...
async function retireDispatchSessionMcpRuntime(params) {
	try {
		const { retireSessionMcpRuntime, retireSessionMcpRuntimeForSessionKey } = await import("./agent-bundle-mcp-tools-CcV3eLnB.js");
