...
async function runStartupUpgradeConvergence(params) {
	...
	const { runPostCorePluginConvergence } = await measureDoctorConfigPreflightStep("plugin-convergence-import", () => import("./post-core-plugin-convergence-DtZmN1dP.js"), params.measure);
...
const loadDoctorStateMigrations = createLazyRuntimeModule(() => import("./doctor-state-migrations-NUAm1xeS.js"));
