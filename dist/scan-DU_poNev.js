...
import { _ as parseStrictFiniteNumber, b as parseStrictPositiveInteger, j as resolveTimerTimeoutMs, l as asPositiveSafeInteger, o as asDateTimestampMs } from "./number-coercion-Crk_c9KW.js";
...
import { i as withProgressTotals } from "./progress-BjGUBuxw.js";
...
import { a as pad, o as truncate, r as formatTokenK } from "./list.options-CKiCgycC.js";
import { l as updateConfig, n as formatMs } from "./shared-CT3i8Kt3.js";
...
async function probeTool(model, apiKey, timeoutMs, complete) {
	...
	try {
		if (!(await withTimeout((signal) => complete(model, context, {
			apiKey,
			maxTokens: 256,
			temperature: 0,
			toolChoice: "required",
...
async function probeImage(model, apiKey, timeoutMs, complete) {
	...
	const startedAt = Date.now();
	try {
		await withTimeout((signal) => complete(model, context, {
			apiKey,
			maxTokens: 16,
			temperature: 0,
			signal
