import { h as isUnsafeDeviceReadPath } from "./path-D8zNGPJM.js";
import { t as sameFileIdentity$1 } from "./file-identity-C0fBiekR.js";
...
function openPinnedFileSync(params) {
	...
	let fd = null;
	try {
		if (isUnsafeDeviceReadPath(params.filePath)) return {
			ok: false,
			reason: "validation"
		};
...
//#endregion
export { openPinnedFileSync as t };
