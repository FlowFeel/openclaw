...
import { t as formatConfigIssueLine } from "./issue-format-NBZpPOU4.js";
import "./config-BBVHtcXg.js";
import { _ as resolveGatewayRequiredListenHosts, h as resolveGatewayBindHost } from "./net-B22ilI8B.js";
import { a as formatPortDiagnostics, i as classifyPortListener, n as inspectPortUsage, o as isDualStackLoopbackGatewayListeners, s as isExpectedGatewayListeners } from "./ports-inspect-CrH88LRj.js";
import "./ports-Dvltmmu1.js";
import { a as resolveGatewayRestartLogPath, i as resolveGatewayLogPaths, o as resolveGatewaySupervisorLogPaths } from "./restart-logs-BBbMF07G.js";
import { n as readLastGatewayErrorLine, t as readGatewayLogTailLines } from "./diagnostics-DNkYhwW-.js";
import { a as classifyOAuthRefreshFailureReason } from "./oauth-refresh-failure-BUReLFib.js";
import { l as readRestartSentinel, u as summarizeRestartSentinel } from "./restart-sentinel-C6_-wnpH.js";
...
import { c as formatPluginCompatibilityNotice, n as buildPluginCompatibilityNotices } from "./status-DBhSQc1q.js";
import { n as resolveStatusAllConnectionDetails } from "./status.gateway-connection-BhoLn6II.js";
import { f as redactSecrets } from "./format-CxmpYXG6.js";
import { d as buildStatusOverviewSurfaceFromOverview, i as resolveStatusGatewayHealthSafe, n as resolveStatusGatewayDiagnosticsSafe, s as resolveStatusServiceSummaries } from "./status-runtime-shared-CGtx63PJ.js";
import { a as statusAgentsTableColumns, c as formatUpdateRestartStatusValue, i as buildStatusChannelDetailSections, l as buildStatusAllOverviewRows, n as appendStatusSectionHeading, o as statusOverviewTableColumns, r as buildStatusAgentTableRows, s as formatUpdateRestartActionLines, t as appendStatusReportSections } from "./text-report-BcLL3Zm7.js";
import { n as statusChannelsTableColumns, t as buildStatusChannelsTableRows } from "./channels-table-DxFNivs3.js";
import { t as resolveNodeOnlyGatewayInfo } from "./status.node-mode-D51Ei0lM.js";
import { t as collectStatusScanOverview } from "./status.scan-overview-9LGMR6a7.js";
...
async function resolveStatusAllLocalDiagnosis(params) {
	...
	const portUsage = await inspectPortUsage(port, { probeHosts: resolveGatewayRequiredListenHosts(await resolveGatewayBindHost(overview.cfg.gateway?.bind ?? "loopback", overview.cfg.gateway?.customBindHost)) }).catch(() => null);
