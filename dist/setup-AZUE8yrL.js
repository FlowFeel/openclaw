...
import { a as requireRiskAcknowledgement, i as readValidSetupConfigFile, o as resolveQuickstartGatewayDefaults, r as readSetupConfigFileSnapshot, s as writeWizardConfigFile, t as hasQuickstartGatewayOverrides } from "./setup.shared-WvGMBt-N.js";
import { a as runSetupModelAuthStep, i as offerLiveModelVerification, n as listSetupMigrationOptions, r as runSetupMigrationImport, t as detectSetupMigrationSources } from "./setup.migration-import-By0W7Fwj.js";
...
async function runSetupWizardOnce(opts, runtimeInput, prompter) {
	...
	if (opts.skipChannels) await prompter.note(t("wizard.setup.skipChannels"), t("wizard.setup.channelsTitle"));
		...
		const { setupChannels } = await import("./onboard-channels-Bjkrb6M5.js");
	...
	if (flow !== "quickstart") {
		const { setupOfficialPluginInstalls } = await import("./setup.official-plugins-Q6t6BLCe.js");
		...
		const { setupAppRecommendations } = await import("./setup.app-recommendations-Cwq8rwFb.js");
	...
	const { finalizeSetupWizard } = await import("./setup.finalize-DaIT2039.js");
