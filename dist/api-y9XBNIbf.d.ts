...
type DeviceBootstrapPurpose = "control-ui" | "mobile-full" | "voice-node";
...
type DevicePairingForbiddenReason = "caller-scopes-required" | "caller-missing-scope" | "scope-outside-requested-roles" | "effective-operator-already-paired" | "bootstrap-role-not-allowed" | "bootstrap-scope-not-allowed";
...
type ApproveDevicePairingResult = {
  status: "approved";
  requestId: string;
  device: PairedDevice; /** Existing connected node transports must be retired before success is returned. */
...
//#endregion
export { resolvePreferredOpenClawTmpDir as a, resolveTailscaleServeGatewayUrlsWithRunner as c, DeviceBootstrapProfile as d, PAIRING_SETUP_BOOTSTRAP_PROFILE as f, revokeDeviceBootstrapToken as i, approveDevicePairing as l, clearDeviceBootstrapTokens as n, resolveGatewayBindUrl as o, issueDeviceBootstrapToken as r, resolveTailnetHostWithRunner as s, runPluginCommandWithTimeout as t, listDevicePairing as u };