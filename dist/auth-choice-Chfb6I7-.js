...
import { o as canonicalizeProviderModelId } from "./openai-model-routes--NVfVZh4.js";
...
import { c as publishPreparedModelRuntimeSnapshot } from "./prepared-model-runtime-Cbe86whM.js";
...
import { r as prepareAuthChoiceLoadedPluginProvider } from "./provider-auth-choice-CpMO0DVE.js";
import { t as buildProviderAuthRecoveryHint } from "./provider-auth-recovery-hint-DqEHEl3h.js";
import "./provider-auth-choice-preference-BIrP25iY.js";
...
async function normalizeLegacyChoice(authChoice, params) {
	...
	const { normalizeLegacyOnboardAuthChoice } = await import("./auth-choice-legacy-D-8wEFYs.js");
...
async function normalizeTokenProviderChoice(params) {
	...
	const { normalizeApiKeyTokenProviderAuthChoice } = await import("./auth-choice.apply.api-providers-DF56kOaC.js");
...
async function formatDeprecatedProviderChoiceError(authChoice, params) {
	...
	const { resolveManifestDeprecatedProviderAuthChoice } = await import("./provider-auth-choices-f_Oyci0_.js");
	...
	const { resolveDeprecatedProviderInstallCatalogEntry } = await import("./provider-install-catalog-B5T7uWOb.js");
